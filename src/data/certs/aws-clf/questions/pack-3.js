export const AWS_CLF_QUESTIONS_3 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "AWS Edge Locations (Points of Presence)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "IAM Roles" },
      { id: 'B', text: "IAM Instance Profiles" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Cost and Usage Report (AWS CUR)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Aggregated usage across member accounts reaches volume tiers sooner." },
