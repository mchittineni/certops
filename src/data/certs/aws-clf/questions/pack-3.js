export const AWS_CLF_QUESTIONS_3 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Service Linked Roles" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Compute Optimized (C instance family)" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Amazon Elastic Kubernetes Service (Amazon EKS)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Usage across all member accounts is aggregated, allowing the organization to reach higher volume discount pricing tiers faster." },
