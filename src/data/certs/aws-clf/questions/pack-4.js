export const AWS_CLF_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "S3 Lifecycle Configuration" },
      { id: 'B', text: "S3 Object Replication" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Managed Keys" },
      { id: 'B', text: "CloudHSM Root Keys" },
      { id: 'C', text: "Customer Managed Keys (CMK)" },
      { id: 'D', text: "AWS Owned Keys" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Inbound data transfer is free; outbound is billed per gigabyte." },
      { id: 'C', text: "Both inbound and outbound data transfers are completely free." },
      { id: 'D', text: "Both inbound and outbound data transfers are billed at identical per-gigabyte rates." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Automated snapshots are retained for 10 years automatically." },
      { id: 'C', text: "Manual snapshots are deleted automatically after 35 days." },
      { id: 'D', text: "Automated snapshots go with the instance; a manual snapshot persists." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon CloudFront Signed URLs" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Dynamic Hosted Zone" },
      { id: 'B', text: "Private Hosted Zone" },
      { id: 'C', text: "Public Hosted Zone" },
      { id: 'D', text: "Global Hosted Zone" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "AWS Backup Vault Lock" }
    ],
    correctAnswers: ['A'],
    type: "single",
