export const AWS_CLF_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Amazon S3 Object Lock in Governance Mode" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Customer Managed Keys (CMK)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "AWS Direct Connect Gateway" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "S3 Lifecycle Management" }
    ],
    correctAnswers: ['D'],
    type: "single",
