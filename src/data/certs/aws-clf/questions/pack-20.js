export const AWS_CLF_QUESTIONS_20 = [
  {
    id: "aws-clf-476",
    difficulty: "hard",
    certId: "aws-clf",
    ...
    title: "AWS Organizations Consolidated Billing: Dr Failover",
    ...
    tags: ["AWS Organizations", "Organizations", "Dr Failover"]
  },
  {
    id: "aws-clf-477",
    difficulty: "medium",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Organizations Consolidated Billing: High Load Scale",
    ...
    explanation: "Enable Consolidated Billing within AWS Organizations. Consolidated Billing is a feature of AWS Organizations that consolidates payment for multiple AWS accounts into a single management account. It aggregates resource usage across all member accounts, allowing the organization to achieve volume pricing tiers (such as S3 tiered storage discounts) and share Reserved Instance / Savings Plans benefits.",
    referenceUrl: "https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_consolidated-billing.html",
    tags: ["AWS Organizations", "Organizations", "High Load Scale"]
  },
  {
    id: "aws-clf-478",
    difficulty: "medium",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Organizations Consolidated Billing: Security Compliance",
    scenario: "A financial compliance and auditing department requires strict enforcement of data protection, access controls, and cloud governance policies across all systems. The organization evaluates AWS Organizations to combine billing across multiple AWS accounts in an enterprise to receive a single monthly bill and aggregate usage for tiered volume discounts.",
    ...
    explanation: "Enable Consolidated Billing within AWS Organizations. Consolidated Billing is a feature of AWS Organizations that consolidates payment for multiple AWS accounts into a single management account. It aggregates resource usage across all member accounts, allowing the organization to achieve volume pricing tiers (such as S3 tiered storage discounts) and share Reserved Instance / Savings Plans benefits.",
    referenceUrl: "https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_consolidated-billing.html",
    tags: ["AWS Organizations", "Organizations", "Security Compliance"]
  },
  {
    id: "aws-clf-479",
    difficulty: "easy",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Organizations Consolidated Billing: Hybrid Migration",
    ...
    explanation: "Enable Consolidated Billing within AWS Organizations. Consolidated Billing is a feature of AWS Organizations that consolidates payment for multiple AWS accounts into a single management account. It aggregates resource usage across all member accounts, allowing the organization to achieve volume pricing tiers (such as S3 tiered storage discounts) and share Reserved Instance / Savings Plans benefits.",
    referenceUrl: "https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_consolidated-billing.html",
    tags: ["AWS Organizations", "Organizations", "Hybrid Migration"]
  },
  {
    id: "aws-clf-480",
    difficulty: "medium",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Organizations Consolidated Billing: Resilience Failure",
    ...
    explanation: "Enable Consolidated Billing within AWS Organizations. Consolidated Billing is a feature of AWS Organizations that consolidates payment for multiple AWS accounts into a single management account. It aggregates resource usage across all member accounts, allowing the organization to achieve volume pricing tiers (such as S3 tiered storage discounts) and share Reserved Instance / Savings Plans benefits.",
    referenceUrl: "https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_consolidated-billing.html",
    tags: ["AWS Organizations", "Organizations", "Resilience Failure"]
  },
  {
    id: "aws-clf-481",
    difficulty: "hard",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Cost Explorer: Dr Failover",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Cost Explorer: High Load Scale",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Cost Explorer: Security Compliance",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Cost Explorer: Hybrid Migration",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Cost Explorer: Resilience Failure",
    scenario: "An IT operations team is modernizing infrastructure to eliminate single points of failure, optimize spending, and automate infrastructure maintenance. The organization evaluates AWS Cost Management to visualize, understand, and analyze historical AWS costs and usage trends over time, and forecast spending for the next 12 months.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Budgets Alerts: Dr Failover",
    ...
    tags: ["AWS Cost Management", "Budgets", "Dr Failover"]
  },
  {
    id: "aws-clf-487",
    difficulty: "medium",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Budgets Alerts: High Load Scale",
    ...
    explanation: "Create a Cost Budget in AWS Budgets and configure an alert threshold at 80% linked to email notifications or an SNS topic. AWS Budgets allows you to set custom budgets for costs, usage, and reservations, and sends automated alerts via email or Amazon SNS when actual or forecasted spending exceeds your defined threshold (e.g. 80% of $1,000).",
    referenceUrl: "https://docs.aws.amazon.com/cost-management/latest/userguide/budgets-managing-costs.html",
    tags: ["AWS Cost Management", "Budgets", "High Load Scale"]
  },
  {
    id: "aws-clf-488",
    difficulty: "medium",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Budgets Alerts: Security Compliance",
    ...
    explanation: "Create a Cost Budget in AWS Budgets and configure an alert threshold at 80% linked to email notifications or an SNS topic. AWS Budgets allows you to set custom budgets for costs, usage, and reservations, and sends automated alerts via email or Amazon SNS when actual or forecasted spending exceeds your defined threshold (e.g. 80% of $1,000).",
    referenceUrl: "https://docs.aws.amazon.com/cost-management/latest/userguide/budgets-managing-costs.html",
    tags: ["AWS Cost Management", "Budgets", "Security Compliance"]
  },
  {
    id: "aws-clf-489",
    difficulty: "easy",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Budgets Alerts: Hybrid Migration",
    ...
    explanation: "Create a Cost Budget in AWS Budgets and configure an alert threshold at 80% linked to email notifications or an SNS topic. AWS Budgets allows you to set custom budgets for costs, usage, and reservations, and sends automated alerts via email or Amazon SNS when actual or forecasted spending exceeds your defined threshold (e.g. 80% of $1,000).",
    referenceUrl: "https://docs.aws.amazon.com/cost-management/latest/userguide/budgets-managing-costs.html",
    tags: ["AWS Cost Management", "Budgets", "Hybrid Migration"]
  },
  {
    id: "aws-clf-490",
    difficulty: "medium",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Budgets Alerts: Resilience Failure",
    ...
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management? AWS Budgets cost and usage thresholds is under consideration.",
    options: [
    ...
    explanation: "Create a Cost Budget in AWS Budgets and configure an alert threshold at 80% linked to email notifications or an SNS topic. AWS Budgets allows you to set custom budgets for costs, usage, and reservations, and sends automated alerts via email or Amazon SNS when actual or forecasted spending exceeds your defined threshold (e.g. 80% of $1,000).",
    referenceUrl: "https://docs.aws.amazon.com/cost-management/latest/userguide/budgets-managing-costs.html",
    tags: ["AWS Cost Management", "Budgets", "Resilience Failure"]
  },
  {
    id: "aws-clf-491",
    difficulty: "hard",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Pricing Calculator: Dr Failover",
    ...
    tags: ["AWS Cost Management", "Pricing Calculator", "Dr Failover"]
  },
  {
    id: "aws-clf-492",
    difficulty: "medium",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Pricing Calculator: High Load Scale",
    ...
    explanation: "AWS Pricing Calculator The AWS Pricing Calculator is a web-based planning tool that allows you to explore AWS services and create detailed cost estimates for your use cases before deploying any infrastructure. Cost Explorer analyzes costs after resources are running.",
    referenceUrl: "https://calculator.aws/",
    tags: ["AWS Cost Management", "Pricing Calculator", "High Load Scale"]
  },
  {
    id: "aws-clf-493",
    difficulty: "medium",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Pricing Calculator: Security Compliance",
    ...
    explanation: "AWS Pricing Calculator The AWS Pricing Calculator is a web-based planning tool that allows you to explore AWS services and create detailed cost estimates for your use cases before deploying any infrastructure. Cost Explorer analyzes costs after resources are running.",
    referenceUrl: "https://calculator.aws/",
    tags: ["AWS Cost Management", "Pricing Calculator", "Security Compliance"]
  },
  {
    id: "aws-clf-494",
    difficulty: "easy",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Pricing Calculator: Hybrid Migration",
    ...
    explanation: "AWS Pricing Calculator The AWS Pricing Calculator is a web-based planning tool that allows you to explore AWS services and create detailed cost estimates for your use cases before deploying any infrastructure. Cost Explorer analyzes costs after resources are running.",
    referenceUrl: "https://calculator.aws/",
    tags: ["AWS Cost Management", "Pricing Calculator", "Hybrid Migration"]
  },
  {
    id: "aws-clf-495",
    difficulty: "medium",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Pricing Calculator: Resilience Failure",
    scenario: "An IT operations team is modernizing infrastructure to eliminate single points of failure, optimize spending, and automate infrastructure maintenance. The organization evaluates AWS Cost Management to estimate the projected monthly costs of an architectural solution on AWS (EC2, S3, RDS) before building or deploying any resources.",
    ...
    explanation: "AWS Pricing Calculator The AWS Pricing Calculator is a web-based planning tool that allows you to explore AWS services and create detailed cost estimates for your use cases before deploying any infrastructure. Cost Explorer analyzes costs after resources are running.",
    referenceUrl: "https://calculator.aws/",
    tags: ["AWS Cost Management", "Pricing Calculator", "Resilience Failure"]
  },
  {
    id: "aws-clf-496",
    difficulty: "hard",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Support Plans Comparison: Dr Failover",
    ...
    tags: ["AWS Support", "Support", "Dr Failover"]
  },
  {
    id: "aws-clf-497",
    difficulty: "medium",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Support Plans Comparison: High Load Scale",
    ...
    explanation: "AWS Business Support AWS Business Support provides 24/7 access to Cloud Support Engineers via phone, chat, and email, with a guaranteed response time of under 1 hour for production system down cases. Developer Support offers business-hours email access only, and Basic Support provides account/billing assistance only.",
    referenceUrl: "https://aws.amazon.com/premiumsupport/plans/",
    tags: ["AWS Support", "Support", "High Load Scale"]
  },
  {
    id: "aws-clf-498",
    difficulty: "medium",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Support Plans Comparison: Security Compliance",
    scenario: "A financial compliance and auditing department requires strict enforcement of data protection, access controls, and cloud governance policies across all systems. The organization evaluates AWS Support to select an AWS Support plan that provides 24/7 phone and chat access to Cloud Support Engineers with a 1-hour response time for production system down incidents.",
    ...
    explanation: "AWS Business Support AWS Business Support provides 24/7 access to Cloud Support Engineers via phone, chat, and email, with a guaranteed response time of under 1 hour for production system down cases. Developer Support offers business-hours email access only, and Basic Support provides account/billing assistance only.",
    referenceUrl: "https://aws.amazon.com/premiumsupport/plans/",
    tags: ["AWS Support", "Support", "Security Compliance"]
  },
  {
    id: "aws-clf-499",
    difficulty: "easy",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Support Plans Comparison: Hybrid Migration",
    ...
    explanation: "AWS Business Support AWS Business Support provides 24/7 access to Cloud Support Engineers via phone, chat, and email, with a guaranteed response time of under 1 hour for production system down cases. Developer Support offers business-hours email access only, and Basic Support provides account/billing assistance only.",
    referenceUrl: "https://aws.amazon.com/premiumsupport/plans/",
    tags: ["AWS Support", "Support", "Hybrid Migration"]
  },
  {
    id: "aws-clf-500",
    difficulty: "medium",
    ...
    domainId: "d4",
    domainName: "Billing, Pricing, and Support",
    title: "AWS Support Plans Comparison: Resilience Failure",
    scenario: "An IT operations team is modernizing infrastructure to eliminate single points of failure, optimize spending, and automate infrastructure maintenance. The organization evaluates AWS Support to select an AWS Support plan that provides 24/7 phone and chat access to Cloud Support Engineers with a 1-hour response time for production system down incidents.",
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management? AWS Support Plans: Basic, Developer, Business, Enterprise is under consideration.",
    options: [
      { id: 'A', text: "AWS Business Support" },
    ...
    explanation: "AWS Business Support AWS Business Support provides 24/7 access to Cloud Support Engineers via phone, chat, and email, with a guaranteed response time of under 1 hour for production system down cases. Developer Support offers business-hours email access only, and Basic Support provides account/billing assistance only.",
    referenceUrl: "https://aws.amazon.com/premiumsupport/plans/",
    tags: ["AWS Support", "Support", "Resilience Failure"]
  }
];

export default AWS_CLF_QUESTIONS_20;
