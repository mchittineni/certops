export const AWS_CLF_QUESTIONS_20 = [
  {
    ...
    options: [
      { id: 'A', text: "Deploy AWS Cost Explorer in each account without linking." },
      { id: 'B', text: "Create a joint shared IAM user across all accounts." },
      { id: 'C', text: "Enable Consolidated Billing within AWS Organizations." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy an Amazon CloudWatch Logs metric filter searching for billing numbers." },
      { id: 'C', text: "Configure AWS Cost Anomaly Detection with manual invoice review." },
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "AWS Free Tier Support" },
