export const AWS_CLF_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "It invokes a built-in AWS Lambda rotation function that updates both the database secret and the database server credentials synchronously." },
      { id: 'D', text: "It requires AWS CloudHSM to manually rotate passwords." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "S3 Access Control Lists (ACLs)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Three perspectives: Compute, Storage, and Networking" },
      { id: 'B', text: "Twelve perspectives: one for each AWS management service" },
      { id: 'C', text: "Four perspectives: Development, Testing, Staging, and Production" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "It permanently deletes the compromised EC2 instance immediately." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Temporary credentials expire automatically after a short duration, eliminating the risk of long-term credential leakage." }
    ],
    correctAnswers: ['D'],
    type: "single",
