export const AWS_CLF_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Event Source Mapping" },
      { id: 'B', text: "Amazon SNS Subscription" },
      { id: 'C', text: "API Gateway HTTP API" },
