export const AWS_CLF_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Use EBS Elastic Volumes to change size and IOPS while in use." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Storage volume, requests, and outbound transfer." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS CloudFormation Template" },
      { id: 'B', text: "Amazon EBS Snapshot" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Availability of AWS Snowcone devices" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "User-defined tags are only visible to AWS Support." },
      { id: 'D', text: "AWS-generated tags incur extra monthly billing fees." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Six: Business, People, Governance, Platform, Security, Operations" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It raises a finding and sends an event to Amazon EventBridge." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "HA keeps a Region running; DR restores after a Regional failure." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "One invoice paid by the management account, at combined tiers." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Temporary credentials cannot be audited in AWS CloudTrail." },
      { id: 'B', text: "Temporary credentials require no IAM policies." },
      { id: 'C', text: "Temporary credentials grant full administrator permissions." },
      { id: 'D', text: "They expire automatically after a short, fixed period." }
    ],
    correctAnswers: ['D'],
    type: "single",
