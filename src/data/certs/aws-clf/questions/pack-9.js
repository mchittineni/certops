export const AWS_CLF_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Stop the EC2 instance, detach the volume, resize it, and reattach it." },
      { id: 'C', text: "EBS volume sizes cannot be increased once created." },
      { id: 'D', text: "Use Amazon EBS Elastic Volumes to modify the volume size and IOPS dynamically while the volume is in use." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The number of IAM users accessing the bucket." },
      { id: 'B', text: "Inbound data transfer from the public internet." },
      { id: 'C', text: "Storage volume (GB-months), request counts (PUT, GET), and outbound data transfer." },
      { id: 'D', text: "The number of S3 buckets created in an account." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It requires AWS CloudHSM to manually rotate passwords." },
      { id: 'B', text: "It restarts the database instance on a monthly schedule." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon Machine Image (AMI)" },
      { id: 'B', text: "AWS CloudFormation Template" },
      { id: 'C', text: "Amazon EBS Snapshot" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The tier of AWS Support plan purchased" },
      { id: 'B', text: "The number of IAM users in the account" },
      { id: 'C', text: "Availability of AWS Snowcone devices" },
      { id: 'D', text: "Data residency and legal compliance requirements" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "User-defined tags are only visible to AWS Support." },
      { id: 'C', text: "AWS-generated tags incur extra monthly billing fees." },
      { id: 'D', text: "AWS-generated tags are defined and created automatically by AWS (prefixed with `aws:`), while user-defined tags are created and assigned by customers." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "S3 Access Control Lists (ACLs)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "IAM management is automatically outsourced to third-party identity providers." },
      { id: 'B', text: "AWS is responsible for resetting user passwords." },
      { id: 'C', text: "The customer is solely responsible for IAM user creation, password policies, and credential security." },
      { id: 'D', text: "AWS Support manages IAM users on behalf of the customer." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CloudFront Signed URLs and Signed Cookies" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Four perspectives: Development, Testing, Staging, and Production" },
      { id: 'B', text: "Twelve perspectives: one for each AWS management service" },
      ...
      { id: 'D', text: "Three perspectives: Compute, Storage, and Networking" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "`Environment` is the tag value, and `Production` is the tag key." },
      { id: 'B', text: "`Environment` is the tag key, and `Production` is the tag value." },
      { id: 'C', text: "Both are IAM policy variables." },
      { id: 'D', text: "Both are AWS Organization OU names." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "It revokes all IAM user credentials in the AWS account." },
      { id: 'C', text: "It blocks all internet access across the entire VPC." },
      { id: 'D', text: "It generates a security finding in the GuardDuty console and sends an event to Amazon EventBridge for automated notification or remediation." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "HA applies only to databases, whereas DR applies only to compute." },
      { id: 'B', text: "HA is free, whereas DR requires Enterprise Support." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "All AWS services are discounted by 50% automatically." },
      { id: 'C', text: "Member accounts cannot run production workloads." },
      { id: 'D', text: "All member accounts receive one consolidated monthly invoice paid by the management account, and benefit from combined volume pricing tiers." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Stored Volumes" },
      { id: 'B', text: "Tape Gateway" },
      { id: 'C', text: "Cached Volumes" },
      { id: 'D', text: "Amazon S3 File Gateway" }
    ],
    correctAnswers: ['A'],
    type: "single",
