export const AWS_CLF_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Stop the EC2 instance, detach the volume, resize it, and reattach it." },
      { id: 'B', text: "Create a new EBS volume and migrate data manually." },
      { id: 'C', text: "Use Amazon EBS Elastic Volumes to modify the volume size and IOPS dynamically while the volume is in use." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The number of S3 buckets created in an account." },
      { id: 'C', text: "Inbound data transfer from the public internet." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "EC2 Launch Template" },
      { id: 'C', text: "Amazon Machine Image (AMI)" },
      { id: 'D', text: "AWS CloudFormation Template" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "The tier of AWS Support plan purchased" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "User-defined tags are only visible to AWS Support." },
      ...
      { id: 'D', text: "AWS-generated tags can be deleted by customers at any time." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Support manages IAM users on behalf of the customer." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Six perspectives: Business, People, Governance (Business capabilities) and Platform, Security, Operations (Technical capabilities)" },
      { id: 'C', text: "Three perspectives: Compute, Storage, and Networking" },
      { id: 'D', text: "Twelve perspectives: one for each AWS management service" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It generates a security finding in the GuardDuty console and sends an event to Amazon EventBridge for automated notification or remediation." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "HA is manual, whereas DR is always fully automated." },
      { id: 'B', text: "HA applies only to databases, whereas DR applies only to compute." },
      { id: 'C', text: "HA focuses on continuous operational uptime and automatic fault handling within a Region (e.g. across AZs), whereas DR focuses on restoring operations after a major catastrophic Regional failure." },
      { id: 'D', text: "HA is free, whereas DR requires Enterprise Support." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Member accounts cannot run production workloads." },
      { id: 'B', text: "All AWS services are discounted by 50% automatically." },
      { id: 'C', text: "All member accounts receive one consolidated monthly invoice paid by the management account, and benefit from combined volume pricing tiers." },
      { id: 'D', text: "Each member account pays its bill separately to AWS local entities." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Temporary credentials expire automatically after a short duration, eliminating the risk of long-term credential leakage." },
      { id: 'B', text: "Temporary credentials grant full administrator permissions." },
      { id: 'C', text: "Temporary credentials require no IAM policies." },
      { id: 'D', text: "Temporary credentials cannot be audited in AWS CloudTrail." }
    ],
    correctAnswers: ['A'],
    type: "single",
