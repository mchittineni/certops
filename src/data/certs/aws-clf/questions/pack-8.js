export const AWS_CLF_QUESTIONS_8 = [
  {
    ...
    options: [
      ...
      { id: 'D', text: "Auto Scaling Lifecycle Hooks" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create a second key, switch the application over, then delete the old key." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS is responsible because the instance runs in an AWS data centre." },
      { id: 'B', text: "AWS Support will automatically re-write the vulnerable application code." },
      { id: 'C', text: "The customer remediates the OS and application inside the instance." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "99.9% durability" },
      { id: 'D', text: "99.99% durability" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Each member account must have its own corporate credit card on file." },
      { id: 'D', text: "The management (payer) account receives one invoice and pays all member charges." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Snapshots are incremental, saving only changed blocks." },
      { id: 'C', text: "EBS snapshots overwrite previous snapshots automatically." },
      { id: 'D', text: "EBS snapshots are stored directly on EC2 instance store disks." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hardware depreciates faster in the cloud." },
      ...
      { id: 'D', text: "Resources come and go on demand with no long-term commitment." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "AWS WAF" },
      { id: 'D', text: "Network Access Control Lists (NACLs)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon S3 Cross-Region Replication (CRR)" },
      { id: 'B', text: "Amazon S3 Transfer Acceleration" },
      { id: 'C', text: "AWS DataSync" },
      { id: 'D', text: "Amazon S3 Same-Region Replication (SRR)" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Managed Rules for AWS WAF" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The customer must SSH into the RDS host to install OS security patches." },
      { id: 'B', text: "OS patching is the shared responsibility of third-party consulting partners." },
      { id: 'C', text: "AWS is responsible for managing and patching the operating system hosting the RDS database." },
      { id: 'D', text: "The operating system does not require patching in the cloud." }
    ],
    correctAnswers: ['C'],
    type: "single",
