export const AWS_CLF_QUESTIONS_8 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Change the IAM user password, which automatically rotates the access keys." },
      { id: 'C', text: "Create a second access key, update the application with the new key, verify functionality, deactivate the old key, and finally delete the old key." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "The customer is solely responsible for remediating the application and operating system inside the EC2 instance." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "The Management (Payer) Account receives a single monthly consolidated invoice and is responsible for paying all charges incurred by all member accounts." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS refunds the cost of all failed business ideas." },
      { id: 'B', text: "All development environments are permanently free of charge." },
      { id: 'C', text: "Hardware depreciates faster in the cloud." },
      { id: 'D', text: "Resources can be provisioned and decommissioned on demand with zero long-term hardware commitments." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "AWS Managed Rules for AWS WAF" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The operating system does not require patching in the cloud." },
