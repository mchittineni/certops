export const AWS_CLF_QUESTIONS_12 = [
  {
    id: "aws-clf-276",
    difficulty: "hard",
    certId: "aws-clf",
    ...
    options: [
      ...
      { id: 'B', text: "Rely on a single on-premises server located in North America and route all international traffic over the public internet." },
      { id: 'C', text: "Build regional physical data centers in four continents over a three-year period." },
      { id: 'D', text: "Go global in minutes by deploying applications across multiple AWS Regions and utilizing Amazon CloudFront edge locations worldwide." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Rely on a single on-premises server located in North America and route all international traffic over the public internet." },
      { id: 'D', text: "Contract with local telecommunications providers in 20 countries individually." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Go global in minutes by deploying applications across multiple AWS Regions and utilizing Amazon CloudFront edge locations worldwide. With AWS, organizations can deploy applications to multiple global regions with just a few clicks. This allows businesses to provide lower latency and a better customer experience at minimal cost without physical overseas infrastructure.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Contract with local telecommunications providers in 20 countries individually." },
      { id: 'C', text: "Go global in minutes by deploying applications across multiple AWS Regions and utilizing Amazon CloudFront edge locations worldwide." },
      { id: 'D', text: "Build regional physical data centers in four continents over a three-year period." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Go global in minutes by deploying applications across multiple AWS Regions and utilizing Amazon CloudFront edge locations worldwide. With AWS, organizations can deploy applications to multiple global regions with just a few clicks. This allows businesses to provide lower latency and a better customer experience at minimal cost without physical overseas infrastructure.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Infrastructure as a Service (IaaS), such as Amazon EC2." },
      { id: 'D', text: "Software as a Service (SaaS), such as Microsoft 365." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "On-Premises Private Data Center hosting." },
      { id: 'C', text: "Platform as a Service (PaaS), such as AWS Elastic Beanstalk or Amazon RDS." },
      { id: 'D', text: "Infrastructure as a Service (IaaS), such as Amazon EC2." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Platform as a Service (PaaS), such as AWS Elastic Beanstalk or Amazon RDS. Platform as a Service (PaaS) removes the need for organizations to manage underlying infrastructure (hardware, OS provisioning, patching) and allows them to focus on the deployment and management of applications. Infrastructure as a Service (IaaS) requires the customer to manage the operating system and software stack.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Platform as a Service (PaaS), such as AWS Elastic Beanstalk or Amazon RDS." },
      { id: 'B', text: "Infrastructure as a Service (IaaS), such as Amazon EC2." },
      { id: 'C', text: "Software as a Service (SaaS), such as Microsoft 365." },
      { id: 'D', text: "On-Premises Private Data Center hosting." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Platform as a Service (PaaS), such as AWS Elastic Beanstalk or Amazon RDS. Platform as a Service (PaaS) removes the need for organizations to manage underlying infrastructure (hardware, OS provisioning, patching) and allows them to focus on the deployment and management of applications. Infrastructure as a Service (IaaS) requires the customer to manage the operating system and software stack.",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Deploy a hybrid architecture joining on-premises to AWS over Direct Connect or VPN." },
      { id: 'B', text: "Deploy a Public Cloud only architecture and decommission all on-premises servers immediately." },
      { id: 'C', text: "Deploy a Private Cloud exclusively within a local server room." },
      { id: 'D', text: "Isolate on-premises systems completely from AWS without network routing." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy a hybrid architecture joining on-premises to AWS over Direct Connect or VPN." },
      { id: 'B', text: "Deploy a Private Cloud exclusively within a local server room." },
      { id: 'C', text: "Isolate on-premises systems completely from AWS without network routing." },
      { id: 'D', text: "Deploy a Public Cloud only architecture and decommission all on-premises servers immediately." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Deploy a Hybrid Cloud architecture connecting on-premises data centers to AWS using AWS Direct Connect or AWS Site-to-Site VPN. A Hybrid deployment model connects infrastructure and applications between cloud-based resources and existing resources located in on-premises data centers, allowing organizations to extend their infrastructure into the cloud while retaining legacy systems.",
  ...
  },
  {
    ...
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management?",
    options: [
      { id: 'A', text: "Isolate on-premises systems completely from AWS without network routing." },
      { id: 'B', text: "Deploy a hybrid architecture joining on-premises to AWS over Direct Connect or VPN." },
      { id: 'C', text: "Deploy a Private Cloud exclusively within a local server room." },
      { id: 'D', text: "Deploy a Public Cloud only architecture and decommission all on-premises servers immediately." }
    ],
    correctAnswers: ['B'],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "All Availability Zones share the exact same physical power grid and flood plain." },
      { id: 'C', text: "A geographic location of several isolated Availability Zones." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "All Availability Zones share the exact same physical power grid and flood plain." },
      { id: 'B', text: "An AWS Region consists of exactly one single physical data center building." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Implement fault tolerance with redundant resources across several AZs." },
      { id: 'C', text: "Deploy a single high-performance EC2 instance in one Availability Zone." },
      { id: 'D', text: "Implement High Availability by scheduling a daily backup tape export." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Implement High Availability by scheduling a daily backup tape export." },
      { id: 'D', text: "Implement fault tolerance with redundant resources across several AZs." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Implement Fault Tolerance by deploying redundant active resources across multiple Availability Zones with automated load balancing and failover. Fault tolerance refers to the ability of a system to continue operating without interruption despite the failure of one or more components. In AWS, deploying stateless microservices across multiple Availability Zones behind Elastic Load Balancing achieves fault tolerance against AZ failure.",
  ...
  },
  {
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Implement fault tolerance with redundant resources across several AZs." },
      { id: 'B', text: "Implement High Availability by scheduling a daily backup tape export." },
      { id: 'C', text: "Deploy a single high-performance EC2 instance in one Availability Zone." },
      { id: 'D', text: "Rely on manual reboot scripts when an instance fails." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Implement Fault Tolerance by deploying redundant active resources across multiple Availability Zones with automated load balancing and failover. Fault tolerance refers to the ability of a system to continue operating without interruption despite the failure of one or more components. In AWS, deploying stateless microservices across multiple Availability Zones behind Elastic Load Balancing achieves fault tolerance against AZ failure.",
...
export default AWS_CLF_QUESTIONS_12;
