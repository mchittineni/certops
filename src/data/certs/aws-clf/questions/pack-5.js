export const AWS_CLF_QUESTIONS_5 = [
  {
    ...
    options: [
      { id: 'A', text: "A public subnet routes to an internet gateway; a private one does not." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "750 hours per month of t2.micro or t3.micro usage." },
      { id: 'C', text: "Unlimited EC2 usage for the first 30 days." },
