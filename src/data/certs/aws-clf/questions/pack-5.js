export const AWS_CLF_QUESTIONS_5 = [
  {
    ...
    options: [
      { id: 'A', text: "A public subnet uses Security Groups; a private subnet uses Network ACLs." },
      ...
      { id: 'D', text: "A public subnet routes to an internet gateway; a private one does not." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Egress-Only Internet Gateway for IPv4" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "750 hours per month of t2.micro or t3.micro usage." }
    ],
    correctAnswers: ['D'],
    type: "single",
