export const AWS_CLF_QUESTIONS_11 = [
  {
    id: "aws-clf-251",
    difficulty: "hard",
    certId: "aws-clf",
    ...
    title: "Trade Capital Expense for Variable Expense: Dr Failover",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Trade Capital Expense for Variable Expense: High Load Scale",
    ...
    options: [
      ...
      { id: 'B', text: "Build a private co-located data center facility." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Trade Capital Expense for Variable Expense: Security Compliance",
    ...
    options: [
      ...
      { id: 'D', text: "Trade capital expense for variable operating expense, consumed on demand." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Trade capital expense (CapEx) for variable operational expense (OpEx) by consuming AWS cloud resources on demand. One of the primary advantages of cloud computing is trading capital expense (CapEx) for variable expense (OpEx). Organizations pay only for the compute, storage, and networking resources they consume without requiring massive upfront capital investments in physical hardware or facilities.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Trade Capital Expense for Variable Expense: Hybrid Migration",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Trade Capital Expense for Variable Expense: Resilience Failure",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Massive Economies of Scale: Dr Failover",
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "AWS economies of scale continually lower pay-as-you-go prices." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Massive Economies of Scale: High Load Scale",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Massive Economies of Scale: Security Compliance",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Massive Economies of Scale: Hybrid Migration",
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Deploy dedicated physical private servers in an on-premises wiring closet." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Massive Economies of Scale: Resilience Failure",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Stop Guessing Capacity: Dr Failover",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Stop Guessing Capacity: High Load Scale",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Stop Guessing Capacity: Security Compliance",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Stop Guessing Capacity: Hybrid Migration",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Stop Guessing Capacity: Resilience Failure",
    ...
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management?",
    options: [
      { id: 'A', text: "Purchase static dedicated server capacity based on annual maximum forecasts." },
      { id: 'B', text: "Throttle incoming customer requests to match physical hardware constraints." },
      { id: 'C', text: "Stop guessing capacity; scale compute with demand." },
      { id: 'D', text: "Overprovision server hardware by 300% to ensure peak capacity is never exceeded." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Increase Speed and Agility: Dr Failover",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Increase Speed and Agility: High Load Scale",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Increase Speed and Agility: Security Compliance",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Increase Speed and Agility: Hybrid Migration",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Increase Speed and Agility: Resilience Failure",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Stop Spending Money Running Data Centers: Dr Failover",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Stop Spending Money Running Data Centers: High Load Scale",
    ...
    options: [
      ...
      { id: 'B', text: "Purchase backup diesel generators and redundant uninterruptible power supplies (UPS)." },
      { id: 'C', text: "Stop spending money running data centers so teams can focus on the business." },
      { id: 'D', text: "Perform manual hardware diagnostics and replace failed hard drives in physical server racks." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Stop Spending Money Running Data Centers: Security Compliance",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Stop Spending Money Running Data Centers: Hybrid Migration",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts",
    title: "Stop Spending Money Running Data Centers: Resilience Failure",
...
export default AWS_CLF_QUESTIONS_11;
