export const AWS_CLF_QUESTIONS_10 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cost allocation tags do not apply to EC2 instances." },
      { id: 'B', text: "Cost Explorer only tags compute instances in `us-east-1`." },
      { id: 'C', text: "Tags require manual approval by AWS Support." },
      { id: 'D', text: "They ran before the `CostCenter` tag was applied." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "AWS Artifact Agreements" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "25 GB plus 25 read and write units." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "At least 10 Availability Zones" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Do not generate root user access keys; if they exist, delete them immediately." },
      { id: 'C', text: "Share root access keys with all lead developers." },
      { id: 'D', text: "Store root access keys in a public GitHub repository." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "AWS Marketplace AMIs" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Server-side encryption with S3-managed keys" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Stop spending money running and maintaining data centres." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "No; the standby is for failover only and serves no reads." },
      { id: 'C', text: "Yes, by connecting to the standby's public IP address." },
      { id: 'D', text: "Yes, if provisioned with SSD gp3 storage." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Operating system application event logs on EC2." },
      { id: 'B', text: "Amazon S3 server access logs only." },
      { id: 'C', text: "AWS Trusted Advisor scan logs." },
      { id: 'D', text: "AWS CloudTrail management events, VPC Flow Logs, and DNS query logs." }
    ],
    correctAnswers: ['D'],
    type: "single",
