export const AWS_CLF_QUESTIONS_10 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "KMS deletes the old key and requires re-encrypting all data manually." },
      { id: 'B', text: "Key rotation is only available in AWS CloudHSM." },
      { id: 'C', text: "KMS changes the key ARN and breaks existing application code." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "AWS Billing Preferences" },
      { id: 'C', text: "AWS IAM Console" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Rotate root access keys every 7 days." },
      { id: 'C', text: "Store root access keys in a public GitHub repository." },
      { id: 'D', text: "Share root access keys with all lead developers." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "My AMIs" },
      { id: 'B', text: "AWS Marketplace AMIs" },
      { id: 'C', text: "Quick Start AMIs" },
      { id: 'D', text: "Community AMIs" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS CloudHSM hardware encryption." },
      { id: 'B', text: "Server-Side Encryption with Amazon S3 managed keys (SSE-S3) using 256-bit AES." },
      { id: 'C', text: "Client-side PGP encryption." },
      { id: 'D', text: "No encryption is applied unless explicitly enabled." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "AWS Concierge Support Team" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "No, in a standard RDS Multi-AZ deployment, the standby replica is strictly for high availability and failover and cannot accept read connections (unlike Read Replicas)." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon S3 server access logs only." },
      { id: 'B', text: "AWS CloudTrail management events, VPC Flow Logs, and DNS query logs." },
      { id: 'C', text: "AWS Trusted Advisor scan logs." },
