export const AWS_CLF_QUESTIONS_10 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Business Support and Enterprise Support (including Enterprise On-Ramp)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Store root access keys in a public GitHub repository." },
      { id: 'B', text: "Share root access keys with all lead developers." },
      { id: 'C', text: "Do not generate root user access keys; if they exist, delete them immediately." },
