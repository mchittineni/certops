export const AWS_CLF_QUESTIONS_1 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Enable MFA on the root user and use individual IAM identities for daily work." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The S3 console multipart upload feature run overnight." },
      { id: 'B', text: "AWS Snowball Edge Storage Optimized devices shipped to the AWS Region." },
      { id: 'C', text: "AWS DataSync over the existing internet connection." },
      { id: 'D', text: "AWS Database Migration Service (DMS) with a full-load task." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Cost Explorer, AWS Budgets, AWS Pricing Calculator." },
      { id: 'B', text: "AWS Pricing Calculator, AWS Cost Explorer, AWS Budgets with budget actions." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An AWS Config rule that flags resources created in non-approved Regions." },
      { id: 'B', text: "IAM Access Analyzer findings reviewed weekly by the security team." },
      { id: 'C', text: "An IAM permissions policy with a Region condition attached to every user in each account." },
      { id: 'D', text: "A Service Control Policy attached to the workload OU that denies actions outside the two approved Regions." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Strict Latency Optimization" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Sustainability Pillar" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Grant least privilege by allowing only `s3:GetObject` on `arn:aws:s3:::company-media/*`." },
      ...
      { id: 'D', text: "Allow full S3 access (`s3:*`) across all AWS resources." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Amazon RDS Read Replicas" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Short-term Trials" },
      { id: 'C', text: "Enterprise Discount Program" },
      { id: 'D', text: "12 Months Free" }
    ],
    correctAnswers: ['A'],
    type: "single",
