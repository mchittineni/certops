export const AWS_CLF_QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Consolidated billing in AWS Organizations, which aggregates usage across member accounts and shares Reserved Instance and Savings Plans discounts." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "AWS DataSync over the existing internet connection." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Amazon CloudWatch metrics for the S3 namespace." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Budgets, AWS Cost and Usage Report, AWS Compute Optimizer." },
      ...
      { id: 'D', text: "AWS Pricing Calculator, AWS Cost Explorer, AWS Budgets with budget actions." }
    ],
    correctAnswers: ['D'],
    type: "single",
