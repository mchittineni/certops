export const AWS_CLF_QUESTIONS_16 = [
  {
    ...
    options: [
      { id: 'A', text: "Use Amazon CloudWatch Logs Insights to parse S3 objects." },
      { id: 'B', text: "Use AWS Key Management Service (KMS) to scan file content." },
      { id: 'C', text: "Download all S3 objects and run regex search scripts manually." },
      { id: 'D', text: "Use Amazon Macie to find sensitive personal data in S3 buckets." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Download all S3 objects and run regex search scripts manually." },
      { id: 'C', text: "Use AWS Key Management Service (KMS) to scan file content." },
      { id: 'D', text: "Use Amazon CloudWatch Logs Insights to parse S3 objects." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Use Amazon Macie to evaluate S3 buckets and detect sensitive personal data using machine learning and pattern matching. Amazon Macie is a fully managed data security and privacy service that uses machine learning and pattern matching to discover, monitor, and protect sensitive data (like PII, financial details, or national IDs) stored in Amazon S3 buckets.",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Open a technical support case with AWS Premium Support." },
      { id: 'B', text: "Use AWS Artifact to download compliance reports and sign agreements." },
      { id: 'C', text: "Email AWS Customer Support requesting physical copies of audit certificates." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Use On-Demand instances exclusively." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Use Dedicated Hosts with annual commitments." },
  ...
  },
  {
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Use Standard 3-year Reserved Instances." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Increase the instance size vertically every morning." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Manually launch additional EC2 instances from the console during busy periods." },
      { id: 'C', text: "Use an EC2 Auto Scaling group with target tracking on average CPU." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy a Gateway Load Balancer." },
      { id: 'C', text: "Deploy a Network Load Balancer (NLB)." },
      { id: 'D', text: "An ALB with path-based routing rules." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Deploy an Application Load Balancer (ALB) and configure path-based routing rules. Application Load Balancer (ALB) operates at the application layer (Layer 7) and supports advanced routing features such as host-based, path-based, and query parameter routing. Network Load Balancer (NLB) operates at the transport layer (Layer 4) for extreme performance and ultra-low latency with static IP support.",
  ...
  },
  {
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Deploy a Gateway Load Balancer." },
      { id: 'B', text: "Deploy a Network Load Balancer (NLB)." },
      { id: 'C', text: "Configure Amazon Route 53 Weighted DNS routing." },
      { id: 'D', text: "An ALB with path-based routing rules." }
    ],
    correctAnswers: ['D'],
    type: "single",
