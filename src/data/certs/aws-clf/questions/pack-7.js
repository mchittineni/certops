export const AWS_CLF_QUESTIONS_7 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Credentials can be exposed through source code leaks, version control history, and unauthorized repository access." },
      { id: 'C', text: "Hardcoded credentials increase Amazon S3 storage costs." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "AWS CloudFormation alone" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Reserved Instance Credits" },
      { id: 'B', text: "12 Months Free" },
      { id: 'C', text: "Free Trials" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "AWS Global Service Health Dashboard (Public)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "The request requires root user confirmation." },
      { id: 'D', text: "Access is allowed only during business hours." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Instance Re-sizing" },
      { id: 'B', text: "Dynamic Tiering" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Amazon RDS Multi-AZ" },
      { id: 'C', text: "Amazon Aurora Global Database" },
      { id: 'D', text: "Amazon DynamoDB Local Secondary Indexes" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "User-defined cost allocation tags must be explicitly activated in the AWS Billing and Cost Management console before they appear in billing reports." },
