export const AWS_CLF_QUESTIONS_2 = [
  {
    ...
    options: [
      { id: 'A', text: "Trade upfront expense for variable expense." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An IAM Group with DynamoDB permissions." },
      { id: 'B', text: "An IAM User with long-term secret access keys." },
      { id: 'C', text: "The AWS Account Root user credentials." },
      { id: 'D', text: "An IAM Role assigned via an EC2 Instance Profile." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Amazon CloudWatch Events" },
