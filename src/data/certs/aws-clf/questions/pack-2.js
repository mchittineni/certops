export const AWS_CLF_QUESTIONS_2 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "AWS Cloud Adoption Framework (AWS CAF)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The AWS Account Root user credentials." },
      { id: 'C', text: "An IAM Group with DynamoDB permissions." },
      { id: 'D', text: "An IAM User with long-term secret access keys." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "AWS WAF (Web Application Firewall)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "EC2 Instance Savings Plans" },
      { id: 'D', text: "Compute Savings Plans" }
    ],
    correctAnswers: ['D'],
    type: "single",
