export const AWS_CLF_QUESTIONS_2 = [
  {
    ...
    options: [
      ...
      { id: 'D', text: "Trade upfront expense for variable expense." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Cloud Adoption Framework (AWS CAF)" },
      { id: 'B', text: "AWS Migration Hub" },
      { id: 'C', text: "AWS Well-Architected Framework" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The AWS Account Root user credentials." },
      { id: 'B', text: "An IAM Role assigned via an EC2 Instance Profile." },
      { id: 'C', text: "An IAM User with long-term secret access keys." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Throughput Optimized HDD (st1)" },
      { id: 'C', text: "Cold HDD (sc1)" },
      { id: 'D', text: "General Purpose SSD (gp3) or Provisioned IOPS SSD (io2)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Elastic IP Addresses" },
