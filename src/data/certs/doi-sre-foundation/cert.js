/**
 * DevOps Institute SRE Foundation (SREF) — exam blueprint.
 *
 ...
 *   4. add content: npm run new:pack -- --cert doi-sre-foundation --kind questions --count 50
 */
export default {
  "id": "doi-sre-foundation",
  "provider": "DevOps Institute",
  "code": "SREF",
  "title": "DevOps Institute SRE Foundation",
  "category": "DevOps & SRE",
  "tier": "foundational",
  "status": "planned",
  "priority": null,
  ...
  "icon": "devops",
  "color": "#14b8a6",
  "description": "TODO one-sentence description of what SREF validates.",
  "passingScore": 65,
  "maxScore": 100,
