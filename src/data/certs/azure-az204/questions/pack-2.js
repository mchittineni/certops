export const AZURE_AZ204_QUESTIONS_2 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A blob container with a SAS token" },
      { id: 'B', text: "An on-premises FTP server" },
      { id: 'C', text: "A Git repository in Azure DevOps" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set Minimum TLS Version to 1.2" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Helm chart bundle" },
      { id: 'C', text: "Vagrantfile" },
      { id: 'D', text: "Kubernetes Pod manifest YAML" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "0 9 30 * * 1-5" },
      { id: 'B', text: "30 9 * * 1-5" },
      { id: 'C', text: "0 30 9 * * 1-5" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Admin authorization level" },
      { id: 'C', text: "User authorization level" },
      { id: 'D', text: "Anonymous authorization level" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Decorate the return value with a [QueueOutput] attribute" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In Program.cs using HostBuilder ConfigureServices" },
      { id: 'B', text: "In host.json under the extensions block" },
      { id: 'C', text: "In local.settings.json" },
      { id: 'D', text: "In an external XML configuration file" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Fan-out / Fan-in pattern with Task.WhenAny" },
      { id: 'B', text: "Event Hub consumer pattern" },
      { id: 'C', text: "Async HTTP APIs pattern" },
      { id: 'D', text: "The function chaining pattern" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Human Interaction pattern" },
      { id: 'D', text: "Durable Entities pattern" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The monitor pattern with CreateTimer" },
      { id: 'B', text: "Thread.Sleep in a standard Azure Function" },
      { id: 'C', text: "An infinite while loop with no delays" },
      { id: 'D', text: "A continuous SQL query polling script" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In the container group resource requests" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Delegate the subnet to container groups" },
      { id: 'B', text: "Enable public IP assignment on the subnet" },
      { id: 'C', text: "Open inbound port 80 to 0.0.0.0/0" },
      { id: 'D', text: "Disable Network Security Groups" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Continuous revision mode" },
      { id: 'C', text: "Manual revision mode" },
      { id: 'D', text: "Single revision mode" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A Dapr state component manifest" },
      { id: 'B', text: "An App Service connection string" },
      { id: 'C', text: "A Dockerfile environment variable" },
      { id: 'D', text: "A Kubernetes Ingress controller rule" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Mount the key from an Azure Files share into the container" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Scaling up raises the pricing tier; scaling out adds instances" },
      { id: 'B', text: "Scaling up increases instance count; scaling out increases RAM" },
      { id: 'C', text: "Scaling up moves to another Azure region; scaling out enables ARR affinity" },
      { id: 'D', text: "Scaling up and scaling out are identical operations in Azure" }
    ],
    correctAnswers: ['A'],
    type: "single",
