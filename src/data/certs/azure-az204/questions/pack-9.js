export const AZURE_AZ204_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "API Revisions for both scenarios" },
      { id: 'C', text: "API Revisions for breaking changes; API Versions for non-breaking changes" },
      { id: 'D', text: "API Versions for both scenarios" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create a Named Value in APIM backed by an Azure Key Vault secret reference" },
      { id: 'B', text: "Embed the key directly in the policy XML string" },
      { id: 'C', text: "Store the secret in an unencrypted environment variable" },
      { id: 'D', text: "Pass the key in client HTTP request headers" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Custom JSON dictionary" },
      { id: 'B', text: "CloudEvents v1.0 schema" },
      { id: 'C', text: "Event Grid schema" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Stream Analytics query" },
      { id: 'B', text: "Subject Begins With filtering alone" },
      { id: 'C', text: "Advanced filtering on the payload" },
      { id: 'D', text: "Event Type filtering alone" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Partitions allow concurrent consumers and order within each one" },
      { id: 'B', text: "Partitions act as separate physical backup copies across different cloud providers" },
      { id: 'C', text: "Partitions automatically compress JSON data into MP4 video files" },
      { id: 'D', text: "Partitions eliminate the need for consumer applications" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Event Hubs Capture" },
      { id: 'B', text: "Event Hubs Checkpointing" },
      { id: 'C', text: "Azure Data Factory Trigger" },
      { id: 'D', text: "Log Analytics streaming" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Event Hubs exposes a Kafka-compatible endpoint" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Event Hubs Partition" },
      { id: 'B', text: "Service Bus Queues" },
      { id: 'C', text: "Service Bus Topics and Subscriptions" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Duplicate Detection with a DuplicateDetectionHistoryTimeWindow" },
      { id: 'B', text: "Message Sessions" },
      { id: 'C', text: "Dead-Letter Queue" },
      { id: 'D', text: "Auto-forwarding" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Past maxDeliveryCount it moves to the dead-letter queue" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Dead-Letter Filter" },
      { id: 'C', text: "Auto-forwarding rule" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Inspect the DequeueCount property" },
      { id: 'B', text: "Inspect the MessageId property" },
      { id: 'C', text: "Check the InsertionTime timestamp" },
      { id: 'D', text: "Inspect the NextVisibleTime" }
    ],
    correctAnswers: ['A'],
    type: "single",
