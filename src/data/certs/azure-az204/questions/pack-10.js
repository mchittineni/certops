export const AZURE_AZ204_QUESTIONS_10 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "&lt;validate-content&gt;" },
      { id: 'C', text: "&lt;validate-jwt&gt;" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "&lt;ip-filter action='allow'&gt;" },
      { id: 'B', text: "&lt;rate-limit-by-key&gt;" },
      { id: 'C', text: "&lt;validate-client-certificate&gt;" },
      { id: 'D', text: "&lt;cors&gt;" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "&lt;set-header name='Access-Control-Allow-Origin' * /&gt; manually" },
      { id: 'B', text: "&lt;cross-domain&gt; in &lt;outbound&gt;" },
      { id: 'C', text: "&lt;validate-jwt&gt;" },
      { id: 'D', text: "&lt;cors&gt; in the &lt;inbound&gt; section" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Event Grid Event Domains" },
      { id: 'B', text: "Custom Topics alone" },
      { id: 'C', text: "System Topics alone" },
      { id: 'D', text: "Event Hubs Dedicated" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "In the Webhook HTTP response header" },
      { id: 'D', text: "In the Event Grid Topic definition" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Dead-Lettering" },
      { id: 'B', text: "Correlation Filters alone" },
      { id: 'C', text: "Message Sessions" },
      { id: 'D', text: "Auto-Forwarding (ForwardTo property)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "TimeToLive" },
      { id: 'B', text: "CorrelationId" },
      { id: 'C', text: "SessionId" },
      { id: 'D', text: "ScheduledEnqueueTimeUtc" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Message Sessions alone" },
      { id: 'B', text: "Transactions using the Send-Via pattern" },
      { id: 'C', text: "Auto-forwarding alone" },
      { id: 'D', text: "Two-phase commit across external databases" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Geo-Disaster Recovery (Geo-DR)" },
      { id: 'B', text: "Geo-Replication alone" },
      { id: 'C', text: "Availability Zones alone" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create a static client per HTTP thread" },
      { id: 'B', text: "Instantiate a new ServiceBusClient and dispose it inside every method call" },
      { id: 'C', text: "Store clients in temporary disk files" },
      { id: 'D', text: "Register the client and sender as singletons" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CompleteMessageAsync" },
      { id: 'B', text: "DeferMessageAsync" },
      { id: 'C', text: "DeadLetterMessageAsync" },
      { id: 'D', text: "AbandonMessageAsync" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "DeleteMessage" },
      { id: 'B', text: "PeekMessages (PeekMessagesAsync)" },
      { id: 'C', text: "UpdateMessage" },
      { id: 'D', text: "ReceiveMessages" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Exactly-once delivery guaranteed under all conditions" },
      { id: 'B', text: "Zero-latency synchronous execution" },
      { id: 'C', text: "At-most-once delivery (events are never duplicated but can be dropped)" },
      { id: 'D', text: "At-least-once delivery, so subscribers must be idempotent" }
    ],
    correctAnswers: ['D'],
    type: "single",
