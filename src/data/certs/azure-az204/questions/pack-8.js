export const AZURE_AZ204_QUESTIONS_8 = [
  {
    ...
    options: [
      { id: 'A', text: "Cache-Aside pattern (Lazy Loading)" },
      { id: 'B', text: "Write-Through pattern" },
      { id: 'C', text: "Write-Behind pattern" },
      { id: 'D', text: "Refresh-Ahead pattern" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create and share a single ConnectionMultiplexer instance as a singleton throughout the application lifetime" },
      { id: 'B', text: "Instantiate a new ConnectionMultiplexer instance inside every HTTP request and dispose it" },
      { id: 'C', text: "Store ConnectionMultiplexer in client browser cookies" },
      { id: 'D', text: "Create a static thread-local instance per thread" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Basic tier (single node, no SLA)" },
      { id: 'C', text: "Standard tier (two nodes, no VNet or persistence)" },
      { id: 'D', text: "General Purpose tier" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In-Memory Snapshotting alone" },
      { id: 'B', text: "AOF (Append-Only File) persistence" },
      { id: 'C', text: "Redis Transaction Logging" },
      { id: 'D', text: "RDB (Redis Database) persistence" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "volatile-lru" },
      { id: 'B', text: "allkeys-lru" },
      { id: 'C', text: "noeviction" },
      { id: 'D', text: "allkeys-random" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure CDN Standard" },
      { id: 'C', text: "Azure Traffic Manager alone" },
      { id: 'D', text: "Azure Application Gateway alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cache every unique URL" },
      { id: 'B', text: "Ignore query strings" },
      { id: 'C', text: "Bypass caching" },
      { id: 'D', text: "Standard query stripping" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Front Door Rules Engine" },
      { id: 'B', text: "Origin Groups" },
      { id: 'C', text: "Health Probe settings" },
      { id: 'D', text: "Traffic Manager profiles" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "By compressing JSON files using lossy audio codecs" },
      { id: 'B', text: "By caching dynamic data in memory for 24 hours" },
      { id: 'C', text: "By terminating TLS at the nearest edge location" },
      { id: 'D', text: "By deploying dedicated physical servers in every city" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Purge the cache for that asset path" },
      { id: 'B', text: "Delete the Azure subscription and recreate it" },
      { id: 'C', text: "Wait for the 7-day TTL to expire" },
      { id: 'D', text: "Restart the backend origin server" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "properties is only for timestamps; metrics is for error messages" },
      { id: 'B', text: "Both dictionaries are identical in functionality" },
      { id: 'C', text: "properties can only contain integers; metrics contains strings" },
      { id: 'D', text: "properties holds strings for filtering, metrics holds numbers" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "An Azure Event Hub" },
      { id: 'C', text: "An Azure Storage Account container" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Export logs to a local on-premises server" },
      { id: 'B', text: "90 days interactive and 730 days total" },
      { id: 'C', text: "Delete logs older than 90 days" },
      { id: 'D', text: "Set interactive retention to 730 days" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Redis Pub/Sub alone" },
      { id: 'C', text: "Setting TTL to 1 millisecond" },
      { id: 'D', text: "Manual polling loops" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Web Application Firewall (WAF) on Azure Front Door" },
      { id: 'B', text: "Azure DDoS Protection Standard alone" },
      { id: 'C', text: "Network Security Groups on VMs" },
      { id: 'D', text: "App Service IP Restrictions alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A high dependency call failure rate" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "By hashing keys into 100 fixed partitions" },
      { id: 'B', text: "By spreading 16,384 hash slots across primary nodes" },
      { id: 'C', text: "By creating duplicate copies of every key on every node" },
      { id: 'D', text: "By running a round-robin DNS server" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The API Gateway (Data Plane)" },
      { id: 'B', text: "The Management Plane" },
      { id: 'C', text: "The Developer Portal" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The &lt;inbound&gt; section" },
      { id: 'B', text: "The &lt;backend&gt; section" },
      { id: 'C', text: "The &lt;outbound&gt; section" },
      { id: 'D', text: "The &lt;on-error&gt; section" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "&lt;validate-jwt calls='100' /&gt;" },
      { id: 'B', text: "&lt;quota-by-key calls='100' renewal-period='60' /&gt;" },
      { id: 'C', text: "&lt;rate-limit-by-key calls='100' renewal-period='60' counter-key='@(context.Subscription.Key)' /&gt;" },
      { id: 'D', text: "&lt;throttle calls='100' /&gt;" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "&lt;redirect-url /&gt;" },
      { id: 'B', text: "&lt;rewrite-uri template='/services/crm/customer-lookup?cid=@(context.Request.MatchedParameters[\"id\"])' /&gt;" },
      { id: 'C', text: "&lt;forward-request /&gt;" },
      { id: 'D', text: "&lt;set-header name='X-Original-URL' /&gt;" }
    ],
    correctAnswers: ['B'],
    type: "single",
