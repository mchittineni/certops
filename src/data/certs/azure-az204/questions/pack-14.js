export const AZURE_AZ204_QUESTIONS_14 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure Session consistency (default level providing read-your-writes guarantees within a session)." },
      { id: 'C', text: "Configure Strong consistency across all global regions for non-financial read traffic." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure Eventual consistency and accept stale reads during active customer shopping sessions." },
      { id: 'B', text: "Configure Strong consistency across all global regions for non-financial read traffic." },
      { id: 'C', text: "Disable database consistency checks entirely to minimize billing charges." },
      { id: 'D', text: "Configure Session consistency (default level providing read-your-writes guarantees within a session)." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Configure Session consistency (default level providing read-your-writes guarantees within a session). Cosmos DB provides five well-defined consistency levels: Strong, Bounded Staleness, Session, Consistent Prefix, and Eventual. Session consistency is the default and most widely used level, providing monotonic reads, monotonic writes, and read-your-writes guarantees scoped to a client session token.",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Trigger an Azure VM restart whenever a document is modified in Cosmos DB." },
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Provision 500 RU/s and rely on client HTTP retries for throttled requests." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Configure a static compute pool on an Azure Virtual Machine." },
      { id: 'D', text: "Provision 2,000 RU/s (1 RU per 1 KB point read under Session consistency)." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Provision 2,000 RU/s (1 RU per 1 KB point read under Session consistency). In Azure Cosmos DB, reading a 1 KB item by ID and partition key value (point read) consumes approximately 1 Request Unit (RU) under Session or Eventual consistency. Reading 2,000 items (1 KB each) per second requires provisioning at least 2,000 RU/s.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Implement Optimistic Concurrency Control (OCC) using the _etag property and an HTTP If-Match header." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create a separate blob container for every individual customer ID in the system." },
      { id: 'B', text: "Apply Blob Index Tags (key-value attributes) and query blobs using Find Blobs by Tags API." },
