export const AZURE_AZ204_QUESTIONS_18 = [
  {
    ...
    options: [
      ...
      { id: 'D', text: "Set the maxmemory-policy configuration to volatile-lru." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Set the maxmemory-policy configuration to noeviction." },
      { id: 'C', text: "Set the maxmemory-policy configuration to allkeys-random." },
      { id: 'D', text: "Set the maxmemory-policy configuration to volatile-lru." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Cache-aside: read Redis first, fall back to SQL, then write back with a TTL." },
      { id: 'D', text: "Write all database queries directly to the relational database and never read from Redis." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CDN caching rules with TTLs, plus an endpoint purge on release." },
      { id: 'B', text: "Change the DNS A record of the origin web server every time an image changes." },
  ...
  },
  {
    ...
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management?",
    options: [
      { id: 'A', text: "Change the DNS A record of the origin web server every time an image changes." },
      { id: 'B', text: "Instruct global users to clear their web browser cookies manually." },
      { id: 'C', text: "Host all images on an on-premises physical file server." },
      { id: 'D', text: "CDN caching rules with TTLs, plus an endpoint purge on release." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Configure CDN custom caching rules with defined TTLs and execute a CDN endpoint purge upon releasing new images. Azure Content Delivery Network (CDN) caches static content at strategically placed physical nodes globally to reduce latency. Custom caching rules control expiration durations (TTLs), while the Purge API forces edge nodes to discard cached assets and fetch fresh copies from the origin immediately.",
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Review application error logs manually at the start of each working week." },
      { id: 'B', text: "Deploy an Azure Virtual Machine to ping the payment gateway endpoint continuously." },
