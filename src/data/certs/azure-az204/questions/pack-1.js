export const AZURE_AZ204_QUESTIONS_1 = [
  {
    ...
    options: [
      { id: 'A', text: "Traffic redirection is instantaneous with zero downtime because routing rules are swapped at the front-end load balancer after the target worker processes are warmed up" },
      { id: 'B', text: "The production instance is terminated and restarted with a new virtual IP address" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Store the connection string in an unencrypted Blob storage container" },
      ...
      { id: 'D', text: "Mark the configuration setting as a Deployment slot setting (Sticky setting)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hybrid Connections" },
      { id: 'B', text: "Regional VNet Integration" },
      { id: 'C', text: "Azure ExpressRoute Gateway" },
      { id: 'D', text: "App Service Access Restrictions alone" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Scale out based on App Service CPU Percentage only" },
      { id: 'C', text: "Scale out based on HTTP 404 response counts" },
      { id: 'D', text: "Scale up the App Service Plan tier manually each morning" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Functions Dedicated Basic Tier" },
      { id: 'C', text: "Azure Functions Premium Plan (Elastic Premium)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Timer Trigger with manual SDK connections" },
      { id: 'B', text: "Queue Storage Trigger with a Cosmos DB Output Binding" },
      { id: 'C', text: "Cosmos DB Input Binding with an HTTP Trigger" },
      { id: 'D', text: "Cosmos DB Trigger with a Queue Storage Output Binding" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Generating random GUIDs or calling DateTime.UtcNow directly inside the orchestrator function code" },
      { id: 'B', text: "Calling activity functions using CallActivityAsync" },
      { id: 'C', text: "Creating timers using CreateTimer" },
      { id: 'D', text: "Awaiting other sub-orchestrators" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Async HTTP APIs pattern" },
      { id: 'B', text: "Fan-out / Fan-in pattern using Task.WhenAll" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Thread.Sleep for 72 hours" },
      { id: 'B', text: "A standard HTTP Webhook with an infinite timeout" },
      { id: 'C', text: "context.WaitForExternalEvent paired with context.CreateTimer and Task.WhenAny" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Standard environment variables in the pod YAML" },
      { id: 'B', text: "Secure Environment Variables (secureValue property)" },
      { id: 'C', text: "Passing passwords in the container command arguments" },
      { id: 'D', text: "Hardcoding the password in the container Dockerfile" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Azure Blob Storage container via NFS" },
      { id: 'D', text: "Azure Files file share mounted via SMB" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Virtual Machine Scale Sets autoscale" },
      { id: 'B', text: "Kubernetes Horizontal Pod Autoscaler CPU only" },
      { id: 'C', text: "Kubernetes Event-driven Autoscaling (KEDA)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Traffic Manager routing profile" },
      { id: 'B', text: "Traffic Splitting rules in Multiple revision mode" },
      { id: 'C', text: "App Service Slot Swap" },
      { id: 'D', text: "DNS round-robin records" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Istio Service Mesh alone" },
      { id: 'C', text: "Spring Cloud Gateway" },
      { id: 'D', text: "Apache ZooKeeper" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A poison queue named webjobs-blobtrigger-poison in the default storage account" },
      { id: 'B', text: "A Dead Letter Queue in Service Bus" },
      { id: 'C', text: "The root container" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Azure API Management (APIM)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "App Service Managed Certificate (ASMC)" },
      { id: 'B', text: "App Service Certificate purchased via GoDaddy" },
      { id: 'C', text: "Self-signed certificate uploaded to Key Vault" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Automation Runbook" },
      { id: 'C', text: "Entrypoint Dockerfile argument only" },
      { id: 'D', text: "Linux crontab schedule" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Always On setting in Configuration" },
      { id: 'B', text: "ARR Affinity setting" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Session State Provider" },
      { id: 'B', text: "ARR Affinity (Application Request Routing Cookie)" },
      { id: 'C', text: "Always On" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Service Endpoints without policies" },
      { id: 'B', text: "Access Restrictions" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "eventHubName and consumerGroup" },
      { id: 'D', text: "tableName and partitionKey" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In an in-memory dictionary" },
      { id: 'B', text: "Using an Azure Blob Storage container configured in AzureWebJobsStorage" },
      { id: 'C', text: "In Azure Cache for Redis" },
      { id: 'D', text: "In a local SQLite database on the worker VM" }
    ],
    correctAnswers: ['B'],
    type: "single",
