export const AZURE_AZ204_QUESTIONS_1 = [
  {
    ...
    options: [
      { id: 'A', text: "Routing is swapped at the front end once the target workers are warm" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable deployment slot swaps on the App Service Plan" },
      { id: 'B', text: "Store the connection string in Key Vault and reference it from the slot" },
      { id: 'C', text: "Mark the configuration setting as a Deployment slot setting (Sticky setting)" },
      { id: 'D', text: "Store the connection string in an unencrypted Blob storage container" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Regional VNet Integration" },
      { id: 'B', text: "Hybrid Connections" },
      { id: 'C', text: "App Service Access Restrictions alone" },
      { id: 'D', text: "Azure ExpressRoute Gateway" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An autoscale rule on the queue ActiveMessageCount metric" },
      { id: 'B', text: "Scale out based on HTTP 404 response counts" },
      { id: 'C', text: "Scale up the App Service Plan tier manually each morning" },
      { id: 'D', text: "Scale out based on App Service CPU Percentage only" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Functions Dedicated Basic Tier" },
      { id: 'B', text: "Azure Functions Premium Plan (Elastic Premium)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cosmos DB Trigger with a Queue Storage Output Binding" },
      { id: 'B', text: "Cosmos DB Input Binding with an HTTP Trigger" },
      { id: 'C', text: "Queue Storage Trigger with a Cosmos DB Output Binding" },
      { id: 'D', text: "Timer Trigger with manual SDK connections" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Calling DateTime.UtcNow or NewGuid inside it" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Function Chaining pattern" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A standard HTTP Webhook with an infinite timeout" },
      { id: 'B', text: "WaitForExternalEvent with a CreateTimer race" },
      { id: 'C', text: "Thread.Sleep for 72 hours" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Secure Environment Variables (secureValue property)" },
      { id: 'B', text: "Standard environment variables in the pod YAML" },
      { id: 'C', text: "Hardcoding the password in the container Dockerfile" },
      { id: 'D', text: "Passing passwords in the container command arguments" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Files file share mounted via SMB" },
      { id: 'B', text: "Azure Blob Storage container via NFS" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Kubernetes Horizontal Pod Autoscaler CPU only" },
      { id: 'B', text: "Kubernetes Event-driven Autoscaling (KEDA)" },
      { id: 'C', text: "Azure Virtual Machine Scale Sets autoscale" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Traffic Splitting rules in Multiple revision mode" },
      { id: 'B', text: "Azure Traffic Manager routing profile" },
      { id: 'C', text: "DNS round-robin records" },
      { id: 'D', text: "App Service Slot Swap" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A webjobs-blobtrigger-poison queue" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure API Management (APIM)" },
      { id: 'B', text: "Azure Front Door alone" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The startup command setting" },
      { id: 'B', text: "Linux crontab schedule" },
      { id: 'C', text: "Azure Automation Runbook" },
      { id: 'D', text: "Entrypoint Dockerfile argument only" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The Always On setting" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Always On" },
      { id: 'B', text: "Session State Provider" },
      { id: 'C', text: "ARR affinity cookie" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Service Endpoints without policies" },
      { id: 'C', text: "Private Link alone" },
      { id: 'D', text: "Access Restrictions" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A blob container in AzureWebJobsStorage" },
      { id: 'B', text: "In an in-memory dictionary" },
      { id: 'C', text: "In a local SQLite database on the worker VM" },
      { id: 'D', text: "In Azure Cache for Redis" }
    ],
    correctAnswers: ['A'],
    type: "single",
