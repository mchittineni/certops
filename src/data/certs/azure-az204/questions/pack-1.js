export const AZURE_AZ204_QUESTIONS_1 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Routing is swapped at the front end once the target workers are warm" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Calling DateTime.UtcNow or NewGuid inside it" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Fan-out / fan-in with Task.WhenAll" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "WaitForExternalEvent with a CreateTimer race" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A webjobs-blobtrigger-poison queue" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The Always On setting" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A blob container in AzureWebJobsStorage" },
