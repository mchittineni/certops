export const AZURE_AZ204_QUESTIONS_17 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Comment out feature code in source control and rebuild the Docker container image." },
      { id: 'C', text: "Reboot the production database server to toggle application behaviors." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Reboot the production database server to toggle application behaviors." },
      { id: 'B', text: "A feature flag in App Configuration read by Microsoft.FeatureManagement." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Associate the Shared Access Signatures with a Stored Access Policy on the storage container." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Issue ad-hoc SAS tokens without associating them with any policy." },
      { id: 'B', text: "Regenerate the storage account primary and secondary access keys, breaking all existing applications." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Issue ad-hoc SAS tokens without associating them with any policy." },
      { id: 'C', text: "Delete the storage account and recreate it under a different name." },
      { id: 'D', text: "Associate the Shared Access Signatures with a Stored Access Policy on the storage container." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Rely on client timestamps to guess which log entries correspond to which HTTP requests." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Implement a custom ITelemetryInitializer that appends custom properties to all telemetry items." },
      { id: 'C', text: "Manually pass the tenant ID to every Console.WriteLine statement throughout the entire codebase." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Store tenant IDs in a public database table without linking them to Application Insights." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Implement a custom ITelemetryInitializer that appends custom properties to all telemetry items. In Application Insights, an `ITelemetryInitializer` intercepts all telemetry items created by the SDK before they are sent to the ingest endpoint. Developers implement this interface to inject global contextual properties (like TenantId or AppVersion) into every logged item automatically.",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Block outbound internet traffic on port 443 from all web server virtual machines." },
      ...
      { id: 'D', text: "Configure Adaptive Sampling in the Application Insights SDK." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable all exception tracking and crash reporting in the application." },
      { id: 'C', text: "Delete the Application Insights resource and write logs to unmanaged VM hard drives." },
  ...
  },
  {
    ...
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management?",
    options: [
      { id: 'A', text: "Delete the Application Insights resource and write logs to unmanaged VM hard drives." },
