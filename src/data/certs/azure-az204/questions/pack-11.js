export const AZURE_AZ204_QUESTIONS_11 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy new code directly to the production slot and restart the App Service Plan during business hours." },
      { id: 'B', text: "Point DNS records to an unverified third-party virtual machine." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy new code directly to the production slot and restart the App Service Plan during business hours." },
      { id: 'C', text: "Delete the production slot and recreate it from a Git repository." },
      { id: 'D', text: "Use a staging slot with applicationInitialization for pre-swap warm-up." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Configure an App Service staging deployment slot and define an applicationInitialization element in web.config for pre-swap warm-up. Azure App Service deployment slots allow developers to validate application changes in a staging environment. Specifying applicationInitialization rules in web.config ensures that worker instances are fully warmed up and responsive before the virtual IP swap occurs, guaranteeing zero client downtime.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable deployment slot swaps on the App Service Plan." },
      { id: 'C', text: "Store the connection string in Key Vault and reference it from both slots." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy an ExpressRoute gateway to route outbound web app calls over on-premises routers." },
      { id: 'C', text: "Configure Regional VNet Integration connecting the App Service to a delegated subnet in the virtual network." },
  ...
  },
  {
    ...
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management?",
    options: [
      { id: 'A', text: "Write custom background daemon threads that sleep for 5 seconds between database polling cycles." },
      { id: 'B', text: "Deploy an Azure Virtual Machine to relay messages from Service Bus to Cosmos DB." },
      { id: 'C', text: "Configure a ServiceBusTrigger input binding and a CosmosDBOutput binding in the function definition." },
      { id: 'D', text: "Instantiate raw TCP socket connections inside the function handler to poll the queue." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Use the function chaining pattern in a Durable orchestrator." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Chain standard functions together using unmonitored HTTP webhooks without retry logic." },
      { id: 'C', text: "Use the function chaining pattern in a Durable orchestrator." },
      { id: 'D', text: "Store state in static in-memory variables inside a standard Consumption Function." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Implement the Function Chaining pattern using a Durable Functions Orchestrator function calling Activity functions. Azure Durable Functions is an extension of Azure Functions that enables writing stateful serverless functions. Orchestrator functions define workflows in code and use durable execution checkpointing to call Activity functions deterministically without paying for idle time.",
