export const AZURE_AZ204_QUESTIONS_12 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy 100 separate Azure Function Apps, each configured to process one invoice." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Use the fan-out/fan-in pattern with Task.WhenAll in the orchestrator." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Call the WaitForExternalEvent API in a Durable Functions orchestrator combined with a durable timer." },
      { id: 'D', text: "Keep an HTTP function thread blocked in a while(true) loop sleeping for 72 hours." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Call the WaitForExternalEvent API in a Durable Functions orchestrator combined with a durable timer. Durable Functions provides the `WaitForExternalEvent` method, which allows an orchestrator to pause execution and release compute resources while waiting for an external event (such as an approval click). Combined with a durable timer, it cleanly handles timeout scenarios.",
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Deploy the Function App on an Azure Functions Elastic Premium Plan with pre-warmed instances." },
      { id: 'B', text: "Deploy the Function App on the standard Consumption Plan with a 5-minute timeout." },
      { id: 'C', text: "Host the code as a background thread inside an unmanaged Azure Batch job." },
      { id: 'D', text: "Deploy an on-premises scheduled task to ping the function endpoint every 30 seconds." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Deploy the Function App on an Azure Functions Elastic Premium Plan with pre-warmed instances. The Azure Functions Premium Plan provides pre-warmed instances to eliminate cold start delays, advanced virtual network connectivity, unbounded run duration (up to 60 minutes default or unlimited), and dedicated compute sizing while retaining serverless autoscaling.",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Deploy an Azure Application Gateway with static backend IP targets." },
      { id: 'B', text: "Deploy the microservices to Azure Container Apps (ACA) with a KEDA Service Bus scale rule." },
      { id: 'C', text: "Host the container as a static website in an Azure Storage container." },
      { id: 'D', text: "Deploy a self-hosted Docker engine on an Azure IaaS virtual machine without autoscaling." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Host the container as a static website in an Azure Storage container." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure an Azure Container Registry (ACR) Task with base image trigger updates." },
      { id: 'C', text: "Deploy an unmanaged Jenkins server on an on-premises physical blade server." },
