export const AZURE_AZ204_QUESTIONS_15 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Set the blob container permissions to private read-only access." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Restore the entire virtual machine operating system disk from yesterday's backup." },
      { id: 'C', text: "Invoke the Undelete Blob API on the soft-deleted blob in the container." },
  ...
  },
  {
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Share the primary storage access key in plaintext with end users." },
      { id: 'B', text: "Generate a User Delegation SAS token signed with Microsoft Entra ID credentials." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Instantiate ConfidentialClientApplication with a certificate held in the browser." },
      { id: 'C', text: "Instantiate ConfidentialClientApplication and embed the client secret in the bundled JavaScript file." },
      { id: 'D', text: "Instantiate PublicClientApplication because browser-based SPAs cannot securely store private client secrets." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Instantiate PublicClientApplication because browser-based SPAs cannot securely store private client secrets. In the Microsoft Authentication Library (MSAL), `PublicClientApplication` is designed for apps running on devices or in web browsers where secrets cannot be securely maintained. `ConfidentialClientApplication` is designed for secure backend servers that safely hold client secrets or certificates.",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Implement the Resource Owner Password Credentials (ROPC) grant collecting user passwords directly." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Implement the legacy Implicit Grant Flow returning access tokens in URL hash fragments." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Implement the OAuth 2.0 Authorization Code Flow with Proof Key for Code Exchange (PKCE). The OAuth 2.0 Authorization Code Flow with PKCE is the industry standard for single-page applications. It prevents authorization code interception attacks by generating a cryptographic code verifier and code challenge, eliminating the need for client secrets in browser code.",
