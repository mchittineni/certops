export const AZURE_AZ204_QUESTIONS_6 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Switch to key 2, regenerate key 1, then reverse" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A Key Vault reference in App Configuration" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A distributed token cache in Redis" },
      { id: 'B', text: "Disable token caching completely in MSAL" },
      { id: 'C', text: "Store tokens in unencrypted client cookies" },
      { id: 'D', text: "Enable ARR affinity so each user returns to the same instance" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Integrated CAs as certificate issuers" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Verify the signature and the exp, aud and iss claims" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Existing tokens inherit the new expiry at once" },
