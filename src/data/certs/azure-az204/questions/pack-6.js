export const AZURE_AZ204_QUESTIONS_6 = [
  {
    ...
    options: [
      { id: 'A', text: "Soft Delete alone (without Purge Protection)" },
      { id: 'B', text: "Diagnostic Logging" },
      { id: 'C', text: "Purge Protection" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A percentage targeting filter" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Registering a sentinel key with a cache expiration" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Associating the SAS with a stored access policy" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Delete Key 1 and recreate the storage account" },
      { id: 'B', text: "Regenerate Key 1 and Key 2 simultaneously in the portal" },
      { id: 'C', text: "Disable Shared Key access before rotating" },
      { id: 'D', text: "Switch to key 2, regenerate key 1, then reverse" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A Key Vault reference in App Configuration" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "sip=198.51.100.45" },
      { id: 'B', text: "sp=198.51.100.45" },
      { id: 'C', text: "spr=198.51.100.45" },
      { id: 'D', text: "se=198.51.100.45" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Under Redirect URIs" },
      { id: 'B', text: "In API Permissions" },
      { id: 'C', text: "In Expose an API" },
      { id: 'D', text: "In Certificates & Secrets" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable token caching completely in MSAL" },
      { id: 'B', text: "Enable ARR affinity so each user returns to the same instance" },
      { id: 'C', text: "Store tokens in unencrypted client cookies" },
      { id: 'D', text: "A distributed token cache in Redis" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Integrated CAs as certificate issuers" },
      { id: 'B', text: "Self-signed certificates with manual renewal" },
      { id: 'C', text: "Let's Encrypt bash scripts on VMs" },
      { id: 'D', text: "External manual PFX imports" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Basic Authentication" },
      { id: 'D', text: "Access Restrictions on App Service alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "App Configuration Labels" },
      { id: 'B', text: "Key Vault Secret Versions" },
      { id: 'C', text: "App Configuration Snapshots" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In the app registration appRoles, returned in the roles claim" },
      { id: 'B', text: "Defined in local.settings.json and returned in the sub claim" },
      { id: 'C', text: "Defined in Key Vault and returned in the aud claim" },
      { id: 'D', text: "Defined in Azure Subscriptions and returned in the groups claim" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Verify the signature and the exp, aud and iss claims" },
      { id: 'B', text: "Verify caller IP address only" },
      { id: 'C', text: "Check only that the token string is longer than 50 characters" },
      { id: 'D', text: "Validate that the token contains no vowels" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "BackupKeyAsync (Backup Key)" },
      { id: 'B', text: "ExportKeyAsync in plain text" },
      { id: 'C', text: "CopyKeyVault" },
      { id: 'D', text: "CreateKeySnapshot" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Existing tokens inherit the new expiry at once" },
