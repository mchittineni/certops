export const AZURE_AZ204_QUESTIONS_4 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Consistent Prefix consistency" },
      { id: 'C', text: "Session consistency" },
      { id: 'D', text: "Eventual consistency" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cosmos DB Stored Procedures" },
      { id: 'B', text: "Azure Monitor Activity Log" },
      { id: 'C', text: "Cosmos DB Change Feed" },
      { id: 'D', text: "Cosmos DB Audit Logs" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "ConnectionMode.Gateway (over HTTPS port 443)" },
      { id: 'C', text: "ConnectionMode.WebSocket" },
      { id: 'D', text: "ConnectionMode.NamedPipes" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Page Blobs" },
      { id: 'B', text: "Archive Blobs" },
      { id: 'C', text: "Block Blobs" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Event Grid subscriptions" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Blob Snapshots alone" },
      { id: 'B', text: "Blob Versioning" },
      { id: 'C', text: "Append Blobs" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Blob Metadata alone (x-ms-meta-)" },
      { id: 'C', text: "Container ACLs" },
      { id: 'D', text: "Blob Snapshots" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An Azure Private Endpoint (Private Link)" },
      { id: 'B', text: "A Service Endpoint alone" },
      { id: 'C', text: "VNet Peering alone" },
      { id: 'D', text: "A Public IP with Network Security Group" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Creating a new storage account in the secondary region manually" },
      { id: 'B', text: "Slot Swap" },
      { id: 'C', text: "Customer-Managed Storage Account Failover (Account Failover)" },
      { id: 'D', text: "Automatic failover managed by DNS alone" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Azure Event Grid basic topic alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
