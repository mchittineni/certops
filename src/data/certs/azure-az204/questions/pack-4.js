export const AZURE_AZ204_QUESTIONS_4 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Consistent Prefix consistency" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Custom Merge Stored Procedure only" },
      { id: 'B', text: "A last-writer-wins policy" },
      { id: 'C', text: "First-Writer-Wins policy" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A composite index on both fields" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cosmos DB Change Feed" },
      { id: 'B', text: "Cosmos DB Stored Procedures" },
      { id: 'C', text: "Cosmos DB Audit Logs" },
      { id: 'D', text: "Azure Monitor Activity Log" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Execute two independent UpsertItemAsync calls in C# without locks" },
      { id: 'B', text: "Use the Change Feed processor to apply compensations" },
      { id: 'C', text: "A stored procedure run within the partition key" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure an Azure Storage lifecycle rule targeting Cosmos DB" },
      { id: 'C', text: "Cosmos DB does not support automatic document expiration" },
      { id: 'D', text: "Write a nightly Azure Function that runs DELETE * queries" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "ConnectionMode.WebSocket" },
      { id: 'C', text: "ConnectionMode.NamedPipes" },
      { id: 'D', text: "ConnectionMode.Gateway (over HTTPS port 443)" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Passing the previous ContinuationToken back in" },
      { id: 'B', text: "Using SQL OFFSET and LIMIT with high numbers" },
      { id: 'C', text: "Downloading the entire container into memory on the mobile device" },
      { id: 'D', text: "Executing separate Scan queries per page" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hot for 30 days, then Archive" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "High rehydration priority, under an hour" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Append Blobs" },
      { id: 'B', text: "Block Blobs" },
      { id: 'C', text: "Page Blobs" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Undelete the container with Restore-AzStorageContainer" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A locked retention policy" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Container ACLs" },
      { id: 'C', text: "Blob Snapshots" },
      { id: 'D', text: "Blob Metadata alone (x-ms-meta-)" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "UploadBlockRange" },
      { id: 'B', text: "PutBlob with a single 100 GB stream" },
      { id: 'C', text: "StageBlock then CommitBlockList" },
      { id: 'D', text: "AppendBlock in a single thread" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The Range request header" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Static website hosting from $web" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hierarchical namespace on the account" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A Public Elastic IP address" },
      { id: 'B', text: "Azure Bastion Host" },
      { id: 'C', text: "A storage service endpoint" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A Service Endpoint alone" },
      { id: 'B', text: "A Public IP with Network Security Group" },
      { id: 'C', text: "VNet Peering alone" },
      { id: 'D', text: "An Azure Private Endpoint (Private Link)" }
    ],
    correctAnswers: ['D'],
    type: "single",
