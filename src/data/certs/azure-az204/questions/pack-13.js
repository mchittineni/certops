export const AZURE_AZ204_QUESTIONS_13 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Configure an Azure Network Security Group rule to inspect registry port 443 traffic." },
      { id: 'D', text: "Schedule an Azure Automation runbook to poll the registry catalog every 60 seconds." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure an Azure Container Registry Webhook listening for the 'push' action on the repository." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Mount an Azure Files share as a volume in the Azure Container Instances container group definition." },
      { id: 'C', text: "Write database transactions to the local container /tmp filesystem." },
  ...
  },
  {
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Attach an unmanaged physical SCSI drive to the container group via USB." },
      { id: 'B', text: "Mount an Azure Files share as a volume in the Azure Container Instances container group definition." },
      { id: 'C', text: "Store persistent application state in the container's temporary local scratch disk." },
      { id: 'D', text: "Write database transactions to the local container /tmp filesystem." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Store the API secret in a public text file within the container image." },
      { id: 'B', text: "Pass the password as an unencrypted plaintext command-line argument." },
      { id: 'C', text: "Pass the password as a standard environment variable on the container group." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Pass the password as a standard environment variable on the container group." },
      { id: 'C', text: "Pass the password as an unencrypted plaintext command-line argument." },
      { id: 'D', text: "Store the API secret in a public text file within the container image." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Define environment variables using the secureValue attribute in the ACI resource specification. Azure Container Instances allows specifying environment variables with secure values (`secureValue`). Secure values are masked in the Azure portal, CLI, and REST API inspection outputs, protecting sensitive credentials from unauthorized administrative exposure.",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Implement custom username and password hashing routines in the application controller." },
      { id: 'B', text: "Enable built-in App Service Authentication with Microsoft Entra ID as the provider." },
      { id: 'C', text: "Disable authentication and rely on obscurity by hiding the URL from search engines." },
      { id: 'D', text: "Store user passwords in a flat CSV file on an unencrypted virtual machine disk." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Enable built-in App Service Authentication with Microsoft Entra ID as the provider." },
      ...
      { id: 'D', text: "Disable authentication and rely on obscurity by hiding the URL from search engines." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Enable built-in App Service Authentication (Easy Auth) and select Microsoft Entra ID as the identity provider. App Service Authentication (Easy Auth) is a turn-key authentication feature built directly into Azure App Service and Azure Functions. It intercepts incoming HTTP requests, validates identity tokens with providers like Microsoft Entra ID, and injects user claims into request headers without requiring SDK code.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Select tenantId or a composite synthetic key with high cardinality." },
      { id: 'C', text: "Select the country property where 98% of users reside in a single country." },
      { id: 'D', text: "Select the boolean isDeleted property that has only two distinct values." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Select tenantId or a composite synthetic key with high cardinality." },
      { id: 'C', text: "Select the boolean isDeleted property that has only two distinct values." },
