export const AZURE_AZ204_QUESTIONS_13 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Hardcode the database password in the Dockerfile ENV directive." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable built-in App Service Authentication (Easy Auth) and select Microsoft Entra ID as the identity provider." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Select tenantId or a composite synthetic key (tenantId_yearMonth) that provides high cardinality and even distribution." },
