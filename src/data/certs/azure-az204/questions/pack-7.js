export const AZURE_AZ204_QUESTIONS_7 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "softDeleteRetentionInDays (configurable between 7 and 90 days)" },
      { id: 'B', text: "purgeProtectionDays" },
      { id: 'C', text: "retentionWindowDays" },
      { id: 'D', text: "keyLifespanDays" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Microsoft Graph Delta Query" },
      { id: 'B', text: "Graph JSON Batching" },
      { id: 'C', text: "Graph Webhooks alone without tokens" },
      { id: 'D', text: "OData $filter queries alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Key 1 is read-only; Key 2 is read-write" },
      { id: 'B', text: "Key 1 is for Blob storage only; Key 2 is for Queue storage only" },
      { id: 'C', text: "None; both keys are identical and exist for rotation" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The subscription ID" },
      { id: 'C', text: "An Azure Storage SAS token" },
      { id: 'D', text: "The legacy APPINSIGHTS_INSTRUMENTATIONKEY alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "TrackMetric for numbers, TrackEvent for named events" },
      { id: 'B', text: "TrackTrace for numbers and TrackDependency for events" },
      { id: 'C', text: "TrackException only" },
      { id: 'D', text: "TrackAvailability for business transactions" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A KQL query filter" },
      { id: 'B', text: "A custom Telemetry Processor" },
      { id: 'C', text: "A custom telemetry initializer" },
      { id: 'D', text: "An Azure Functions output binding" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A KQL where clause in Azure Monitor" },
      { id: 'B', text: "A custom telemetry processor" },
      { id: 'C', text: "A Telemetry Initializer" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Transaction Diagnostics alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Standard Test (URL ping test)" },
      { id: 'B', text: "Custom TrackAvailability test alone" },
      { id: 'C', text: "KQL alert rule" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "SELECT count(*) FROM requests WHERE success = 0 GROUP BY date" },
      { id: 'B', text: "requests | where timestamp > ago(24h) and success == false | summarize count() by bin(timestamp, 1h)" },
      { id: 'C', text: "requests | select failed where time = 24h | group by hour" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "summarize calculates the column, and render outputs it" },
      { id: 'C', text: "evaluate creates the column, and table filters it" },
      { id: 'D', text: "project calculates the column, and select filters fields" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "An Autoscale Setting" },
      { id: 'D', text: "An Alert Processing Rule alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Smart Detection alone" },
      { id: 'D', text: "Live Metrics Stream" }
    ],
    correctAnswers: ['A'],
    type: "single",
