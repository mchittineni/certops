export const K8S_CKA_QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'The default StorageClass dynamically provisions a matching PersistentVolume and binds it to the claim.' },
      { id: 'B', text: 'The claim stays Pending until an administrator manually creates a matching PersistentVolume.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'preferredDuringSchedulingIgnoredDuringExecution podAntiAffinity matching the app label, with topologyKey kubernetes.io/hostname.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'kubectl get pod POD -n payments -o wide' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'A StatefulSet with pod anti-affinity' },
      { id: 'D', text: 'A CronJob scheduled every minute' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'kubectl drain node-3 --ignore-daemonsets --delete-emptydir-data' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Add a startupProbe with a generous failureThreshold, which disables the liveness and readiness probes until it succeeds.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Run ETCDCTL_API=3 etcdctl snapshot restore /backup/etcd-snap.db --data-dir /var/lib/etcd-restored' },
      ...
      { id: 'D', text: 'Run kubeadm reset on the control plane node before restoring the snapshot.' },
      { id: 'E', text: 'Copy the snapshot file directly over /var/lib/etcd/member/snap/db and restart kubelet.' }
    ],
    correctAnswers: ['A', 'B'],
    type: 'multiple',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'A second policy selecting app=api with an ingress rule for podSelector app=frontend on port 8080 grants the exception, because policies are additive.' },
      { id: 'C', text: 'The default-deny policy must include an explicit deny rule listing the blocked sources.' },
      { id: 'D', text: 'The exception policy must set policyTypes: [Egress] because the traffic leaves the frontend pod.' },
