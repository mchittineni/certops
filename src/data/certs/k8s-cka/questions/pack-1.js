export const K8S_CKA_QUESTIONS = [
  {
    ...
    options: [
      { id: 'A', text: "A single Service of type NodePort with two ports defined." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The claim stays Pending until an administrator manually creates a matching PersistentVolume." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A CronJob scheduled every minute" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Remove the liveness probe entirely so the container is never restarted." },
