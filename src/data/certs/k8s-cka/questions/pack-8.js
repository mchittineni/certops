export const K8S_CKA_QUESTIONS_8 = [
  {
    ...
    options: [
      { id: 'A', text: "Both webhook types run concurrently in arbitrary order." },
      { id: 'B', text: "Admission runs after the object is written to etcd." },
      { id: 'C', text: "Authentication, authorization, mutating admission, schema validation, validating admission, then persistence." },
      { id: 'D', text: "Validating admission first, then mutating admission." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl replace deployment/web --image=nginx:1.27" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "NetworkPolicies require a restart of kube-proxy to take effect." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "securityContext.fsGroup: 1000 on the pod" },
      { id: 'B', text: "automountServiceAccountToken: false" },
      { id: 'C', text: "securityContext.runAsUser: 0 on the container" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The CoreDNS pod logs." },
      { id: 'B', text: "The etcd member logs." },
      { id: 'C', text: "The kube-scheduler pod logs in kube-system, optionally at a higher verbosity level." },
      { id: 'D', text: "The kubelet journal on each candidate node." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Compact the history to a recent revision, defragment each member, then disarm the alarm." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The critical workload needs no change, and the batch workload needs a toleration for spot=true:NoSchedule." },
      ...
      { id: 'D', text: "Both workloads need tolerations, with different effects." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Pods using those volumes are evicted." },
      ...
      { id: 'D', text: "The volumes are converted to static provisioning and lose their reclaim policy." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "kubectl get node worker1 -o jsonpath=\"{.status.addresses[?(@.type=='InternalIP')].address}\"" },
      { id: 'C', text: "kubectl describe node worker1 | grep IP" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Scale to zero, edit, then scale up." },
      { id: 'B', text: "kubectl rollout pause, make the edits, then kubectl rollout resume." },
      { id: 'C', text: "Apply each change with --dry-run=server and then apply once." },
      { id: 'D', text: "Set maxSurge to 0 during the edits." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "One port entry with protocol: TCP,UDP." },
      { id: 'B', text: "A single port entry, because UDP is implied." },
      { id: 'C', text: "Two entries in spec.ports with distinct names, one with protocol TCP and one with protocol UDP." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CoreDNS is misconfigured for external names." },
      { id: 'B', text: "A NetworkPolicy or kube-proxy rule problem is blocking traffic to the kubernetes Service ClusterIP in the default namespace." },
      { id: 'C', text: "The API server certificate has expired." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "kubectl create secret tls shop-tls --cert=tls.crt --key=tls.key" },
      { id: 'C', text: "kubectl create secret generic shop-tls --from-literal=cert=tls.crt" },
      { id: 'D', text: "kubectl create configmap shop-tls --from-file=tls.crt --from-file=tls.key" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "maxSurge set to 100 percent." },
      { id: 'B', text: "progressDeadlineSeconds set to 10." },
      ...
      { id: 'D', text: "revisionHistoryLimit set to 1." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "In the Service selector labels." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Authentication succeeded and authorization failed, so the ServiceAccount needs an RBAC binding granting create on pods in prod." },
      { id: 'C', text: "The prod namespace does not exist." },
      { id: 'D', text: "An admission webhook rejected the pod." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The kubelet requires Docker Engine and communicates with it directly." },
      ...
      { id: 'D', text: "The kubelet talks only to CRI-compatible runtimes such as containerd or CRI-O over a CRI socket; dockershim was removed in v1.24." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A configMap volume with defaultMode set to 0400." },
      { id: 'B', text: "An envFrom reference to the ConfigMap." },
      { id: 'C', text: "A secret volume referencing the ConfigMap name." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Horizontal Pod Autoscaler on CPU utilisation." },
      { id: 'B', text: "Cluster Autoscaler alone." },
      { id: 'C', text: "Both HPA and VPA on the same CPU metric simultaneously." },
      { id: 'D', text: "Vertical Pod Autoscaler, because the workload needs larger resource allocations rather than more replicas." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The CoreDNS Corefile only." },
      { id: 'B', text: "The kubelet log files from every node." },
      { id: 'C', text: "The container images of every workload." },
      { id: 'D', text: "The /etc/kubernetes/pki certificate authority material and the static pod manifests, because a restored etcd is unusable without a matching CA." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A headless Service, because named ports require clusterIP: None." },
      { id: 'D', text: "Two named Service ports whose targetPort values are the container port names http and metrics." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Increase terminationGracePeriodSeconds on every pod." },
