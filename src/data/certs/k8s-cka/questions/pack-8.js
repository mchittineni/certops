export const K8S_CKA_QUESTIONS_8 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "kubectl replace deployment/web --image=nginx:1.27" },
      { id: 'C', text: "kubectl rollout restart deployment/web" },
      { id: 'D', text: "kubectl set image deployment/web web=nginx:1.27" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The policy must be created in the kube-system namespace." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Delete the etcd data directory and restart the member." },
      { id: 'C', text: "Restart kube-controller-manager to reduce write volume." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Bound PersistentVolumes and their data are unaffected, but no new claims can be provisioned with that class." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "In the API server admission plugins." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "The CoreDNS Corefile only." },
