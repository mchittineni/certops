export const K8S_CKA_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Only external etcd supports TLS between the API server and etcd." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "revisionHistoryLimit: 0" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl logs POD -c proxy" },
      { id: 'B', text: "kubectl describe pod POD | grep proxy" },
      { id: 'C', text: "kubectl logs POD --previous" },
      { id: 'D', text: "kubectl logs POD --all-containers --tail=1" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Both values are advisory and are not enforced." },
      { id: 'C', text: "The request applies to the pod and the limit applies to the namespace." },
      { id: 'D', text: "The request is what the scheduler reserves when placing the pod; the limit is the ceiling the kernel enforces at runtime." }
    ],
    correctAnswers: ['D'],
    type: "single",
