export const K8S_CKA_QUESTIONS_4 = [
  {
    ...
    options: [
      { id: 'A', text: "Run etcdctl snapshot restore and the running etcd picks up the new data automatically." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A hostAliases entry for the database hostname." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "kube-scheduler preempted lower priority pods on a node where eviction would make the pending pod schedulable." },
      { id: 'D', text: "The kubelet on node02 evicted the pod because of memory pressure." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create a PodSecurityPolicy object with privileged: false." },
      { id: 'B', text: "Label the namespace with pod-security.kubernetes.io/enforce: restricted or baseline." },
      { id: 'C', text: "Add a ResourceQuota counting privileged pods." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubeadm reset and rejoin the node" },
      { id: 'B', text: "kubectl certificate approve --all" },
      { id: 'C', text: "systemctl restart kubelet" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "It is updated within the kubelet sync period like any other ConfigMap volume." },
      { id: 'C', text: "It keeps the old contents, because subPath mounts are not updated when the ConfigMap changes." },
      { id: 'D', text: "The container is restarted automatically to pick up the change." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "terminationGracePeriodSeconds: 0" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Name the Ingress object nginx." },
      { id: 'B', text: "Add a label controller=nginx to the Ingress." },
      { id: 'C', text: "Set spec.ingressClassName: nginx on the Ingress." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A kubectl plugin that shells out to a database." },
      { id: 'B', text: "A CustomResourceDefinition with an OpenAPI v3 structural schema." },
      { id: 'C', text: "A ValidatingAdmissionWebhook on ConfigMaps." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The pod CIDR must be a subnet of the Service CIDR." },
      { id: 'B', text: "Service ClusterIPs are assigned from the pod CIDR." },
      { id: 'C', text: "The node network must be inside the pod CIDR for pods to reach nodes." },
      { id: 'D', text: "The pod CIDR, the Service CIDR, and the node network must not overlap, because each is routed differently." }
    ],
    correctAnswers: ['D'],
    type: "single",
