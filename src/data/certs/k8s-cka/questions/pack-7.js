export const K8S_CKA_QUESTIONS_7 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl get nodes -o wide" },
      { id: 'B', text: "kubectl cluster-info" },
      { id: 'C', text: "kubectl config get-clusters" },
      { id: 'D', text: "kubectl version --short" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The controller merges the rules for the shared host so both paths are served." },
      { id: 'B', text: "Only the alphabetically first Ingress is served." },
      { id: 'C', text: "The second Ingress is rejected by the API server as a duplicate host." },
