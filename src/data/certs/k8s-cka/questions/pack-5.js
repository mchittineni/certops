export const K8S_CKA_QUESTIONS_5 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The target pods must define CPU requests." },
      { id: 'C', text: "The pods must run with a Guaranteed QoS class." },
      { id: 'D', text: "metrics-server must be installed and serving the Metrics API." }
    ],
    correctAnswers: ['B', 'D'],
    type: "multiple",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "They are deleted with the pods and new empty volumes are created on scale-up." },
      { id: 'B', text: "They are retained by default and reattached to the pods when the StatefulSet scales back up." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Only traffic from alpha, because the first policy wins." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl cluster-info dump" },
      { id: 'B', text: "kubectl get all -A" },
      { id: 'C', text: "kubectl explain pod" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "ipFamilyPolicy: RequireDualStack with both IPv4 and IPv6 listed in ipFamilies." },
      { id: 'C', text: "externalTrafficPolicy: Local on an IPv6-only Service." },
