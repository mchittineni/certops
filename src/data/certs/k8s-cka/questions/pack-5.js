export const K8S_CKA_QUESTIONS_5 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Restarting the API server re-elects a leader and restores writes." },
      { id: 'B', text: "One of three members cannot form a majority, so the cluster must be rebuilt from a snapshot, typically by restoring a single-member cluster and re-adding members." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The target pods must define CPU requests." },
      { id: 'B', text: "metrics-server must be installed and serving the Metrics API." },
      { id: 'C', text: "The deployment must set a PodDisruptionBudget." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "They are merged into the claim of the surviving replica." },
      { id: 'B', text: "They are deleted with the pods and new empty volumes are created on scale-up." },
      { id: 'C', text: "They are retained by default and reattached to the pods when the StatefulSet scales back up." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Traffic from alpha and from beta, because policies are additive." },
      { id: 'B', text: "Only traffic matching both selectors simultaneously." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "The Service targetPort does not match the port the container listens on." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The controller component handles provisioning, attaching, and snapshotting; the node component handles staging, mounting, and formatting on each node." },
      { id: 'B', text: "The node component talks to the storage API and the controller runs inside each pod." },
      { id: 'C', text: "Both components perform identical work and one is a hot standby." },
      { id: 'D', text: "The controller mounts volumes into pods and the node component provisions storage." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "kubectl apply -f - --dry-run=server" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An audit policy file plus the kube-apiserver flags --audit-policy-file and --audit-log-path, with both paths mounted into the static pod." },
      { id: 'B', text: "Deploying metrics-server with audit mode enabled." },
      { id: 'C', text: "Turning on the NodeRestriction admission plugin." },
      { id: 'D', text: "Setting audit: true on each namespace." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The kubelet injects a hosts file entry for every Service." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A second regular container listed before the application container." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "etcd is out of disk space." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The Node authorizer combined with the NodeRestriction admission plugin." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A single Endpoints object holding thousands of addresses caused large, frequently rewritten objects; slices shard the membership into smaller chunks that scale and update more cheaply." },
      { id: 'B', text: "EndpointSlices replace the need for kube-proxy." },
      { id: 'C', text: "EndpointSlices allow Services to span clusters automatically." },
      { id: 'D', text: "EndpointSlices add layer 7 routing that Endpoints lacked." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "etcd write latency is the bottleneck, so faster disks or reduced write churn on the control plane are the fix." },
      { id: 'C', text: "The scheduler is overloaded and should be scaled out." },
      { id: 'D', text: "kube-proxy is throttling API traffic." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "/etc/kubernetes/admin.conf" },
      { id: 'D', text: "/var/lib/kubelet/config.yaml, the KubeletConfiguration file the kubeadm-managed unit points at." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "hostPath exposes the node filesystem to the pod, is not portable across nodes, and is disallowed by the baseline and restricted Pod Security Standards." },
      { id: 'B', text: "hostPath volumes cannot be mounted read-write." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "externalTrafficPolicy: Local on an IPv6-only Service." },
      { id: 'B', text: "ipFamilyPolicy: SingleStack with ipFamilies listing both families." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "kubectl delete deployment web --cascade=foreground" },
      { id: 'C', text: "kubectl scale deployment web --replicas=0 then delete it" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "docker ps and docker logs, which always work with containerd." },
      { id: 'D', text: "kubeadm inspect containers." }
    ],
    correctAnswers: ['B'],
    type: "single",
