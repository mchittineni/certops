export const K8S_CKA_QUESTIONS_6 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set readOnlyRootFilesystem: false only for that container." },
      { id: 'B', text: "Run the container as root so it can write anywhere." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Add a toleration for node-role.kubernetes.io/control-plane with effect NoSchedule to the DaemonSet pod template." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A projected volume with a serviceAccountToken source specifying audience and expirationSeconds." },
      { id: 'C', text: "The automountServiceAccountToken field set to true." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "nslookup api.web.svc.cluster.local from the workstation" },
      { id: 'C', text: "kubectl run tmp --rm -it --image=busybox --restart=Never -- nslookup api.web.svc.cluster.local" },
      { id: 'D', text: "kubectl describe configmap coredns -n kube-system" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "progressDeadlineSeconds: 60" },
      { id: 'D', text: "activeDeadlineSeconds: 60" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A VolumeSnapshotClass, a VolumeSnapshot referencing the source PVC, and a new PVC with dataSource pointing at the snapshot." },
      ...
      { id: 'D', text: "A CronJob running tar against the mounted volume." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "create cannot read YAML files." },
      { id: 'D', text: "apply bypasses admission control, so it is faster." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Neither; the pod must reference the PersistentVolume directly." },
      { id: 'D', text: "The claim in namespace app, because PVCs are namespaced and a pod can only reference one in its own namespace." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Create a NetworkPolicy allowing egress to the database." },
      { id: 'D', text: "Create a headless Service with a podSelector for the database." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "The Service selector for the deployment." },
      { id: 'D', text: "The CNI plugin configuration." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubeadm init phase kubeconfig all, which runs one phase of the init workflow in isolation." },
      { id: 'B', text: "kubeadm join --control-plane --skip-phases=all" },
      { id: 'C', text: "kubectl config regenerate" },
      { id: 'D', text: "kubeadm reset --kubeconfig-only" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set immutable: true, which stops the kubelet watching for changes; the object can then only be replaced, not updated." },
      { id: 'B', text: "Set immutable: true, which encrypts the data at rest." },
      { id: 'C', text: "Add the annotation kubernetes.io/no-watch: \"true\"." },
      { id: 'D', text: "Convert the ConfigMaps to Secrets, which are not watched." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "kubectl get componentstatuses, which is the current recommended API." }
    ],
    correctAnswers: ['B', 'C'],
    type: "multiple",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "The Job retries with exponential backoff and is marked Failed after the retry budget is exhausted." },
      { id: 'D', text: "The Job retries forever until manually deleted." }
    ],
    correctAnswers: ['C'],
    type: "single",
