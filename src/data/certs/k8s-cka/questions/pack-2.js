export const K8S_CKA_QUESTIONS_2 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A ClusterRole with pods/list plus a ClusterRoleBinding to the ServiceAccount." },
      { id: 'C', text: "A Role with pods/list plus a ClusterRoleBinding to the ServiceAccount." },
      { id: 'D', text: "A ClusterRole with pods/list plus a RoleBinding in the build namespace." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Upgrade the kubeadm binary, run kubeadm upgrade plan and apply, then drain the node and upgrade kubelet and kubectl, then uncordon." },
