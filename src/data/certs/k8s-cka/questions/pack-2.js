export const K8S_CKA_QUESTIONS_2 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "/var/lib/kubelet/pods" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "podSelector matching every app label, with an ingress rule allowing 0.0.0.0/0." },
      { id: 'B', text: "podSelector: {} with policyTypes: [Ingress] and no ingress rules." },
      { id: 'C', text: "namespaceSelector: {} with policyTypes: [Ingress] and no ingress rules." },
      { id: 'D', text: "podSelector: {} with policyTypes: [Ingress, Egress] and no rules." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "kubectl rollout pause deployment/api" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CoreDNS has not created a record for the Service." },
      { id: 'B', text: "kube-proxy is running in iptables mode instead of IPVS." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Pod C, because it is BestEffort." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "svc.cache.data.cluster.local" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "kubectl get pods -n api -o wide" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The liveness probe failed and the kubelet restarted the container." },
      { id: 'C', text: "The image entrypoint exited normally after finishing its work." },
      { id: 'D', text: "The node ran out of disk and the kubelet evicted the pod." }
    ],
    correctAnswers: ['A'],
    type: "single",
