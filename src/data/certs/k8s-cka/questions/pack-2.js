export const K8S_CKA_QUESTIONS_2 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "/etc/systemd/system/kubelet.service.d" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Restart kube-apiserver on the control plane node." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "podSelector matching every app label, with an ingress rule allowing 0.0.0.0/0." },
      { id: 'C', text: "namespaceSelector: {} with policyTypes: [Ingress] and no ingress rules." },
      { id: 'D', text: "podSelector: {} with policyTypes: [Ingress] and no ingress rules." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "kubectl delete node node01" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "ETCDCTL_API=3 etcdctl snapshot restore /opt/snap.db" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A Service with clusterIP: None referenced as the StatefulSet serviceName." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "kubectl rollout restart deployment/api" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The Service is missing a NodePort assignment." },
      { id: 'C', text: "kube-proxy is running in iptables mode instead of IPVS." },
      { id: 'D', text: "CoreDNS has not created a record for the Service." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Pod A, because Guaranteed pods hold the most reserved memory." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "cache.web.svc.cluster.local" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Delete the API server pod with kubectl so the kubelet re-creates it." },
      { id: 'C', text: "Inspect the container runtime directly with crictl ps -a and crictl logs, plus the kubelet journal." },
      { id: 'D', text: "Run kubectl logs -n kube-system kube-apiserver-cp01." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "ResourceQuota limits on a namespace." },
      { id: 'D', text: "Node affinity rules on the pod spec." }
    ],
    correctAnswers: ['B', 'D'],
    type: "multiple",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "kubectl logs -n api --all-containers" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A ResourceQuota limiting pods to five." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "The liveness probe failed and the kubelet restarted the container." },
      { id: 'D', text: "The image entrypoint exited normally after finishing its work." }
    ],
    correctAnswers: ['B'],
    type: "single",
