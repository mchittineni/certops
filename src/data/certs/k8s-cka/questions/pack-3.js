export const K8S_CKA_QUESTIONS_3 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Check the CoreDNS pod logs and events, plus the kube-dns Service endpoints in kube-system." },
      { id: 'D', text: "Edit /etc/resolv.conf inside each application pod." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "kubectl edit replicaset web" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The PVC must be deleted and recreated with the larger size." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "kubectl auth reconcile -f role.yaml" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "kubectl get all -A --show-labels" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A readiness probe on the health endpoint, plus a liveness probe with an initialDelaySeconds or startupProbe long enough to cover warm-up." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "All pod networking stops immediately, including pod IP traffic." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "reclaimPolicy: Retain" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Add a toleration for node-role.kubernetes.io/control-plane." }
    ],
    correctAnswers: ['A', 'B'],
    type: "multiple",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "completions: 12 and parallelism: 4" },
      { id: 'C', text: "backoffLimit: 12 and parallelism: 4" },
      { id: 'D', text: "completions: 12 and backoffLimit: 4" }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "completions is the number of successful pod runs required and parallelism caps how many run at once, so twelve and four express the requirement directly. Option B inverts the two, and backoffLimit only counts retries before the Job is marked failed.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Gateway API, where a GatewayClass and Gateway are operator-owned and HTTPRoutes are application-owned." },
      { id: 'C', text: "A single Ingress object per cluster shared by all teams." },
      { id: 'D', text: "A NetworkPolicy per route with L7 path selectors." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A nodeSelector on topology.kubernetes.io/zone." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl expose deployment api --port=80 --target-port=8080" },
      { id: 'B', text: "kubectl port-forward deployment/api 80:8080" },
      { id: 'C', text: "kubectl create ingress api --rule=\"/=api:8080\"" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run kubectl apply -f on the manifest from the control plane node." },
      { id: 'B', text: "Confirm the kubelet staticPodPath in its config file and read journalctl -u kubelet for parse errors." },
      { id: 'C', text: "Verify that a Deployment owns the static pod." },
      { id: 'D', text: "Check the scheduler logs for a placement failure." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Remove the finalizer from the PersistentVolumeClaim." },
      { id: 'C', text: "Restart kube-proxy on the surviving nodes." },
      { id: 'D', text: "Delete the PersistentVolume so a new one is provisioned." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A spec.tls entry listing the host shop.example.com and secretName shop-tls." },
      { id: 'B', text: "A ConfigMap referencing the certificate path." },
      { id: 'C', text: "An annotation naming the Secret on the backend Service." },
      { id: 'D', text: "A volume mount of the Secret into the ingress controller pod." }
    ],
    correctAnswers: ['A'],
    type: "single",
