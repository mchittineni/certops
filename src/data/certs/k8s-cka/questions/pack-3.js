export const K8S_CKA_QUESTIONS_3 = [
  {
    ...
    options: [
      { id: 'A', text: "kubeadm token create --print-join-command" },
      { id: 'B', text: "kubeadm init phase upload-certs" },
      { id: 'C', text: "kubectl create token default -n kube-system" },
      { id: 'D', text: "kubeadm reset on the control plane node" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The PersistentVolume capacity must be edited directly; PVCs are immutable." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "An ingress rule with from: [{ podSelector: { matchLabels: { team: payments } } }]." },
      { id: 'D', text: "An ingress rule with ipBlock cidr set to the payments pod CIDR." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl apply -f csr.yaml a second time" },
      { id: 'B', text: "kubectl certificate approve dev-user" },
      { id: 'C', text: "kubectl auth reconcile -f role.yaml" },
      { id: 'D', text: "kubeadm certs renew all" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "volumeBindingMode: WaitForFirstConsumer" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Add a node with enough allocatable CPU." },
      { id: 'B', text: "Remove the CPU limit while leaving the request at 4." },
      { id: 'C', text: "Lower the CPU request to a value a node can satisfy." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Verify that a Deployment owns the static pod." },
      { id: 'C', text: "Check the scheduler logs for a placement failure." },
      { id: 'D', text: "Confirm the kubelet staticPodPath in its config file and read journalctl -u kubelet for parse errors." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A separate Job with the same labels as the pod." },
      { id: 'C', text: "A postStart lifecycle hook on the application container." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A spec.tls entry listing the host shop.example.com and secretName shop-tls." },
      { id: 'C', text: "An annotation naming the Secret on the backend Service." },
      { id: 'D', text: "A ConfigMap referencing the certificate path." }
    ],
    correctAnswers: ['B'],
    type: "single",
