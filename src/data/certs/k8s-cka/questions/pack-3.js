export const K8S_CKA_QUESTIONS_3 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl autoscale deployment/web --max=10" },
      { id: 'B', text: "kubectl set image deployment/web web=web:10" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl describe events -A" },
      { id: 'B', text: "kubectl get events -A --sort-by=.lastTimestamp" },
      { id: 'C', text: "kubectl get all -A --show-labels" },
      { id: 'D', text: "kubectl logs -n kube-system --all-containers --since=5m" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Pod-to-pod traffic by pod IP keeps working, but new ClusterIP Service routing on that node is no longer programmed." },
      { id: 'B', text: "The node is marked NotReady within seconds." },
      { id: 'C', text: "DNS keeps working but pods lose their IP addresses." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A NetworkPolicy per route with L7 path selectors." },
      { id: 'B', text: "A single Ingress object per cluster shared by all teams." },
      { id: 'C', text: "One LoadBalancer Service per application team." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "persistentVolumeClaim" },
      { id: 'B', text: "hostPath" },
      { id: 'C', text: "configMap" },
      { id: 'D', text: "emptyDir" }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl port-forward deployment/api 80:8080" },
      { id: 'B', text: "kubectl set port deployment/api 80" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Delete the Node object for the crashed node so the attach-detach controller can force-detach the volume." },
      { id: 'D', text: "Restart kube-proxy on the surviving nodes." }
    ],
    correctAnswers: ['C'],
    type: "single",
