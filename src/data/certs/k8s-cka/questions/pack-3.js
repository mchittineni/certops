export const K8S_CKA_QUESTIONS_3 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "kubectl create token default -n kube-system" },
      { id: 'C', text: "kubeadm reset on the control plane node" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "kubeadm certs renew all" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "reclaimPolicy: Retain" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Lower the CPU request to a value a node can satisfy." }
    ],
    correctAnswers: ['A', 'D'],
    type: "multiple",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "kubectl port-forward deployment/api 80:8080" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "PriorityClass" },
      { id: 'D', text: "PodDisruptionBudget" }
    ],
    correctAnswers: ['A'],
    type: "single",
