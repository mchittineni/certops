...
export default {
  ...
  "blueprintSource": "https://training.linuxfoundation.org/certification/certified-kubernetes-application-developer-ckad/",
  "blueprintVerified": true,
  "domains": [
    { "id": "d1", "name": "Application Design and Build", "weight": 20 },
    { "id": "d2", "name": "Application Deployment", "weight": 20 },
    { "id": "d3", "name": "Application Observability and Maintenance", "weight": 15 },
    { "id": "d4", "name": "Application Environment, Configuration and Security", "weight": 25 },
    { "id": "d5", "name": "Services and Networking", "weight": 20 }
  ]
};
