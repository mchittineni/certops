export const K8S_CKAD_QUESTIONS_7 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "volumeBindingMode: Delayed" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "dynamicResize: true" },
      { id: 'C', text: "reclaimPolicy: Resize" },
      { id: 'D', text: "volumeResizeMode: Online" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "emptyDir volume with copy script" },
      { id: 'B', text: "configMap volume alone" },
      { id: 'C', text: "projected volume" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "securityContext: { allowExecution: true }" },
      { id: 'B', text: "defaultMode: 0755 (or 493 in decimal)" },
      { id: 'C', text: "mode: executable" },
      { id: 'D', text: "runAsUser: 0" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "nonResourceURLs: ['/metrics'] with verbs: ['get']" },
      { id: 'B', text: "resources: ['metrics']" },
      { id: 'C', text: "apiGroups: ['metrics.k8s.io']" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "matchNames: ['database-creds']" },
      { id: 'B', text: "resourceNames: ['database-creds']" },
      { id: 'C', text: "objectFilter: database-creds" },
      { id: 'D', text: "resources: ['secrets/database-creds']" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "spec.nodeSelector: { disktype: ssd }" },
      { id: 'B', text: "spec.nodeName: ssd" },
      { id: 'C', text: "spec.affinity.nodeAffinity alone" },
      { id: 'D', text: "spec.tolerations: { disktype: ssd }" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "nodeSelector soft preference" },
      { id: 'C', text: "requiredDuringSchedulingRequiredDuringExecution" },
      { id: 'D', text: "preferredDuringSchedulingIgnoredDuringExecution" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "effect: NoExecute (which immediately evicts existing pods)" },
      { id: 'C', text: "effect: PreferNoSchedule" },
      { id: 'D', text: "effect: Drain" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "spec.hostName: worker-node-03" },
      { id: 'C', text: "spec.nodeSelector: { name: worker-node-03 }" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "security.k8s.io/mode: enforce" },
      { id: 'D', text: "pod-security.kubernetes.io/warn: restricted" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl configmap create app-config -l DB_HOST=db.internal.net" },
      { id: 'B', text: "kubectl apply configmap app-config --data DB_HOST=db.internal.net" },
      { id: 'C', text: "kubectl create configmap app-config --set DB_HOST=db.internal.net,DB_PORT=5432" },
      { id: 'D', text: "kubectl create configmap app-config --from-literal=DB_HOST=db.internal.net --from-literal=DB_PORT=5432" }
    ],
    correctAnswers: ['D'],
    type: "single",
