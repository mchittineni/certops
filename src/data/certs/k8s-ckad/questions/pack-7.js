export const K8S_CKAD_QUESTIONS_7 = [
  {
    ...
    options: [
      { id: 'A', text: "A dynamic StorageClass" },
      { id: 'B', text: "ResourceQuota" },
      { id: 'C', text: "LimitRange" },
      { id: 'D', text: "Static Volume Binding" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "dynamicResize: true" },
      { id: 'B', text: "volumeResizeMode: Online" },
      { id: 'C', text: "reclaimPolicy: Resize" },
      { id: 'D', text: "allowVolumeExpansion: true" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Base64 is encoding, not encryption; anyone can decode it" },
      { id: 'B', text: "Base64 is an irreversible AES-256 hash" },
      { id: 'C', text: "Secrets are encrypted with hardware HSMs automatically in all clusters" },
      { id: 'D', text: "Base64 requires a private decryption key" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "defaultMode: 0755 (or 493 in decimal)" },
      { id: 'B', text: "mode: executable" },
      { id: 'C', text: "capabilities: { drop: ['ALL'] } with runAsUser: 0" },
      { id: 'D', text: "securityContext: { allowExecution: true }" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Kubernetes automatically changes the user to UID 1000" },
      { id: 'B', text: "The node reboots" },
      { id: 'C', text: "The container runs normally as root" },
      { id: 'D', text: "It fails with CreateContainerConfigError" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "They expire hourly and are bound to that pod" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Mounted volumes update in minutes; env vars need a restart" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "subPath mounts do not receive updates" },
      { id: 'B', text: "The kubelet has crashed" },
      { id: 'C', text: "ConfigMaps can only be updated once per month" },
      { id: 'D', text: "The file is read-only" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "nonResourceURLs: ['/metrics'] with resources: ['*']" },
      { id: 'B', text: "nonResourceURLs: ['/metrics'] with verbs: ['get']" },
      { id: 'C', text: "resources: ['/metrics'] with verbs: ['get']" },
      { id: 'D', text: "apiGroups: ['metrics.k8s.io'] with verbs: ['get']" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "resourceNames: ['database-creds']" },
      { id: 'B', text: "resources: ['secrets/database-creds']" },
      { id: 'C', text: "matchNames: ['database-creds']" },
      { id: 'D', text: "objectFilter: database-creds" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "spec.nodeName: ssd" },
      { id: 'B', text: "spec.tolerations: { disktype: ssd }" },
      { id: 'C', text: "spec.affinity.nodeAffinity alone" },
      { id: 'D', text: "spec.nodeSelector: { disktype: ssd }" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "DaemonSet" },
      { id: 'C', text: "podAntiAffinity by hostname" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "nodeSelector alone" },
      { id: 'B', text: "podAffinity with maxPods: 2" },
      { id: 'C', text: "ClusterAutoscaler zone balance flag" },
      { id: 'D', text: "topologySpreadConstraints by zone" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "effect: Drain" },
      { id: 'C', text: "effect: NoExecute (which immediately evicts existing pods)" },
      { id: 'D', text: "effect: PreferNoSchedule" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A 300-second unreachable toleration" },
      { id: 'B', text: "activeDeadlineSeconds: 300" },
      { id: 'C', text: "terminationGracePeriodSeconds: 300" },
      { id: 'D', text: "retryAfter: 300" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A PriorityClass" },
      { id: 'B', text: "ResourceQuota" },
      { id: 'C', text: "LimitRange" },
      { id: 'D', text: "QoS Guaranteed class alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "By systemd daemons running outside containers" },
      { id: 'B', text: "As static pods read by the kubelet" },
      { id: 'C', text: "By Docker Compose" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It exposes host namespaces to the container" },
      { id: 'B', text: "It slows down network throughput by 50%" },
      { id: 'C', text: "It forces the pod to run on master nodes only" },
      { id: 'D', text: "Kubernetes does not support host namespaces" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "kubectl create configmap app-config --from-env-file=DB_HOST=db.internal.net,DB_PORT=5432" },
      { id: 'C', text: "kubectl create configmap app-config --data DB_HOST=db.internal.net --data DB_PORT=5432" },
      { id: 'D', text: "kubectl create configmap app-config --from-literal='DB_HOST=db.internal.net DB_PORT=5432'" }
    ],
    correctAnswers: ['A'],
    type: "single",
