export const K8S_CKAD_QUESTIONS_3 = [
  {
    ...
    options: [
      { id: 'A', text: "strategy: Recreate" },
      { id: 'B', text: "maxUnavailable: 0 and maxSurge: 3" },
      { id: 'C', text: "maxUnavailable: 1 and maxSurge: 1" },
      { id: 'D', text: "maxUnavailable: 3 and maxSurge: 0" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "strategy: { type: Recreate }" },
      { id: 'B', text: "strategy: { type: RollingUpdate }" },
      { id: 'C', text: "strategy: { type: BlueGreen }" },
      { id: 'D', text: "strategy: { type: Canary }" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl rollout status deployment/&lt;name&gt;" },
      { id: 'B', text: "kubectl delete deployment/&lt;name&gt;" },
      { id: 'C', text: "kubectl rollout undo deployment/&lt;name&gt;" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl rollout pause, apply, then rollout resume" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "maxReplicaSets: 5" },
      { id: 'B', text: "historyLimit: 5" },
      { id: 'C', text: "revisionHistoryLimit: 5" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A headless Service with clusterIP: None" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Recreate (kills all pods across all nodes at once)" },
      { id: 'B', text: "OnDelete (waits until the administrator manually kills the old pod on each node)" },
      { id: 'C', text: "DaemonSets cannot be updated once created" },
      { id: 'D', text: "RollingUpdate (default, terminates and replaces DaemonSet pods one node at a time)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Restart the CoreDNS pods" },
      { id: 'B', text: "Switch the Service selector to v2" },
      { id: 'C', text: "Delete the v1 Deployment" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run a shell script on the node that drops 90% of packets" },
      { id: 'B', text: "Two deployments at 9 and 1 replicas behind one selector" },
      { id: 'C', text: "Deploy two Services with different IP addresses" },
      { id: 'D', text: "Configure weight: 10% in the Service manifest" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A HorizontalPodAutoscaler" },
      { id: 'B', text: "VerticalPodAutoscaler" },
      { id: 'C', text: "ClusterAutoscaler" },
      { id: 'D', text: "NodeAutoProvisioner" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The pod lacks a readiness probe" },
      { id: 'B', text: "The container specification lacks resources.limits.cpu" },
      { id: 'C', text: "The container specification lacks resources.requests.cpu" },
      { id: 'D', text: "The container is running as root" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "minReplicas: 10" },
      { id: 'C', text: "cooldownPeriod: 300s" },
      { id: 'D', text: "behavior.scaleUp.stabilizationWindowSeconds: 300" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It deletes the namespace" },
      { id: 'B', text: "It hashes the ConfigMap name, so the pod template changes" },
      { id: 'C', text: "It modifies etcd directly to force a restart" },
      { id: 'D', text: "It executes kubectl exec in all pods to restart the process" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Strategic Merge Patch" },
      { id: 'B', text: "ConfigMapGenerator" },
      { id: 'C', text: "A JSON 6902 patch" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "helm install my-app ./chart --force" },
      { id: 'B', text: "helm apply my-app" },
      { id: 'C', text: "helm upgrade my-app ./chart -f values.yaml" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "helm revert payment-service 2" },
      { id: 'B', text: "helm rollback payment-service 2" },
      { id: 'C', text: "helm upgrade payment-service --revision=2" },
      { id: 'D', text: "helm undo payment-service --revision=2" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "minAvailable: 4 (or maxUnavailable: 1)" },
      { id: 'B', text: "maxUnavailable: 4, or minAvailable: 1" },
      { id: 'C', text: "minAvailable: 5 and maxUnavailable: 0" },
      { id: 'D', text: "maxUnavailable: 1 for each of the 5 pods" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl rollout status deployment/&lt;name&gt; --timeout=300s" },
      { id: 'B', text: "kubectl get deployment/&lt;name&gt; -w --output-watch-events" },
      { id: 'C', text: "kubectl wait deployment/&lt;name&gt; --for=condition=Available" },
      { id: 'D', text: "kubectl rollout history deployment/&lt;name&gt; --revision=0" }
    ],
    correctAnswers: ['A'],
    type: "single",
