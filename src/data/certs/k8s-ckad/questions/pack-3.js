export const K8S_CKAD_QUESTIONS_3 = [
  {
    ...
    options: [
      { id: 'A', text: "maxUnavailable: 0 and maxSurge: 3" },
      { id: 'B', text: "maxUnavailable: 3 and maxSurge: 0" },
      { id: 'C', text: "maxUnavailable: 1 and maxSurge: 1" },
      { id: 'D', text: "strategy: Recreate" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "strategy: { type: Canary }" },
      { id: 'B', text: "strategy: { type: Recreate }" },
      { id: 'C', text: "strategy: { type: RollingUpdate }" },
      { id: 'D', text: "strategy: { type: BlueGreen }" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "kubectl rollout restart deployment/&lt;name&gt;" },
      { id: 'D', text: "kubectl rollout status deployment/&lt;name&gt;" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "revisionHistoryLimit: 5" },
      { id: 'B', text: "maxReplicaSets: 5" },
      { id: 'C', text: "historyLimit: 5" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "volumes in the pod spec" },
      { id: 'B', text: "volumeClaimTemplates" },
      { id: 'C', text: "persistentVolumeClaim volumeSource" },
      { id: 'D', text: "emptyDir volumes" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "parallelism: true" },
      { id: 'C', text: "strategy: Concurrent" },
      { id: 'D', text: "podManagementPolicy: OrderedReady" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "RollingUpdate (default, terminates and replaces DaemonSet pods one node at a time)" },
      { id: 'B', text: "OnDelete (waits until the administrator manually kills the old pod on each node)" },
      { id: 'C', text: "Recreate (kills all pods across all nodes at once)" },
      { id: 'D', text: "DaemonSets cannot be updated once created" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The container specification lacks resources.requests.cpu" },
      { id: 'B', text: "The container specification lacks resources.limits.cpu" },
      { id: 'C', text: "The container is running as root" },
      { id: 'D', text: "The pod lacks a readiness probe" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "behavior.scaleUp.stabilizationWindowSeconds: 300" },
      { id: 'C', text: "minReplicas: 10" },
      { id: 'D', text: "cooldownPeriod: 300s" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "updateMode: Recreate" },
      { id: 'B', text: "updateMode: Auto" },
      { id: 'C', text: "updateMode: Off" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "helm upgrade my-app ./chart -f values.yaml" },
      { id: 'B', text: "helm install my-app ./chart --force" },
      { id: 'C', text: "helm apply my-app" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "--env tag=$COMMIT_SHA" },
      { id: 'B', text: "--override tag=$COMMIT_SHA" },
      { id: 'C', text: "--values $COMMIT_SHA" },
      { id: 'D', text: "--set image.tag=$COMMIT_SHA" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "helm get values payment-service" },
      { id: 'B', text: "helm status payment-service" },
      { id: 'C', text: "helm list --all" },
      { id: 'D', text: "helm history payment-service" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "helm rollback payment-service 2" },
      { id: 'B', text: "helm undo payment-service --revision=2" },
      { id: 'C', text: "helm upgrade payment-service --revision=2" },
      { id: 'D', text: "helm revert payment-service 2" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "minAvailable: 1" },
      { id: 'B', text: "parallelism: 4" },
      { id: 'C', text: "minAvailable: 4 (or maxUnavailable: 1)" },
      { id: 'D', text: "maxUnavailable: 4" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl describe deployment/&lt;name&gt;" },
      { id: 'B', text: "kubectl rollout check deployment/&lt;name&gt;" },
      { id: 'C', text: "kubectl rollout status deployment/&lt;name&gt; --timeout=300s" },
      { id: 'D', text: "kubectl get pods -w" }
    ],
    correctAnswers: ['C'],
    type: "single",
