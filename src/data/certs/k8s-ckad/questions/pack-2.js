export const K8S_CKAD_QUESTIONS_2 = [
  {
    ...
    options: [
      { id: 'A', text: "requests guide scheduling; limits are enforced by cgroups" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "OOM-killed for exceeding the memory limit" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CPU over-limit is throttled; memory over-limit is OOMKilled" },
      { id: 'B', text: "Containers exceeding CPU limits are terminated immediately" },
      { id: 'C', text: "Both CPU and memory overages trigger pod restarts" },
      { id: 'D', text: "Kubernetes ignores CPU limits completely" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Guaranteed" },
      { id: 'B', text: "Burstable" },
      { id: 'C', text: "BestEffort" },
      { id: 'D', text: "Critical" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "docker buildx build --platform linux/amd64,linux/arm64" },
      { id: 'B', text: "docker build -t app:latest --platform linux/arm64 ." },
      { id: 'C', text: "docker manifest create app:latest app:amd64 app:arm64" },
      { id: 'D', text: "docker build with QEMU emulation configured for each target" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "RUN npm install followed by COPY package*.json ./ and then COPY . ." },
      { id: 'B', text: "COPY . . followed by RUN npm install --prefer-offline --no-audit" },
      { id: 'C', text: "COPY package*.json ./ followed by COPY . . and then RUN npm install" },
      { id: 'D', text: "COPY package*.json ./ followed by RUN npm install, and then COPY . ." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Trivy (or Grype / Clair)" },
      { id: 'B', text: "kubectl lint" },
      { id: 'C', text: "Helm verify" },
      { id: 'D', text: "Kustomize build" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Jobs run to completion; restartPolicy must be OnFailure or Never" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The app container never starts; init container 2 is restarted" },
      { id: 'B', text: "Init Container 2 is skipped and the main container starts immediately" },
      { id: 'C', text: "The pod is permanently deleted from the cluster" },
      { id: 'D', text: "Init Container 1 is re-executed simultaneously" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "securityContext: { privileged: true }" },
      { id: 'B', text: "securityContext: { runAsGroup: 2000 }" },
      { id: 'C', text: "securityContext: { runAsUser: 2000 }" },
      { id: 'D', text: "securityContext: { fsGroup: 2000 } alone" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "fsGroup: 3000" },
      { id: 'B', text: "runAsGroup: 3000" },
      { id: 'C', text: "runAsUser: 3000" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "envFrom: [ configMapRef: { name: my-config } ]" },
      { id: 'B', text: "env: [ name: ALL, valueFrom: configMapRef ]" },
      { id: 'C', text: "volumeMounts: [ configMap ]" },
      { id: 'D', text: "configMapEnv: true" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "imagePullSecrets on the pod spec" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "imagePullPolicy: IfNotPresent" },
      { id: 'B', text: "imagePullPolicy: Never" },
      { id: 'C', text: "imagePullPolicy: Always" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "paused: true" },
      { id: 'B', text: "active: false" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "terminationMessagePolicy: FallbackToLogsOnError on the container" },
      { id: 'C', text: "terminationLogPath: /var/log/termination on the container" },
      { id: 'D', text: "lifecycle.preStop writing to /dev/termination-log" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "CAP_NET_BIND_SERVICE" },
      { id: 'D', text: "CAP_KILL" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "successfulJobsHistoryLimit: 3 and backoffLimit: 1" },
      { id: 'C', text: "completions: 3 and failedJobsHistoryLimit: 1" },
      { id: 'D', text: "jobHistoryLimit: { successful: 3, failed: 1 }" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "seccomp: { enabled: true }" },
      { id: 'B', text: "seccompProfile: { type: RuntimeDefault }" },
      { id: 'C', text: "seccompProfile: { type: Unconfined }" },
