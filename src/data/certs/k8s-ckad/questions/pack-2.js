export const K8S_CKAD_QUESTIONS_2 = [
  {
    ...
    options: [
      { id: 'A', text: "requests are used by the kube-scheduler to find a suitable node; limits enforce hard ceilings via cgroups on the node" },
      ...
      { id: 'D', text: "There is no difference between requests and limits" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The container process exceeded its memory limit and was terminated by the Linux kernel Out-Of-Memory (OOM) killer (128 + SIGKILL 9 = 137)" },
      { id: 'B', text: "The container CPU quota was exceeded" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Containers exceeding CPU limits are terminated immediately" },
      { id: 'B', text: "Containers exceeding CPU limits are throttled by the CFS scheduler without crashing; containers exceeding memory limits are killed (OOMKilled)" },
      { id: 'C', text: "Kubernetes ignores CPU limits completely" },
      { id: 'D', text: "Both CPU and memory overages trigger pod restarts" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Critical" },
      { id: 'B', text: "BestEffort" },
      { id: 'C', text: "Burstable" },
      { id: 'D', text: "Guaranteed" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "ConfigMaps" },
      { id: 'C', text: "Secrets" },
      { id: 'D', text: "Downward Volumes alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "resourceFieldRef (e.g. containerName: app, resource: limits.memory)" },
      { id: 'B', text: "fieldRef.fieldPath" },
      { id: 'C', text: "configMapKeyRef" },
      { id: 'D', text: "secretKeyRef" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "docker buildx build --platform linux/amd64,linux/arm64" },
      { id: 'D', text: "docker build -t app:latest ." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Docker does not support layer caching" },
      { id: 'B', text: "COPY package*.json ./ followed by RUN npm install, and then COPY . ." },
      { id: 'C', text: "COPY . . followed by RUN npm install --cache" },
      { id: 'D', text: "RUN npm install followed by COPY package*.json" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl lint" },
      { id: 'B', text: "Trivy (or Grype / Clair)" },
      { id: 'C', text: "Kustomize build" },
      { id: 'D', text: "Helm verify" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Jobs represent batch tasks intended to run to completion; restartPolicy must be either OnFailure or Never" },
      { id: 'B', text: "Jobs only support restartPolicy: Always" },
      { id: 'C', text: "restartPolicy is only valid for DaemonSets" },
      { id: 'D', text: "The API server requires a paid enterprise license for restartPolicy" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Init Container 2 is skipped and the main container starts immediately" },
      { id: 'B', text: "The main application container is never started; Kubernetes restarts Init Container 2 according to the pod's restartPolicy" },
      { id: 'C', text: "Init Container 1 is re-executed simultaneously" },
      { id: 'D', text: "The pod is permanently deleted from the cluster" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Connect to localhost:3000 (127.0.0.1:3000)" },
      { id: 'B', text: "Connect to the pod's public DNS domain name" },
      { id: 'C', text: "Connect to the node's physical IP address" },
      { id: 'D', text: "Multi-container pods cannot communicate over TCP" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Kubernetes automatically reassigns NGINX to port 8080" },
      { id: 'C', text: "Both containers share port 80 using round-robin DNS" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "securityContext: { fsGroup: 2000 } alone" },
      { id: 'B', text: "securityContext: { privileged: true }" },
      { id: 'C', text: "securityContext: { runAsUser: 2000 }" },
      { id: 'D', text: "securityContext: { runAsGroup: 2000 }" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "runAsUser: 3000" },
      { id: 'B', text: "allowPrivilegeEscalation: false" },
      { id: 'C', text: "fsGroup: 3000" },
      { id: 'D', text: "runAsGroup: 3000" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "configMapEnv: true" },
      { id: 'B', text: "volumeMounts: [ configMap ]" },
      { id: 'C', text: "env: [ name: ALL, valueFrom: configMapRef ]" },
      { id: 'D', text: "envFrom: [ configMapRef: { name: my-config } ]" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "command overrides Docker ENTRYPOINT; args overrides Docker CMD" },
      { id: 'B', text: "command overrides Docker CMD; args overrides Docker ENTRYPOINT" },
      { id: 'C', text: "command and args append to Docker CMD without overriding" },
      { id: 'D', text: "command executes in host OS; args executes in container" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "imagePullSecrets: [ name: ghcr-secret ] in the Pod specification (or attached to the ServiceAccount)" },
      { id: 'B', text: "secrets: [ name: ghcr-secret ]" },
      { id: 'C', text: "dockerAuth: [ name: ghcr-secret ]" },
      { id: 'D', text: "env: [ DOCKER_AUTH ]" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "imagePullPolicy: Never" },
      { id: 'B', text: "imagePullPolicy: Always" },
      { id: 'C', text: "imagePullPolicy: IfNotPresent" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl describe pod &lt;pod-name&gt;" },
      { id: 'B', text: "kubectl logs &lt;pod-name&gt; alone" },
      { id: 'C', text: "kubectl get pod &lt;pod-name&gt; -o wide" },
      { id: 'D', text: "kubectl top pod &lt;pod-name&gt;" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "active: false" },
      { id: 'B', text: "suspend: true" },
      { id: 'C', text: "replicas: 0" },
      { id: 'D', text: "paused: true" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "exitMessagePath: /tmp/exit" },
      { id: 'D', text: "stderrCapture: true" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "successfulJobsHistoryLimit: 3 and failedJobsHistoryLimit: 1" },
      { id: 'B', text: "completions: 3 and backoffLimit: 1" },
      { id: 'C', text: "historyLimit: 3 and purgeFailed: 1" },
      { id: 'D', text: "retention: { success: 3, failed: 1 }" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "seccomp: { enabled: true }" },
      { id: 'C', text: "seccompProfile: { type: RuntimeDefault }" },
