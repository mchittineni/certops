export const K8S_CKAD_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "pod-2 shuts down first, then pod-1" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "It reverts the cluster to the replica count Git declares" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Delete the pods one at a time" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It is rejected: spec.selector is immutable" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "helm lint ./chart to validate the chart structure only" },
      { id: 'D', text: "helm upgrade --install --atomic my-app ./chart" }
    ],
    correctAnswers: ['A'],
    type: "single",
