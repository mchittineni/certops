export const K8S_CKAD_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "pod-2 shuts down first, then pod-1" },
      { id: 'B', text: "pod-0 is terminated first, followed by pod-1" },
      { id: 'C', text: "All pods are terminated simultaneously" },
      { id: 'D', text: "Pods are terminated in random order" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "persistentVolumeClaimRetentionPolicy: { whenDeleted: Delete }" },
      { id: 'B', text: "persistentVolumeClaimRetentionPolicy: { whenScaled: Delete }" },
      { id: 'C', text: "volumeClaimTemplates[].spec.persistentVolumeReclaimPolicy: Delete" },
      { id: 'D', text: "volumeClaimTemplates[].metadata.ownerReferences on the StatefulSet" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "spec.selector.matchLabels: { hardware: gpu } on the DaemonSet itself" },
      { id: 'C', text: "spec.template.spec.tolerations for a hardware=gpu node taint" },
      { id: 'D', text: "spec.template.spec.topologySpreadConstraints on hardware" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A toleration matching the control plane taint" },
      { id: 'B', text: "nodeSelector: { master: true }" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl rollout undo deployment/&lt;name&gt;" },
      { id: 'B', text: "kubectl rollout restart deployment/&lt;name&gt;" },
      { id: 'C', text: "kubectl scale deployment/&lt;name&gt; --replicas=0" },
      { id: 'D', text: "kubectl delete pods --all" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It reverts the cluster to the replica count Git declares" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "helm lint ./mychart and helm template ./mychart" },
      { id: 'B', text: "helm dry-run ./mychart and helm test ./mychart" },
      { id: 'C', text: "helm verify ./mychart and helm render ./mychart" },
      { id: 'D', text: "kubectl apply --validate ./mychart" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "labels: [{ pairs: { team: checkout, environment: prod } }]" },
      { id: 'C', text: "commonAnnotations: { team: checkout, environment: prod }" },
      { id: 'D', text: "patchesStrategicMerge setting metadata.labels in each base" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Within seconds, by switching the selector back" },
      { id: 'B', text: "Blue-Green deployments cannot be rolled back" },
      { id: 'C', text: "Requires restarting the Kubernetes API server" },
      { id: 'D', text: "It takes 30 minutes to rebuild containers" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Kustomize alone" },
      { id: 'C', text: "Helm alone" },
      { id: 'D', text: "kubectl apply alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Delete the pods one at a time" },
      { id: 'B', text: "Run kubectl rollout resume" },
      { id: 'C', text: "Scale replicas to 0 and back to 3" },
      { id: 'D', text: "OnDelete does not support image updates" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It adopts the existing pod" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "partition: 4" },
      { id: 'B', text: "canary: 1" },
      { id: 'C', text: "maxUnavailable: 1" },
      { id: 'D', text: "testOrdinal: 4" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The API server deletes all running pods" },
      { id: 'B', text: "The API server updates all existing pods to have the new label" },
      { id: 'C', text: "It is rejected: spec.selector is immutable" },
      { id: 'D', text: "The Deployment is converted to a ReplicaSet" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A CronJob" },
      { id: 'D', text: "Job with restartPolicy: Always" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "initialDelaySeconds: 15" },
      { id: 'B', text: "progressDeadlineSeconds: 15" },
      { id: 'C', text: "minReadySeconds: 15" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Sealed Secrets or External Secrets" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "helm lint ./chart to validate the chart structure only" },
      { id: 'B', text: "helm template my-app ./chart to render the manifests locally" },
      { id: 'C', text: "helm upgrade --install --atomic my-app ./chart" },
      { id: 'D', text: "helm install --dry-run --debug my-app ./chart" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Check spec.paused in the deployment YAML" },
