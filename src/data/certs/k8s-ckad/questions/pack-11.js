export const K8S_CKAD_QUESTIONS_11 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Run a separate CronJob that SSHs into the node every minute to copy logs." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Replace the legacy application with an entirely new codebase immediately." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure an `initContainers` block in the pod spec to run connectivity checks and migration scripts before the application container launches." },
      ...
      { id: 'D', text: "Manually start the application container after observing database startup." }
    ],
    correctAnswers: ['A'],
    type: "single",
