export const K8S_CKAD_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "30000 to 32767" },
      { id: 'B', text: "1024 to 5000" },
      { id: 'C', text: "8000 to 9000" },
      { id: 'D', text: "40000 to 50000" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "targetPort is the external load balancer port; port is the container port" },
      { id: 'B', text: "port is the container port; targetPort is the service port; nodePort is the host port" },
      { id: 'C', text: "All three ports must be identical in Kubernetes" },
      { id: 'D', text: "port is on the ClusterIP, targetPort on the container, nodePort on each node" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CoreDNS returns each ready pod IP directly" },
      { id: 'B', text: "CoreDNS returns HTTP 404" },
      { id: 'C', text: "CoreDNS returns the IP address of the node" },
      { id: 'D', text: "CoreDNS returns the master API server IP" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "externalTrafficPolicy: Cluster (default)" },
      { id: 'C', text: "internalTrafficPolicy: Local" },
      { id: 'D', text: "sourceIpPreserve: true" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "podSelector: { matchLabels: {} }, policyTypes: [Ingress], ingress: []" },
      { id: 'B', text: "podSelector: {}, policyTypes: [Ingress], with an empty ingress: [] list" },
      { id: 'C', text: "podSelector: {}, policyTypes: [Ingress], ingress: [{ from: [] }]" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "podSelector: { matchLabels: { role: db } }, ingress: [{ from: [{ podSelector: { matchLabels: { role: frontend } } }], ports: [{ protocol: TCP, port: 5432 }] }]" },
      { id: 'B', text: "podSelector: { matchLabels: { role: frontend } }, egress: [{ to: [{ podSelector: { matchLabels: { role: db } } }], ports: [{ protocol: TCP, port: 5432 }] }]" },
      { id: 'C', text: "podSelector: { matchLabels: { role: db } }, ingress: [{ from: [{ namespaceSelector: { matchLabels: { role: frontend } } }], ports: [{ protocol: TCP, port: 5432 }] }]" },
      { id: 'D', text: "podSelector: { matchLabels: { role: db } }, ingress: [{ from: [{ podSelector: { matchLabels: { role: frontend } } }], ports: [{ protocol: UDP, port: 5432 }] }]" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "from: [{ namespaceSelector: { matchLabels: { name: 'orders' } } }], ports: [{ port: 8080 }]" },
      { id: 'C', text: "from: [{ podSelector: { matchLabels: { 'kubernetes.io/metadata.name': 'orders' } } }]" },
      { id: 'D', text: "from: [{ namespaceSelector: { matchExpressions: [{ key: name, operator: Exists }] } }]" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In one list item: from: [{ namespaceSelector: { matchLabels: { env: prod } }, podSelector: { matchLabels: { role: api } } }]" },
      { id: 'B', text: "As two list items: from: [{ namespaceSelector: { matchLabels: { env: prod } } }, { podSelector: { matchLabels: { role: api } } }]" },
      { id: 'C', text: "With matchExpressions: from: [{ namespaceSelector: { matchExpressions: [{ key: env, operator: In, values: [prod] }] } }]" },
      { id: 'D', text: "With both labels on one selector: from: [{ podSelector: { matchLabels: { role: api, env: prod } } }]" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "pathType: Prefix" },
      { id: 'B', text: "pathType: Exact" },
      { id: 'C', text: "pathType: ImplementationSpecific" },
      { id: 'D', text: "pathType: Regex" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "All HTTP requests" },
      { id: 'B', text: "Both /orders and /orders/123" },
      { id: 'C', text: "Only /orders" },
      { id: 'D', text: "Any path starting with /order" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "spec.tls: [{ hosts: ['api.example.com'], secretName: example-tls-secret }]" },
      { id: 'B', text: "spec.certificates: [{ host: api.example.com, secret: example-tls-secret }]" },
      { id: 'C', text: "spec.ssl: { enabled: true, cert: example-tls-secret }" },
      { id: 'D', text: "spec.rules[].tlsSecret: example-tls-secret" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Two spec.rules entries, one per host" },
      { id: 'B', text: "Create two separate IngressClass resources" },
      { id: 'C', text: "Deploy two separate LoadBalancer services" },
      { id: 'D', text: "Host-based routing is not supported in Ingress" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Several paths under one host rule, each to its own service" },
      { id: 'B', text: "Create two separate Ingress resources with the same hostname" },
      { id: 'C', text: "Configure two LoadBalancer services" },
      { id: 'D', text: "Path routing requires modifying the Linux kernel on worker nodes" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The defaultBackend, or a 404" },
      { id: 'B', text: "It drops the packet silently" },
      { id: 'C', text: "It restarts all backend pods" },
      { id: 'D', text: "It routes the request to CoreDNS" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "database.svc.cluster.local" },
      { id: 'B', text: "database.frontend.svc.cluster.local" },
      { id: 'C', text: "database.backend.svc.cluster.local" },
