export const K8S_CKAD_QUESTIONS_1 = [
  {
    ...
    options: [
      { id: 'A', text: "Multi-stage builds with a separate builder stage" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Reference the image by digest" },
      { id: 'B', text: "Set imagePullPolicy to Always" },
      { id: 'C', text: "Set imagePullPolicy to Never" },
      { id: 'D', text: "Use the latest tag" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "completions: 4" },
      { id: 'B', text: "restartPolicy: OnFailure" },
      { id: 'C', text: "backoffLimit: 4" },
      { id: 'D', text: "activeDeadlineSeconds: 4" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "activeDeadlineSeconds: 1200" },
      { id: 'B', text: "backoffLimit: 1200" },
      { id: 'C', text: "ttlSecondsAfterFinished: 1200" },
      { id: 'D', text: "timeout: 1200s" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "cleanUpAfter: 300" },
      { id: 'B', text: "activeDeadlineSeconds: 300" },
      { id: 'C', text: "ttlSecondsAfterFinished: 300" },
      { id: 'D', text: "backoffLimit: 0" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Running the logging agent inside the application container using systemd" },
      { id: 'B', text: "Init container with hostPath volume" },
      { id: 'C', text: "Sidecar container sharing an emptyDir volume mounted at /var/log in both containers" },
      { id: 'D', text: "Deploying the logging agent as an independent ReplicaSet with persistent volumes" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Ambassador container pattern" },
      { id: 'B', text: "Adapter container pattern" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "ephemeralContainers" },
      { id: 'B', text: "sidecar containers" },
      { id: 'C', text: "readinessProbes alone" },
      { id: 'D', text: "initContainers" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An initContainer with restartPolicy: Always" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Ephemeral containers" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "capabilities: { drop: ['NET_ADMIN'], add: ['NET_RAW'] }" },
      { id: 'B', text: "capabilities: { add: ['NET_RAW'] } with privileged: true" },
      { id: 'C', text: "capabilities: { drop: ['ALL'] } with runAsUser: 0" },
      { id: 'D', text: "capabilities: { drop: ['ALL'], add: ['NET_RAW'] }" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "activeDeadlineSeconds: 90" },
      { id: 'B', text: "timeout: 90" },
      { id: 'C', text: "terminationGracePeriodSeconds: 90" },
