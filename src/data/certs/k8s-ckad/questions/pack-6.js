export const K8S_CKAD_QUESTIONS_6 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "kubectl attach pod/&lt;pod-name&gt; -p 5432" },
      { id: 'C', text: "kubectl exec -it &lt;pod-name&gt; -- nc" },
      { id: 'D', text: "kubectl proxy --port=5432" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "spec.startupProbe" },
      { id: 'B', text: "spec.readinessProbe.external" },
      { id: 'C', text: "spec.readinessGates" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "kubectl get pods --format=ip" },
      { id: 'C', text: "kubectl get pods -n default -o yaml" },
      { id: 'D', text: "kubectl describe pods | grep IP" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "kubectl get pods -o wide alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CoreDNS" },
      { id: 'B', text: "OpenTelemetry Collector (deployed as a DaemonSet or Sidecar)" },
      { id: 'C', text: "Fluentd standalone" },
      { id: 'D', text: "Metrics Server" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Pod Phase is a high-level summary of the pod lifecycle (Pending, Running, Succeeded, Failed); Container States track individual container lifecycles (Waiting, Running, Terminated)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Check the Docker daemon logs" },
      { id: 'B', text: "Inspect /etc/hosts on the node" },
      { id: 'C', text: "Run ping 8.8.8.8" },
      { id: 'D', text: "Run nslookup order-service (or dig order-service) inside the pod or a debug container" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Kubernetes sends SIGHUP, followed by SIGSTOP" },
      { id: 'B', text: "Kubernetes sends SIGTERM to the root process, waits for terminationGracePeriodSeconds, and sends SIGKILL if the process has not exited" },
      { id: 'C', text: "Kubernetes sends SIGKILL immediately" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "startupProbe: { periodSeconds: 200, failureThreshold: 1 }" },
      { id: 'B', text: "startupProbe: { httpGet: { path: /healthz, port: 8080 }, periodSeconds: 10, failureThreshold: 20 }" },
      { id: 'C', text: "readinessProbe with timeoutSeconds: 200" },
      { id: 'D', text: "livenessProbe with initialDelaySeconds: 200" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "readOnly: true alone" },
      { id: 'B', text: "mountOnly: nginx.conf" },
      { id: 'C', text: "subPath: nginx.conf" },
      { id: 'D', text: "mountPropagation: HostToContainer" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "disableToken: true" },
      { id: 'B', text: "automountServiceAccountToken: false (on the Pod or ServiceAccount spec)" },
      { id: 'C', text: "securityContext: { unauthenticated: true }" },
      { id: 'D', text: "serviceAccountName: none" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "ClusterRoleBinding alone" },
      { id: 'B', text: "GlobalRole" },
      { id: 'C', text: "Role (paired with a RoleBinding)" },
      { id: 'D', text: "ClusterRole (paired with a ClusterRoleBinding)" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create a RoleBinding in the marketing namespace referencing the ClusterRole in roleRef" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "apiGroups: ['apps'], resources: ['deployments'], verbs: ['create', 'update', 'delete', 'get', 'list', 'watch']" },
      { id: 'B', text: "apiGroups: [''], resources: ['deployments'], verbs: ['all']" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl describe serviceaccount ci-deployer" },
      { id: 'B', text: "kubectl get rbac --user=ci-deployer" },
      { id: 'C', text: "kubectl test rbac delete secrets" },
      { id: 'D', text: "kubectl auth can-i delete secrets -n staging --as=system:serviceaccount:staging:ci-deployer" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "ResourceQuota" },
      { id: 'B', text: "PodSecurityPolicy" },
      { id: 'C', text: "MutatingAdmissionWebhook alone" },
      { id: 'D', text: "LimitRange" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "ReadOnlyMany (ROX)" },
      { id: 'B', text: "ReadWriteMany (RWX)" },
      { id: 'C', text: "ReadWriteOnce (RWO)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "persistentVolumeReclaimPolicy: Archive" },
      { id: 'B', text: "persistentVolumeReclaimPolicy: Recycle" },
      { id: 'C', text: "persistentVolumeReclaimPolicy: Delete" },
      { id: 'D', text: "persistentVolumeReclaimPolicy: Retain" }
    ],
    correctAnswers: ['D'],
    type: "single",
