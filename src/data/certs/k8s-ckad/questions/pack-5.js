export const K8S_CKAD_QUESTIONS_5 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "initialDelaySeconds on livenessProbe alone" },
      { id: 'C', text: "preStop hook" },
      { id: 'D', text: "readinessProbe with failureThreshold: 100" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "tcpSocket: { path: /tmp/healthy }" },
      { id: 'B', text: "exec: { command: ['cat', '/tmp/healthy'] }" },
      { id: 'C', text: "httpGet: { path: /tmp/healthy }" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A grpc probe on port 50051" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "delay: 10s, interval: 5s, timeout: 2s" },
      { id: 'C', text: "periodSeconds: 10, initialDelaySeconds: 5, timeoutSeconds: 2" },
      { id: 'D', text: "timeoutSeconds: 10, periodSeconds: 5, initialDelaySeconds: 2" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "kubectl logs &lt;pod-name&gt; --previous (or -p)" },
      { id: 'D', text: "kubectl logs &lt;pod-name&gt; --follow" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl logs order-processor/app" },
      { id: 'B', text: "kubectl logs order-processor --all-containers" },
      { id: 'C', text: "kubectl exec order-processor -c app logs" },
      { id: 'D', text: "kubectl logs order-processor -c app" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl logs -f --tail=50 &lt;pod-name&gt;" },
      { id: 'B', text: "kubectl logs -f --limit=50 &lt;pod-name&gt;" },
      { id: 'C', text: "kubectl logs -w -n 50 &lt;pod-name&gt;" },
      { id: 'D', text: "kubectl describe pod --logs=50" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Kubernetes Metrics Server" },
      { id: 'D', text: "CoreDNS" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl top pods -n production --sort-by=memory" },
      { id: 'B', text: "kubectl get pods -n production --sort-by=memory" },
      { id: 'C', text: "kubectl describe pods -n production | grep Memory" },
      { id: 'D', text: "kubectl top pods -n production --order=desc" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It runs now but was OOMKilled and restarted earlier" },
      { id: 'B', text: "The container is currently dead and will not restart" },
      { id: 'C', text: "The container exceeded its CPU quota" },
      { id: 'D', text: "A network partition caused the pod to be rescheduled" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl debug -it &lt;pod-name&gt; --image=nicolaka/netshoot --target=&lt;container-name&gt;" },
      { id: 'B', text: "kubectl exec -it &lt;pod-name&gt; -- /bin/bash, which needs a shell in the image" },
      { id: 'C', text: "kubectl run debug --image=nicolaka/netshoot --rm -it in a pod of its own" },
      { id: 'D', text: "kubectl attach &lt;pod-name&gt; -c &lt;container-name&gt; to reattach to its stdio" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "kubectl debug &lt;node-name&gt; -it --image=busybox --privileged" },
      { id: 'C', text: "kubectl run host-debug -it --image=busybox --overrides hostPID" },
      { id: 'D', text: "kubectl attach node/&lt;node-name&gt; -it --image=busybox" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl debug &lt;pod-name&gt; --copy-to=my-debugger --image=busybox --container=app -- /bin/sh" },
      { id: 'B', text: "kubectl debug &lt;pod-name&gt; --copy-to=my-debugger --image=busybox --share-processes" },
      { id: 'C', text: "kubectl debug &lt;pod-name&gt; --image=busybox --target=app --attach -- sleep 3600" },
      { id: 'D', text: "kubectl run my-debugger --image=busybox --overrides from the pod spec -- sleep 3600" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "HTTP POST on /telemetry returning JSON" },
      { id: 'B', text: "UDP datagrams on port 8125 in StatsD format" },
      { id: 'C', text: "HTTP GET on /healthz returning XML" },
      { id: 'D', text: "An HTTP GET on /metrics in Prometheus format" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The container must run with root permissions" },
      { id: 'B', text: "kubectl logs only captures files in /tmp" },
      { id: 'C', text: "Kubernetes requires logs to be written to UDP port 514" },
      { id: 'D', text: "Collectors only capture stdout and stderr" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It exits at once and the kubelet backs off restarts" },
      { id: 'B', text: "The worker node ran out of disk space" },
      { id: 'C', text: "The container image cannot be found in the registry" },
      { id: 'D', text: "The cluster control plane is offline" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The pod lacks CPU requests" },
      { id: 'B', text: "The container ran out of memory limits" },
      { id: 'C', text: "Wrong image name or missing pull secret" },
      { id: 'D', text: "The liveness probe failed 3 times" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Pod-1 is terminated and restarted immediately" },
      { id: 'B', text: "All 3 pods are restarted" },
      { id: 'C', text: "Pod-1 continues receiving traffic normally" },
      { id: 'D', text: "It is removed from the Service endpoints" }
    ],
    correctAnswers: ['D'],
    type: "single",
