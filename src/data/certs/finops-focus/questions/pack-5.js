export const FINOPS_FOCUS_QUESTIONS_5 = [
  {
    ...
    title: "Separating Two Sources of Discount Value: High-Frequency FinTech Trading",
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The FinOps team is separating the value delivered by rate negotiation from the value of commitments. The work is scoped to a newly built secondary environment.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Allocating Cost to the Owning Team: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The FinOps team is attributing every line of spend to the business owner that should carry it. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Comparing Cost Data From Several Providers: Global E-Commerce Black Friday Scale",
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The FinOps team is making cost data from several providers directly comparable in one warehouse. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Which Cost Column Ties Out to the Invoice: Autonomous Vehicle Telemetry",
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The FinOps team is reconciling to the vendor invoice while charging teams a stable monthly figure. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Usage From Purchases, Tax, and Credits: Multi-Tenant B2B SaaS Platform",
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The FinOps team is splitting billing lines into consumption, commitment purchases, tax, and credits. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Aggregating Accounts and Resources Across Clouds: Media Streaming & Global CDN",
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The FinOps team is grouping spend by account and resource consistently across every provider. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Making Cost Comparisons Valid Between Providers: Aerospace Satellite Ground Systems",
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The FinOps team is comparing the unit rate paid for equivalent resources on different providers. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Two Sources of Discount Value: Telecommunications 5G Core Network",
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The FinOps team is separating the value delivered by rate negotiation from the value of commitments. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Compare the contracted rate against 'ListUnitPrice' on each line and multiply that gap by the pricing quantity for every row." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Allocating Cost to the Owning Team: Renewable Energy Smart Grid IoT",
    scenario: "A smart electrical grid platform monitors millions of smart meters with low-latency time-series analysis and automated load shedding. The FinOps team is attributing every line of spend to the business owner that should carry it. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
      ...
      { id: 'C', text: "Query each provider's own tag columns and union the results, renaming the differing tag key spellings for each provider as part of the warehouse load step." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Comparing Cost Data From Several Providers: Supply Chain Cold-Chain Logistics",
    scenario: "A pharmaceutical distribution network tracks temperature-sensitive cargo with cryptographic provenance and automated breach alerts. The FinOps team is making cost data from several providers directly comparable in one warehouse. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Which Cost Column Ties Out to the Invoice: Banking Core Ledger & Payments",
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The FinOps team is reconciling to the vendor invoice while charging teams a stable monthly figure. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Usage From Purchases, Tax, and Credits: Genomic Sequencing & Biotech Pipeline",
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The FinOps team is splitting billing lines into consumption, commitment purchases, tax, and credits. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Aggregating Accounts and Resources Across Clouds: Defense-Grade Zero-Trust Network",
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The FinOps team is grouping spend by account and resource consistently across every provider. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Making Cost Comparisons Valid Between Providers: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The FinOps team is comparing the unit rate paid for equivalent resources on different providers. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Two Sources of Discount Value: Insurance Risk & Actuarial Modeling",
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The FinOps team is separating the value delivered by rate negotiation from the value of commitments. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Compare the contracted rate against 'ListUnitPrice' on each line and multiply that gap by the pricing quantity for every row." },
      { id: 'B', text: "Compare 'BilledCost' against 'EffectiveCost' so that the difference shows what the commitments contributed across the period." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Allocating Cost to the Owning Team: Pharmaceutical Clinical Trial Platform",
    scenario: "A global pharmaceutical research group manages double-blind clinical trial records with strict regulatory reporting and audit trails. The FinOps team is attributing every line of spend to the business owner that should carry it. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Comparing Cost Data From Several Providers: Smart City Traffic & Mobility Sensor Hub",
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The FinOps team is making cost data from several providers directly comparable in one warehouse. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Load each provider's native export into its own table and have the FinOps team join them in the warehouse with views lining up comparable columns." },
      { id: 'B', text: "Build an internal canonical billing schema and write one mapping per provider, maintaining each of those mappings by hand as that provider changes its export format over time." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Which Cost Column Ties Out to the Invoice: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The FinOps team is reconciling to the vendor invoice while charging teams a stable monthly figure. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use 'ListCost' for the chargeback so that teams see the undiscounted rate and the savings remain with the central FinOps function." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Usage From Purchases, Tax, and Credits: Legal Discovery & Semantic Document Search",
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The FinOps team is splitting billing lines into consumption, commitment purchases, tax, and credits. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Query the 'ServiceCategory' column, which groups every usage line by the kind of service that it belongs to consistently across all of the supported providers." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Aggregating Accounts and Resources Across Clouds: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The FinOps team is grouping spend by account and resource consistently across every provider. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Making Cost Comparisons Valid Between Providers: Precision Agriculture & Drone Scouting",
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The FinOps team is comparing the unit rate paid for equivalent resources on different providers. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Two Sources of Discount Value: Industrial Robotics Predictive Maintenance",
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The FinOps team is separating the value delivered by rate negotiation from the value of commitments. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Allocating Cost to the Owning Team: Educational Remote Proctoring Platform",
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The FinOps team is attributing every line of spend to the business owner that should carry it. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Comparing Cost Data From Several Providers: Real Estate Valuation & Geo-Spatial Analytics",
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The FinOps team is making cost data from several providers directly comparable in one warehouse. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Load each provider's native export into its own table and have the FinOps team join them in the warehouse with views lining up comparable columns." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Which Cost Column Ties Out to the Invoice: Disaster Emergency Dispatch & Operations",
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The FinOps team is reconciling to the vendor invoice while charging teams a stable monthly figure. The work is scoped to a newly built secondary environment.",
    question: "Which approach best meets these requirements?",
    options: [
