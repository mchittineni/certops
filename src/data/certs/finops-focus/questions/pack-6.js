export const FINOPS_FOCUS_QUESTIONS_6 = [
  {
    ...
    title: "Which Cost Column Ties Out to the Invoice: High-Frequency FinTech Trading",
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The FinOps team is reconciling to the vendor invoice while charging teams a stable monthly figure. The work is scoped to the development environment.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Usage From Purchases, Tax, and Credits: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The FinOps team is splitting billing lines into consumption, commitment purchases, tax, and credits. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Aggregating Accounts and Resources Across Clouds: Global E-Commerce Black Friday Scale",
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The FinOps team is grouping spend by account and resource consistently across every provider. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Making Cost Comparisons Valid Between Providers: Autonomous Vehicle Telemetry",
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The FinOps team is comparing the unit rate paid for equivalent resources on different providers. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Two Sources of Discount Value: Multi-Tenant B2B SaaS Platform",
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The FinOps team is separating the value delivered by rate negotiation from the value of commitments. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Allocating Cost to the Owning Team: Media Streaming & Global CDN",
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The FinOps team is attributing every line of spend to the business owner that should carry it. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Comparing Cost Data From Several Providers: Aerospace Satellite Ground Systems",
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The FinOps team is making cost data from several providers directly comparable in one warehouse. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Which Cost Column Ties Out to the Invoice: Telecommunications 5G Core Network",
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The FinOps team is reconciling to the vendor invoice while charging teams a stable monthly figure. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Usage From Purchases, Tax, and Credits: Renewable Energy Smart Grid IoT",
    scenario: "A smart electrical grid platform monitors millions of smart meters with low-latency time-series analysis and automated load shedding. The FinOps team is splitting billing lines into consumption, commitment purchases, tax, and credits. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Aggregating Accounts and Resources Across Clouds: Supply Chain Cold-Chain Logistics",
    scenario: "A pharmaceutical distribution network tracks temperature-sensitive cargo with cryptographic provenance and automated breach alerts. The FinOps team is grouping spend by account and resource consistently across every provider. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Making Cost Comparisons Valid Between Providers: Banking Core Ledger & Payments",
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The FinOps team is comparing the unit rate paid for equivalent resources on different providers. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Two Sources of Discount Value: Genomic Sequencing & Biotech Pipeline",
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The FinOps team is separating the value delivered by rate negotiation from the value of commitments. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Compare the contracted rate against 'ListUnitPrice' on each line and multiply that gap by the pricing quantity for every row." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Allocating Cost to the Owning Team: Defense-Grade Zero-Trust Network",
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The FinOps team is attributing every line of spend to the business owner that should carry it. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Comparing Cost Data From Several Providers: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The FinOps team is making cost data from several providers directly comparable in one warehouse. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Which Cost Column Ties Out to the Invoice: Insurance Risk & Actuarial Modeling",
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The FinOps team is reconciling to the vendor invoice while charging teams a stable monthly figure. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "'BilledCost' for invoices, 'EffectiveCost' for chargeback." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Usage From Purchases, Tax, and Credits: Pharmaceutical Clinical Trial Platform",
    scenario: "A global pharmaceutical research group manages double-blind clinical trial records with strict regulatory reporting and audit trails. The FinOps team is splitting billing lines into consumption, commitment purchases, tax, and credits. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Query the 'ChargeCategory' column to segment billing lines into 'Usage', 'Purchase', 'Tax', 'Adjustment', and 'Credit' with standard subcategories." },
      { id: 'B', text: "Query the 'ServiceCategory' column, which groups every usage line by the kind of service that it belongs to consistently across all of the supported providers." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Aggregating Accounts and Resources Across Clouds: Smart City Traffic & Mobility Sensor Hub",
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The FinOps team is grouping spend by account and resource consistently across every provider. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Making Cost Comparisons Valid Between Providers: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The FinOps team is comparing the unit rate paid for equivalent resources on different providers. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Two Sources of Discount Value: Legal Discovery & Semantic Document Search",
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The FinOps team is separating the value delivered by rate negotiation from the value of commitments. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Allocating Cost to the Owning Team: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The FinOps team is attributing every line of spend to the business owner that should carry it. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Comparing Cost Data From Several Providers: Precision Agriculture & Drone Scouting",
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The FinOps team is making cost data from several providers directly comparable in one warehouse. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Which Cost Column Ties Out to the Invoice: Industrial Robotics Predictive Maintenance",
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The FinOps team is reconciling to the vendor invoice while charging teams a stable monthly figure. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Usage From Purchases, Tax, and Credits: Educational Remote Proctoring Platform",
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The FinOps team is splitting billing lines into consumption, commitment purchases, tax, and credits. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Query the 'ServiceCategory' column, which groups every usage line by the kind of service that it belongs to consistently across all of the supported providers." },
      { id: 'B', text: "Query the 'ChargeCategory' column to segment billing lines into 'Usage', 'Purchase', 'Tax', 'Adjustment', and 'Credit' with standard subcategories." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Aggregating Accounts and Resources Across Clouds: Real Estate Valuation & Geo-Spatial Analytics",
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The FinOps team is grouping spend by account and resource consistently across every provider. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use 'InvoiceIssuerName' and 'BillingAccountName' as the grouping keys, since together they identify who is being billed for each line." },
      { id: 'B', text: "Use the 'Tags' column and require every team to tag its resources with the owning account and region so the hierarchy is readable." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Making Cost Comparisons Valid Between Providers: Disaster Emergency Dispatch & Operations",
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The FinOps team is comparing the unit rate paid for equivalent resources on different providers. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Measure usage using 'PricingQuantity' and standardized 'PricingUnit' (e.g., 'Hour', 'Gigabyte-Month', 'Request') to compare unit rates directly." },
