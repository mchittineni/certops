export const FINOPS_FOCUS_QUESTIONS_4 = [
  {
    ...
    title: "Separating Usage From Purchases, Tax, and Credits: High-Frequency FinTech Trading",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Aggregating Accounts and Resources Across Clouds: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The FinOps team is grouping spend by account and resource consistently across every provider. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Making Cost Comparisons Valid Between Providers: Global E-Commerce Black Friday Scale",
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The FinOps team is comparing the unit rate paid for equivalent resources on different providers. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Two Sources of Discount Value: Autonomous Vehicle Telemetry",
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The FinOps team is separating the value delivered by rate negotiation from the value of commitments. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Allocating Cost to the Owning Team: Multi-Tenant B2B SaaS Platform",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Comparing Cost Data From Several Providers: Media Streaming & Global CDN",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Which Cost Column Ties Out to the Invoice: Aerospace Satellite Ground Systems",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Usage From Purchases, Tax, and Credits: Telecommunications 5G Core Network",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Aggregating Accounts and Resources Across Clouds: Renewable Energy Smart Grid IoT",
    scenario: "A smart electrical grid platform monitors millions of smart meters with low-latency time-series analysis and automated load shedding. The FinOps team is grouping spend by account and resource consistently across every provider. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Making Cost Comparisons Valid Between Providers: Supply Chain Cold-Chain Logistics",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Two Sources of Discount Value: Banking Core Ledger & Payments",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Allocating Cost to the Owning Team: Genomic Sequencing & Biotech Pipeline",
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The FinOps team is attributing every line of spend to the business owner that should carry it. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Comparing Cost Data From Several Providers: Defense-Grade Zero-Trust Network",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Which Cost Column Ties Out to the Invoice: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The FinOps team is reconciling to the vendor invoice while charging teams a stable monthly figure. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use 'EffectiveCost' for the invoice reconciliation as well as the team chargeback so that one column is applied consistently everywhere." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Usage From Purchases, Tax, and Credits: Insurance Risk & Actuarial Modeling",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Aggregating Accounts and Resources Across Clouds: Pharmaceutical Clinical Trial Platform",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Making Cost Comparisons Valid Between Providers: Smart City Traffic & Mobility Sensor Hub",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Two Sources of Discount Value: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The FinOps team is separating the value delivered by rate negotiation from the value of commitments. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Compare 'ListCost' against 'BilledCost' so that the difference captures every single discount which reached the invoice during that particular month." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Allocating Cost to the Owning Team: Legal Discovery & Semantic Document Search",
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The FinOps team is attributing every line of spend to the business owner that should carry it. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Query each provider's own tag columns and union the results, renaming the differing tag key spellings for each provider as part of the warehouse load step." },
      { id: 'B', text: "Query 'SubAccountId' and maintain a lookup table mapping each account or subscription onto the team that is known to own it." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Comparing Cost Data From Several Providers: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The FinOps team is making cost data from several providers directly comparable in one warehouse. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Build an internal canonical billing schema and write one mapping per provider, maintaining each of those mappings by hand as that provider changes its export format over time." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Which Cost Column Ties Out to the Invoice: Precision Agriculture & Drone Scouting",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Usage From Purchases, Tax, and Credits: Industrial Robotics Predictive Maintenance",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Aggregating Accounts and Resources Across Clouds: Educational Remote Proctoring Platform",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Making Cost Comparisons Valid Between Providers: Real Estate Valuation & Geo-Spatial Analytics",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "FOCUS Specification Fundamentals and Column Taxonomy",
    title: "Separating Two Sources of Discount Value: Disaster Emergency Dispatch & Operations",
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The FinOps team is separating the value delivered by rate negotiation from the value of commitments. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
