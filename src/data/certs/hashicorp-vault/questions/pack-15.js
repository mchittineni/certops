export const HASHICORP_VAULT_QUESTIONS_15 = [
  {
    id: "hashicorp-vault-351",
    difficulty: "easy",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Surviving the Loss of a Cluster Node: High-Frequency FinTech Trading",
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The platform team is designing a production cluster topology that tolerates the loss of a node. The work is scoped to a newly built secondary environment.",
  ...
  {
    id: "hashicorp-vault-352",
    difficulty: "easy",
    certId: "hashicorp-vault",
    domainId: "d7",
    domainName: "Vault architecture fundamentals",
    title: "Restarting a Node Without an Operator Key Ceremony: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The platform team is bringing nodes back into service after a restart without assembling key holders. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-353",
    difficulty: "easy",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Choosing a Cross-Region Replication Mode: Global E-Commerce Black Friday Scale",
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The platform team is planning cross-region failover alongside low-latency reads in each region. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-354",
    difficulty: "easy",
    certId: "hashicorp-vault",
    domainId: "d4",
    domainName: "Vault leases",
    title: "Withdrawing Credentials Already in Circulation: Autonomous Vehicle Telemetry",
  ...
  {
    id: "hashicorp-vault-355",
    difficulty: "easy",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Audit Logging That Cannot Fail Quietly: Multi-Tenant B2B SaaS Platform",
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The platform team is guaranteeing every request is recorded without the logging path halting the cluster. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Enable multiple audit devices (e.g., file and syslog) and monitor them, so Vault keeps serving while at least one device can still write." },
  ...
  {
    id: "hashicorp-vault-356",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d3",
    domainName: "Vault tokens",
    title: "Token Type for Very High Request Volume: Media Streaming & Global CDN",
  ...
  {
    id: "hashicorp-vault-357",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d9",
    domainName: "Access management architecture",
    title: "Delivering Secrets to Mixed Kubernetes and VM Workloads: Aerospace Satellite Ground Systems",
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The platform team is delivering secrets into applications that run on both Kubernetes and plain virtual machines. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-358",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Surviving the Loss of a Cluster Node: Telecommunications 5G Core Network",
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The platform team is designing a production cluster topology that tolerates the loss of a node. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-359",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d7",
    domainName: "Vault architecture fundamentals",
    title: "Restarting a Node Without an Operator Key Ceremony: Renewable Energy Smart Grid IoT",
    scenario: "A smart electrical grid platform monitors millions of smart meters with low-latency time-series analysis and automated load shedding. The platform team is bringing nodes back into service after a restart without assembling key holders. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-360",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Choosing a Cross-Region Replication Mode: Supply Chain Cold-Chain Logistics",
    scenario: "A pharmaceutical distribution network tracks temperature-sensitive cargo with cryptographic provenance and automated breach alerts. The platform team is planning cross-region failover alongside low-latency reads in each region. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-361",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d4",
    domainName: "Vault leases",
    title: "Withdrawing Credentials Already in Circulation: Banking Core Ledger & Payments",
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The platform team is cutting off credentials that have already been issued after a suspected compromise. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Seal the Vault cluster so that every outstanding lease is invalidated until an operator unseals it again." },
  ...
  {
    id: "hashicorp-vault-362",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Audit Logging That Cannot Fail Quietly: Genomic Sequencing & Biotech Pipeline",
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The platform team is guaranteeing every request is recorded without the logging path halting the cluster. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-363",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d3",
    domainName: "Vault tokens",
    title: "Token Type for Very High Request Volume: Defense-Grade Zero-Trust Network",
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The platform team is choosing a token type for short-lived functions invoked many thousands of times per second. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-364",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d9",
    domainName: "Access management architecture",
    title: "Delivering Secrets to Mixed Kubernetes and VM Workloads: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The platform team is delivering secrets into applications that run on both Kubernetes and plain virtual machines. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-365",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Surviving the Loss of a Cluster Node: Insurance Risk & Actuarial Modeling",
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The platform team is designing a production cluster topology that tolerates the loss of a node. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Deploy a multi-node Vault cluster using integrated Raft storage, where one node is elected active and standby nodes forward requests." },
      { id: 'B', text: "Deploy a single Vault node against a highly available managed database backend and restart the node automatically on failure." },
  ...
  {
    id: "hashicorp-vault-366",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d7",
    domainName: "Vault architecture fundamentals",
    title: "Restarting a Node Without an Operator Key Ceremony: Pharmaceutical Clinical Trial Platform",
    scenario: "A global pharmaceutical research group manages double-blind clinical trial records with strict regulatory reporting and audit trails. The platform team is bringing nodes back into service after a restart without assembling key holders. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Configure the 'seal' stanza with AWS KMS, Azure Key Vault, or GCP KMS to automatically unseal Vault upon service initialization and reboot." },
  ...
  {
    id: "hashicorp-vault-367",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Choosing a Cross-Region Replication Mode: Smart City Traffic & Mobility Sensor Hub",
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The platform team is planning cross-region failover alongside low-latency reads in each region. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use Disaster Recovery (DR) replication to maintain a warm-standby secondary cluster that can be promoted, or Performance Replication for localized secret reads." },
      { id: 'B', text: "Run an independent cluster in each region and keep their secrets aligned with Vault Agent templates that copy values between them." },
  ...
  {
    id: "hashicorp-vault-368",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d4",
    domainName: "Vault leases",
    title: "Withdrawing Credentials Already in Circulation: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The platform team is cutting off credentials that have already been issued after a suspected compromise. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-369",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Audit Logging That Cannot Fail Quietly: Legal Discovery & Semantic Document Search",
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The platform team is guaranteeing every request is recorded without the logging path halting the cluster. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-370",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d3",
    domainName: "Vault tokens",
    title: "Token Type for Very High Request Volume: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The platform team is choosing a token type for short-lived functions invoked many thousands of times per second. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use Batch tokens for high-volume, short-lived workloads to eliminate write operations to the storage backend." },
      { id: 'B', text: "Use service tokens with very short TTLs so that expired entries are pruned from the token store by routine cleanup operations." },
  ...
  {
    id: "hashicorp-vault-371",
    difficulty: "hard",
    certId: "hashicorp-vault",
    domainId: "d9",
    domainName: "Access management architecture",
    title: "Delivering Secrets to Mixed Kubernetes and VM Workloads: Precision Agriculture & Drone Scouting",
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The platform team is delivering secrets into applications that run on both Kubernetes and plain virtual machines. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-372",
    difficulty: "hard",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Surviving the Loss of a Cluster Node: Industrial Robotics Predictive Maintenance",
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The platform team is designing a production cluster topology that tolerates the loss of a node. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-373",
    difficulty: "hard",
    certId: "hashicorp-vault",
    domainId: "d7",
    domainName: "Vault architecture fundamentals",
    title: "Restarting a Node Without an Operator Key Ceremony: Educational Remote Proctoring Platform",
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The platform team is bringing nodes back into service after a restart without assembling key holders. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Configure the 'seal' stanza with AWS KMS, Azure Key Vault, or GCP KMS to automatically unseal Vault upon service initialization and reboot." },
  ...
  {
    id: "hashicorp-vault-374",
    difficulty: "hard",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Choosing a Cross-Region Replication Mode: Real Estate Valuation & Geo-Spatial Analytics",
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The platform team is planning cross-region failover alongside low-latency reads in each region. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Run an independent cluster in each region and keep their secrets aligned with Vault Agent templates that copy values between them." },
      { id: 'B', text: "Use Disaster Recovery (DR) replication to maintain a warm-standby secondary cluster that can be promoted, or Performance Replication for localized secret reads." },
  ...
  {
    id: "hashicorp-vault-375",
    difficulty: "hard",
    certId: "hashicorp-vault",
    domainId: "d4",
    domainName: "Vault leases",
    title: "Withdrawing Credentials Already in Circulation: Disaster Emergency Dispatch & Operations",
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The platform team is cutting off credentials that have already been issued after a suspected compromise. The work is scoped to a newly built secondary environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Seal the Vault cluster so that every outstanding lease is invalidated until an operator unseals it again." },
      { id: 'B', text: "Delete the auth method role so that no further credentials can be issued, and allow the ones already outstanding to lapse when their own TTL expires naturally." },
...
export default HASHICORP_VAULT_QUESTIONS_15;
