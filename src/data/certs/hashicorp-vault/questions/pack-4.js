export const HASHICORP_VAULT_QUESTIONS_4 = [
  ...
  },
  {
    ...
    title: "Machine Identity for Workloads Without a Platform Identity: Media Streaming & Global CDN",
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The platform team is granting an application read access to its own secrets without allowing it to overwrite them. The work is scoped to the production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Defense-Grade Zero-Trust Network",
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The platform team is authenticating ephemeral cluster pods whose identity must be revocable the moment they are deleted. The work is scoped to the production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
