export const HASHICORP_VAULT_QUESTIONS_7 = [
  ...
  },
  {
    ...
    certId: "hashicorp-vault",
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Autonomous Vehicle Telemetry",
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the staging environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Banking Core Ledger & Payments",
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the staging environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the staging environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Disaster Emergency Dispatch & Operations",
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the staging environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
