export const HASHICORP_VAULT_QUESTIONS_6 = [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Aerospace Satellite Ground Systems",
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Precision Agriculture & Drone Scouting",
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
