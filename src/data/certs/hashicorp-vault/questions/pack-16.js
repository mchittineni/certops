export const HASHICORP_VAULT_QUESTIONS_16 = [
  {
    id: "hashicorp-vault-376",
    difficulty: "easy",
    certId: "hashicorp-vault",
    domainId: "d4",
    domainName: "Vault leases",
    title: "Withdrawing Credentials Already in Circulation: High-Frequency FinTech Trading",
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The platform team is cutting off credentials that have already been issued after a suspected compromise. The work is scoped to the development environment.",
  ...
  {
    id: "hashicorp-vault-377",
    difficulty: "easy",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Audit Logging That Cannot Fail Quietly: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The platform team is guaranteeing every request is recorded without the logging path halting the cluster. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-378",
    difficulty: "easy",
    certId: "hashicorp-vault",
    domainId: "d3",
    domainName: "Vault tokens",
    title: "Token Type for Very High Request Volume: Global E-Commerce Black Friday Scale",
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The platform team is choosing a token type for short-lived functions invoked many thousands of times per second. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-379",
    difficulty: "easy",
    certId: "hashicorp-vault",
    domainId: "d9",
    domainName: "Access management architecture",
    title: "Delivering Secrets to Mixed Kubernetes and VM Workloads: Autonomous Vehicle Telemetry",
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The platform team is delivering secrets into applications that run on both Kubernetes and plain virtual machines. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      ...
      { id: 'D', text: "Deploy the Vault Secrets Operator so that secrets are synchronised into native Kubernetes Secret objects for pods to consume." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  {
    id: "hashicorp-vault-380",
    difficulty: "easy",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Surviving the Loss of a Cluster Node: Multi-Tenant B2B SaaS Platform",
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The platform team is designing a production cluster topology that tolerates the loss of a node. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-381",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d7",
    domainName: "Vault architecture fundamentals",
    title: "Restarting a Node Without an Operator Key Ceremony: Media Streaming & Global CDN",
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The platform team is bringing nodes back into service after a restart without assembling key holders. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-382",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Choosing a Cross-Region Replication Mode: Aerospace Satellite Ground Systems",
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The platform team is planning cross-region failover alongside low-latency reads in each region. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-383",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d4",
    domainName: "Vault leases",
    title: "Withdrawing Credentials Already in Circulation: Telecommunications 5G Core Network",
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The platform team is cutting off credentials that have already been issued after a suspected compromise. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-384",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Audit Logging That Cannot Fail Quietly: Renewable Energy Smart Grid IoT",
    scenario: "A smart electrical grid platform monitors millions of smart meters with low-latency time-series analysis and automated load shedding. The platform team is guaranteeing every request is recorded without the logging path halting the cluster. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Enable a single file audit device and configure aggressive log rotation so the destination cannot fill its disk." },
  ...
  {
    id: "hashicorp-vault-386",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d9",
    domainName: "Access management architecture",
    title: "Delivering Secrets to Mixed Kubernetes and VM Workloads: Banking Core Ledger & Payments",
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The platform team is delivering secrets into applications that run on both Kubernetes and plain virtual machines. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-387",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Surviving the Loss of a Cluster Node: Genomic Sequencing & Biotech Pipeline",
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The platform team is designing a production cluster topology that tolerates the loss of a node. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Deploy several independent Vault clusters behind a load balancer that spreads write requests evenly across all of them." },
  ...
  {
    id: "hashicorp-vault-388",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d7",
    domainName: "Vault architecture fundamentals",
    title: "Restarting a Node Without an Operator Key Ceremony: Defense-Grade Zero-Trust Network",
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The platform team is bringing nodes back into service after a restart without assembling key holders. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-389",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Choosing a Cross-Region Replication Mode: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The platform team is planning cross-region failover alongside low-latency reads in each region. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-390",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d4",
    domainName: "Vault leases",
    title: "Withdrawing Credentials Already in Circulation: Insurance Risk & Actuarial Modeling",
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The platform team is cutting off credentials that have already been issued after a suspected compromise. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Monitor lease TTLs, allow clients to renew active leases, and invoke 'sys/leases/revoke-prefix' to revoke compromised credential trees immediately." },
      { id: 'B', text: "Delete the auth method role so that no further credentials can be issued, and allow the ones already outstanding to lapse when their own TTL expires naturally." },
  ...
  {
    id: "hashicorp-vault-391",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Audit Logging That Cannot Fail Quietly: Pharmaceutical Clinical Trial Platform",
    scenario: "A global pharmaceutical research group manages double-blind clinical trial records with strict regulatory reporting and audit trails. The platform team is guaranteeing every request is recorded without the logging path halting the cluster. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-392",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d3",
    domainName: "Vault tokens",
    title: "Token Type for Very High Request Volume: Smart City Traffic & Mobility Sensor Hub",
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The platform team is choosing a token type for short-lived functions invoked many thousands of times per second. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use service tokens with very short TTLs so that expired entries are pruned from the token store by routine cleanup operations." },
      { id: 'B', text: "Use batch tokens with renewable set to true so that a long-running invocation is able to extend its own lifetime." },
  ...
  {
    id: "hashicorp-vault-393",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d9",
    domainName: "Access management architecture",
    title: "Delivering Secrets to Mixed Kubernetes and VM Workloads: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The platform team is delivering secrets into applications that run on both Kubernetes and plain virtual machines. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Deploy Vault Agent as a sidecar or daemon to handle authentication, token renewal, and automated secret templating to local disk." },
  ...
  {
    id: "hashicorp-vault-394",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Surviving the Loss of a Cluster Node: Legal Discovery & Semantic Document Search",
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The platform team is designing a production cluster topology that tolerates the loss of a node. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-395",
    difficulty: "medium",
    certId: "hashicorp-vault",
    domainId: "d7",
    domainName: "Vault architecture fundamentals",
    title: "Restarting a Node Without an Operator Key Ceremony: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The platform team is bringing nodes back into service after a restart without assembling key holders. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Configure the 'seal' stanza to use the transit engine of the same Vault cluster so that each node can decrypt its own root key automatically on restart." },
  ...
  {
    id: "hashicorp-vault-396",
    difficulty: "hard",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Choosing a Cross-Region Replication Mode: Precision Agriculture & Drone Scouting",
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The platform team is planning cross-region failover alongside low-latency reads in each region. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-397",
    difficulty: "hard",
    certId: "hashicorp-vault",
    domainId: "d4",
    domainName: "Vault leases",
    title: "Withdrawing Credentials Already in Circulation: Industrial Robotics Predictive Maintenance",
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The platform team is cutting off credentials that have already been issued after a suspected compromise. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  {
    id: "hashicorp-vault-398",
    difficulty: "hard",
    certId: "hashicorp-vault",
    domainId: "d8",
    domainName: "Vault deployment architecture",
    title: "Audit Logging That Cannot Fail Quietly: Educational Remote Proctoring Platform",
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The platform team is guaranteeing every request is recorded without the logging path halting the cluster. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      ...
      { id: 'B', text: "Enable a file audit device with log_raw set to true so that responders can read unhashed values during an investigation." },
      { id: 'C', text: "Enable multiple audit devices (e.g., file and syslog) and monitor them, so Vault keeps serving while at least one device can still write." },
  ...
  {
    id: "hashicorp-vault-399",
    difficulty: "hard",
    certId: "hashicorp-vault",
    domainId: "d3",
    domainName: "Vault tokens",
    title: "Token Type for Very High Request Volume: Real Estate Valuation & Geo-Spatial Analytics",
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The platform team is choosing a token type for short-lived functions invoked many thousands of times per second. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use Batch tokens for high-volume, short-lived workloads to eliminate write operations to the storage backend." },
      { id: 'B', text: "Use batch tokens with renewable set to true so that a long-running invocation is able to extend its own lifetime." },
  ...
  {
    id: "hashicorp-vault-400",
    difficulty: "hard",
    certId: "hashicorp-vault",
    domainId: "d9",
    domainName: "Access management architecture",
    title: "Delivering Secrets to Mixed Kubernetes and VM Workloads: Disaster Emergency Dispatch & Operations",
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The platform team is delivering secrets into applications that run on both Kubernetes and plain virtual machines. The work is scoped to the development environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
...
export default HASHICORP_VAULT_QUESTIONS_16;
