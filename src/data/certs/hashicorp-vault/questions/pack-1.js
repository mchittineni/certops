export const HASHICORP_VAULT_QUESTIONS_1 = [
  {
    ...
    title: "Machine Identity for Workloads Without a Platform Identity: High-Frequency FinTech Trading",
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the development environment.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Telecommunications 5G Core Network",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Insurance Risk & Actuarial Modeling",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Industrial Robotics Predictive Maintenance",
