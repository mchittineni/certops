export const HASHICORP_VAULT_QUESTIONS_3 = [
  ...
  },
  {
    ...
    title: "Machine Identity for Workloads Without a Platform Identity: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Renewable Energy Smart Grid IoT",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Pharmaceutical Clinical Trial Platform",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Authentication methods",
    title: "Machine Identity for Workloads Without a Platform Identity: Educational Remote Proctoring Platform",
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The platform team is configuring machine authentication for workloads on hosts with no platform identity, where a trusted deployment pipeline can deliver a short-lived credential at launch. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
