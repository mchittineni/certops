export const HASHICORP_VAULT_QUESTIONS_13 = [
  {
    ...
    title: "Encrypting Records Without Distributing Key Material: High-Frequency FinTech Trading",
    ...
    options: [
      ...
      { id: 'D', text: "Store an AES data key at a KV v2 path and have each service read it at startup to encrypt records locally." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Database Access That Expires On Its Own: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The platform team is giving services database access that disappears automatically when it is no longer needed. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Internal TLS Without Manual Certificate Renewal: Global E-Commerce Black Friday Scale",
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The platform team is issuing TLS certificates to internal services without an operator renewing them by hand. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    title: "Moving Stored Ciphertext to a New Key Version: Autonomous Vehicle Telemetry",
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The platform team is rotating an encryption key and bringing existing ciphertext onto the new version. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Short-Lived Cloud Credentials Brokered Centrally: Multi-Tenant B2B SaaS Platform",
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The platform team is issuing time-bound cloud credentials to workloads under one central policy. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Server Access Without Standing Authorized Keys: Media Streaming & Global CDN",
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The platform team is granting engineers shell access to a large fleet without maintaining authorized_keys files. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Recovering a Previous Secret Value: Aerospace Satellite Ground Systems",
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The platform team is storing configuration secrets so that an accidental overwrite can be rolled back. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Encrypting Records Without Distributing Key Material: Telecommunications 5G Core Network",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Database Access That Expires On Its Own: Renewable Energy Smart Grid IoT",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Internal TLS Without Manual Certificate Renewal: Supply Chain Cold-Chain Logistics",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Encryption as a service",
    title: "Moving Stored Ciphertext to a New Key Version: Banking Core Ledger & Payments",
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The platform team is rotating an encryption key and bringing existing ciphertext onto the new version. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Short-Lived Cloud Credentials Brokered Centrally: Genomic Sequencing & Biotech Pipeline",
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The platform team is issuing time-bound cloud credentials to workloads under one central policy. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Server Access Without Standing Authorized Keys: Defense-Grade Zero-Trust Network",
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The platform team is granting engineers shell access to a large fleet without maintaining authorized_keys files. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Recovering a Previous Secret Value: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The platform team is storing configuration secrets so that an accidental overwrite can be rolled back. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Encrypting Records Without Distributing Key Material: Insurance Risk & Actuarial Modeling",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Database Access That Expires On Its Own: Pharmaceutical Clinical Trial Platform",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Internal TLS Without Manual Certificate Renewal: Smart City Traffic & Mobility Sensor Hub",
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The platform team is issuing TLS certificates to internal services without an operator renewing them by hand. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use the Transit engine to sign each certificate signing request with a managed key and distribute the results to the services." },
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Encryption as a service",
    title: "Moving Stored Ciphertext to a New Key Version: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The platform team is rotating an encryption key and bringing existing ciphertext onto the new version. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Create a second transit key, then have the application decrypt each record with the old key and encrypt it again with the new one." },
      { id: 'B', text: "Rotate the transit key and raise min_decryption_version with 'vault write transit/keys/my-key/config' so that stored ciphertext moves onto the new version." },
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Short-Lived Cloud Credentials Brokered Centrally: Legal Discovery & Semantic Document Search",
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The platform team is issuing time-bound cloud credentials to workloads under one central policy. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Server Access Without Standing Authorized Keys: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The platform team is granting engineers shell access to a large fleet without maintaining authorized_keys files. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Recovering a Previous Secret Value: Precision Agriculture & Drone Scouting",
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The platform team is storing configuration secrets so that an accidental overwrite can be rolled back. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Encrypting Records Without Distributing Key Material: Industrial Robotics Predictive Maintenance",
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The platform team is encrypting application records where the key must never be readable by the application host. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Call the transit engine's datakey endpoint for a plaintext data key per record and hold it in application memory while encrypting." },
      { id: 'B', text: "Send plaintext to Vault's transit engine endpoint 'transit/encrypt/keyname' to receive ciphertext, keeping keys securely inside Vault." },
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Database Access That Expires On Its Own: Educational Remote Proctoring Platform",
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The platform team is giving services database access that disappears automatically when it is no longer needed. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Configure the Database secrets engine with a connection plugin and role definition that executes 'CREATE USER' with a short lease TTL." },
      { id: 'B', text: "Store the database password in KV v2 and use a Vault Agent template to re-render the connection configuration hourly." },
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Secrets engines",
    title: "Internal TLS Without Manual Certificate Renewal: Real Estate Valuation & Geo-Spatial Analytics",
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The platform team is issuing TLS certificates to internal services without an operator renewing them by hand. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
      { id: 'A', text: "Mount the PKI engine, configure an intermediate CA signed by an enterprise root, and generate short-lived TLS certificates dynamically via API." },
      { id: 'B', text: "Use the SSH secrets engine as a certificate authority to sign a certificate for each service to present during mutual TLS." },
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Encryption as a service",
    title: "Moving Stored Ciphertext to a New Key Version: Disaster Emergency Dispatch & Operations",
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The platform team is rotating an encryption key and bringing existing ciphertext onto the new version. The work is scoped to the pre-production environment.",
    question: "Which HashiCorp Vault approach best meets these requirements?",
    options: [
