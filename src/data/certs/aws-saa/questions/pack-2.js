export const AWS_SAA_QUESTIONS_2 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Amazon FSx for Windows File Server deployed via AWS Direct Connect." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon Elastic Block Store (Amazon EBS) gp3 volumes." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Increase the read capacity units (RCUs) on the DynamoDB table to 40,000." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon EBS io2 Block Express volumes in a RAID 0 array attached to an EC2 instance." },
      { id: 'B', text: "AWS Storage Gateway File Gateway with local SSD cache." },
      { id: 'C', text: "Amazon EFS with Provisioned Throughput mode and Max I/O performance." },
      { id: 'D', text: "Amazon FSx for Lustre linked to the input Amazon S3 bucket with a data repository association." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure VPC Peering between Account A and Account B and allow root access through the route tables." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'E', text: "Associate AWS WAF with the CloudFront distribution and configure rate-based rules and AWS Managed Core/SQLi rule sets." }
    ],
    correctAnswers: ['B', 'E'],
    type: "multiple",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Standard Reserved Instances (Standard RIs)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "DynamoDB Provisioned capacity mode with Reserved Capacity." },
