export const AWS_SAA_QUESTIONS_2 = [
  {
    ...
    options: [
      ...
      { id: 'D', text: "Cross-zone load balancing, with the ASG using all three subnets." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set up an AWS Lambda function triggered by S3 Event Notifications to copy objects using the AWS SDK." },
      { id: 'B', text: "Use S3 Multi-Region Access Points to write each object simultaneously to two regional buckets." },
      { id: 'C', text: "Enable S3 Versioning on source and destination buckets and configure S3 Cross-Region Replication (CRR)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A failover routing policy with a health-checked primary and a secondary." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Amazon Elastic Block Store (Amazon EBS) gp3 volumes." },
      { id: 'D', text: "Amazon S3 mounted using S3FS-FUSE." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'E', text: "Send device telemetry to an Amazon SQS FIFO queue with message deduplication IDs." }
    ],
    correctAnswers: ['A', 'C'],
    type: "multiple",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Create an IAM group in Account B and add Account A's AWS account root ID to the group." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure Security Groups on the ALB to deny traffic originating from suspicious autonomous system numbers (ASNs)." },
      ...
      { id: 'C', text: "Replace the Application Load Balancer with an Amazon API Gateway Private REST API." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Replace the NAT Gateway with a NAT instance running on a t4g.nano EC2 instance." },
      { id: 'B', text: "Assign Elastic IP addresses directly to all private EC2 instances." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "DynamoDB Provisioned capacity mode with 10,000 RCU/WCU." },
