export const AWS_SAA_QUESTIONS_8 = [
  {
    ...
    options: [
      { id: 'A', text: "Amazon MQ Single-instance broker with daily EBS snapshots." },
      { id: 'B', text: "Amazon SQS FIFO queue with standard fanout." },
      { id: 'C', text: "Amazon SNS topic with SMS subscriptions." },
      { id: 'D', text: "An Amazon MQ active/standby broker across two AZs" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Latency records to both regional endpoints, health checked." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A Lambda consumer replicating records to a stream in us-west-2." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Weighted routing, 90 on v1 and 10 on v2" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Use Amazon S3 Multipart Upload API in the client application to upload parts in parallel." },
      ...
      { id: 'D', text: "Switch the bucket storage class to S3 Glacier Deep Archive." },
      { id: 'E', text: "Configure S3 Same-Region Replication." }
    ],
    correctAnswers: ['A', 'B'],
    type: "multiple",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "GSI overloading on generic `GSI1-PK` and `GSI1-SK` attributes" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set `rds.force_ssl` to 1 in the parameter group" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Pass an inline session policy with resource conditions to `sts:AssumeRole`" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Site-to-Site VPN with open SSH ports." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Amazon EC2 Spot Instances in an Auto Scaling group." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A Budgets action running SSM automation" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "AWS Storage Gateway in Volume Gateway Stored Volume mode." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "AWS DataSync cross-cluster sync." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "DynamoDB Standard-Infrequent Access (DynamoDB Standard-IA) table class." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Client-side encryption with the AWS Encryption SDK and a CMK" },
