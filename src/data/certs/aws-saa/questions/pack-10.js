export const AWS_SAA_QUESTIONS_10 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Deploy an Amazon RDS Proxy in front of the RDS Multi-AZ DB instance.' },
      { id: 'B', text: 'Convert the database to an Amazon S3 static bucket.' },
      { id: 'C', text: 'Increase the EC2 instance class size on the web servers.' },
      { id: 'D', text: 'Deploy an AWS Transit Gateway between the web servers and database.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Network ACLs on the VPC subnets.' },
      { id: 'D', text: 'Security Groups attached to Route 53.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Amazon S3 Standard with S3FS-FUSE.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'AWS AppSync Unit Resolver with SQS queue.' },
      { id: 'C', text: 'Amazon API Gateway WebSocket API.' },
      { id: 'D', text: 'Amazon S3 Event Notifications.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Enable Amazon S3 Object Lock in Compliance Mode with a 7-year retention period on the central audit bucket.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'AWS Gateway Load Balancer (GWLB) with GWLB endpoints (GWLBe).' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Individual IAM users created in each of the 100 AWS accounts.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Amazon ECR Basic Scanning (powered by Clair).' },
      { id: 'C', text: 'AWS WAF container scanning rules.' },
      { id: 'D', text: 'Amazon GuardDuty S3 scanner.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Amazon Route 53 Alias records.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Create a central VPC in a Networking account and share private subnets with member accounts using AWS Resource Access Manager (AWS RAM) VPC Sharing.' },
      { id: 'B', text: 'Deploy an AWS Direct Connect dedicated circuit in every account.' },
      { id: 'C', text: 'Create a mesh of 50 VPC Peering connections.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Amazon Redshift RA3 node types (e.g. `ra3.4xlarge`, `ra3.16xlarge`).' },
      { id: 'B', text: 'Amazon Redshift Dense Compute (DC2) nodes.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Switch to Cold HDD (sc1).' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Amazon FSx for OpenZFS.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'AWS AppConfig (a capability of AWS Systems Manager).' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'AWS Shield Standard alarm.' },
