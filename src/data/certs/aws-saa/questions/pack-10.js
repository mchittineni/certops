export const AWS_SAA_QUESTIONS_10 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create a CloudWatch Alarm on `SentMessageSize`." },
      { id: 'B', text: "A CloudWatch alarm on DLQ depth with SNS email" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Resolver DNS Firewall managed lists" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Route 53 Simple routing." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Multi-AZ FSx for Windows with DFS Namespaces" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Auto-refreshed materialized views" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS AppSync Unit Resolver with SQS queue." },
      { id: 'B', text: "AppSync pipeline resolvers over both sources" },
      { id: 'C', text: "Amazon S3 Event Notifications." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy Amazon Inspector on the S3 bucket." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Gateway Load Balancer endpoints" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Individual IAM users created in each of the 100 AWS accounts." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Amazon ECR Enhanced Scanning (powered by Amazon Inspector)." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "AWS DataSync endpoint rules." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Assign Elastic IP addresses directly to all EC2 instances across all accounts." },
      ...
      { id: 'D', text: "A central VPC whose private subnets are shared through AWS RAM." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Amazon RDS MySQL Multi-AZ." },
      { id: 'C', text: "Amazon Redshift RA3 node types" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create a software RAID 0 array of gp2 volumes." },
      { id: 'B', text: "Switch to Cold HDD (sc1)." },
      { id: 'C', text: "A 500 GB gp3 volume with IOPS set separately" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cost Explorer rightsizing" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon Kinesis Data Streams Provisioned capacity mode with 2 shards." },
      { id: 'B', text: "Amazon Kinesis Data Streams On-Demand capacity mode." },
      { id: 'C', text: "Amazon EventBridge schema discovery." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon S3 Versioning." },
      { id: 'B', text: "Amazon DynamoDB Global Tables." },
      { id: 'C', text: "AWS AppConfig feature flags" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A lifecycle rule expiring noncurrent versions after 30 days." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Composite alarms mapped to a calculated health check" },
