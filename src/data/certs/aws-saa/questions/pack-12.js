export const AWS_SAA_QUESTIONS_12 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure a CloudFront Origin Group containing the primary S3 bucket and secondary S3 bucket, specifying failover criteria for 5xx status codes." },
