export const AWS_SAA_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure AWS DataSync to run a nightly cron job copying EFS to an S3 bucket in us-west-2." },
      { id: 'B', text: "Attach the EFS file system concurrently to EC2 instances across both regions using VPC Peering." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy an Amazon RDS Proxy between AWS Lambda and the RDS database." },
      { id: 'D', text: "Configure Amazon ElastiCache Memcached to store database connection objects." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Elastic Fabric Adapter (EFA)." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "IAM Permissions Boundaries hardcoded with project manager IAM usernames." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Migrate the backend code to an AWS Lambda function fronted by an Amazon API Gateway HTTP API." },
