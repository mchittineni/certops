export const AWS_SAA_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Enable enhanced networking with the ENA driver on those instances" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Convert all Lambda functions from On-Demand to Provisioned Concurrency." },
      ...
      { id: 'D', text: "Deploy an Amazon RDS Proxy between AWS Lambda and the RDS database." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Elastic Network Interface (ENI)." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "S3 Block Public Access at account level" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Attribute-Based Access Control (ABAC) using `aws:PrincipalTag` and `aws:ResourceTag` IAM policy condition keys." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A WAF rate-based rule with a threshold" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An endpoint policy on the gateway endpoint scoped to that bucket ARN." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Transition all objects to S3 Glacier Flexible Retrieval immediately upon upload." },
      { id: 'B', text: "A lifecycle rule aborting incomplete multipart uploads after 7 days." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Launch On-Demand Instances in a Cluster placement group." },
      { id: 'B', text: "Deploy Dedicated Hosts with Bring Your Own License (BYOL)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy the application on an Amazon ECS cluster running on `c6g.large` instances." },
      { id: 'C', text: "Migrate the backend code to an AWS Lambda function fronted by an Amazon API Gateway HTTP API." },
      { id: 'D', text: "Convert the EC2 instances to 3-year All Upfront Reserved Instances." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Create separate IAM groups for each department." },
      { id: 'D', text: "Activate user-defined cost allocation tags in Billing" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Aurora Global Database with secondary clusters replicated at storage level" },
      { id: 'B', text: "Amazon RDS for MySQL with logical binlog cross-region replication." },
      { id: 'C', text: "Hourly Aurora DB cluster snapshots copied cross-region and restored on demand." },
      { id: 'D', text: "AWS Database Migration Service (DMS) continuous CDC replication over a VPN connection." }
    ],
    correctAnswers: ['A'],
    type: "single",
