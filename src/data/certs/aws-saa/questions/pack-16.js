export const AWS_SAA_QUESTIONS_16 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create a separate IAM group and policy for every individual project and update policies on each team change." },
      ...
      { id: 'D', text: "Grant full AdministratorAccess to developers and audit actions after the fact using AWS CloudTrail." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure AWS Systems Manager Session Manager with hardcoded user IP addresses." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create a separate IAM group and policy for every individual project and update policies on each team change." },
      { id: 'B', text: "Grant full AdministratorAccess to developers and audit actions after the fact using AWS CloudTrail." },
      { id: 'C', text: "Implement IAM Attribute-Based Access Control (ABAC) policies using the `aws:PrincipalTag` and `aws:ResourceTag` condition keys." },
