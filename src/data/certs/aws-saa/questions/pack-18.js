export const AWS_SAA_QUESTIONS_18 = [
  {
    ...
    options: [
      { id: 'A', text: "Enable Amazon GuardDuty, create an Amazon EventBridge rule matching GuardDuty finding types, and invoke an AWS Lambda function to attach an isolating security group to the compromised instance." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure a custom domain name on Amazon API Gateway with mutual TLS (mTLS) enabled and upload the trusted CA certificate bundle to an Amazon S3 bucket." },
