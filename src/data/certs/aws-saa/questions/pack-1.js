export const AWS_SAA_QUESTIONS = [
  {
    ...
    options: [
      { id: 'A', text: "Create Amazon RDS Read Replicas in the same or multiple Availability Zones and update the application connection string to route read queries to the replica endpoints." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Assign Elastic IP addresses to all EC2 instances and restrict the S3 bucket policy using aws:SourceIp conditions." },
      ...
      { id: 'D', text: "Create an Amazon S3 Gateway VPC Endpoint in the VPC and update the subnet route tables with a route targeting the gateway endpoint." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Use an Amazon Kinesis Data Firehose delivery stream to write directly to Amazon EBS volumes attached to the web servers." },
      ...
      { id: 'D', text: "Replace the ALB with a Network Load Balancer (NLB) to handle TCP-level backpressure." },
      { id: 'E', text: "Store the uploaded images in an Amazon S3 bucket and send a message containing image metadata to an Amazon SQS standard queue." }
    ],
    correctAnswers: ['B', 'E'],
    type: "multiple",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Transition objects to S3 One Zone-Infrequent Access after 30 days and expire them after 7 years." },
      ...
      { id: 'D', text: "Transition objects to S3 Standard-Infrequent Access after 30 days, to S3 Glacier Deep Archive after 90 days, and expire them after 7 years." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Serve the single-page application through an Amazon CloudFront distribution with the S3 bucket as the origin." },
      { id: 'D', text: "Put AWS Global Accelerator in front of the Application Load Balancer to route dynamic API traffic over the AWS backbone from static anycast IP addresses." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Encrypt the password with AWS KMS, commit the ciphertext to the container image, and rebuild the image monthly." },
      { id: 'C', text: "Store the credential in an SSM Parameter Store String parameter and write a scheduled Lambda function to overwrite it every 30 days." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Three-year all-upfront Reserved Instances sized for the nightly peak." },
      { id: 'B', text: "On-Demand Instances launched and terminated by a scheduled Lambda function." },
      { id: 'C', text: "Spot Instances in an Auto Scaling group with multiple instance types and capacity-optimized allocation." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable RDS automated backups with a longer retention window." },
      ...
      { id: 'D', text: "Increase the RDS allocated storage to raise the provisioned IOPS ceiling." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Use AWS Backup with a 24-hour backup plan and cross-Region copy as the sole replication mechanism." },
      ...
      { id: 'D', text: "Deploy an Aurora global database with a secondary Region read replica cluster, promotable in about a minute." },
      { id: 'E', text: "Run a full active-active multi-Region deployment with both Regions serving live write traffic." }
    ],
    correctAnswers: ['C', 'D'],
    type: "multiple",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A Network Load Balancer with TCP port forwarding rules." },
      { id: 'B', text: "An Application Load Balancer with listener path-based routing rules forwarding to distinct target groups." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy an Amazon CloudFront distribution with the ALB as origin, configure cache behavior with TTL set to 0, and forward all query strings and headers." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Enable S3 ACL public-read on all bucket objects." },
      ...
      { id: 'D', text: "Change the KMS key in Account A to an AWS Managed key (`aws/s3`)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy the websites on an Amazon Aurora Serverless cluster." },
      { id: 'C', text: "Migrate the websites to Amazon EFS mounted by single-node EC2 instances." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Place an Application Load Balancer directly in front of the database." },
      { id: 'B', text: "Upgrade the RDS database instance class to db.x2iedn.32xlarge." },
      { id: 'C', text: "Insert an Amazon SQS standard queue between the web tier and worker fleet, and configure target tracking Auto Scaling based on the `ApproximateNumberOfMessagesVisible` metric." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Add a Deny statement with the Condition `\"Bool\": {\"aws:SecureTransport\": \"false\"}`." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Expedited Retrieval (completes in 1 to 5 minutes)." },
      { id: 'B', text: "Instant Retrieval (completes in milliseconds)." },
      { id: 'C', text: "Standard Retrieval (completes in 3 to 5 hours)." },
      { id: 'D', text: "Bulk Retrieval (completes in 5 to 12 hours at lowest cost or free in some tiers)." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy 2 instances in us-east-1 and 2 instances in eu-west-1." },
      { id: 'B', text: "Deploy the Auto Scaling group in a single Availability Zone with 4 instances." },
      { id: 'C', text: "Deploy the Auto Scaling group across 3 Availability Zones with a minimum of 6 instances (2 per AZ)." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy an additional Aurora Writer instance in another region." },
      { id: 'B', text: "Convert the cluster to an Amazon RDS single-AZ instance." },
      { id: 'C', text: "Configure Aurora Auto Scaling on Aurora Read Replicas with the Reader Endpoint used for application read traffic." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A Deny statement with the Condition `\"NotIpAddress\": {\"aws:SourceIp\": \"198.51.100.0/24\"}`." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Geoproximity Routing policy." },
      { id: 'B', text: "Failover Routing policy." },
      { id: 'C', text: "Simple Routing policy." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The payload size exceeds 10 MB per record; resolve by enabling gzip." },
      { id: 'B', text: "Kinesis Client Library (KCL) is reading too slowly; resolve by adding more consumer EC2 instances." },
      { id: 'C', text: "Kinesis Data Streams only supports 1 shard per AWS account; resolve by migrating to SQS." },
      { id: 'D', text: "The low cardinality of `sensorType` causes all data to hash to only 2 of the 4 shards; resolve by changing the partition key to a high-cardinality attribute like `deviceId` and resharding if necessary." }
    ],
    correctAnswers: ['D'],
    type: "single",
