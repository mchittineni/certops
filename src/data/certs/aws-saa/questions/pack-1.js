export const AWS_SAA_QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Assign Elastic IP addresses to all EC2 instances and restrict the S3 bucket policy using aws:SourceIp conditions." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Standard-IA at 30 days, Deep Archive at 90, expire after 7 years." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Increase the Application Load Balancer idle timeout and enable HTTP keep-alive on the API." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Secrets Manager with automatic rotation, read at runtime by the task role." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Attach an S3 read role to the instance profile for the SDK to use." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Spot in an ASG over several types with capacity-optimized" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Move session state into an ElastiCache for Redis cluster." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Run a full active-active multi-Region deployment with both Regions serving live write traffic." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "An ALB with path-based rules to separate target groups" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Switch from HTTP/2 to HTTP/1.0 on the Application Load Balancer." },
      ...
      { id: 'D', text: "CloudFront over the ALB with TTL 0, forwarding all headers." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Create an AWS Site-to-Site VPN connection between Account A and Account B." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Private S3 buckets behind CloudFront with Origin Access Control." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An SQS queue between the tiers, with Auto Scaling on queue depth." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Bulk retrieval, completing in 5 to 12 hours" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy the Auto Scaling group in a single Availability Zone with 4 instances." },
      { id: 'B', text: "Deploy 4 instances on a single EC2 Dedicated Host." },
      { id: 'C', text: "The Auto Scaling group across three AZs with six instances minimum" },
      { id: 'D', text: "Deploy 2 instances in us-east-1 and 2 instances in eu-west-1." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Aurora Auto Scaling on read replicas behind the reader endpoint" },
      { id: 'C', text: "Increase the Aurora storage volume from 500 GB to 10 TB." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A Network ACL applied to the Amazon S3 gateway." },
      { id: 'D', text: "An Allow statement with the Condition `\"IpAddress\": {\"aws:SourceIp\": \"0.0.0.0/0\"}`." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Low cardinality in `sensorType` uses only two shards; key on `deviceId`." },
