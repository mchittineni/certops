export const AWS_SAA_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Deploy OpenSearch with 3 Availability Zones, 3 Dedicated Master Nodes, and at least 1 replica shard per primary shard." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Amazon RDS Multi-AZ DB Cluster deployment (one primary writer and two readable standby instances across 3 AZs)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Register the consumer applications using Kinesis Enhanced Fan-Out with HTTP/2 streaming." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Route 53 Geoproximity Routing policy with configured routing bias in Route 53 Traffic Flow." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Amazon File Cache (or AWS Storage Gateway S3 File Gateway)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Multiple AWS Transit Gateway Route Tables with specific route table associations and propagations." },
