export const AWS_SAA_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Configure the Amazon SQS queue Delivery Delay (Delay Queue) parameter to 900 seconds (15 minutes).' },
      { id: 'B', text: 'Set the SQS Visibility Timeout to 900 seconds.' },
      { id: 'C', text: 'Set the SQS Message Retention Period to 900 seconds.' },
      { id: 'D', text: 'Set ReceiveMessageWaitTimeSeconds to 900 seconds.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Deploy OpenSearch with 3 Availability Zones, 3 Dedicated Master Nodes, and at least 1 replica shard per primary shard.' },
      { id: 'B', text: 'Deploy a single data node in 1 Availability Zone with automated daily snapshots.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Increase the stream retention period to 365 days.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Route 53 Failover routing policy.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'AWS CloudTrail Insights.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Attach a Security Group to the API Gateway REST API.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Application Load Balancer Mutual TLS (mTLS) with an S3-hosted Trust Store.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Migrate to `c5a` (AMD) instance types only.' },
      { id: 'C', text: 'Convert instances to Dedicated Hosts.' },
      { id: 'D', text: 'Increase instance size to `c5.metal`.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Amazon EFS Provisioned Throughput mode set to 500 MB/s.' },
      { id: 'C', text: 'Amazon EBS io2 Block Express.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Deploy a DAX cluster with a minimum of 3 nodes across 3 Availability Zones (1 primary node and 2 read replicas).' },
      { id: 'B', text: 'Deploy a single DAX node in 1 Availability Zone.' },
      { id: 'C', text: 'Deploy 2 DAX clusters in the same AZ.' },
      { id: 'D', text: 'Enable DynamoDB Global Tables without DAX.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Configure a CloudFront Origin Group with the primary and secondary ALBs and specify failover HTTP status codes (500, 502, 503, 504).' },
      { id: 'B', text: 'Create Route 53 Weighted DNS records pointing to both ALBs.' },
      { id: 'C', text: 'Deploy an AWS Global Accelerator with standard health checks.' },
