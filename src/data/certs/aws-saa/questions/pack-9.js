export const AWS_SAA_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Detach the secondary cluster and promote it to standalone" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Set the queue delivery delay to 900 seconds" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy a single data node in 1 Availability Zone with automated daily snapshots." },
      { id: 'D', text: "Three AZs, three dedicated master nodes and a replica per shard." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "An RDS Multi-AZ DB cluster with two readable standbys across 3 AZs" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy an Amazon ElastiCache cluster in front of Kinesis." },
      { id: 'B', text: "Kinesis enhanced fan-out with HTTP/2 consumers" },
      { id: 'C', text: "Increase the stream retention period to 365 days." },
      { id: 'D', text: "Convert the Kinesis Data Stream to an SQS FIFO queue." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Geoproximity routing with a bias" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Amazon File Cache or an S3 File Gateway" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure Route 53 Geolocation routing." },
      { id: 'B', text: "Attach a Security Group to the API Gateway REST API." },
      { id: 'C', text: "A resource policy allowing only that `aws:sourceVpc`" },
      { id: 'D', text: "Enable API Gateway Standard API Keys." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "AWS WAF client token inspection." },
      { id: 'C', text: "Amazon CloudFront standard HTTPS listener." },
      { id: 'D', text: "ALB mutual TLS with an S3 trust store" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Export the KMS master private key to Account B." },
      { id: 'B', text: "Make the KMS key public in AWS Organizations." },
      { id: 'C', text: "A KMS grant naming the Account B EMR role" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Move to Graviton `c7g` instance types" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon S3 One Zone-IA with Glacier flexible transitions." },
      { id: 'B', text: "Amazon S3 Standard with standard S3 Lifecycle rules." },
      { id: 'C', text: "S3 Intelligent-Tiering with the archive tiers enabled" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon Redshift Provisioned `ra3.4xlarge` cluster." },
      { id: 'B', text: "Amazon DynamoDB On-Demand." },
      { id: 'C', text: "Amazon Redshift Serverless." },
      { id: 'D', text: "Amazon RDS for MySQL single-AZ." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Separate Transit Gateway route tables with propagations" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A three-node DAX cluster across three AZs" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Export the database to Amazon S3 as CSV files and import with AWS DMS." },
      { id: 'B', text: "Share the encrypted snapshot and its CMK, then restore in staging." },
      { id: 'C', text: "Replicate the entire RDS cluster with active Multi-AZ." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A CloudFront origin group over both ALBs with failover codes" },
