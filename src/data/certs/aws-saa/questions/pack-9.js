export const AWS_SAA_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Three AZs, three dedicated master nodes and a replica per shard." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "An RDS Multi-AZ DB cluster with two readable standbys across 3 AZs" },
      { id: 'C', text: "Amazon RDS Multi-AZ DB Instance deployment (one primary and one non-readable standby)." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Kinesis enhanced fan-out with HTTP/2 consumers" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Geoproximity routing with a bias" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS DataSync scheduled batch transfers." },
      { id: 'B', text: "Amazon File Cache or an S3 File Gateway" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A resource policy allowing only that `aws:sourceVpc`" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "ALB mutual TLS with an S3 trust store" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A KMS grant naming the Account B EMR role" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Move to Graviton `c7g` instance types" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "S3 Intelligent-Tiering with the archive tiers enabled" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Amazon Redshift Provisioned `ra3.4xlarge` cluster." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Separate Transit Gateway route tables with propagations" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A three-node DAX cluster across three AZs" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A CloudFront origin group over both ALBs with failover codes" }
    ],
    correctAnswers: ['D'],
    type: "single",
