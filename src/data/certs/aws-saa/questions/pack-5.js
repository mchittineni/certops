export const AWS_SAA_QUESTIONS_5 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy an Application Load Balancer with path-based routing rules between SNS and SQS." },
      { id: 'B', text: "Convert all subscriber queues from SQS standard to SQS FIFO." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "AWS Transit Gateway with IPsec VPN." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "AWS IAM Identity Center (successor to AWS Single Sign-On)." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A Security Group rule attached to the S3 bucket." },
