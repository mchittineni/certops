export const AWS_SAA_QUESTIONS_5 = [
  {
    ...
    options: [
      { id: 'A', text: 'AWS Backup with AWS Backup Vault Lock and cross-account backup copies enabled via AWS Organizations.' },
      { id: 'B', text: 'Amazon S3 Glacier Flexible Retrieval with S3 Object Lock in Governance mode.' },
      { id: 'C', text: 'Amazon Data Lifecycle Manager (DLM) with cross-region snapshot policies.' },
      { id: 'D', text: 'Custom AWS Lambda backup scripts orchestrated by AWS Step Functions.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Configure Amazon SNS Subscription Filter Policies on each subscriber SQS queue based on event message attributes.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Amazon ElastiCache for Memcached with multi-AZ replication.' },
      { id: 'D', text: 'Amazon DynamoDB Accelerator (DAX) with a single node.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Configure CloudFront to forward all headers and increase Default TTL to 86400 seconds.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Amazon Simple Workflow Service (SWF).' },
      { id: 'D', text: 'Amazon Managed Workflows for Apache Airflow (MWAA).' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Configure Route 53 Weighted routing to two independent standalone RDS instances.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'AWS App Mesh with Envoy sidecar proxies.' },
      { id: 'B', text: 'AWS Transit Gateway with IPsec VPN.' },
      { id: 'C', text: 'Network Load Balancers in front of every individual ECS container.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Create an AWS Secrets Manager Interface VPC Endpoint (AWS PrivateLink) in the VPC.' },
      ...
      { id: 'C', text: 'Create an Amazon S3 Gateway VPC Endpoint and store credentials in encrypted CSV files.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'AWS Directory Service Simple AD.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'A Deny statement with the Condition `"StringNotEquals": {"aws:sourceVpce": "vpce-12345abcde"}`.' },
      { id: 'B', text: 'An Allow statement with the Condition `"StringEquals": {"aws:SourceIp": "10.0.0.0/16"}`.' },
      { id: 'C', text: 'A Security Group rule attached to the S3 bucket.' },
      { id: 'D', text: 'A Network ACL rule applied to the VPC endpoint route table.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'AWS IAM Database Authentication.' },
      { id: 'D', text: 'Application Load Balancer Path-based authentication.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Transition to S3 Standard-IA after 30 days, transition to S3 Glacier Flexible Retrieval after 90 days, and expire after 1,825 days (5 years).' },
      { id: 'B', text: 'Keep in S3 Standard for 5 years, then enable S3 Versioning.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Create one or more RDS Read Replicas and point read-heavy reporting queries to the replica endpoints.' },
      { id: 'C', text: 'Deploy the RDS instance in a single Availability Zone and configure hourly automated snapshots.' },
      { id: 'D', text: 'Convert the RDS database to an Amazon S3 static table.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Modify the live EBS volume attributes in the AWS console and select the KMS key.' },
      { id: 'C', text: 'Attach an AWS KMS policy directly to the operating system filesystem.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Create a central VPC in a Network account and share subnets with all 40 member accounts using AWS Resource Access Manager (AWS RAM) VPC Sharing.' },
      { id: 'B', text: 'Create 40 VPC Peering connections between each account and an on-premises data center.' },
      { id: 'C', text: 'Deploy an AWS Direct Connect dedicated circuit in every member account.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'FSx for OpenZFS ZFS Snapshots and on-demand Cross-Region Snapshot Copy / Replication.' },
