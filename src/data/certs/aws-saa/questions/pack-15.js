export const AWS_SAA_QUESTIONS_15 = [
  {
    ...
    options: [
      { id: 'A', text: "Stage response caching with a TTL and query strings as cache keys." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Stage response caching with a TTL and query strings as cache keys." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Enable API Gateway stage response caching with a configured TTL and define query string parameters as cache keys. API Gateway stage caching caches responses from backend integrations for a configurable Time to Live (TTL) period in seconds. Subsequent identical client requests are served directly from the API Gateway cache without invoking backend Lambda functions, drastically reducing latency and compute costs.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy an Amazon ElastiCache for Memcached cluster in front of API Gateway." },
      { id: 'D', text: "Increase Lambda function memory to 10,240 MB to execute GET requests faster." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which architecture or service configuration satisfies these disaster recovery and regional resilience requirements?",
    options: [
      { id: 'A', text: "Register each consumer application as an Enhanced Fan-Out consumer using the HTTP/2 SubscribeToShard API." },
      { id: 'B', text: "Deploy an intermediate Amazon SQS queue between Kinesis and each consumer." },
      { id: 'C', text: "Increase the number of Kinesis shards by a factor of 10 to provide extra read capacity." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Register each consumer application as an Enhanced Fan-Out consumer using the HTTP/2 SubscribeToShard API." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Increase the number of Kinesis shards by a factor of 10 to provide extra read capacity." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Register each consumer application as an Enhanced Fan-Out consumer using the HTTP/2 SubscribeToShard API. Kinesis Enhanced Fan-Out gives each registered consumer application its own dedicated 2 MB/sec read throughput per shard using an HTTP/2 connection (`SubscribeToShard`), eliminating contention among consumers and reducing end-to-end propagation latency to roughly 70 milliseconds.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Switch the Lambda runtime from Python to Java without SnapStart enabled." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Provisioned concurrency on the Lambda alias behind the ALB" },
      { id: 'C', text: "Increase the Lambda ephemeral storage (/tmp) to 10 GB." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Provisioned concurrency on the Lambda alias behind the ALB" },
      { id: 'B', text: "Increase the Lambda ephemeral storage (/tmp) to 10 GB." },
  ...
  },
  {
    ...
    question: "Which architecture or service configuration satisfies these disaster recovery and regional resilience requirements?",
    options: [
      { id: 'A', text: "Deploy an Amazon RDS Proxy between the Lambda functions and the Amazon RDS PostgreSQL instance." },
      { id: 'B', text: "Increase the memory size of each Lambda function to 10,240 MB." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Increase the memory size of each Lambda function to 10,240 MB." },
      { id: 'D', text: "Deploy an Amazon RDS Proxy between the Lambda functions and the Amazon RDS PostgreSQL instance." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Deploy an Amazon RDS Proxy between the Lambda functions and the Amazon RDS PostgreSQL instance. Amazon RDS Proxy maintains an established pool of connections to the database and multiplexes thousands of incoming connections from ephemeral Lambda instances onto a controlled number of database connections, preventing connection exhaustion and memory depletion on PostgreSQL or MySQL.",
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Initialize a new database connection inside the Lambda handler function on every single invocation." },
