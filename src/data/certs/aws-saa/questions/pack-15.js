export const AWS_SAA_QUESTIONS_15 = [
  {
    ...
    options: [
      { id: 'A', text: "Enable API Gateway stage response caching with a configured TTL and define query string parameters as cache keys." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable Concurrency Scaling on the Amazon Redshift cluster workload management (WLM) query queue." },
      { id: 'B', text: "Deploy Amazon Aurora MySQL read replicas to offload analytical SQL reporting." },
      { id: 'C', text: "Migrate the Redshift cluster from RA3 node types to Dense Storage (ds2) node types." },
