export const AWS_SAA_QUESTIONS_20 = [
  {
    ...
    options: [
      { id: 'A', text: "A NoncurrentVersionExpiration rule deleting old versions at 30 days." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Enable MFA Delete on the S3 bucket to prevent object versioning." },
      { id: 'C', text: "Configure an S3 Lifecycle rule with an Expiration action on current versions." },
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Deploy an AWS CloudWatch metric alarm on the EstimatedCharges billing metric." },
      { id: 'B', text: "Configure AWS Budgets with a fixed monthly forecast threshold only." },
      { id: 'C', text: "Cost Anomaly Detection across all services with an SNS subscription." },
      { id: 'D', text: "Review the AWS Monthly Billing invoice PDF manually at the end of each billing cycle." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Configure AWS Cost Anomaly Detection with a cost monitor across all AWS services and create an alert subscription linked to an Amazon SNS topic. AWS Cost Anomaly Detection uses machine learning to continually monitor billing and usage patterns, detecting abnormal spending spikes in real time. It automatically performs root-cause analysis identifying the account, service, region, and usage type responsible and alerts teams via SNS or email.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure an Auto Scaling group with a minimum capacity of 0 instances." },
      { id: 'C', text: "Activate AWS Compute Optimizer across the AWS Organization to evaluate historical CloudWatch utilization metrics and implement rightsizing recommendations." },
  ...
  },
  {
    ...
    question: "Which architecture or service configuration satisfies these disaster recovery and regional resilience requirements?",
    options: [
      { id: 'A', text: "Attach an Amazon S3 bucket to the EC2 instances using S3FS." },
      { id: 'B', text: "Migrate existing EBS gp2 volumes to General Purpose SSD (gp3) volumes using Amazon EBS Elastic Volumes without instance downtime." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Migrate existing EBS gp2 volumes to General Purpose SSD (gp3) volumes using Amazon EBS Elastic Volumes without instance downtime." },
      { id: 'B', text: "Migrate EBS gp2 volumes to Cold HDD (sc1) magnetic storage volumes." },
      { id: 'C', text: "Attach an Amazon S3 bucket to the EC2 instances using S3FS." },
      { id: 'D', text: "Migrate EBS gp2 volumes to Provisioned IOPS SSD (io2) volumes." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy a larger NAT Gateway instance type to increase data processing efficiency." },
      { id: 'C', text: "Assign public IP addresses to all private EC2 instances and route traffic through an Internet Gateway." },
      { id: 'D', text: "Deploy an Interface VPC Endpoint (AWS PrivateLink) for Amazon S3 in each private subnet." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which solution enables a robust, highly available architecture while minimizing ongoing operational overhead?",
    options: [
      { id: 'A', text: "Assign public IP addresses to all private EC2 instances and route traffic through an Internet Gateway." },
      { id: 'B', text: "Deploy a larger NAT Gateway instance type to increase data processing efficiency." },
      { id: 'C', text: "Deploy an Interface VPC Endpoint (AWS PrivateLink) for Amazon S3 in each private subnet." },
      { id: 'D', text: "Create a Gateway VPC Endpoint for Amazon S3, associate it with the private subnet route tables, and route S3 traffic directly over the AWS private network." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Create a Gateway VPC Endpoint for Amazon S3, associate it with the private subnet route tables, and route S3 traffic directly over the AWS private network. Gateway VPC Endpoints for Amazon S3 and Amazon DynamoDB are provided at no additional cost and incur zero data processing charges. Routing private subnet traffic through Gateway VPC Endpoints bypasses NAT Gateways completely, eliminating heavy per-GB NAT Gateway data processing fees.",
