export const AWS_SAA_QUESTIONS_6 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Same-region replication with ownership override" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Application Recovery Controller routing controls" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Scheduled scaling plus target tracking on CPU" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Lambda@Edge rewriting `request.origin`" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Split shards 3 and 7 to double the hot key capacity" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "EventBridge Pipes from the stream, filtered and enriched, to SQS." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "S3 Object Lock in compliance mode for 7 years" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A PrivateLink endpoint service behind an NLB, consumed by interface endpoints." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Download the KMS master private key to the application server and encrypt the file locally with OpenSSL." },
      { id: 'B', text: "`GenerateDataKey`, encrypt locally, erase the plaintext key, store the rest." },
      { id: 'C', text: "Call `kms:Encrypt` passing the entire 5 GB file payload directly to KMS." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A CloudTrail Lake data store" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A WAF geo match blocking countries other than US and CA" },
      { id: 'D', text: "Network ACL rules with geographical country code filters." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "All data in Amazon EBS gp3 volumes attached to stopped EC2 instances." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Enable DynamoDB Time to Live (TTL) on an epoch timestamp attribute (`expiresAt`)." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A Transit Gateway in each region with an inter-region peering attachment." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A Distributed Map over S3 objects with item-level error handling." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable CloudFront Geographic Restrictions." },
      { id: 'B', text: "Configure CloudFront Price Class All." },
      { id: 'C', text: "CloudFront Price Class 100 edge locations" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "ECR and logs on the task execution role; DynamoDB and secrets on the task role." }
    ],
    correctAnswers: ['D'],
    type: "single",
