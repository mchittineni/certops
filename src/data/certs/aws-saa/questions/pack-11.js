export const AWS_SAA_QUESTIONS_11 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Cross-region replication with RTC, the destination KMS key and role permissions." },
  ...
  },
  {
    ...
    question: "Which architecture or service configuration satisfies these disaster recovery and regional resilience requirements?",
    options: [
      { id: 'A', text: "Delete the Route 53 alias record pointing to the failed region Application Load Balancer." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Route 53 ARC routing control states tied to regional health checks." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Configure Route 53 Application Recovery Controller (ARC) routing control states integrated with regional health checks. Route 53 ARC routing controls provide highly reliable, redundant control plane endpoints that immediately toggle regional traffic flow by altering health check states associated with DNS records, bypassing DNS caching delays. Low TTLs are frequently cached or ignored by downstream resolvers. Deleting records or stacks causes ungraceful failures.",
  ...
  },
  {
    ...
    question: "Which architectural approach should the solutions architect recommend to accommodate this scale?",
    options: [
      { id: 'A', text: "Configure an S3 Glacier Flexible Retrieval archive with a customer-managed bucket policy." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure an S3 Glacier Flexible Retrieval archive with a customer-managed bucket policy." },
      { id: 'C', text: "Configure AWS Backup Vault Lock in compliance mode with minimum and maximum retention periods." },
      { id: 'D', text: "Attach an IAM permissions boundary policy to the AWS account root user." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A terminating lifecycle hook that drains, then completes the action." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Increase the Auto Scaling group Default Cooldown period to 900 seconds." },
      { id: 'C', text: "Modify the Auto Scaling group termination policy to prioritize OldestInstance." },
      { id: 'D', text: "A terminating lifecycle hook that drains, then completes the action." }
    ],
    correctAnswers: ['D'],
    type: "single",
