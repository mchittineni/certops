export const AZURE_AZ104_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Cost Anomaly Alerts in Microsoft Cost Management." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Microsoft Entra B2B Guest accounts." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Enable Large File Shares (100 TiB support) on the storage account." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Hardcode the VHD URL of a storage blob." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure Container Apps secrets with Key Vault references using a Managed Identity." },
      { id: 'C', text: "Hardcode secrets in the Dockerfile." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Accelerated Networking." },
      { id: 'D', text: "IP Forwarding." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Public Peering for all workloads." },
