export const AZURE_AZ104_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Microsoft Entra B2B Guest accounts." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Set \"Public network access\" to \"Enabled from selected virtual networks\"." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Enable Hierarchical Namespace." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable Accelerated Networking only." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hardcode secrets in the Dockerfile." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Connection draining only." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Network Watcher Topology." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "1 to 30 days." },
      { id: 'B', text: "30 to 365 days." },
      { id: 'C', text: "1 to 5 days." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Data Collection Rule (DCR) with an ingestion transformation KQL query (`transformKql`)." },
