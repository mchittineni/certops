export const AZURE_AZ104_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Microsoft Entra B2B Guest accounts." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The base blob is locked and cannot be edited." },
      { id: 'C', text: "The snapshot is updated to match the base blob." },
      { id: 'D', text: "It stays unchanged; only deltas cost extra" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Enable large file shares on the account" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Stored Access Policy SAS." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The image definition ID with version `latest`" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Make the Azure Container Registry public." },
      { id: 'B', text: "A managed identity with `AcrPull` on the registry" },
      { id: 'C', text: "Store the ACR admin password in plain text in App Settings." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable IP forwarding on the NIC" },
      { id: 'B', text: "Assign a Dynamic Public IP." },
      { id: 'C', text: "Enable Azure Bastion." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Container Apps secrets as Key Vault references" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Connection draining only." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An Azure DNS alias record" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Private peering for VNets, Microsoft peering for PaaS" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Backup vault snapshot." },
      { id: 'B', text: "Azure Activity Log export." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Advisor security check." },
      { id: 'C', text: "An activity log alert on role assignments" },
