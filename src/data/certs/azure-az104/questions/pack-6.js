export const AZURE_AZ104_QUESTIONS_6 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Add an Azure ABAC role assignment condition filter specifying container name and blob index tag attributes when assigning the role.' },
      { id: 'B', text: 'Create separate storage accounts for each project.' },
      { id: 'C', text: 'Assign the Reader role at the Resource Group scope.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Navigate to "Deleted shares" in the Azure portal, select the deleted share, and click "Undelete".' },
      { id: 'B', text: 'Restore from an on-premises tape backup.' },
      { id: 'C', text: 'Recreate the storage account using the original name.' },
      { id: 'D', text: 'Open a Microsoft Support ticket and wait 48 hours.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Configure Diagnostic Settings on the Storage Account (Blob service) targeting the Log Analytics workspace.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Azure Bastion tunneling.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Effective Security Rules on the Network Interface.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Azure Virtual WAN (Standard tier) with secure virtual hubs.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'OpenVPN protocol with Microsoft Entra ID authentication.' },
      { id: 'B', text: 'SSTP protocol with self-signed root certificates.' },
      { id: 'C', text: 'IKEv2 protocol with RADIUS username/password only.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Alert Processing Rules configured with "Suppress notifications" during the scheduled time window.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Soft Delete with 14-day retention.' },
      { id: 'C', text: 'Azure Storage Account SAS token.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Set Interactive retention to 2,555 days.' },
