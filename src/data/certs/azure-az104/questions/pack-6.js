export const AZURE_AZ104_QUESTIONS_6 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Advisor scorecard." },
      { id: 'B', text: "Azure Log Analytics workspace." },
      { id: 'C', text: "Azure Activity Log." },
      { id: 'D', text: "Azure Resource Graph (ARG) Explorer." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Key Vault password generator." },
      { id: 'C', text: "Self-Service Password Reset without agents." },
      { id: 'D', text: "Password Protection with a banned list" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Enable Hierarchical Namespace (HNS)." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Recreate the storage account using the original name." },
      { id: 'B', text: "Open a Microsoft Support ticket and wait 48 hours." },
      { id: 'C', text: "Undelete it from the Deleted shares view" },
      { id: 'D', text: "Restore from an on-premises tape backup." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Storage Metrics." },
      { id: 'B', text: "Azure Blob Storage Inventory." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Create an Azure Queue Storage endpoint." },
      { id: 'C', text: "Deploy an Azure Linux VM running OpenSSH in front of Blob storage." },
      { id: 'D', text: "Enable SFTP on the storage account with local users and SSH keys" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Diagnostic settings on the blob service" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Premium SSD Managed Disks." },
      { id: 'C', text: "Ultra Disks." },
      { id: 'D', text: "Ephemeral OS Disks." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Azure Serial Console." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Bastion tunneling." },
      { id: 'B', text: "Regional VNet Integration with public IP routing." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Automatic OS image upgrades" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A multi-site listener" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Full mesh of 4,950 VNet Peering connections." },
      { id: 'C', text: "Azure Virtual WAN with secure virtual hubs" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "SSTP protocol with self-signed root certificates." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "An alert processing rule suppressing notifications" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "An immutable vault with lock" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "90 days interactive, 2,555 days total" }
    ],
    correctAnswers: ['D'],
    type: "single",
