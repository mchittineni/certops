export const AZURE_AZ104_QUESTIONS_6 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Management Group tags." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Azure Advisor scorecard." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Azure Blob Storage Inventory." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Enable Ingress and set the Ingress type to \"Accepting traffic from anywhere\" (External Ingress)." },
      { id: 'D', text: "Disable Ingress completely." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Bastion without VPN." },
