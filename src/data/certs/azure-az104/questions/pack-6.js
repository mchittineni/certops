export const AZURE_AZ104_QUESTIONS_6 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Add an Azure ABAC role assignment condition filter specifying container name and blob index tag attributes when assigning the role." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Microsoft Entra Password Protection with a Custom Banned Password List." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Navigate to \"Deleted shares\" in the Azure portal, select the deleted share, and click \"Undelete\"." },
      { id: 'C', text: "Open a Microsoft Support ticket and wait 48 hours." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Backup vault report." },
      { id: 'B', text: "Azure Monitor Log Analytics workspace." },
      { id: 'C', text: "Azure Blob Storage Inventory." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create an Azure Queue Storage endpoint." },
      ...
      { id: 'D', text: "Deploy an Azure Linux VM running OpenSSH in front of Blob storage." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Enable Classic Storage Analytics logging only." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Premium SSD Managed Disks." },
      { id: 'B', text: "Standard HDD Managed Disks." },
      { id: 'C', text: "Ephemeral OS Disks." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Azure App Service Hybrid Connections (powered by Azure Relay)." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable Ingress and set the Ingress type to \"Accepting traffic from anywhere\" (External Ingress)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "IKEv2 protocol with RADIUS username/password only." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deleting the Action Group during the maintenance window." },
      { id: 'B', text: "Alert Processing Rules configured with \"Suppress notifications\" during the scheduled time window." },
      { id: 'C', text: "Disabling all Metric Alert rules manually." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Activity Log alerts." },
      { id: 'D', text: "Availability Web Tests." }
    ],
    correctAnswers: ['A'],
    type: "single",
