export const AZURE_AZ104_QUESTIONS_4 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Microsoft Entra Access Reviews." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "App Service Certificate purchased via GoDaddy." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Event Hubs stream only." },
      { id: 'B', text: "Classic Application Insights (deprecated)." },
      { id: 'C', text: "Azure Storage Blob table." },
      { id: 'D', text: "Workspace-based Application Insights resource." }
    ],
    correctAnswers: ['D'],
    type: "single",
