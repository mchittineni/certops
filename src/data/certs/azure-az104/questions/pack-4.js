export const AZURE_AZ104_QUESTIONS_4 = [
  {
    ...
    options: [
      { id: 'A', text: 'Microsoft Entra Access Reviews.' },
      { id: 'B', text: 'Azure Policy initiative.' },
      { id: 'C', text: 'Microsoft Entra Terms of Use.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'The subscription has exceeded its resource quota.' },
      { id: 'D', text: 'The administrator must activate the User Access Administrator role first.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: '`Actions` section specifying `Microsoft.Storage/storageAccounts/*`.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'The VM must be recreated and all disk data is lost.' },
      { id: 'C', text: 'The VM is duplicated in both resource groups.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Administrative Units with dynamic device rules.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Storage Account Resource Locks.' },
      { id: 'D', text: 'Static Website Hosting.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Anonymous public read access.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Azure Front Door (or Azure CDN) with custom domain and managed SSL.' },
      { id: 'B', text: 'Azure Network Security Group.' },
      { id: 'C', text: 'Azure Virtual Network NAT Gateway.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Read-Access Geo-Redundant Storage (RA-GRS) or RA-GZRS.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Azure Data Studio.' },
      { id: 'C', text: 'Remote Desktop Connection.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Azure VM Auto-Shutdown feature.' },
      { id: 'B', text: 'Azure Resource Locks.' },
      { id: 'C', text: 'Azure Policy with Deny effect.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Self-signed certificate uploaded to Key Vault.' },
      { id: 'C', text: 'App Service Certificate purchased via GoDaddy.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'AKS Cluster Autoscaler.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'No, because VNet Peering is non-transitive by default.' },
      { id: 'B', text: 'Yes, because VNet Peering is fully transitive.' },
      { id: 'C', text: 'Yes, if all VNets are in the same resource group.' },
      { id: 'D', text: 'Yes, if Network Security Groups permit port 80.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'All inbound traffic from within the Virtual Network (`AllowVNetInBound`) and Azure Load Balancers (`AllowAzureLoadBalancerInBound`) is allowed; all other inbound traffic is denied (`DenyAllInBound`).' },
      { id: 'B', text: 'All inbound traffic from the public internet is allowed by default.' },
      { id: 'C', text: 'All inbound and outbound traffic is completely blocked.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Deploy an ExpressRoute Gateway and a Route-Based VPN Gateway in the `GatewaySubnet`, configuring both to advertise identical routes over BGP.' },
      { id: 'B', text: 'Deploy two `GatewaySubnet` subnets in the VNet.' },
      { id: 'C', text: 'Configure Policy-Based VPN with static routes only.' },
      { id: 'D', text: 'Deploy Azure Bastion in the GatewaySubnet.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Packets are routed to the `Virtual appliance` (`10.0.1.4`) because `192.168.1.0/24` is a longer prefix match (more specific route) than `192.168.0.0/16`.' },
      { id: 'B', text: 'Packets are routed to the `Virtual network gateway` because system routes take precedence over UDRs.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Azure Public Load Balancer with port forwarding.' },
      { id: 'C', text: 'Azure VNet Peering with Gateway Transit.' },
      { id: 'D', text: 'Azure Virtual WAN.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Workspace-based Application Insights resource.' },
      { id: 'B', text: 'Classic Application Insights (deprecated).' },
      { id: 'C', text: 'Azure Storage Blob table.' },
      { id: 'D', text: 'Azure Event Hubs stream only.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Azure Status page (public).' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Define a single Azure Backup Policy with configured Daily, Weekly, Monthly, and Yearly Grandfather-Father-Son (GFS) retention rules.' },
      { id: 'B', text: 'Create 4 separate Recovery Services Vaults in different regions.' },
      { id: 'C', text: 'Write a custom PowerShell script using Cron.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Azure Monitor Metrics Explorer.' },
