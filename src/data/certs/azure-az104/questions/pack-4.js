export const AZURE_AZ104_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deny assignments override every role assignment, Owner included." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "They move intact but the resource IDs change." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Policy with Modify effect." },
      { id: 'B', text: "Azure Key Vault secret rotation." },
      { id: 'C', text: "A user risk policy requiring a password change" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Front Door with managed SSL" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Read-access geo-redundant storage" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Azure Compute Gallery" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "VNet and load balancer inbound allowed; all else denied." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "To the virtual appliance: `192.168.1.0/24` is the longer prefix match." },
      { id: 'B', text: "Packets are dropped due to routing conflict." },
      { id: 'C', text: "Packets are routed to the `Virtual network gateway` because system routes take precedence over UDRs." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Public Load Balancer with port forwarding." },
      { id: 'B', text: "A Private Link service on the load balancer" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "One backup policy with GFS retention rules" },
      { id: 'B', text: "Write a custom PowerShell script using Cron." },
      { id: 'C', text: "Create 4 separate Recovery Services Vaults in different regions." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Network Watcher Topology." },
