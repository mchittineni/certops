export const AZURE_AZ104_QUESTIONS_8 = [
  {
    ...
    options: [
      { id: 'A', text: 'Microsoft Entra Terms of Use integrated with a Conditional Access policy.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Assign the Virtual Machine Contributor role individually on each VM.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: '`az policy assignment create`' },
      { id: 'C', text: '`az resource lock create`' },
      { id: 'D', text: '`az monitor alert create`' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Up to 6 levels of depth (excluding the Root level).' },
      { id: 'B', text: 'Up to 2 levels of depth.' },
      { id: 'C', text: 'Unlimited levels of depth.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Stored Access Policy on the container.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Tiered files are represented as local NTFS sparse files (reparse points) containing only metadata and a pointer to Azure Files, downloading on-demand when opened.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Set "Minimum TLS version" to `Version 1.2` in the storage account configuration.' },
      { id: 'B', text: 'Enable Storage Account Soft Delete.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Configure a static IP address manually inside the guest OS network adapter settings.' },
      { id: 'C', text: 'Keep Private IP allocation as `Dynamic`.' },
      { id: 'D', text: 'Assign a Public IP address to the NIC.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'App Service Premium v3 Plan.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Generation 2 (Gen2) Virtual Machines.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Azure DNS CNAME records.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Cookie-based session affinity.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Azure Virtual Network NAT Gateway (VNet NAT Gateway).' },
      { id: 'B', text: 'Azure Standard Load Balancer outbound rules.' },
      { id: 'C', text: 'Azure Basic Load Balancer.' },
      { id: 'D', text: 'Instance-level public IPs.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Create a single Azure Public DNS Zone with private IP records.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Azure Storage Archive export.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'ASR Recovery Plans (with Failover Groups and Azure Automation runbook actions).' },
      { id: 'B', text: 'Azure Backup Enhanced Policies.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Static Metric Alert rules.' },
