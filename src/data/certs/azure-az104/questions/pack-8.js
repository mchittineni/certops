export const AZURE_AZ104_QUESTIONS_8 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Terms of Use with Conditional Access" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Virtual Machine Contributor scoped to that resource group" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Authenticator, SMS, voice, email and security questions" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Six levels below the root" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "1) Page Blobs, 2) Block Blobs, 3) Append Blobs." },
      { id: 'B', text: "1) Append Blobs, 2) Page Blobs, 3) Block Blobs." },
      { id: 'C', text: "1) Block Blobs, 2) Block Blobs, 3) Block Blobs." },
      { id: 'D', text: "1) Block Blobs, 2) Page Blobs, 3) Append Blobs." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A CORS rule with that allowed origin" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Tiered files become sparse reparse points, recalled on open." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set the minimum TLS version to 1.2" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Traffic splitting across revisions" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An SSL profile with a client CA chain" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A private DNS zone linked to the VNet plus the public zone" },
      { id: 'B', text: "Deploy an Azure Bastion host." },
      { id: 'C', text: "Configure VNet Peering with Gateway Transit." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Static Metric Alert rules." },
      { id: 'D', text: "Activity Log Alert rules." }
    ],
    correctAnswers: ['B'],
    type: "single",
