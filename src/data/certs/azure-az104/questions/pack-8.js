export const AZURE_AZ104_QUESTIONS_8 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "1) Block Blobs, 2) Page Blobs, 3) Append Blobs." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Blob-level (Object-level) Immutability policy." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "App Service Free Plan." },
