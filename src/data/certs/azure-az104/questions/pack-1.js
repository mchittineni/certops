export const AZURE_AZ104_QUESTIONS_1 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Manually delete and recreate the 150 Key Vaults.' },
      { id: 'C', text: 'Change the policy effect from `Modify` to `Deny`.' },
      { id: 'D', text: 'Deploy an Azure Resource Lock on the subscriptions.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'A `CanNotDelete` (Delete) lock.' },
      { id: 'B', text: 'A `ReadOnly` (Read-Only) lock.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Create separate Microsoft Entra ID tenants for each country.' },
      { id: 'C', text: 'Assign the Helpdesk Administrator role at the Tenant root scope.' },
      { id: 'D', text: 'Deploy Azure Management Groups with subscription RBAC.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Azure File Sync Cloud Tiering.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Deploy an Azure Storage Data Box Gateway.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Create an ad-hoc User Delegation SAS with a 30-day expiration.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Framework runtime versions and virtual directory paths.' },
      { id: 'D', text: 'HTTP 2.0 configuration toggle.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Disable virtual network peering and deploy an ExpressRoute circuit.' },
      { id: 'E', text: 'Deploy an Azure Bastion host in the Spoke VNet.' }
    ],
    correctAnswers: ['A', 'B'],
    type: 'multiple',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Assign public IP addresses to all database VMs.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Azure Bastion deployed in a dedicated `AzureBastionSubnet`.' },
      { id: 'B', text: 'Azure VPN Gateway Point-to-Site.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Create a Recovery Services Vault in North Europe and enable Azure Backup.' },
