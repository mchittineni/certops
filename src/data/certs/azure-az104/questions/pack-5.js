export const AZURE_AZ104_QUESTIONS_5 = [
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Configure an Azure Bastion host.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Use an `allOf` condition with `field: "Microsoft.Compute/virtualMachines/sku.name", notIn: "[parameters(\'allowedSizes\')]"` and `field: "tags.Environment", notEquals: "Benchmark"`, with an `Audit` effect.' },
      { id: 'B', text: 'Use a `Deny` effect with `anyOf` on all subscriptions.' },
      { id: 'C', text: 'Create an Azure RBAC role with NotActions on VM SKU.' },
      { id: 'D', text: 'Deploy an Azure Resource Lock on the benchmark resource group.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Company Branding in the Microsoft Entra admin center.' },
      { id: 'B', text: 'Azure App Service Custom Domains.' },
      { id: 'C', text: 'Azure Front Door web designer.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Convert the storage account to LRS.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Azure Backup downloads the backup archive from cold secondary storage.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Standard priority rehydration.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Azure Key Vault secret retrieval.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Azure Policy with Modify effect.' },
      { id: 'C', text: 'App Service Custom Script extension.' },
      { id: 'D', text: 'Azure Resource Locks.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Azure Container Registry Standard SKU.' },
      { id: 'C', text: 'Azure Container Registry Basic SKU.' },
      { id: 'D', text: 'Azure Storage General-Purpose v2.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Traffic is routed over the public internet through a NAT Gateway.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: '`Detection` mode.' },
      { id: 'B', text: '`Prevention` mode.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Standard Load Balancer Outbound Rules.' },
      { id: 'B', text: 'Inbound NAT Rules.' },
      { id: 'C', text: 'Load Balancing Rules with default outbound.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: '`Heartbeat | summarize LastCall = max(TimeGenerated) by Computer | where LastCall < ago(10m)`' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Azure Boot Diagnostics.' },
      { id: 'B', text: 'Azure Network Watcher IP Flow Verify.' },
