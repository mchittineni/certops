export const AZURE_AZ104_QUESTIONS_5 = [
  {
    ...
    options: [
      { id: 'A', text: "A system-assigned identity on the VM with Key Vault Secrets User." },
      { id: 'B', text: "Assign the Owner role to the VM administrator." },
      { id: 'C', text: "Configure an Azure Bastion host." },
      { id: 'D', text: "Register a service principal and store its client secret in app settings." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Azure cost allocation rules" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Front Door web designer." },
      { id: 'B', text: "Azure Resource Manager templates." },
      { id: 'C', text: "Azure App Service Custom Domains." },
      { id: 'D', text: "Company branding in Entra ID" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Switch to `key2`, regenerate `key1`, then reverse." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It restores from the local file share snapshot directly." },
      { id: 'B', text: "Azure Backup converts the file share into a VM managed disk." },
      { id: 'C', text: "Azure Backup downloads the backup archive from cold secondary storage." },
      { id: 'D', text: "Azure Backup requires creating a new storage account." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Import/Export Service." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Blob Index Tags." },
      { id: 'B', text: "Blob Metadata properties only." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Enable Azure Disk Encryption." },
      { id: 'C', text: "Bring it online, initialize, then format NTFS" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Spot VMs with an eviction policy" },
      { id: 'C', text: "Pay-As-You-Go Standard Instances." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The Azure VM Run Command" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "App Service Auto-Heal rules" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Container Registry Standard SKU." },
      { id: 'B', text: "Azure Storage General-Purpose v2." },
      { id: 'C', text: "Azure Container Registry Basic SKU." },
      { id: 'D', text: "Azure Container Registry Premium SKU." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Traffic is routed over the public internet through a NAT Gateway." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Inbound NAT Rules." },
      { id: 'B', text: "Load Balancing Rules with default outbound." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Standard SKU (or Premium SKU)." },
      { id: 'B', text: "Basic SKU." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "`Heartbeat | where TimeGenerated > ago(10m) | project Computer`" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A test failover into an isolated VNet" },
      { id: 'C', text: "Perform a Planned Failover." },
      { id: 'D', text: "Disable replication and recreate the VMs." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Network Watcher IP Flow Verify." },
      { id: 'B', text: "Azure Boot Diagnostics." },
      { id: 'C', text: "Azure Policy compliance." },
