export const AZURE_AZ104_QUESTIONS_5 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Enable a System-assigned Managed Identity on the VM and grant it Key Vault Secrets User permissions in Key Vault." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Azure Cost Allocation rules in Microsoft Cost Management." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Backup converts the file share into a VM managed disk." },
      ...
      { id: 'D', text: "Azure Backup restores directly from the local Azure File Share snapshot without transferring data over the network." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Azure Blob Index Tags." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Restart the virtual machine from the Azure portal." },
      { id: 'D', text: "Enable Azure Disk Encryption." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Public DNS Zones." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Free Tier." },
      { id: 'B', text: "Standard SKU (or Premium SKU)." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Blob Lifecycle Policy." },
      { id: 'B', text: "Enhanced Backup Policy." },
      { id: 'C', text: "Standard Backup Policy (Legacy)." },
