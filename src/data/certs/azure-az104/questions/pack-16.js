export const AZURE_AZ104_QUESTIONS_16 = [
  {
    ...
    options: [
      ...
      { id: 'D', text: "Convert the web application into an Azure Storage static website." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy the container group with the restart policy configured as 'Always'." },
      { id: 'C', text: "Deploy the container to Azure Kubernetes Service as an infinite loop daemon." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy the container group with the restart policy configured as 'Never'." },
      { id: 'D', text: "Deploy the container group with the restart policy configured as 'Always'." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Deploy the container group with the restart policy configured as 'Never'. Azure Container Instances supports three restart policies: 'Always' (default, for web servers and long-running services), 'OnFailure' (restarts only if the process exits with a non-zero code), and 'Never' (for batch processing or run-to-completion tasks that should run once and terminate).",
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Deploy the container group with the restart policy configured as 'Always'." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy the container group with the restart policy configured as 'Never'." },
      { id: 'B', text: "Deploy the container to Azure Kubernetes Service as an infinite loop daemon." },
      { id: 'C', text: "Configure an Azure Virtual Machine to reboot the container every 60 seconds." },
      { id: 'D', text: "Deploy the container group with the restart policy configured as 'Always'." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Deploy two separate AKS clusters and connect them via an unencrypted public VPN." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy separate VPN gateways inside every individual spoke virtual network." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Assign an Azure Policy definition that blocks outbound internet access." },
      { id: 'B', text: "Raise the priority of the default allow rules above the custom ones." },
      { id: 'C', text: "Allow 443 at priority 100 and let the default deny handle the rest." },
      { id: 'D', text: "Create a rule with priority 65500 that permits all inbound internet traffic." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Create an inbound rule allowing port 443 with priority 100, relying on the default DenyAllInBound rule at priority 65500. Network Security Groups (NSGs) evaluate rules in priority order from lowest number (highest priority, e.g. 100) to highest number (e.g. 4096). Once a rule matches traffic, subsequent rules are not evaluated. Built-in default rules (like DenyAllInBound at 65500) ensure unallowed traffic is dropped.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Raise the priority of the default allow rules above the custom ones." },
      { id: 'B', text: "Create a rule with priority 65500 that permits all inbound internet traffic." },
      { id: 'C', text: "Allow 443 at priority 100 and let the default deny handle the rest." },
      { id: 'D', text: "Assign an Azure Policy definition that blocks outbound internet access." }
    ],
    correctAnswers: ['C'],
