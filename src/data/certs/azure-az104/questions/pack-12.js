export const AZURE_AZ104_QUESTIONS_12 = [
  {
    ...
    options: [
      { id: 'A', text: "Assign an Azure Policy definition with the 'Modify' effect and trigger a remediation task for existing resources." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure an Azure Cost Management budget with an alert threshold linked to an Azure Monitor Action Group." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Implement Microsoft Entra Privileged Identity Management (PIM) with eligible role assignments and approval workflows." },
