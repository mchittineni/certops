export const AZURE_AZ104_QUESTIONS_12 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy an Azure Automation runbook scheduled to delete untagged resource groups daily." },
      { id: 'C', text: "An Azure Policy with the Modify effect, plus a remediation task." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An Azure Policy with the Modify effect, plus a remediation task." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Assign an Azure Policy definition with the 'Audit' effect and review the compliance report." },
      { id: 'D', text: "Deploy an Azure Automation runbook scheduled to delete untagged resource groups daily." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Assign an Azure Policy definition with the 'Modify' effect and trigger a remediation task for existing resources. The 'Modify' effect in Azure Policy adds, updates, or removes properties or tags on resources during creation or update. When assigned with a managed identity, administrators can create remediation tasks to automatically update existing non-compliant resources across subscriptions.",
  ...
  },
  {
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Merge all 50 subscriptions into a single monolithic Azure subscription." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Remove all Contributor permissions from the subscription and grant only Reader access." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Apply individual locks to every single network interface card and IP configuration manually." },
      { id: 'C', text: "Configure an Azure Monitor metric alert to trigger after a resource has been deleted." },
      { id: 'D', text: "Apply a CanNotDelete Resource Lock directly to the production Resource Group." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Apply a CanNotDelete Resource Lock directly to the production Resource Group. Resource locks applied at a parent scope (such as a subscription or resource group) are automatically inherited by all child resources contained within that scope. A CanNotDelete lock on a resource group prevents authorized users from deleting any resource within that group until the lock is removed.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Apply a CanNotDelete Resource Lock directly to the production Resource Group." },
      { id: 'B', text: "Remove all Contributor permissions from the subscription and grant only Reader access." },
      { id: 'C', text: "Configure an Azure Monitor metric alert to trigger after a resource has been deleted." },
      { id: 'D', text: "Apply individual locks to every single network interface card and IP configuration manually." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Apply a CanNotDelete Resource Lock directly to the production Resource Group. Resource locks applied at a parent scope (such as a subscription or resource group) are automatically inherited by all child resources contained within that scope. A CanNotDelete lock on a resource group prevents authorized users from deleting any resource within that group until the lock is removed.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A Cost Management budget with an alert threshold on an action group." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Assign an Azure Policy definition to deny all VM creation when cost thresholds are exceeded." },
      { id: 'C', text: "A Cost Management budget with an alert threshold on an action group." },
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "A Cost Management budget with an alert threshold on an action group." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Microsoft Entra PIM with eligible assignments and approval workflows." },
  ...
  },
  {
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Microsoft Entra PIM with eligible assignments and approval workflows." },
      { id: 'B', text: "Grant permanent Owner permissions to all cloud engineers across the production subscription." },
