export const AZURE_AZ104_QUESTIONS_10 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Flexible Orchestration Mode (`Flexible`).' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Private Endpoints allocate a private IP address directly from the customer VNet that is fully routable over ExpressRoute and VPN from on-premises, whereas Service Endpoints cannot be reached from on-premises.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Azure Advisor Operational Excellence recommendations.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
