export const AZURE_AZ104_QUESTIONS_10 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Self-service group management with group owners" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Key Vault access policies." },
      { id: 'B', text: "Microsoft Entra ID Protection sign-in risk." },
      { id: 'C', text: "Microsoft Entra PIM for Azure resources" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deployment stacks with `actionOnUnmanage`" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Microsoft Entra Global Secure Access (SSE)." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Require phishing-resistant MFA" },
      { id: 'D', text: "Terms of Use consent." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Allow trusted Microsoft services access" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The data in the primary region is instantly recovered." },
      { id: 'C', text: "West US becomes primary and redundancy drops to LRS." },
      { id: 'D', text: "The storage account automatically converts to ZRS in East US." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "`azcopy list \"C:\\Data\"`" },
      { id: 'B', text: "`azcopy copy \"C:\\Data\" \"https://mystorage.blob.core.windows.net/data\" --recursive`" },
      { id: 'C', text: "`azcopy make \"https://mystorage.blob.core.windows.net/data\"`" },
      { id: 'D', text: "`azcopy sync \"C:\\Data\" \"https://mystorage.blob.core.windows.net/data\" --delete-destination=true`" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Azure Advisor alerts." },
      { id: 'D', text: "Azure Scheduled Events" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "`AutoHeal`." },
      { id: 'B', text: "`Always`." },
      { id: 'C', text: "`OnFailure` (or `Never`)." },
      { id: 'D', text: "`RestartHourly`." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "32 total IP addresses, with 30 usable IP addresses." },
      { id: 'B', text: "64 total IP addresses, with 59 usable IP addresses." },
      { id: 'C', text: "16 total IP addresses, with 11 usable IP addresses." },
      { id: 'D', text: "32 total, 27 usable after the 5 reserved" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The DNS record for the public domain expired." },
      { id: 'B', text: "The storage account was deleted." },
      { id: 'C', text: "The frontend public IP was deallocated." },
      { id: 'D', text: "An NSG or guest firewall is blocking the probe traffic" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Both `0.0.0.0/0` and `10.2.0.0/16` to the appliance at `10.0.0.4`." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Private endpoints are routable from on-premises; service endpoints are not." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Bastion shareable links" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Instant Restore snapshot." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Advisor Operational Excellence recommendations." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A Service Health alert rule" },
      { id: 'C', text: "Log Analytics KQL query alert." },
