export const AZURE_AZ104_QUESTIONS_3 = [
  {
    ...
    options: [
      { id: 'A', text: "Azure Policy definition with a Deny effect." },
      ...
      { id: 'D', text: "Azure RBAC role assignment with reader permissions." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "`AuditIfNotExists` effect." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "General-purpose v1 (legacy)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Data Box (100 TB capacity device with 80 TB usable)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The deployment fails immediately with an object conflict error." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Global Virtual Network Peering." },
      { id: 'D', text: "Azure ExpressRoute Direct only." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Resource Graph." },
