export const AZURE_AZ104_QUESTIONS_3 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "A Conditional Access policy using named locations" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Delete the policy assignment from the subscription." },
      { id: 'B', text: "Assign the Owner role to the legacy benchmark VM administrators." },
      { id: 'C', text: "A policy exemption on that resource group, expiring in 30 days" },
      { id: 'D', text: "Apply a CanNotDelete Resource Lock on the resource group." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "General-purpose v2" },
      { id: 'C', text: "General-purpose v1 (legacy)." },
      { id: 'D', text: "BlockBlobStorage Premium only." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A premium file share using NFS v4.1" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A managed identity with Crypto Service Encryption User rights" },
      { id: 'D', text: "Grant the VM a Key Vault access policy instead of an RBAC role." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Rehydrate the blobs from the Archive tier." },
      { id: 'B', text: "Create a new Storage Account and run AzCopy." },
      { id: 'C', text: "List the soft-deleted blobs and run `Undelete`" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "An Azure Data Box device" },
      { id: 'C', text: "Azure File Sync." },
      { id: 'D', text: "AzCopy over VPN." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "SSE with platform keys is on by default for all managed disks." },
      ...
      { id: 'D', text: "SSE only encrypts temporary instance disks." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Resizing can only be performed by deleting the VM resource group." },
      { id: 'B', text: "Resizing a running VM restarts it and causes brief downtime." },
      { id: 'C', text: "Resizing a VM permanently changes its private IP address." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "ARM evaluates it idempotently and leaves the resources unchanged." },
      { id: 'C', text: "The deployment fails immediately with an object conflict error." },
      { id: 'D', text: "Azure Resource Manager creates a duplicate set of 5 new VMs." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Scale the App Service Plan up to Standard" },
      { id: 'B', text: "Add a custom domain name." },
      { id: 'C', text: "Enable VNet Integration on the web app." },
      { id: 'D', text: "Scale out the instance count from 1 to 5." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    certId: "azure-az104",
    domainId: "d4",
    domainName: "Implement and manage virtual networking",
    ...
    options: [
      { id: 'A', text: "256 usable IP addresses." },
      { id: 'B', text: "250 usable IP addresses." },
      { id: 'C', text: "251 usable addresses" },
      { id: 'D', text: "254 usable IP addresses." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Public Internet Gateway." },
      { id: 'C', text: "Azure ExpressRoute Direct only." },
      { id: 'D', text: "Regional Virtual Network Peering." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Attach an Azure NAT Gateway to the subnet" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Premium SKU with Anycast allocation." },
      { id: 'B', text: "Basic SKU with Static IP allocation." },
      { id: 'C', text: "Basic SKU with Dynamic IP allocation." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Point-to-Site VPN Gateway." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Network Watcher Agent." },
      { id: 'B', text: "Legacy Microsoft Monitoring Agent (MMA)." },
      { id: 'C', text: "Azure Monitor Agent with collection rules" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Resource Graph." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A Backup policy in a vault targeting the file share" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Service Health alerts for that region" },
