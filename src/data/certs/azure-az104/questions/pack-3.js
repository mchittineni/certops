export const AZURE_AZ104_QUESTIONS_3 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Create a new local member user in Microsoft Entra ID with the consultant\'s external password.' },
      { id: 'C', text: 'Deploy Microsoft Entra Connect on the external partner\'s domain.' },
      { id: 'D', text: 'Assign an Azure Resource Lock to the consultant\'s email.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'General-purpose v2 (standard general-purpose v2).' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'Azure Blob Storage with FTP endpoint.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Enable a System-assigned or User-assigned Managed Identity on the Storage Account and grant it Key Vault Crypto Service Encryption User permissions.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Scale up the App Service Plan from `Basic` to `Standard` (or Premium).' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'Standard SKU with Static IP allocation.' },
