export const AZURE_AZ104_QUESTIONS_14 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Instruct branch office users to access files solely via the Azure portal web interface." },
      { id: 'C', text: "Configure manual FTP synchronization scripts running between branch offices overnight." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Place both virtual machines on the same physical host hardware rack." },
      { id: 'D', text: "Put the VMs in an availability set with fault and update domains." }
    ],
    correctAnswers: ['D'],
    type: "single",
