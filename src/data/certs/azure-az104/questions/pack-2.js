export const AZURE_AZ104_QUESTIONS_2 = [
  {
    ...
    options: [
      { id: 'A', text: "A dynamic-membership security group on the department attribute" },
      ...
      { id: 'D', text: "Create an Assigned group and assign the User Administrator role." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Assign the Reader role at the `Production` Management Group scope." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Budgets with actual and forecast alerts" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set Storage Account public network access to \"Enabled from all networks\"." },
      { id: 'B', text: "Configure an Azure Route Table with next hop `None`." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The secondary becomes primary and redundancy drops to LRS." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "PowerShell `Copy-Item`." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "B-series (Burstable VMs)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy a single VM with Ultra SSD storage." },
      { id: 'D', text: "Deploy all three VMs in a single Availability Set with 3 Fault Domains." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Cross-Region Virtual Network Peering." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "App Service Access Restrictions." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A log search alert on the result count" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Azure Service Health maintenance notification." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure Azure File Sync cloud tiering." },
