export const CNCF_OPA_QUESTIONS_4 = [
  {
    id: "cncf-opa-76",
    difficulty: "easy",
    certId: "cncf-opa",
    ...
    title: "What Happens When No Rule Matches: High-Frequency FinTech Trading",
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the production environment.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Building a Filtered Collection Inside a Rule: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      ...
      { id: 'C', text: "Use a partial set rule that assigns one element per matching input document and reference that rule from wherever the filtered collection is needed." },
      { id: 'D', text: "Use the built-in 'filter' function with a predicate over input.users so that only the active matching elements are returned." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Verifying Policy Branches Before Release: Global E-Commerce Black Friday Scale",
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rolling a Policy Change Out Fleet-Wide: Autonomous Vehicle Telemetry",
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      ...
      { id: 'D', text: "Bake the policy bundle into the OPA container image centrally and roll the deployment so that each instance restarts on the new version." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Reconstructing Why a Request Was Denied: Multi-Tenant B2B SaaS Platform",
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      ...
      { id: 'D', text: "Enable OPA's status plugin so that the central service receives bundle activation records and health information from every instance." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Where Authorization Decisions Get Evaluated: Media Streaming & Global CDN",
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The policy team is deciding where authorization decisions should be evaluated across a large service estate. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Compile the Rego policies to WebAssembly and make the authorization decisions inside each application process using the OPA Wasm SDK." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Granting Access When Any One Condition Holds: Aerospace Satellite Ground Systems",
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The policy team is expressing several independent conditions where satisfying any one of them should grant access. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Define a single 'allow' rule and join the individual conditions with the 'or' keyword placed between each expression in the rule body." },
      { id: 'B', text: "Define several rules with the same name; OPA combines them as OR." },
      { id: 'C', text: "Define one 'allow' rule whose body lists every condition on its own line, since the expressions inside a single rule body are combined by OPA as a logical OR when it is evaluated." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "What Happens When No Rule Matches: Telecommunications 5G Core Network",
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Building a Filtered Collection Inside a Rule: Renewable Energy Smart Grid IoT",
    scenario: "A smart electrical grid platform monitors millions of smart meters with low-latency time-series analysis and automated load shedding. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Iterate with a 'for user in input.users' loop and append each matching element to a local variable as it is found." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Verifying Policy Branches Before Release: Supply Chain Cold-Chain Logistics",
    scenario: "A pharmaceutical distribution network tracks temperature-sensitive cargo with cryptographic provenance and automated breach alerts. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rolling a Policy Change Out Fleet-Wide: Banking Core Ledger & Payments",
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Reconstructing Why a Request Was Denied: Genomic Sequencing & Biotech Pipeline",
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Add a print() call inside each Rego rule so that the reason for a denial is written out to the OPA server log whenever that rule fires." },
      ...
      { id: 'D', text: "Run OPA with the --log-level debug flag so that evaluation detail for each query appears on the container's standard output." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Decision logs record the query, the full input, the result, and the bundle revision that produced it, which is exactly the set of facts needed to explain a past decision, and they can be masked and shipped to a SIEM. Debug logging prints evaluation detail but is unstructured, unmasked, and far too voluminous to leave enabled in production. The status plugin reports which bundle an instance is running and nothing about individual decisions. print() emits a line only where an author remembered to add one and carries no input or result alongside it.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Where Authorization Decisions Get Evaluated: Defense-Grade Zero-Trust Network",
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The policy team is deciding where authorization decisions should be evaluated across a large service estate. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Granting Access When Any One Condition Holds: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The policy team is expressing several independent conditions where satisfying any one of them should grant access. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "What Happens When No Rule Matches: Insurance Risk & Actuarial Modeling",
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Building a Filtered Collection Inside a Rule: Pharmaceutical Clinical Trial Platform",
    scenario: "A global pharmaceutical research group manages double-blind clinical trial records with strict regulatory reporting and audit trails. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Verifying Policy Branches Before Release: Smart City Traffic & Mobility Sensor Hub",
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rolling a Policy Change Out Fleet-Wide: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      ...
      { id: 'B', text: "Configure OPA to poll a central bundle service via the Bundle API, automatically downloading, validating, and activating signed policy tarballs in memory." },
      { id: 'C', text: "Bake the policy bundle into the OPA container image centrally and roll the deployment so that each instance restarts on the new version." },
      { id: 'D', text: "Push each change to every OPA instance through the REST Policy API so that the new rules apply immediately without waiting for a bundle poll interval to elapse." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Bundles are versioned, optionally signed, and activated atomically, and each instance reports the revision it is running through the status plugin, so a fleet-wide rollout is observable and verifiable. The REST Policy API pushes successfully but leaves no record of which revision any instance holds, and an instance that restarts loses the push entirely. Baking policy into the image ties every rule change to a container build and a rolling restart. The --watch flag reloads from local disk, which suits a developer laptop but offers no signing and no way to reach instances across a fleet.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Reconstructing Why a Request Was Denied: Legal Discovery & Semantic Document Search",
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Add a print() call inside each Rego rule so that the reason for a denial is written out to the OPA server log whenever that rule fires." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Where Authorization Decisions Get Evaluated: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The policy team is deciding where authorization decisions should be evaluated across a large service estate. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      ...
      { id: 'B', text: "Embed the OPA Go library directly in each service and evaluate policy in-process against the bundles it loads at startup." },
      { id: 'C', text: "Compile the Rego policies to WebAssembly and make the authorization decisions inside each application process using the OPA Wasm SDK." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Granting Access When Any One Condition Holds: Precision Agriculture & Drone Scouting",
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The policy team is expressing several independent conditions where satisfying any one of them should grant access. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Define a single 'allow' rule and join the individual conditions with the 'or' keyword placed between each expression in the rule body." },
      { id: 'B', text: "Define several rules with the same name; OPA combines them as OR." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "What Happens When No Rule Matches: Industrial Robotics Predictive Maintenance",
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Write the allow rules with no default at all and have every enforcement point treat an undefined decision result as though it were an explicit denial." },
      { id: 'B', text: "Set 'default allow := false' inside each allow rule body so that every rule carries its own fallback value independently." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Building a Filtered Collection Inside a Rule: Educational Remote Proctoring Platform",
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use a comprehension to build the filtered collection." },
      { id: 'B', text: "Iterate with a 'for user in input.users' loop and append each matching element to a local variable as it is found." },
      { id: 'C', text: "Use the built-in 'filter' function with a predicate over input.users so that only the active matching elements are returned." },
      { id: 'D', text: "Use a partial set rule that assigns one element per matching input document and reference that rule from wherever the filtered collection is needed." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "A comprehension iterates, filters, and constructs the new collection as one expression whose value is local to the rule that needs it. A partial set rule is valid Rego and often the right choice, but it defines a document at package scope rather than a value inside the rule, so it is visible to every other rule and to the query. The other two options are not Rego at all: there is no 'filter' built-in, and the language has no imperative loop and no mutable local variable to append to.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Verifying Policy Branches Before Release: Real Estate Valuation & Geo-Spatial Analytics",
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Create test rules prefixed with 'test_' in dedicated test files and execute 'opa test --coverage' using the 'with' keyword to mock 'input' and 'data'." },
      ...
      { id: 'C', text: "Create test rules prefixed with 'test_' and run 'opa eval' against each policy file in turn, comparing each printed result against the expected value recorded in CI." },
      { id: 'D', text: "Run 'conftest verify' against the policy directory so that the Rego test files execute as part of the Conftest tooling." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rolling a Policy Change Out Fleet-Wide: Disaster Emergency Dispatch & Operations",
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Mount the policy directory from a shared volume and start OPA with the --watch flag so that it reloads the files when they change." },
      { id: 'B', text: "Configure OPA to poll a central bundle service via the Bundle API, automatically downloading, validating, and activating signed policy tarballs in memory." },
...
export default CNCF_OPA_QUESTIONS_4;
