export const CNCF_OPA_QUESTIONS_2 = [
  {
    ...
    title: "Building a Filtered Collection Inside a Rule: High-Frequency FinTech Trading",
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the staging environment.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Verifying Policy Branches Before Release: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rolling a Policy Change Out Fleet-Wide: Global E-Commerce Black Friday Scale",
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Reconstructing Why a Request Was Denied: Autonomous Vehicle Telemetry",
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Where Authorization Decisions Get Evaluated: Multi-Tenant B2B SaaS Platform",
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The policy team is deciding where authorization decisions should be evaluated across a large service estate. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Granting Access When Any One Condition Holds: Media Streaming & Global CDN",
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The policy team is expressing several independent conditions where satisfying any one of them should grant access. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "What Happens When No Rule Matches: Aerospace Satellite Ground Systems",
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Building a Filtered Collection Inside a Rule: Telecommunications 5G Core Network",
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Verifying Policy Branches Before Release: Renewable Energy Smart Grid IoT",
    scenario: "A smart electrical grid platform monitors millions of smart meters with low-latency time-series analysis and automated load shedding. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rolling a Policy Change Out Fleet-Wide: Supply Chain Cold-Chain Logistics",
    scenario: "A pharmaceutical distribution network tracks temperature-sensitive cargo with cryptographic provenance and automated breach alerts. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Push each change to every OPA instance through the REST Policy API so that the new rules apply immediately without waiting for a bundle poll interval to elapse." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Reconstructing Why a Request Was Denied: Banking Core Ledger & Payments",
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Run OPA with the --log-level debug flag so that evaluation detail for each query appears on the container's standard output." },
      { id: 'B', text: "Enable OPA's status plugin so that the central service receives bundle activation and health information from every instance." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Where Authorization Decisions Get Evaluated: Genomic Sequencing & Biotech Pipeline",
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The policy team is deciding where authorization decisions should be evaluated across a large service estate. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Granting Access When Any One Condition Holds: Defense-Grade Zero-Trust Network",
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The policy team is expressing several independent conditions where satisfying any one of them should grant access. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "What Happens When No Rule Matches: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Write the allow rules with no default at all and have every enforcement point treat an undefined decision result as though it were an explicit denial." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Building a Filtered Collection Inside a Rule: Insurance Risk & Actuarial Modeling",
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use a partial set rule that assigns one element per matching input document and reference that rule from wherever the filtered collection is needed." },
      { id: 'B', text: "Use the built-in 'filter' function with a predicate over input.users so that only the matching elements are returned." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Verifying Policy Branches Before Release: Pharmaceutical Clinical Trial Platform",
    scenario: "A global pharmaceutical research group manages double-blind clinical trial records with strict regulatory reporting and audit trails. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Create test rules prefixed with 'test_' and run 'opa eval' against each policy file in turn, comparing each printed result against the expected value recorded in CI." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rolling a Policy Change Out Fleet-Wide: Smart City Traffic & Mobility Sensor Hub",
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Reconstructing Why a Request Was Denied: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Run OPA with the --log-level debug flag so that evaluation detail for each query appears on the container's standard output." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Where Authorization Decisions Get Evaluated: Legal Discovery & Semantic Document Search",
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The policy team is deciding where authorization decisions should be evaluated across a large service estate. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Run OPA as a central remote decision service that every application calls over the network, scaling the service horizontally behind a load balancer." },
      { id: 'B', text: "Compile the Rego policies to WebAssembly and evaluate them inside each application process using the OPA Wasm SDK." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Granting Access When Any One Condition Holds: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The policy team is expressing several independent conditions where satisfying any one of them should grant access. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Define one 'allow' rule whose body lists every condition on its own line, since the expressions inside a single rule body are combined by OPA as a logical OR when it is evaluated." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "What Happens When No Rule Matches: Precision Agriculture & Drone Scouting",
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Building a Filtered Collection Inside a Rule: Industrial Robotics Predictive Maintenance",
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use a partial set rule that assigns one element per matching input document and reference that rule from wherever the filtered collection is needed." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Verifying Policy Branches Before Release: Educational Remote Proctoring Platform",
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Create test rules prefixed with 'test_' and run 'opa eval' against each policy file in turn, comparing each printed result against the expected value recorded in CI." },
      { id: 'B', text: "Write the expected decisions into a JSON fixture and run 'opa check' over the whole policy directory to compare them against it." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rolling a Policy Change Out Fleet-Wide: Real Estate Valuation & Geo-Spatial Analytics",
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Push each change to every OPA instance through the REST Policy API so that the new rules apply immediately without waiting for a bundle poll interval to elapse." },
      { id: 'B', text: "Bake the policy bundle into the OPA container image and roll the deployment so that each instance restarts on the new version." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Reconstructing Why a Request Was Denied: Disaster Emergency Dispatch & Operations",
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the staging environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
