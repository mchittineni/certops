export const CNCF_OPA_QUESTIONS_1 = [
  {
    id: "cncf-opa-1",
    difficulty: "easy",
    certId: "cncf-opa",
    ...
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The policy team is deciding where authorization decisions should be evaluated across a large service estate. The work is scoped to the development environment.",
  ...
  },
  {
    ...
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The policy team is expressing several independent conditions where satisfying any one of them should grant access. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The policy team is deciding where authorization decisions should be evaluated across a large service estate. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A pharmaceutical distribution network tracks temperature-sensitive cargo with cryptographic provenance and automated breach alerts. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The policy team is deciding where authorization decisions should be evaluated across a large service estate. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Set 'default allow := false' inside each allow rule body so that every rule carries its own fallback value independently." },
  ...
  },
  {
    ...
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use a partial set rule that assigns one element per matching input document and reference that rule from wherever the filtered collection is needed." },
      { id: 'B', text: "Use the built-in 'filter' function with a predicate over input.users so that only the active matching elements are returned." },
  ...
  },
  {
    ...
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Enable OPA Decision Logs to export structured JSON records of every query, input payload, and decision result to central security analytics." },
      { id: 'B', text: "Enable OPA's status plugin so that the central service receives bundle activation records and health information from every instance." },
  ...
  },
  {
    ...
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The policy team is deciding where authorization decisions should be evaluated across a large service estate. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Embed the OPA Go library directly in each service and evaluate policy in-process against the bundles it loads at startup." },
      { id: 'B', text: "Run OPA as a sidecar evaluating local policy bundles." },
  ...
  },
  {
    ...
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The policy team is expressing several independent conditions where satisfying any one of them should grant access. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Write the allow rules with no default at all and have every enforcement point treat an undefined decision result as though it were an explicit denial." },
      { id: 'B', text: "Add a catch-all rule 'allow := false' after the other allow rules so that it applies when none of them match." },
  ...
  },
  {
    ...
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the development environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use the built-in 'filter' function with a predicate over input.users so that only the active matching elements are returned." },
      { id: 'B', text: "Iterate with a 'for user in input.users' loop and append each matching element to a local variable as it is found." },
...
export default CNCF_OPA_QUESTIONS_1;
