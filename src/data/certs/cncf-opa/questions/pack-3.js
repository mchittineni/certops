export const CNCF_OPA_QUESTIONS_3 = [
  {
    ...
    title: "Reconstructing Why a Request Was Denied: High-Frequency FinTech Trading",
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the pre-production environment.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Where Authorization Decisions Get Evaluated: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The policy team is deciding where authorization decisions should be evaluated across a large service estate. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      ...
      { id: 'C', text: "Run OPA as a central remote decision service that every application calls over the network, scaling the service horizontally behind a load balancer." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Granting Access When Any One Condition Holds: Global E-Commerce Black Friday Scale",
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The policy team is expressing several independent conditions where satisfying any one of them should grant access. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "What Happens When No Rule Matches: Autonomous Vehicle Telemetry",
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Building a Filtered Collection Inside a Rule: Multi-Tenant B2B SaaS Platform",
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Verifying Policy Branches Before Release: Media Streaming & Global CDN",
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rolling a Policy Change Out Fleet-Wide: Aerospace Satellite Ground Systems",
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Reconstructing Why a Request Was Denied: Telecommunications 5G Core Network",
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Enable OPA Decision Logs to export structured JSON records of every query, input payload, and decision result to central security analytics." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Granting Access When Any One Condition Holds: Supply Chain Cold-Chain Logistics",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "What Happens When No Rule Matches: Banking Core Ledger & Payments",
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Add a catch-all rule 'allow := false' after the other allow rules so that it applies when none of them match." },
      { id: 'B', text: "Set 'default allow := false' and write explicit allow rules." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Building a Filtered Collection Inside a Rule: Genomic Sequencing & Biotech Pipeline",
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Verifying Policy Branches Before Release: Defense-Grade Zero-Trust Network",
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rolling a Policy Change Out Fleet-Wide: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Configure OPA to poll a central bundle service via the Bundle API, automatically downloading, validating, and activating signed policy tarballs in memory." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Reconstructing Why a Request Was Denied: Insurance Risk & Actuarial Modeling",
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Where Authorization Decisions Get Evaluated: Pharmaceutical Clinical Trial Platform",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Granting Access When Any One Condition Holds: Smart City Traffic & Mobility Sensor Hub",
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The policy team is expressing several independent conditions where satisfying any one of them should grant access. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Define a single 'allow' rule and join the individual conditions with the 'or' keyword placed between each expression in the rule body." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "What Happens When No Rule Matches: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Add a catch-all rule 'allow := false' after the other allow rules so that it applies when none of them match." },
      { id: 'B', text: "Set 'default allow := false' and write explicit allow rules." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Building a Filtered Collection Inside a Rule: Legal Discovery & Semantic Document Search",
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The policy team is deriving a filtered collection from nested input inside a single rule. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use a comprehension to build the filtered collection." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Verifying Policy Branches Before Release: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The policy team is verifying that every branch of a policy behaves correctly before it reaches a cluster. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rolling a Policy Change Out Fleet-Wide: Precision Agriculture & Drone Scouting",
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The policy team is rolling a policy change out to every running OPA instance without redeploying services. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Reconstructing Why a Request Was Denied: Industrial Robotics Predictive Maintenance",
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The policy team is reconstructing after the fact exactly why a particular request was denied. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Enable OPA Decision Logs to export structured JSON records of every query, input payload, and decision result to central security analytics." },
      { id: 'B', text: "Add a print() call inside each Rego rule so that the reason for a denial is written out to the OPA server log whenever that rule fires." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Where Authorization Decisions Get Evaluated: Educational Remote Proctoring Platform",
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The policy team is deciding where authorization decisions should be evaluated across a large service estate. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Run OPA as a central remote decision service that every application calls over the network, scaling the service horizontally behind a load balancer." },
      { id: 'B', text: "Embed the OPA Go library directly in each service and evaluate policy in-process against the bundles it loads at startup." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Granting Access When Any One Condition Holds: Real Estate Valuation & Geo-Spatial Analytics",
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The policy team is expressing several independent conditions where satisfying any one of them should grant access. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "What Happens When No Rule Matches: Disaster Emergency Dispatch & Operations",
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The policy team is making sure a request that matches no rule is denied rather than left undefined. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Add a catch-all rule 'allow := false' after the other allow rules so that it applies when none of them match." },
