export const CNCF_OPA_QUESTIONS_13 = [
  {
    id: "cncf-opa-301",
    difficulty: "easy",
    certId: "cncf-opa",
    ...
    title: "Scoping a Policy to Certain Namespaces: High-Frequency FinTech Trading",
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The policy team is applying an existing policy to only some namespaces and resource kinds. The work is scoped to the pre-production environment.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Introducing a Policy Without Blocking Teams: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The policy team is introducing a new policy across a busy cluster without blocking teams on day one. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Finding Resources That Predate a Policy: Global E-Commerce Black Friday Scale",
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The policy team is finding resources that were already running before a new policy was written. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Applying a Required Default Automatically: Autonomous Vehicle Telemetry",
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The policy team is applying a required default to incoming workloads without every team editing manifests. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Catching Violations Before the Cluster Sees Them: Multi-Tenant B2B SaaS Platform",
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The policy team is catching constraint violations in a pull request rather than at admission time. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Behaviour When the Policy Webhook Is Unreachable: Media Streaming & Global CDN",
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The policy team is deciding how admission should behave while the policy webhook is unreachable. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Making One Policy Reusable With Parameters: Aerospace Satellite Ground Systems",
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The policy team is packaging a policy so that several teams can apply it with different values. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Scoping a Policy to Certain Namespaces: Telecommunications 5G Core Network",
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The policy team is applying an existing policy to only some namespaces and resource kinds. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Introducing a Policy Without Blocking Teams: Renewable Energy Smart Grid IoT",
    scenario: "A smart electrical grid platform monitors millions of smart meters with low-latency time-series analysis and automated load shedding. The policy team is introducing a new policy across a busy cluster without blocking teams on day one. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Finding Resources That Predate a Policy: Supply Chain Cold-Chain Logistics",
    scenario: "A pharmaceutical distribution network tracks temperature-sensitive cargo with cryptographic provenance and automated breach alerts. The policy team is finding resources that were already running before a new policy was written. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use 'gator test' against a full set of manifests exported from the cluster with kubectl so that the resources already running are checked offline in the pipeline." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Applying a Required Default Automatically: Banking Core Ledger & Payments",
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The policy team is applying a required default to incoming workloads without every team editing manifests. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Catching Violations Before the Cluster Sees Them: Genomic Sequencing & Biotech Pipeline",
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The policy team is catching constraint violations in a pull request rather than at admission time. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Behaviour When the Policy Webhook Is Unreachable: Defense-Grade Zero-Trust Network",
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The policy team is deciding how admission should behave while the policy webhook is unreachable. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Making One Policy Reusable With Parameters: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The policy team is packaging a policy so that several teams can apply it with different values. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Scoping a Policy to Certain Namespaces: Insurance Risk & Actuarial Modeling",
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The policy team is applying an existing policy to only some namespaces and resource kinds. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Set a namespaceSelector on the Gatekeeper ValidatingWebhookConfiguration so that the API server forwards only the matching resource kinds and namespaces." },
      { id: 'B', text: "Label the namespaces that should be skipped and list every one of them in the Gatekeeper controller's --exempt-namespace flag at startup." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Introducing a Policy Without Blocking Teams: Pharmaceutical Clinical Trial Platform",
    scenario: "A global pharmaceutical research group manages double-blind clinical trial records with strict regulatory reporting and audit trails. The policy team is introducing a new policy across a busy cluster without blocking teams on day one. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Write the ConstraintTemplate's Rego so that each violation message begins with the word warning, which causes admission to allow the request." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Finding Resources That Predate a Policy: Smart City Traffic & Mobility Sensor Hub",
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The policy team is finding resources that were already running before a new policy was written. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use 'gator test' against a full set of manifests exported from the cluster with kubectl so that the resources already running are checked offline in the pipeline." },
      { id: 'B', text: "Set enforcementAction to deny so that resources already running are evicted automatically the next time the Gatekeeper controller reconciles them." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Applying a Required Default Automatically: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The policy team is applying a required default to incoming workloads without every team editing manifests. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Configure a Kubernetes MutatingAdmissionPolicy with a CEL expression that patches the missing field during the admission request." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Catching Violations Before the Cluster Sees Them: Legal Discovery & Semantic Document Search",
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The policy team is catching constraint violations in a pull request rather than at admission time. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use the 'gator' CLI tool in developer environments and CI pipelines to test Kubernetes manifests against ConstraintTemplates before applying to clusters." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Behaviour When the Policy Webhook Is Unreachable: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The policy team is deciding how admission should behave while the policy webhook is unreachable. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Making One Policy Reusable With Parameters: Precision Agriculture & Drone Scouting",
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The policy team is packaging a policy so that several teams can apply it with different values. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Define a separate Constraint for each variation and place the differing parameters directly in the Rego source of each one." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Scoping a Policy to Certain Namespaces: Industrial Robotics Predictive Maintenance",
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The policy team is applying an existing policy to only some namespaces and resource kinds. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Set a namespaceSelector on the Gatekeeper ValidatingWebhookConfiguration so that the API server forwards only the matching resource kinds and namespaces." },
      { id: 'B', text: "Create a Constraint custom resource that references the ConstraintTemplate and specifies 'match' criteria (kinds, namespaces, label selectors) and parameter values." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Introducing a Policy Without Blocking Teams: Educational Remote Proctoring Platform",
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The policy team is introducing a new policy across a busy cluster without blocking teams on day one. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Write the ConstraintTemplate's Rego so that each violation message begins with the word warning, which causes admission to allow the request." },
      { id: 'B', text: "Deploy the Constraint with a match block that initially selects one pilot namespace and widen the selector as teams come into compliance." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Finding Resources That Predate a Policy: Real Estate Valuation & Geo-Spatial Analytics",
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The policy team is finding resources that were already running before a new policy was written. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use 'gator test' against a full set of manifests exported from the cluster with kubectl so that the resources already running are checked offline in the pipeline." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Kubernetes Admission Control with Gatekeeper",
    title: "Applying a Required Default Automatically: Disaster Emergency Dispatch & Operations",
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The policy team is applying a required default to incoming workloads without every team editing manifests. The work is scoped to the pre-production environment.",
    question: "Which policy approach best meets these requirements?",
    options: [
      { id: 'A', text: "Configure a Kubernetes MutatingAdmissionPolicy with a CEL expression that patches the missing field during the admission request." },
      { id: 'B', text: "Configure a Constraint that denies any incoming pod missing the field, so that each team adds the required value automatically in its own manifests." },
...
export default CNCF_OPA_QUESTIONS_13;
