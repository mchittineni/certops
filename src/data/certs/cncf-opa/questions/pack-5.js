export const CNCF_OPA_QUESTIONS_5 = [
  {
    id: "cncf-opa-101",
    difficulty: "easy",
    certId: "cncf-opa",
    ...
    title: "OPA Bundle API and Management: High-Frequency FinTech Trading",
    scenario: "In a high-frequency fintech trading platform, a quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The policy architecture team is currently distributing policies dynamically to opa instances under production cluster cycle 5.1.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these high-frequency fintech trading requirements for opa bundle api and management?",
    options: [
    ...
    tags: ["bundles", "distribution", "operations", "High-Frequency FinTech Trading"]
  },
  {
    id: "cncf-opa-102",
    difficulty: "easy",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Decision Logging and Auditability: Healthcare Patient Records & HIPAA",
    scenario: "In a healthcare patient records & hipaa platform, a national hospital network requires strict cryptographic privacy, auditable access controls, and hipaa compliance. The policy architecture team is currently tracking authorization events and compliance records under production cluster cycle 5.2.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these healthcare patient records & hipaa requirements for decision logging and auditability?",
    options: [
    ...
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["decision-logs", "audit", "compliance", "Healthcare Patient Records & HIPAA"]
  },
  {
    id: "cncf-opa-103",
    difficulty: "easy",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "OPA Decoupled Policy Architecture: Global E-Commerce Black Friday Scale",
    scenario: "In a global e-commerce black friday scale platform, an international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The policy architecture team is currently decoupling authorization logic from application source code under production cluster cycle 5.3.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these global e-commerce black friday scale requirements for opa decoupled policy architecture?",
    options: [
    ...
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["opa", "architecture", "decoupling", "Global E-Commerce Black Friday Scale"]
  },
  {
    id: "cncf-opa-104",
    difficulty: "easy",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rego Rule Evaluation and OR Semantics: Autonomous Vehicle Telemetry",
    scenario: "In a autonomous vehicle telemetry platform, a self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The policy architecture team is currently writing declarative authorization rules in rego under production cluster cycle 5.4.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these autonomous vehicle telemetry requirements for rego rule evaluation and or semantics?",
    options: [
    ...
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["rego", "syntax", "rules", "Autonomous Vehicle Telemetry"]
  },
  {
    id: "cncf-opa-105",
    difficulty: "easy",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Default Values and Safe Deny: Multi-Tenant B2B SaaS Platform",
    scenario: "In a multi-tenant b2b saas platform platform, an enterprise cloud saas architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The policy architecture team is currently configuring default deny rules for secure authorization under production cluster cycle 5.5.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these multi-tenant b2b saas platform requirements for default values and safe deny?",
    options: [
    ...
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["rego", "default", "security", "Multi-Tenant B2B SaaS Platform"]
  },
  {
    id: "cncf-opa-106",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Set and Array Comprehensions: Media Streaming & Global CDN",
    scenario: "In a media streaming & global cdn platform, a global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized drm protection. The policy architecture team is currently transforming and filtering nested collections in rego under production cluster cycle 5.6.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these media streaming & global cdn requirements for set and array comprehensions?",
    options: [
    ...
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["rego", "comprehensions", "collections", "Media Streaming & Global CDN"]
  },
  {
    id: "cncf-opa-107",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Testing Rego with 'opa test': Aerospace Satellite Ground Systems",
    scenario: "In a aerospace satellite ground systems platform, an aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The policy architecture team is currently unit testing policies with mocks and code coverage under production cluster cycle 5.7.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these aerospace satellite ground systems requirements for testing rego with 'opa test'?",
    options: [
    ...
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["testing", "opa-test", "coverage", "Aerospace Satellite Ground Systems"]
  },
  {
    id: "cncf-opa-108",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "OPA Bundle API and Management: Telecommunications 5G Core Network",
    scenario: "In a telecommunications 5g core network platform, a national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The policy architecture team is currently distributing policies dynamically to opa instances under production cluster cycle 5.8.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these telecommunications 5g core network requirements for opa bundle api and management?",
    options: [
    ...
    explanation: "OPA's Bundle API allows distributed OPA instances to periodically poll and activate versioned, digitally signed policy bundles (tar.gz files containing Rego and data) from cloud object storage (S3, GCS) or control planes without restarting OPA containers.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["bundles", "distribution", "operations", "Telecommunications 5G Core Network"]
  },
  {
    id: "cncf-opa-109",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Decision Logging and Auditability: Renewable Energy Smart Grid IoT",
    scenario: "In a renewable energy smart grid iot platform, a smart electrical grid platform monitors millions of smart meters with low-latency time-series analysis and automated load shedding. The policy architecture team is currently tracking authorization events and compliance records under production cluster cycle 5.9.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these renewable energy smart grid iot requirements for decision logging and auditability?",
    options: [
    ...
    explanation: "OPA Decision Logging captures high-fidelity audit trails of every policy query, including the full input payload, timestamp, and evaluation decision. Logs can be masked to remove PII and streamed to SIEM systems for regulatory compliance and threat detection.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["decision-logs", "audit", "compliance", "Renewable Energy Smart Grid IoT"]
  },
  {
    id: "cncf-opa-110",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "OPA Decoupled Policy Architecture: Supply Chain Cold-Chain Logistics",
    scenario: "In a supply chain cold-chain logistics platform, a pharmaceutical distribution network tracks temperature-sensitive cargo with cryptographic provenance and automated breach alerts. The policy architecture team is currently decoupling authorization logic from application source code under production cluster cycle 5.10.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these supply chain cold-chain logistics requirements for opa decoupled policy architecture?",
    options: [
      { id: 'A', text: "Hardcode role-based access checks directly inside every microservice backend codebase using nested if-else branches." },
    ...
    explanation: "Open Policy Agent (OPA) is a general-purpose, open-source policy engine that decouples policy decision-making from policy enforcement. Services offload authorization by sending arbitrary JSON context to OPA's in-memory engine, which evaluates declarative Rego policies in sub-millisecond time without querying remote databases during evaluation.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["opa", "architecture", "decoupling", "Supply Chain Cold-Chain Logistics"]
  },
  {
    id: "cncf-opa-111",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rego Rule Evaluation and OR Semantics: Banking Core Ledger & Payments",
    scenario: "In a banking core ledger & payments platform, a central banking consortium enforces acid consistency, immutable transaction audit trails, and automated reconciliation. The policy architecture team is currently writing declarative authorization rules in rego under production cluster cycle 5.11.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these banking core ledger & payments requirements for rego rule evaluation and or semantics?",
    options: [
      { id: 'A', text: "Nest procedural while loops with break statements inside imperative functions to compute access." },
      { id: 'B', text: "Write a single monolithic rule that throws an unhandled exception when any condition fails." },
    ...
    explanation: "In Rego, multiple rule definitions sharing the same rule name represent a logical disjunction (OR). If all expressions within at least one rule body evaluate to true, the rule evaluates to true. Within a single rule body, expressions are evaluated as a logical conjunction (AND).",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["rego", "syntax", "rules", "Banking Core Ledger & Payments"]
  },
  {
    id: "cncf-opa-112",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Default Values and Safe Deny: Genomic Sequencing & Biotech Pipeline",
    scenario: "In a genomic sequencing & biotech pipeline platform, a genomics laboratory processes petabyte-scale fastq files with distributed batch computing and high-throughput posix storage. The policy architecture team is currently configuring default deny rules for secure authorization under production cluster cycle 5.12.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these genomic sequencing & biotech pipeline requirements for default values and safe deny?",
    options: [
    ...
    explanation: "A foundational principle of zero-trust policy-as-code is fail-closed security. Declaring 'default allow := false' ensures that if an incoming request does not explicitly satisfy any defined allow rule, the result evaluates deterministically to false rather than undefined or permissive.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["rego", "default", "security", "Genomic Sequencing & Biotech Pipeline"]
  },
  {
    id: "cncf-opa-113",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Set and Array Comprehensions: Defense-Grade Zero-Trust Network",
    scenario: "In a defense-grade zero-trust network platform, a defense intelligence system enforces continuous mutual tls authentication, strict least privilege, and non-repudiation. The policy architecture team is currently transforming and filtering nested collections in rego under production cluster cycle 5.13.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these defense-grade zero-trust network requirements for set and array comprehensions?",
    options: [
    ...
    explanation: "Rego provides powerful set, array, and object comprehensions (e.g., '[x | ...]'). Comprehensions iterate over collections, apply filtering predicates, and construct new immutable collections in a single declarative expression without side effects.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["rego", "comprehensions", "collections", "Defense-Grade Zero-Trust Network"]
  },
  {
    id: "cncf-opa-114",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Testing Rego with 'opa test': Online Multiplayer Gaming Engine",
    scenario: "In a online multiplayer gaming engine platform, a real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The policy architecture team is currently unit testing policies with mocks and code coverage under production cluster cycle 5.14.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these online multiplayer gaming engine requirements for testing rego with 'opa test'?",
    options: [
      { id: 'A', text: "Deploy policies directly to production and monitor end-user support tickets to detect authorization bugs." },
    ...
    explanation: "The OPA CLI provides a built-in testing framework via 'opa test'. Tests define rules starting with 'test_', mock contextual inputs using 'with input as ...' or 'with data as ...', and report code coverage metrics to verify edge cases and rule branches before deployment.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["testing", "opa-test", "coverage", "Online Multiplayer Gaming Engine"]
  },
  {
    id: "cncf-opa-115",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "OPA Bundle API and Management: Insurance Risk & Actuarial Modeling",
    scenario: "In a insurance risk & actuarial modeling platform, an actuarial underwriting platform executes monte carlo simulations across millions of policy holder records with parallel workers. The policy architecture team is currently distributing policies dynamically to opa instances under production cluster cycle 5.15.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these insurance risk & actuarial modeling requirements for opa bundle api and management?",
    options: [
      { id: 'A', text: "SSH into every Kubernetes node and manually copy-paste Rego files into the /tmp directory." },
      { id: 'B', text: "Rebuild the OPA container image from scratch every time a security policy rule changes." },
    ...
    explanation: "OPA's Bundle API allows distributed OPA instances to periodically poll and activate versioned, digitally signed policy bundles (tar.gz files containing Rego and data) from cloud object storage (S3, GCS) or control planes without restarting OPA containers.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["bundles", "distribution", "operations", "Insurance Risk & Actuarial Modeling"]
  },
  {
    id: "cncf-opa-116",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Decision Logging and Auditability: Pharmaceutical Clinical Trial Platform",
    scenario: "In a pharmaceutical clinical trial platform platform, a global pharmaceutical research group manages double-blind clinical trial records with strict regulatory reporting and audit trails. The policy architecture team is currently tracking authorization events and compliance records under production cluster cycle 5.16.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these pharmaceutical clinical trial platform requirements for decision logging and auditability?",
    options: [
      { id: 'A', text: "Disable logging completely to save disk space and improve raw request latency." },
    ...
    explanation: "OPA Decision Logging captures high-fidelity audit trails of every policy query, including the full input payload, timestamp, and evaluation decision. Logs can be masked to remove PII and streamed to SIEM systems for regulatory compliance and threat detection.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["decision-logs", "audit", "compliance", "Pharmaceutical Clinical Trial Platform"]
  },
  {
    id: "cncf-opa-117",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "OPA Decoupled Policy Architecture: Smart City Traffic & Mobility Sensor Hub",
    scenario: "In a smart city traffic & mobility sensor hub platform, a metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The policy architecture team is currently decoupling authorization logic from application source code under production cluster cycle 5.17.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these smart city traffic & mobility sensor hub requirements for opa decoupled policy architecture?",
    options: [
    ...
    explanation: "Open Policy Agent (OPA) is a general-purpose, open-source policy engine that decouples policy decision-making from policy enforcement. Services offload authorization by sending arbitrary JSON context to OPA's in-memory engine, which evaluates declarative Rego policies in sub-millisecond time without querying remote databases during evaluation.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["opa", "architecture", "decoupling", "Smart City Traffic & Mobility Sensor Hub"]
  },
  {
    id: "cncf-opa-118",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rego Rule Evaluation and OR Semantics: Digital Identity & Biometric Verification",
    scenario: "In a digital identity & biometric verification platform, a cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The policy architecture team is currently writing declarative authorization rules in rego under production cluster cycle 5.18.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these digital identity & biometric verification requirements for rego rule evaluation and or semantics?",
    options: [
      { id: 'A', text: "Nest procedural while loops with break statements inside imperative functions to compute access." },
    ...
    explanation: "In Rego, multiple rule definitions sharing the same rule name represent a logical disjunction (OR). If all expressions within at least one rule body evaluate to true, the rule evaluates to true. Within a single rule body, expressions are evaluated as a logical conjunction (AND).",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["rego", "syntax", "rules", "Digital Identity & Biometric Verification"]
  },
  {
    id: "cncf-opa-119",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Default Values and Safe Deny: Legal Discovery & Semantic Document Search",
    scenario: "In a legal discovery & semantic document search platform, a global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The policy architecture team is currently configuring default deny rules for secure authorization under production cluster cycle 5.19.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these legal discovery & semantic document search requirements for default values and safe deny?",
    options: [
      { id: 'A', text: "Set 'default allow := true' to ensure developers never encounter authorization errors during development." },
      { id: 'B', text: "Omit default statements so that undefined rules return null and grant unrestricted access." },
    ...
    explanation: "A foundational principle of zero-trust policy-as-code is fail-closed security. Declaring 'default allow := false' ensures that if an incoming request does not explicitly satisfy any defined allow rule, the result evaluates deterministically to false rather than undefined or permissive.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["rego", "default", "security", "Legal Discovery & Semantic Document Search"]
  },
  {
    id: "cncf-opa-120",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Set and Array Comprehensions: AdTech Real-Time Bidding Exchange",
    scenario: "In a adtech real-time bidding exchange platform, an advertising exchange processes 500,000 bids per second with a strict 20-millisecond sla and distributed caching. The policy architecture team is currently transforming and filtering nested collections in rego under production cluster cycle 5.20.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these adtech real-time bidding exchange requirements for set and array comprehensions?",
    options: [
      { id: 'A', text: "Write recursive procedural functions that mutate global array pointers in memory." },
    ...
    explanation: "Rego provides powerful set, array, and object comprehensions (e.g., '[x | ...]'). Comprehensions iterate over collections, apply filtering predicates, and construct new immutable collections in a single declarative expression without side effects.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["rego", "comprehensions", "collections", "AdTech Real-Time Bidding Exchange"]
  },
  {
    id: "cncf-opa-121",
    difficulty: "hard",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Testing Rego with 'opa test': Precision Agriculture & Drone Scouting",
    scenario: "In a precision agriculture & drone scouting platform, an agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The policy architecture team is currently unit testing policies with mocks and code coverage under production cluster cycle 5.21.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these precision agriculture & drone scouting requirements for testing rego with 'opa test'?",
    options: [
    ...
    explanation: "The OPA CLI provides a built-in testing framework via 'opa test'. Tests define rules starting with 'test_', mock contextual inputs using 'with input as ...' or 'with data as ...', and report code coverage metrics to verify edge cases and rule branches before deployment.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["testing", "opa-test", "coverage", "Precision Agriculture & Drone Scouting"]
  },
  {
    id: "cncf-opa-122",
    difficulty: "hard",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "OPA Bundle API and Management: Industrial Robotics Predictive Maintenance",
    scenario: "In a industrial robotics predictive maintenance platform, a semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The policy architecture team is currently distributing policies dynamically to opa instances under production cluster cycle 5.22.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these industrial robotics predictive maintenance requirements for opa bundle api and management?",
    options: [
      { id: 'A', text: "SSH into every Kubernetes node and manually copy-paste Rego files into the /tmp directory." },
    ...
    explanation: "OPA's Bundle API allows distributed OPA instances to periodically poll and activate versioned, digitally signed policy bundles (tar.gz files containing Rego and data) from cloud object storage (S3, GCS) or control planes without restarting OPA containers.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["bundles", "distribution", "operations", "Industrial Robotics Predictive Maintenance"]
  },
  {
    id: "cncf-opa-123",
    difficulty: "hard",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Decision Logging and Auditability: Educational Remote Proctoring Platform",
    scenario: "In a educational remote proctoring platform platform, an online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The policy architecture team is currently tracking authorization events and compliance records under production cluster cycle 5.23.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these educational remote proctoring platform requirements for decision logging and auditability?",
    options: [
      { id: 'A', text: "Disable logging completely to save disk space and improve raw request latency." },
      { id: 'B', text: "Log only failed requests to local ephemeral container stdout without timestamps." },
    ...
    explanation: "OPA Decision Logging captures high-fidelity audit trails of every policy query, including the full input payload, timestamp, and evaluation decision. Logs can be masked to remove PII and streamed to SIEM systems for regulatory compliance and threat detection.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["decision-logs", "audit", "compliance", "Educational Remote Proctoring Platform"]
  },
  {
    id: "cncf-opa-124",
    difficulty: "hard",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "OPA Decoupled Policy Architecture: Real Estate Valuation & Geo-Spatial Analytics",
    scenario: "In a real estate valuation & geo-spatial analytics platform, a property appraisal engine fuses gis parcel maps with real-time market transactions for automated valuation. The policy architecture team is currently decoupling authorization logic from application source code under production cluster cycle 5.24.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these real estate valuation & geo-spatial analytics requirements for opa decoupled policy architecture?",
    options: [
      { id: 'A', text: "Hardcode role-based access checks directly inside every microservice backend codebase using nested if-else branches." },
      { id: 'B', text: "Deploy a monolithic relational SQL database and execute complex joins synchronously on every user HTTP request." },
    ...
    explanation: "Open Policy Agent (OPA) is a general-purpose, open-source policy engine that decouples policy decision-making from policy enforcement. Services offload authorization by sending arbitrary JSON context to OPA's in-memory engine, which evaluates declarative Rego policies in sub-millisecond time without querying remote databases during evaluation.",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["opa", "architecture", "decoupling", "Real Estate Valuation & Geo-Spatial Analytics"]
  },
  {
    id: "cncf-opa-125",
    difficulty: "hard",
    ...
    domainId: "d1",
    domainName: "OPA Architecture, Rego Language Fundamentals, and Testing",
    title: "Rego Rule Evaluation and OR Semantics: Disaster Emergency Dispatch & Operations",
    scenario: "In a disaster emergency dispatch & operations platform, a municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The policy architecture team is currently writing declarative authorization rules in rego under production cluster cycle 5.25.",
    question: "Which Rego policy implementation or Gatekeeper architecture satisfies these disaster emergency dispatch & operations requirements for rego rule evaluation and or semantics?",
    options: [
    ...
    explanation: "In Rego, multiple rule definitions sharing the same rule name represent a logical disjunction (OR). If all expressions within at least one rule body evaluate to true, the rule evaluates to true. Within a single rule body, expressions are evaluated as a logical conjunction (AND).",
    referenceUrl: "https://www.cncf.io/certification/copaa/",
    tags: ["rego", "syntax", "rules", "Disaster Emergency Dispatch & Operations"]
  }
];

export default CNCF_OPA_QUESTIONS_5;
