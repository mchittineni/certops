export const AZURE_AI102_QUESTIONS_7 = [
  {
    ...
    title: "Letting a Model Reach Live System Data: High-Frequency FinTech Trading",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Constraining Model Behaviour and Refusals: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The AI team is fixing an assistant's persona, scope, and refusal behaviour before it goes live. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Answering From Proprietary Documents: Global E-Commerce Black Friday Scale",
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The AI team is getting accurate answers out of an internal document corpus that changes weekly. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Guaranteed Capacity for a Latency-Sensitive Workload: Autonomous Vehicle Telemetry",
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The AI team is guaranteeing consistent inference latency for a workload that cannot tolerate throttling. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Letting a Model Reach Live System Data: Multi-Tenant B2B SaaS Platform",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Constraining Model Behaviour and Refusals: Media Streaming & Global CDN",
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The AI team is fixing an assistant's persona, scope, and refusal behaviour before it goes live. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Answering From Proprietary Documents: Aerospace Satellite Ground Systems",
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The AI team is getting accurate answers out of an internal document corpus that changes weekly. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Guaranteed Capacity for a Latency-Sensitive Workload: Telecommunications 5G Core Network",
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The AI team is guaranteeing consistent inference latency for a workload that cannot tolerate throttling. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Deploy models with Provisioned Throughput Units (PTU) to guarantee reserved compute capacity, consistent latency, and predictable monthly costs for critical apps." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Letting a Model Reach Live System Data: Renewable Energy Smart Grid IoT",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Constraining Model Behaviour and Refusals: Supply Chain Cold-Chain Logistics",
    scenario: "A pharmaceutical distribution network tracks temperature-sensitive cargo with cryptographic provenance and automated breach alerts. The AI team is fixing an assistant's persona, scope, and refusal behaviour before it goes live. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Answering From Proprietary Documents: Banking Core Ledger & Payments",
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The AI team is getting accurate answers out of an internal document corpus that changes weekly. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Fine-tune a base model on the whole document corpus so that the answers are learned directly into the model's own weights and no retrieval step is needed at query time." },
      { id: 'B', text: "Use Azure OpenAI 'On Your Data' integrated with Azure AI Search to retrieve relevant document chunks using hybrid vector search and ground the model prompt." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Guaranteed Capacity for a Latency-Sensitive Workload: Genomic Sequencing & Biotech Pipeline",
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The AI team is guaranteeing consistent inference latency for a workload that cannot tolerate throttling. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Letting a Model Reach Live System Data: Defense-Grade Zero-Trust Network",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Constraining Model Behaviour and Refusals: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The AI team is fixing an assistant's persona, scope, and refusal behaviour before it goes live. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Answering From Proprietary Documents: Insurance Risk & Actuarial Modeling",
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The AI team is getting accurate answers out of an internal document corpus that changes weekly. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Guaranteed Capacity for a Latency-Sensitive Workload: Pharmaceutical Clinical Trial Platform",
    scenario: "A global pharmaceutical research group manages double-blind clinical trial records with strict regulatory reporting and audit trails. The AI team is guaranteeing consistent inference latency for a workload that cannot tolerate throttling. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use a standard deployment and request a regional quota increase so that the tokens-per-minute limit comfortably covers the peak load that is expected in that region." },
      { id: 'B', text: "Use a standard deployment and add a batch endpoint so that requests queue and complete at a consistent latency once shared capacity becomes available." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Letting a Model Reach Live System Data: Smart City Traffic & Mobility Sensor Hub",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Constraining Model Behaviour and Refusals: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The AI team is fixing an assistant's persona, scope, and refusal behaviour before it goes live. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Set the response_format parameter to a JSON schema so that the model is constrained to the required output structure, including its refusal shape." },
      { id: 'B', text: "Lower the temperature and top_p values so that the model's responses become considerably more consistent from call to call." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Answering From Proprietary Documents: Legal Discovery & Semantic Document Search",
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The AI team is getting accurate answers out of an internal document corpus that changes weekly. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use Azure AI Search on its own to ground the answer, returning the highest-ranked document extracts with no model in the path." },
      { id: 'B', text: "Use Azure OpenAI 'On Your Data' integrated with Azure AI Search to retrieve relevant document chunks using hybrid vector search and ground the model prompt." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Guaranteed Capacity for a Latency-Sensitive Workload: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The AI team is guaranteeing consistent inference latency for a workload that cannot tolerate throttling. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Letting a Model Reach Live System Data: Precision Agriculture & Drone Scouting",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Constraining Model Behaviour and Refusals: Industrial Robotics Predictive Maintenance",
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The AI team is fixing an assistant's persona, scope, and refusal behaviour before it goes live. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Fine-tune the deployed model on several thousand examples that demonstrate both the intended persona and the required output format in each case." },
      { id: 'B', text: "Lower the temperature and top_p values so that the model's responses become considerably more consistent from call to call." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Answering From Proprietary Documents: Educational Remote Proctoring Platform",
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The AI team is getting accurate answers out of an internal document corpus that changes weekly. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Fine-tune a base model on the whole document corpus so that the answers are learned directly into the model's own weights and no retrieval step is needed at query time." },
      { id: 'B', text: "Raise the deployment's context window and place the entire document set into the system message on every single request." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Guaranteed Capacity for a Latency-Sensitive Workload: Real Estate Valuation & Geo-Spatial Analytics",
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The AI team is guaranteeing consistent inference latency for a workload that cannot tolerate throttling. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Deploy models with Provisioned Throughput Units (PTU) to guarantee reserved compute capacity, consistent latency, and predictable monthly costs for critical apps." },
      { id: 'B', text: "Use a standard deployment and request a regional quota increase so that the tokens-per-minute limit comfortably covers the peak load that is expected in that region." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Implement generative AI solutions with Azure OpenAI Service",
    title: "Letting a Model Reach Live System Data: Disaster Emergency Dispatch & Operations",
