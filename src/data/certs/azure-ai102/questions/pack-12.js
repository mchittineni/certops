export const AZURE_AI102_QUESTIONS_12 = [
  {
    id: "azure-ai102-276",
    difficulty: "easy",
    certId: "azure-ai102",
    ...
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The AI team is mapping short spoken commands onto actions together with the parameters each one needs. The work is scoped to the staging environment.",
    ...
    options: [
      ...
      { id: 'D', text: "Send every utterance to an Azure OpenAI deployment and ask the model to name the intent and list any parameters that it finds." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The AI team is building a live voice assistant that must recognise domain-specific product names. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The AI team is stripping identifiers out of stored customer transcripts before analysts see them. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The AI team is extracting printed and handwritten text from photographs taken by field staff. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The AI team is mapping short spoken commands onto actions together with the parameters each one needs. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The AI team is building a live voice assistant that must recognise domain-specific product names. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The AI team is stripping identifiers out of stored customer transcripts before analysts see them. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use Azure AI Language PII detection to mask sensitive entities in transcripts." },
      { id: 'B', text: "Use the key phrase extraction feature in Azure AI Language for detection of the significant terms, stripping them out before storage." },
  ...
  },
  {
    ...
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The AI team is extracting printed and handwritten text from photographs taken by field staff. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use Azure AI Translator's document translation endpoint to process the image files and return the text content it recovers." },
  ...
  },
  {
    ...
    scenario: "A smart electrical grid platform monitors millions of smart meters with low-latency time-series analysis and automated load shedding. The AI team is mapping short spoken commands onto actions together with the parameters each one needs. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Send every utterance to an Azure OpenAI deployment and ask the model to name the intent and list any parameters that it finds." },
  ...
  },
  {
    ...
    scenario: "A pharmaceutical distribution network tracks temperature-sensitive cargo with cryptographic provenance and automated breach alerts. The AI team is building a live voice assistant that must recognise domain-specific product names. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The AI team is stripping identifiers out of stored customer transcripts before analysts see them. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use Azure AI Language PII detection to mask sensitive entities in transcripts." },
  ...
  },
  {
    ...
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The AI team is extracting printed and handwritten text from photographs taken by field staff. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use Azure AI Translator's document translation endpoint to process the image files and return the text content it recovers." },
      { id: 'B', text: "Use the Azure AI Vision Read API for printed and handwritten text." },
  ...
  },
  {
    ...
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The AI team is mapping short spoken commands onto actions together with the parameters each one needs. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The AI team is building a live voice assistant that must recognise domain-specific product names. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use the Azure AI Speech fast transcription API for the incoming audio, without vocabulary tuning, and SSML with a standard voice for the replies." },
      { id: 'B', text: "Use the Azure AI Speech batch transcription REST API for the incoming audio and a selection of prebuilt neural voices for the spoken replies that are sent back." },
  ...
  },
  {
    ...
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The AI team is stripping identifiers out of stored customer transcripts before analysts see them. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A global pharmaceutical research group manages double-blind clinical trial records with strict regulatory reporting and audit trails. The AI team is extracting printed and handwritten text from photographs taken by field staff. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The AI team is mapping short spoken commands onto actions together with the parameters each one needs. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The AI team is building a live voice assistant that must recognise domain-specific product names. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use an Azure OpenAI audio model to transcribe the incoming audio and generate the spoken reply within a single request." },
      { id: 'B', text: "Use the Azure AI Speech batch transcription REST API for the incoming audio and a selection of prebuilt neural voices for the spoken replies that are sent back." },
  ...
  },
  {
    ...
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The AI team is stripping identifiers out of stored customer transcripts before analysts see them. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The AI team is extracting printed and handwritten text from photographs taken by field staff. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The AI team is mapping short spoken commands onto actions together with the parameters each one needs. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Send every utterance to an Azure OpenAI deployment and ask the model to name the intent and list any parameters that it finds." },
      { id: 'B', text: "Use the question answering feature in Azure AI Language with a knowledge base built from the list of supported commands." },
  ...
  },
  {
    ...
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The AI team is building a live voice assistant that must recognise domain-specific product names. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use Azure AI Speech SDK with Neural Voices for natural text-to-speech synthesis and continuous speech recognition with custom vocabulary models." },
  ...
  },
  {
    ...
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The AI team is stripping identifiers out of stored customer transcripts before analysts see them. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use the key phrase extraction feature in Azure AI Language for detection of the significant terms, stripping them out before storage." },
      { id: 'B', text: "Use Azure AI Language PII detection to mask sensitive entities in transcripts." },
  ...
  },
  {
    ...
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The AI team is extracting printed and handwritten text from photographs taken by field staff. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use the Azure AI Vision Image Analysis caption and dense captions features to describe the printed and handwritten content of each page." },
      { id: 'B', text: "Use Azure AI Translator's document translation endpoint to process the image files and return the text content it recovers." },
  ...
  },
  {
    ...
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The AI team is mapping short spoken commands onto actions together with the parameters each one needs. The work is scoped to the staging environment.",
    question: "Which Azure AI approach best meets these requirements?",
    options: [
      { id: 'A', text: "Train a custom text classification project in Azure AI Language so that each utterance is assigned to one of the supported intents as a category." },
...
export default AZURE_AI102_QUESTIONS_12;
