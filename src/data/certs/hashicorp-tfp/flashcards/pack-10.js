export const HASHICORP_TFP_FLASHCARDS_10 = [
  {
    id: 'hashicorp-tfp-fc-226', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd3',
  ...
  {
    id: 'hashicorp-tfp-fc-227', difficulty: 'hard', certId: 'hashicorp-tfp', domainId: 'd1',
    front: 'Which operations write state, and which only read it?',
    hint: 'More write than you think.',
    back: '<strong>Write:</strong> apply, destroy, refresh-only apply, <code>state mv/rm/push/import</code>. Plan never writes state. <strong>Read:</strong> <code>state list/show</code>, <code>output</code>, <code>show</code>, <code>console</code>, <code>graph</code>. Anything that writes takes a lock.',
    tags: ['State', 'Locking']
  },
  {
    id: 'hashicorp-tfp-fc-228', difficulty: 'easy', certId: 'hashicorp-tfp', domainId: 'd4',
  ...
  {
    id: 'hashicorp-tfp-fc-229', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd1',
  ...
  {
    id: 'hashicorp-tfp-fc-231', difficulty: 'hard', certId: 'hashicorp-tfp', domainId: 'd1',
  ...
  {
    id: 'hashicorp-tfp-fc-233', difficulty: 'easy', certId: 'hashicorp-tfp', domainId: 'd4',
  ...
  {
    id: 'hashicorp-tfp-fc-234', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd1',
  ...
  {
    id: 'hashicorp-tfp-fc-235', difficulty: 'hard', certId: 'hashicorp-tfp', domainId: 'd3',
  ...
  {
    id: 'hashicorp-tfp-fc-236', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd3',
  ...
  {
    id: 'hashicorp-tfp-fc-237', difficulty: 'easy', certId: 'hashicorp-tfp', domainId: 'd2',
  ...
  {
    id: 'hashicorp-tfp-fc-238', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd4',
  ...
  {
    id: 'hashicorp-tfp-fc-239', difficulty: 'hard', certId: 'hashicorp-tfp', domainId: 'd1',
  ...
  {
    id: 'hashicorp-tfp-fc-241', difficulty: 'easy', certId: 'hashicorp-tfp', domainId: 'd2',
  ...
  {
    id: 'hashicorp-tfp-fc-242', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd3',
  ...
  {
    id: 'hashicorp-tfp-fc-243', difficulty: 'hard', certId: 'hashicorp-tfp', domainId: 'd4',
  ...
  {
    id: 'hashicorp-tfp-fc-244', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd2',
  ...
  {
    id: 'hashicorp-tfp-fc-246', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd2',
  ...
  {
    id: 'hashicorp-tfp-fc-248', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd3',
  ...
  {
    id: 'hashicorp-tfp-fc-249', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd4',
  ...
  {
    id: 'hashicorp-tfp-fc-250', difficulty: 'hard', certId: 'hashicorp-tfp', domainId: 'd1',
