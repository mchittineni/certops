export const HASHICORP_TFP_FLASHCARDS_2 = [
  {
    id: 'hashicorp-tfp-fc-26', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd2',
  ...
  {
    id: 'hashicorp-tfp-fc-27', difficulty: 'hard', certId: 'hashicorp-tfp', domainId: 'd1',
    front: 'Moving resources between two different state files.',
    hint: 'moved blocks will not help you here.',
    back: "<code>moved</code> only works <em>within</em> one state. Across states: back up both, <strong>import</strong> into the new configuration, then drop the resources from the old one with <code>terraform state rm</code> or a <code>removed</code> block (destroy = false, 1.7+). <code>state mv -state-out</code> only works with local state files. Never copy a whole state file into a configuration that does not declare those resources.",
    tags: ['State', 'Migration']
  },
  {
    id: 'hashicorp-tfp-fc-28', difficulty: 'easy', certId: 'hashicorp-tfp', domainId: 'd2',
  ...
  {
    id: 'hashicorp-tfp-fc-29', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd4',
  ...
  {
    id: 'hashicorp-tfp-fc-32', difficulty: 'easy', certId: 'hashicorp-tfp', domainId: 'd1',
  ...
  {
    id: 'hashicorp-tfp-fc-33', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd1',
  ...
  {
    id: 'hashicorp-tfp-fc-34', difficulty: 'hard', certId: 'hashicorp-tfp', domainId: 'd4',
  ...
  {
    id: 'hashicorp-tfp-fc-35', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd2',
  ...
  {
    id: 'hashicorp-tfp-fc-36', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd1',
  ...
  {
    id: 'hashicorp-tfp-fc-37', difficulty: 'easy', certId: 'hashicorp-tfp', domainId: 'd2',
  ...
  {
    id: 'hashicorp-tfp-fc-38', difficulty: 'hard', certId: 'hashicorp-tfp', domainId: 'd5',
  ...
  {
    id: 'hashicorp-tfp-fc-39', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd4',
  ...
  {
    id: 'hashicorp-tfp-fc-40', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd3',
  ...
  {
    id: 'hashicorp-tfp-fc-42', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd2',
  ...
  {
    id: 'hashicorp-tfp-fc-43', difficulty: 'hard', certId: 'hashicorp-tfp', domainId: 'd1',
  ...
  {
    id: 'hashicorp-tfp-fc-44', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd3',
  ...
  {
    id: 'hashicorp-tfp-fc-45', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd4',
  ...
  {
    id: 'hashicorp-tfp-fc-46', difficulty: 'easy', certId: 'hashicorp-tfp', domainId: 'd2',
  ...
  {
    id: 'hashicorp-tfp-fc-47', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd4',
  ...
  {
    id: 'hashicorp-tfp-fc-48', difficulty: 'hard', certId: 'hashicorp-tfp', domainId: 'd1',
  ...
  {
    id: 'hashicorp-tfp-fc-49', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd2',
  ...
  {
    id: 'hashicorp-tfp-fc-50', difficulty: 'medium', certId: 'hashicorp-tfp', domainId: 'd3',
