export const HASHICORP_TFP_QUESTIONS_7 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Use ${{ var.name }} instead." },
      { id: 'C', text: "Wrap it in the tostring function." },
      { id: 'D', text: "Interpolation is required for all variable references." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "terraform state list module.network" },
      { id: 'C', text: "terraform state show module.network" },
      { id: 'D', text: "terraform show module.network" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Plan does not contact the provider at all." },
      ...
      { id: 'D', text: "Apply uses a different provider version." }
    ],
    correctAnswers: ['B'],
    type: "single",
