export const HASHICORP_TFP_QUESTIONS_5 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The previous state written before the most recent operation, kept as a one-step safety net for the local backend." },
      { id: 'C', text: "A full history of every state version ever written." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Terraform core needs upgrading." },
      { id: 'C', text: "The argument was removed or renamed in a new major provider version; consult the upgrade guide and change the configuration or pin the previous version." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "One workspace per resource type." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The file function with string concatenation." },
      { id: 'B', text: "The deprecated template_file data source from the template provider." },
      { id: 'C', text: "A local-exec provisioner running envsubst." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "terraform import -all, which discovers and imports everything." },
      { id: 'B', text: "terraform state push with a generated state file." },
      { id: 'C', text: "Import blocks combined with terraform plan -generate-config-out=generated.tf, which writes candidate resource configuration for review." },
      { id: 'D', text: "A data source per security group." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Restrict who can read the state and the run logs, since state stores the value in plain text regardless." }
    ],
    correctAnswers: ['A', 'D'],
    type: "multiple",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "An entry in the dependency lock file only." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The state version history." },
      { id: 'B', text: "Speculative plans, which include cost by definition." },
      { id: 'C', text: "Cost estimation, which runs after plan for supported providers and can be gated by a policy on the estimate." },
      { id: 'D', text: "The private module registry." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Data sources are always faster and never fail." },
      { id: 'B', text: "Both approaches give the consumer the ability to modify the producer resources." },
      { id: 'C', text: "Remote state couples the consumer to the producer state layout and requires state access, while a data source couples it to a discoverable naming or tagging convention and needs only provider read access." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deleting the state file from the backend." },
      { id: 'B', text: "terraform state rm for every resource." },
      { id: 'C', text: "terraform apply -destroy -auto-approve, or terraform destroy -auto-approve, scoped to that environment configuration and state." },
      { id: 'D', text: "terraform apply -refresh-only." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "lookup(var.settings, \"timeout\", 30) to supply a default, or declare the attribute as optional with a default in the variable type." },
      { id: 'C', text: "Setting the variable type to any." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A shared variable set." },
      { id: 'B', text: "Remote state sharing, which automatically re-runs consumers." },
      { id: 'C', text: "Run triggers, which queue a run in a workspace when a source workspace completes an apply." },
      { id: 'D', text: "A notification webhook that developers act on manually." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "terraform state push" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Add ignore_changes for that attribute, and if the value is genuinely needed downstream read it through a data source at use time." },
      { id: 'C', text: "Remove the resource from state before each plan." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "terraform plan tfplan" },
      { id: 'C', text: "terraform output -json tfplan" },
