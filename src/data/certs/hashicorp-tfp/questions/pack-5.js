export const HASHICORP_TFP_QUESTIONS_5 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "[ for k, v in var.subnets : k if v.public ]" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Upgrade the provider to a version that supports module iteration." },
      { id: 'C', text: "Replace for_each with a dynamic block." },
      { id: 'D', text: "Remove the provider blocks from the module and have it declare configuration_aliases instead, with the caller passing providers explicitly." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The state of the previous workspace." },
      { id: 'B', text: "An encrypted copy of the current state." },
      ...
      { id: 'D', text: "A full history of every state version ever written." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Skip all checks on forks and rely on review." },
      { id: 'D', text: "Run fmt -check, validate with -backend=false, and static analysis on the fork; run plan against real credentials only for branches in the trusted repository." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "terraform init, which reinstalls modules into .terraform/modules; add -upgrade to move to a newer allowed version." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A data source per security group." },
      { id: 'B', text: "terraform import -all, which discovers and imports everything." },
      { id: 'C', text: "terraform state push with a generated state file." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Use -no-color so values are not highlighted." },
      { id: 'B', text: "Encrypt the plan file, which prevents display of the value." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "(known after apply) always indicates an error in the provider." },
      { id: 'B', text: "Unknown values only occur on first apply and never afterwards." },
      { id: 'C', text: "count and for_each keys must be resolvable at plan time, so anything derived from an unknown attribute must be restructured or applied in stages." },
      { id: 'D', text: "Unknown values can be forced known with the tolist function." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The private module registry." },
      { id: 'B', text: "The state version history." },
      { id: 'C', text: "Speculative plans, which include cost by definition." },
      { id: 'D', text: "Cost estimation, which runs after plan for supported providers and can be gated by a policy on the estimate." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A variable validation block inside the test file." },
      { id: 'B', text: "A precondition on the test provider." },
      { id: 'C', text: "A Sentinel policy in the test directory." },
      { id: 'D', text: "A run block with command = apply containing an assert block whose condition compares the module output to the expected prefix." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Data sources are always faster and never fail." },
      { id: 'C', text: "Both approaches give the consumer the ability to modify the producer resources." },
      { id: 'D', text: "Remote state is deprecated in favour of data sources." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "terraform state rm for every resource." },
      { id: 'B', text: "terraform apply -destroy -auto-approve, or terraform destroy -auto-approve, scoped to that environment configuration and state." },
      { id: 'C', text: "terraform apply -refresh-only." },
      { id: 'D', text: "Deleting the state file from the backend." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "try(var.settings[\"timeout\"]) with no fallback." },
      ...
      { id: 'D', text: "coalesce(var.settings) to fill missing keys." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "State locking failed, which always causes duplicates." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Naming variables after the provider attributes they set." },
      { id: 'B', text: "Publishing the module without a version so consumers always get the latest documentation." },
      { id: 'C', text: "Descriptions and precise types on every variable and output, a README with usage examples, and an examples directory that is exercised by tests." },
      { id: 'D', text: "A comment at the top of main.tf listing the resources." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "terraform state push" },
      { id: 'B', text: "terraform apply -refresh-only" },
      { id: 'C', text: "terraform force-unlock" },
      { id: 'D', text: "terraform apply -auto-approve" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable refresh for the whole configuration." },
      ...
      { id: 'D', text: "Set the attribute to null so Terraform stops tracking it." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The CLI configuration file - .terraformrc or terraform.rc in the user home directory - which can define credentials, provider_installation, and the plugin cache." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It is a reasonable way to encode standards and reduce choice, at the cost of an extra layer to maintain and upgrade whenever the upstream module changes." },
      { id: 'B', text: "It prevents consumers from ever hitting upstream breaking changes." },
      { id: 'C', text: "It removes the need to pin the upstream module version." },
