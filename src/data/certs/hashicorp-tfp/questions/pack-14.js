export const HASHICORP_TFP_QUESTIONS_14 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Terraform does not support native testing frameworks." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Write documentation manually in Word documents stored outside the repository." },
      { id: 'C', text: "Rely on developers to manually keep README tables updated in every pull request." },
