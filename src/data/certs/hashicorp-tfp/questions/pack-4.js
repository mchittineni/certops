export const HASHICORP_TFP_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The directory named root or modules/root." },
      { id: 'B', text: "The top level of the git repository." },
      { id: 'C', text: "The directory in which Terraform is run - its .tf files form the root module, and any module blocks in them call child modules." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Running terraform init -upgrade on every job." },
      { id: 'B', text: "Removing version constraints so any cached version is accepted." },
      { id: 'C', text: "A provider plugin cache directory (TF_PLUGIN_CACHE_DIR) persisted between jobs, or a provider mirror." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "aws_subnet.this[0].id" },
      { id: 'B', text: "aws_subnet.this[\"prod\"].id" },
      { id: 'C', text: "each.value[\"prod\"].id" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Wrap the value in nonsensitive() as the standard fix." },
      { id: 'B', text: "Instance keys appear in plan output and state addresses, which would expose the sensitive value; derive the keys from a non-sensitive source instead." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "terraform state show endpoint" },
      { id: 'D', text: "terraform console -var endpoint" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Nesting depth has no effect because the graph is flattened." },
      { id: 'B', text: "Deep nesting is required for reuse and should be increased." },
      ...
      { id: 'D', text: "Terraform forbids more than two levels of nesting." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "depends_on = [aws_launch_configuration.this]" },
      { id: 'B', text: "ignore_changes = [aws_launch_configuration.this]" },
      { id: 'C', text: "replace_triggered_by = [aws_launch_configuration.this]" },
      { id: 'D', text: "create_before_destroy = true" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Run terraform apply -auto-approve nightly." },
      { id: 'D', text: "Enable state versioning and compare serial numbers." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The provider has not been initialised." },
      { id: 'B', text: "The state file has not been refreshed." },
      { id: 'C', text: "The resource is declared inside a child module, so the root must reference a module output instead of the resource address." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The bucket is deleted from the cloud." },
      { id: 'C', text: "The configuration block is removed from the .tf files." },
      { id: 'D', text: "The bucket is marked for replacement on the next apply." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Remove version constraints so everyone tracks main." },
      ...
      { id: 'D', text: "Make the breaking change immediately and tell consumers to fix their code." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A for_each on the provider block." },
      { id: 'C', text: "One provider block whose region is a list." },
      { id: 'D', text: "Two provider blocks, one default and one with alias = \"west\", with resources selecting provider = aws.west where needed." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enforcement levels apply per organisation only, so two policy sets are impossible." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The input variables, echoed back." },
      { id: 'B', text: "The provider credentials used during the run." },
      { id: 'C', text: "The identifiers and attributes consumers must reference, such as vpc_id and subnet_ids, described and typed clearly." },
      { id: 'D', text: "Every attribute of every resource, so nothing is missing." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Terraform silently removes the resource from the configuration." },
      { id: 'B', text: "Terraform errors out and refuses to plan until state is repaired." },
