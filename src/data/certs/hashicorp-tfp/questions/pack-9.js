export const HASHICORP_TFP_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Apply always skips security groups." },
      { id: 'B', text: "The rule is managed as an inline block or is not in the configuration at all, or the run did not refresh - Terraform only reconciles what its configuration and state describe." },
      { id: 'C', text: "The provider cached the previous result." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A single slash before the subdirectory." },
      { id: 'B', text: "A subdir argument alongside source." },
      { id: 'C', text: "A path argument in the module block." },
      { id: 'D', text: "A double slash before the subdirectory, as in git::https://example.com/repo.git//modules/vpc?ref=v1.0.0" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Confirming the state serial increased." },
      ...
      { id: 'D', text: "Checking that terraform state list returns any output." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Concatenating lines with the plus operator." },
      { id: 'B', text: "Backtick-delimited template literals." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable the autoscaler." },
      { id: 'B', text: "Run Terraform more frequently so it wins." },
      { id: 'C', text: "Remove the resource from Terraform management entirely." },
      { id: 'D', text: "Add ignore_changes for the capacity attribute so the external system owns it, while Terraform continues to own the rest of the resource." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Reduce the size of each configuration so a typical change touches fewer resources." },
      { id: 'C', text: "Post only the exit code." },
      { id: 'D', text: "Summarise the change counts and highlight destroy and replace actions from the JSON plan, collapsing the full output behind a details block." }
    ],
    correctAnswers: ['B', 'D'],
    type: "multiple",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Terraform requires an explicit terraform state init command first." },
      { id: 'B', text: "Terraform scans the cloud account and adopts matching resources automatically." },
      { id: 'C', text: "Terraform creates a new state with a fresh lineage, plans every resource as a create, applies them, and writes each created object into state as it goes." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The published tag does not contain the same code - the change was never committed, tagged, or the tag points at an older commit - so compare the published contents with the local working tree." },
      { id: 'C', text: "Registry modules cannot use for_each." },
      { id: 'D', text: "Local modules use a different provider version." }
    ],
    correctAnswers: ['B'],
    type: "single",
