export const HASHICORP_TFP_QUESTIONS_18 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "`-var` and `-var-file` in CLI order, then `*.auto.tfvars`, `terraform.tfvars`, `TF_VAR_`, defaults." },
      { id: 'D', text: "`TF_VAR_` environment variables win, then `-var`, then the various variable files in order." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Command-line `-var` and `-var-file` options take the highest precedence and share it: they are processed in the order given, so a later one overrides an earlier one. Below them, from higher to lower: `*.auto.tfvars` files (in lexical order), `terraform.tfvars.json`, `terraform.tfvars`, `TF_VAR_` environment variables, and finally the default in the variable block.",
  ...
  },
  {
    ...
    question: "Which architectural pattern or Terraform capability manages this scale effectively while preventing dependency bottlenecks and configuration drift?",
    options: [
      { id: 'A', text: "`-var` and `-var-file` in CLI order, then `*.auto.tfvars`, `terraform.tfvars`, `TF_VAR_`, defaults." },
      { id: 'B', text: "The default in `variables.tf` always wins, and every other source is applied only when it is absent." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "`-var` and `-var-file` in CLI order, then `*.auto.tfvars`, `terraform.tfvars`, `TF_VAR_`, defaults." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Command-line `-var` and `-var-file` options take the highest precedence and share it: they are processed in the order given, so a later one overrides an earlier one. Below them, from higher to lower: `*.auto.tfvars` files (in lexical order), `terraform.tfvars.json`, `terraform.tfvars`, `TF_VAR_` environment variables, and finally the default in the variable block.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "`-var` and `-var-file` in CLI order, then `*.auto.tfvars`, `terraform.tfvars`, `TF_VAR_`, defaults." },
      { id: 'C', text: "`terraform.tfvars` wins, then `-var`, then `*.auto.tfvars`, `TF_VAR_` env vars and defaults." },
      { id: 'D', text: "`TF_VAR_` environment variables win, then `-var`, then the various variable files in order." }
    ],
    correctAnswers: ['B'],
  ...
  },
  {
    ...
    title: "HCP Terraform Agent Pools for Private Environments: Dr Failover",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Collaborate on infrastructure as code using HCP Terraform",
    title: "HCP Terraform Agent Pools for Private Environments: High Load Scale",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Collaborate on infrastructure as code using HCP Terraform",
    title: "HCP Terraform Agent Pools for Private Environments: Security Compliance",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Collaborate on infrastructure as code using HCP Terraform",
    title: "HCP Terraform Agent Pools for Private Environments: Hybrid Migration",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Collaborate on infrastructure as code using HCP Terraform",
    title: "HCP Terraform Agent Pools for Private Environments: Resilience Failure",
