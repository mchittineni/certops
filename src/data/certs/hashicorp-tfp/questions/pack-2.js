export const HASHICORP_TFP_QUESTIONS_2 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "[ for o in var.items : o.name ]" },
      { id: 'D', text: "merge(var.items...)" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "terraform state mv -state-out with the target state file (or pull, edit, push carefully), after backing up both states - or re-import the resources into the new configuration." },
      { id: 'C', text: "A moved block, which works across separate state files." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A variable set scoped to the organisation, a project, or a chosen list of workspaces." },
      { id: 'C', text: "A workspace template that clones variables on creation." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set the provider version to any value in required_providers." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "terraform validate, which executes assertions against real infrastructure." },
      { id: 'B', text: "terraform test with .tftest.hcl files containing run blocks and assert conditions." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Store the key in a Terraform variable marked sensitive." },
      { id: 'C', text: "Pass the access key as a -var value on the command line." },
      { id: 'D', text: "Use OIDC or workload identity federation so the CI job exchanges a short-lived token for cloud credentials at run time." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Only the lock file needs protecting; state itself is redacted." },
      { id: 'D', text: "State files are binary and cannot be diffed, so version control adds nothing." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "CLI workspaces are deprecated and removed." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "terraform force-unlock." },
      ...
      { id: 'D', text: "terraform graph, which renders the dependency graph." }
    ],
    correctAnswers: ['C'],
    type: "single",
