/**
 * Docker Certified Associate (DCA) — exam blueprint.
 *
 ...
 *   4. add content: npm run new:pack -- --cert docker-dca --kind questions --count 50
 */
export default {
  "id": "docker-dca",
  "provider": "Docker",
  ...
  "icon": "docker",
  "color": "#2496ED",
  "description": "TODO one-sentence description of what DCA validates.",
  "passingScore": 65,
  "maxScore": 100,
