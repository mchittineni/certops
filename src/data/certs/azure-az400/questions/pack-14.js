export const AZURE_AZ400_QUESTIONS_14 = [
  {
    ...
    options: [
      { id: 'A', text: "Configure a forking workflow where developers fork the central repository into their own project, make modifications, and submit cross-repository pull requests." },
