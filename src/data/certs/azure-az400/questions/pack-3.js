export const AZURE_AZ400_QUESTIONS_3 = [
  {
    ...
    options: [
      { id: 'A', text: "Branch policies on main requiring reviewers and validation" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Basic merge (no-fast-forward merge commit)" },
      { id: 'B', text: "Squash merge" },
      { id: 'C', text: "Fast-forward merge only" },
      { id: 'D', text: "Rebase and merge" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Scalar (formerly VFS for Git)" },
      { id: 'B', text: "Git submodule" },
      { id: 'C', text: "AzCopy" },
      { id: 'D', text: "Docker Desktop" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Maintaining separate branches for each customer tenant" },
      { id: 'B', text: "Trunk-based development with short-lived branches merged daily" },
      { id: 'C', text: "GitFlow with long-lived feature, develop, release, and hotfix branches" },
      { id: 'D', text: "Forking workflow where every developer works in a personal clone" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Client-side pre-commit hooks" },
      { id: 'C', text: "Azure Artifacts upstream sources" },
      { id: 'D', text: "Azure Boards delivery plans" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "When contractors lack write access to the origin repository" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Use subversion instead of git" },
      { id: 'B', text: "Disable pull requests completely" },
      { id: 'C', text: "Delete the release branch after each deployment" },
      { id: 'D', text: "Limit merge types to squash" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Copying files manually using Windows Explorer" },
      { id: 'B', text: "AzCopy data transfer" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A branch moves with new commits; a tag stays on one commit" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The main branch is reset to the initial commit" },
      { id: 'B', text: "The commits are replayed on main, giving new SHAs" },
      { id: 'C', text: "The feature commits are permanently deleted" },
      { id: 'D', text: "A 3-way merge commit is generated joining the branches" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable build validation" },
      { id: 'C', text: "Merge the PR immediately using administrator bypass" },
      { id: 'D', text: "Set auto-complete on the pull request" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable branch policies" },
      { id: 'B', text: "Send manual emails to the downstream application team" },
      { id: 'C', text: "Combine both repositories into a single Git branch" },
      { id: 'D', text: "Pipeline resource triggers and status checks" }
    ],
    correctAnswers: ['D'],
    type: "single",
