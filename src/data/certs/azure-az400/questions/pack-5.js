export const AZURE_AZ400_QUESTIONS_5 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "When deploying to Azure App Service" },
      { id: 'C', text: "When builds need private network or licensed software" },
      { id: 'D', text: "When compiling public GitHub repositories" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run the agent as the root user" },
      { id: 'B', text: "Run the agent as a dedicated non-root service user" },
      { id: 'C', text: "Run the agent using the personal account of the CIO" },
      { id: 'D', text: "Run the agent with passwordless sudo on all commands" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Code (read and write)" },
      { id: 'B', text: "Full access" },
      { id: 'C', text: "Agent Pools (read, manage)" },
      { id: 'D', text: "Work Items (read)" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Agent pool maintenance jobs on a schedule" },
      { id: 'B', text: "Disabling all builds" },
      { id: 'C', text: "Restarting the VM after every job" },
      { id: 'D', text: "Manually formatting the agent hard drive every month" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Containerized agent pods scaled by KEDA" },
      { id: 'B', text: "Deploying physical blade servers" },
      { id: 'C', text: "Using Microsoft-hosted pools exclusively" },
      { id: 'D', text: "Running Windows 98 VMs" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Service principal with client secret (password)" },
      { id: 'C', text: "Personal user credentials" },
      { id: 'D', text: "Workload identity federation (OIDC - OpenID Connect)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Use client secret authentication" },
      { id: 'B', text: "Make the service connection public" },
      { id: 'C', text: "Delete the service connection after every deployment" },
      { id: 'D', text: "Authorize only specific pipelines on the connection" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run the pipeline 4 times manually" },
      { id: 'B', text: "Delete half of the unit tests" },
      { id: 'C', text: "Decrease the test timeout to 15 minutes" },
      { id: 'D', text: "Parallel slicing with VSTest@2" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "name: $(Date:yyyy.MM.dd)$(Rev:.r)" },
      { id: 'C', text: "variables: { build: 1 }" },
      { id: 'D', text: "version: 1.0" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "continueOnError: true" },
      { id: 'B', text: "retryCountOnTaskFailure: 2" },
      { id: 'C', text: "timeoutInMinutes: 2" },
      { id: 'D', text: "condition: always()" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "continueOnError works only on Windows" },
      { id: 'B', text: "condition: always() deletes failed build logs" },
      { id: 'C', text: "There is no difference between continueOnError and condition: always()" },
      { id: 'D', text: "`continueOnError` warns; `condition: always()` still runs later tasks" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Enable system diagnostics on the run" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Pipeline retention policies" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Secure files, fetched with DownloadSecureFile@1" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "pwsh: true" },
      { id: 'B', text: "script: powershell.exe" },
      { id: 'C', text: "os: cross-platform" },
      { id: 'D', text: "targetType: inline" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Bash@3 runs bash; CmdLine@2 the native shell" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "DOTNET_SKIP_FIRST_TIME_EXPERIENCE: '1' on the build job" },
      { id: 'C', text: "DOTNET_NOLOGO: '1' and NPM_CONFIG_LOGLEVEL: 'silent'" },
      { id: 'D', text: "An agent-level firewall rule blocking outbound telemetry hosts" }
    ],
    correctAnswers: ['A'],
    type: "single",
