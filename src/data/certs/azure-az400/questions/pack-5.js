export const AZURE_AZ400_QUESTIONS_5 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "When builds need private network or licensed software" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Run the agent as a dedicated non-root service user" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Containerized agent pods scaled by KEDA" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Authorize only specific pipelines on the connection" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Parallel slicing with VSTest@2" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "`continueOnError` warns; `condition: always()` still runs later tasks" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable system diagnostics on the run" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Pipeline retention policies" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Secure files, fetched with DownloadSecureFile@1" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Bash@3 runs bash; CmdLine@2 the native shell" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "scriptLocation: inlineScript, pasting the file contents into the YAML" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "DOTNET_NOLOGO: '1' and NPM_CONFIG_LOGLEVEL: 'silent'" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Authorize the pipeline on the agent pool" },
