export const AZURE_AZ400_QUESTIONS_2 = [
  {
    ...
    certId: "azure-az400",
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #24",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #25",
    scenario: "A DevOps lead is standardizing team notification channels, sprint cadence, and cross-tool integrations between Azure DevOps and chat platforms.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #26",
    scenario: "A DevOps lead is standardizing team notification channels, sprint cadence, and cross-tool integrations between Azure DevOps and chat platforms.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #27",
    scenario: "A DevOps lead is standardizing team notification channels, sprint cadence, and cross-tool integrations between Azure DevOps and chat platforms.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #28",
    scenario: "A DevOps lead is standardizing team notification channels, sprint cadence, and cross-tool integrations between Azure DevOps and chat platforms.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #29",
    scenario: "A DevOps lead is standardizing team notification channels, sprint cadence, and cross-tool integrations between Azure DevOps and chat platforms.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #30",
    scenario: "A DevOps lead is standardizing team notification channels, sprint cadence, and cross-tool integrations between Azure DevOps and chat platforms.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #31",
    scenario: "A DevOps lead is standardizing team notification channels, sprint cadence, and cross-tool integrations between Azure DevOps and chat platforms.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #32",
    scenario: "A DevOps lead is standardizing team notification channels, sprint cadence, and cross-tool integrations between Azure DevOps and chat platforms.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #33",
    scenario: "A DevOps lead is standardizing team notification channels, sprint cadence, and cross-tool integrations between Azure DevOps and chat platforms.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #34",
    scenario: "A DevOps lead is standardizing team notification channels, sprint cadence, and cross-tool integrations between Azure DevOps and chat platforms.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #35",
    scenario: "A DevOps lead is standardizing team notification channels, sprint cadence, and cross-tool integrations between Azure DevOps and chat platforms.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Process and Communication Scenario #36",
    scenario: "A DevOps lead is standardizing team notification channels, sprint cadence, and cross-tool integrations between Azure DevOps and chat platforms.",
  ...
  },
  {
    ...
    certId: "azure-az400",
    domainId: "d2",
    domainName: "Design and implement a source control strategy",
    title: "Git Branching Strategy: Trunk-Based Development vs. GitFlow",
    scenario: "A software engineering group is shifting from quarterly release cycles to continuous delivery (CD), deploying to production multiple times per day. The current GitFlow model with long-lived feature, develop, and release branches causes frequent painful merge conflicts.",
    question: "Which branching strategy should the team adopt to support continuous delivery?",
    options: [
      { id: 'A', text: "Trunk-based development with short-lived branches and feature flags" },
      { id: 'B', text: "GitFlow with additional long-lived staging and integration branches" },
      { id: 'C', text: "Release branching where developers commit code directly to hotfix branches" },
      { id: 'D', text: "Forking workflow where every developer works in a private disconnected repository without merging" }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Trunk-Based Development is the industry-standard branching strategy for high-performing DevOps teams practicing continuous delivery. Developers collaborate on a single shared branch ('main' or 'trunk') using short-lived feature branches (lasting hours to days), avoiding large merge conflicts and leveraging feature flags to decouple code deployment from feature release.",
    referenceUrl: "https://learn.microsoft.com/en-us/devops/develop/how-microsoft-develops-with-devops",
    tags: ["Git","Trunk-Based Development","Branching Strategy","Source Control"]
  },
  {
    id: "azure-az400-40",
    difficulty: "easy",
    ...
    domainId: "d2",
    domainName: "Design and implement a source control strategy",
    title: "Branch Policy Enforcement for Production Stability",
    ...
    options: [
      { id: 'A', text: "Converting the repository to read-only and deploying code via FTP" },
      { id: 'B', text: "Azure Policy assigned at the subscription level restricting Git CLI push commands" },
      { id: 'C', text: "Branch policies requiring reviewers, build validation and comment resolution" },
      { id: 'D', text: "Pre-commit hooks installed manually on each developer's personal laptop" }
    ],
    correctAnswers: ['C'],
    type: "single",
    ...
    tags: ["Azure Repos","Branch Policies","Pull Requests","Code Review"]
  },
  {
    id: "azure-az400-41",
    difficulty: "hard",
    ...
    domainId: "d2",
    domainName: "Design and implement a source control strategy",
    title: "Managing Massive Binary Assets in Git with Git LFS",
    ...
    options: [
      { id: 'A', text: "Compress all 3D assets into a multi-part ZIP archive committed directly to the main branch" },
      { id: 'B', text: "Split the repository into 500 individual micro-repositories" },
      { id: 'C', text: "Instruct developers to use git commit --amend exclusively to overwrite history" },
      { id: 'D', text: "Git LFS, keeping pointers in the tree and payloads on remote storage" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    tags: ["Git LFS","Azure Repos","Performance","Source Control"]
  },
  {
    id: "azure-az400-42",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Customizing Azure Boards Process Templates: Inherited Processes",
    scenario: "An organization uses the standard Scrum process template in Azure Boards. The PMO mandates adding a custom 'Security Sign-off' boolean field and a custom work item state 'Pen-Test Review' to all User Stories.",
    ...
    options: [
      ...
      { id: 'C', text: "Create an inherited Scrum process, customize it, and switch the project to it" },
    ...
    tags: ["Azure Boards","Process Templates","Inherited Process","Work Items"]
  },
  {
    id: "azure-az400-43",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Cross-Project Work Item Querying and Dashboards",
    ...
    options: [
      { id: 'A', text: "Assigning all bugs to a single developer account" },
      { id: 'B', text: "A cross-project query pinned to an organization dashboard" },
      { id: 'C', text: "Consolidating all five repositories into a single Git repository" },
      { id: 'D', text: "Exporting work items to Microsoft Excel every morning" }
    ],
    correctAnswers: ['B'],
    type: "single",
    ...
    tags: ["Azure Boards","Queries","Dashboards","Reporting"]
  },
  {
    id: "azure-az400-44",
    difficulty: "easy",
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Azure DevOps Integration with Microsoft Teams: Service Hooks",
    ...
    options: [
      { id: 'A', text: "The Azure Pipelines and Azure Repos Teams apps, wired through service hooks" },
    ...
    tags: ["Microsoft Teams","Service Hooks","Notifications","ChatOps"]
  },
  {
    id: "azure-az400-45",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Azure Boards GitHub Integration: Linking Commits and PRs",
    ...
    options: [
      { id: 'A', text: "The Azure Boards app for GitHub, with AB#ID in commit messages" },
      { id: 'B', text: "Manually attach git log screenshots to the work item card in Azure Boards" },
      { id: 'C', text: "Rename the git branch to match the work item title" },
    ...
    tags: ["Azure Boards","GitHub","Integration","Traceability"]
  },
  {
    id: "azure-az400-46",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Service Hooks vs Webhooks: Event-Driven Automation",
    ...
    referenceUrl: "https://learn.microsoft.com/en-us/azure/devops/service-hooks/overview",
    tags: ["Service Hooks","Webhooks","Automation","Integrations"]
  },
  {
    id: "azure-az400-47",
    difficulty: "easy",
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Azure DevOps Wiki: Code Repository vs Project Wiki",
    ...
    options: [
      { id: 'A', text: "Publish code as wiki from a repository folder" },
      { id: 'B', text: "Use Work Item description fields" },
      { id: 'C', text: "Provision a default Project Wiki" },
      { id: 'D', text: "Store documentation in Word files on OneDrive" }
    ],
    correctAnswers: ['A'],
    type: "single",
    ...
    tags: ["Wiki","Documentation","Git","Knowledge Base"]
  },
  {
    id: "azure-az400-48",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Area Paths and Iteration Paths in Multi-Squad Organizations",
    ...
    options: [
      { id: 'A', text: "Distinct area paths per squad and shared iteration paths" },
      { id: 'B', text: "Assign all squads to a single backlog column without filters" },
      { id: 'C', text: "Create three separate Azure DevOps organizations" },
      { id: 'D', text: "Use separate Git repositories with no shared boards" }
    ],
    correctAnswers: ['A'],
    type: "single",
    ...
    tags: ["Area Paths","Iteration Paths","Azure Boards","Agile"]
  },
  {
    id: "azure-az400-49",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Configuring Project-Level Permissions with Microsoft Entra Groups",
    ...
    options: [
      ...
      { id: 'C', text: "Add the Entra group to the Project Administrators group" },
    ...
    tags: ["Entra ID","RBAC","Governance","Permissions"]
  },
  {
    id: "azure-az400-50",
    difficulty: "easy",
    ...
    domainId: "d1",
    domainName: "Design and implement processes and communications",
    title: "Delivery Plans: Multi-Team Milestone Tracking",
    ...
    correctAnswers: ['B'],
    type: "single",
    explanation: "Delivery Plans provides a visual timeline view of multi-team work items across sprints and calendar dates, allowing program managers to track deliverables, identify dependencies, and manage release milestones across multiple team backlogs.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/devops/boards/plans/review-team-plans",
    tags: ["Delivery Plans","Roadmap","Milestones","Azure Boards"]
  }
];
