export const AZURE_AZ400_QUESTIONS_2 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Branch policies requiring reviewers, build validation and comment resolution" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Git LFS, keeping pointers in the tree and payloads on remote storage" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Create an inherited Scrum process, customize it, and switch the project to it" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A cross-project query pinned to an organization dashboard" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "The Azure Pipelines and Azure Repos Teams apps, wired through service hooks" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The Azure Boards app for GitHub, with AB#ID in commit messages" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Publish code as wiki from a repository folder" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Distinct area paths per squad and shared iteration paths" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Add the Entra group to the Project Administrators group" },
