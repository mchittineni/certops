export const AZURE_AZ400_QUESTIONS_6 = [
  {
    ...
    options: [
      { id: 'A', text: "workspace: 'Production'" },
      { id: 'B', text: "pool: 'Production'" },
      { id: 'C', text: "environment: 'Production'" },
      { id: 'D', text: "stage: 'Production'" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Inline the script in azure-pipelines.yml as a bash step" },
      { id: 'B', text: "In Azure Key Vault" },
      { id: 'C', text: "In branch protection rules" },
      { id: 'D', text: "Under Environments, in Approvals and checks" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "By shutting down all virtual machines" },
      { id: 'B', text: "Rollbacks cannot be automated in YAML pipelines" },
      { id: 'C', text: "In the `on: failure` lifecycle hook" },
      { id: 'D', text: "By deleting the entire Azure resource group" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Business Hours check on the Environment" },
      { id: 'B', text: "Disabling the pipeline manually on Friday" },
      { id: 'C', text: "Setting a 48-hour timeout" },
      { id: 'D', text: "Writing a cron job on developer laptops" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "ArchiveFiles@2" },
      { id: 'C', text: "Docker@2 with action: build" },
      { id: 'D', text: "A bake action step" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "YAML pipelines are versioned, reviewed and audited in Git" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Service Connections" },
      { id: 'B', text: "Variable Groups" },
      { id: 'C', text: "YAML step templates" },
      { id: 'D', text: "Agent Pools" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deployment Groups only support Linux; Environments only support Windows" },
      { id: 'B', text: "Deployment Groups run in the cloud; Environments run only on-premises" },
      { id: 'C', text: "Deployment groups are Classic; environments are the YAML construct" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Database migrations should only be executed manually by developers" },
      { id: 'C', text: "In a pre-deployment hook, before traffic is routed" },
      { id: 'D', text: "After deleting the production database" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Committing node_modules into git" },
      { id: 'B', text: "npmjs.org as an upstream source on the internal feed" },
      { id: 'C', text: "Disabling external package dependencies" },
      { id: 'D', text: "Downloading all 2 million npm packages onto a local hard drive" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "npm packages" },
      { id: 'B', text: "Maven artifacts" },
      { id: 'C', text: "NuGet packages" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Automatic package retention policies on the feed" },
