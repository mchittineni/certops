export const AZURE_AZ400_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Universal Packages" },
      { id: 'B', text: "Azure Blob Storage sync" },
      { id: 'C', text: "Pipeline Artifacts" },
      { id: 'D', text: "Upstream sources" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Pipeline → Jobs → Stages → Steps" },
      { id: 'B', text: "Pipeline → Tasks → Environments → Deployments" },
      { id: 'C', text: "Pipeline → Steps → Jobs → Stages" },
      { id: 'D', text: "Pipeline → Stages → Jobs → Steps (Tasks/Scripts)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "pool: fast-pool" },
      { id: 'B', text: "cancelTimeoutInMinutes: 5" },
      { id: 'C', text: "retryCountOnTaskFailure: 0" },
      { id: 'D', text: "timeoutInMinutes: 30" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Convert the project to Windows" },
      { id: 'B', text: "Specify `container: mycorp/build-env:v1` at the job level" },
      { id: 'C', text: "Install the tools using sudo apt-get on every run" },
      { id: 'D', text: "Run docker run inside every script step manually" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Running mocks only" },
      { id: 'C', text: "services: { postgres: 'postgres:15', redis: 'redis:alpine' }" },
      { id: 'D', text: "Deploying live Azure SQL databases for every test" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "demands: [ 'VisualStudio', 'GPU' ]" }
    ],
    correctAnswers: ['D'],
    type: "single",
