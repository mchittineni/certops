export const AZURE_AZ400_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Self-hosted agents on machines inside the corporate network" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The `extends:` template syntax" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "The publish test and coverage tasks" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "timeoutInMinutes: 30" },
      { id: 'B', text: "retryCountOnTaskFailure: 0" },
      { id: 'C', text: "pool: fast-pool" },
      { id: 'D', text: "cancelTimeoutInMinutes: 5" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Write a bash script that downloads the secrets over an unencrypted HTTP endpoint" },
      { id: 'B', text: "Paste the database password in the commit message" },
      { id: 'C', text: "A variable group with secrets linked from an Azure key vault" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The password is printed in plaintext" },
      { id: 'B', text: "The agent machine is formatted" },
      { id: 'C', text: "The secret value is masked with asterisks in the log" },
      { id: 'D', text: "The pipeline aborts immediately with a compiler error" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Install the tools using sudo apt-get on every run" },
      { id: 'B', text: "Convert the project to Windows" },
      { id: 'C', text: "Run docker run inside every script step manually" },
      { id: 'D', text: "Specify `container: mycorp/build-env:v1` at the job level" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "services: { postgres: 'postgres:15', redis: 'redis:alpine' }" },
      { id: 'C', text: "Deploying live Azure SQL databases for every test" },
      { id: 'D', text: "Running mocks only" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Limit job authorization scope" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "demands: [ 'VisualStudio', 'GPU' ]" },
      { id: 'B', text: "tags: [ 'GPU' ]" },
