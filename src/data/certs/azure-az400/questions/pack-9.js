export const AZURE_AZ400_QUESTIONS_9 = [
  {
    ...
    options: [
      { id: 'A', text: "It speeds up secret encryption algorithms" },
      { id: 'B', text: "It allows public unauthenticated access to secrets" },
      { id: 'C', text: "Consistent access management, with PIM support" },
      { id: 'D', text: "It makes Key Vault free of charge" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Transport Layer Security (TLS 1.3)" },
      { id: 'B', text: "Azure Storage SSE" },
      { id: 'C', text: "Azure Confidential Computing" },
      { id: 'D', text: "Azure Disk Encryption with BitLocker" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Customer-managed keys in Key Vault" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Weekly status reports by email" },
      { id: 'B', text: "Restarting servers once a day" },
      { id: 'C', text: "Console print statements" },
      { id: 'D', text: "Tracing, logging and metrics" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "By passing a `traceparent` correlation header between services" },
      { id: 'B', text: "By consolidating all services onto a single virtual machine" },
      { id: 'C', text: "By checking the server clock timestamps manually" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Service Health alert dashboard" },
      { id: 'B', text: "Azure Network Watcher connection monitor" },
      { id: 'C', text: "Azure Activity Log event viewer" },
      { id: 'D', text: "The Application Map and diagnostics" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A PowerShell task that ping-tests the web server once" },
      { id: 'B', text: "Setting the pipeline timeout to 60 minutes" },
      { id: 'C', text: "A manual approval gate assigned to the lead SRE" },
      { id: 'D', text: "A release gate querying Azure Monitor alerts" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Free tier" },
      { id: 'B', text: "Per-node pricing" },
      { id: 'C', text: "Commitment Tiers (starting at 100 GB/day)" },
      { id: 'D', text: "Pay-As-You-Go with no reservations" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Multi-step web test" },
      { id: 'B', text: "Live Metrics test" },
      { id: 'C', text: "Profiler test" },
      { id: 'D', text: "A standard test" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Metric alerts are sub-minute; log alerts run KQL" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Alert processing rules" },
