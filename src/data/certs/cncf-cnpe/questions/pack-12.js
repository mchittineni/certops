export const CNCF_CNPE_QUESTIONS_12 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Refuse to evolve the API and remain trapped on deprecated alpha schemas forever." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Set `failurePolicy: Fail` on all cluster resources including kube-system with a 30-second timeout, freezing the entire cluster if the pod crashes." },
      { id: 'C', text: "Disable admission webhooks completely and permit unvetted deployments." },
