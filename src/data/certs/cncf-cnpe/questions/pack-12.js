export const CNCF_CNPE_QUESTIONS_12 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Implement an event-driven platform bus using the CNCF CloudEvents standard and Knative Eventing brokers." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Implement an event-driven platform bus using the CNCF CloudEvents standard and Knative Eventing brokers. Event-driven platform architectures decouple platform tools (portals, CI/CD, security scanners, orchestrators). Adopting the CNCF CloudEvents specification provides a common event envelope, while brokers (Knative Eventing, Strimzi) route events reliably.",
  ...
  },
  {
    ...
    question: "Which advanced architectural approach or platform engineering design satisfies these enterprise IDP objectives?",
    options: [
      { id: 'A', text: "Make breaking schema changes directly in production etcd without supporting backward compatibility." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Implement CRD conversion webhooks that seamlessly translate between storage versions (`v1alpha1`, `v1beta1`, `v1`) on the fly." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Force all development teams to update thousands of repository manifests in a single coordinated maintenance outage." },
  ...
  },
  {
    ...
    question: "Which platform engineering pattern or security mechanism satisfies these mandatory zero-trust controls?",
    options: [
      { id: 'A', text: "Expose raw backend platform databases and microservices directly to the public internet without authentication." },
  ...
  },
  {
    ...
    question: "Which platform capability or automation workflow enables application teams to self-serve safely?",
    options: [
      { id: 'A', text: "Deploy an Envoy-based API Gateway enforcing OIDC JWT token validation, mTLS upstream connections, and rate limiting policies." },
      { id: 'B', text: "Expose raw backend platform databases and microservices directly to the public internet without authentication." },
      { id: 'C', text: "Hardcode static administrative passwords in client frontend source code." },
      { id: 'D', text: "Disable network firewalls and rate limiters to optimize throughput." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which control plane pattern or composition architecture handles this operational scale effectively while preventing controller contention and state drift?",
    options: [
      { id: 'A', text: "Disable admission webhooks completely and permit unvetted deployments." },
      { id: 'B', text: "Set `failurePolicy: Ignore` for non-critical webhooks, configure strict `timeoutSeconds: 2`, and exclude the `kube-system` namespace." },
