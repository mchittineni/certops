export const CNCF_CNPE_QUESTIONS_14 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Manually create and maintain 100 individual ArgoCD Application manifests by hand in the web console." },
      { id: 'C', text: "Deploy applications by running manual kubectl apply commands from local laptops." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Rely on manual SSH scripts executing concurrent git clones across server fleets." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy an Argo Rollouts resource configured with automated canary steps, Prometheus metric analysis, and automated abort thresholds." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Rely on customer support ticket volume to determine whether a newly deployed release contains fatal defects." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Deploy an Argo Rollouts resource configured with automated canary steps, Prometheus metric analysis, and automated abort thresholds. Argo Rollouts replaces the standard Kubernetes Deployment with advanced rollout capabilities. It manages traffic splitting via ingress/mesh controllers, evaluates metric queries (e.g., error rate &lt; 0.1%), and automatically promotes or reverts the canary.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Perform an instant 100% replacement of all running production pods without health checks or traffic analysis." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Deploy an Argo Rollouts resource configured with automated canary steps, Prometheus metric analysis, and automated abort thresholds. Argo Rollouts replaces the standard Kubernetes Deployment with advanced rollout capabilities. It manages traffic splitting via ingress/mesh controllers, evaluates metric queries (e.g., error rate &lt; 0.1%), and automatically promotes or reverts the canary.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Share a single hardcoded database password across all microservices for five years without rotation." },
      { id: 'C', text: "Deploy the HashiCorp Vault Secrets Operator (VSO) to dynamically generate, lease, and rotate short-lived database credentials directly into pod secrets." },
      { id: 'D', text: "Print database passwords in plaintext container startup logs." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy standalone un-replicated PostgreSQL pods on ephemeral host disks without backups." },
      { id: 'D', text: "Deploy CloudNativePG (or CrunchyData PGO) to manage declarative PostgreSQL clusters with automated streaming replication and failover." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Deploy CloudNativePG (or CrunchyData PGO) to manage declarative PostgreSQL clusters with automated streaming replication and failover. Database operators bring cloud-like managed database experiences into Kubernetes. Operators like CloudNativePG use declarative custom resources (`Cluster`) to manage primary/standby replication, physical WAL archiving, connection pooling, and sub-minute automated failovers.",
  ...
  },
  {
    ...
    question: "Which operational design or SRE configuration guarantees high availability and resilient platform evolution?",
    options: [
      { id: 'A', text: "Instruct developers to manually install database packages on Linux VMs over SSH." },
      { id: 'B', text: "Deploy standalone un-replicated PostgreSQL pods on ephemeral host disks without backups." },
      { id: 'C', text: "Require all applications to write data to flat text files on shared network drives." },
      { id: 'D', text: "Deploy CloudNativePG (or CrunchyData PGO) to manage declarative PostgreSQL clusters with automated streaming replication and failover." }
    ],
