export const CNCF_CNPE_QUESTIONS_11 = [
  {
    ...
    options: [
      ...
      { id: 'D', text: "Deploy fragile external webhook containers that introduce network latency and single points of failure for basic schema checks." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Incorporate Common Expression Language (CEL) validation rules (`x-kubernetes-validations`) directly within the CRD OpenAPI v3 schema." },
      { id: 'D', text: "Disable API validation to maximize manifest ingestion speed." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Grant developers direct administrative cloud console access with no API abstraction." },
      { id: 'C', text: "Deploy raw virtual machines manually and configure database software over SSH." },
      { id: 'D', text: "Require developers to write raw cloud provider CloudFormation or ARM templates directly." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which control plane pattern or composition architecture handles this operational scale effectively while preventing controller contention and state drift?",
    options: [
      { id: 'A', text: "Deploy raw virtual machines manually and configure database software over SSH." },
      { id: 'B', text: "Author a Crossplane CompositeResourceDefinition (XRD) defining the schema, parameters, and published connection secret keys." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Fork the Crossplane source code to add hardcoded business logic." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Execute shell scripts directly on the host Kubernetes nodes during reconciliation." },
      { id: 'C', text: "Adopt Crossplane Composition Functions, executing composable logic pipelines authored in languages like Go, Python, or KCL." },
  ...
  },
  {
    ...
    question: "Which advanced architectural approach or platform engineering design satisfies these enterprise IDP objectives?",
    options: [
      { id: 'A', text: "Poll the Kubernetes API server in an infinite busy loop without using informers or event watches." },
