export const GITHUB_ACTIONS_QUESTIONS_20 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Instruct developers to read third-party source code voluntarily." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Configure Enterprise Actions Policies to allow 'Local actions only' or 'Allow select actions' from verified creators." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Allow all public marketplace actions without restrictions." },
      { id: 'C', text: "Configure Enterprise Actions Policies to allow 'Local actions only' or 'Allow select actions' from verified creators." },
      { id: 'D', text: "Disable GitHub Actions completely across the enterprise." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Configure Enterprise Actions Policies to allow 'Local actions only' or 'Allow select actions' from verified creators. Enterprise and organization settings allow administrators to enforce strict action policies: disabling actions, allowing only actions created by GitHub, or allowing specific whitelisted action patterns (e.g., `actions/*`, `aws-actions/*`), protecting the entire software supply chain.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable all automated pull request workflows." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Interpolate context strings directly inside inline bash commands: `run: echo \"${{ github.event.issue.title }}\"`." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Manually copy the security workflow into all 500 enterprise repositories." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Manually copy the security workflow into all 500 enterprise repositories." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Perform compliance audits manually once every six months." },
      { id: 'B', text: "Trust all developers to include the security scan in their local workflows." },
      { id: 'C', text: "Manually copy the security workflow into all 500 enterprise repositories." },
      { id: 'D', text: "Configure an Organization Rule (or Repository Ruleset) requiring specific status checks from a centralized workflow." }
    ],
    correctAnswers: ['D'],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Trust all developers to include the security scan in their local workflows." },
      { id: 'B', text: "Manually copy the security workflow into all 500 enterprise repositories." },
      { id: 'C', text: "Configure an Organization Rule (or Repository Ruleset) requiring specific status checks from a centralized workflow." },
      { id: 'D', text: "Perform compliance audits manually once every six months." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Duplicate the secret manually in 100 individual repository settings pages." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Create Organization Secrets configured with repository access policies (All repositories, Private repositories, or Selected repositories)." },
      { id: 'D', text: "Duplicate the secret manually in 100 individual repository settings pages." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Review developer browser search history." },
      { id: 'B', text: "Assume GitHub does not record administrative actions." },
      { id: 'C', text: "Query the GitHub Enterprise Audit Log for actions-related events (`action:org.runner_group.*` or `action:workflows.*`)." },
      { id: 'D', text: "Inspect the git commit history of the repository." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Query the GitHub Enterprise Audit Log for actions-related events (`action:org.runner_group.*` or `action:workflows.*`). The GitHub Enterprise Audit Log captures administrative and security events: runner group creation, runner registration, workflow permissions changes, secret access, and environment modifications. Querying audit logs provides immutable forensic visibility for compliance investigations.",
