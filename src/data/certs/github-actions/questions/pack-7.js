export const GITHUB_ACTIONS_QUESTIONS_7 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A continue-on-error setting on the step, which stops it after the default step limit." },
      { id: 'C', text: "A timeout-minutes value on the job, which applies to its longest step." },
      { id: 'D', text: "A concurrency group on the step with a three-minute limit." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Nothing; inner step outputs are exposed automatically under the identifier of the inner step." },
      { id: 'B', text: "The inner step must write to the environment file instead, since composite actions cannot produce outputs." },
