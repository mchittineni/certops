export const GITHUB_ACTIONS_QUESTIONS_5 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "A types filter of ready_for_review only, which also covers later pushes to the branch." },
      { id: 'D', text: "A paths filter excluding files typically changed during drafting." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A job output named annotations holding a JSON array of findings." },
      { id: 'C', text: "A non-zero exit code, from which the platform infers the failing file." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A reusable workflow for both, since a reusable workflow can be referenced from a step." },
      { id: 'C', text: "A composite action for the multi-job piece and a reusable workflow for the setup sequence." },
      { id: 'D', text: "A composite action for both, since composite actions can declare jobs when required." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Set an output named failed to true, which the runner inspects after the step." },
      { id: 'C', text: "Call core.warning with the message, which fails the step when the workflow runs in strict mode." },
      { id: 'D', text: "Call core.setFailed with the message, which records the error and sets a failing exit code for the step." }
    ],
    correctAnswers: ['D'],
    type: "single",
