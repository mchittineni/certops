export const GITHUB_ACTIONS_QUESTIONS_5 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "A types filter of ready_for_review only, which also covers later pushes to the branch." },
      { id: 'C', text: "A paths filter excluding files typically changed during drafting." },
      { id: 'D', text: "A concurrency group keyed on the pull request number, which suppresses draft runs." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Add a scheduled workflow that deletes the artifact through the API after two days." },
      { id: 'B', text: "Upload the debug bundle to the cache instead, which expires sooner." },
      { id: 'C', text: "Pass a retention-days input to the upload step for the debug bundle, which may shorten but not exceed the configured maximum." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "As ubuntu-latest, with a container key selecting the operating system per combination." },
      { id: 'C', text: "As an expression referencing the os value of the matrix context." },
      { id: 'D', text: "As the literal string matrix.os, which the runner resolves at dispatch." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Dependabot cannot update actions pinned to a commit SHA, only ones pinned to tags." },
      { id: 'B', text: "Dependabot requires the repository to have vulnerability alerts enabled before any version updates run." },
      ...
      { id: 'D', text: "The github-actions ecosystem only covers actions in the Marketplace, not those referenced by SHA." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A repository ruleset defined at organization level that requires the specified workflow to pass, applied to the target repositories." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A composite action for the multi-job piece and a reusable workflow for the setup sequence." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The number of stars on the repository and how recently the README was updated." },
      { id: 'C', text: "Whether the action is written in JavaScript, since container actions cannot be reviewed." },
      { id: 'D', text: "Whether the action is listed in the Marketplace, which is sufficient evidence of safety." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Add a since key to the new input naming the version at which the old one stops working." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set an output named failed to true, which the runner inspects after the step." },
      ...
      { id: 'D', text: "Call core.warning with the message, which fails the step when the workflow runs in strict mode." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Fork the image and rebuild it with a different entry point, because metadata cannot override it." },
      ...
      { id: 'C', text: "Wrap the image in a composite action, which is the only way to change how a container starts." },
      { id: 'D', text: "Set the image to the published reference and add a command key, which container actions use instead of entrypoint." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run the runner service under a dedicated unprivileged account on a machine that hosts nothing else, restrict its outbound network reach to what builds require, and prefer ephemeral instances so state does not carry between jobs." },
