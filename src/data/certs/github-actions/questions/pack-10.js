export const GITHUB_ACTIONS_QUESTIONS_10 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A max-parallel value of six on the matrix strategy, which limits how many of its jobs run at once without reducing the number of combinations." },
      { id: 'C', text: "A fail-fast setting, which staggers the jobs." },
      { id: 'D', text: "A concurrency group on the job, which limits it to one at a time and is the only available control." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Prefix the command with a double colon, which re-enables the legacy syntax." },
      { id: 'B', text: "Use the set-env command instead, which supersedes set-output." },
      { id: 'C', text: "Append a name and value pair to the file named by GITHUB_OUTPUT, which replaced the deprecated command form." },
      { id: 'D', text: "Declare the output in a job outputs block, which removes the need to set it from the step." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Add a display key to each matrix entry." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "There is no way to emit the delimiter, so the file must be produced by an action written in a general purpose language." },
      { id: 'D', text: "Wrap a quoted string containing the delimiter in an expression, so the expression evaluates to the literal text." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Only through individual expressions, since the payload is never written to disk." },
      { id: 'C', text: "As an artifact automatically attached to every run." },
      { id: 'D', text: "As an environment variable named GITHUB_EVENT containing the serialised payload." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The push trigger on the default branch, because it fires for every way a change lands there including direct pushes and merge queue merges, whereas the closed activity misses those paths." },
      { id: 'C', text: "The closed activity, because a push trigger also fires for pushes to other branches." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "There is no tooling; each pipeline must be rewritten by hand after a manual inventory." },
      ...
      { id: 'D', text: "The actions synchronisation tool, which mirrors pipelines from other systems." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Subdirectories are supported but each needs an index file listing its workflows." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The command line must be installed with a setup step, which also configures authentication." },
      { id: 'B', text: "The permissions block must additionally grant a cli scope." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Runs cannot be deleted before their retention expires, so the request cannot be satisfied." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "No; every run step in a composite action must use the same shell, declared once for the action." },
      { id: 'D', text: "Yes, but only by setting a defaults block, which composite actions support." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "As a patch release with the old input kept as an undocumented alias, which is always preferable to a major version." },
      { id: 'D', text: "As a new major version, because renaming an input breaks every caller passing the old name, and the major version tag should only be moved forward for callers once they have migrated." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "None; a sequence of tool invocations must remain inline in each workflow." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Registering a runner requires a registration token that only someone with administrative access at the corresponding level can obtain, and the registration is recorded in the audit log." }
    ],
    correctAnswers: ['D'],
    type: "single",
