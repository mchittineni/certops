export const GITHUB_ACTIONS_QUESTIONS_10 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Conditions are supported at workflow level only for scheduled workflows." },
      ...
      { id: 'C', text: "Conditions are supported only on steps, so a job-level condition would also be rejected." },
      { id: 'D', text: "Conditions are supported at workflow level but must appear before the trigger declaration." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Increase artifact retention so builds can be reused instead of repeated." },
      ...
      { id: 'D', text: "Cancel superseded runs with concurrency groups, restrict expensive non-Linux legs to the schedule rather than every pull request, filter triggers by path so unaffected work does not run, and cache dependencies effectively." }
    ],
    correctAnswers: ['D'],
    type: "single",
