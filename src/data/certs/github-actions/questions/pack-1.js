export const GITHUB_ACTIONS_QUESTIONS_1 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A continue-on-error setting scoped to the windows-latest runner." },
      { id: 'C', text: "An exclude entry naming node-version 16 together with os windows-latest." },
      { id: 'D', text: "A max-parallel value of five." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Write the tag to an environment variable with export so later jobs inherit it." },
      ...
      { id: 'D', text: "Store the tag in a repository secret from the build job and read the secret in the deploy job." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "pull_request_target runs in the context of the base repository with access to secrets and a writable token, so checking out and executing untrusted fork code lets a contributor exfiltrate those secrets." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Copy the workflow into each repository and keep the copies aligned with a Dependabot configuration." },
      { id: 'D', text: "Add the workflow to the organization .github repository, which applies it to every repository automatically." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The dependency directory belongs in the cache and the installer belongs in an artifact." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Push an empty commit to trigger a fresh run of the whole workflow." },
      { id: 'B', text: "Use Re-run failed jobs on the run, which re-executes the failed jobs and their dependents while reusing the successful results." },
      { id: 'C', text: "Cancel the run and start it again from the workflow_dispatch button." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Composite actions cannot contain run steps, only uses steps." },
      ...
      { id: 'D', text: "Composite actions require runs.using to name a specific runtime version rather than the word composite." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Print the value to standard output; the runner captures the last line as the step output automatically." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Publish only immutable tags for each patch release and tell consumers to update their references on every release." },
      ...
      { id: 'C', text: "Ask consumers to reference the default branch, and cut a tag only for breaking changes." },
      { id: 'D', text: "Publish each release as a separate repository named after its version." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Move the access key pair from repository secrets to organization secrets scoped to selected repositories." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Place the runners in a runner group whose access is limited to the selected repositories." },
      { id: 'B', text: "Apply a unique label to the runners and ask teams not to reference that label." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Set the Actions permissions policy to allow enterprise actions plus specified actions, and populate the allow list with the reviewed third-party references." },
      { id: 'C', text: "Require a CODEOWNERS review on the workflows directory in every repository." },
