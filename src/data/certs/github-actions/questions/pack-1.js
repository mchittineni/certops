export const GITHUB_ACTIONS_QUESTIONS_1 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An exclude entry naming node-version 16 together with os windows-latest." },
      { id: 'B', text: "A max-parallel value of five." },
      { id: 'C', text: "An include entry listing the five wanted combinations." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "An if condition evaluating always(), because a job with needs is skipped by default once an upstream job fails." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Both belong in the cache, because the cache persists across workflow runs." },
      { id: 'B', text: "Both belong in artifacts, because artifacts are the only storage retained after a run." },
      { id: 'C', text: "The dependency directory belongs in the cache and the installer belongs in an artifact." },
      { id: 'D', text: "The installer belongs in the cache and the dependency directory belongs in an artifact." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Write the value to a file named outputs.json in the workspace root." },
      { id: 'B', text: "Call core.setOutput from the toolkit and declare a matching entry under outputs in action.yml." },
      { id: 'C', text: "Call core.exportVariable and declare the name under inputs in action.yml." },
      { id: 'D', text: "Print the value to standard output; the runner captures the last line as the step output automatically." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Set an organization ruleset that blocks the runs-on key in non-production repositories." },
      { id: 'D', text: "Register the runners at repository level in all four repositories individually and delete the organization registration." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Use ephemeral runners, so each runner processes a single job and is then discarded along with anything the job left behind." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create an organization variable holding the token so every repository can read it." },
