export const GITHUB_ACTIONS_QUESTIONS_18 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Call the GitHub API using raw unauthenticated curl commands." },
  ...
  },
  {
    ...
    question: "Which workflow architecture or runner configuration manages this execution volume effectively while preventing queue congestion and latency?",
    options: [
      { id: 'A', text: "Commit the entire 200MB `node_modules` directory with thousands of loose files directly to Git." },
      ...
      { id: 'C', text: "Host dependencies on an external public FTP server." },
  ...
  },
  {
    ...
    question: "Which practice or platform feature enables the engineering team to modernize automated delivery with minimal operational friction?",
    options: [
      { id: 'A', text: "Install all OS libraries manually in every single workflow step." },
      { id: 'B', text: "Use a composite action and attempt to compile Linux libraries on Windows runners." },
      { id: 'C', text: "Docker container actions are not supported in GitHub Actions." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Create a `Dockerfile` and `entrypoint.sh`, specifying `runs: using: 'docker' image: 'Dockerfile'` in `action.yml`." },
      { id: 'C', text: "Install all OS libraries manually in every single workflow step." },
      { id: 'D', text: "Use a composite action and attempt to compile Linux libraries on Windows runners." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Create a `Dockerfile` and `entrypoint.sh`, specifying `runs: using: 'docker' image: 'Dockerfile'` in `action.yml`. Docker container actions package the entire execution environment—operating system packages, tools, and scripts—inside a container. When executed, GitHub Actions builds or pulls the container image on Linux runners, providing complete environment consistency.",
  ...
  },
  {
    ...
    question: "Which practice or platform feature enables the engineering team to modernize automated delivery with minimal operational friction?",
    options: [
      { id: 'A', text: "Never release updates to custom actions once published." },
      { id: 'B', text: "Create semantic release tags (e.g., `v1.2.3`) and update the moving major tag (`v1`) to point to the latest `v1.x.x` release commit." },
      { id: 'C', text: "Create a completely new repository for every bug fix release." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Upload the action as a raw binary zip file to Marketplace." },
