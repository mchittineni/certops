export const GITHUB_ACTIONS_QUESTIONS_6 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The filters may be combined only when each names a literal branch rather than a pattern." },
      { id: 'B', text: "The two filters cannot both be used for the same event, so the intent should be written with branches-ignore alone naming the sandbox prefix." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An empty matrix array fails the run with a strategy error, so the discovery job must emit a placeholder entry." },
      { id: 'B', text: "An empty matrix array produces one job with all matrix values unset, which must be guarded by a step condition." },
      { id: 'C', text: "An empty matrix array produces no jobs, so the build job is reported as skipped; any job that depends on it should use a status check function if it must still run." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The env context, which is populated automatically from organization variables." },
      { id: 'B', text: "The vars context, which exposes configuration variables defined at organization, repository and environment level." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A title property added to GITHUB_STEP_SUMMARY, which the list reads." },
      ...
      { id: 'D', text: "The name key at workflow level, which is re-evaluated per run." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Artifacts are only downloadable from the run page in a browser." },
      ...
      { id: 'D', text: "Re-run the workflow with an added step that copies the build to a shared drive." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A step that sleeps for fifteen minutes at the start of the production job." },
      { id: 'B', text: "Required reviewers on the production environment, with the reviewers instructed to wait fifteen minutes." },
      { id: 'C', text: "A wait timer on the production environment, which delays the job by the configured number of minutes before it proceeds." },
      { id: 'D', text: "A concurrency group with a fifteen-minute cooldown property." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Increase the audit log retention setting to the required number of years." },
      ...
      { id: 'D', text: "Configure audit log streaming to an external destination such as object storage or a log platform, which delivers events continuously so retention is governed by the destination." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Generate a just-in-time runner configuration through the API for each instance, which encodes a single-use ephemeral registration the runner consumes at start-up." }
    ],
    correctAnswers: ['D'],
    type: "single",
