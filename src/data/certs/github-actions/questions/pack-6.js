export const GITHUB_ACTIONS_QUESTIONS_6 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Keep secrets: inherit, since the called workflow can only read secrets it declares in its workflow_call block anyway, making the two equivalent." },
      ...
      { id: 'D', text: "Pass the secret through the with block instead, which avoids the secrets context entirely." }
    ],
    correctAnswers: ['C'],
    type: "single",
