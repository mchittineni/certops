export const GITHUB_ACTIONS_QUESTIONS_8 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The workflow_run event, which fires for deployments made by external systems." },
      { id: 'B', text: "The release event with a published type." },
      { id: 'C', text: "The deployment_status event, with a condition on the state carried in the payload." },
      { id: 'D', text: "The push event on the deployed branch." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Add every outside collaborator to a team with read access, which triggers approval automatically." },
      { id: 'C', text: "Enable required reviewers on an environment, which also gates whether workflows start." },
