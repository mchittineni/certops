export const GITHUB_ACTIONS_FLASHCARDS_9 = [
  ...
  },
  {
    ...
    hint: "360 minutes per job on GitHub-hosted runners and 35 days per workflow run.",
    back: "A single job on GitHub-hosted runners can execute for at most <strong>6 hours (360 minutes)</strong>; on self-hosted runners the job limit is 5 days. An entire workflow run is capped at <strong>35 days</strong>, including time spent waiting and on approvals.",
