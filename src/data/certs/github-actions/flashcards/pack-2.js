export const GITHUB_ACTIONS_FLASHCARDS_2 = [
  ...
  },
  {
    ...
    hint: "10 GB default per-repository limit and 7-day inactivity eviction.",
    back: "Each repository gets a <strong>10 GB cache limit by default</strong>. Enterprise owners, organization owners or repository admins can raise it, and usage beyond 10 GB is billed. When the limit is reached, the oldest caches by access time are evicted. Caches not accessed for <strong>7 days</strong> are automatically purged.",
