export const AZURE_AZ900_QUESTIONS_13 = [
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently? Infrastructure as a Service (IaaS) characteristics is under consideration.",
    options: [
      { id: 'A', text: "Deploy Azure Virtual Machines under the Infrastructure as a Service (IaaS) model." },
  ...
  },
  {
    ...
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management? Platform as a Service (PaaS) capabilities is under consideration.",
    options: [
