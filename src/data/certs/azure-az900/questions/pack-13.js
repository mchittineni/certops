export const AZURE_AZ900_QUESTIONS_13 = [
  {
    id: "az-900-301",
    difficulty: "hard",
    certId: "azure-az900",
    ...
    title: "Security and Governance in the Cloud: Dr Failover",
    ...
    options: [
      { id: 'A', text: "Rely on voluntary developer adherence to written PDF security guideline manuals." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Security and Governance in the Cloud: High Load Scale",
    ...
    options: [
      ...
      { id: 'D', text: "Grant all development engineers Owner privileges across the root tenant management group." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Apply Azure Policy definitions and Azure Role-Based Access Control (RBAC) across management groups and subscriptions. Azure governance provides automated mechanisms to enforce organizational compliance standards. Azure Policy assesses resource configurations and prevents non-compliant deployments, while RBAC enforces least-privilege administrative access controls across subscriptions.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Security and Governance in the Cloud: Security Compliance",
    ...
    options: [
      ...
      { id: 'C', text: "Apply Azure Policy definitions and Azure Role-Based Access Control (RBAC) across management groups and subscriptions." },
      { id: 'D', text: "Grant all development engineers Owner privileges across the root tenant management group." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Security and Governance in the Cloud: Hybrid Migration",
    ...
    options: [
      { id: 'A', text: "Rely on voluntary developer adherence to written PDF security guideline manuals." },
      { id: 'B', text: "Grant all development engineers Owner privileges across the root tenant management group." },
      { id: 'C', text: "Apply Azure Policy definitions and Azure Role-Based Access Control (RBAC) across management groups and subscriptions." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Security and Governance in the Cloud: Resilience Failure",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Manageability of Cloud Resources: Dr Failover",
    ...
    options: [
      ...
      { id: 'C', text: "Use Azure Resource Manager (ARM) templates, Azure Portal, Azure CLI, and Azure PowerShell for consistent infrastructure management." },
    ...
    tags: ["Azure Management","Management","Dr Failover"]
  },
  {
    id: "az-900-307",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Manageability of Cloud Resources: High Load Scale",
    ...
    explanation: "Use Azure Resource Manager (ARM) templates, Azure Portal, Azure CLI, and Azure PowerShell for consistent infrastructure management. Manageability in the cloud provides automated, repeatable management options for deploying, maintaining, and monitoring cloud infrastructure through the Azure Portal, command-line interfaces (CLI and PowerShell), and Infrastructure as Code (Bicep/ARM templates).",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/azure-resource-manager/management/overview",
    tags: ["Azure Management","Management","High Load Scale"]
  },
  {
    id: "az-900-308",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Manageability of Cloud Resources: Security Compliance",
    ...
    explanation: "Use Azure Resource Manager (ARM) templates, Azure Portal, Azure CLI, and Azure PowerShell for consistent infrastructure management. Manageability in the cloud provides automated, repeatable management options for deploying, maintaining, and monitoring cloud infrastructure through the Azure Portal, command-line interfaces (CLI and PowerShell), and Infrastructure as Code (Bicep/ARM templates).",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/azure-resource-manager/management/overview",
    tags: ["Azure Management","Management","Security Compliance"]
  },
  {
    id: "az-900-309",
    difficulty: "easy",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Manageability of Cloud Resources: Hybrid Migration",
    ...
    explanation: "Use Azure Resource Manager (ARM) templates, Azure Portal, Azure CLI, and Azure PowerShell for consistent infrastructure management. Manageability in the cloud provides automated, repeatable management options for deploying, maintaining, and monitoring cloud infrastructure through the Azure Portal, command-line interfaces (CLI and PowerShell), and Infrastructure as Code (Bicep/ARM templates).",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/azure-resource-manager/management/overview",
    tags: ["Azure Management","Management","Hybrid Migration"]
  },
  {
    id: "az-900-310",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Manageability of Cloud Resources: Resilience Failure",
    ...
    options: [
      ...
      { id: 'D', text: "Maintain separate proprietary hardware configuration tools for each physical server rack." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Use Azure Resource Manager (ARM) templates, Azure Portal, Azure CLI, and Azure PowerShell for consistent infrastructure management. Manageability in the cloud provides automated, repeatable management options for deploying, maintaining, and monitoring cloud infrastructure through the Azure Portal, command-line interfaces (CLI and PowerShell), and Infrastructure as Code (Bicep/ARM templates).",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/azure-resource-manager/management/overview",
    tags: ["Azure Management","Management","Resilience Failure"]
  },
  {
    id: "az-900-311",
    difficulty: "hard",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Infrastructure as a Service (IaaS): Dr Failover",
    scenario: "An enterprise organization is establishing high-availability standards and operational continuity guidelines for its cloud systems. Business leaders mandate reliable and resilient operations across all operational domains. The organization evaluates Cloud Service Models to deploy custom legacy enterprise software requiring full control over the underlying operating system kernel, network configuration, and disk partitioning.",
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
    ...
    tags: ["Cloud Service Models","IaaS","Dr Failover"]
  },
  {
    id: "az-900-312",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Infrastructure as a Service (IaaS): High Load Scale",
    scenario: "A rapidly growing technology startup experiences seasonal surges in user traffic and transactions. The management team requires architecture that scales seamlessly while maintaining performance and operational stability. The organization evaluates Cloud Service Models to deploy custom legacy enterprise software requiring full control over the underlying operating system kernel, network configuration, and disk partitioning.",
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Deploy Azure Virtual Machines under the Infrastructure as a Service (IaaS) model." },
    ...
    explanation: "Deploy Azure Virtual Machines under the Infrastructure as a Service (IaaS) model. Infrastructure as a Service (IaaS) provides virtualized computing resources over the internet. Microsoft manages physical datacenter facilities and hypervisors, while the customer configures and maintains the operating system, middleware, installed software, and network settings.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/architecture/guide/technology-choices/compute-overview",
    tags: ["Cloud Service Models","IaaS","High Load Scale"]
  },
  {
    id: "az-900-313",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Infrastructure as a Service (IaaS): Security Compliance",
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Subscribe to Microsoft 365 under the Software as a Service (SaaS) model." },
      { id: 'B', text: "Purchase physical rack servers for installation in a private on-premises server room." },
    ...
    explanation: "Deploy Azure Virtual Machines under the Infrastructure as a Service (IaaS) model. Infrastructure as a Service (IaaS) provides virtualized computing resources over the internet. Microsoft manages physical datacenter facilities and hypervisors, while the customer configures and maintains the operating system, middleware, installed software, and network settings.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/architecture/guide/technology-choices/compute-overview",
    tags: ["Cloud Service Models","IaaS","Security Compliance"]
  },
  {
    id: "az-900-314",
    difficulty: "easy",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Infrastructure as a Service (IaaS): Hybrid Migration",
    ...
    explanation: "Deploy Azure Virtual Machines under the Infrastructure as a Service (IaaS) model. Infrastructure as a Service (IaaS) provides virtualized computing resources over the internet. Microsoft manages physical datacenter facilities and hypervisors, while the customer configures and maintains the operating system, middleware, installed software, and network settings.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/architecture/guide/technology-choices/compute-overview",
    tags: ["Cloud Service Models","IaaS","Hybrid Migration"]
  },
  {
    id: "az-900-315",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Infrastructure as a Service (IaaS): Resilience Failure",
    ...
    explanation: "Deploy Azure Virtual Machines under the Infrastructure as a Service (IaaS) model. Infrastructure as a Service (IaaS) provides virtualized computing resources over the internet. Microsoft manages physical datacenter facilities and hypervisors, while the customer configures and maintains the operating system, middleware, installed software, and network settings.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/architecture/guide/technology-choices/compute-overview",
    tags: ["Cloud Service Models","IaaS","Resilience Failure"]
  },
  {
    id: "az-900-316",
    difficulty: "hard",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Platform as a Service (PaaS): Dr Failover",
    ...
    options: [
      ...
      { id: 'C', text: "Provision raw Azure Virtual Machines and configure IIS or Apache web servers manually." },
      { id: 'D', text: "Deploy web applications using Azure App Service under the Platform as a Service (PaaS) model." }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    tags: ["Cloud Service Models","PaaS","Dr Failover"]
  },
  {
    id: "az-900-317",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Platform as a Service (PaaS): High Load Scale",
    ...
    explanation: "Deploy web applications using Azure App Service under the Platform as a Service (PaaS) model. Platform as a Service (PaaS) provides an environment for building, testing, and deploying applications without the complexity of managing the underlying operating system, server hardware, or network infrastructure. Azure App Service and Azure SQL Database are examples of PaaS.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/app-service/overview",
    tags: ["Cloud Service Models","PaaS","High Load Scale"]
  },
  {
    id: "az-900-318",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Platform as a Service (PaaS): Security Compliance",
    ...
    explanation: "Deploy web applications using Azure App Service under the Platform as a Service (PaaS) model. Platform as a Service (PaaS) provides an environment for building, testing, and deploying applications without the complexity of managing the underlying operating system, server hardware, or network infrastructure. Azure App Service and Azure SQL Database are examples of PaaS.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/app-service/overview",
    tags: ["Cloud Service Models","PaaS","Security Compliance"]
  },
  {
    id: "az-900-319",
    difficulty: "easy",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Platform as a Service (PaaS): Hybrid Migration",
    ...
    options: [
      ...
      { id: 'B', text: "Deploy web applications using Azure App Service under the Platform as a Service (PaaS) model." },
      { id: 'C', text: "Build a private Kubernetes cluster on physical on-premises bare-metal servers." },
    ...
    explanation: "Deploy web applications using Azure App Service under the Platform as a Service (PaaS) model. Platform as a Service (PaaS) provides an environment for building, testing, and deploying applications without the complexity of managing the underlying operating system, server hardware, or network infrastructure. Azure App Service and Azure SQL Database are examples of PaaS.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/app-service/overview",
    tags: ["Cloud Service Models","PaaS","Hybrid Migration"]
  },
  {
    id: "az-900-320",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Platform as a Service (PaaS): Resilience Failure",
    scenario: "An IT operations team is modernizing infrastructure to eliminate single points of failure, optimize spending, and automate infrastructure maintenance. The organization evaluates Cloud Service Models to allow application developers to build, test, and deploy web applications without managing operating system installations, security patches, or server updates.",
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management?",
    options: [
      { id: 'A', text: "Deploy web applications using Azure App Service under the Platform as a Service (PaaS) model." },
      { id: 'B', text: "Provision raw Azure Virtual Machines and configure IIS or Apache web servers manually." },
    ...
    explanation: "Deploy web applications using Azure App Service under the Platform as a Service (PaaS) model. Platform as a Service (PaaS) provides an environment for building, testing, and deploying applications without the complexity of managing the underlying operating system, server hardware, or network infrastructure. Azure App Service and Azure SQL Database are examples of PaaS.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/app-service/overview",
    tags: ["Cloud Service Models","PaaS","Resilience Failure"]
  },
  {
    id: "az-900-321",
    difficulty: "hard",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Software as a Service (SaaS): Dr Failover",
    scenario: "An enterprise organization is establishing high-availability standards and operational continuity guidelines for its cloud systems. Business leaders mandate reliable and resilient operations across all operational domains. The organization evaluates Cloud Service Models to provide enterprise employees with fully managed, ready-to-use cloud productivity, email, and collaboration software accessible via web browsers.",
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      ...
      { id: 'D', text: "Build a custom messaging application using Azure Functions and Azure Cosmos DB." }
    ],
    correctAnswers: ['A'],
    type: "single",
    ...
    tags: ["Cloud Service Models","SaaS","Dr Failover"]
  },
  {
    id: "az-900-322",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Software as a Service (SaaS): High Load Scale",
    ...
    explanation: "Subscribe to Microsoft 365 and Microsoft Teams under the Software as a Service (SaaS) model. Software as a Service (SaaS) delivers complete software applications over the internet on a subscription basis. The cloud provider hosts and manages the application, underlying infrastructure, operating systems, and security, while end users connect via web browsers or client applications.",
    referenceUrl: "https://learn.microsoft.com/en-us/microsoft-365/enterprise/microsoft-365-overview",
    tags: ["Cloud Service Models","SaaS","High Load Scale"]
  },
  {
    id: "az-900-323",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Software as a Service (SaaS): Security Compliance",
    scenario: "A financial compliance and auditing department requires strict enforcement of data protection, access controls, and cloud governance policies across all systems. The organization evaluates Cloud Service Models to provide enterprise employees with fully managed, ready-to-use cloud productivity, email, and collaboration software accessible via web browsers.",
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Subscribe to Microsoft 365 and Microsoft Teams under the Software as a Service (SaaS) model." },
      { id: 'B', text: "Deploy custom Microsoft Exchange servers across multiple Azure IaaS Virtual Machines." },
    ...
    explanation: "Subscribe to Microsoft 365 and Microsoft Teams under the Software as a Service (SaaS) model. Software as a Service (SaaS) delivers complete software applications over the internet on a subscription basis. The cloud provider hosts and manages the application, underlying infrastructure, operating systems, and security, while end users connect via web browsers or client applications.",
    referenceUrl: "https://learn.microsoft.com/en-us/microsoft-365/enterprise/microsoft-365-overview",
    tags: ["Cloud Service Models","SaaS","Security Compliance"]
  },
  {
    id: "az-900-324",
    difficulty: "easy",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Software as a Service (SaaS): Hybrid Migration",
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Deploy custom Microsoft Exchange servers across multiple Azure IaaS Virtual Machines." },
      { id: 'B', text: "Subscribe to Microsoft 365 and Microsoft Teams under the Software as a Service (SaaS) model." },
    ...
    explanation: "Subscribe to Microsoft 365 and Microsoft Teams under the Software as a Service (SaaS) model. Software as a Service (SaaS) delivers complete software applications over the internet on a subscription basis. The cloud provider hosts and manages the application, underlying infrastructure, operating systems, and security, while end users connect via web browsers or client applications.",
    referenceUrl: "https://learn.microsoft.com/en-us/microsoft-365/enterprise/microsoft-365-overview",
    tags: ["Cloud Service Models","SaaS","Hybrid Migration"]
  },
  {
    id: "az-900-325",
    difficulty: "medium",
    ...
    domainId: "d1",
    domainName: "Describe cloud concepts",
    title: "Software as a Service (SaaS): Resilience Failure",
    scenario: "An IT operations team is modernizing infrastructure to eliminate single points of failure, optimize spending, and automate infrastructure maintenance. The organization evaluates Cloud Service Models to provide enterprise employees with fully managed, ready-to-use cloud productivity, email, and collaboration software accessible via web browsers.",
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management?",
    options: [
      { id: 'A', text: "Subscribe to Microsoft 365 and Microsoft Teams under the Software as a Service (SaaS) model." },
      { id: 'B', text: "Deploy custom Microsoft Exchange servers across multiple Azure IaaS Virtual Machines." },
    ...
    explanation: "Subscribe to Microsoft 365 and Microsoft Teams under the Software as a Service (SaaS) model. Software as a Service (SaaS) delivers complete software applications over the internet on a subscription basis. The cloud provider hosts and manages the application, underlying infrastructure, operating systems, and security, while end users connect via web browsers or client applications.",
    referenceUrl: "https://learn.microsoft.com/en-us/microsoft-365/enterprise/microsoft-365-overview",
    tags: ["Cloud Service Models","SaaS","Resilience Failure"]
  }
];

export default AZURE_AZ900_QUESTIONS_13;
