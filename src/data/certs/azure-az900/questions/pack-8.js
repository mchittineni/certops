export const AZURE_AZ900_QUESTIONS_8 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Pay-as-you-go billing" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Microsoft Cost Management" },
      { id: 'C', text: "Azure Dev/Test Pricing" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An Azure Policy deny assignment" },
      { id: 'B', text: "A CanNotDelete (Delete) resource lock" },
      { id: 'C', text: "A ReadOnly resource lock" },
      { id: 'D', text: "A Network Security Group block rule" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A ReadOnly resource lock" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "The Microsoft Service Trust Portal" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Azure Advisor" },
      { id: 'D', text: "Azure Policy Deny effect" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Azure CLI" },
      { id: 'D', text: "Azure Bicep compiler" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Service Health alerts" },
      { id: 'B', text: "Policy initiative enforcement" },
      { id: 'C', text: "Azure Advisor security recommendations" },
      { id: 'D', text: "Budget alerts in Microsoft Cost Management" }
    ],
    correctAnswers: ['D'],
    type: "single",
