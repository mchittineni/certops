export const AZURE_AZ900_QUESTIONS_8 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Budgets and budget alerts" },
      { id: 'B', text: "Azure Policy initiatives" },
      { id: 'C', text: "Azure Reservations" },
      { id: 'D', text: "Azure Service Health advisories" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Pay-as-you-go billing" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Microsoft Cost Management" },
      { id: 'B', text: "Azure Dev/Test Pricing" },
      { id: 'C', text: "Azure Reservations" },
      { id: 'D', text: "Azure Hybrid Benefit (AHB)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Policy exemptions" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An Azure Role assignment" },
      { id: 'B', text: "A Resource Group container" },
      { id: 'C', text: "An Azure Policy Initiative (policy set)" },
      { id: 'D', text: "A Management Group hierarchy" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A Network Security Group block rule" },
      { id: 'B', text: "An Azure Policy deny assignment" },
      { id: 'C', text: "A ReadOnly resource lock" },
      { id: 'D', text: "A CanNotDelete (Delete) resource lock" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "An Azure Advisor recommendation" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The Azure Portal" },
      { id: 'B', text: "The Azure CLI in a terminal" },
      { id: 'C', text: "Azure Resource Manager JSON editor" },
      { id: 'D', text: "Azure PowerShell SDK" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Windows Terminal Desktop" },
      { id: 'C', text: "Visual Studio Code on-premises" },
      { id: 'D', text: "Azure Service Health" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure PowerShell scripts" },
      { id: 'C', text: "Azure Bicep" },
      { id: 'D', text: "Azure Cloud Shell Bash aliases" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Policy Deny effect" },
      { id: 'B', text: "Azure Advisor" },
      { id: 'C', text: "Azure Monitor Alerts" },
      { id: 'D', text: "Azure Service Health" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Log Analytics workspace only" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure PowerShell Az module only" },
      { id: 'B', text: "Azure Portal web UI" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure CLI" },
      { id: 'C', text: "Azure Cloud Shell Bash" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Budget alerts in Microsoft Cost Management" },
      { id: 'B', text: "Service Health alerts" },
      { id: 'C', text: "Policy initiative enforcement" },
