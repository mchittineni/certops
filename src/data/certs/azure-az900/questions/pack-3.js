export const AZURE_AZ900_QUESTIONS_3 = [
  {
    ...
    options: [
      { id: 'A', text: "Public cloud exclusively" },
      { id: 'B', text: "Private cloud exclusively" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Serverless computing" },
      { id: 'B', text: "Colocation hosting" },
      { id: 'C', text: "Dedicated virtual machines" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Standard public commercial Azure regions" },
      { id: 'B', text: "Azure China" },
      { id: 'C', text: "Azure Germany" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Delete the resource group holding all project resources" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Batch" },
      { id: 'C', text: "Azure Availability Sets" },
      { id: 'D', text: "Azure Virtual Machine Scale Sets (VMSS)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Azure App Service Web Apps" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A physical network cable connecting Azure to the customer's office" },
      { id: 'B', text: "A logically isolated private network within an Azure subscription" },
      { id: 'C', text: "A storage bucket for database backups" },
      { id: 'D', text: "A public web domain registration service" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Virtual Network (VNet) Peering" },
      { id: 'C', text: "A site-to-site IPsec VPN over the public internet" },
      { id: 'D', text: "Public IP addresses on all VMs" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure ExpressRoute Direct" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Data Box, a shipped physical appliance" },
      { id: 'B', text: "Uploading over public internet using AzCopy" },
      { id: 'C', text: "Azure ExpressRoute" },
