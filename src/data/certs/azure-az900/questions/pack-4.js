export const AZURE_AZ900_QUESTIONS_4 = [
  {
    ...
    options: [
      { id: 'A', text: "An Azure region" },
      { id: 'B', text: "An Azure geography" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Virtual Machine Scale Sets (VMSS)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Point-to-Site VPN with OpenVPN" },
      { id: 'C', text: "Azure Bastion host" },
      { id: 'D', text: "Azure VPN Gateway with Site-to-Site IPsec" }
    ],
    correctAnswers: ['A'],
    type: "single",
