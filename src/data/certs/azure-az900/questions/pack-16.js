export const AZURE_AZ900_QUESTIONS_16 = [
  {
    ...
    options: [
      ...
      { id: 'D', text: "Provision an Azure Virtual Machine and install the Docker engine manually." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy the container image to Azure Container Instances (ACI)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Use Azure Static Web Apps to run stateful microservice backend databases." },
      { id: 'C', text: "Deploy all microservices into a single monolithic Azure App Service instance." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy standard single-instance Linux virtual machines without remote desktop protocols." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy resources into an Azure Virtual Network (VNet) segmented into distinct subnets." },
      { id: 'B', text: "Deploy all virtual machines into the default multi-tenant Azure public network." },
      { id: 'C', text: "Assign public IP addresses to all database servers and expose them directly to the internet." },
      { id: 'D', text: "Rely on public internet DNS routing for internal communication between backend servers." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Provision an Azure ExpressRoute dedicated private circuit connection." },
