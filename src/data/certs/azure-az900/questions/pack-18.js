export const AZURE_AZ900_QUESTIONS_18 = [
  {
    id: "az-900-426",
    difficulty: "hard",
    certId: "azure-az900",
    ...
    title: "Azure Cost Management and Billing: Dr Failover",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Cost Management and Billing: High Load Scale",
    ...
    options: [
      ...
      { id: 'B', text: "Rely on manual spot checks of individual virtual machine billing sheets." },
      { id: 'C', text: "Review physical paper invoices 60 days after expenses are incurred." },
      { id: 'D', text: "Use Azure Cost Management to create monthly budgets and automated spending alert notifications." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Cost Management and Billing: Security Compliance",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Cost Management and Billing: Hybrid Migration",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Cost Management and Billing: Resilience Failure",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Pricing Calculator vs TCO Calculator: Dr Failover",
    scenario: "An enterprise organization is establishing high-availability standards and operational continuity guidelines for its cloud systems. Business leaders mandate reliable and resilient operations across all operational domains. The organization evaluates Azure Cost Forecasting to estimate the expected monthly cost of running a proposed new Azure cloud solution before provisioning any resources in the cloud.",
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
    ...
    tags: ["Azure Cost Forecasting","Cost Estimation","Dr Failover"]
  },
  {
    id: "az-900-432",
    difficulty: "medium",
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Pricing Calculator vs TCO Calculator: High Load Scale",
    ...
    explanation: "Model the proposed architecture using the Azure Pricing Calculator. The Azure Pricing Calculator is a free web-based planning tool that allows organizations to estimate the cost of Azure products and configurations before deploying them. Users customize resource parameters (regions, VM sizes, storage tiers, usage hours) to view estimated hourly and monthly costs.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/cost-management-billing/costs/pricing-calculator",
    tags: ["Azure Cost Forecasting","Cost Estimation","High Load Scale"]
  },
  {
    id: "az-900-433",
    difficulty: "medium",
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Pricing Calculator vs TCO Calculator: Security Compliance",
    ...
    explanation: "Model the proposed architecture using the Azure Pricing Calculator. The Azure Pricing Calculator is a free web-based planning tool that allows organizations to estimate the cost of Azure products and configurations before deploying them. Users customize resource parameters (regions, VM sizes, storage tiers, usage hours) to view estimated hourly and monthly costs.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/cost-management-billing/costs/pricing-calculator",
    tags: ["Azure Cost Forecasting","Cost Estimation","Security Compliance"]
  },
  {
    id: "az-900-434",
    difficulty: "easy",
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Pricing Calculator vs TCO Calculator: Hybrid Migration",
    scenario: "An enterprise is migrating traditional on-premises data center operations to the Microsoft Azure Cloud. The executive team wants to maximize efficiency, accelerate innovation, and minimize operational complexity. The organization evaluates Azure Cost Forecasting to estimate the expected monthly cost of running a proposed new Azure cloud solution before provisioning any resources in the cloud.",
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Model the proposed architecture using the Azure Pricing Calculator." },
      { id: 'B', text: "Use a generic spreadsheet with static on-premises hardware prices." },
    ...
    explanation: "Model the proposed architecture using the Azure Pricing Calculator. The Azure Pricing Calculator is a free web-based planning tool that allows organizations to estimate the cost of Azure products and configurations before deploying them. Users customize resource parameters (regions, VM sizes, storage tiers, usage hours) to view estimated hourly and monthly costs.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/cost-management-billing/costs/pricing-calculator",
    tags: ["Azure Cost Forecasting","Cost Estimation","Hybrid Migration"]
  },
  {
    id: "az-900-435",
    difficulty: "medium",
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Pricing Calculator vs TCO Calculator: Resilience Failure",
    ...
    explanation: "Model the proposed architecture using the Azure Pricing Calculator. The Azure Pricing Calculator is a free web-based planning tool that allows organizations to estimate the cost of Azure products and configurations before deploying them. Users customize resource parameters (regions, VM sizes, storage tiers, usage hours) to view estimated hourly and monthly costs.",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/cost-management-billing/costs/pricing-calculator",
    tags: ["Azure Cost Forecasting","Cost Estimation","Resilience Failure"]
  },
  {
    id: "az-900-436",
    difficulty: "hard",
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Policy and Initiatives: Dr Failover",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Policy and Initiatives: High Load Scale",
    ...
    options: [
      ...
      { id: 'C', text: "Deploy an external third-party firewall to filter outbound HTTP requests from VMs." },
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Policy and Initiatives: Security Compliance",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Policy and Initiatives: Hybrid Migration",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Policy and Initiatives: Resilience Failure",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Role-Based Access Control (RBAC): Dr Failover",
    ...
    tags: ["Azure Identity & Access","RBAC","Dr Failover"]
  },
  {
    id: "az-900-442",
    difficulty: "medium",
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Role-Based Access Control (RBAC): High Load Scale",
    ...
    explanation: "Assign built-in Azure RBAC roles (such as Reader and Virtual Machine Contributor) at the appropriate management scopes. Azure Role-Based Access Control (RBAC) provides fine-grained access management for Azure resources. Using RBAC, administrators grant users, groups, and service principals only the specific permissions needed to perform their jobs (principle of least privilege) at specified scopes (management group, subscription, resource group, or resource).",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/role-based-access-control/overview",
    tags: ["Azure Identity & Access","RBAC","High Load Scale"]
  },
  {
    id: "az-900-443",
    difficulty: "medium",
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Role-Based Access Control (RBAC): Security Compliance",
    scenario: "A financial compliance and auditing department requires strict enforcement of data protection, access controls, and cloud governance policies across all systems. The organization evaluates Azure Identity & Access to grant security auditors read-only access to all subscription resources while allowing cloud engineers to restart virtual machines without giving them full subscription ownership.",
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Disable Azure RBAC and manage permissions using local Windows guest OS user accounts." },
      { id: 'B', text: "Grant all employees the Owner role on the enterprise root management group." },
      { id: 'C', text: "Assign built-in Azure RBAC roles (such as Reader and Virtual Machine Contributor) at the appropriate management scopes." },
    ...
    explanation: "Assign built-in Azure RBAC roles (such as Reader and Virtual Machine Contributor) at the appropriate management scopes. Azure Role-Based Access Control (RBAC) provides fine-grained access management for Azure resources. Using RBAC, administrators grant users, groups, and service principals only the specific permissions needed to perform their jobs (principle of least privilege) at specified scopes (management group, subscription, resource group, or resource).",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/role-based-access-control/overview",
    tags: ["Azure Identity & Access","RBAC","Security Compliance"]
  },
  {
    id: "az-900-444",
    difficulty: "easy",
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Role-Based Access Control (RBAC): Hybrid Migration",
    ...
    options: [
      ...
      { id: 'C', text: "Grant all employees the Owner role on the enterprise root management group." },
    ...
    explanation: "Assign built-in Azure RBAC roles (such as Reader and Virtual Machine Contributor) at the appropriate management scopes. Azure Role-Based Access Control (RBAC) provides fine-grained access management for Azure resources. Using RBAC, administrators grant users, groups, and service principals only the specific permissions needed to perform their jobs (principle of least privilege) at specified scopes (management group, subscription, resource group, or resource).",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/role-based-access-control/overview",
    tags: ["Azure Identity & Access","RBAC","Hybrid Migration"]
  },
  {
    id: "az-900-445",
    difficulty: "medium",
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Role-Based Access Control (RBAC): Resilience Failure",
    scenario: "An IT operations team is modernizing infrastructure to eliminate single points of failure, optimize spending, and automate infrastructure maintenance. The organization evaluates Azure Identity & Access to grant security auditors read-only access to all subscription resources while allowing cloud engineers to restart virtual machines without giving them full subscription ownership.",
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management?",
    options: [
      { id: 'A', text: "Assign built-in Azure RBAC roles (such as Reader and Virtual Machine Contributor) at the appropriate management scopes." },
      { id: 'B', text: "Disable Azure RBAC and manage permissions using local Windows guest OS user accounts." },
    ...
    explanation: "Assign built-in Azure RBAC roles (such as Reader and Virtual Machine Contributor) at the appropriate management scopes. Azure Role-Based Access Control (RBAC) provides fine-grained access management for Azure resources. Using RBAC, administrators grant users, groups, and service principals only the specific permissions needed to perform their jobs (principle of least privilege) at specified scopes (management group, subscription, resource group, or resource).",
    referenceUrl: "https://learn.microsoft.com/en-us/azure/role-based-access-control/overview",
    tags: ["Azure Identity & Access","RBAC","Resilience Failure"]
  },
  {
    id: "az-900-446",
    difficulty: "hard",
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Resource Locks: Dr Failover",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Resource Locks: High Load Scale",
    scenario: "A rapidly growing technology startup experiences seasonal surges in user traffic and transactions. The management team requires architecture that scales seamlessly while maintaining performance and operational stability. The organization evaluates Azure Governance to prevent mission-critical production databases from being accidentally deleted or modified by authorized administrators.",
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Rely on administrator verbal agreements to be careful when navigating the Azure portal." },
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Resource Locks: Security Compliance",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Resource Locks: Hybrid Migration",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Describe Azure Management and Governance",
    title: "Azure Resource Locks: Resilience Failure",
    ...
    options: [
      ...
      { id: 'B', text: "Disable the Azure Resource Manager API to prevent all administrative interactions." },
      { id: 'C', text: "Apply a CanNotDelete or ReadOnly Resource Lock to the production database and its resource group." },
...
export default AZURE_AZ900_QUESTIONS_18;
