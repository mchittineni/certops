export const AZURE_AZ900_QUESTIONS_6 = [
  {
    ...
    options: [
      ...
      { id: 'D', text: "A hosting service for DNS domains providing name resolution" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Virtual Network NAT" },
      { id: 'D', text: "Local Network Gateways" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Network Security Groups (NSGs)" },
      { id: 'D', text: "Azure DNS" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Through built-in infrastructure-level DDoS protection" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Three copies" },
      { id: 'B', text: "Six copies" },
      { id: 'C', text: "Twelve copies" },
      { id: 'D', text: "One single copy" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Three in the primary region and three in the paired region" },
      { id: 'B', text: "Two copies in the primary region and two in the secondary" },
      { id: 'C', text: "One copy in each global region" },
      { id: 'D', text: "Ten copies across cloud providers" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Cognitive Search" },
      { id: 'B', text: "Azure Stream Analytics" },
      { id: 'C', text: "Azure Logic Apps" },
      { id: 'D', text: "Azure OpenAI Service" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Azure Storage Account" }
    ],
    correctAnswers: ['C'],
    type: "single",
