export const AZURE_AZ900_QUESTIONS_5 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Azure Managed Disks" },
      { id: 'D', text: "Azure Blob containers" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Single-tenant storage" },
      { id: 'C', text: "Zone-Redundant Storage (ZRS)" },
      { id: 'D', text: "Read-Access LRS" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Active Directory Federation Services only" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Multi-tenant isolation" },
      { id: 'D', text: "Conditional licensing" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Microsoft Entra Conditional Access" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Rely exclusively on perimeter network firewalls" },
      { id: 'B', text: "Verify explicitly, use least privileged access, and assume breach" },
      { id: 'C', text: "Disable multi-factor authentication for administrators" },
      { id: 'D', text: "Trust all internal corporate network traffic by default" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Stateless firewalling" },
      { id: 'B', text: "Defense in Depth" },
      { id: 'C', text: "Perimeter-only defense" },
      { id: 'D', text: "Single-perimeter security" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Advisor" },
      { id: 'B', text: "Azure Monitor Log Analytics only" },
      { id: 'C', text: "Microsoft Sentinel" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Database for PostgreSQL" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Installing SQL Server on an Azure Virtual Machine (IaaS)" },
      { id: 'B', text: "Azure Table Storage" },
      { id: 'C', text: "Azure Cosmos DB" },
      { id: 'D', text: "Azure SQL Database (PaaS)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Database for PostgreSQL" },
      { id: 'B', text: "Azure Cosmos DB" },
      { id: 'C', text: "Azure SQL Database single database" },
