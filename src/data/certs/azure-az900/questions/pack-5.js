export const AZURE_AZ900_QUESTIONS_5 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Single-tenant storage" },
      { id: 'B', text: "Read-Access LRS" },
      { id: 'C', text: "Locally Redundant Storage (LRS)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Conditional licensing" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Azure Role-Based Access Control (RBAC)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Verify explicitly, use least privileged access, and assume breach" },
      { id: 'D', text: "Disable multi-factor authentication for administrators" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Single-perimeter security" },
      { id: 'C', text: "Stateless firewalling" },
      { id: 'D', text: "Perimeter-only defense" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Monitor Log Analytics only" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure Virtual Network" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Table Storage" },
      { id: 'B', text: "Azure SQL Database (PaaS)" },
      { id: 'C', text: "Azure Cosmos DB" },
      { id: 'D', text: "Installing SQL Server on an Azure Virtual Machine (IaaS)" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure SQL Database single database" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Scale sets" },
      { id: 'B', text: "WebJobs" },
      { id: 'C', text: "Deployment slots" },
