export const AZURE_AZ900_QUESTIONS_2 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Restricting application access strictly to internal subnets" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Horizontal and Vertical Elasticity" },
      { id: 'B', text: "Recovery Time Objective (RTO) and Recovery Point Objective (RPO)" },
      { id: 'C', text: "Mean Time Between Upgrades and SLA" },
      { id: 'D', text: "Total Cost of Ownership and ROI" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Software as a Service with public endpoints" },
      { id: 'B', text: "Hybrid cloud with dedicated private connectivity" },
      { id: 'C', text: "Public cloud over commodity internet only" },
      { id: 'D', text: "Isolated private cloud with no internet access" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Event-driven execution" },
      { id: 'B', text: "Manual administrator invocations" },
      { id: 'C', text: "Fixed scheduled server reboots" },
      { id: 'D', text: "Constant continuous background polling" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "OpEx can be deducted in full in the current accounting period" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hardware failures are automatically repaired by public cloud vendors" },
      { id: 'B', text: "The company incurs zero capital expenditure" },
      { id: 'C', text: "The public cloud provider manages the physical cooling and power" },
      { id: 'D', text: "The company owns and maintains hardware, facilities and hypervisors" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Sovereign isolation" },
      { id: 'B', text: "Single-point failover" },
      { id: 'C', text: "Cloud colocation" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Users consume the application without managing infrastructure or updates" },
      { id: 'C', text: "Users must regularly install operating system patches on the hosting servers" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Economies of scale and engineering efficiency at hyperscale" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Azure SQL Database is PaaS, whereas SQL Server on an Azure VM is IaaS" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Statutory audit reports" },
      { id: 'B', text: "Non-disclosure commitments" },
      { id: 'C', text: "Terms of Service waivers" },
      { id: 'D', text: "Service Level Agreements (SLAs)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Ensuring compliance with local data residency rules" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Elasticity applies only to storage, whereas scalability applies only to networking" },
      { id: 'B', text: "There is no functional or technical difference between the two terms" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "It shifts spending from CapEx hardware to OpEx consumption" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Third-party internet service providers" },
      { id: 'B', text: "The customer" },
      { id: 'C', text: "The hardware server manufacturer" },
      { id: 'D', text: "Microsoft exclusively" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Physical datacenter security and cooling" },
      { id: 'B', text: "Operating system patching on mail servers" },
      { id: 'C', text: "Data classification, accounts and access" },
      { id: 'D', text: "Network switch firmware updates" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Predictability" },
      { id: 'C', text: "Data Sovereignty" },
      { id: 'D', text: "Geo-distribution" }
    ],
    correctAnswers: ['A'],
    type: "single",
