export const AZURE_AZ900_QUESTIONS_1 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Colocation facility" },
      { id: 'C', text: "On-premises datacenter" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Application agility" },
      { id: 'B', text: "Vertical elasticity" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Geographic localization" },
      { id: 'C', text: "Fixed allocation scaling" },
      { id: 'D', text: "Horizontal scaling (scale out)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Sovereign governance" },
      { id: 'B', text: "Elasticity" },
      { id: 'C', text: "Data residency" },
      { id: 'D', text: "Capital optimization" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Local fault domain redundancy" },
      { id: 'C', text: "Single-zone elasticity" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Maintaining physical access controls to the server room" },
      ...
      { id: 'D', text: "Updating the firmware of the underlying physical host hypervisor" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Operating system patching and server hardware maintenance" },
      { id: 'B', text: "Creating database table indexes and queries" },
      { id: 'C', text: "Writing application business logic" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Dedicated server hosting" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Preventing vendor lock-in and using best-of-breed services per provider" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Single-tenant arbitrage" },
      { id: 'C', text: "Micro-segmentation" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Physical security responsibility is shared equally in PaaS" },
      { id: 'B', text: "The customer is responsible for physical security in IaaS" },
      { id: 'C', text: "The customer provides security guards at local Azure facilities" },
      { id: 'D', text: "Microsoft is always responsible for physical datacenter security" }
    ],
    correctAnswers: ['D'],
    type: "single",
