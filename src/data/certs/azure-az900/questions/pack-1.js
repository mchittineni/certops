export const AZURE_AZ900_QUESTIONS = [
  {
    ...
    options: [
      { id: 'A', text: "Both models are operational expenditure because both are recorded monthly." },
      { id: 'B', text: "Buying servers is an operational expenditure, while Azure VMs are a capital expenditure." },
      { id: 'C', text: "Buying servers is a capital expenditure, while paying for Azure VMs as they run is an operational expenditure." },
      { id: 'D', text: "Both models are capital expenditure because both involve compute hardware." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Two or more VMs in the same Availability Zone behind a load balancer." },
      { id: 'B', text: "Two or more VMs spread across different Availability Zones in the region." },
      { id: 'C', text: "Two or more VMs in a single availability set within one datacentre." },
      { id: 'D', text: "A single VM using Premium SSD managed disks." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure RBAC with a custom role that omits the storage write permission." },
      { id: 'B', text: "Azure Policy with a deny effect assigned at the subscription scope." },
      { id: 'C', text: "Azure Monitor with an alert rule on storage account creation." },
      { id: 'D', text: "Microsoft Cost Management with a budget action." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Read-access geo-zone-redundant storage (RA-GZRS)." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The TCO Calculator for the estimate and the Azure Pricing Calculator for the comparison." },
      { id: 'B', text: "Azure Monitor for the estimate and Microsoft Cost Management for the comparison." },
      { id: 'C', text: "The Azure Pricing Calculator for the estimate and the Total Cost of Ownership (TCO) Calculator for the comparison." },
      { id: 'D', text: "Microsoft Cost Management for the estimate and Azure Advisor for the comparison." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure Policy, a CanNotDelete resource lock, Azure RBAC." },
      { id: 'B', text: "A management group, Azure Policy, Azure Blueprints." },
      { id: 'C', text: "Azure Policy, Azure RBAC, a CanNotDelete resource lock." },
      { id: 'D', text: "Azure RBAC, Azure Policy, a ReadOnly resource lock." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Azure VMware Solution." },
      { id: 'B', text: "Azure Arc." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Agility, elasticity, disaster recovery." },
      { id: 'C', text: "High availability, scalability, elasticity." },
      { id: 'D', text: "Scalability, elasticity, high availability." }
    ],
    correctAnswers: ['A'],
    type: "single",
