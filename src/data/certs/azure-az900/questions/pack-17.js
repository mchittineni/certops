export const AZURE_AZ900_QUESTIONS_17 = [
  {
    ...
    options: [
      { id: 'A', text: "Store the compliance records in Azure Cosmos DB with multi-region write replication." },
      { id: 'B', text: "Keep the archives on running Azure Virtual Machine local OS disks." },
      { id: 'C', text: "Store the archives in the Hot access tier with Premium SSD disks." },
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Rely on manual weekly export of storage blobs to local client workstations." },
      { id: 'B', text: "Configure Geo-Zone-Redundant Storage (GZRS) for the Azure Storage account." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Configure Locally Redundant Storage (LRS) within a single datacenter." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Store file shares on an unattached managed data disk." },
      { id: 'C', text: "Deploy an Azure Cosmos DB document collection for file sharing." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Use Azure Table Storage with partition key indexing for binary file sharing." },
      { id: 'C', text: "Store file shares on an unattached managed data disk." },
      { id: 'D', text: "Deploy an Azure Files managed cloud file share mounted via SMB or NFS." }
    ],
    correctAnswers: ['D'],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Use Azure Table Storage with partition key indexing for binary file sharing." },
      { id: 'B', text: "Deploy an Azure Cosmos DB document collection for file sharing." },
      { id: 'C', text: "Deploy an Azure Files managed cloud file share mounted via SMB or NFS." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy Azure Cosmos DB with multi-region write replication." },
      { id: 'C', text: "Use Azure Queue Storage to persist relational user profiles." },
      { id: 'D', text: "Store operational state in Azure Table Storage with single-region LRS redundancy." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Deploy Azure Cosmos DB with multi-region write replication. Azure Cosmos DB is a fully managed NoSQL and relational database for modern app development. It offers single-digit millisecond response times, automatic and instant scalability, along with guaranteed speed at any scale, supporting document (NoSQL), MongoDB, Cassandra, Gremlin, and PostgreSQL APIs.",
