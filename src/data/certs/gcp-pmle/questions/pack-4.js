export const GCP_PMLE_QUESTIONS_4 = [
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Scaling prototypes into ML models",
    title: "Distributed training strategies with TensorFlow MirroredStrategy and PyTorch DDP: Operational Strategy (Part 87)",
    scenario: "A pharmaceutical clinical trial data service is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Distributed training strategies with TensorFlow MirroredStrategy and PyTorch DDP. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #87.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
