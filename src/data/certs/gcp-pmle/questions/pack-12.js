export const GCP_PMLE_QUESTIONS_12 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Store defect video clips in Cloud Storage Archive tier without local inference." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy an 8-GPU Compute Engine cluster inside the cloud to process remote video feeds." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Use the What-If Tool and Vertex Explainable AI to evaluate fairness metrics across protected slices." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Rely solely on overall global accuracy across the entire population." },
      { id: 'D', text: "Remove demographic labels from the test dataset and assume the model cannot be biased." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Use the What-If Tool and Vertex Explainable AI to evaluate fairness metrics across protected slices. Responsible AI practices require auditing models across demographic slices. The What-If Tool and Vertex Explainable AI enable evaluating fairness metrics (demographic parity, equalized odds) and testing counterfactual scenarios to uncover and mitigate proxy bias.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy the Gemini Multimodal foundation model via Vertex AI Model Garden and Generative AI Studio." },
      { id: 'B', text: "Convert all audio and images into base64 strings and store in an unindexed Cloud SQL database." },
      { id: 'C', text: "Use a simple regex pattern matching script in Python." },
