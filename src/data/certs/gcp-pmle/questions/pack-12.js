export const GCP_PMLE_QUESTIONS_12 = [
  {
    ...
    scenario: "An enterprise organization is establishing high-availability standards and operational continuity guidelines for its cloud systems. Business leaders mandate reliable and resilient operations across all operational domains. The machine learning engineer needs to deploy a defect detection computer vision model to IoT factory cameras with intermittent internet connectivity and strict 10ms local inference requirements.",
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Quantize the model using TensorFlow Lite (TFLite) and deploy directly to edge IoT devices." },
      { id: 'B', text: "Store defect video clips in Cloud Storage Archive tier without local inference." },
      { id: 'C', text: "Deploy an 8-GPU Compute Engine cluster inside the cloud to process remote video feeds." },
      { id: 'D', text: "Stream full 4K video frames over public satellite internet to a central Cloud Run endpoint." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Stream full 4K video frames over public satellite internet to a central Cloud Run endpoint." },
      { id: 'B', text: "Store defect video clips in Cloud Storage Archive tier without local inference." },
      { id: 'C', text: "Quantize the model using TensorFlow Lite (TFLite) and deploy directly to edge IoT devices." },
      { id: 'D', text: "Deploy an 8-GPU Compute Engine cluster inside the cloud to process remote video feeds." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Quantize the model using TensorFlow Lite (TFLite) and deploy directly to edge IoT devices. TensorFlow Lite (TFLite) and post-training quantization reduce model file size and memory footprint while accelerating execution on mobile and embedded edge hardware, enabling real-time local inference without requiring internet connectivity.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Stream full 4K video frames over public satellite internet to a central Cloud Run endpoint." },
      { id: 'B', text: "Deploy an 8-GPU Compute Engine cluster inside the cloud to process remote video feeds." },
      { id: 'C', text: "Store defect video clips in Cloud Storage Archive tier without local inference." },
      { id: 'D', text: "Quantize the model using TensorFlow Lite (TFLite) and deploy directly to edge IoT devices." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Quantize the model using TensorFlow Lite (TFLite) and deploy directly to edge IoT devices. TensorFlow Lite (TFLite) and post-training quantization reduce model file size and memory footprint while accelerating execution on mobile and embedded edge hardware, enabling real-time local inference without requiring internet connectivity.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Quantize the model using TensorFlow Lite (TFLite) and deploy directly to edge IoT devices." },
      { id: 'B', text: "Deploy an 8-GPU Compute Engine cluster inside the cloud to process remote video feeds." },
      { id: 'C', text: "Stream full 4K video frames over public satellite internet to a central Cloud Run endpoint." },
  ...
  },
  {
    ...
    scenario: "An enterprise organization is establishing high-availability standards and operational continuity guidelines for its cloud systems. Business leaders mandate reliable and resilient operations across all operational domains. The machine learning engineer needs to evaluate a loan approval model to ensure it does not exhibit disparate impact or algorithmic bias across demographic and gender subgroups.",
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Rely solely on overall global accuracy across the entire population." },
      { id: 'B', text: "Remove demographic labels from the test dataset and assume the model cannot be biased." },
      { id: 'C', text: "Train the model exclusively on historical approvals without demographic auditing." },
      { id: 'D', text: "Use the What-If Tool and Vertex Explainable AI to evaluate fairness metrics across protected slices." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Train the model exclusively on historical approvals without demographic auditing." },
      { id: 'B', text: "Remove demographic labels from the test dataset and assume the model cannot be biased." },
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Remove demographic labels from the test dataset and assume the model cannot be biased." },
      { id: 'B', text: "Use the What-If Tool and Vertex Explainable AI to evaluate fairness metrics across protected slices." },
      { id: 'C', text: "Train the model exclusively on historical approvals without demographic auditing." },
      { id: 'D', text: "Rely solely on overall global accuracy across the entire population." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Use the What-If Tool and Vertex Explainable AI to evaluate fairness metrics across protected slices. Responsible AI practices require auditing models across demographic slices. The What-If Tool and Vertex Explainable AI enable evaluating fairness metrics (demographic parity, equalized odds) and testing counterfactual scenarios to uncover and mitigate proxy bias.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Remove demographic labels from the test dataset and assume the model cannot be biased." },
      { id: 'B', text: "Train the model exclusively on historical approvals without demographic auditing." },
      { id: 'C', text: "Rely solely on overall global accuracy across the entire population." },
      { id: 'D', text: "Use the What-If Tool and Vertex Explainable AI to evaluate fairness metrics across protected slices." }
    ],
    correctAnswers: ['D'],
  ...
  },
  {
    ...
    scenario: "An enterprise organization is establishing high-availability standards and operational continuity guidelines for its cloud systems. Business leaders mandate reliable and resilient operations across all operational domains. The machine learning engineer needs to train a mobile predictive text keyboard model across millions of user smartphones without uploading personal keystrokes or private messages to central servers.",
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Disable predictive text modeling to avoid privacy concerns." },
      { id: 'B', text: "Implement Federated Learning where models train locally on client devices and only encrypted gradient updates are aggregated." },
      { id: 'C', text: "Store unencrypted user chat logs in a public Cloud Storage bucket." },
      { id: 'D', text: "Upload all raw user keystrokes and SMS text messages to a central BigQuery table." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Store unencrypted user chat logs in a public Cloud Storage bucket." },
      { id: 'B', text: "Disable predictive text modeling to avoid privacy concerns." },
      { id: 'C', text: "Implement Federated Learning where models train locally on client devices and only encrypted gradient updates are aggregated." },
      { id: 'D', text: "Upload all raw user keystrokes and SMS text messages to a central BigQuery table." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable predictive text modeling to avoid privacy concerns." },
      { id: 'C', text: "Upload all raw user keystrokes and SMS text messages to a central BigQuery table." },
      { id: 'D', text: "Store unencrypted user chat logs in a public Cloud Storage bucket." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Implement Federated Learning where models train locally on client devices and only encrypted gradient updates are aggregated. Federated Learning trains machine learning algorithms across decentralized edge devices holding local data samples without exchanging raw data. Devices download the global model, train locally on personal data, and send only aggregated, encrypted weight updates to the central coordinator.",
  ...
  },
  {
    ...
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management?",
    options: [
      { id: 'A', text: "Upload all raw user keystrokes and SMS text messages to a central BigQuery table." },
      { id: 'B', text: "Store unencrypted user chat logs in a public Cloud Storage bucket." },
      { id: 'C', text: "Disable predictive text modeling to avoid privacy concerns." },
      { id: 'D', text: "Implement Federated Learning where models train locally on client devices and only encrypted gradient updates are aggregated." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Implement Federated Learning where models train locally on client devices and only encrypted gradient updates are aggregated. Federated Learning trains machine learning algorithms across decentralized edge devices holding local data samples without exchanging raw data. Devices download the global model, train locally on personal data, and send only aggregated, encrypted weight updates to the central coordinator.",
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Train separate custom convolutional neural networks and acoustic models from scratch." },
      { id: 'B', text: "Deploy the Gemini Multimodal foundation model via Vertex AI Model Garden and Generative AI Studio." },
      { id: 'C', text: "Convert all audio and images into base64 strings and store in an unindexed Cloud SQL database." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy the Gemini Multimodal foundation model via Vertex AI Model Garden and Generative AI Studio." },
      { id: 'B', text: "Use a simple regex pattern matching script in Python." },
      { id: 'C', text: "Train separate custom convolutional neural networks and acoustic models from scratch." },
      { id: 'D', text: "Convert all audio and images into base64 strings and store in an unindexed Cloud SQL database." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Deploy the Gemini Multimodal foundation model via Vertex AI Model Garden and Generative AI Studio. Google Cloud Vertex AI provides access to the Gemini family of foundational models, which are natively multimodal. Gemini can ingest and reason across text, high-resolution images, audio recordings, and video streams natively within a single prompt context.",
  ...
  },
  {
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Convert all audio and images into base64 strings and store in an unindexed Cloud SQL database." },
      { id: 'B', text: "Use a simple regex pattern matching script in Python." },
      { id: 'C', text: "Train separate custom convolutional neural networks and acoustic models from scratch." },
      { id: 'D', text: "Deploy the Gemini Multimodal foundation model via Vertex AI Model Garden and Generative AI Studio." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Deploy the Gemini Multimodal foundation model via Vertex AI Model Garden and Generative AI Studio. Google Cloud Vertex AI provides access to the Gemini family of foundational models, which are natively multimodal. Gemini can ingest and reason across text, high-resolution images, audio recordings, and video streams natively within a single prompt context.",
  ...
  },
  {
    ...
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management?",
    options: [
      { id: 'A', text: "Use a simple regex pattern matching script in Python." },
  ...
  },
  {
    ...
    scenario: "An enterprise organization is establishing high-availability standards and operational continuity guidelines for its cloud systems. Business leaders mandate reliable and resilient operations across all operational domains. The machine learning engineer needs to build a real-time semantic search and retrieval-augmented generation (RAG) engine over 50 million enterprise PDF documents with sub-10ms query latency.",
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Execute SQL LIKE '%keyword%' queries over unstructured text columns in Cloud SQL." },
      { id: 'B', text: "Store raw PDF binary data in a Redis in-memory cache without embedding vectors." },
      { id: 'C', text: "Generate text embeddings using Vertex AI Embeddings API and index them in Vertex AI Vector Search." },
      { id: 'D', text: "Scan all PDF documents sequentially using desktop text search software." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Store raw PDF binary data in a Redis in-memory cache without embedding vectors." },
      { id: 'B', text: "Generate text embeddings using Vertex AI Embeddings API and index them in Vertex AI Vector Search." },
      { id: 'C', text: "Execute SQL LIKE '%keyword%' queries over unstructured text columns in Cloud SQL." },
      { id: 'D', text: "Scan all PDF documents sequentially using desktop text search software." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Scan all PDF documents sequentially using desktop text search software." },
      { id: 'B', text: "Store raw PDF binary data in a Redis in-memory cache without embedding vectors." },
      { id: 'C', text: "Generate text embeddings using Vertex AI Embeddings API and index them in Vertex AI Vector Search." },
      { id: 'D', text: "Execute SQL LIKE '%keyword%' queries over unstructured text columns in Cloud SQL." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Generate text embeddings using Vertex AI Embeddings API and index them in Vertex AI Vector Search. Vertex AI Vector Search (formerly Matching Engine) is an ultra-high-scale, low-latency vector similarity search service. Based on Google's ScaNN algorithm, it searches billions of high-dimensional embedding vectors with millisecond retrieval times, forming the backbone for enterprise RAG systems.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Store raw PDF binary data in a Redis in-memory cache without embedding vectors." },
      { id: 'B', text: "Scan all PDF documents sequentially using desktop text search software." },
      { id: 'C', text: "Execute SQL LIKE '%keyword%' queries over unstructured text columns in Cloud SQL." },
      { id: 'D', text: "Generate text embeddings using Vertex AI Embeddings API and index them in Vertex AI Vector Search." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Generate text embeddings using Vertex AI Embeddings API and index them in Vertex AI Vector Search. Vertex AI Vector Search (formerly Matching Engine) is an ultra-high-scale, low-latency vector similarity search service. Based on Google's ScaNN algorithm, it searches billions of high-dimensional embedding vectors with millisecond retrieval times, forming the backbone for enterprise RAG systems.",
