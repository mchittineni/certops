export const GCP_PMLE_QUESTIONS_7 = [
  {
    id: "gcp-pmle-151",
    difficulty: "medium",
    certId: "gcp-pmle",
    ...
    title: "Automated hyperparameter tuning with Vertex AI Vizier: Operational Strategy (Part 151)",
    scenario: "A multinational fintech banking platform is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Automated hyperparameter tuning with Vertex AI Vizier. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #151.",
    ...
    options: [
      ...
      { id: 'D', text: "Deploy native automation for automated hyperparameter tuning with vertex ai vizier utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    title: "Vertex AI Model Monitoring detecting data drift and concept skew: Operational Strategy (Part 152)",
    scenario: "A healthcare telemedicine network is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Vertex AI Model Monitoring detecting data drift and concept skew. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #152.",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Monitoring AI solutions",
    title: "Addressing data privacy, fairness, and model interpretability with Explainable AI: Operational Strategy (Part 153)",
    scenario: "A high-throughput e-commerce retailer is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Addressing data privacy, fairness, and model interpretability with Explainable AI. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #153.",
  ...
  },
  {
    ...
    title: "Handling data anomalies, skew, and missing values at scale: Operational Strategy (Part 154)",
    scenario: "A global streaming entertainment platform is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Handling data anomalies, skew, and missing values at scale. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #154.",
    ...
    options: [
      ...
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'C', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'D', text: "Deploy native automation for handling data anomalies, skew, and missing values at scale utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Collaborating within and across teams to manage data and models",
    title: "Model evaluation metrics precision, recall, AUC-ROC, and F1 score: Operational Strategy (Part 155)",
    scenario: "An algorithmic trading exchange is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Model evaluation metrics precision, recall, AUC-ROC, and F1 score. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #155.",
  ...
  },
  {
    ...
    title: "Deploying models to Vertex AI Endpoints with autoscaling and traffic splitting: Operational Strategy (Part 156)",
    scenario: "A logistics and supply chain optimization service is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Deploying models to Vertex AI Endpoints with autoscaling and traffic splitting. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #156.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Scaling prototypes into ML models",
    title: "Evaluating cost, compute resources, and GPU/TPU acceleration tradeoffs: Operational Strategy (Part 157)",
    scenario: "An IoT industrial telematics infrastructure is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Evaluating cost, compute resources, and GPU/TPU acceleration tradeoffs. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #157.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
  ...
  },
  {
    ...
    title: "Generating dense vector embeddings for search and recommendation systems: Operational Strategy (Part 158)",
    scenario: "A multi-tenant enterprise SaaS provider is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Generating dense vector embeddings for search and recommendation systems. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #158.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Deploy native automation for generating dense vector embeddings for search and recommendation systems utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'C', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Serving and scaling models",
    title: "Batch prediction pipelines processing petabyte-scale datasets efficiently: Operational Strategy (Part 160)",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Architecting low-code AI solutions",
    title: "Translating business requirements into supervised and unsupervised ML objectives: Operational Strategy (Part 161)",
    scenario: "A digital media publishing network is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Translating business requirements into supervised and unsupervised ML objectives. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #161.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Architecting low-code AI solutions",
    title: "BigQuery ML for rapid prototyping and SQL-based model training: Operational Strategy (Part 162)",
    scenario: "A pharmaceutical clinical trial data service is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding BigQuery ML for rapid prototyping and SQL-based model training. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #162.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Scaling prototypes into ML models",
    title: "Custom model training with Vertex AI Training and custom container images: Operational Strategy (Part 163)",
    scenario: "A renewable energy smart-grid operator is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Custom model training with Vertex AI Training and custom container images. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #163.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
  ...
  },
  {
    ...
    title: "Vertex AI Pipelines orchestrating Kubeflow and TFX pipeline components: Operational Strategy (Part 164)",
    scenario: "A mobile gaming backend architecture is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Vertex AI Pipelines orchestrating Kubeflow and TFX pipeline components. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #164.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Deploy native automation for vertex ai pipelines orchestrating kubeflow and tfx pipeline components utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'C', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'D', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." }
    ],
    correctAnswers: ['B'],
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Architecting low-code AI solutions",
    title: "Choosing between pre-trained APIs, AutoML, and custom trained models: Operational Strategy (Part 165)",
    scenario: "A ride-sharing dispatch system is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Choosing between pre-trained APIs, AutoML, and custom trained models. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #165.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Collaborating within and across teams to manage data and models",
    title: "Dataflow preprocessing pipelines with Apache Beam and tf.Transform: Operational Strategy (Part 166)",
    scenario: "An insurance claims processing engine is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Dataflow preprocessing pipelines with Apache Beam and tf.Transform. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #166.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Scaling prototypes into ML models",
    title: "Distributed training strategies with TensorFlow MirroredStrategy and PyTorch DDP: Operational Strategy (Part 167)",
    scenario: "A commercial airline reservation service is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Distributed training strategies with TensorFlow MirroredStrategy and PyTorch DDP. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #167.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Serving and scaling models",
    title: "Vertex AI Model Registry tracking model versions and lineage metadata: Operational Strategy (Part 168)",
    scenario: "A cybersecurity threat intelligence agency is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Vertex AI Model Registry tracking model versions and lineage metadata. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #168.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Serving and scaling models",
    title: "Designing low-latency prediction architectures streaming vs batch: Operational Strategy (Part 169)",
    scenario: "A real estate property management portal is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Designing low-latency prediction architectures streaming vs batch. The engineering group is implementing automated canary analysis with instant rollback capabilities triggered by error budget burn rates for service tier #169.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Collaborating within and across teams to manage data and models",
    title: "Vertex AI Feature Store managing online serving and offline training features: Operational Strategy (Part 170)",
    scenario: "An autonomous robotics manufacturing facility is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Vertex AI Feature Store managing online serving and offline training features. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #170.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Scaling prototypes into ML models",
    title: "Automated hyperparameter tuning with Vertex AI Vizier: Operational Strategy (Part 171)",
    scenario: "A higher education student information system is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Automated hyperparameter tuning with Vertex AI Vizier. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #171.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Monitoring AI solutions",
    title: "Vertex AI Model Monitoring detecting data drift and concept skew: Operational Strategy (Part 172)",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Monitoring AI solutions",
    title: "Addressing data privacy, fairness, and model interpretability with Explainable AI: Operational Strategy (Part 173)",
    scenario: "A digital payments settlement processor is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Addressing data privacy, fairness, and model interpretability with Explainable AI. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #173.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Collaborating within and across teams to manage data and models",
    title: "Handling data anomalies, skew, and missing values at scale: Operational Strategy (Part 174)",
    scenario: "A genomics sequencing data pipeline is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Handling data anomalies, skew, and missing values at scale. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #174.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'C', text: "Deploy native automation for handling data anomalies, skew, and missing values at scale utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Collaborating within and across teams to manage data and models",
    title: "Model evaluation metrics precision, recall, AUC-ROC, and F1 score: Operational Strategy (Part 175)",
    scenario: "A cloud-native telecommunications provider is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Model evaluation metrics precision, recall, AUC-ROC, and F1 score. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #175.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
...
export default GCP_PMLE_QUESTIONS_7;
