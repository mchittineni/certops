export const GCP_PMLE_QUESTIONS_7 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy native automation for deploying models to vertex ai endpoints with autoscaling and traffic splitting utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Developing and training ML models",
    title: "Distributed training strategies with TensorFlow and PyTorch MirroredStrategy: Operational Strategy (Part 167)",
    scenario: "A commercial airline reservation service is evaluating Google Cloud Professional Machine Learning Engineer practices specifically regarding Distributed training strategies with TensorFlow and PyTorch MirroredStrategy. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #167.",
    ...
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Deploy native automation for distributed training strategies with tensorflow and pytorch mirroredstrategy utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'C', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'D', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." }
    ],
    correctAnswers: ['B'],
