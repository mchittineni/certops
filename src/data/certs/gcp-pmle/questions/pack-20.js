export const GCP_PMLE_QUESTIONS_20 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure Google Cloud Build triggers to run unit tests and build custom training containers upon Git commits." },
      { id: 'B', text: "Deploy model code without running regression tests or dependency checks." },
      { id: 'C', text: "Commit unverified training scripts directly to the production branch without automated testing." },
      { id: 'D', text: "Test machine learning code manually by running Jupyter notebooks on personal laptops." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Configure Google Cloud Build triggers to run unit tests and build custom training containers upon Git commits. Continuous Integration (CI) for ML extends traditional software CI to machine learning assets. Cloud Build runs automated unit tests on data validation and feature engineering modules, tests model training steps on synthetic micro-datasets, and builds versioned container images.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Use a batch SQL script scheduled to run every 1 second inside BigQuery." },
    ...
    correctAnswers: ['A'],
    type: "single",
    explanation: "Export the BigQuery ML model using 'EXPORT MODEL' to Cloud Storage, register in Vertex AI Model Registry, and deploy to an Endpoint. BigQuery ML models can be exported to Cloud Storage with the `EXPORT MODEL` SQL statement (boosted tree models as XGBoost boosters, DNN models as TensorFlow SavedModels). Setting model_registry = 'vertex_ai' in CREATE MODEL registers the model directly without an export. Once in Vertex AI Model Registry, models can be deployed to managed prediction endpoints for low-latency real-time serving.",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Store user features in local virtual machine memory caches." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Configure training scripts to save model checkpoints periodically to a Cloud Storage bucket and resume from the latest checkpoint." },
      { id: 'D', text: "Start the 7-day training job from epoch 1 every time a Spot VM node is reclaimed." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Hardcode enterprise document text into a prompt template." }
    ],
    correctAnswers: ['C'],
    type: "single",
