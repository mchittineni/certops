export const GCP_PMLE_QUESTIONS_13 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Train a classification model using BigQuery ML (CREATE OR REPLACE MODEL ... OPTIONS(model_type='boosted_tree_classifier'))." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Manually calculate probabilities in Excel spreadsheets." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Train a classification model using BigQuery ML (CREATE OR REPLACE MODEL ... OPTIONS(model_type='boosted_tree_classifier')). BigQuery ML (BQML) enables data scientists and analysts to build and operationalize ML models directly inside BigQuery using standard SQL. It eliminates the need to export massive datasets, handles automated preprocessing via the `TRANSFORM` clause, and scales compute dynamically.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Store raw unprocessed text directly in the training pipeline and perform CPU tokenization inside the training loop." },
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Process all text files sequentially on a single-core virtual machine." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Calculate scaling factors dynamically on each individual incoming online prediction request." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable all feature scaling and normalization to avoid discrepancies." },
      { id: 'C', text: "Implement feature transformations using TensorFlow Transform (tf.transform) and export the preprocessing graph with the saved model." },
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Store features in a public Google Sheets document shared across teams." },
      { id: 'B', text: "Hardcode calculated feature values directly into application source code." },
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Replace all missing numerical values with the number 999999 without indicator flags." },
      { id: 'B', text: "Apply appropriate imputation strategies (median for skewed numbers, mode or dedicated 'MISSING' category for categorical features)." },
      { id: 'C', text: "Delete all rows that contain at least one missing value." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Delete all rows that contain at least one missing value." },
      { id: 'D', text: "Replace all missing numerical values with the number 999999 without indicator flags." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Apply appropriate imputation strategies (median for skewed numbers, mode or dedicated 'MISSING' category for categorical features). Dropping rows with missing values causes significant data loss and introduces selection bias. Proper imputation techniques (such as median imputation for continuous features or creating an explicit 'Unknown' category) preserve training data while representing missingness cleanly.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Apply appropriate imputation strategies (median for skewed numbers, mode or dedicated 'MISSING' category for categorical features)." },
      { id: 'B', text: "Delete all rows that contain at least one missing value." },
