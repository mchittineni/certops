export const GCP_PMLE_QUESTIONS_13 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Implement feature transformations using TensorFlow Transform (tf.transform) and export the preprocessing graph with the saved model." },
      { id: 'B', text: "Implement preprocessing in Python for training and rewrite the logic in JavaScript for serving." },
      { id: 'C', text: "Calculate scaling factors dynamically on each individual incoming online prediction request." },
