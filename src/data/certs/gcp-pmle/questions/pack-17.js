export const GCP_PMLE_QUESTIONS_17 = [
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives? Feature attributions using Sampled Shapley values and Integrated Gradients is under consideration.",
    options: [
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently? Feature attributions using Sampled Shapley values and Integrated Gradients is under consideration.",
    options: [
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls? Feature attributions using Sampled Shapley values and Integrated Gradients is under consideration.",
    options: [
  ...
  },
  {
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals? Feature attributions using Sampled Shapley values and Integrated Gradients is under consideration.",
    options: [
      { id: 'A', text: "Enable Vertex Explainable AI to compute feature attributions (Sampled Shapley for tabular data or Integrated Gradients for neural networks)." },
      { id: 'B', text: "Claim that machine learning models are complete black boxes that cannot be explained." },
      { id: 'C', text: "Generate random percentage contributions for each input field." },
      { id: 'D', text: "Provide auditors with the raw floating-point neural network weight matrices." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Enable Vertex Explainable AI to compute feature attributions (Sampled Shapley for tabular data or Integrated Gradients for neural networks). Vertex Explainable AI provides detailed feature attributions that explain the relative contribution of each feature to a model's prediction. For tabular models, Sampled Shapley values compute marginal feature contributions, while Integrated Gradients evaluates gradients along a path for differentiable models.",
  ...
  },
  {
    ...
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management? Feature attributions using Sampled Shapley values and Integrated Gradients is under consideration.",
    options: [
      { id: 'A', text: "Claim that machine learning models are complete black boxes that cannot be explained." },
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives? Binary cross-entropy vs Categorical cross-entropy vs Mean Squared Error vs Focal Loss is under consideration.",
    options: [
  ...
  },
  {
    ...
    scenario: "A rapidly growing technology startup experiences seasonal surges in user traffic and transactions. The management team requires architecture that scales seamlessly while maintaining performance and operational stability. The machine learning engineer evaluates Machine Learning Theory to select the mathematical loss function for a multi-class image classification model where each image belongs to exactly one of 10 mutually exclusive categories.",
    question: "Which architectural approach should the team select to manage this demand efficiently? Binary cross-entropy vs Categorical cross-entropy vs Mean Squared Error vs Focal Loss is under consideration.",
    options: [
      { id: 'A', text: "Use Mean Squared Error (MSE) loss with linear activation." },
      { id: 'B', text: "Use Categorical Cross-Entropy loss with a softmax output activation function." },
  ...
  },
  {
    ...
    scenario: "A financial compliance and auditing department requires strict enforcement of data protection, access controls, and cloud governance policies across all systems. The machine learning engineer evaluates Machine Learning Theory to select the mathematical loss function for a multi-class image classification model where each image belongs to exactly one of 10 mutually exclusive categories.",
    question: "Which solution properly implements these mandatory security and governance controls? Binary cross-entropy vs Categorical cross-entropy vs Mean Squared Error vs Focal Loss is under consideration.",
    options: [
      ...
      { id: 'C', text: "Use Categorical Cross-Entropy loss with a softmax output activation function." },
      { id: 'D', text: "Use Binary Cross-Entropy loss with sigmoid activations on each output unit." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    scenario: "An enterprise is migrating traditional on-premises data center operations to Google Cloud. The executive team wants to maximize efficiency, accelerate innovation, and minimize operational complexity. The machine learning engineer evaluates Machine Learning Theory to select the mathematical loss function for a multi-class image classification model where each image belongs to exactly one of 10 mutually exclusive categories.",
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals? Binary cross-entropy vs Categorical cross-entropy vs Mean Squared Error vs Focal Loss is under consideration.",
    options: [
      { id: 'A', text: "Use Hinge loss designed for binary support vector machines." },
      { id: 'B', text: "Use Mean Squared Error (MSE) loss with linear activation." },
      { id: 'C', text: "Use Categorical Cross-Entropy loss with a softmax output activation function." },
  ...
  },
  {
    ...
    scenario: "An IT operations team is modernizing infrastructure to eliminate single points of failure, optimize spending, and automate infrastructure maintenance. The machine learning engineer evaluates Machine Learning Theory to select the mathematical loss function for a multi-class image classification model where each image belongs to exactly one of 10 mutually exclusive categories.",
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management? Binary cross-entropy vs Categorical cross-entropy vs Mean Squared Error vs Focal Loss is under consideration.",
    options: [
      { id: 'A', text: "Use Categorical Cross-Entropy loss with a softmax output activation function." },
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives? Post-training integer quantization (INT8) and weight pruning is under consideration.",
    options: [
      ...
      { id: 'C', text: "Deploy the model on an unoptimized high-power cloud server." },
  ...
  },
  {
    ...
    scenario: "A rapidly growing technology startup experiences seasonal surges in user traffic and transactions. The management team requires architecture that scales seamlessly while maintaining performance and operational stability. The machine learning engineer evaluates Model Optimization to reduce the memory footprint of a deep learning model by 75% and double inference throughput on mobile edge devices with minimal accuracy degradation.",
    question: "Which architectural approach should the team select to manage this demand efficiently? Post-training integer quantization (INT8) and weight pruning is under consideration.",
    options: [
      { id: 'A', text: "Deploy the model on an unoptimized high-power cloud server." },
      { id: 'B', text: "Apply post-training INT8 quantization and weight pruning to the model graph." },
  ...
  },
  {
    ...
    scenario: "A financial compliance and auditing department requires strict enforcement of data protection, access controls, and cloud governance policies across all systems. The machine learning engineer evaluates Model Optimization to reduce the memory footprint of a deep learning model by 75% and double inference throughput on mobile edge devices with minimal accuracy degradation.",
    question: "Which solution properly implements these mandatory security and governance controls? Post-training integer quantization (INT8) and weight pruning is under consideration.",
    options: [
      { id: 'A', text: "Apply post-training INT8 quantization and weight pruning to the model graph." },
  ...
  },
  {
    ...
    scenario: "An enterprise is migrating traditional on-premises data center operations to Google Cloud. The executive team wants to maximize efficiency, accelerate innovation, and minimize operational complexity. The machine learning engineer evaluates Model Optimization to reduce the memory footprint of a deep learning model by 75% and double inference throughput on mobile edge devices with minimal accuracy degradation.",
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals? Post-training integer quantization (INT8) and weight pruning is under consideration.",
    options: [
  ...
  },
  {
    ...
    scenario: "An IT operations team is modernizing infrastructure to eliminate single points of failure, optimize spending, and automate infrastructure maintenance. The machine learning engineer evaluates Model Optimization to reduce the memory footprint of a deep learning model by 75% and double inference throughput on mobile edge devices with minimal accuracy degradation.",
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management? Post-training integer quantization (INT8) and weight pruning is under consideration.",
    options: [
      { id: 'A', text: "Double the floating-point precision from FP32 to FP64." },
      { id: 'B', text: "Apply post-training INT8 quantization and weight pruning to the model graph." },
      { id: 'C', text: "Deploy the model on an unoptimized high-power cloud server." },
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives? Reward modeling and PPO reinforcement learning from human feedback is under consideration.",
    options: [
  ...
  },
  {
    ...
    scenario: "A rapidly growing technology startup experiences seasonal surges in user traffic and transactions. The management team requires architecture that scales seamlessly while maintaining performance and operational stability. The machine learning engineer evaluates Generative AI Training to align a generative language model to follow human instructions safely, produce helpful responses, and avoid generating toxic or harmful content.",
    question: "Which architectural approach should the team select to manage this demand efficiently? Reward modeling and PPO reinforcement learning from human feedback is under consideration.",
    options: [
      ...
      { id: 'D', text: "Continue standard unsupervised next-token prediction training on raw web text indefinitely." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Implement Reinforcement Learning from Human Feedback (RLHF) using a trained reward model and Proximal Policy Optimization (PPO). Reinforcement Learning from Human Feedback (RLHF) aligns LLMs with human intent. After supervised fine-tuning (SFT), human annotators rank model completions to train a Reward Model, which guides the policy model using reinforcement learning (PPO) to maximize helpfulness and safety.",
  ...
  },
  {
    ...
    scenario: "A financial compliance and auditing department requires strict enforcement of data protection, access controls, and cloud governance policies across all systems. The machine learning engineer evaluates Generative AI Training to align a generative language model to follow human instructions safely, produce helpful responses, and avoid generating toxic or harmful content.",
    question: "Which solution properly implements these mandatory security and governance controls? Reward modeling and PPO reinforcement learning from human feedback is under consideration.",
    options: [
      { id: 'A', text: "Hardcode a list of banned words using static string replace operations." },
  ...
  },
  {
    ...
    scenario: "An enterprise is migrating traditional on-premises data center operations to Google Cloud. The executive team wants to maximize efficiency, accelerate innovation, and minimize operational complexity. The machine learning engineer evaluates Generative AI Training to align a generative language model to follow human instructions safely, produce helpful responses, and avoid generating toxic or harmful content.",
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals? Reward modeling and PPO reinforcement learning from human feedback is under consideration.",
    options: [
      { id: 'A', text: "Hardcode a list of banned words using static string replace operations." },
      { id: 'B', text: "Implement Reinforcement Learning from Human Feedback (RLHF) using a trained reward model and Proximal Policy Optimization (PPO)." },
      { id: 'C', text: "Instruct human operators to manually approve every generated response in real time." },
  ...
  },
  {
    ...
    scenario: "An IT operations team is modernizing infrastructure to eliminate single points of failure, optimize spending, and automate infrastructure maintenance. The machine learning engineer evaluates Generative AI Training to align a generative language model to follow human instructions safely, produce helpful responses, and avoid generating toxic or harmful content.",
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management? Reward modeling and PPO reinforcement learning from human feedback is under consideration.",
    options: [
      { id: 'A', text: "Instruct human operators to manually approve every generated response in real time." },
      { id: 'B', text: "Hardcode a list of banned words using static string replace operations." },
      { id: 'C', text: "Continue standard unsupervised next-token prediction training on raw web text indefinitely." },
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives? Vertex AI Pipelines executing containerized Kubeflow Pipelines (KFP) and TFX components is under consideration.",
    options: [
      { id: 'A', text: "Write a monolithic Python script executing all steps sequentially on an individual VM." },
      { id: 'B', text: "Build and execute an MLOps pipeline using Kubeflow Pipelines (KFP) or TFX deployed on Vertex AI Pipelines." },
  ...
  },
  {
    ...
    scenario: "A rapidly growing technology startup experiences seasonal surges in user traffic and transactions. The management team requires architecture that scales seamlessly while maintaining performance and operational stability. The machine learning engineer evaluates MLOps Pipelines to orchestrate an automated, reproducible end-to-end MLOps workflow spanning data extraction, validation, training, evaluation, and model deployment.",
    question: "Which architectural approach should the team select to manage this demand efficiently? Vertex AI Pipelines executing containerized Kubeflow Pipelines (KFP) and TFX components is under consideration.",
    options: [
      { id: 'A', text: "Run manual shell commands sequentially in Cloud Shell whenever a model update is needed." },
      { id: 'B', text: "Build and execute an MLOps pipeline using Kubeflow Pipelines (KFP) or TFX deployed on Vertex AI Pipelines." },
      { id: 'C', text: "Write a monolithic Python script executing all steps sequentially on an individual VM." },
      { id: 'D', text: "Schedule separate cron jobs across 5 independent virtual machines without dependency coordination." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    scenario: "A financial compliance and auditing department requires strict enforcement of data protection, access controls, and cloud governance policies across all systems. The machine learning engineer evaluates MLOps Pipelines to orchestrate an automated, reproducible end-to-end MLOps workflow spanning data extraction, validation, training, evaluation, and model deployment.",
    question: "Which solution properly implements these mandatory security and governance controls? Vertex AI Pipelines executing containerized Kubeflow Pipelines (KFP) and TFX components is under consideration.",
    options: [
      ...
      { id: 'C', text: "Run manual shell commands sequentially in Cloud Shell whenever a model update is needed." },
      { id: 'D', text: "Build and execute an MLOps pipeline using Kubeflow Pipelines (KFP) or TFX deployed on Vertex AI Pipelines." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Build and execute an MLOps pipeline using Kubeflow Pipelines (KFP) or TFX deployed on Vertex AI Pipelines. Vertex AI Pipelines is a serverless orchestration service that runs machine learning workflows built using Kubeflow Pipelines (KFP) or TensorFlow Extended (TFX). It manages container execution, passes artifacts deterministically between steps, tracks lineage in Vertex ML Metadata, and eliminates cluster maintenance.",
  ...
  },
  {
    ...
    scenario: "An enterprise is migrating traditional on-premises data center operations to Google Cloud. The executive team wants to maximize efficiency, accelerate innovation, and minimize operational complexity. The machine learning engineer evaluates MLOps Pipelines to orchestrate an automated, reproducible end-to-end MLOps workflow spanning data extraction, validation, training, evaluation, and model deployment.",
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals? Vertex AI Pipelines executing containerized Kubeflow Pipelines (KFP) and TFX components is under consideration.",
    options: [
      { id: 'A', text: "Schedule separate cron jobs across 5 independent virtual machines without dependency coordination." },
      { id: 'B', text: "Write a monolithic Python script executing all steps sequentially on an individual VM." },
      { id: 'C', text: "Run manual shell commands sequentially in Cloud Shell whenever a model update is needed." },
  ...
  },
  {
    ...
    scenario: "An IT operations team is modernizing infrastructure to eliminate single points of failure, optimize spending, and automate infrastructure maintenance. The machine learning engineer evaluates MLOps Pipelines to orchestrate an automated, reproducible end-to-end MLOps workflow spanning data extraction, validation, training, evaluation, and model deployment.",
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management? Vertex AI Pipelines executing containerized Kubeflow Pipelines (KFP) and TFX components is under consideration.",
    options: [
      { id: 'A', text: "Build and execute an MLOps pipeline using Kubeflow Pipelines (KFP) or TFX deployed on Vertex AI Pipelines." },
      { id: 'B', text: "Schedule separate cron jobs across 5 independent virtual machines without dependency coordination." },
      { id: 'C', text: "Run manual shell commands sequentially in Cloud Shell whenever a model update is needed." },
      { id: 'D', text: "Write a monolithic Python script executing all steps sequentially on an individual VM." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Build and execute an MLOps pipeline using Kubeflow Pipelines (KFP) or TFX deployed on Vertex AI Pipelines. Vertex AI Pipelines is a serverless orchestration service that runs machine learning workflows built using Kubeflow Pipelines (KFP) or TensorFlow Extended (TFX). It manages container execution, passes artifacts deterministically between steps, tracks lineage in Vertex ML Metadata, and eliminates cluster maintenance.",
