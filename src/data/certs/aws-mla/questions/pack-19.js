export const AWS_MLA_QUESTIONS_19 = [
  {
    ...
    title: "An Approval Gate Before Production Deployment: High-Frequency FinTech Trading",
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The ML engineering team is requiring a reviewer's approval before any model version can reach production. The work is scoped to the production environment.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Keeping Training Data and Traffic Private: Healthcare Patient Records & HIPAA",
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The ML engineering team is keeping training data encrypted and job traffic off the public internet under audit. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Noticing That a Production Model Has Degraded: Global E-Commerce Black Friday Scale",
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The ML engineering team is detecting that a deployed model's inputs or accuracy have shifted away from training. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Explaining One Individual Prediction: Autonomous Vehicle Telemetry",
    scenario: "A self-driving automotive fleet streams terabytes of sensor telemetry requiring real-time distributed ingestion and anomaly detection. The ML engineering team is explaining to a declined applicant which inputs drove their particular decision. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "An Approval Gate Before Production Deployment: Multi-Tenant B2B SaaS Platform",
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The ML engineering team is requiring a reviewer's approval before any model version can reach production. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Keeping Training Data and Traffic Private: Media Streaming & Global CDN",
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The ML engineering team is keeping training data encrypted and job traffic off the public internet under audit. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Noticing That a Production Model Has Degraded: Aerospace Satellite Ground Systems",
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The ML engineering team is detecting that a deployed model's inputs or accuracy have shifted away from training. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Explaining One Individual Prediction: Telecommunications 5G Core Network",
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The ML engineering team is explaining to a declined applicant which inputs drove their particular decision. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "An Approval Gate Before Production Deployment: Renewable Energy Smart Grid IoT",
    scenario: "A smart electrical grid platform monitors millions of smart meters with low-latency time-series analysis and automated load shedding. The ML engineering team is requiring a reviewer's approval before any model version can reach production. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Store each model artifact in a versioned S3 bucket and record its metrics in a DynamoDB table that the deployment job consults first." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Keeping Training Data and Traffic Private: Supply Chain Cold-Chain Logistics",
    scenario: "A pharmaceutical distribution network tracks temperature-sensitive cargo with cryptographic provenance and automated breach alerts. The ML engineering team is keeping training data encrypted and job traffic off the public internet under audit. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Enable network isolation on the training job so that the container has no network access, and encrypt the storage volumes with the default key." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Noticing That a Production Model Has Degraded: Banking Core Ledger & Payments",
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The ML engineering team is detecting that a deployed model's inputs or accuracy have shifted away from training. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Explaining One Individual Prediction: Genomic Sequencing & Biotech Pipeline",
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The ML engineering team is explaining to a declined applicant which inputs drove their particular decision. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "An Approval Gate Before Production Deployment: Defense-Grade Zero-Trust Network",
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The ML engineering team is requiring a reviewer's approval before any model version can reach production. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Keeping Training Data and Traffic Private: Online Multiplayer Gaming Engine",
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The ML engineering team is keeping training data encrypted and job traffic off the public internet under audit. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Enable network isolation on the training job so that the container has no network access, and encrypt the storage volumes with the default key." },
      { id: 'B', text: "Configure VPC interface endpoints (PrivateLink), enable KMS encryption for S3 and EBS storage, and enforce IAM least-privilege execution roles." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Noticing That a Production Model Has Degraded: Insurance Risk & Actuarial Modeling",
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The ML engineering team is detecting that a deployed model's inputs or accuracy have shifted away from training. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Configure SageMaker Model Monitor with a baseline dataset to continuously inspect endpoint requests and detect data drift or model quality degradation." },
      { id: 'B', text: "Configure CloudWatch alarms across the endpoint's invocation count, latency, and error metrics so that any operational problem raises an alert." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Explaining One Individual Prediction: Pharmaceutical Clinical Trial Platform",
    scenario: "A global pharmaceutical research group manages double-blind clinical trial records with strict regulatory reporting and audit trails. The ML engineering team is explaining to a declined applicant which inputs drove their particular decision. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use the bias drift monitor in SageMaker Model Monitor to report how the model's fairness metrics are changing over time in production." },
      { id: 'B', text: "Use SageMaker Clarify to compute pre-training bias metrics and post-training SHAP (Shapley Additive exPlanations) values to explain feature contributions." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "An Approval Gate Before Production Deployment: Smart City Traffic & Mobility Sensor Hub",
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The ML engineering team is requiring a reviewer's approval before any model version can reach production. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Store each model artifact in a versioned S3 bucket and record its metrics in a DynamoDB table that the deployment job consults first." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Keeping Training Data and Traffic Private: Digital Identity & Biometric Verification",
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The ML engineering team is keeping training data encrypted and job traffic off the public internet under audit. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Enable network isolation on the training job so that the container has no network access, and encrypt the storage volumes with the default key." },
      { id: 'B', text: "Run the training jobs inside a VPC with a NAT gateway for their egress and rely on S3 default encryption using Amazon-managed keys." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Noticing That a Production Model Has Degraded: Legal Discovery & Semantic Document Search",
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The ML engineering team is detecting that a deployed model's inputs or accuracy have shifted away from training. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Explaining One Individual Prediction: AdTech Real-Time Bidding Exchange",
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The ML engineering team is explaining to a declined applicant which inputs drove their particular decision. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use SageMaker Debugger rules to capture tensors during training and report which of the features carried the largest gradients." },
      { id: 'B', text: "Use SageMaker Clarify to compute pre-training bias metrics and post-training SHAP (Shapley Additive exPlanations) values to explain feature contributions." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "An Approval Gate Before Production Deployment: Precision Agriculture & Drone Scouting",
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The ML engineering team is requiring a reviewer's approval before any model version can reach production. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Keeping Training Data and Traffic Private: Industrial Robotics Predictive Maintenance",
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The ML engineering team is keeping training data encrypted and job traffic off the public internet under audit. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Enable network isolation on the training job so that the container has no network access, and encrypt the storage volumes with the default key." },
      { id: 'B', text: "Run the training jobs inside a VPC with a NAT gateway for their egress and rely on S3 default encryption using Amazon-managed keys." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Noticing That a Production Model Has Degraded: Educational Remote Proctoring Platform",
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The ML engineering team is detecting that a deployed model's inputs or accuracy have shifted away from training. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Configure SageMaker Model Monitor with a baseline dataset to continuously inspect endpoint requests and detect data drift or model quality degradation." },
      { id: 'B', text: "Configure CloudWatch alarms across the endpoint's invocation count, latency, and error metrics so that any operational problem raises an alert." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "Explaining One Individual Prediction: Real Estate Valuation & Geo-Spatial Analytics",
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The ML engineering team is explaining to a declined applicant which inputs drove their particular decision. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use the model's built-in feature importance scores to report which of the inputs the algorithm relies upon most heavily across the whole of the training dataset." },
      { id: 'B', text: "Use SageMaker Clarify to compute pre-training bias metrics and post-training SHAP (Shapley Additive exPlanations) values to explain feature contributions." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operating, Monitoring, and Securing ML and AI Solutions",
    title: "An Approval Gate Before Production Deployment: Disaster Emergency Dispatch & Operations",
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The ML engineering team is requiring a reviewer's approval before any model version can reach production. The work is scoped to the production environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Tag each SageMaker model resource with its evaluation metrics and an approval tag which the deployment pipeline reads before it will run." },
      { id: 'B', text: "Register models in the SageMaker Model Registry, cataloging metadata, evaluation metrics, approval status ('Approved', 'Rejected'), and lineage." },
