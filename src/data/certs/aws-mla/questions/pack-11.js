export const AWS_MLA_QUESTIONS_11 = [
  {
    id: "aws-mla-251",
    difficulty: "easy",
    certId: "aws-mla",
    domainId: "d2",
    domainName: "ML Model and Foundation Model (FM) Development",
    title: "Finding Good Hyperparameters on a Fixed Budget: High-Frequency FinTech Trading",
    scenario: "A quantitative trading desk requires microsecond secrets delivery, zero packet loss, and deterministic authentication guarantees. The ML engineering team is searching a hyperparameter space efficiently when only a limited number of trials can be afforded. The work is scoped to the development environment.",
  ...
  },
  {
    ...
    scenario: "A national hospital network requires strict cryptographic privacy, auditable access controls, and HIPAA compliance. The ML engineering team is choosing evaluation metrics where positives make up a small fraction of one percent. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      ...
      { id: 'B', text: "Rebalance the training data with SMOTE and then evaluate the model using accuracy measured on the rebalanced holdout set." },
  ...
  },
  {
    ...
    scenario: "An international retail marketplace prepares for 100x traffic surges with zero downtime and instant failover. The ML engineering team is reducing the cost of long training runs that can tolerate being interrupted. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An enterprise cloud SaaS architecture mandates strict logical tenant isolation, data masking, and per-tenant resource quotas. The ML engineering team is searching a hyperparameter space efficiently when only a limited number of trials can be afforded. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A global video streaming service distributes high-bitrate live media with distributed edge caching and tokenized DRM protection. The ML engineering team is choosing evaluation metrics where positives make up a small fraction of one percent. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "An aerospace telemetry platform processes orbital downlinks with fault-tolerant queuing and asynchronous edge processing. The ML engineering team is reducing the cost of long training runs that can tolerate being interrupted. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A national telecom operator manages high-density network slices with automated scaling and sub-millisecond service mesh routing. The ML engineering team is scaling a training job that fits in GPU memory across many GPUs to shorten wall-clock time. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A smart electrical grid platform monitors millions of smart meters with low-latency time-series analysis and automated load shedding. The ML engineering team is searching a hyperparameter space efficiently when only a limited number of trials can be afforded. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A pharmaceutical distribution network tracks temperature-sensitive cargo with cryptographic provenance and automated breach alerts. The ML engineering team is choosing evaluation metrics where positives make up a small fraction of one percent. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Evaluate fraud detection or rare disease models using Precision, Recall, F1-Score, and PR-AUC instead of standard classification accuracy." },
  ...
  },
  {
    ...
    scenario: "A central banking consortium enforces ACID consistency, immutable transaction audit trails, and automated reconciliation. The ML engineering team is reducing the cost of long training runs that can tolerate being interrupted. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Move the training job onto a larger instance type so that it finishes in fewer hours and therefore costs less in total." },
  ...
  },
  {
    ...
    scenario: "A genomics laboratory processes petabyte-scale FASTQ files with distributed batch computing and high-throughput POSIX storage. The ML engineering team is scaling a training job that fits in GPU memory across many GPUs to shorten wall-clock time. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use PyTorch DistributedDataParallel with NCCL across the cluster's network so that the gradients are averaged between the workers each step." },
      { id: 'B', text: "Use the SageMaker Distributed Data Parallel (SMDDP) library to shard training batches across distributed GPU instances with optimized AllReduce communication." },
  ...
  },
  {
    ...
    scenario: "A defense intelligence system enforces continuous mutual TLS authentication, strict least privilege, and non-repudiation. The ML engineering team is searching a hyperparameter space efficiently when only a limited number of trials can be afforded. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Configure SageMaker Autopilot so that the algorithm and its parameters are both selected automatically from the training dataset." },
  ...
  },
  {
    ...
    scenario: "A real-time competitive gaming cluster orchestrates match sessions with regional matchmaking and anti-cheat validation. The ML engineering team is choosing evaluation metrics where positives make up a small fraction of one percent. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Evaluate fraud detection or rare disease models using Precision, Recall, F1-Score, and PR-AUC instead of standard classification accuracy." },
  ...
  },
  {
    ...
    scenario: "An actuarial underwriting platform executes Monte Carlo simulations across millions of policy holder records with parallel workers. The ML engineering team is reducing the cost of long training runs that can tolerate being interrupted. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A metropolitan transit authority optimizes urban traffic signals with real-time video analytics and edge inference. The ML engineering team is searching a hyperparameter space efficiently when only a limited number of trials can be afforded. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Configure SageMaker Autopilot so that the algorithm and its parameters are both selected automatically from the training dataset." },
  ...
  },
  {
    ...
    scenario: "A cross-border passport control gateway validates identity credentials with zero-knowledge cryptographic proofs. The ML engineering team is choosing evaluation metrics where positives make up a small fraction of one percent. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Evaluate fraud detection or rare disease models using Precision, Recall, F1-Score, and PR-AUC instead of standard classification accuracy." },
      { id: 'B', text: "Evaluate the model with ROC-AUC, which is insensitive to the class ratio and is therefore appropriate whenever the positive class is rare." },
  ...
  },
  {
    ...
    scenario: "A global law firm conducts regulatory discovery across millions of scanned legal filings with vector-enhanced semantic retrieval. The ML engineering team is reducing the cost of long training runs that can tolerate being interrupted. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use SageMaker Training Compiler to speed the job up so that fewer instance hours are billed for exactly the same training work." },
      { id: 'B', text: "Enable Managed Spot Training on SageMaker with checkpointing configured to Amazon S3 to save up to 90% on EC2 compute costs." },
  ...
  },
  {
    ...
    scenario: "An advertising exchange processes 500,000 bids per second with a strict 20-millisecond SLA and distributed caching. The ML engineering team is scaling a training job that fits in GPU memory across many GPUs to shorten wall-clock time. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use SageMaker automatic model tuning so that several training jobs execute in parallel across all of the available GPU instances." },
      { id: 'B', text: "Use the SageMaker model parallel library to split the network's layers across the GPUs so that each individual device holds only a portion of the whole model." },
  ...
  },
  {
    ...
    scenario: "An agricultural drone fleet captures multispectral crop imagery with automated computer vision defect classification. The ML engineering team is searching a hyperparameter space efficiently when only a limited number of trials can be afforded. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A semiconductor fabrication facility detects vibration harmonics on manufacturing robots to prevent unplanned downtime. The ML engineering team is choosing evaluation metrics where positives make up a small fraction of one percent. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Evaluate fraud detection or rare disease models using Precision, Recall, F1-Score, and PR-AUC instead of standard classification accuracy." },
      { id: 'B', text: "Rebalance the training data with SMOTE and then evaluate the model using accuracy measured on the rebalanced holdout set." },
  ...
  },
  {
    ...
    scenario: "An online university platform enforces anti-plagiarism and biometric proctoring for high-stakes certification exams. The ML engineering team is reducing the cost of long training runs that can tolerate being interrupted. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Use SageMaker Training Compiler to speed the job up so that fewer instance hours are billed for exactly the same training work." },
  ...
  },
  {
    ...
    scenario: "A property appraisal engine fuses GIS parcel maps with real-time market transactions for automated valuation. The ML engineering team is scaling a training job that fits in GPU memory across many GPUs to shorten wall-clock time. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
  ...
  },
  {
    ...
    scenario: "A municipal 911 emergency response platform guarantees 99.999% uptime with multi-region hot-standby active failover. The ML engineering team is searching a hyperparameter space efficiently when only a limited number of trials can be afforded. The work is scoped to the development environment.",
    question: "Which approach best meets these requirements?",
    options: [
      { id: 'A', text: "Configure SageMaker automatic model tuning with grid search so that every combination within the defined ranges is evaluated exactly once." },
      { id: 'B', text: "Configure SageMaker automatic model tuning with random search so that the parameter space is sampled uniformly right across the trial budget." },
...
export default AWS_MLA_QUESTIONS_11;
