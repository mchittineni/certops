/**
 * DevSecOps Practitioner (DSOP) — exam blueprint.
 *
 ...
 *   4. add content: npm run new:pack -- --cert doi-devsecops-practitioner --kind questions --count 50
 */
export default {
  "id": "doi-devsecops-practitioner",
  ...
  "icon": "devops",
  "color": "#14b8a6",
  "description": "TODO one-sentence description of what DSOP validates.",
  "passingScore": 65,
  "maxScore": 100,
