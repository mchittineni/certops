export const CNCF_CNPA_QUESTIONS_8 = [
  {
    id: "cncf-cnpa-176",
    difficulty: "medium",
    certId: "cncf-cnpa",
  ...
  },
  {
    ...
    title: "Container network interface CNI and storage abstractions CSI: Operational Strategy (Part 177)",
    scenario: "A healthcare telemedicine network is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Container network interface CNI and storage abstractions CSI. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #177.",
  ...
  },
  {
    ...
    title: "Evaluating Platform as a Product and developer experience DevEx: Operational Strategy (Part 178)",
    scenario: "A high-throughput e-commerce retailer is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Evaluating Platform as a Product and developer experience DevEx. The engineering group is implementing automated canary analysis with instant rollback capabilities triggered by error budget burn rates for service tier #178.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Platform Observability and Governance",
    title: "Service level objectives SLOs for core platform services: Operational Strategy (Part 180)",
    scenario: "An algorithmic trading exchange is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Service level objectives SLOs for core platform services. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #180.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Native Architecture and Substrates",
    title: "Kubernetes as an extensible control plane substrate: Operational Strategy (Part 181)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Internal Developer Platforms and Portals",
    title: "Internal Developer Platform IDP architectural components: Operational Strategy (Part 182)",
    scenario: "An IoT industrial telematics infrastructure is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Internal Developer Platform IDP architectural components. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #182.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Golden Paths and Workflows",
    title: "Defining Golden Paths for scaffolding new microservices: Operational Strategy (Part 183)",
    scenario: "A multi-tenant enterprise SaaS provider is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Defining Golden Paths for scaffolding new microservices. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #183.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Platform Observability and Governance",
    title: "Platform adoption and developer onboarding metrics: Operational Strategy (Part 184)",
    scenario: "A public sector aerospace engineering department is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Platform adoption and developer onboarding metrics. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #184.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Native Architecture and Substrates",
    title: "Declarative resource management and reconciliation loops: Operational Strategy (Part 185)",
    scenario: "An automotive connected-vehicle fleet manager is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Declarative resource management and reconciliation loops. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #185.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Internal Developer Platforms and Portals",
    title: "Backstage developer portal catalog and service ownership: Operational Strategy (Part 186)",
    scenario: "A digital media publishing network is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Backstage developer portal catalog and service ownership. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #186.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Golden Paths and Workflows",
    title: "Declarative GitOps application delivery workflows: Operational Strategy (Part 187)",
    scenario: "A pharmaceutical clinical trial data service is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Declarative GitOps application delivery workflows. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #187.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Platform Observability and Governance",
    title: "Resource quota management and fair cluster sharing: Operational Strategy (Part 188)",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Native Architecture and Substrates",
    title: "Custom Resource Definitions CRDs and Operator pattern: Operational Strategy (Part 189)",
    scenario: "A mobile gaming backend architecture is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Custom Resource Definitions CRDs and Operator pattern. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #189.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Internal Developer Platforms and Portals",
    title: "Self-service infrastructure provisioning interfaces: Operational Strategy (Part 190)",
    scenario: "A ride-sharing dispatch system is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Self-service infrastructure provisioning interfaces. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #190.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Golden Paths and Workflows",
    title: "Dynamic ephemeral environments for pull request testing: Operational Strategy (Part 191)",
    scenario: "An insurance claims processing engine is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Dynamic ephemeral environments for pull request testing. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #191.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Platform Observability and Governance",
    title: "Cloud cost transparency and FinOps integration with OpenCost: Operational Strategy (Part 192)",
    scenario: "A commercial airline reservation service is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Cloud cost transparency and FinOps integration with OpenCost. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #192.",
    ...
    options: [
      ...
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'C', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'D', text: "Deploy native automation for cloud cost transparency and finops integration with opencost utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Native Architecture and Substrates",
    title: "Multi-tenant cluster architecture and workload isolation: Operational Strategy (Part 193)",
    scenario: "A cybersecurity threat intelligence agency is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Multi-tenant cluster architecture and workload isolation. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #193.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Internal Developer Platforms and Portals",
    title: "Reducing cognitive load for application engineering teams: Operational Strategy (Part 194)",
    scenario: "A real estate property management portal is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Reducing cognitive load for application engineering teams. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #194.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Golden Paths and Workflows",
    title: "Standardized CI/CD workflow templates and reusable pipelines: Operational Strategy (Part 195)",
    scenario: "An autonomous robotics manufacturing facility is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Standardized CI/CD workflow templates and reusable pipelines. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #195.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Platform Observability and Governance",
    title: "Open Policy Agent and Kyverno policy governance on platforms: Operational Strategy (Part 196)",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Native Architecture and Substrates",
    title: "Container network interface CNI and storage abstractions CSI: Operational Strategy (Part 197)",
    scenario: "A global hotel hospitality reservation platform is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Container network interface CNI and storage abstractions CSI. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #197.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria? (Focus: Container network interface CNI and storage abstractions CSI in Cloud Native Architecture and Substrates)",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Internal Developer Platforms and Portals",
    title: "Evaluating Platform as a Product and developer experience DevEx: Operational Strategy (Part 198)",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Golden Paths and Workflows",
    title: "Policy guardrails embedded into developer self-service workflows: Operational Strategy (Part 199)",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Platform Observability and Governance",
    title: "Service level objectives SLOs for core platform services: Operational Strategy (Part 200)",
    scenario: "A cloud-native telecommunications provider is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Service level objectives SLOs for core platform services. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #200.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability? (Focus: Service level objectives SLOs for core platform services in Platform Observability and Governance)",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
...
export default CNCF_CNPA_QUESTIONS_8;
