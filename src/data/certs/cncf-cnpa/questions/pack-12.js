export const CNCF_CNPA_QUESTIONS_12 = [
  ...
  },
  {
    ...
    question: "Which architectural approach or platform engineering practice satisfies these enterprise IDP objectives?",
    options: [
      { id: 'A', text: "Configure routing using legacy monolithic hardware load balancer consoles manually." },
      { id: 'B', text: "Disable TLS and route all production traffic over unencrypted plaintext HTTP." },
      { id: 'C', text: "Hardcode proprietary routing rules into individual application source code files." },
      { id: 'D', text: "Implement the Kubernetes Gateway API (`Gateway`, `HTTPRoute`) backed by a service mesh such as Istio or Linkerd." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Implement the Kubernetes Gateway API (`Gateway`, `HTTPRoute`) backed by a service mesh such as Istio or Linkerd. The Kubernetes Gateway API provides role-oriented, expressive APIs for L4/L7 routing. When combined with service meshes (Istio, Linkerd), platform substrates deliver transparent mutual TLS (mTLS), fine-grained traffic splitting for canaries, and uniform telemetry.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Implement the Kubernetes Gateway API (`Gateway`, `HTTPRoute`) backed by a service mesh such as Istio or Linkerd." },
  ...
  },
  {
    ...
    question: "Which platform engineering pattern or security mechanism satisfies these mandatory governance controls?",
    options: [
      { id: 'A', text: "Implement the Kubernetes Gateway API (`Gateway`, `HTTPRoute`) backed by a service mesh such as Istio or Linkerd." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Implement the Kubernetes Gateway API (`Gateway`, `HTTPRoute`) backed by a service mesh such as Istio or Linkerd." },
      { id: 'C', text: "Hardcode proprietary routing rules into individual application source code files." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Implement the Kubernetes Gateway API (`Gateway`, `HTTPRoute`) backed by a service mesh such as Istio or Linkerd." },
      { id: 'B', text: "Hardcode proprietary routing rules into individual application source code files." },
      { id: 'C', text: "Disable TLS and route all production traffic over unencrypted plaintext HTTP." },
      { id: 'D', text: "Configure routing using legacy monolithic hardware load balancer consoles manually." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which architectural approach or platform engineering practice satisfies these enterprise IDP objectives?",
    options: [
      { id: 'A', text: "Manually attach physical SATA hard drives to server racks whenever a database pod launches." },
      { id: 'B', text: "Prohibit stateful workloads and store all database records in container memory." },
  ...
  },
  {
    ...
    question: "Which platform engineering pattern or security mechanism satisfies these mandatory governance controls?",
    options: [
      { id: 'A', text: "Deploy production-grade CSI drivers or software-defined cloud-native storage like Rook-Ceph using dynamic `StorageClasses`." },
      { id: 'B', text: "Mount host directories (`hostPath`) directly without permissions or lifecycle management." },
      { id: 'C', text: "Manually attach physical SATA hard drives to server racks whenever a database pod launches." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Store infrastructure state in unencrypted email attachments." },
  ...
  },
  {
    ...
    question: "Which platform substrate pattern or workflow automation handles this delivery scale effectively while preventing infrastructure bottlenecks?",
    options: [
      { id: 'A', text: "Manually provision network subnets through cloud provider web consoles without documentation." },
      { id: 'B', text: "Run imperative CLI commands from developer laptops without version-controlled state locking." },
      { id: 'C', text: "Deploy Kubernetes IaC controllers (like Terraform Operator, Crossplane, or Flux IaC runners) to reconcile infrastructure state continuously." },
      { id: 'D', text: "Store infrastructure state in unencrypted email attachments." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Deploy Kubernetes IaC controllers (like Terraform Operator, Crossplane, or Flux IaC runners) to reconcile infrastructure state continuously. Platform engineering integrates Infrastructure as Code (IaC) into the control plane substrate. By leveraging operators that execute OpenTofu/Terraform or Crossplane within GitOps loops, baseline cloud networking and IAM remain continuously synchronized with Git.",
  ...
  },
  {
    ...
    question: "Which platform feature or DevEx practice empowers application teams to self-serve safely?",
    options: [
      { id: 'A', text: "Run imperative CLI commands from developer laptops without version-controlled state locking." },
      { id: 'B', text: "Store infrastructure state in unencrypted email attachments." },
      { id: 'C', text: "Deploy Kubernetes IaC controllers (like Terraform Operator, Crossplane, or Flux IaC runners) to reconcile infrastructure state continuously." },
      { id: 'D', text: "Manually provision network subnets through cloud provider web consoles without documentation." }
    ],
  ...
  },
  {
    ...
    question: "Which platform feature or DevEx practice empowers application teams to self-serve safely?",
    options: [
      { id: 'A', text: "Print sensitive authentication credentials in container stdout logs during startup." },
      { id: 'B', text: "Hardcode API tokens into application Dockerfiles." },
      { id: 'C', text: "Deploy the External Secrets Operator (ESO) to synchronize credentials dynamically from HashiCorp Vault or AWS Secrets Manager into Kubernetes Secrets." },
