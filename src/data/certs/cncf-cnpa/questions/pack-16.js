export const CNCF_CNPA_QUESTIONS_16 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Centralize pipeline definitions into reusable workflow templates (e.g., GitHub Actions reusable workflows or GitLab CI templates)." },
      ...
      { id: 'D', text: "Instruct developers to run security scans manually on local workstations before committing code." }
    ],
    correctAnswers: ['A'],
    type: "single",
