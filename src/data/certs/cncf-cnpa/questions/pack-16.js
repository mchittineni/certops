export const CNCF_CNPA_QUESTIONS_16 = [
  {
    ...
    options: [
      { id: 'A', text: "Integrate cloud cost visibility tools (such as OpenCost or Kubecost) into the developer portal to display real-time service spend." },
      ...
      { id: 'C', text: "Impose arbitrary compute quota bans without providing any visibility into resource utilization." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hide all cloud billing data from developers and complain about excessive cloud costs at quarterly executive meetings." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Hide all cloud billing data from developers and complain about excessive cloud costs at quarterly executive meetings." },
      { id: 'C', text: "Require developers to calculate cloud server electrical power consumption by hand." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Assume platform engineers inherently know what is best for developers without ever speaking to them." },
      { id: 'C', text: "Cancel all communication channels between platform engineers and product development teams." },
      { id: 'D', text: "Mandate new platform features without testing usability or gathering feedback." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Cancel all communication channels between platform engineers and product development teams." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Establish structured feedback channels including quarterly developer surveys, automated telemetry on tool usage, and office hours. Platform evolution requires continuous feedback loops. Platform teams combine quantitative telemetry (command usage, pipeline duration) with qualitative input (developer satisfaction surveys, office hours) to prioritize the highest-impact platform enhancements.",
  ...
  },
  {
    ...
    question: "Which operational design or observability configuration guarantees resilient, cost-effective platform operation?",
    options: [
      { id: 'A', text: "Assume platform engineers inherently know what is best for developers without ever speaking to them." },
      { id: 'B', text: "Establish structured feedback channels including quarterly developer surveys, automated telemetry on tool usage, and office hours." },
  ...
  },
  {
    ...
    question: "Which architectural approach or platform engineering practice satisfies these enterprise IDP objectives?",
    options: [
      { id: 'A', text: "Force every individual team to invent custom deployment and infrastructure pipelines from scratch." },
      { id: 'B', text: "Ban all open-source frameworks and force developers to write custom web servers." },
      { id: 'C', text: "Provide 'Golden Paths' (paved roads)—well-supported, automated opt-in workflows that make the right architectural choice the easiest choice." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Ban all open-source frameworks and force developers to write custom web servers." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Provide 'Golden Paths' (paved roads)—well-supported, automated opt-in workflows that make the right architectural choice the easiest choice. Golden Paths (or Paved Roads) represent supported, frictionless paths that encode best practices for architecture, CI/CD, and security. Rather than enforcing rigid mandates, platform teams make Golden Paths so smooth and self-service that developers choose them willingly.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy automated software templates that scaffold new repositories with pre-configured Dockerfiles, pipelines, and observability hooks." },
      { id: 'D', text: "Instruct developers to copy obsolete codebases from deprecated repositories on developer laptops." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which platform engineering pattern or security mechanism satisfies these mandatory governance controls?",
    options: [
      { id: 'A', text: "Deploy automated software templates that scaffold new repositories with pre-configured Dockerfiles, pipelines, and observability hooks." },
      { id: 'B', text: "Instruct developers to copy obsolete codebases from deprecated repositories on developer laptops." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Instruct developers to run security scans manually on local workstations before committing code." },
      { id: 'C', text: "Centralize pipeline definitions into reusable workflow templates (e.g., GitHub Actions reusable workflows or GitLab CI templates)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Centralize pipeline definitions into reusable workflow templates (e.g., GitHub Actions reusable workflows or GitLab CI templates)." },
      { id: 'D', text: "Disable security scanning across all repositories to avoid pipeline maintenance." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Centralize pipeline definitions into reusable workflow templates (e.g., GitHub Actions reusable workflows or GitLab CI templates). Modern platforms centralize continuous integration by publishing reusable workflow templates. Repository pipelines simply reference these shared templates, allowing platform teams to update linters, build caches, and security scanners centrally across the entire organization.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Manually open 500 individual pull requests editing duplicated pipeline YAML files by hand." },
      { id: 'D', text: "Centralize pipeline definitions into reusable workflow templates (e.g., GitHub Actions reusable workflows or GitLab CI templates)." }
    ],
    correctAnswers: ['D'],
    type: "single",
