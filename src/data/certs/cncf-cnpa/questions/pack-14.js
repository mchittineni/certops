export const CNCF_CNPA_QUESTIONS_14 = [
  {
    ...
    options: [
      { id: 'A', text: "Implement automated self-service workflows that provision pre-approved cloud resources through platform APIs or portal templates." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Permit developers to manually click through cloud provider root accounts with no audit tracking." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Implement automated self-service workflows that provision pre-approved cloud resources through platform APIs or portal templates. Automated self-service is a primary platform engineering objective. By encapsulating infrastructure creation into audited, pre-approved templates and APIs, developers provision databases and queues autonomously without waiting for manual operational intervention.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Maintain a centralized software catalog that records service ownership, repositories, deployed versions, and operational documentation." },
  ...
  },
  {
    ...
    question: "Which operational design or observability configuration guarantees resilient, cost-effective platform operation?",
    options: [
      { id: 'A', text: "Prohibit documentation of service dependencies to prevent information leakage." },
      { id: 'B', text: "Maintain a centralized software catalog that records service ownership, repositories, deployed versions, and operational documentation." },
      { id: 'C', text: "Rely on word-of-mouth institutional memory and obsolete spreadsheets saved on personal laptops." },
      { id: 'D', text: "Wait for customer complaints before identifying which team created a production service." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Prohibit pre-merge testing in cloud environments." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which platform substrate pattern or workflow automation handles this delivery scale effectively while preventing infrastructure bottlenecks?",
    options: [
      { id: 'A', text: "Require developers to share a single, fragile staging environment where concurrent test runs constantly overwrite each other." },
      { id: 'B', text: "Automate the creation of isolated ephemeral environments for pull requests that automatically terminate upon PR merge or closure." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Duplicate thousands of lines of hardcoded YAML across dozens of environment-specific folders manually." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Hardcode production database IP addresses directly into application source code." },
      { id: 'D', text: "Require developers to write bespoke Terraform scripts for each individual development laptop." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Use a platform orchestrator and developer specification (like Score) to dynamically synthesize environment configurations at deploy time. Platform orchestrators (e.g., Humanitec, Kratix) use workload specifications (like CNCF Score) to dynamically generate infrastructure and deployment manifests at deployment time, matching application requirements to environment-specific infrastructure policies.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Prohibit developers from using terminal command-line interfaces." }
    ],
    correctAnswers: ['A'],
    type: "single",
