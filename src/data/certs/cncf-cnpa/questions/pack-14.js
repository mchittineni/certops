export const CNCF_CNPA_QUESTIONS_14 = [
  {
    id: "cncf-cnpa-326",
    difficulty: "hard",
    certId: "cncf-cnpa",
    ...
    options: [
      ...
      { id: 'C', text: "Permit developers to manually click through cloud provider root accounts with no audit tracking." },
      { id: 'D', text: "Implement automated self-service workflows that provision pre-approved cloud resources through platform APIs or portal templates." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Implement automated self-service workflows that provision pre-approved cloud resources through platform APIs or portal templates." },
      { id: 'D', text: "Prohibit developers from creating any test environments to minimize infrastructure costs." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Implement automated self-service workflows that provision pre-approved cloud resources through platform APIs or portal templates. Automated self-service is a primary platform engineering objective. By encapsulating infrastructure creation into audited, pre-approved templates and APIs, developers provision databases and queues autonomously without waiting for manual operational intervention.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Require three tiers of executive manager signatures on physical paper forms before provisioning test databases." },
      { id: 'D', text: "Implement automated self-service workflows that provision pre-approved cloud resources through platform APIs or portal templates." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Prohibit developers from creating any test environments to minimize infrastructure costs." },
      { id: 'D', text: "Require three tiers of executive manager signatures on physical paper forms before provisioning test databases." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Implement automated self-service workflows that provision pre-approved cloud resources through platform APIs or portal templates. Automated self-service is a primary platform engineering objective. By encapsulating infrastructure creation into audited, pre-approved templates and APIs, developers provision databases and queues autonomously without waiting for manual operational intervention.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Prohibit documentation of service dependencies to prevent information leakage." },
      { id: 'D', text: "Rely on word-of-mouth institutional memory and obsolete spreadsheets saved on personal laptops." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Wait for customer complaints before identifying which team created a production service." },
      { id: 'D', text: "Prohibit documentation of service dependencies to prevent information leakage." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Maintain a centralized software catalog that records service ownership, repositories, deployed versions, and operational documentation. A centralized software catalog is the cornerstone of internal developer platforms. It acts as an authoritative single source of truth for software assets, mapping team ownership, operational dependencies, deployed environments, and monitoring links.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Maintain a centralized software catalog that records service ownership, repositories, deployed versions, and operational documentation." },
      { id: 'D', text: "Rely on word-of-mouth institutional memory and obsolete spreadsheets saved on personal laptops." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Prohibit documentation of service dependencies to prevent information leakage." },
      { id: 'C', text: "Maintain a centralized software catalog that records service ownership, repositories, deployed versions, and operational documentation." },
      { id: 'D', text: "Wait for customer complaints before identifying which team created a production service." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Maintain a centralized software catalog that records service ownership, repositories, deployed versions, and operational documentation. A centralized software catalog is the cornerstone of internal developer platforms. It acts as an authoritative single source of truth for software assets, mapping team ownership, operational dependencies, deployed environments, and monitoring links.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Prohibit pre-merge testing in cloud environments." },
      { id: 'D', text: "Keep all test environments running permanently in production clusters at maximum capacity." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Automate the creation of isolated ephemeral environments for pull requests that automatically terminate upon PR merge or closure." },
      { id: 'D', text: "Require developers to share a single, fragile staging environment where concurrent test runs constantly overwrite each other." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Automate the creation of isolated ephemeral environments for pull requests that automatically terminate upon PR merge or closure. Ephemeral (preview) environments spin up on-demand when a developer opens a pull request, deploying the branch workloads into an isolated namespace with mock or ephemeral dependencies, and tearing down resources automatically when the PR merges.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Require developers to share a single, fragile staging environment where concurrent test runs constantly overwrite each other." },
      { id: 'D', text: "Automate the creation of isolated ephemeral environments for pull requests that automatically terminate upon PR merge or closure." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Automate the creation of isolated ephemeral environments for pull requests that automatically terminate upon PR merge or closure. Ephemeral (preview) environments spin up on-demand when a developer opens a pull request, deploying the branch workloads into an isolated namespace with mock or ephemeral dependencies, and tearing down resources automatically when the PR merges.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Prohibit pre-merge testing in cloud environments." },
      { id: 'B', text: "Require developers to share a single, fragile staging environment where concurrent test runs constantly overwrite each other." },
      { id: 'C', text: "Keep all test environments running permanently in production clusters at maximum capacity." },
      { id: 'D', text: "Automate the creation of isolated ephemeral environments for pull requests that automatically terminate upon PR merge or closure." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Duplicate thousands of lines of hardcoded YAML across dozens of environment-specific folders manually." },
      { id: 'D', text: "Hardcode production database IP addresses directly into application source code." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Duplicate thousands of lines of hardcoded YAML across dozens of environment-specific folders manually." },
      { id: 'D', text: "Use a platform orchestrator and developer specification (like Score) to dynamically synthesize environment configurations at deploy time." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Use a platform orchestrator and developer specification (like Score) to dynamically synthesize environment configurations at deploy time. Platform orchestrators (e.g., Humanitec, Kratix) use workload specifications (like CNCF Score) to dynamically generate infrastructure and deployment manifests at deployment time, matching application requirements to environment-specific infrastructure policies.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Require developers to write bespoke Terraform scripts for each individual development laptop." },
      { id: 'C', text: "Use a platform orchestrator and developer specification (like Score) to dynamically synthesize environment configurations at deploy time." },
      { id: 'D', text: "Duplicate thousands of lines of hardcoded YAML across dozens of environment-specific folders manually." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Use a platform orchestrator and developer specification (like Score) to dynamically synthesize environment configurations at deploy time. Platform orchestrators (e.g., Humanitec, Kratix) use workload specifications (like CNCF Score) to dynamically generate infrastructure and deployment manifests at deployment time, matching application requirements to environment-specific infrastructure policies.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Hardcode production database IP addresses directly into application source code." },
      { id: 'C', text: "Require developers to write bespoke Terraform scripts for each individual development laptop." },
      { id: 'D', text: "Use a platform orchestrator and developer specification (like Score) to dynamically synthesize environment configurations at deploy time." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Instruct developers to log into production Kubernetes nodes directly via SSH." },
      { id: 'D', text: "Distribute a custom internal developer CLI that encapsulates complex multi-step kubectl, cloud, and auth commands into simple verbs." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Distribute a custom internal developer CLI that encapsulates complex multi-step kubectl, cloud, and auth commands into simple verbs." },
      { id: 'D', text: "Instruct developers to log into production Kubernetes nodes directly via SSH." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Distribute a custom internal developer CLI that encapsulates complex multi-step kubectl, cloud, and auth commands into simple verbs. Internal platform CLIs wrap complex underlying tooling (kubectl, helm, vault, aws-cli) into streamlined, team-friendly commands (e.g., `company-cli dev start`, `company-cli logs --service billing`), drastically reducing developer cognitive load.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Require every junior developer to memorize hundreds of intricate kubectl flags and shell pipes." },
      { id: 'D', text: "Distribute a custom internal developer CLI that encapsulates complex multi-step kubectl, cloud, and auth commands into simple verbs." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Require every junior developer to memorize hundreds of intricate kubectl flags and shell pipes." },
      { id: 'C', text: "Prohibit developers from using terminal command-line interfaces." },
      { id: 'D', text: "Instruct developers to log into production Kubernetes nodes directly via SSH." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Prohibit developers from using terminal command-line interfaces." },
      { id: 'C', text: "Instruct developers to log into production Kubernetes nodes directly via SSH." },
      { id: 'D', text: "Require every junior developer to memorize hundreds of intricate kubectl flags and shell pipes." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Distribute a custom internal developer CLI that encapsulates complex multi-step kubectl, cloud, and auth commands into simple verbs. Internal platform CLIs wrap complex underlying tooling (kubectl, helm, vault, aws-cli) into streamlined, team-friendly commands (e.g., `company-cli dev start`, `company-cli logs --service billing`), drastically reducing developer cognitive load.",
...
export default CNCF_CNPA_QUESTIONS_14;
