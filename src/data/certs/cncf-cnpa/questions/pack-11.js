export const CNCF_CNPA_QUESTIONS_11 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Force developers to call proprietary vendor web consoles without any declarative tracking." },
  ...
  },
  {
    ...
    question: "Which architectural approach or platform engineering practice satisfies these enterprise IDP objectives?",
    options: [
      { id: 'A', text: "Require developers to file manual IT support tickets for every test database creation." },
      { id: 'B', text: "Define Crossplane Composite Resource Definitions (XRDs) and Compositions that expose simplified, standardized infrastructure APIs." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Define Crossplane Composite Resource Definitions (XRDs) and Compositions that expose simplified, standardized infrastructure APIs." },
      { id: 'B', text: "Embed raw cloud credentials in application git repositories." },
      { id: 'C', text: "Grant full Cloud Provider root credentials to all application developer workstations." },
      { id: 'D', text: "Require developers to file manual IT support tickets for every test database creation." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Define Crossplane Composite Resource Definitions (XRDs) and Compositions that expose simplified, standardized infrastructure APIs. Crossplane turns Kubernetes clusters into universal infrastructure control planes. Platform teams author Composite Resource Definitions (XRDs) and Compositions, presenting simplified, policy-compliant custom resources (e.g., `CompositePostgreSQLInstance`) to developers.",
  ...
  },
  {
    ...
    question: "Which platform substrate pattern or workflow automation handles this delivery scale effectively while preventing infrastructure bottlenecks?",
    options: [
      { id: 'A', text: "Run all enterprise workloads inside a single giant unsegmented Kubernetes cluster." },
      { id: 'B', text: "Rely on ad-hoc workstation bash scripts that execute unversioned curl commands." },
      { id: 'C', text: "Deploy Cluster API (CAPI) using declarative `Cluster`, `MachineDeployment`, and control plane provider resources." },
      { id: 'D', text: "Manually click through cloud provider web consoles to launch virtual machines and install kubeadm via SSH." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Deploy Cluster API (CAPI) using declarative `Cluster`, `MachineDeployment`, and control plane provider resources. Cluster API (CAPI) is a CNCF subproject that brings declarative, Kubernetes-style APIs to cluster creation, configuration, and management. It uses Custom Resources (`Cluster`, `MachineSet`, `MachineDeployment`) to manage Kubernetes clusters across diverse cloud providers.",
