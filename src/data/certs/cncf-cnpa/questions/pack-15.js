export const CNCF_CNPA_QUESTIONS_15 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Provide pre-configured Dev Containers or cloud development environments (e.g., Gitpod, GitHub Codespaces) with all dependencies pre-installed." },
      ...
      { id: 'C', text: "Require new hires to spend their first month configuring operating system environment variables." },
