export const CNCF_CNPA_QUESTIONS_2 = [
  {
    id: "cncf-cnpa-26",
    difficulty: "medium",
    certId: "cncf-cnpa",
    ...
    title: "Backstage developer portal catalog and service ownership: Operational Strategy (Part 26)",
    scenario: "A multinational fintech banking platform is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Backstage developer portal catalog and service ownership. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #26.",
  ...
  },
  {
    ...
    title: "Declarative GitOps application delivery workflows: Operational Strategy (Part 27)",
  ...
  },
  {
    ...
    title: "Resource quota management and fair cluster sharing: Operational Strategy (Part 28)",
  ...
  },
  {
    ...
    title: "Custom Resource Definitions CRDs and Operator pattern: Operational Strategy (Part 29)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Internal Developer Platforms and Portals",
    title: "Self-service infrastructure provisioning interfaces: Operational Strategy (Part 30)",
    scenario: "An algorithmic trading exchange is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Self-service infrastructure provisioning interfaces. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #30.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Golden Paths and Workflows",
    title: "Dynamic ephemeral environments for pull request testing: Operational Strategy (Part 31)",
    scenario: "A logistics and supply chain optimization service is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Dynamic ephemeral environments for pull request testing. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #31.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Platform Observability and Governance",
    title: "Cloud cost transparency and FinOps integration with OpenCost: Operational Strategy (Part 32)",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Native Architecture and Substrates",
    title: "Multi-tenant cluster architecture and workload isolation: Operational Strategy (Part 33)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Internal Developer Platforms and Portals",
    title: "Reducing cognitive load for application engineering teams: Operational Strategy (Part 34)",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Golden Paths and Workflows",
    title: "Standardized CI/CD workflow templates and reusable pipelines: Operational Strategy (Part 35)",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Platform Observability and Governance",
    title: "Open Policy Agent and Kyverno policy governance on platforms: Operational Strategy (Part 36)",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Native Architecture and Substrates",
    title: "Container network interface CNI and storage abstractions CSI: Operational Strategy (Part 37)",
    scenario: "A pharmaceutical clinical trial data service is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Container network interface CNI and storage abstractions CSI. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #37.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Internal Developer Platforms and Portals",
    title: "Evaluating Platform as a Product and developer experience DevEx: Operational Strategy (Part 38)",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Golden Paths and Workflows",
    title: "Policy guardrails embedded into developer self-service workflows: Operational Strategy (Part 39)",
    scenario: "A mobile gaming backend architecture is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Policy guardrails embedded into developer self-service workflows. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #39.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Platform Observability and Governance",
    title: "Service level objectives SLOs for core platform services: Operational Strategy (Part 40)",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Native Architecture and Substrates",
    title: "Kubernetes as an extensible control plane substrate: Operational Strategy (Part 41)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Internal Developer Platforms and Portals",
    title: "Internal Developer Platform IDP architectural components: Operational Strategy (Part 42)",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Golden Paths and Workflows",
    title: "Defining Golden Paths for scaffolding new microservices: Operational Strategy (Part 43)",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Platform Observability and Governance",
    title: "Platform adoption and developer onboarding metrics: Operational Strategy (Part 44)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Internal Developer Platforms and Portals",
    title: "Backstage developer portal catalog and service ownership: Operational Strategy (Part 46)",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Golden Paths and Workflows",
    title: "Declarative GitOps application delivery workflows: Operational Strategy (Part 47)",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Platform Observability and Governance",
    title: "Resource quota management and fair cluster sharing: Operational Strategy (Part 48)",
    scenario: "A digital payments settlement processor is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Resource quota management and fair cluster sharing. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #48.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead? (Focus: Resource quota management and fair cluster sharing in Platform Observability and Governance)",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Native Architecture and Substrates",
    title: "Custom Resource Definitions CRDs and Operator pattern: Operational Strategy (Part 49)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Internal Developer Platforms and Portals",
    title: "Self-service infrastructure provisioning interfaces: Operational Strategy (Part 50)",
    scenario: "A cloud-native telecommunications provider is evaluating Certified Cloud Native Platform Engineering Associate practices specifically regarding Self-service infrastructure provisioning interfaces. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #50.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability? (Focus: Self-service infrastructure provisioning interfaces in Internal Developer Platforms and Portals)",
    options: [
...
export default CNCF_CNPA_QUESTIONS_2;
