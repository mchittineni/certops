export const GCP_PCDOE_QUESTIONS_13 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Run builds on public Cloud Build default pools and open database ports to 0.0.0.0/0 on the internet." },
      { id: 'C', text: "Download internal databases to public Cloud Storage buckets during every build." },
      { id: 'D', text: "Use unencrypted public internet webhooks to transfer internal source code." }
    ],
    correctAnswers: ['A'],
    type: "single",
