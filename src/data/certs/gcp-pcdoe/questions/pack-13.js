export const GCP_PCDOE_QUESTIONS_13 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Force product engineers to handle all 3:00 AM server crashes without training or monitoring tools." },
      { id: 'C', text: "Assign one SRE to manage 50 disparate legacy applications single-handedly." },
      { id: 'D', text: "Adopt a Consulting / Platform SRE model to provide shared tools, CI/CD templates, and reliability coaching to product teams." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Adopt a Consulting / Platform SRE model to provide shared tools, CI/CD templates, and reliability coaching to product teams. SRE engagement models vary based on organizational maturity and scale. In a Consulting or Platform SRE model, SREs build centralized self-service infrastructure, observability frameworks, and golden deployment paths, empowering software developers to own service reliability autonomously.",
  ...
  },
  {
    ...
    question: "Which architectural approach or configuration satisfies these operational continuity and resilience objectives?",
    options: [
      { id: 'A', text: "Run manual shell scripts sequentially on a personal workstation." },
      { id: 'B', text: "Define build steps in a cloudbuild.yaml file using containerized builder images with built-in substitution variables." },
  ...
  },
  {
    ...
    question: "Which architectural approach or configuration satisfies these operational continuity and resilience objectives?",
    options: [
      { id: 'A', text: "Create a Cloud Build Trigger configured to invoke on pull requests matching the 'main' branch regex." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Poll the GitHub API using a Python while loop running on a Compute Engine instance." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Schedule an hourly cron job that pulls code from GitHub." },
      { id: 'C', text: "Create a Cloud Build Trigger configured to invoke on pull requests matching the 'main' branch regex." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Configure Cloud Build Private Pools with VPC Network Peering to the internal virtual network." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Download internal databases to public Cloud Storage buckets during every build." },
      { id: 'C', text: "Use unencrypted public internet webhooks to transfer internal source code." },
  ...
  },
  {
    ...
    question: "Which design pattern or configuration eliminates operational bottlenecks and ensures service stability?",
    options: [
      { id: 'A', text: "Download internal databases to public Cloud Storage buckets during every build." },
      { id: 'B', text: "Use unencrypted public internet webhooks to transfer internal source code." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Manually edit Kubernetes manifest files directly inside the production cluster using vi." },
      { id: 'D', text: "Deploy software by copying binary files over RDP connections to production servers." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Define a Cloud Deploy delivery pipeline with dev, staging, and production targets, requiring approval on the production stage. Google Cloud Deploy provides opinionated, managed continuous delivery. Delivery pipelines specify the sequence of targets (GKE, Cloud Run, GKE attached clusters). Releases progress from development to staging and production, with built-in rollback capabilities and audit trails.",
