export const GCP_PCDOE_QUESTIONS_17 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Instruct each team lead to manually construct charts and graphs by hand clicking in the Cloud Console." },
      { id: 'B', text: "Define Cloud Monitoring dashboards declaratively using Terraform `google_monitoring_dashboard` resources with version-controlled JSON layouts stored in Git." },
      { id: 'C', text: "Rely exclusively on command-line terminal output without visual dashboard representation." },
      { id: 'D', text: "Take screenshots of monitoring graphs and upload them to a corporate wiki for weekly review." }
    ],
    correctAnswers: ['B'],
  ...
  },
  {
    ...
    question: "Which engineering approach should the DevOps team select to manage this demand reliably without manual intervention?",
    options: [
      { id: 'A', text: "Configure high-priority alerts to write entries into a hidden log file with no notification dispatch." },
      { id: 'B', text: "Configure separate Cloud Monitoring Notification Channels (PagerDuty for critical priority, Slack webhook for warnings) and bind them to respective alert policy severity tiers." },
  ...
  },
  {
    ...
    question: "Which solution implements these mandatory compliance and security controls?",
    options: [
      { id: 'A', text: "Set all alerting policies to broadcast push notifications to every corporate employee's mobile phone." },
      { id: 'B', text: "Configure separate Cloud Monitoring Notification Channels (PagerDuty for critical priority, Slack webhook for warnings) and bind them to respective alert policy severity tiers." },
      { id: 'C', text: "Configure high-priority alerts to write entries into a hidden log file with no notification dispatch." },
      { id: 'D', text: "Direct all alerting policies to a single shared unmonitored team email inbox." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Configure separate Cloud Monitoring Notification Channels (PagerDuty for critical priority, Slack webhook for warnings) and bind them to respective alert policy severity tiers. Cloud Monitoring supports diverse notification channels including email, PagerDuty, Slack, Webhooks, and Pub/Sub. Proper routing links severe, user-impacting alerts to active paging channels (PagerDuty) and lower-priority trend alerts to asynchronous chat channels.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Integrate the Cloud Error Reporting library or format application stack trace logs to comply with Google Cloud structured error formatting standards." },
      { id: 'D', text: "Instruct customers to take photos of error screens and send them via mail to technical support." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Delete all admission controllers from the cluster without examining their webhook execution times." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Attach the Cloud Profiler agent to the application runtime (Java, Go, Node.js, Python) to collect continuous flame graphs of CPU and heap usage." },
      { id: 'B', text: "Inspect static source code in text editors to guess where CPU cycles are being consumed." },
