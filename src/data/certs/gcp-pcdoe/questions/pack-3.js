export const GCP_PCDOE_QUESTIONS_3 = [
  {
    id: "gcp-pcdoe-51",
    difficulty: "easy",
    certId: "gcp-pcdoe",
    ...
    title: "Service Level Indicators SLIs based on latency and errors: Operational Strategy (Part 51)",
  ...
  },
  {
    ...
    title: "Cloud Build pipeline configuration with substitutions and triggers: Operational Strategy (Part 52)",
    scenario: "A healthcare telemedicine network is evaluating Google Cloud Professional Cloud DevOps Engineer practices specifically regarding Cloud Build pipeline configuration with substitutions and triggers. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #52.",
  ...
  },
  {
    ...
    title: "Cloud Monitoring alert policies with multi-window burn rate alerts: Operational Strategy (Part 53)",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Applying site reliability engineering practices",
    title: "Establishing incident commander roles and communication bridges: Operational Strategy (Part 54)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Building and implementing CI/CD pipelines, including continuous testing, for application, infrastructure, and machine learning workloads",
    title: "Binary Authorization attestations in Google Kubernetes Engine: Operational Strategy (Part 55)",
    scenario: "An algorithmic trading exchange is evaluating Google Cloud Professional Cloud DevOps Engineer practices specifically regarding Binary Authorization attestations in Google Kubernetes Engine. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #55.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Applying site reliability engineering practices",
    title: "Defining realistic SLOs and managing error budget consumption: Operational Strategy (Part 56)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Building and implementing CI/CD pipelines, including continuous testing, for application, infrastructure, and machine learning workloads",
    title: "Artifact Registry vulnerability scanning and immutable tags: Operational Strategy (Part 57)",
    scenario: "An IoT industrial telematics infrastructure is evaluating Google Cloud Professional Cloud DevOps Engineer practices specifically regarding Artifact Registry vulnerability scanning and immutable tags. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #57.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Implementing observability practices and troubleshooting issues",
    title: "Cloud Logging log sinks routing logs to BigQuery and Pub/Sub: Operational Strategy (Part 58)",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Implementing observability practices and troubleshooting issues",
    title: "Triaging service disruptions using Monitoring dashboards: Operational Strategy (Part 59)",
    scenario: "A public sector aerospace engineering department is evaluating Google Cloud Professional Cloud DevOps Engineer practices specifically regarding Triaging service disruptions using Monitoring dashboards. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #59.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Building and implementing CI/CD pipelines, including continuous testing, for application, infrastructure, and machine learning workloads",
    title: "IAM least privilege service accounts for Cloud Build steps: Operational Strategy (Part 60)",
    scenario: "An automotive connected-vehicle fleet manager is evaluating Google Cloud Professional Cloud DevOps Engineer practices specifically regarding IAM least privilege service accounts for Cloud Build steps. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #60.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Applying site reliability engineering practices",
    title: "Eliminating engineering toil through automated operational workflows: Operational Strategy (Part 61)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Building and implementing CI/CD pipelines, including continuous testing, for application, infrastructure, and machine learning workloads",
    title: "Google Cloud Deploy delivery pipelines and target environments: Operational Strategy (Part 62)",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Implementing observability practices and troubleshooting issues",
    title: "Cloud Trace distributed tracing across microservices: Operational Strategy (Part 63)",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Applying site reliability engineering practices",
    title: "Implementing circuit breakers and graceful degradation under load: Operational Strategy (Part 64)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Building and implementing CI/CD pipelines, including continuous testing, for application, infrastructure, and machine learning workloads",
    title: "Secret Manager secret storage and automated rotation policies: Operational Strategy (Part 65)",
    scenario: "A ride-sharing dispatch system is evaluating Google Cloud Professional Cloud DevOps Engineer practices specifically regarding Secret Manager secret storage and automated rotation policies. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #65.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Building and implementing CI/CD pipelines, including continuous testing, for application, infrastructure, and machine learning workloads",
    title: "Canary release analysis and progressive traffic shifting: Operational Strategy (Part 66)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Building and implementing CI/CD pipelines, including continuous testing, for application, infrastructure, and machine learning workloads",
    title: "Automated canary rollouts and instant rollback triggers: Operational Strategy (Part 67)",
    scenario: "A commercial airline reservation service is evaluating Google Cloud Professional Cloud DevOps Engineer practices specifically regarding Automated canary rollouts and instant rollback triggers. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #67.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    title: "Cloud Profiler continuous performance optimization in production: Operational Strategy (Part 68)",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Implementing observability practices and troubleshooting issues",
    title: "Root cause analysis using correlated log entries and error reporting: Operational Strategy (Part 69)",
    scenario: "A real estate property management portal is evaluating Google Cloud Professional Cloud DevOps Engineer practices specifically regarding Root cause analysis using correlated log entries and error reporting. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #69.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
  ...
  },
  {
    ...
    title: "VPC Service Controls perimeters protecting sensitive analytics data: Operational Strategy (Part 70)",
    scenario: "An autonomous robotics manufacturing facility is evaluating Google Cloud Professional Cloud DevOps Engineer practices specifically regarding VPC Service Controls perimeters protecting sensitive analytics data. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #70.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Applying site reliability engineering practices",
    title: "Conducting blameless postmortems and tracking action items: Operational Strategy (Part 71)",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Bootstrapping and maintaining a Google Cloud organization",
    title: "Skaffold continuous development workflows for GKE workloads: Operational Strategy (Part 72)",
    scenario: "A global hotel hospitality reservation platform is evaluating Google Cloud Professional Cloud DevOps Engineer practices specifically regarding Skaffold continuous development workflows for GKE workloads. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #72.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Implementing observability practices and troubleshooting issues",
    title: "Cloud Monitoring uptime checks across global geographic locations: Operational Strategy (Part 73)",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Applying site reliability engineering practices",
    title: "Conducting chaos testing and disaster recovery game days: Operational Strategy (Part 74)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Building and implementing CI/CD pipelines, including continuous testing, for application, infrastructure, and machine learning workloads",
    title: "Software supply chain security using SLSA level verification: Operational Strategy (Part 75)",
    scenario: "A cloud-native telecommunications provider is evaluating Google Cloud Professional Cloud DevOps Engineer practices specifically regarding Software supply chain security using SLSA level verification. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #75.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
...
export default GCP_PCDOE_QUESTIONS_3;
