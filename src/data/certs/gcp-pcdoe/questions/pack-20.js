export const GCP_PCDOE_QUESTIONS_20 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Grant public access to all Google Cloud APIs to avoid configuring authentication tokens." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Generate a permanent service account JSON private key file and commit it directly to the repository codebase." },
      { id: 'B', text: "Configure Workload Identity Federation with OpenID Connect (OIDC) between the external CI provider and Google Cloud IAM service accounts." },
      { id: 'C', text: "Grant public access to all Google Cloud APIs to avoid configuring authentication tokens." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Write database passwords on whiteboard walls in the engineering conference room." },
      { id: 'C', text: "Store credentials in Secret Manager and configure Cloud Functions rotation triggers linked to Pub/Sub rotation notifications." },
  ...
  },
  {
    ...
    question: "Which engineering approach should the DevOps team select to manage this demand reliably without manual intervention?",
    options: [
      { id: 'A', text: "Store production secrets in plain environment variables committed to public source control." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Write database passwords on whiteboard walls in the engineering conference room." },
      { id: 'D', text: "Hardcode database credentials in application configuration files and recompile binaries when secrets change." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Store credentials in Secret Manager and configure Cloud Functions rotation triggers linked to Pub/Sub rotation notifications. Secret Manager provides encrypted, centralized storage for API keys, passwords, and certificates. Configuring automated rotation leverages Pub/Sub rotation schedule topics to trigger Cloud Functions that generate new credentials in the target database and update the secret version seamlessly.",
  ...
  },
  {
    ...
    question: "Which architectural approach or configuration satisfies these operational continuity and resilience objectives?",
    options: [
      { id: 'A', text: "Configure Customer-Managed Encryption Keys (CMEK) using Cloud Key Management Service (Cloud KMS) and associate the keys with target Cloud Storage buckets and BigQuery datasets." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Implement custom AES encryption algorithms in Python code and store key files on ephemeral virtual machine disks." },
      { id: 'D', text: "Rely exclusively on default Google-managed keys without retaining cryptographic control." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Configure Customer-Managed Encryption Keys (CMEK) using Cloud Key Management Service (Cloud KMS) and associate the keys with target Cloud Storage buckets and BigQuery datasets. Google Cloud encrypts all customer data at rest by default using Google-managed keys. For regulatory compliance (HIPAA, PCI-DSS, GDPR), Customer-Managed Encryption Keys (CMEK) using Cloud KMS grant customers granular control over key lifecycle, rotation, and instantaneous data revocation by disabling the KMS key.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Configure Customer-Managed Encryption Keys (CMEK) using Cloud Key Management Service (Cloud KMS) and associate the keys with target Cloud Storage buckets and BigQuery datasets." },
      { id: 'D', text: "Disable all encryption at rest to improve disk I/O performance." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Trust all developers to always configure non-privileged security contexts voluntarily." },
      { id: 'B', text: "Disable Kubernetes admission webhooks to prevent validation failures during container deployment." },
      { id: 'C', text: "Deploy Policy Controller on GKE to enforce declarative Open Policy Agent (OPA) Gatekeeper constraint templates across all cluster namespaces." },
      { id: 'D', text: "Manually review pod YAML manifests in production clusters using kubectl get pods once a quarter." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Deploy Policy Controller on GKE to enforce declarative Open Policy Agent (OPA) Gatekeeper constraint templates across all cluster namespaces. Policy Controller on GKE is based on OPA Gatekeeper. It intercepts pod creation requests at the Kubernetes admission phase, evaluating them against declarative constraint templates. Non-compliant configurations (e.g., privileged containers, root users) are rejected pre-runtime.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Manually review pod YAML manifests in production clusters using kubectl get pods once a quarter." },
      { id: 'C', text: "Trust all developers to always configure non-privileged security contexts voluntarily." },
      { id: 'D', text: "Disable Kubernetes admission webhooks to prevent validation failures during container deployment." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Deploy Policy Controller on GKE to enforce declarative Open Policy Agent (OPA) Gatekeeper constraint templates across all cluster namespaces. Policy Controller on GKE is based on OPA Gatekeeper. It intercepts pod creation requests at the Kubernetes admission phase, evaluating them against declarative constraint templates. Non-compliant configurations (e.g., privileged containers, root users) are rejected pre-runtime.",
  ...
  },
  {
    ...
    correctAnswers: ['A'],
    type: "single",
    explanation: "Enable Cloud Audit Logs (Admin Activity, Data Access) across all projects and aggregate them via an organization-level log sink into BigQuery for forensic SQL auditing. Cloud Audit Logs automatically record who did what, where, and when across Google Cloud. Admin Activity logs are retained for 400 days at no charge. Aggregating Admin Activity and Data Access logs via an organization-level sink into BigQuery enables fast SQL forensic analysis and compliance verification.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Delete all log records after 24 hours to prevent compliance auditors from finding discrepancies." },
