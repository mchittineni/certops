export const GCP_PCDOE_QUESTIONS_11 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Define SLI based on the total number of lines of code deployed each sprint." },
      { id: 'D', text: "Assume 100% availability unless more than 1,000 customer complaints are received." }
    ],
    correctAnswers: ['A'],
    type: "single",
