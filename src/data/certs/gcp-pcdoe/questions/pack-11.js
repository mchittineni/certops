export const GCP_PCDOE_QUESTIONS_11 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Define SLI based on the total number of lines of code deployed each sprint." },
  ...
  },
  {
    ...
    question: "Which architectural approach or configuration satisfies these operational continuity and resilience objectives?",
    options: [
      { id: 'A', text: "Continue shipping new features while ignoring error budget alerts." },
      { id: 'B', text: "Fire the developers who wrote code deployed in the first 5 days." },
      { id: 'C', text: "Enforce an Error Budget policy halting non-critical feature deployments and redirecting engineering effort to reliability and bug fixes." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Relax the SLO target from 99.9% to 90% immediately to avoid feature release freezes." },
      { id: 'C', text: "Continue shipping new features while ignoring error budget alerts." },
      { id: 'D', text: "Fire the developers who wrote code deployed in the first 5 days." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Enforce an Error Budget policy halting non-critical feature deployments and redirecting engineering effort to reliability and bug fixes. An Error Budget represents 100% minus the SLO. When an error budget is depleted rapidly, a pre-agreed Error Budget Policy dictates consequences—such as freezing feature releases and redirecting sprint engineering resources toward automated testing, hardening, and resilience.",
  ...
  },
  {
    ...
    question: "Which engineering approach should the DevOps team select to manage this demand reliably without manual intervention?",
    options: [
      { id: 'A', text: "Require engineers to work overtime on weekends to process manual ticket backlogs." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Identify toil and automate repetitive tasks using software engineering (e.g. Cloud Functions, Terraform, and Cloud Workflows) to keep toil under 50%." },
      { id: 'B', text: "Hire more manual system administrators to process operational tickets by hand." },
      { id: 'C', text: "Require engineers to work overtime on weekends to process manual ticket backlogs." },
      { id: 'D', text: "Outsource manual server reboot procedures to a low-cost third-party helpdesk." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Identify toil and automate repetitive tasks using software engineering (e.g. Cloud Functions, Terraform, and Cloud Workflows) to keep toil under 50%. In Google SRE, 'toil' is operational work that is manual, repetitive, automatable, tactical, lacks enduring value, and scales linearly with service growth. Google mandates that SRE teams spend at least 50% of their time on engineering projects to systematically eliminate toil.",
  ...
  },
  {
    ...
    question: "Which design pattern or configuration eliminates operational bottlenecks and ensures service stability?",
    options: [
      { id: 'A', text: "Hide the incident documentation from company leadership to protect team reputation." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure client applications to retry failed requests immediately in an infinite loop." },
      { id: 'C', text: "Deploy 50 additional web servers to queue incoming HTTP requests indefinitely." },
      { id: 'D', text: "Increase client HTTP timeout settings to 10 minutes to ensure every request finishes." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which engineering approach should the DevOps team select to manage this demand reliably without manual intervention?",
    options: [
      { id: 'A', text: "Deploy 50 additional web servers to queue incoming HTTP requests indefinitely." },
      { id: 'B', text: "Configure client applications to retry failed requests immediately in an infinite loop." },
