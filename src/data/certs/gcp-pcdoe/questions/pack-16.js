export const GCP_PCDOE_QUESTIONS_16 = [
  {
    ...
    correctAnswers: ['A'],
    type: "single",
    explanation: "Configure Cloud Monitoring Uptime Checks originating from diverse global regions to query service endpoints and validate HTTP status codes and response content. Cloud Monitoring Uptime Checks test public endpoints from multiple regions around the world at a configured interval (every 1, 5, 10, or 15 minutes). They verify reachability, response time, and payload content from an external perspective, alerting teams to regional routing or CDN failures.",
