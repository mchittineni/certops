export const GCP_PCDOE_QUESTIONS_14 = [
  ...
  },
  {
    ...
    question: "Which architectural approach or configuration satisfies these operational continuity and resilience objectives?",
    options: [
      { id: 'A', text: "Deploy the candidate service version and configure an Istio / Cloud Service Mesh VirtualService with a 95/5 traffic weight split." },
    ...
    correctAnswers: ['A'],
    type: "single",
    explanation: "Deploy the candidate service version and configure an Istio / Cloud Service Mesh VirtualService with a 95/5 traffic weight split. Canary deployments with a service mesh (Istio/Cloud Service Mesh) use dynamic Layer 7 traffic routing rules (VirtualService) to route precise percentages of live requests to the canary deployment based on weights or HTTP headers, enabling safe validation without altering pod counts.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy the candidate service version and configure an Istio / Cloud Service Mesh VirtualService with a 95/5 traffic weight split." },
      { id: 'C', text: "Instruct 5% of users via email to type a special beta URL in their browsers." },
  ...
  },
  {
    ...
    question: "Which design pattern or configuration eliminates operational bottlenecks and ensures service stability?",
    options: [
      { id: 'A', text: "Delete the Kubernetes Deployment object and recreate it from scratch." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Wait for external security researchers to report vulnerabilities." },
  ...
  },
  {
    ...
    question: "Which design pattern or configuration eliminates operational bottlenecks and ensures service stability?",
    options: [
      { id: 'A', text: "Manually inspect installed software packages inside each container filesystem." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable Kubernetes admission controllers in the cluster settings." },
      { id: 'B', text: "Restrict cluster access by changing the cluster root password daily." },
      { id: 'C', text: "Rely on developers promising not to deploy untrusted container images." },
      { id: 'D', text: "Configure Binary Authorization requiring an attestor whose public key verifies Cloud KMS signatures generated during build." }
    ],
    correctAnswers: ['D'],
    type: "single",
