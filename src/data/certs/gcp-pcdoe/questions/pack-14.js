export const GCP_PCDOE_QUESTIONS_14 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy new code directly over existing running processes and reboot all servers." },
      { id: 'C', text: "Shut down the website for 4 hours while software is updated manually." },
      { id: 'D', text: "Replace the production servers in-place during peak business hours." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Shut down the website for 4 hours while software is updated manually." },
      { id: 'B', text: "Deploy new code directly over existing running processes and reboot all servers." },
      { id: 'C', text: "Replace the production servers in-place during peak business hours." },
      { id: 'D', text: "Implement a Blue/Green deployment: spin up the new version (Green) alongside the current version (Blue) and switch load balancer target pools." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Implement a Blue/Green deployment: spin up the new version (Green) alongside the current version (Blue) and switch load balancer target pools. Blue/Green deployments run two identical production environments. The 'Blue' environment serves live production traffic, while the 'Green' environment hosts the new release. Once Green is validated, traffic is shifted instantly via the load balancer, enabling immediate rollback if needed.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Replace the production servers in-place during peak business hours." },
      { id: 'B', text: "Implement a Blue/Green deployment: spin up the new version (Green) alongside the current version (Blue) and switch load balancer target pools." },
      { id: 'C', text: "Shut down the website for 4 hours while software is updated manually." },
      { id: 'D', text: "Deploy new code directly over existing running processes and reboot all servers." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Implement a Blue/Green deployment: spin up the new version (Green) alongside the current version (Blue) and switch load balancer target pools. Blue/Green deployments run two identical production environments. The 'Blue' environment serves live production traffic, while the 'Green' environment hosts the new release. Once Green is validated, traffic is shifted instantly via the load balancer, enabling immediate rollback if needed.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Replace the production servers in-place during peak business hours." },
      { id: 'B', text: "Shut down the website for 4 hours while software is updated manually." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure DNS A records with 5% weight on public internet DNS resolvers." },
      { id: 'C', text: "Deploy 100 candidate pods and 5 old pods without service mesh traffic routing." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure DNS A records with 5% weight on public internet DNS resolvers." },
      { id: 'B', text: "Instruct 5% of users via email to type a special beta URL in their browsers." },
      { id: 'C', text: "Deploy 100 candidate pods and 5 old pods without service mesh traffic routing." },
      { id: 'D', text: "Deploy the candidate service version and configure an Istio / Anthos Service Mesh VirtualService with a 95/5 traffic weight split." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Deploy the candidate service version and configure an Istio / Anthos Service Mesh VirtualService with a 95/5 traffic weight split. Canary deployments with a service mesh (Istio/ASM) use dynamic Layer 7 traffic routing rules (VirtualService) to route precise percentages of live requests to the canary deployment based on weights or HTTP headers, enabling safe validation without altering pod counts.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Instruct 5% of users via email to type a special beta URL in their browsers." },
      { id: 'B', text: "Configure DNS A records with 5% weight on public internet DNS resolvers." },
      { id: 'C', text: "Deploy the candidate service version and configure an Istio / Anthos Service Mesh VirtualService with a 95/5 traffic weight split." },
      { id: 'D', text: "Deploy 100 candidate pods and 5 old pods without service mesh traffic routing." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Deploy the candidate service version and configure an Istio / Anthos Service Mesh VirtualService with a 95/5 traffic weight split. Canary deployments with a service mesh (Istio/ASM) use dynamic Layer 7 traffic routing rules (VirtualService) to route precise percentages of live requests to the canary deployment based on weights or HTTP headers, enabling safe validation without altering pod counts.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy 100 candidate pods and 5 old pods without service mesh traffic routing." },
      { id: 'B', text: "Configure DNS A records with 5% weight on public internet DNS resolvers." },
      { id: 'C', text: "Deploy the candidate service version and configure an Istio / Anthos Service Mesh VirtualService with a 95/5 traffic weight split." },
      { id: 'D', text: "Instruct 5% of users via email to type a special beta URL in their browsers." }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Instruct 5% of users via email to type a special beta URL in their browsers." },
      { id: 'C', text: "Deploy 100 candidate pods and 5 old pods without service mesh traffic routing." },
      { id: 'D', text: "Configure DNS A records with 5% weight on public internet DNS resolvers." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Deploy the candidate service version and configure an Istio / Anthos Service Mesh VirtualService with a 95/5 traffic weight split. Canary deployments with a service mesh (Istio/ASM) use dynamic Layer 7 traffic routing rules (VirtualService) to route precise percentages of live requests to the canary deployment based on weights or HTTP headers, enabling safe validation without altering pod counts.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Manually restart worker node VMs one by one." },
      ...
      { id: 'D', text: "Configure the Deployment spec with strategy: RollingUpdate, maxUnavailable: 2, and maxSurge: 4." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Manually restart worker node VMs one by one." },
      { id: 'C', text: "Delete the Kubernetes Deployment object and recreate it from scratch." },
      { id: 'D', text: "Configure strategy: Recreate, terminating all 20 pods simultaneously before starting new pods." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Configure the Deployment spec with strategy: RollingUpdate, maxUnavailable: 2, and maxSurge: 4. In Kubernetes, the `RollingUpdate` strategy updates pods in a gradual, rolling fashion. The `maxSurge` parameter specifies how many extra pods can be created over the desired replica count, while `maxUnavailable` specifies the maximum number of pods that can be unavailable during the update.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure strategy: Recreate, terminating all 20 pods simultaneously before starting new pods." },
      { id: 'B', text: "Configure the Deployment spec with strategy: RollingUpdate, maxUnavailable: 2, and maxSurge: 4." },
      { id: 'C', text: "Manually restart worker node VMs one by one." },
      { id: 'D', text: "Delete the Kubernetes Deployment object and recreate it from scratch." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Configure the Deployment spec with strategy: RollingUpdate, maxUnavailable: 2, and maxSurge: 4. In Kubernetes, the `RollingUpdate` strategy updates pods in a gradual, rolling fashion. The `maxSurge` parameter specifies how many extra pods can be created over the desired replica count, while `maxUnavailable` specifies the maximum number of pods that can be unavailable during the update.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure the Deployment spec with strategy: RollingUpdate, maxUnavailable: 2, and maxSurge: 4." },
      { id: 'B', text: "Manually restart worker node VMs one by one." },
      { id: 'C', text: "Configure strategy: Recreate, terminating all 20 pods simultaneously before starting new pods." },
      { id: 'D', text: "Delete the Kubernetes Deployment object and recreate it from scratch." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure strategy: Recreate, terminating all 20 pods simultaneously before starting new pods." },
      { id: 'B', text: "Delete the Kubernetes Deployment object and recreate it from scratch." },
      { id: 'C', text: "Configure the Deployment spec with strategy: RollingUpdate, maxUnavailable: 2, and maxSurge: 4." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Wait for external security researchers to report vulnerabilities." },
      { id: 'B', text: "Enable Automated Vulnerability Scanning on Artifact Registry repositories in Google Cloud." },
      { id: 'C', text: "Disable container base image updates to avoid changing package dependencies." },
      { id: 'D', text: "Manually inspect installed software packages inside each container filesystem." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable container base image updates to avoid changing package dependencies." },
      ...
      { id: 'D', text: "Enable Automated Vulnerability Scanning on Artifact Registry repositories in Google Cloud." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Enable Automated Vulnerability Scanning on Artifact Registry repositories in Google Cloud. Artifact Registry integrates with Google Cloud's Container Scanning service. When enabled, every container image pushed to the registry is automatically scanned against known CVE vulnerability databases, generating vulnerability reports and triggering alerts for critical package flaws.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Wait for external security researchers to report vulnerabilities." },
      { id: 'B', text: "Disable container base image updates to avoid changing package dependencies." },
      { id: 'C', text: "Enable Automated Vulnerability Scanning on Artifact Registry repositories in Google Cloud." },
      { id: 'D', text: "Manually inspect installed software packages inside each container filesystem." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable container base image updates to avoid changing package dependencies." },
      { id: 'C', text: "Manually inspect installed software packages inside each container filesystem." },
      { id: 'D', text: "Wait for external security researchers to report vulnerabilities." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Enable Automated Vulnerability Scanning on Artifact Registry repositories in Google Cloud. Artifact Registry integrates with Google Cloud's Container Scanning service. When enabled, every container image pushed to the registry is automatically scanned against known CVE vulnerability databases, generating vulnerability reports and triggering alerts for critical package flaws.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Wait for external security researchers to report vulnerabilities." },
      { id: 'B', text: "Manually inspect installed software packages inside each container filesystem." },
      { id: 'C', text: "Disable container base image updates to avoid changing package dependencies." },
      { id: 'D', text: "Enable Automated Vulnerability Scanning on Artifact Registry repositories in Google Cloud." }
    ],
    correctAnswers: ['D'],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Restrict cluster access by changing the cluster root password daily." },
      { id: 'B', text: "Rely on developers promising not to deploy untrusted container images." },
      { id: 'C', text: "Disable Kubernetes admission controllers in the cluster settings." },
      { id: 'D', text: "Configure Binary Authorization requiring an attestor whose public key verifies Cloud KMS signatures generated during build." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable Kubernetes admission controllers in the cluster settings." },
      { id: 'C', text: "Restrict cluster access by changing the cluster root password daily." },
      { id: 'D', text: "Rely on developers promising not to deploy untrusted container images." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Configure Binary Authorization requiring an attestor whose public key verifies Cloud KMS signatures generated during build. Binary Authorization integrates with Cloud Build and Cloud KMS. After automated security checks pass, Cloud Build signs the container image digest using a Cloud KMS key to create an attestation. GKE's admission controller verifies this cryptographic signature before allowing pod deployment.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable Kubernetes admission controllers in the cluster settings." },
      { id: 'B', text: "Rely on developers promising not to deploy untrusted container images." },
      { id: 'C', text: "Configure Binary Authorization requiring an attestor whose public key verifies Cloud KMS signatures generated during build." },
      { id: 'D', text: "Restrict cluster access by changing the cluster root password daily." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Configure Binary Authorization requiring an attestor whose public key verifies Cloud KMS signatures generated during build. Binary Authorization integrates with Cloud Build and Cloud KMS. After automated security checks pass, Cloud Build signs the container image digest using a Cloud KMS key to create an attestation. GKE's admission controller verifies this cryptographic signature before allowing pod deployment.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Restrict cluster access by changing the cluster root password daily." },
      { id: 'B', text: "Configure Binary Authorization requiring an attestor whose public key verifies Cloud KMS signatures generated during build." },
      { id: 'C', text: "Disable Kubernetes admission controllers in the cluster settings." },
      { id: 'D', text: "Rely on developers promising not to deploy untrusted container images." }
    ],
    correctAnswers: ['B'],
