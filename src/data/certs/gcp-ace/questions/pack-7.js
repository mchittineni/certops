export const GCP_ACE_QUESTIONS_7 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Set --concurrency=1 so each container handles one task" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Require authentication and have Scheduler call it with an OIDC token." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "requests guarantee the baseline, limits cap the maximum" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A multi-region uptime check with an alerting policy and notification channels." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "An aggregated sink for all audit logs into a locked Archive-class bucket." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Create a disk from the snapshot and swap it in as the boot disk." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A maintenance exclusion for those ten days" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The process exceeded its memory limit and the kernel OOM-killed it" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "An aggregated log sink at the organization level, into BigQuery" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A Cloud Logging exclusion for severity<=INFO" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A log-based counter metric with an alerting policy on it" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Restoring overwrites the instance and loses everything since the backup." }
    ],
    correctAnswers: ['D'],
    type: "single",
