export const GCP_ACE_QUESTIONS_7 = [
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable Node Auto-Repair on the GKE node pool"
      },
      {
        "id": "B",
        "text": "Enable Horizontal Pod Autoscaler"
      },
      {
        "id": "C",
        "text": "Deploy a custom daemonset that restarts the kubelet every 5 minutes"
      },
      {
        "id": "D",
        "text": "Configure Node Auto-Upgrade with a 24-hour maintenance window"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Reduce concurrency using '--concurrency=1' (or a low value like 2-5) so each container processes only one transcoding task at a time"
      },
      {
        "id": "B",
        "text": "Increase concurrency to 1,000 to process more videos in parallel"
      },
      {
        "id": "C",
        "text": "Deploy Cloud Run behind an Internal Network Load Balancer"
      },
      {
        "id": "D",
        "text": "Set CPU allocation to request-based"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable Object Versioning on the Cloud Storage bucket"
      },
      {
        "id": "B",
        "text": "Enable Bucket Lock with compliance mode"
      },
      {
        "id": "C",
        "text": "Switch the storage class to Coldline Storage"
      },
      {
        "id": "D",
        "text": "Apply a VPC firewall rule blocking HTTP DELETE requests"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Deploy Cloud Run with '--no-allow-unauthenticated', and configure Cloud Scheduler to invoke the service using an OIDC token signed by a dedicated service account granted 'roles/run.invoker'"
      },
      {
        "id": "B",
        "text": "Deploy Cloud Run with '--allow-unauthenticated' and check IP headers in application code"
      },
      {
        "id": "C",
        "text": "Deploy Cloud Run inside an unmanaged Compute Engine instance"
      },
      {
        "id": "D",
        "text": "Protect the Cloud Run service with a basic HTTP username and password in metadata"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "bq mk --table --time_partitioning_type=DAY [DATASET].[TABLE]"
      },
      {
        "id": "B",
        "text": "bq mk --table --partition_by=date [DATASET].[TABLE]"
      },
      {
        "id": "C",
        "text": "bq query --create_partitioned_table [DATASET].[TABLE]"
      },
      {
        "id": "D",
        "text": "gcloud bigquery tables create [TABLE] --partition=daily"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Define 'resources.requests' to guarantee baseline capacity, and define 'resources.limits' to hard-cap maximum CPU and memory consumption for each container"
      },
      {
        "id": "B",
        "text": "Set PodDisruptionBudget to minAvailable: 1"
      },
      {
        "id": "C",
        "text": "Enable Vertical Pod Autoscaler in auto mode"
      },
      {
        "id": "D",
        "text": "Assign each container its own dedicated network interface"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "gcloud sql instances create [REPLICA_NAME] --master-instance-name=[PRIMARY_NAME] --region=europe-west1"
      },
      {
        "id": "B",
        "text": "gcloud sql instances clone [PRIMARY_NAME] [REPLICA_NAME] --region=europe-west1"
      },
      {
        "id": "C",
        "text": "gcloud sql instances replicate [PRIMARY_NAME] --to-region=europe-west1"
      },
      {
        "id": "D",
        "text": "gcloud compute instances create [REPLICA_NAME] --sql-master=[PRIMARY_NAME]"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Google Cloud Deploy"
      },
      {
        "id": "B",
        "text": "Cloud Build with custom inline shell scripts"
      },
      {
        "id": "C",
        "text": "Artifact Registry automated deployment hooks"
      },
      {
        "id": "D",
        "text": "Cloud Scheduler invoking Compute Engine startup scripts"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a Cloud Monitoring Uptime Check targeting the public URL from multiple geographic regions, and attach an Alerting Policy configured with email and PagerDuty notification channels"
      },
      {
        "id": "B",
        "text": "Write a bash script that curls the website from an internal VM and writes to a text file"
      },
      {
        "id": "C",
        "text": "Configure a Compute Engine health check and set the autohealing threshold to 3 minutes"
      },
      {
        "id": "D",
        "text": "Configure Cloud Trace to sample 100% of incoming HTTP requests and alert on latency"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Increase the retention period of the _Default and _Required log buckets in Cloud Logging to 2,555 days"
      },
      {
        "id": "B",
        "text": "Stream all logs to a Cloud Pub/Sub topic with message retention set to 7 years"
      },
      {
        "id": "C",
        "text": "Export logs daily to a BigQuery table with a 30-day partition expiration policy"
      },
      {
        "id": "D",
        "text": "Create an aggregated log sink in Cloud Logging with a filter matching all audit logs, routing to a Cloud Storage bucket configured with Archive storage class and an object retention lock"
      }
    ],
    "correctAnswers": [
      "D"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "gcloud compute instances get-serial-port-output [INSTANCE_NAME] --zone=[ZONE]"
      },
      {
        "id": "B",
        "text": "gcloud compute instances tail-logs [INSTANCE_NAME]"
      },
      {
        "id": "C",
        "text": "gcloud logging read 'resource.type=gce_instance AND logName=console'"
      },
      {
        "id": "D",
        "text": "gcloud compute ssh [INSTANCE_NAME] --troubleshoot"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a new persistent disk from snapshot 'boot-snap-safe', stop the VM, detach the corrupted boot disk, attach the new disk as the boot disk, and start the VM"
      },
      {
        "id": "B",
        "text": "Run 'gcloud compute disks restore' to overwrite the running boot disk in place"
      },
      {
        "id": "C",
        "text": "Delete the entire VPC network and redeploy from Cloud Shell"
      },
      {
        "id": "D",
        "text": "Execute 'gcloud compute instances reset' with the '--snapshot' flag"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Perform a Stop operation followed by a Start operation on the instance"
      },
      {
        "id": "B",
        "text": "Perform an instance Reset operation"
      },
      {
        "id": "C",
        "text": "Execute 'sudo reboot' from inside the guest Linux operating system"
      },
      {
        "id": "D",
        "text": "Change the network tags on the instance"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "When the instance is stopped or terminated by the user"
      },
      {
        "id": "B",
        "text": "During standard Google Cloud live migration events"
      },
      {
        "id": "C",
        "text": "When the guest operating system is rebooted using 'sudo reboot'"
      },
      {
        "id": "D",
        "text": "When new firewall rules are applied to the VPC network"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Blue/Green node pool upgrade"
      },
      {
        "id": "B",
        "text": "Surge node pool upgrade"
      },
      {
        "id": "C",
        "text": "Immediate in-place node drain without surge"
      },
      {
        "id": "D",
        "text": "Manual node-by-node kubelet package upgrade via SSH"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Configure a Maintenance Exclusion for the cluster covering the 10-day date range"
      },
      {
        "id": "B",
        "text": "Disable the GKE cluster autoscaler"
      },
      {
        "id": "C",
        "text": "Remove all IAM permissions from Google Cloud Support"
      },
      {
        "id": "D",
        "text": "Convert the cluster from Regional to Zonal"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "B",
        "text": "kubectl rollout restart deployment/frontend-app"
      },
      {
        "id": "C",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Install the Google Cloud Ops Agent on each VM instance"
      },
      {
        "id": "B",
        "text": "Upgrade the instances to Memory-Optimized machine types"
      },
      {
        "id": "C",
        "text": "Enable VPC Flow Logs on the subnet"
      },
      {
        "id": "D",
        "text": "Assign the 'roles/monitoring.admin' role to the VM's service account"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "The container process exceeded its configured memory limit in the pod specification and was terminated by the Linux kernel Out-Of-Memory killer"
      },
      {
        "id": "B",
        "text": "The node running the pod lost network connectivity to the master control plane"
      },
      {
        "id": "C",
        "text": "The container's liveness probe failed 3 consecutive times"
      },
      {
        "id": "D",
        "text": "The container was evicted due to an invalid CPU request"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "resource.type=\"gce_instance\" AND resource.labels.zone=~\"^us-east1\" AND severity>=ERROR AND textPayload=~\"timeout\""
      },
      {
        "id": "B",
        "text": "logName=\"projects/gce\" AND severity=FAILED AND message=\"timeout\""
      },
      {
        "id": "C",
        "text": "compute.instances.list --filter=\"status:ERROR AND timeout\""
      },
      {
        "id": "D",
        "text": "SELECT * FROM logs WHERE type='vm' AND error='timeout'"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create an aggregated Log Sink at the Organization level configured with a destination of BigQuery"
      },
      {
        "id": "B",
        "text": "Write a script that exports logs to Cloud Storage and runs daily bq load jobs"
      },
      {
        "id": "C",
        "text": "Stream logs to a Compute Engine instance running an ELK stack"
      },
      {
        "id": "D",
        "text": "Configure Cloud Monitoring uptime checks with webhook notifications"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a Log Exclusion in Cloud Logging with a filter matching 'severity<=INFO'"
      },
      {
        "id": "B",
        "text": "Delete the Cloud Logging API from the project"
      },
      {
        "id": "C",
        "text": "Set the retention period on the '_Default' log bucket to 1 day"
      },
      {
        "id": "D",
        "text": "Configure an alert policy with notification channels disabled"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a Log-Based Counter Metric in Cloud Logging matching the failure log filter, and build an Alerting Policy based on that metric"
      },
      {
        "id": "B",
        "text": "Install a custom cron script on the VMs that scrapes logs every 5 minutes"
      },
      {
        "id": "C",
        "text": "Deploy Cloud Trace with distributed context propagation"
      },
      {
        "id": "D",
        "text": "Create a Cloud SQL read replica dedicated to audit logging"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Restoring a backup into the existing instance permanently overwrites and destroys all current database tables and transactions created since the backup"
      },
      {
        "id": "B",
        "text": "The backup will fail because Cloud SQL does not allow restoring into the same region"
      },
      {
        "id": "C",
        "text": "The instance will be converted to an unmanaged Compute Engine VM"
      },
      {
        "id": "D",
        "text": "Google Cloud charges a 50% restoration fee on the database storage size"
      }
    ],
    "correctAnswers": [
      "A"
