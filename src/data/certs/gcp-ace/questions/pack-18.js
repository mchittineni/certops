export const GCP_ACE_QUESTIONS_18 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Manually click 'Create Snapshot' on every disk in the console each night." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Manually click 'Create Snapshot' on every disk in the console each night." },
      { id: 'D', text: "Create a Snapshot Schedule in Compute Engine and attach it to the persistent disks." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Create a Snapshot Schedule in Compute Engine and attach it to the persistent disks. Snapshot schedules in Compute Engine automate the creation and retention of point-in-time persistent disk backups. Snapshots are incremental, compressed, and stored across multiple zones or regions, enabling rapid point-in-time recovery.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Shut down all production servers every night to export virtual machine images." },
      { id: 'C', text: "Write an in-guest script that copies all files to a secondary local folder." },
      { id: 'D', text: "Create a Snapshot Schedule in Compute Engine and attach it to the persistent disks." }
    ],
    correctAnswers: ['D'],
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Manually run 'kubectl scale deployment' whenever response times slow down." },
      { id: 'B', text: "Deploy 100 oversized virtual machine nodes permanently to ensure capacity is never exceeded." },
      { id: 'C', text: "A Horizontal Pod Autoscaler plus the GKE cluster autoscaler on the pool." },
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Restart the Kubernetes cluster every 6 hours to clear memory." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Manually run 'kubectl scale deployment' whenever response times slow down." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Configure the Horizontal Pod Autoscaler (HPA) for application deployments and enable the GKE Cluster Autoscaler on the node pool. The Horizontal Pod Autoscaler (HPA) scales the number of pod replicas based on observed CPU/memory utilization or custom metrics. When pending pods cannot be scheduled due to insufficient node resources, the GKE Cluster Autoscaler automatically provisions additional worker nodes.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Configure an Object Lifecycle Management rule on the Cloud Storage bucket with Age conditions." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Write a custom python script scheduled on a VM to check object timestamps daily." },
      { id: 'D', text: "Download all objects to an on-premises disk after 90 days." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Attach an HTTP Health Check to the Managed Instance Group with an autohealing policy." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Configure a ping probe against the VM network interface." },
      { id: 'D', text: "Rely on operations engineers to manually reboot frozen virtual machines." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Attach an HTTP Health Check to the Managed Instance Group with an autohealing policy. Compute Engine auto-healing in Managed Instance Groups uses application-level health checks (HTTP, HTTPS, or TCP). If an application fails health check probes for the configured threshold, the MIG automatically stops, deletes, and recreates the VM instance to restore service availability.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Restore from last Sunday's full database export file." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Point-in-time recovery from backups and write-ahead logs." },
