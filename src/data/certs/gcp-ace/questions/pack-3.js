export const GCP_ACE_QUESTIONS_3 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Coldline Storage" },
      { id: 'C', text: "Archive Storage" },
      { id: 'D', text: "Standard Storage" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud SQL for PostgreSQL" },
      { id: 'B', text: "Cloud Bigtable" },
      { id: 'C', text: "Firebase Realtime Database" },
      { id: 'D', text: "Cloud Storage Standard bucket" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable Cloud Run concurrency by setting '--concurrency=1'" },
      { id: 'B', text: "Set --min-instances=5 for warm starts and --max-instances=30 as a cap." },
      { id: 'C', text: "Increase container memory to 32 GiB and set CPU allocation to 'always allocated'" },
      { id: 'D', text: "Deploy Cloud Run into a multi-region Managed Instance Group with unmanaged health checks" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Compute Engine Managed Instance Group running container-optimized OS" },
      { id: 'B', text: "GKE Autopilot" },
      { id: 'C', text: "GKE Standard with node auto-upgrade and auto-repair" },
      { id: 'D', text: "Anthos Service Mesh standalone" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Custom Machine Types with Committed Use Discounts" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Cloud Storage Autoclass" },
      { id: 'C', text: "Cloud Storage Object Lifecycle Management rules with SetStorageClass" },
      { id: 'D', text: "Cloud Storage Object Versioning" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable Object Versioning and configure an IAM deny rule for storage.objects.delete" },
      { id: 'B', text: "Create a Customer-Managed Encryption Key (CMEK) and destroy the key" },
      { id: 'C', text: "Assign the 'roles/storage.objectViewer' role to the Organization Administrator" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Enable HA to provision a synchronous standby in another zone" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Sequential keys hotspot the tail split; use a UUID or bit-reversed key." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Row keys sort lexicographically, so timestamps hotspot one tablet." },
      { id: 'C', text: "Timestamps exceed Bigtable's 4 KB row key length limit" },
      { id: 'D', text: "Cloud Bigtable requires row keys to be strictly generated by Cloud Spanner" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Export the table to Cloud Storage as uncompressed CSV files" },
      { id: 'B', text: "Partition the table by 'order_date' and cluster the table by 'store_id'" },
      { id: 'C', text: "Cluster the table by 'order_date' and create a view filtering by store_id" },
      { id: 'D', text: "Upgrade to BigQuery flat-rate reservation slots" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Auto mode uses fixed 10.128.0.0/9 ranges; custom mode lets you choose." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Peering is non-transitive, so A cannot reach C via B" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It will fail because peering forbids overlapping CIDR ranges" },
      { id: 'B', text: "Google Cloud will automatically re-number the subnets in Team 2's network" },
      { id: 'C', text: "The peering will succeed, and packets will be routed based on longest prefix match" },
      { id: 'D', text: "Traffic will be routed through Cloud NAT automatically" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud NAT deployed with dual redundant IP addresses" },
      { id: 'B', text: "HA VPN with two interfaces to dual peer gateways, routed by BGP" },
      { id: 'C', text: "Classic VPN configured with static routing and policy-based tunnels" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "HA VPN over the public internet" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy a custom Squid proxy on a single public VM with no health checks" },
      { id: 'B', text: "Enable Identity-Aware Proxy (IAP) TCP forwarding" },
      { id: 'C', text: "Deploy Cloud NAT on the Cloud Router associated with the VPC subnet" },
      { id: 'D', text: "Assign ephemeral external IP addresses to all instances and apply an egress firewall rule" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create a DENY rule for port 22 from 0.0.0.0/0 with priority 500, and an ALLOW rule for 10.10.1.0/24 with priority 1000" },
      { id: 'B', text: "Allow 22 from 10.10.1.0/24 at priority 1000 and deny 22 from anywhere at 2000." },
      { id: 'C', text: "Rely on the implicit default deny ingress rule at priority 65535" },
      { id: 'D', text: "Create a single bidirectional rule with priority 0" }
    ],
    correctAnswers: ['B'],
    type: "single",
