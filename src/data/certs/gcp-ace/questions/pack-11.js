export const GCP_ACE_QUESTIONS_11 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create separate unlinked Google Cloud organizations for every developer." },
      { id: 'B', text: "Establish a resource hierarchy with an Organization node, structured department Folders, and scoped Projects." },
      { id: 'C', text: "Deploy all company workloads into a single flat project without folders." },
      { id: 'D', text: "Manage cloud infrastructure using independent personal Gmail accounts without an organization node." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Deploy all company workloads into a single flat project without folders." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Establish a resource hierarchy with an Organization node, structured department Folders, and scoped Projects. The Google Cloud resource hierarchy consists of Organization, Folders, Projects, and Resources. Policies and IAM role bindings configured at higher parent nodes (Organization or Folder) automatically inherit down to child projects and resources, enabling centralized governance.",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Disable billing on production projects to prevent accidental overages." },
      ...
      { id: 'D', text: "Enter individual physical credit cards separately into every project." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Set compute engine quota limits to zero when estimated costs exceed expectations." },
      { id: 'C', text: "A budget with 50%, 90% and 100% thresholds to email and Pub/Sub." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Create named gcloud configurations and activate the one you need." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Reinstall the entire Google Cloud SDK every time a project context change is needed." },
      { id: 'C', text: "Download a service account key and point GOOGLE_APPLICATION_CREDENTIALS at it." },
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Download a service account key and point GOOGLE_APPLICATION_CREDENTIALS at it." },
      ...
      { id: 'D', text: "Reinstall the entire Google Cloud SDK every time a project context change is needed." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Create named gcloud configurations using 'gcloud config configurations create' and activate them with 'gcloud config configurations activate'. The `gcloud` CLI supports multiple named configurations (profiles) that store project IDs, compute zones, and authenticated accounts. Administrators switch between environments using `gcloud config configurations activate [NAME]` without re-authenticating.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create named gcloud configurations and activate the one you need." },
      { id: 'B', text: "Download a service account key and point GOOGLE_APPLICATION_CREDENTIALS at it." },
      { id: 'C', text: "Use only the Cloud Console web interface to avoid configuring local CLI profiles." },
      { id: 'D', text: "Reinstall the entire Google Cloud SDK every time a project context change is needed." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Deploy Google Cloud Directory Sync (GCDS) on-premises to sync users and groups to Cloud Identity." },
