export const GCP_ACE_QUESTIONS_11 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Disable billing on production projects to prevent accidental overages." },
      { id: 'D', text: "Rely on quarterly paper invoices sent by mail without automated data export." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Hardcode OAuth access tokens in local shell startup scripts." },
