export const GCP_ACE_QUESTIONS_5 = [
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Store the script in a private Cloud Storage bucket, grant the VM service account 'roles/storage.objectViewer' on the bucket, and create instances with '--metadata-from-file startup-script-url=gs://[BUCKET]/startup.sh'"
      },
      {
        "id": "B",
        "text": "Embed the entire script base64-encoded into the '--metadata startup-script' flag"
      },
      {
        "id": "C",
        "text": "Commit the script to a public GitHub repository and curl it from the command line inside the VM"
      },
      {
        "id": "D",
        "text": "Log into each VM via SSH immediately after launch and execute the script manually"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Increase the 'initial delay' (cooldown period) on the autohealing health check to at least 300 seconds"
      },
      {
        "id": "B",
        "text": "Disable the health check and rely solely on VM host status"
      },
      {
        "id": "C",
        "text": "Change the machine type to an instance family with faster single-core performance"
      },
      {
        "id": "D",
        "text": "Increase the MIG target size to double the current instance count"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Set 'maxUnavailable' to 0 and 'maxSurge' to at least 1 (or 25%)"
      },
      {
        "id": "B",
        "text": "Set 'maxUnavailable' to 100% and 'maxSurge' to 0"
      },
      {
        "id": "C",
        "text": "Delete the existing instance group and recreate it with the new template"
      },
      {
        "id": "D",
        "text": "Perform a rolling restart with proactive replacement set to false"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Stateful Managed Instance Groups (Stateful MIGs)"
      },
      {
        "id": "B",
        "text": "Stateless Managed Instance Groups with regional persistent disks"
      },
      {
        "id": "C",
        "text": "Unmanaged Instance Groups with round-robin DNS"
      },
      {
        "id": "D",
        "text": "Compute Engine Autoscaling with predictive scaling enabled"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Stop the source VM instance before running 'gcloud compute images create'"
      },
      {
        "id": "B",
        "text": "Delete all log files in /var/log while the VM is running"
      },
      {
        "id": "C",
        "text": "Resize the persistent disk to its minimum allowable size"
      },
      {
        "id": "D",
        "text": "Convert the persistent disk to a local SSD"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Assign each new monthly image to an 'Image Family', and configure instance templates to reference the image family name rather than a specific image name"
      },
      {
        "id": "B",
        "text": "Overwrite the existing image in-place using 'gcloud compute images update'"
      },
      {
        "id": "C",
        "text": "Create a symbolic link in Cloud Storage pointing to the latest raw disk file"
      },
      {
        "id": "D",
        "text": "Delete old images and recreate new images using the identical image name"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Device names (/dev/sdb) are not deterministic across reboots; the mount entry in /etc/fstab should use the disk's filesystem UUID and include the 'nofail' mount option"
      },
      {
        "id": "B",
        "text": "Persistent disks must always be formatted with XFS rather than ext4"
      },
      {
        "id": "C",
        "text": "Secondary disks must be attached to the SATA bus rather than SCSI"
      },
      {
        "id": "D",
        "text": "The disk was not marked as a boot disk in the VM metadata"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Resize the disk using 'gcloud compute disks resize' and then run 'resize2fs' (or 'xfs_growfs') on the VM operating system"
      },
      {
        "id": "B",
        "text": "Stop the instance, resize the disk in the console, and restart the VM"
      },
      {
        "id": "C",
        "text": "Create a snapshot, create a new 500 GB disk from the snapshot, and swap disks"
      },
      {
        "id": "D",
        "text": "Attach a second disk and run 'mkfs' across both disks"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "gcloud compute instances create-with-container nginx-vm --container-image=gcr.io/cloud-marketplace/google/nginx"
      },
      {
        "id": "B",
        "text": "gcloud compute instances create nginx-vm --metadata=docker-run=nginx"
      },
      {
        "id": "C",
        "text": "gcloud run deploy nginx-vm --image=nginx --platform=gce"
      },
      {
        "id": "D",
        "text": "gcloud container clusters create nginx-vm --single-node"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "--enable-private-nodes --master-ipv4-cidr=172.16.0.0/28 --enable-master-authorized-networks"
      },
      {
        "id": "B",
        "text": "--no-assign-external-ip --isolated-nodes"
      },
      {
        "id": "C",
        "text": "--private-cluster --disable-public-endpoint"
      },
      {
        "id": "D",
        "text": "--network-mode=internal-only"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a dedicated Node Pool configured with GPU accelerators and Kubernetes taints, and add corresponding tolerations and nodeSelectors to the ML deployment manifests"
      },
      {
        "id": "B",
        "text": "Deploy two separate VPC networks and connect them with Cloud Router"
      },
      {
        "id": "C",
        "text": "Assign higher Linux 'nice' values to web container processes"
      },
      {
        "id": "D",
        "text": "Run web pods on GKE and ML training jobs on Cloud Functions"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable Cluster Autoscaler on the GKE node pool with minimum and maximum node counts"
      },
      {
        "id": "B",
        "text": "Enable Vertical Pod Autoscaler (VPA) in recommendation mode"
      },
      {
        "id": "C",
        "text": "Deploy a Managed Instance Group autoscaler pointing to the Kubernetes master"
      },
      {
        "id": "D",
        "text": "Configure Node Auto-Repair with an aggressive probe interval"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "gcloud container clusters get-credentials [CLUSTER_NAME] --region=[REGION]"
      },
      {
        "id": "B",
        "text": "kubectl config set-cluster [CLUSTER_NAME] --server=google"
      },
      {
        "id": "C",
      ...
      {
        "id": "D",
        "text": "gcloud compute ssh [CLUSTER_NAME]-master"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Define a 'BackendConfig' Custom Resource specifying the Cloud Armor policy and health check path, and reference the BackendConfig in an annotation on the Kubernetes Service"
      },
      {
        "id": "B",
        "text": "Configure Cloud Armor rules manually in the Cloud Console on the generated target proxy"
      },
      {
        "id": "C",
        "text": "Modify the /etc/nginx/nginx.conf file inside the container image"
      },
      {
        "id": "D",
        "text": "Create a FrontendConfig resource pointing to the Cloud Armor security policy"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "gcloud run services update-traffic auth-service --to-revisions=auth-v2=10,auth-v1=90"
      },
      {
        "id": "B",
        "text": "gcloud run deploy auth-service --traffic-split=10/90"
      },
      {
        "id": "C",
        "text": "Configure an External Application Load Balancer with weighted backend instance groups"
      },
      {
        "id": "D",
        "text": "Deploy two separate Cloud Run services and update Cloud DNS records with weighted values"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Store the password in Google Secret Manager, grant the Cloud Run service account 'roles/secretmanager.secretAccessor', and deploy with '--set-secrets=DB_PASSWORD=projects/[PROJECT]/secrets/db-pass:latest'"
      },
      {
        "id": "B",
        "text": "Store the password in a text file in a public Cloud Storage bucket"
      },
      {
        "id": "C",
        "text": "Embed the password in the container entrypoint shell script"
      },
      {
        "id": "D",
        "text": "Hardcode the password in Cloud KMS and decrypt it during application build"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "gcloud functions deploy thumbnail-generator --runtime=python311 --trigger-bucket=raw-images --entry-point=process_image"
      },
      {
        "id": "B",
        "text": "gcloud run deploy thumbnail-generator --trigger-gcs=raw-images"
      },
      {
        "id": "C",
        "text": "gcloud storage buckets add-notification raw-images --function=thumbnail-generator"
      },
      {
        "id": "D",
        "text": "gcloud compute instances create thumbnail-generator --metadata=gcs-trigger=raw-images"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Allocate a dedicated RFC 1918 IP address range in the VPC and establish a Private Services Access connection peering the VPC with servicenetworking.googleapis.com"
      },
      {
        "id": "B",
        "text": "Deploy Cloud NAT with a static external IP address in each zone"
      },
      {
        "id": "C",
        "text": "Configure an HA VPN tunnel to Google's internal network"
      },
      {
        "id": "D",
        "text": "Create an SSL certificate in Cloud KMS and upload it to the VPC route table"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Cloud SQL Auth Proxy"
      },
      {
        "id": "B",
        "text": "Identity-Aware Proxy (IAP) TCP forwarding"
      },
      {
        "id": "C",
        "text": "Cloud NAT port forwarding"
      },
      {
        "id": "D",
        "text": "SSH local port tunneling via a bastion host"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable Uniform Bucket-Level Access on the bucket"
      },
      {
        "id": "B",
        "text": "Enable Object Versioning and lock the retention policy"
      },
      {
        "id": "C",
        "text": "Delete all object metadata using a lifecycle policy"
      },
      {
        "id": "D",
        "text": "Switch the bucket storage class from Standard to Archive"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Define an Object Lifecycle Management JSON configuration with a rule setting storageClass to 'COLDLINE' at age 30 and an action 'Delete' at age 365, and apply it via 'gcloud storage buckets update'"
      },
      {
        "id": "B",
        "text": "Write a Cloud Function scheduled via Cloud Scheduler to scan the bucket daily and delete old files"
      },
      {
        "id": "C",
        "text": "Configure Bucket Lock with a 365-day retention policy"
      },
      {
        "id": "D",
        "text": "Enable Turbo Replication between Coldline and Archive buckets"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "bq load --source_format=CSV --autodetect ecommerce.daily_sales gs://company-imports/transactions.csv.gz"
      },
      {
        "id": "B",
        "text": "bq query --destination_table=ecommerce.daily_sales 'SELECT * FROM gs://company-imports/transactions.csv.gz'"
      },
      {
        "id": "C",
        "text": "gcloud storage cp gs://company-imports/transactions.csv.gz bigquery://ecommerce/daily_sales"
      },
      {
        "id": "D",
        "text": "bq extract ecommerce.daily_sales gs://company-imports/transactions.csv.gz"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "B",
        "text": "Attach a public IP address to the default internet gateway"
      },
      {
        "id": "C",
        "text": "Create an ingress firewall rule permitting traffic from Google APIs"
      },
      {
        "id": "D",
        "text": "Deploy Cloud NAT with static IP addresses"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "gcloud compute firewall-rules create allow-web --network=custom-vpc --allow=tcp:80,tcp:443 --source-ranges=0.0.0.0/0 --target-tags=frontend-web"
      },
      {
        "id": "B",
        "text": "gcloud compute firewall-rules create allow-web --network=custom-vpc --allow=tcp:80,tcp:443 --source-ranges=frontend-web"
      },
      {
        "id": "C",
        "text": "gcloud compute instances add-tags backend-db --tags=allow-web"
      },
      {
        "id": "D",
        "text": "gcloud compute networks subnets update custom-vpc --allow-public-ports=80,443"
      }
    ],
    "correctAnswers": [
      "A"
