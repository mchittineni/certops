export const GCP_ACE_QUESTIONS_8 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "A deny maintenance period over the peak dates" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Enable firewall rules logging and read the logs" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Bigtable cluster autoscaling with node bounds and a CPU target." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "NAT port exhaustion; add NAT IPs and raise ports per VM" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Set the maximum_bytes_billed parameter on queries and sessions" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Align the latency metric to the 95th or 99th percentile" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Read the cluster-autoscaler-status ConfigMap" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Data skew shuffling all rows to one worker" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Taint the GPU nodes and tolerate it only on ML pods" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable parallel composite uploads in the gcloud config" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Set the maintenance window to Sunday 02:00-06:00 UTC" },
