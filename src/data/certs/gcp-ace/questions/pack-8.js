export const GCP_ACE_QUESTIONS_8 = [
  {
    ...
    certId: "gcp-ace",
    domainId: "d3",
    domainName: "Ensuring the successful operation of a cloud solution",
    ...
    options: [
      { id: 'A', text: "A deny maintenance period over the peak dates" },
      { id: 'B', text: "Switch the database storage engine from InnoDB to MyISAM" },
      { id: 'C', text: "Disable the primary database network interface" },
      { id: 'D', text: "Assign the database service account an expired OAuth token" }
    ],
    correctAnswers: ['A'],
    type: "single",
    ...
    tags: ["CloudSQL","Maintenance","HighAvailability"]
  },
  {
    id: "gcp-ace-177",
    difficulty: "hard",
    ...
    options: [
      ...
      { id: 'B', text: "Deploy an Envoy sidecar proxy on every Compute Engine VM" },
      { id: 'C', text: "Enable firewall rules logging and read the logs" },
      { id: 'D', text: "Enable VPC Network Peering route export logging" }
    ],
    correctAnswers: ['C'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["VPC","FirewallLogging","Security"]
  },
  {
    id: "gcp-ace-178",
    difficulty: "medium",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudTrace","Microservices","Observability"]
  },
  {
    id: "gcp-ace-179",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "Cloud Debugger legacy agent" },
      { id: 'B', text: "Cloud Security Command Center" },
      { id: 'C', text: "Cloud Profiler" },
      { id: 'D', text: "Cloud Monitoring Metric Explorer" }
    ],
    correctAnswers: ['C'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudProfiler","Performance","Observability"]
  },
  {
    id: "gcp-ace-180",
    difficulty: "easy",
    ...
    options: [
      { id: 'A', text: "kubectl taint node gke-prod-pool-1234 app=stop:NoExecute" },
      { id: 'B', text: "kubectl scale node gke-prod-pool-1234 --replicas=0" },
      { id: 'C', text: "kubectl delete node gke-prod-pool-1234 --force" },
      { id: 'D', text: "kubectl cordon gke-prod-pool-1234 && kubectl drain gke-prod-pool-1234 --ignore-daemonsets --delete-emptydir-data" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["GKE","kubectl","NodeMaintenance"]
  },
  {
    id: "gcp-ace-181",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "Deploy a Kubernetes Horizontal Pod Autoscaler pointing to the Bigtable API" },
      { id: 'B', text: "Bigtable cluster autoscaling with node bounds and a CPU target." },
      { id: 'C', text: "Switch the storage type from SSD to HDD" },
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudBigtable","Autoscaling","Operations"]
  },
  {
    id: "gcp-ace-182",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "Cloud Router BGP sessions have dropped" },
      { id: 'B', text: "The instances lack the roles/compute.networkUser permission" },
      { id: 'C', text: "NAT port exhaustion; add NAT IPs and raise ports per VM" },
      { id: 'D', text: "The VPC firewall is blocking outbound port 443" }
    ],
    correctAnswers: ['C'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudNAT","PortExhaustion","Networking"]
  },
  {
    id: "gcp-ace-183",
    difficulty: "hard",
    ...
    options: [
      { id: 'A', text: "gcloud compute images update golden-ubuntu-v1 --no-access" },
      { id: 'B', text: "gcloud compute images delete golden-ubuntu-v1 --quiet" },
      { id: 'C', text: "gcloud storage rm gs://images/golden-ubuntu-v1.tar.gz" },
      { id: 'D', text: "gcloud compute images deprecate golden-ubuntu-v1 --state=DEPRECATED --replacement=golden-ubuntu-v3" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["ComputeEngine","CustomImages","Governance"]
  },
  {
    id: "gcp-ace-184",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "Set the maximum_bytes_billed parameter on queries and sessions" },
      { id: 'B', text: "Set a Cloud Storage object retention lock on the dataset" },
      { id: 'C', text: "Restrict data scientists to the 'roles/bigquery.jobUser' role only" },
      { id: 'D', text: "Schedule BigQuery queries exclusively during weekend maintenance windows" }
    ],
    correctAnswers: ['A'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["BigQuery","CostControls","FinOps"]
  },
  {
    id: "gcp-ace-185",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "Increase the dashboard refresh rate to 1 second" },
      { id: 'B', text: "Filter the metric by VM CPU utilization" },
      { id: 'C', text: "Create a log-based metric counting total HTTP 200 responses" },
      { id: 'D', text: "Align the latency metric to the 95th or 99th percentile" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudMonitoring","MetricExplorer","SRE"]
  },
  {
    id: "gcp-ace-186",
    difficulty: "easy",
    ...
    options: [
      ...
      { id: 'B', text: "gcloud sql instances clone [REPLICA_NAME] [NEW_PRIMARY]" },
      { id: 'C', text: "gcloud sql instances promote-replica [REPLICA_NAME]" },
      { id: 'D', text: "gcloud sql instances failover [PRIMARY_NAME]" }
    ],
    correctAnswers: ['C'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudSQL","DisasterRecovery","ReadReplicas"]
  },
  {
    id: "gcp-ace-187",
    difficulty: "medium",
    ...
    options: [
      ...
      { id: 'D', text: "Read the cluster-autoscaler-status ConfigMap" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["GKE","ClusterAutoscaler","Troubleshooting"]
  },
  {
    id: "gcp-ace-188",
    difficulty: "medium",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudStorage","rsync","Automation"]
  },
  {
    id: "gcp-ace-189",
    difficulty: "hard",
    ...
    options: [
      { id: 'A', text: "gcloud storage objects update gs://compliance-vault/2023-audit.tar.gz --storage-class=COLDLINE" },
      { id: 'B', text: "gcloud storage buckets update gs://compliance-vault --default-storage-class=COLDLINE" },
      ...
      { id: 'D', text: "gsutil setmeta -h \"Content-Type: coldline\" gs://compliance-vault/2023-audit.tar.gz" }
    ],
    correctAnswers: ['A'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudStorage","StorageClasses","DataManagement"]
  },
  {
    id: "gcp-ace-190",
    difficulty: "medium",
    ...
    options: [
      ...
      { id: 'C', text: "Data skew shuffling all rows to one worker" },
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["BigQuery","QueryOptimization","DataSkew"]
  },
  {
    id: "gcp-ace-191",
    difficulty: "medium",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["LoadBalancing","HealthChecks","Troubleshooting"]
  },
  {
    id: "gcp-ace-192",
    difficulty: "easy",
    ...
    options: [
      ...
      { id: 'C', text: "A gcloud dns record-sets transaction: start, add, then execute." },
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudDNS","Transactions","Networking"]
  },
  {
    id: "gcp-ace-193",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "gcloud compute instance-groups managed rolling-action replace [MIG_NAME]" },
      { id: 'B', text: "gcloud compute instance-groups managed resize [MIG_NAME] --size=0" },
      { id: 'C', text: "gcloud compute instances reset $(gcloud compute instances list --format='value(name)')" },
      { id: 'D', text: "gcloud compute instance-groups managed rolling-action restart [MIG_NAME] --max-unavailable=25%" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["ComputeEngine","MIG","RollingRestart"]
  },
  {
    id: "gcp-ace-194",
    difficulty: "medium",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudSQL","DatabaseAdministration","Security"]
  },
  {
    id: "gcp-ace-195",
    difficulty: "hard",
    ...
    options: [
      { id: 'A', text: "Deploy a VPC firewall rule blocking port 80 to GPU nodes" },
      { id: 'B', text: "Set the CPU limit on general web pods to 100m" },
      { id: 'C', text: "Convert the GPU node pool to an unmanaged instance group" },
      { id: 'D', text: "Taint the GPU nodes and tolerate it only on ML pods" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["GKE","TaintsTolerations","Kubernetes"]
  },
  {
    id: "gcp-ace-196",
    difficulty: "medium",
    ...
    options: [
      ...
      { id: 'B', text: "kubectl describe cluster" },
      { id: 'C', text: "gcloud compute instances list --show-metrics" },
      { id: 'D', text: "kubectl top nodes and kubectl top pods" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl describe node to view logs, and ssh order-processor-xyz to access files" },
      { id: 'B', text: "kubectl logs to see output, then kubectl exec -it for a shell inside" },
      { id: 'C', text: "kubectl attach to reboot the pod, and kubectl edit deployment to view logs" },
      { id: 'D', text: "gcloud logging read to view files, and kubectl port-forward to edit config" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Enable parallel composite uploads in the gcloud config" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudStorage","ParallelUploads","Performance"]
  },
  {
    id: "gcp-ace-199",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "Cloud Trace waterfall analysis" },
      { id: 'B', text: "VPC Flow Logs sampling" },
      { id: 'C', text: "Cloud Profiler latency traces" },
      { id: 'D', text: "Cloud Monitoring Uptime Checks" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudMonitoring","UptimeChecks","Reliability"]
  },
  {
    id: "gcp-ace-200",
    difficulty: "medium",
    ...
    options: [
      ...
      { id: 'D', text: "Set the maintenance window to Sunday 02:00-06:00 UTC" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://cloud.google.com/docs",
    tags: ["CloudSQL","MaintenanceWindow","Administration"]
  }
];
