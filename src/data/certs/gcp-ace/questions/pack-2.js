export const GCP_ACE_QUESTIONS_2 = [
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a custom user-managed service account, grant it 'roles/storage.objectViewer' on the specific bucket, and update the VM instances to run under the new service account"
      },
      {
        "id": "B",
        "text": "Edit the default service account's role at the project level to Viewer"
      },
      {
        "id": "C",
        "text": "Disable the default service account in the Cloud Console"
      },
      {
        "id": "D",
        "text": "Enable Cloud Storage Object Versioning on the bucket"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Submit an allocation quota increase request for GPUs in the IAM & Admin > Quotas console and provide business justification"
      },
      {
        "id": "B",
        "text": "Run 'gcloud compute instances create' repeatedly with exponential backoff until capacity becomes available"
      },
      {
        "id": "C",
        "text": "Upgrade the Cloud Billing account from credit card billing to invoiced billing"
      },
      {
        "id": "D",
        "text": "Switch machine types from a2-highgpu-1g to e2-standard-4"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "roles/resourcemanager.projectCreator bound directly to the 'Frontend' folder"
      },
      {
        "id": "B",
        "text": "roles/resourcemanager.organizationAdmin bound at the organization root"
      },
      {
        "id": "C",
        "text": "roles/owner bound to each existing project in the Frontend folder"
      },
      {
        "id": "D",
        "text": "roles/resourcemanager.folderAdmin bound at the organization root"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "roles/billing.viewer on the billing account"
      },
      {
        "id": "B",
        "text": "roles/billing.admin on the billing account"
      },
      {
        "id": "C",
        "text": "roles/billing.user on the billing account"
      },
      {
        "id": "D",
        "text": "roles/viewer on all projects"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Cloud Shell provisions a persistent 5 GB $HOME directory backed by network storage that is preserved across sessions, while the root filesystem container is ephemeral"
      },
      {
        "id": "B",
        "text": "Cloud Shell is completely stateless; all files in $HOME are deleted when the session disconnects"
      },
      {
        "id": "C",
        "text": "Files must be manually committed to Google Cloud Source Repositories before closing the browser"
      },
      {
        "id": "D",
        "text": "Persistent storage requires attaching a dedicated Cloud SQL instance to the Cloud Shell VM"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enforce the constraint 'constraints/compute.skipDefaultNetworkCreation' at the organization root"
      },
      {
        "id": "B",
        "text": "Deploy a Cloud Function that executes 'gcloud compute networks delete default' every hour"
      },
      {
        "id": "C",
        "text": "Block port 22 in all subnet firewall rules"
      },
      {
        "id": "D",
        "text": "Revoke Compute Network Admin from project creators"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "gcloud config set compute/region us-east1 && gcloud config set compute/zone us-east1-b"
      },
      {
        "id": "B",
        "text": "gcloud default set region=us-east1 zone=us-east1-b"
      },
      {
        "id": "C",
        "text": "export GOOGLE_COMPUTE_REGION=us-east1 GOOGLE_COMPUTE_ZONE=us-east1-b"
      },
      {
        "id": "D",
        "text": "gcloud compute set-default --region=us-east1 --zone=us-east1-b"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a Custom IAM Role at the project or organization level containing only the specific required permissions (e.g., compute.instances.get, compute.instances.list), and grant this custom role to the vendor"
      },
      {
        "id": "B",
        "text": "Grant the vendor the primitive Viewer role and instruct them not to click on network settings"
      },
      {
        "id": "C",
        "text": "Download an administrative service account JSON key and provide it to the vendor"
      },
      {
        "id": "D",
        "text": "Add the vendor to the default Compute Engine service account"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Cloud Audit Logs - Admin Activity audit logs"
      },
      {
        "id": "B",
        "text": "Cloud Audit Logs - Data Access audit logs"
      },
      {
        "id": "C",
        "text": "VPC Flow Logs"
      ...
      {
        "id": "D",
        "text": "Compute Engine serial port console logs"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Grant the 'roles/bigquery.dataViewer' role to the data scientist directly on the 'marketing_analytics' dataset resource in BigQuery, and grant 'roles/bigquery.jobUser' at the project level to allow running query jobs"
      },
      {
        "id": "B",
        "text": "Grant 'roles/bigquery.dataViewer' and 'roles/bigquery.jobUser' at the project level"
      },
      {
        "id": "C",
        "text": "Assign the primitive Viewer role at the project level"
      },
      {
        "id": "D",
        "text": "Export the BigQuery dataset to CSV files in a public Cloud Storage bucket"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Cloud Billing Budget API (google_billing_budget resource in Terraform)"
      },
      {
        "id": "B",
        "text": "Cloud Resource Manager API"
      },
      {
        "id": "C",
        "text": "Cloud Monitoring Metric Alert API"
      },
      {
        "id": "D",
        "text": "Service Usage API"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "roles/iam.serviceAccountAdmin on the folder"
      },
      {
        "id": "B",
        "text": "roles/resourcemanager.organizationAdmin on the organization"
      },
      {
        "id": "C",
        "text": "roles/owner on the project"
      },
      {
        "id": "D",
        "text": "roles/iam.securityAdmin on the folder"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Project ID is globally unique, immutable, and chosen by the user at creation to identify the project in CLI and API calls; Project Name is a mutable, user-friendly display string that is not globally unique"
      },
      {
        "id": "B",
        "text": "Project Name is globally unique and cannot be changed; Project ID can be updated at any time in the console"
      },
      {
        "id": "C",
        "text": "Project Number is chosen by the user; Project ID is generated randomly by Google"
      },
      {
        "id": "D",
        "text": "Project ID and Project Name are interchangeable in all gcloud CLI commands"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Apply the Organization Policy constraint 'constraints/gcp.resourceLocations' restricting locations to 'australia-southeast1'"
      },
      {
        "id": "B",
        "text": "Delete all default storage classes in the Google Cloud Console"
      },
      {
        "id": "C",
        "text": "Configure a Cloud Storage lifecycle policy to delete non-compliant buckets"
      },
      {
        "id": "D",
        "text": "Assign 'roles/storage.admin' with an IAM condition checking IP subnet"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "gcloud billing accounts list"
      },
      {
        "id": "B",
        "text": "gcloud compute billing list"
      },
      {
        "id": "C",
        "text": "gcloud projects billing get"
      },
      {
        "id": "D",
        "text": "gcloud organizations list-billing"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Identity-Aware Proxy (IAP) TCP forwarding with 'gcloud compute ssh --tunnel-through-iap'"
      },
      {
        "id": "B",
        "text": "Cloud NAT with port forwarding rules"
      },
      {
        "id": "C",
        "text": "VPC Network Peering with on-premises routers"
      },
      {
        "id": "D",
        "text": "Cloud Interconnect with Direct Peering"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Pass the '--quiet' (or '-q') flag to the gcloud command"
      },
      {
        "id": "B",
        "text": "Set the environment variable INTERACTIVE=FALSE"
      },
      {
        "id": "C",
        "text": "Append '| echo yes' to the shell command"
      },
      {
        "id": "D",
        "text": "Configure gcloud with 'gcloud config set interactive/enabled false'"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Unlike Admin Activity logs (which are free), Data Access audit logs generate high-volume telemetry that incurs Cloud Logging ingestion and storage charges beyond the free allocation limit"
      },
      {
        "id": "B",
        "text": "Data Access audit logs are free of charge across all services in Google Cloud"
      },
      {
        "id": "C",
        "text": "Enabling Data Access logs automatically slows down Cloud Storage read and write latency by 50%"
      },
      {
        "id": "D",
        "text": "Data Access logs can only be retained for a maximum of 7 days"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Configure the budget amount to $8,000 and uncheck 'Include credits' in the budget's credit filter options"
      },
      {
        "id": "B",
        "text": "Enable credit auto-renewal in the billing console"
      },
      {
        "id": "C",
        "text": "Deploy a custom BigQuery view that deletes credit line items"
      },
      {
        "id": "D",
        "text": "Create an IAM policy that restricts spending to promotional SKUs"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Package-managed installations (apt/yum) disable the internal gcloud component manager; components such as kubectl must be installed using the system package manager (e.g., 'apt-get install google-cloud-cli-kubectl')"
      },
      {
        "id": "B",
        "text": "The engineer must execute the command using 'sudo gcloud components install kubectl --force'"
      },
      {
        "id": "C",
        "text": "The Cloud SDK requires a paid license to install additional components"
      },
      {
        "id": "D",
        "text": "The engineer must first authenticate using 'gcloud auth login --admin'"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Use Resource Labels (key-value pairs) for cost allocation and billing export, and use Network Tags (strings) for VPC firewall rule and routing targets"
      },
      {
        "id": "B",
        "text": "Use Network Tags for cost tracking and Resource Labels for firewalls"
      },
      {
        "id": "C",
        "text": "Use Resource Labels for both cost tracking and firewall rules"
      },
      {
        "id": "D",
        "text": "Use Cloud Identity groups for both cost tracking and network routing"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable Boost Mode in the Cloud Shell settings to upgrade the VM to 4 vCPUs and 16 GB RAM for 24 hours"
      },
      {
        "id": "B",
        "text": "Modify the Cloud Shell machine type in the Compute Engine console to n2-standard-8"
      },
      {
        "id": "C",
        "text": "Attach a Local SSD to the Cloud Shell instance"
      },
      {
        "id": "D",
        "text": "Purchase a Cloud Shell Premium subscription in the billing console"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a Google Group (e.g., auditors@company.com), add the external auditor emails to the group, and grant 'roles/viewer' and 'roles/billing.viewer' to the group at the Organization root level"
      },
      {
        "id": "B",
        "text": "Create individual service accounts for each auditor and email them the JSON private keys"
      },
      {
        "id": "C",
        "text": "Grant the primitive Owner role to each auditor on individual projects"
      },
      {
        "id": "D",
        "text": "Export all project configurations to public S3 buckets"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Designate 'networking-prod' as a Shared VPC Host Project, attach application projects as Service Projects, and grant the 'roles/compute.networkUser' role to application service accounts on the host project's subnets"
      },
      {
        "id": "B",
        "text": "Configure VPC Network Peering between every application project and the networking-prod project"
      },
      {
        "id": "C",
        "text": "Deploy an IPSec Cloud VPN tunnel between each application VPC and the central VPC"
      },
      {
        "id": "D",
        "text": "Deploy all application workloads directly inside the networking-prod project"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create and switch between named CLI configurations using 'gcloud config configurations create [NAME]' and 'gcloud config configurations activate [NAME]'"
      },
      {
        "id": "B",
        "text": "Install three separate instances of the Google Cloud SDK into distinct local directories"
      },
      {
        "id": "C",
        "text": "Export the GOOGLE_APPLICATION_CREDENTIALS environment variable before running each CLI command"
      },
      {
        "id": "D",
        "text": "Run 'gcloud auth login' and 'gcloud config set project' each time an environment switch occurs"
      }
    ],
    "correctAnswers": [
      "A"
