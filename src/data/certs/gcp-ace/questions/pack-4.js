export const GCP_ACE_QUESTIONS_4 = [
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Target firewall rules to the specific Service Account under which the database instances run, rather than using network tags"
      },
      {
        "id": "B",
        "text": "Encrypt network tags using Cloud KMS symmetric keys"
      },
      {
        "id": "C",
        "text": "Convert the VPC network from Custom Mode to Auto Mode"
      },
      {
        "id": "D",
        "text": "Restrict VM deployment to sole-tenant hardware"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "External Application Load Balancer (Global HTTPS)"
      },
      {
        "id": "B",
        "text": "External Passthrough Network Load Balancer"
      },
      {
        "id": "C",
        "text": "Internal Application Load Balancer"
      },
      {
        "id": "D",
        "text": "Cloud DNS with latency-based routing records"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "D",
        "text": "Cloud Armor rate limiting proxy"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "A proxy-only subnet in the region with purpose set to REGIONAL_MANAGED_PROXY"
      },
      {
        "id": "B",
        "text": "An internet gateway route pointing to 0.0.0.0/0"
      },
      {
        "id": "C",
        "text": "A Cloud NAT gateway with manual IP assignment"
      },
      {
        "id": "D",
        "text": "An HA VPN tunnel connected to on-premises"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a Cloud DNS Private Zone authorized for the specific VPC network"
      },
      {
        "id": "B",
        "text": "Create a Cloud DNS Public Zone with DNSSEC enabled"
      },
      {
        "id": "C",
        "text": "Maintain /etc/hosts files across all VM instances using Ansible"
      },
      {
        "id": "D",
        "text": "Deploy BIND9 DNS servers on two Compute Engine VMs"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a Cloud DNS Forwarding Zone for the domain '.corp.local' with forwarding targets set to the on-premises DNS server IP addresses"
      },
      {
        "id": "B",
        "text": "Add public NS records for '.corp.local' in Google Domains"
      },
      {
        "id": "C",
        "text": "Configure a VPC firewall rule allowing outbound port 53 to 0.0.0.0/0"
      },
      {
        "id": "D",
        "text": "Deploy Cloud NAT with DNS proxy enabled"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Regional Persistent Disk (Regional PD)"
      },
      {
        "id": "B",
        "text": "Zonal Persistent Disk with daily snapshots"
      },
      {
        "id": "C",
        "text": "Cloud Storage FUSE mount"
      },
      {
        "id": "D",
        "text": "Local SSD attached in raid-1"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a Snapshot Schedule in Compute Engine with a daily schedule and 30-day retention rule, and attach it to the disks"
      },
      {
        "id": "B",
        "text": "Write a Python script on each VM that executes 'dd' and uploads disk images to Cloud Storage via cron"
      },
      {
        "id": "C",
        "text": "Deploy Cloud Backup and DR standalone virtual appliances"
      },
      {
        "id": "D",
        "text": "Configure Object Lifecycle Management on persistent disk partitions"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "B",
        "text": "Cloud Functions (1st gen) with memory scaled to 8 GB"
      },
      {
        "id": "C",
      ...
      {
        "id": "D",
        "text": "Firebase Cloud Functions legacy runtime"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create one or more Cloud SQL Read Replicas and configure reporting tools to connect to the read replica endpoints"
      },
      {
        "id": "B",
        "text": "Enable High Availability on the primary instance and direct analysts to the standby instance"
      },
      {
        "id": "C",
        "text": "Migrate reporting queries to execute against the binary log files directly"
      },
      {
        "id": "D",
        "text": "Export database tables to Cloud Bigtable every 10 minutes"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Automated daily backups and Binary Logging"
      },
      {
        "id": "B",
        "text": "Read Replicas and High Availability"
      },
      {
        "id": "C",
        "text": "Storage auto-increase and Cloud Monitoring alerts"
      },
      {
        "id": "D",
        "text": "Customer-Managed Encryption Keys and SSL/TLS certificates"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a Dual-Region Cloud Storage bucket and enable Turbo Replication"
      },
      {
        "id": "B",
        "text": "Create a Multi-Region bucket with default replication settings"
      },
      {
        "id": "C",
        "text": "Configure a continuous Storage Transfer Service job running every 15 minutes"
      },
      {
        "id": "D",
        "text": "Deploy cross-region Rsync scripts on Compute Engine instances"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Deploy a Custom Machine Type configured with 2 vCPUs and 32 GB of RAM (extended memory)"
      },
      {
        "id": "B",
        "text": "Deploy an e2-micro instance and attach a 32 GB persistent disk formatted as swap space"
      },
      {
        "id": "C",
        "text": "Run the caching daemon inside Google Cloud Shell"
      },
      {
        "id": "D",
        "text": "Deploy the application on Cloud Run with concurrency set to 1"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "C",
        "text": "Cloud Bigtable in SSD mode"
      },
      {
        "id": "D",
        "text": "Cloud SQL with MySQL read replicas"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Compute-Optimized (C2 or C3) machine series"
      },
      {
        "id": "B",
        "text": "General-Purpose (E2) machine series"
      },
      {
        "id": "C",
        "text": "Memory-Optimized (M2) machine series"
      },
      {
        "id": "D",
        "text": "Accelerator-Optimized (A2) machine series"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Converting to Custom Mode is a permanent, irreversible operation; existing subnets retain their IP ranges, but future subnets must be created manually"
      },
      {
        "id": "B",
        "text": "All running Compute Engine instances in the VPC will be terminated during conversion"
      },
      {
        "id": "C",
        "text": "Converting to Custom Mode requires destroying and recreating the VPC network"
      },
      {
        "id": "D",
        "text": "Subnet IP ranges will automatically be truncated from /20 to /24"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Attach 'billing-dev' as a Service Project to 'shared-net-prod' in Shared VPC settings, and grant 'roles/compute.networkUser' on the subnet to the developers or service accounts in 'billing-dev'"
      },
      {
        "id": "B",
        "text": "Establish VPC Network Peering between billing-dev and shared-net-prod"
      },
      {
        "id": "C",
        "text": "Grant the primitive Owner role on shared-net-prod to developers in billing-dev"
      },
      {
        "id": "D",
        "text": "Deploy an HA VPN tunnel connecting the two projects"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "BigQuery handles high-throughput streaming appends natively via the BigQuery Storage Write API without key-range hotspotting, using distributed columnar storage (Capacitor)"
      },
      {
        "id": "B",
        "text": "BigQuery requires hashing timestamps before streaming data"
      },
      {
        "id": "C",
        "text": "BigQuery limits streaming writes to 100 rows per second to prevent hotspots"
      },
      {
        "id": "D",
        "text": "BigQuery tables must be rebuilt daily to re-balance timestamp splits"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a Dual-Region Cloud Storage bucket with Turbo Replication enabled"
      },
      {
        "id": "B",
        "text": "Create a Multi-Region bucket and configure Cloud Storage Transfer Service to execute every 15 minutes"
      },
      {
        "id": "C",
        "text": "Deploy a Regional bucket with an asynchronous cross-region snapshot schedule"
      },
      {
        "id": "D",
        "text": "Deploy two distinct Regional buckets and write a Cloud Function triggered on object finalize to mirror uploads"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Launch an E2-standard-4 Compute Engine instance and install Docker manually over SSH"
      },
      {
        "id": "B",
        "text": "Provision a 3-node GKE Standard cluster and configure an internal ClusterIP service"
      },
      {
        "id": "C",
        "text": "Deploy the container to Cloud Run with concurrency settings configured and allow unauthenticated invocations"
      },
      {
        "id": "D",
        "text": "Deploy the application to Google App Engine flexible environment with min_instances set to 5"
      }
    ],
    "correctAnswers": [
      "C"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create an instance template and deploy a Regional Managed Instance Group (MIG) distributed across multiple zones with an HTTP health check and autoscaling enabled"
      },
      {
        "id": "B",
        "text": "Deploy a single Zonal MIG with autohealing enabled"
      },
      {
        "id": "C",
        "text": "Deploy unmanaged instance groups in three different regions behind an internal TCP proxy"
      },
      {
        "id": "D",
        "text": "Manually create standalone VMs in three zones and configure DNS round-robin routing"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Configure an Object Lifecycle Management policy on the bucket with two rules: transition to Nearline after 30 days, and delete objects after 365 days"
      },
      {
        "id": "B",
        "text": "Change the default storage class of the bucket to Archive Storage immediately upon creation"
      },
      {
        "id": "C",
        "text": "Deploy an EC2 instance that mounts the bucket via FUSE and runs a nightly cron script"
      },
      {
        "id": "D",
        "text": "Write a Cloud Function triggered by Cloud Scheduler that runs gsutil mv and gsutil rm daily"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable High Availability (regional configuration) on the primary Cloud SQL instance and provision one or more read replicas in the same or separate zones"
      },
      {
        "id": "B",
        "text": "Configure an automated export to Cloud Storage every 10 minutes and read from CSV files"
      },
      {
        "id": "C",
        "text": "Deploy two standalone single-zone Cloud SQL instances and write custom replication scripts"
      },
      {
        "id": "D",
        "text": "Enable point-in-time recovery on a single-zone instance without secondary standby"
      }
    ],
    "correctAnswers": [
      "A"
