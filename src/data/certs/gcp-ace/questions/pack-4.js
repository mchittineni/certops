export const GCP_ACE_QUESTIONS_4 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Target the rules at the database service account" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "External Application Load Balancer (Global HTTPS)" },
      { id: 'C', text: "Cloud DNS with latency-based routing records" },
      { id: 'D', text: "External Passthrough Network Load Balancer" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Internal Application Load Balancer" },
      { id: 'D', text: "Cloud Armor rate limiting proxy" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An internet gateway route pointing to 0.0.0.0/0" },
      { id: 'B', text: "A REGIONAL_MANAGED_PROXY subnet in the region" },
      { id: 'C', text: "A Cloud NAT gateway with manual IP assignment" },
      { id: 'D', text: "An HA VPN tunnel connected to on-premises" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A Cloud DNS forwarding zone targeting the on-premises servers" },
      { id: 'B', text: "Configure a VPC firewall rule allowing outbound port 53 to 0.0.0.0/0" },
      { id: 'C', text: "Deploy Cloud NAT with DNS proxy enabled" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Functions (2nd gen)" },
      { id: 'B', text: "Firebase Cloud Functions legacy runtime" },
      { id: 'C', text: "App Engine Standard Environment" },
      { id: 'D', text: "Cloud Functions (1st gen) with memory scaled to 8 GB" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create Cloud SQL read replicas and point reporting at their endpoints" },
      { id: 'B', text: "Enable High Availability on the primary instance and direct analysts to the standby instance" },
      { id: 'C', text: "Migrate reporting queries to execute against the binary log files directly" },
      { id: 'D', text: "Export database tables to Cloud Bigtable every 10 minutes" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Memory-Optimized (M2) machine series" },
      { id: 'B', text: "Compute-Optimized (C2 or C3) machine series" },
      { id: 'C', text: "General-Purpose (E2) machine series" },
      { id: 'D', text: "Accelerator-Optimized (A2) machine series" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "All running Compute Engine instances in the VPC will be terminated during conversion" },
      { id: 'C', text: "It is irreversible; existing subnets stay, new ones are manual." },
      { id: 'D', text: "Subnet IP ranges will automatically be truncated from /20 to /24" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Attach it as a service project and grant compute.networkUser on the subnet." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "BigQuery requires hashing timestamps before streaming data" },
      { id: 'B', text: "BigQuery limits streaming writes to 100 rows per second to prevent hotspots" },
      { id: 'C', text: "The Storage Write API appends at high throughput without hotspotting." },
      { id: 'D', text: "BigQuery tables must be rebuilt daily to re-balance timestamp splits" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Launch an E2-standard-4 Compute Engine instance and install Docker manually over SSH" },
      { id: 'B', text: "Provision a 3-node GKE Standard cluster and configure an internal ClusterIP service" },
      { id: 'C', text: "Deploy the application to Google App Engine flexible environment with min_instances set to 5" },
      { id: 'D', text: "Deploy the container to Cloud Run with concurrency settings configured and allow unauthenticated invocations" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A regional managed instance group with a health check and autoscaling." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A lifecycle policy moving to Nearline at 30 days and deleting at 365." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable point-in-time recovery on a single-zone instance without secondary standby" },
      { id: 'B', text: "Deploy two standalone single-zone Cloud SQL instances and write custom replication scripts" },
      { id: 'C', text: "Configure an automated export to Cloud Storage every 10 minutes and read from CSV files" },
      { id: 'D', text: "Enable regional HA on the primary and provision read replicas." }
    ],
    correctAnswers: ['D'],
    type: "single",
