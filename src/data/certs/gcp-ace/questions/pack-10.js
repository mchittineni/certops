export const GCP_ACE_QUESTIONS_10 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Share a single corporate service account JSON key among all developers" },
      { id: 'B', text: "Write a weekly Python script that iterates through projects and syncs permissions" },
      { id: 'C', text: "Grant the primitive Owner role to all developers" },
      { id: 'D', text: "Create Google Groups in Google Workspace/Cloud Identity corresponding to job functions, assign IAM roles to the groups, and manage permissions by adjusting group membership" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Container Analysis" },
      { id: 'B', text: "Binary Authorization" },
      { id: 'C', text: "Artifact Registry vulnerability scanning alone" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "--assume-role=terraform-deployer" },
      { id: 'B', text: "--service-account=terraform-deployer" },
      { id: 'C', text: "--impersonate-service-account=terraform-deployer@project.iam.gserviceaccount.com" },
      { id: 'D', text: "--auth-as=terraform-deployer" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Security Command Center Premium" },
      { id: 'B', text: "VPC Service Controls" },
      { id: 'C', text: "Access Transparency" },
      { id: 'D', text: "Cloud Audit Logs - Admin Activity" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Sensitive Data Protection (formerly Cloud DLP)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable the default VPC network in each region" },
      { id: 'C', text: "Create an egress firewall rule blocking 0.0.0.0/0" },
      { id: 'D', text: "Delete all default internet gateways" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create a Policy Tag in Dataplex (Data Catalog), associate it with the 'ssn' column in the BigQuery table schema, and grant the 'Fine-Grained Reader' role on the policy tag only to HR compliance officers" },
      { id: 'B', text: "Create two separate datasets in different regions" },
      { id: 'C', text: "Grant the 'roles/bigquery.dataViewer' role to analysts and create an IAM deny policy on the column" },
      { id: 'D', text: "Encrypt the entire table using Customer-Supplied Encryption Keys (CSEK)" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "resource.type=\"gce_instance\" AND severity=ERROR AND textPayload=~\"stopped\"" },
      ...
      { id: 'D', text: "SELECT caller FROM compute.instances WHERE action='stop'" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable public internet access on all VPC networks" },
      { id: 'B', text: "Remove the primitive Owner role from all administrators" },
      { id: 'C', text: "Delete all external DNS zone records in Cloud DNS" },
      { id: 'D', text: "Enforce constraint 'constraints/iam.allowedPolicyMemberDomains' with the corporate Cloud Identity customer ID" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud SQL Auth Proxy with static RSA keys" },
      { id: 'B', text: "Identity-Aware Proxy TCP forwarding" },
      { id: 'C', text: "Cloud SQL IAM database authentication" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Grant 'roles/viewer' on the project and make the vendor a sudoer on the VM OS" },
      { id: 'B', text: "Create a separate VPC network for the vendor" },
      { id: 'C', text: "Grant 'roles/compute.instanceAdmin.v1' at the project level with an IAM condition on zone" },
      { id: 'D', text: "Grant 'roles/compute.instanceAdmin.v1' directly on the 'billing-server' VM instance resource using 'gcloud compute instances add-iam-policy-binding'" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The administrator must export the raw key material and re-import it every 90 days" },
      { id: 'B', text: "Cloud KMS creates a new Key Ring and updates project IAM policies automatically" },
      { id: 'C', text: "Cloud KMS deletes the old key and triggers a batch re-encryption of all Cloud Storage objects" },
      { id: 'D', text: "Configure an automated rotation period of 90 days on the CryptoKey; Cloud KMS creates a new primary version for future encryptions while preserving older versions to seamlessly decrypt historical data" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable Master Authorized Networks on the GKE cluster and specify the corporate public CIDR ranges" },
      { id: 'B', text: "Configure a VPC firewall rule with target tag 'k8s-master'" },
      { id: 'C', text: "Deploy Cloud Armor on the Kubernetes cluster nodes" },
      { id: 'D', text: "Apply a Kubernetes NetworkPolicy to the kube-system namespace" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enforce constraint 'constraints/storage.uniformBucketLevelAccess' across the organization" },
      { id: 'B', text: "Apply the 'roles/storage.admin' role to the Organization Administrator only" },
      { id: 'C', text: "Enable Bucket Lock on all existing buckets" },
      { id: 'D', text: "Remove all object viewer permissions in IAM" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Access Context Manager" },
      { id: 'D', text: "Cloud Armor standard policy" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "IAM Recommender (Role Recommendations)" },
      { id: 'B', text: "Policy Simulator" },
      { id: 'C', text: "Cloud Security Command Center Asset Inventory" },
      { id: 'D', text: "Cloud Audit Logs Explorer" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Confidential Computing AMD SEV and Cloud KMS" },
      { id: 'C', text: "Secure Boot and Virtual Trusted Platform Module (vTPM)" },
      { id: 'D', text: "Binary Authorization and Container Analysis" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Delete both perimeters and rely on VPC firewall rules" },
      { id: 'B', text: "Configure complementary Ingress and Egress rules on both service perimeters defining the allowed projects, identities, and API methods" },
      { id: 'C', text: "Assign the primitive Owner role to the pipeline service account" },
      { id: 'D', text: "Deploy an unmanaged Squid proxy between the perimeters" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Customer-Managed Encryption Keys (CMEK); keys are automatically backed up to Google Workspace" },
      { id: 'C', text: "Customer-Supplied Encryption Keys (CSEK); if the contractor loses the raw key, Google Cloud cannot recover or decrypt the data under any circumstances" },
      { id: 'D', text: "Google-Default Encryption; Google rotates keys without user involvement" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Compute Engine serial port logs" },
      { id: 'C', text: "Cloud Storage access logs" },
      { id: 'D', text: "Policy Denied audit logs in Cloud Logging" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "roles/iam.serviceAccountUser on the project" },
      { id: 'B', text: "roles/compute.instanceAdmin.v1 on the VM instance" },
      { id: 'C', text: "roles/iam.serviceAccountTokenCreator on the target service account" },
