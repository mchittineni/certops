export const GCP_ACE_QUESTIONS_10 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Grant the primitive Owner role to all developers" },
      { id: 'B', text: "Assign IAM roles to job-function groups and manage membership." },
      { id: 'C', text: "Share a single corporate service account JSON key among all developers" },
      { id: 'D', text: "Write a weekly Python script that iterates through projects and syncs permissions" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Container Analysis" },
      { id: 'D', text: "Artifact Registry vulnerability scanning alone" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "--auth-as=terraform-deployer" },
      { id: 'B', text: "--impersonate-service-account=terraform-deployer@project.iam.gserviceaccount.com" },
      { id: 'C', text: "--service-account=terraform-deployer" },
      { id: 'D', text: "--assume-role=terraform-deployer" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Access Transparency" },
      { id: 'C', text: "VPC Service Controls" },
      { id: 'D', text: "Security Command Center Premium" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Sensitive Data Protection (formerly Cloud DLP)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Remove the default route to the internet gateway" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Encrypt the entire table using Customer-Supplied Encryption Keys (CSEK)" },
      { id: 'B', text: "Create two separate datasets in different regions" },
      { id: 'C', text: "A policy tag on the ssn column, with Fine-Grained Reader granted to HR." },
      { id: 'D', text: "Grant the 'roles/bigquery.dataViewer' role to analysts and create an IAM deny policy on the column" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enforce allowedPolicyMemberDomains with the customer ID" },
      { id: 'B', text: "Disable public internet access on all VPC networks" },
      { id: 'C', text: "Create a Cloud DNS private zone with the same records" },
      { id: 'D', text: "Remove the primitive Owner role from all administrators" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud SQL IAM database authentication" },
      { id: 'B', text: "Compute Engine OS Login" },
      { id: 'C', text: "Cloud SQL Auth Proxy with static RSA keys" },
      { id: 'D', text: "Identity-Aware Proxy TCP forwarding" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Grant compute.instanceAdmin.v1 on that VM instance resource" },
      { id: 'B', text: "Grant 'roles/viewer' on the project and make the vendor a sudoer on the VM OS" },
      { id: 'C', text: "Grant 'roles/compute.instanceAdmin.v1' at the project level with an IAM condition on zone" },
      { id: 'D', text: "Create a separate VPC network for the vendor" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud KMS deletes the old key and triggers a batch re-encryption of all Cloud Storage objects" },
      { id: 'B', text: "Cloud KMS creates a new Key Ring and updates project IAM policies automatically" },
      { id: 'C', text: "A 90-day rotation period; older versions stay to decrypt existing data." },
      { id: 'D', text: "The administrator must export the raw key material and re-import it every 90 days" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable master authorized networks with the corporate CIDRs" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable Bucket Lock on all existing buckets" },
      { id: 'B', text: "Apply the 'roles/storage.admin' role to the Organization Administrator only" },
      { id: 'C', text: "Remove all object viewer permissions in IAM" },
      { id: 'D', text: "Enforce constraint 'constraints/storage.uniformBucketLevelAccess' across the organization" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Access Context Manager" },
      { id: 'B', text: "VPC Flow Logs" },
      { id: 'C', text: "Cloud Armor standard policy" },
      { id: 'D', text: "Cloud NAT" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Security Command Center Asset Inventory" },
      { id: 'B', text: "Policy Simulator" },
      { id: 'C', text: "Cloud Audit Logs Explorer" },
      { id: 'D', text: "IAM Recommender (Role Recommendations)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy an unmanaged Squid proxy between the perimeters" },
      { id: 'B', text: "Assign the primitive Owner role to the pipeline service account" },
      { id: 'C', text: "Complementary ingress and egress rules on both perimeters" },
      { id: 'D', text: "Delete both perimeters and rely on VPC firewall rules" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Google-Default Encryption; Google rotates keys without user involvement" },
      { id: 'C', text: "Customer-Managed Encryption Keys (CMEK); keys are automatically backed up to Google Workspace" },
      { id: 'D', text: "Customer-supplied keys; if the key is lost the data is unrecoverable." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Policy Denied audit logs in Cloud Logging" },
      { id: 'B', text: "Cloud Storage access logs" },
      { id: 'C', text: "Compute Engine serial port logs" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "roles/compute.instanceAdmin.v1 on the VM instance" },
      { id: 'B', text: "serviceAccountTokenCreator on the target account" },
      { id: 'C', text: "roles/iam.serviceAccountUser on the project" },
