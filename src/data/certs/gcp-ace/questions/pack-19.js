export const GCP_ACE_QUESTIONS_19 = [
  {
    id: "gcp-ace-451",
    difficulty: "hard",
    certId: "gcp-ace",
    ...
    options: [
      { id: 'A', text: "Inspect distributed latency spans in Google Cloud Trace." },
      { id: 'B', text: "Examine the virtual machine local operating system syslog." },
      { id: 'C', text: "Increase the CPU core count on all virtual machines." },
      { id: 'D', text: "Disable database query caching." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Examine the virtual machine local operating system syslog." },
      { id: 'D', text: "Disable database query caching." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Increase the CPU core count on all virtual machines." },
      { id: 'D', text: "Inspect distributed latency spans in Google Cloud Trace." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Inspect distributed latency spans in Google Cloud Trace. Cloud Trace is a distributed tracing system that collects latency data from your applications and displays it in the Google Cloud Console. It tracks how requests propagate through microservices, pinpointing exact performance bottlenecks and slow remote procedure calls.",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Bind Viewer or Security Reviewer to the group at the org level." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Create a shared Google account and give the password to all analysts." },
      { id: 'C', text: "Assign the Organization Administrator role to the analyst group." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Add each analyst individually to every single project in the organization." },
      { id: 'B', text: "Assign the Organization Administrator role to the analyst group." },
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Mount a service account key file into the container at deploy time." },
      { id: 'B', text: "Grant full Cloud Storage admin rights to the underlying GKE worker node service account." },
      { id: 'C', text: "Configure GKE Workload Identity to bind the Kubernetes ServiceAccount to an IAM Google ServiceAccount." },
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Deploy an unmanaged bastion host with an open public IP on the perimeter subnet." },
      { id: 'B', text: "Use Identity-Aware Proxy (IAP) TCP forwarding using 'gcloud compute ssh --tunnel-through-iap'." },
      { id: 'C', text: "Assign public IP addresses to all virtual machines and open port 22 to the public internet." },
      { id: 'D', text: "Disable SSH authentication and allow unauthenticated connections." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy an unmanaged bastion host with an open public IP on the perimeter subnet." },
      { id: 'D', text: "Disable SSH authentication and allow unauthenticated connections." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Rely on default Google-managed encryption keys without configuration." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Store encryption keys in an unencrypted Cloud Storage bucket." },
      { id: 'C', text: "Customer-managed encryption keys in Cloud KMS for those resources." },
      { id: 'D', text: "Rely on default Google-managed encryption keys without configuration." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Configure Customer-Managed Encryption Keys (CMEK) using Cloud KMS for storage and database resources. By default, Google Cloud encrypts all customer data at rest using Google-managed encryption keys. Customer-Managed Encryption Keys (CMEK) via Cloud KMS allow organizations to control the keys used to encrypt data at rest, managing key rotation schedules, permissions, and cryptographic destruction.",
...
export default GCP_ACE_QUESTIONS_19;
