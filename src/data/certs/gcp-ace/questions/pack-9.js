export const GCP_ACE_QUESTIONS_9 = [
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Configure 'behavior.scaleDown.stabilizationWindowSeconds' to 300 seconds"
      },
      {
        "id": "B",
        "text": "Reduce the CPU target percentage to 10%"
      },
      {
        "id": "C",
        "text": "Set PodDisruptionBudget to minAvailable: 50"
      },
      {
        "id": "D",
        "text": "Disable Metrics Server on the cluster"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Long-poll the metadata server endpoint 'http://metadata.google.internal/computeMetadata/v1/instance/maintenance-event' with header 'Metadata-Flavor: Google'"
      },
      {
        "id": "B",
        "text": "Monitor /var/log/syslog for the string 'MAINTENANCE'"
      },
      {
        "id": "C",
        "text": "Listen on UDP port 53 for DNS broadcast alerts"
      },
      {
        "id": "D",
        "text": "Subscribe to the Cloud Billing Pub/Sub topic"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Add nodes to the Bigtable cluster to reduce average CPU utilization below the recommended 70% threshold"
      },
      {
        "id": "B",
        "text": "Restart the Bigtable cluster instances during a maintenance window"
      },
      {
        "id": "C",
        "text": "Switch the storage disks from SSD to HDD"
      },
      {
        "id": "D",
        "text": "Change the table column families to single-version retention"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable VPC Flow Logs on the subnet and view records in Cloud Logging"
      },
      {
        "id": "B",
        "text": "Enable Packet Mirroring on the default internet gateway"
      },
      {
        "id": "C",
        "text": "Inspect the Cloud Router dynamic routing table"
      },
      {
        "id": "D",
        "text": "Deploy an unmanaged Squid proxy instance"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Yes, Compute Engine snapshots are stored redundantly across all zones in the region (or multi-region) and can restore a disk into any zone within that region"
      },
      {
        "id": "B",
        "text": "No, snapshots can only be restored into the exact zone where the source disk was located"
      },
      {
        "id": "C",
        "text": "Only if the snapshot was manually copied using Cloud Storage Transfer Service"
      },
      {
        "id": "D",
        "text": "Only if the instance was part of a Regional Managed Instance Group"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Monotonically increasing or sequential object names hotspot a single Cloud Storage backend index shard; prepend a random hash prefix or reverse the timestamp in object keys to distribute write operations evenly across index shards"
      },
      {
        "id": "B",
        "text": "Cloud Storage has exceeded its maximum object count per bucket; create separate regional buckets for each sensor"
      },
      {
        "id": "C",
        "text": "The storage class must be converted from Standard to Nearline to handle high IOPS"
      },
      {
        "id": "D",
        "text": "The project has reached its maximum persistent disk throughput quota in the region"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Assigning the GKE cluster public IP addresses and allowing unauthenticated bucket access"
      },
      {
        "id": "B",
        "text": "Exporting a service account JSON key and mounting it as a Kubernetes Secret volume"
      },
      {
        "id": "C",
      ...
      {
        "id": "D",
        "text": "Compute Engine default service account attached to the node pool with full Cloud API access scopes"
      }
    ],
    "correctAnswers": [
      "C"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Primitive roles incur additional hourly administrative licensing charges"
      },
      {
        "id": "B",
        "text": "Primitive roles automatically expire after 24 hours and must be refreshed manually"
      },
      {
        "id": "C",
        "text": "Primitive roles cannot be applied to human users and only work on service accounts"
      },
      {
        "id": "D",
        "text": "Primitive roles (Owner, Editor, Viewer) grant broad, sweeping permissions across almost all Google Cloud services in the project, violating the principle of least privilege"
      }
    ],
    "correctAnswers": [
      "D"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Project Owner (roles/owner)"
      },
      {
        "id": "B",
        "text": "Security Admin (roles/iam.securityAdmin)"
      },
      {
        "id": "C",
        "text": "Service Account Admin (roles/iam.serviceAccountAdmin)"
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "The developer retains Viewer access to the project because IAM permissions are inherited from parent folders and cannot be revoked at the child resource level"
      },
      {
        "id": "B",
        "text": "The developer loses access to the project while retaining access to all other projects in the folder"
      },
      {
        "id": "C",
        "text": "The project enters an orphaned IAM state and becomes inaccessible to all users"
      },
      {
        "id": "D",
        "text": "Google Cloud creates an automatic Deny rule on the project"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create an IAM Deny Policy at the Folder level specifying a deny rule for permission 'storage.buckets.delete'"
      },
      {
        "id": "B",
        "text": "Remove the 'roles/storage.admin' role from all developers"
      },
      {
        "id": "C",
        "text": "Enable Object Versioning on all Cloud Storage buckets"
      },
      {
        "id": "D",
        "text": "Apply a VPC Service Controls perimeter around the storage API"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Google Cloud automatically grants the primitive 'roles/editor' role to the default service account, giving any compromised VM broad modify permissions across nearly all project services"
      },
      {
        "id": "B",
        "text": "The default service account has its credentials published in the public Google directory"
      },
      {
        "id": "C",
        "text": "Default service accounts cannot communicate over private VPC networks"
      },
      {
        "id": "D",
        "text": "The default service account incurs a 10% premium on VM compute pricing"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Effective permissions are the intersection of OAuth access scopes and IAM roles; stop the VM, update the access scope to 'https://www.googleapis.com/auth/cloud-platform', and start the VM"
      },
      {
        "id": "B",
        "text": "Grant the 'roles/owner' role to the VM's service account"
      },
      {
        "id": "C",
        "text": "Download a service account JSON key to the VM filesystem"
      },
      {
        "id": "D",
        "text": "Convert the persistent disk to a regional persistent disk"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "D",
        "text": "roles/iam.workloadIdentityUser"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable GKE Workload Identity, bind the Kubernetes ServiceAccount to the Google ServiceAccount with 'roles/iam.workloadIdentityUser', and annotate the KSA"
      },
      {
        "id": "B",
        "text": "Assign the 'roles/bigtable.reader' role to all worker node VMs"
      },
      {
        "id": "C",
        "text": "Encrypt the Kubernetes secret using Cloud KMS customer-managed keys"
      },
      {
        "id": "D",
        "text": "Store the JSON key in Secret Manager and fetch it via startup script"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Workload Identity Federation configured with GitHub as an OpenID Connect (OIDC) identity provider"
      },
      {
        "id": "B",
        "text": "Identity-Aware Proxy with TCP forwarding"
      },
      {
        "id": "C",
        "text": "A site-to-site HA VPN between GitHub and Google Cloud"
      },
      {
        "id": "D",
        "text": "Basic authentication with Cloud Identity username and password"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Add the IAM role bindings with an IAM Condition using Common Expression Language (CEL) specifying 'request.time < timestamp(\"2026-10-05T18:00:00Z\")'"
      },
      {
        "id": "B",
        "text": "Create a Google Calendar reminder to delete the auditor's account manually"
      },
      {
        "id": "C",
        "text": "Write a Cloud Function scheduled via Cloud Scheduler to revoke the role"
      },
      {
        "id": "D",
        "text": "Assign the role to an ephemeral service account and delete the service account key"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Admin Activity logs are always enabled, free of charge, and retained for 400 days; Data Access logs record high-volume user data transactions, are billable beyond the free log tier, and are retained for 30 days by default"
      },
      {
        "id": "B",
        "text": "Data Access logs require provisioning dedicated Bigtable clusters"
      },
      {
        "id": "C",
        "text": "Data Access logs can only be stored in multi-region Coldline buckets"
      },
      {
        "id": "D",
        "text": "Google Cloud charges a licensing fee for each enabled API"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Grant the 'roles/cloudkms.cryptoKeyEncrypterDecrypter' role on 'patient-data-key' to the Cloud Storage Service Agent for the project"
      },
      {
        "id": "B",
        "text": "Grant the 'roles/owner' role on the project to Cloud KMS"
      },
      {
        "id": "C",
        "text": "Assign the hospital security team's Google group the 'roles/storage.admin' role"
      },
      {
        "id": "D",
        "text": "Download the KMS private key and attach it to the bucket metadata"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "The command fails because Cloud KMS Keys and Key Rings can never be deleted; key versions can only be disabled or scheduled for destruction to preserve cryptographic audit integrity"
      },
      {
        "id": "B",
        "text": "The key is immediately purged and all encrypted data is automatically re-encrypted with Google-managed keys"
      },
      {
        "id": "C",
        "text": "The key ring is archived to Cloud Storage Coldline"
      },
      {
        "id": "D",
        "text": "The command succeeds only if the administrator possesses the Organization Administrator role"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Grant 'roles/secretmanager.secretAccessor' on the specific secret resource only"
      },
      {
        "id": "B",
        "text": "Grant 'roles/secretmanager.viewer' at the project level"
      },
      {
        "id": "C",
        "text": "Grant 'roles/secretmanager.secretVersionManager' on the folder"
      },
      {
        "id": "D",
        "text": "Grant 'roles/viewer' on the project"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Use 'gcloud compute ssh --tunnel-through-iap' and configure a VPC ingress firewall rule allowing TCP ports 22 and 3389 from source IP range 35.235.240.0/20"
      },
      {
        "id": "B",
        "text": "Configure a firewall rule allowing port 22 from 0.0.0.0/0"
      },
      {
        "id": "C",
        "text": "Deploy Cloud NAT with static IP addresses for inbound SSH"
      },
      {
        "id": "D",
        "text": "Use Cloud Shell with public IP port forwarding"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "VPC Service Controls configured with a Service Perimeter encompassing the enterprise projects and BigQuery/Storage APIs"
      },
      {
        "id": "B",
        "text": "VPC Firewall rules blocking egress to 0.0.0.0/0"
      },
      {
        "id": "C",
        "text": "Cloud Armor security policies attached to external load balancers"
      },
      {
        "id": "D",
        "text": "Cloud NAT egress filtering"
      }
    ],
    "correctAnswers": [
      "A"
