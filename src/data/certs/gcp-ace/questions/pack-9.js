export const GCP_ACE_QUESTIONS_9 = [
  {
    ...
    options: [
      { id: 'A', text: "Regular channel" },
      { id: 'B', text: "Rapid channel" },
      { id: 'C', text: "Stable channel" },
      { id: 'D', text: "Extended support channel" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy an unmanaged Squid proxy instance" },
      { id: 'B', text: "Enable VPC Flow Logs on the subnet and view records in Cloud Logging" },
      { id: 'C', text: "Enable Packet Mirroring on the default internet gateway" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Exporting a service account JSON key and mounting it as a Kubernetes Secret volume" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Project Owner (roles/owner)" },
      { id: 'B', text: "Service Account Admin (roles/iam.serviceAccountAdmin)" },
      { id: 'C', text: "Service Account User (roles/iam.serviceAccountUser)" },
      { id: 'D', text: "Security Admin (roles/iam.securityAdmin)" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "roles/iam.serviceAccountTokenCreator" },
      { id: 'B', text: "roles/iam.workloadIdentityUser" },
      { id: 'C', text: "roles/iam.serviceAccountUser" },
      { id: 'D', text: "roles/iam.serviceAccountAdmin" }
    ],
    correctAnswers: ['C'],
    type: "single",
