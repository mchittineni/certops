export const GCP_ACE_QUESTIONS_9 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Extended support channel" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A 300-second scale-down stabilization window" },
      { id: 'B', text: "Set PodDisruptionBudget to minAvailable: 50" },
      { id: 'C', text: "Reduce the CPU target percentage to 10%" },
      { id: 'D', text: "Disable Metrics Server on the cluster" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Monitor /var/log/syslog for the string 'MAINTENANCE'" },
      { id: 'B', text: "Listen on UDP port 53 for DNS broadcast alerts" },
      { id: 'C', text: "Long-poll the maintenance-event metadata key" },
      { id: 'D', text: "Subscribe to the Cloud Billing Pub/Sub topic" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Add Bigtable nodes to bring average CPU below 70%" },
      { id: 'B', text: "Change the table column families to single-version retention" },
      { id: 'C', text: "Restart the Bigtable cluster instances during a maintenance window" },
      { id: 'D', text: "Switch the storage disks from SSD to HDD" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Yes; snapshots are regional and restore into any zone in the region." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Primitive roles grant sweeping permissions across nearly every service." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Service Account Admin (roles/iam.serviceAccountAdmin)" },
      { id: 'B', text: "Security Admin (roles/iam.securityAdmin)" },
      { id: 'C', text: "Service Account User (roles/iam.serviceAccountUser)" },
      { id: 'D', text: "Project Owner (roles/owner)" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Default service accounts cannot communicate over private VPC networks" },
      { id: 'B', text: "The default service account incurs a 10% premium on VM compute pricing" },
      { id: 'C', text: "The default service account gets roles/editor across the whole project." },
      { id: 'D', text: "The default service account has its credentials published in the public Google directory" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Scopes intersect with IAM; stop the VM and widen the scope" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "roles/iam.serviceAccountUser" },
      { id: 'B', text: "roles/iam.serviceAccountTokenCreator" },
      { id: 'C', text: "roles/iam.serviceAccountAdmin" },
      { id: 'D', text: "roles/iam.workloadIdentityUser" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable Workload Identity, bind the KSA and annotate it" },
      { id: 'B', text: "Encrypt the Kubernetes secret using Cloud KMS customer-managed keys" },
      { id: 'C', text: "Assign the 'roles/bigtable.reader' role to all worker node VMs" },
      { id: 'D', text: "Store the JSON key in Secret Manager and fetch it via startup script" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Workload Identity Federation with GitHub as OIDC provider" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Add the bindings with a CEL condition limiting request.time" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Data Access logs can only be stored in multi-region Coldline buckets" },
      { id: 'B', text: "Google Cloud charges a licensing fee for each enabled API" },
      { id: 'C', text: "Admin Activity is free for 400 days; Data Access is billable" },
      { id: 'D', text: "Data Access logs require provisioning dedicated Bigtable clusters" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Grant cryptoKeyEncrypterDecrypter on the key to the Storage service agent." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The command succeeds only if the administrator possesses the Organization Administrator role" },
      { id: 'B', text: "It fails: keys and key rings cannot be deleted, only versions destroyed." },
      { id: 'C', text: "The key is immediately purged and all encrypted data is automatically re-encrypted with Google-managed keys" },
      { id: 'D', text: "The key ring is archived to Cloud Storage Coldline" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Grant 'roles/secretmanager.viewer' at the project level" },
      { id: 'B', text: "Grant roles/secretmanager.secretAccessor on that secret" },
      { id: 'C', text: "Grant 'roles/secretmanager.secretVersionManager' on the folder" },
      { id: 'D', text: "Grant 'roles/viewer' on the project" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "SSH through IAP and allow 35.235.240.0/20 inbound" },
      { id: 'B', text: "Configure a firewall rule allowing port 22 from 0.0.0.0/0" },
      { id: 'C', text: "Use Cloud Shell with public IP port forwarding" },
      { id: 'D', text: "Deploy Cloud NAT with static IP addresses for inbound SSH" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Cloud NAT egress filtering" },
      { id: 'C', text: "VPC Firewall rules blocking egress to 0.0.0.0/0" },
      { id: 'D', text: "A VPC Service Controls perimeter around those projects and APIs" }
    ],
    correctAnswers: ['D'],
    type: "single",
