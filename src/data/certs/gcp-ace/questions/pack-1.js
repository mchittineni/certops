export const GCP_ACE_QUESTIONS = [
  {
    ...
    options: [
      { id: 'A', text: 'kubectl create deployment app --image=IMAGE --replicas=3, then kubectl expose deployment app --type=LoadBalancer --port=80 --target-port=8080' },
      ...
      { id: 'D', text: 'gcloud container clusters resize CLUSTER --num-nodes=3, then kubectl apply -f service.yaml' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'A Cloud Scheduler job that invokes a Cloud Function calling the snapshots.insert API.' },
      { id: 'C', text: 'A Cloud Storage lifecycle rule on the bucket holding the disk images.' },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'The project.' },
      { id: 'B', text: 'The folder.' },
      { id: 'C', text: 'The organization.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Increase the retention of the _Required log bucket to 730 days.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Grant the node pool service account the union of all permissions the three microservices need.' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: 'Bigtable with a multi-cluster routing app profile.' }
    ],
    correctAnswers: ['A'],
    type: 'single',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: 'Use gcloud run services update-traffic --to-revisions REVISION=5 and later --to-latest to finish the rollout.' },
      ...
      { id: 'D', text: 'Put an external HTTP(S) Load Balancer in front of two separate Cloud Run services and split traffic with a URL map weight.' },
      { id: 'E', text: 'Scale the previous revision to zero instances so the new revision absorbs all requests gradually.' }
    ],
    correctAnswers: ['A', 'B'],
    type: 'multiple',
