export const GCP_ACE_QUESTIONS_20 = [
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Create a new Google account for the external customer and add them to the project." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Apply a standard VPC firewall rule blocking port 80 egress." },
      { id: 'C', text: "Point the VMs at the on-premises DNS servers directly." },
