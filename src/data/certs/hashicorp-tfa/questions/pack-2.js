export const HASHICORP_TFA_QUESTIONS_2 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Any version in the 3.x series" },
      { id: 'B', text: "Only exactly version 3.2.0" },
      { id: 'C', text: "Any version >= 3.2.0 and < 3.3.0 (e.g. 3.2.1, 3.2.5, but not 3.3.0)" },
      { id: 'D', text: "Any version >= 3.2.0 and < 4.0.0" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Terraform strictly prohibits deploying to two regions in one configuration" },
      { id: 'B', text: "By defining a primary default provider block and a secondary provider block with an 'alias' attribute" },
      { id: 'C', text: "By installing two different versions of the Terraform CLI binary" },
      { id: 'D', text: "By creating two separate .tfstate files in the same directory" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "On HashiCorp's hosted cloud servers" },
      { id: 'B', text: "On the local machine where the Terraform CLI binary is currently running" },
      { id: 'C', text: "On the cloud provider's API server gateway" },
      { id: 'D', text: "Inside the target virtual machine in the cloud" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The resource is marked tainted" },
      { id: 'B', text: "Terraform stops the destroy process, leaves the resource intact, and allows the user to re-run destroy after fixing the issue" },
      { id: 'C', text: "Terraform deletes the resource anyway and corrupts state" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Partner Providers" },
      { id: 'B', text: "Enterprise Providers" },
      { id: 'C', text: "Community Providers" },
      { id: 'D', text: "Official Providers" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An explicit dependency (declared via depends_on)" },
      { id: 'B', text: "A circular dependency" },
      { id: 'C', text: "An implicit dependency (automatically detected by Terraform from the expression reference)" },
      { id: 'D', text: "An unmanaged dependency" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "after = [aws_iam_role_policy_attachment.app]" },
      { id: 'B', text: "waitFor = [aws_iam_role_policy_attachment.app]" },
      { id: 'C', text: "before = [aws_iam_role_policy_attachment.app]" },
      { id: 'D', text: "depends_on = [aws_iam_role_policy_attachment.app]" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Inside the cloud provider's root billing console" },
      { id: 'B', text: "On the developer's company Git server" },
      { id: 'C', text: "Locally on the developer's laptop using local memory" },
      { id: 'D', text: "Remotely in a secure, isolated container runner managed by Terraform Cloud" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "GitHub Releases public bucket" },
      { id: 'C', text: "Local filesystem folders alone" },
      { id: 'D', text: "Public Terraform Registry" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In environment variables" },
      { id: 'B', text: "In a file named providers.json" },
      { id: 'C', text: "Inside the terraform { required_providers { ... } } block" },
      { id: 'D', text: "Inside the provider \"aws\" block directly" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "github.com exclusively" },
      { id: 'B', text: "registry.terraform.io only" },
      { id: 'C', text: "Custom hostnames are not supported by Terraform" },
      { id: 'D', text: "A custom enterprise domain (e.g. terraform.company.internal/it-ops/baremetal)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "TF_PROVIDER_CACHE" },
      { id: 'B', text: "TF_GLOBAL_DIR" },
      { id: 'C', text: "TF_PLUGIN_CACHE_DIR" },
      { id: 'D', text: "TERRAFORM_CACHE_PATH" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "terraform update" },
      { id: 'B', text: "terraform refresh" },
      { id: 'C', text: "terraform init -upgrade" },
      { id: 'D', text: "terraform upgrade --all" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The S3 backend does not support locking" },
      { id: 'B', text: "By creating two separate AWS accounts automatically" },
      { id: 'C', text: "By utilizing an Amazon DynamoDB table configured for state locking; the second user receives an 'Error acquiring the state lock'" },
      { id: 'D', text: "By queuing the second user in an SQS message queue" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "terraform force-unlock &lt;LOCK-ID&gt;" },
      { id: 'C', text: "terraform unlock --all" },
      { id: 'D', text: "terraform state unlock" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Standard backends do not support locking" },
      { id: 'B', text: "Standard backends run in RAM; Enhanced backends run on disk" },
      { id: 'C', text: "A Standard backend only stores state and provides locking (e.g. S3, GCS, azurerm); an Enhanced backend also supports remote plan and apply execution (e.g. Terraform Cloud / remote)" },
      { id: 'D', text: "Standard backends are free; Enhanced backends require enterprise licenses" }
    ],
    correctAnswers: ['C'],
    type: "single",
