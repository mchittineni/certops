export const HASHICORP_TFA_QUESTIONS_11 = [
  {
    ...
    domainId: "d1",
    domainName: "Infrastructure as Code (IaC) with Terraform",
  ...
  },
  {
    ...
    correctAnswers: ['B'],
    type: "single",
    explanation: "Run `terraform plan` (or `terraform plan -refresh-only` to review drift alone) to compare real-world infrastructure against the state and configuration, highlighting drift for remediation. Configuration drift occurs when real-world resources are altered out-of-band (via console, CLI, or other tools). Running `terraform plan` refreshes the state against live cloud APIs, detecting differences between real infrastructure and code, and proposing actions to reconcile drift.",
