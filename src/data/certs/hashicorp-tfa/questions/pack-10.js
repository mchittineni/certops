export const HASHICORP_TFA_QUESTIONS_10 = [
  {
    ...
    options: [
      { id: 'A', text: "find(\"assets/*.png\")" },
      { id: 'B', text: "filelist(\"assets/*.png\")" },
      { id: 'C', text: "fileset(path.module, \"assets/*.png\")" },
      { id: 'D', text: "glob(\"assets/*.png\")" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "path.cwd represents the cloud provider datacenter" },
      { id: 'B', text: "path.module is the filesystem path to the current module; path.root is the path to the root module; path.cwd is the current working directory where the CLI was invoked" },
      { id: 'C', text: "path.module is the root module; path.root is the child module" },
      { id: 'D', text: "All three are identical aliases" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "# only" },
      { id: 'B', text: "REM and :: only" },
      { id: 'C', text: "-- (single-line), % (single-line), and <!-- -->" },
      { id: 'D', text: "# (single-line), // (single-line), and /* */ (multi-line block)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Indented heredoc encrypts the text; standard heredoc leaves it in plaintext" },
      { id: 'B', text: "Indented heredoc converts text to uppercase" },
      { id: 'C', text: "Indented heredoc (&lt;&lt;-EOT) strips leading indentation spaces from each line in the resulting string; standard heredoc (&lt;&lt;EOT) preserves all leading spaces literally" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It restricts values to numbers only" },
      { id: 'B', text: "It serves as a wildcard placeholder that accepts any data type and dynamically infers the actual type from the assigned value" },
      { id: 'C', text: "It disables type checking across the entire project" },
      { id: 'D', text: "It enforces that the value must be a boolean" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Structural types cannot be nested" },
      { id: 'C', text: "Collection types require all elements to be of the exact same type; Structural types allow elements to have different, heterogeneous types" },
      { id: 'D', text: "Collection types are only for numbers; Structural types are only for strings" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "encrypt(var.api_key)" },
      { id: 'B', text: "protect(var.api_key)" },
      { id: 'C', text: "sensitive(var.api_key)" },
      { id: 'D', text: "hide(var.api_key)" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "unmask(var.secret_val)" },
      { id: 'B', text: "nonsensitive(var.secret_val)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "array(var.my_set)" },
      { id: 'B', text: "tolist(var.my_set)" },
      { id: 'C', text: "list(var.my_set)" },
      { id: 'D', text: "as_list(var.my_set)" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "0" },
      { id: 'C', text: "2" },
      { id: 'D', text: "3 (rounds up to the nearest integer)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "swap(\"ubuntu/22.04/lts\", \"/\", \"-\")" },
      { id: 'B', text: "regex_replace(\"ubuntu/22.04/lts\", \"/\", \"-\")" },
      { id: 'C', text: "substitute(\"ubuntu/22.04/lts\", \"/\", \"-\")" },
      { id: 'D', text: "replace(\"ubuntu/22.04/lts\", \"/\", \"-\")" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "md5(\"lambda.zip\")" },
      { id: 'C', text: "base64sha256(\"lambda.zip\")" },
      { id: 'D', text: "sha256(file(\"lambda.zip\"))" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "list_keys() and list_values()" },
      { id: 'B', text: "map_keys() and map_values()" },
      { id: 'C', text: "keys(var.tags) and values(var.tags)" },
      { id: 'D', text: "get_keys() and get_values()" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "includes([\"us-east-1\", ...], var.region)" },
      { id: 'B', text: "contains([\"us-east-1\", \"us-west-2\", \"eu-west-1\"], var.region)" },
      { id: 'C', text: "in(var.region, [\"us-east-1\", ...])" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "take(var.cidrs, 3)" },
      { id: 'B', text: "cut(var.cidrs, 0, 3)" },
      { id: 'C', text: "slice(var.cidrs, 0, 3)" },
      { id: 'D', text: "substr(var.cidrs, 0, 3)" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "length() returns a boolean" },
      { id: 'C', text: "length() only works on lists; it fails on strings" },
      { id: 'D', text: "length() returns the memory byte size" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "trim(\"  ami-12345678  \")" },
      { id: 'B', text: "clean(\"  ami-12345678  \")" },
      { id: 'C', text: "strip(\"  ami-12345678  \")" },
      { id: 'D', text: "trimspace(\"  ami-12345678  \")" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "try(var.custom_env, local.default_env, \"dev\")" },
      { id: 'C', text: "first(var.custom_env, local.default_env, \"dev\")" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "coalesce(var.custom_subnets, local.default_subnets)" },
      { id: 'B', text: "coalescelist(var.custom_subnets, local.default_subnets)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "exists(\"${path.module}/custom.json\")" },
      { id: 'B', text: "isfile(\"${path.module}/custom.json\")" },
      { id: 'C', text: "test_file(\"${path.module}/custom.json\")" },
      { id: 'D', text: "fileexists(\"${path.module}/custom.json\")" }
    ],
    correctAnswers: ['D'],
    type: "single",
