export const HASHICORP_TFA_QUESTIONS_10 = [
  {
    ...
    options: [
      { id: 'A', text: "filelist(\"assets/*.png\")" },
      { id: 'B', text: "find(\"assets/*.png\")" },
      { id: 'C', text: "glob(\"assets/*.png\")" },
      { id: 'D', text: "fileset(path.module, \"assets/*.png\")" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "sensitive(var.api_key)" },
      { id: 'B', text: "protect(var.api_key)" },
      { id: 'C', text: "hide(var.api_key)" },
      { id: 'D', text: "encrypt(var.api_key)" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "as_list(var.my_set)" },
      { id: 'B', text: "list(var.my_set)" },
      { id: 'C', text: "tolist(var.my_set)" },
      { id: 'D', text: "array(var.my_set)" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "regex_replace(\"ubuntu/22.04/lts\", \"/\", \"-\")" },
      { id: 'B', text: "swap(\"ubuntu/22.04/lts\", \"/\", \"-\")" },
      { id: 'C', text: "replace(\"ubuntu/22.04/lts\", \"/\", \"-\")" },
      { id: 'D', text: "substitute(\"ubuntu/22.04/lts\", \"/\", \"-\")" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "base64sha256(\"lambda.zip\")" },
      { id: 'C', text: "sha256(file(\"lambda.zip\"))" },
      { id: 'D', text: "md5(\"lambda.zip\")" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "keys(var.tags) and values(var.tags)" },
      { id: 'B', text: "map_keys() and map_values()" },
      { id: 'C', text: "get_keys() and get_values()" },
      { id: 'D', text: "list_keys() and list_values()" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "test_file(\"${path.module}/custom.json\")" },
      { id: 'B', text: "fileexists(\"${path.module}/custom.json\")" },
      { id: 'C', text: "exists(\"${path.module}/custom.json\")" },
      { id: 'D', text: "isfile(\"${path.module}/custom.json\")" }
    ],
    correctAnswers: ['B'],
    type: "single",
