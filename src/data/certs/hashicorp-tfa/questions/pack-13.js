export const HASHICORP_TFA_QUESTIONS_13 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Use a `data \"aws_vpc\" \"default\" { default = true }` or `data \"aws_ami\" \"ubuntu\"` block to query live AWS APIs at plan time." },
      { id: 'D', text: "Create a duplicate VPC resource using `resource \"aws_vpc\"`." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Run external bash scripts to fetch IDs and paste them into `.tf` files by hand." },
      { id: 'C', text: "Use a `data \"aws_vpc\" \"default\" { default = true }` or `data \"aws_ami\" \"ubuntu\"` block to query live AWS APIs at plan time." },
      { id: 'D', text: "Create a duplicate VPC resource using `resource \"aws_vpc\"`." }
    ],
    correctAnswers: ['C'],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run external bash scripts to fetch IDs and paste them into `.tf` files by hand." },
      { id: 'B', text: "Use a `data \"aws_vpc\" \"default\" { default = true }` or `data \"aws_ami\" \"ubuntu\"` block to query live AWS APIs at plan time." },
      { id: 'C', text: "Hardcode static AMI string IDs directly in the resource definition." },
      { id: 'D', text: "Create a duplicate VPC resource using `resource \"aws_vpc\"`." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run external bash scripts to fetch IDs and paste them into `.tf` files by hand." },
      { id: 'B', text: "Create a duplicate VPC resource using `resource \"aws_vpc\"`." },
      { id: 'C', text: "Use a `data \"aws_vpc\" \"default\" { default = true }` or `data \"aws_ami\" \"ubuntu\"` block to query live AWS APIs at plan time." },
      { id: 'D', text: "Hardcode static AMI string IDs directly in the resource definition." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Use a `data \"aws_vpc\" \"default\" { default = true }` or `data \"aws_ami\" \"ubuntu\"` block to query live AWS APIs at plan time. Data sources allow Terraform to read information from external resources or infrastructure defined outside of the current Terraform configuration. At plan/apply time, data blocks query cloud provider APIs and expose resource attributes (like VPC IDs, subnets, AMIs) for use by managed resources.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Hardcode environment names inside resource blocks to prevent variables." },
      { id: 'C', text: "Define a `validation` block inside the `variable` definition with a `condition` and meaningful `error_message`." },
      { id: 'D', text: "Write a custom shell script that validates variable values outside of Terraform." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Accept any string value and let the cloud provider API fail during apply." },
      { id: 'C', text: "Define a `validation` block inside the `variable` definition with a `condition` and meaningful `error_message`." },
      { id: 'D', text: "Write a custom shell script that validates variable values outside of Terraform." }
    ],
    correctAnswers: ['C'],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Define a `validation` block inside the `variable` definition with a `condition` and meaningful `error_message`." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Define an `output \"db_password\"` block with `value = aws_db_instance.db.password` and `sensitive = true`." },
      { id: 'C', text: "Never use outputs for sensitive data." },
      { id: 'D', text: "Echo the password to a plaintext file on the local file system." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable output values entirely in the Terraform root configuration." },
      { id: 'B', text: "Echo the password to a plaintext file on the local file system." },
      { id: 'C', text: "Never use outputs for sensitive data." },
      { id: 'D', text: "Define an `output \"db_password\"` block with `value = aws_db_instance.db.password` and `sensitive = true`." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Define an `output \"db_password\"` block with `value = aws_db_instance.db.password` and `sensitive = true`. Output values expose resource attributes to parent modules or CLI users upon apply. Setting `sensitive = true` prevents Terraform from displaying the value in `terraform plan` and `terraform apply` terminal output, although the value is still preserved in the state file.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Echo the password to a plaintext file on the local file system." },
      { id: 'C', text: "Disable output values entirely in the Terraform root configuration." },
      { id: 'D', text: "Define an `output \"db_password\"` block with `value = aws_db_instance.db.password` and `sensitive = true`." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Manually download provider zip files from the web browser." },
      { id: 'D', text: "Run `terraform init` and commit the generated `.terraform.lock.hcl` dependency lockfile to Git source control." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Run `terraform init` and commit the generated `.terraform.lock.hcl` dependency lockfile to Git source control." },
      { id: 'D', text: "Run `terraform plan` before initializing the directory." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Run `terraform init` and commit the generated `.terraform.lock.hcl` dependency lockfile to Git source control. `terraform init` initializes the working directory, downloads required provider plugins, and configures the backend. It generates or updates the `.terraform.lock.hcl` file, which records cryptographic hashes of downloaded providers to ensure consistent, deterministic provider binaries across environments.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Add `.terraform.lock.hcl` to `.gitignore` so every machine downloads random provider versions." },
      { id: 'B', text: "Run `terraform init` and commit the generated `.terraform.lock.hcl` dependency lockfile to Git source control." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Save the plan output as a text file and pipe it into bash." },
      { id: 'C', text: "Take a screenshot of the plan output and apply code manually from a laptop." },
      { id: 'D', text: "Run `terraform plan -out=tfplan` in the validation stage and pass the `tfplan` binary artifact to `terraform apply tfplan` in the deployment stage." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Take a screenshot of the plan output and apply code manually from a laptop." },
      { id: 'C', text: "Run `terraform apply -auto-approve` without generating or reviewing an execution plan." },
      { id: 'D', text: "Run `terraform plan -out=tfplan` in the validation stage and pass the `tfplan` binary artifact to `terraform apply tfplan` in the deployment stage." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run `terraform apply -auto-approve` without generating or reviewing an execution plan." },
      { id: 'B', text: "Run `terraform plan -out=tfplan` in the validation stage and pass the `tfplan` binary artifact to `terraform apply tfplan` in the deployment stage." },
      { id: 'C', text: "Take a screenshot of the plan output and apply code manually from a laptop." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Take a screenshot of the plan output and apply code manually from a laptop." },
      { id: 'C', text: "Save the plan output as a text file and pipe it into bash." },
      { id: 'D', text: "Run `terraform apply -auto-approve` without generating or reviewing an execution plan." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Run `terraform plan -out=tfplan` in the validation stage and pass the `tfplan` binary artifact to `terraform apply tfplan` in the deployment stage. `terraform plan` determines what actions are necessary to achieve the desired state. Using `-out=filename` saves the calculated execution plan to disk as a binary artifact. Applying that specific plan file (`terraform apply tfplan`) guarantees that only the exact reviewed changes are executed.",
