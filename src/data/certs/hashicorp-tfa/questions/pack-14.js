export const HASHICORP_TFA_QUESTIONS_14 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Execute `terraform apply -auto-approve` or apply a pre-generated plan file (`terraform apply tfplan`)." },
      { id: 'C', text: "Run `terraform destroy` followed by `terraform init`." },
      { id: 'D', text: "Run `terraform apply` and write a custom expect script to type 'yes'." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Execute `terraform apply -auto-approve` or apply a pre-generated plan file (`terraform apply tfplan`)." },
      { id: 'D', text: "Disable all confirmation prompts by modifying the Terraform Go binary." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Execute `terraform apply -auto-approve` or apply a pre-generated plan file (`terraform apply tfplan`). In interactive terminal sessions, `terraform apply` prompts the user to review the plan and type `yes` before modifying infrastructure. In automated CI/CD pipelines, passing `-auto-approve` skips this prompt, executing the planned actions immediately without interactive blocking.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Delete the Terraform state file from the remote S3 bucket." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Delete the Terraform state file from the remote S3 bucket." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Assume developer text editors always produce canonical HCL formatting." },
      { id: 'C', text: "Run `terraform apply` against production to see if syntax errors exist." },
      { id: 'D', text: "Use a generic JSON linter that cannot parse HCL." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Run `terraform fmt -check` to verify canonical style and `terraform validate` to verify syntax, types, and resource attributes." },
      { id: 'C', text: "Run `terraform apply` against production to see if syntax errors exist." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Log into the cloud console to find the instance IP by hand." },
      { id: 'C', text: "Run `terraform plan` and parse terminal text output with regex." },
      { id: 'D', text: "Execute `terraform output -raw instance_public_ip` to extract the raw string value." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Log into the cloud console to find the instance IP by hand." },
      { id: 'C', text: "Open the `.tfstate` JSON file with vi and manually copy-paste the IP." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Run `cat terraform.tfstate` and scroll through thousands of lines of JSON." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Run `cat terraform.tfstate` and scroll through thousands of lines of JSON." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run `terraform destroy` to see what resources get listed." },
      { id: 'B', text: "Run `terraform state list` to see all resource addresses, and `terraform state show aws_security_group.web` to view attributes." },
      { id: 'C', text: "Run `cat terraform.tfstate` and scroll through thousands of lines of JSON." },
      { id: 'D', text: "Open the remote S3 state file in an external hex editor." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Run `terraform state list` to see all resource addresses, and `terraform state show aws_security_group.web` to view attributes. The `terraform state` command family allows safe inspection and modification of the state file. `state list` displays all tracked resource addresses, and `state show` prints the complete set of recorded attributes for a specific resource without modifying the state.",
