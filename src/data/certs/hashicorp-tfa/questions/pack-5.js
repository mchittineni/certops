export const HASHICORP_TFA_QUESTIONS_5 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: ".terraform.lock.hcl alone" },
      { id: 'B', text: ".terraform directory" },
      { id: 'C', text: "src/ directory" },
      { id: 'D', text: "terraform.tfstate" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "terraform state rm is only supported in HCP Terraform" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "-refresh=false" },
      { id: 'B', text: "-no-refresh" },
      { id: 'C', text: "-skip-api" },
      { id: 'D', text: "-fast-plan" }
    ],
    correctAnswers: ['A'],
  ...
  },
  {
    ...
    scenario: "A developer runs `terraform login` to authenticate with HCP Terraform or a private module registry.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "It deletes the user's HCP Terraform account permanently" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "source = \"modules/database\" (without leading dot-slash)" },
      { id: 'B', text: "source = \"local::modules/database\"" },
      { id: 'C', text: "source = \"file://modules/database\"" },
      { id: 'D', text: "source = \"./modules/database\" (or \"../modules/database\")" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "terraform init -upgrade (or terraform get -update)" },
      { id: 'D', text: "terraform module update (or module get)" }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "`terraform init` installs child modules into `.terraform/modules`, but it does not refetch a module that is already installed. `terraform init -upgrade` re-downloads modules (and upgrades providers within their constraints), and `terraform get -update` refreshes only the modules.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Using a while loop in HCL" },
      { id: 'B', text: "By declaring the for_each meta-argument inside the module block" },
      { id: 'C', text: "By duplicating the module block 3 times manually" },
      { id: 'D', text: "Modules do not support for_each" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "if = var.enable_monitoring" },
      { id: 'B', text: "enabled = var.enable_monitoring" },
      { id: 'C', text: "conditional = var.enable_monitoring" },
      { id: 'D', text: "count = var.enable_monitoring ? 1 : 0" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "aws_provider = aws.west" },
      { id: 'B', text: "providers = { aws = aws.west }" },
      { id: 'C', text: "provider = aws.west" },
      { id: 'D', text: "provider_alias = aws.west" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Under the S3 key path prefix: env:/&lt;WORKSPACE_NAME&gt;/&lt;key&gt;" },
      { id: 'B', text: "In completely separate S3 buckets per workspace" },
      { id: 'C', text: "In the root of the bucket with workspace name as filename" },
      { id: 'D', text: "S3 backend does not support workspaces" }
    ],
    correctAnswers: ['A'],
    type: "single",
