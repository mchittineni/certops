export const HASHICORP_TFA_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "dict(name, \"engineering\")" },
      { id: 'B', text: "map(\"alice\", \"bob\", \"engineering\")" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "filter([10, 15, 20, 25, 30], n > 18)" },
      { id: 'B', text: "[for n in [10, 15, 20, 25, 30] : n if n > 18]" },
      { id: 'C', text: "[for n in [10, 15, 20, 25, 30] : n ? n > 18]" },
      { id: 'D', text: "[for n in [10, 15, 20, 25, 30] where n > 18]" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "if var.environment == \"prod\" then \"m5.large\" else \"t3.micro\"" },
      { id: 'C', text: "switch(var.environment, \"prod\" => \"m5.large\", \"t3.micro\")" },
      { id: 'D', text: "case(var.environment, \"prod\", \"m5.large\", \"t3.micro\")" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "distinct([[1, 2], [3, 4], [5]])" },
      { id: 'B', text: "flatten([[1, 2], [3, 4], [5]])" },
      { id: 'C', text: "collapse([[1, 2], [3, 4], [5]])" },
      { id: 'D', text: "merge([[1, 2], [3, 4], [5]])" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "concat(local.app_sgs, local.db_sgs)" },
      { id: 'B', text: "merge(local.app_sgs, local.db_sgs)" },
      { id: 'C', text: "join(local.app_sgs, local.db_sgs)" },
      { id: 'D', text: "append(local.app_sgs, local.db_sgs)" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "find(var.ami_map, \"eu-central-1\", \"ami-default\")" },
      { id: 'B', text: "var.ami_map[\"eu-central-1\"] || \"ami-default\"" },
      { id: 'C', text: "get(var.ami_map, \"eu-central-1\", \"ami-default\")" },
      { id: 'D', text: "lookup(var.ami_map, \"eu-central-1\", \"ami-default\")" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "get([\"zone-a\", \"zone-b\"], count.index)" },
      { id: 'B', text: "slice([\"zone-a\", \"zone-b\"], count.index)" },
      { id: 'C', text: "lookup([\"zone-a\", \"zone-b\"], count.index)" },
      { id: 'D', text: "element([\"zone-a\", \"zone-b\"], count.index)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "try(var.config.spec.database.credentials.port, 5432)" },
      { id: 'B', text: "catch(var.config.spec.database.credentials.port, 5432)" },
      { id: 'C', text: "fallback(var.config.spec.database.credentials.port, 5432)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "formatdate(\"YYYY-MM-DD\", timestamp())" },
      { id: 'B', text: "dateformat(\"YYYY-MM-DD\", timestamp())" },
      { id: 'C', text: "strftime(\"YYYY-MM-DD\", timestamp())" },
