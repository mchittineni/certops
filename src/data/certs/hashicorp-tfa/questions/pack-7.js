export const HASHICORP_TFA_QUESTIONS_7 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "lineage (unique UUID representing the project's identity) and serial (monotonically incrementing integer tracking changes)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Terraform halts the second apply with 'Error: Error acquiring the state lock', displaying the lock ID, owner, and timestamp" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Manual edits easily corrupt JSON syntax, desynchronize lineage/serial tracking, and cause irreversible state corruption and resource loss" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "By passing -backend-config flags (e.g. terraform init -backend-config=\"bucket=my-prod-bucket\") or a config file" },
      { id: 'B', text: "By setting TF_VAR_backend_bucket" },
      { id: 'C', text: "By passing -var=\"bucket=my-bucket\"" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It tracks the internal provider schema version used when the resource was saved, allowing providers to perform automated state migrations during provider upgrades" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "terraform { backend \"cloud_storage\" { bucket = \"...\" } }" },
      { id: 'D', text: "terraform { backend \"gcp\" { bucket = \"...\" } }" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "terraform { backend \"azurerm\" { resource_group_name = \"rg\" storage_account_name = \"sa\" container_name = \"tfstate\" key = \"prod.tfstate\" } }" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Terraform refreshes state, notes that the cloud instance has the tag, and plans an in-place update (~ update) to remove the tag to match the declared HCL code" },
