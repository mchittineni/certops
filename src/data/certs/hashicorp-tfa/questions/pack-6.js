export const HASHICORP_TFA_QUESTIONS_6 = [
  {
    ...
    options: [
      { id: 'A', text: "env.WORKSPACE" },
      { id: 'B', text: "var.workspace" },
      { id: 'C', text: "terraform.workspace" },
      { id: 'D', text: "workspace.name" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "terraform workspace drop feature-x" },
      { id: 'B', text: "terraform workspace delete feature-x" },
      { id: 'C', text: "terraform workspace clear feature-x" },
      { id: 'D', text: "terraform workspace rm feature-x" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "#modules/vpc fragment identifier" },
      { id: 'C', text: "Single slash / e.g. .../infrastructure.git/modules/vpc" },
      { id: 'D', text: "Query parameter ?path=modules/vpc" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "app.tf, vars.tf, and return.tf" },
      { id: 'C', text: "index.tf, config.tf, and export.tf" },
      { id: 'D', text: "module.tf, input.tf, and result.tf" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "private = true" },
      { id: 'B', text: "mask = true" },
      { id: 'C', text: "hidden = true" },
      { id: 'D', text: "sensitive = true inside the output block" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "after = [module.eks_cluster]" },
      { id: 'B', text: "order = 2" },
      { id: 'C', text: "wait_for = [module.eks_cluster]" },
      { id: 'D', text: "depends_on = [module.eks_cluster] inside the module \"kubernetes_apps\" block" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "NFS mount paths" },
      { id: 'B', text: "FTP servers (ftp://...)" },
      { id: 'C', text: "Docker images (docker://...)" },
      { id: 'D', text: "Amazon S3 buckets (s3::https://s3.amazonaws.com/bucket/module.zip) and GCS buckets (gcs::https://...)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "By using a Sentinel policy only" },
      { id: 'B', text: "By defining a validation block with condition = contains([\"dev\", \"stage\", \"prod\"], var.environment_type) and error_message" },
      { id: 'C', text: "Variable validation is not supported in modules" },
      { id: 'D', text: "By writing a bash script in main.tf" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "nullable(number, 9090)" },
      { id: 'B', text: "maybe(number, 9090)" },
      { id: 'C', text: "default(number, 9090)" },
      { id: 'D', text: "optional(number, 9090)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "No, cross-module migrations require deleting the resource" },
      { id: 'B', text: "Yes, moved blocks support moving resources between root modules and child modules (e.g. from = aws_security_group.sg to = module.network.aws_security_group.sg)" },
      { id: 'C', text: "No, moved blocks only work within the exact same file" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The oldest release" },
      { id: 'B', text: "The latest available stable release of the module in the registry" },
      { id: 'C', text: "Version 1.0.0 always" },
      { id: 'D', text: "Terraform refuses to run without an explicit version" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Running terraform with -var=\"env=prod\" from a developer's laptop" },
      { id: 'C', text: "A single directory using CLI workspaces (terraform workspace)" },
      { id: 'D', text: "A single main.tf file with ternary operators" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Terraform automatically converts all variables to strings" },
      { id: 'B', text: "Global variables slow down network transfer speed" },
      { id: 'C', text: "Variables in child modules are prohibited" },
      { id: 'D', text: "Child modules have their own independent variable namespace; undeclared variables cause syntax compilation errors during terraform validate" }
    ],
    correctAnswers: ['D'],
    type: "single",
