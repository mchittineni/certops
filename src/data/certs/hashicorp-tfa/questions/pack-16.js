export const HASHICORP_TFA_QUESTIONS_16 = [
  {
    ...
    options: [
      { id: 'A', text: "Pass the CIDR in the module input arguments and reference the result via `module.vpc.vpc_id`." },
      { id: 'B', text: "Reference child module resources directly using `aws_vpc.this.id`." },
      { id: 'C', text: "Write the VPC ID to a text file on the local machine and read it with a script." },
      { id: 'D', text: "Child module resources are globally accessible from any file without outputs." }
    ],
    correctAnswers: ['A'],
    type: "single",
