export const HASHICORP_TFA_FLASHCARDS_6 = [
  ...
  },
  {
    ...
    back: "CLI workspaces <strong>share credentials and backends</strong>; use completely separate directories or HCP Terraform workspaces to isolate Dev and Prod safely.",
