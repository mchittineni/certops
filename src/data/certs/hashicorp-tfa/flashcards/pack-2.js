export const HASHICORP_TFA_FLASHCARDS_2 = [
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d8",
    front: "HCP Terraform: Remote Execution",
    hint: "Offloading CLI runs to cloud container runners.",
    back: "In HCP Terraform, <strong>plan and apply execute remotely</strong> in managed container runners, centralizing credentials, state locking, and execution logs.",
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d8",
    front: "HCP Terraform: Private Module Registry",
    hint: "Curating internal organizational modules.",
    back: "The <strong>Private Module Registry</strong> in HCP Terraform securely hosts internal, versioned modules with automated docs and access controls.",
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d8",
    front: "HCP Terraform: Workspaces",
    hint: "Comprehensive operational and state units.",
    back: "A <strong>HCP Terraform Workspace</strong> bundles configuration, state, variables, credentials, run history, and access policies into an autonomous management unit.",
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d8",
    front: "HCP Terraform: Speculative Plans in VCS",
    hint: "Automated plan validation on pull requests.",
    back: "HCP Terraform automatically runs <strong>speculative plans on pull requests</strong>, displaying proposed resource changes directly on GitHub/GitLab before merging.",
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d8",
    front: "HCP Terraform: Speculative Plans are Read-Only",
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d6",
    front: "Terraform S3 Backend: State Locking",
    hint: "Preventing concurrent race conditions.",
    back: "Set <code>use_lockfile = true</code> in the S3 backend (Terraform 1.10+) to lock state with a <code>.tflock</code> object in the bucket. Locking through a <strong>DynamoDB table</strong> (<code>dynamodb_table</code>) still works but is deprecated.",
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d6",
    front: "backend Block vs cloud Block",
    hint: "State storage vs remote execution.",
    back: "A <strong>backend</strong> block (S3, GCS, AzureRM) only stores and locks state; runs stay local. The <strong>cloud</strong> block connects to HCP Terraform, which also executes runs remotely. (Older docs called these standard and enhanced backends.)",
