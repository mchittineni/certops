export const HASHICORP_TFA_FLASHCARDS_3 = [
  {
    ...
    domainId: "d8",
    front: "HCP Terraform: Supported Cost Estimation Providers",
    hint: "AWS, Azure, and Google Cloud.",
    back: "HCP Terraform natively computes cost deltas for <strong>AWS, Microsoft Azure, and GCP</strong> workloads prior to execution.",
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d8",
    front: "HCP Terraform: Audit Trail API",
    hint: "Streaming governance events to enterprise SIEMs.",
    back: "The <strong>Audit Trail API</strong> in HCP Terraform streams tamper-proof event logs (who ran plans, modified secrets, or read state) to external SIEM platforms.",
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d8",
    front: "HCP Terraform: Run Triggers",
    hint: "Automating downstream workspace runs.",
    back: "Configure <strong>Run Triggers</strong> in HCP Terraform to automatically execute runs in downstream workspaces when upstream infrastructure changes.",
  ...
  },
  {
    ...
    back: "<strong>Terraform Enterprise (TFE)</strong> delivers self-hosted HCP Terraform capabilities inside private datacenters for strict regulatory compliance.",
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d8",
    front: "HCP Terraform: Agents (TFC Agents)",
    hint: "Provisioning private infrastructure via outbound polling.",
    back: "Deploy <strong>HCP Terraform agents</strong> in private networks to execute runs locally via outbound-only HTTPS without opening inbound firewall ports.",
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d8",
    front: "HCP Terraform: Variable Sets",
    hint: "Centrally sharing credentials across workspaces.",
    back: "Use <strong>Variable Sets</strong> in HCP Terraform to centrally manage and share credentials across multiple workspaces without duplication.",
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d8",
    front: "HCP Terraform: Sensitive Variables",
    hint: "Masking secrets in the UI and API.",
    back: "Mark variables as <strong>Sensitive</strong> in HCP Terraform to permanently mask values from the console UI and API responses.",
  ...
  },
  {
    ...
    certId: "hashicorp-tfa",
    domainId: "d8",
    front: "HCP Terraform: Workspace Permissions",
