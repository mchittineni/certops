export const HASHICORP_TFA_FLASHCARDS_7 = [
  ...
  },
  {
    ...
    hint: "GCS, Azure Blob, S3 lockfiles, and HCP Terraform.",
    back: "Native locking is provided by <strong>GCS, AzureRM, HCP Terraform, and S3</strong> (<code>use_lockfile = true</code> since 1.10; DynamoDB-table locking is deprecated).",
  ...
  },
  {
    ...
    hint: "Native HCP Terraform backend configuration.",
    back: "Use the <strong>terraform { cloud { ... } }</strong> block in Terraform 1.1+ to configure HCP Terraform organizations and workspaces cleanly.",
    tags: ["Terraform 1.1+", "cloud Block", "HCP Terraform"]
  },
  {
