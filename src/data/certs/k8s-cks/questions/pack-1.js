export const K8S_CKS_QUESTIONS_1 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure <code>--service-account-issuer</code>, <code>--service-account-key-file</code>, <code>--service-account-signing-key-file</code>, and <code>--api-audiences</code> on <code>kube-apiserver</code>" },
      { id: 'B', text: "Enable the <code>TokenRequestValidation</code> feature gate on all kubelet daemons across worker nodes" },
      { id: 'C', text: "Set <code>--service-account-lookup=false</code> and configure a custom etcd certificate bundle" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Set <code>--peer-client-cert-auth=true</code> and configure <code>--auto-tls=true</code>" },
      { id: 'C', text: "Set <code>--client-cert-auth=true</code>, <code>--trusted-ca-file</code>, <code>--cert-file</code>, and <code>--key-file</code>" },
      { id: 'D', text: "Set <code>--insecure-transport-security=false</code> and configure <code>--enable-v2=false</code>" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Specify <code>apiGroups: ['*']</code>, <code>resources: ['pods']</code>, and <code>verbs: ['*']</code>" },
      { id: 'B', text: "Specify <code>apiGroups: ['']</code>, <code>resources: ['pods', 'pods/log', 'pods/status']</code>, and <code>verbs: ['get', 'list', 'watch']</code>" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Ensure permissions are set to <code>0755</code> and owned by <code>nobody:nogroup</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The insecure port only accepts requests from the <code>system:masters</code> group over plain HTTP" },
      { id: 'C', text: "The insecure port forces all pods to communicate without NetworkPolicies" },
      { id: 'D', text: "The insecure port causes etcd to disable encryption at rest for all newly created secrets" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Ownership <code>root:admin</code> and permissions <code>0660</code>" },
      { id: 'B', text: "Ownership <code>etcd:etcd</code> and permissions <code>0400</code>" },
      { id: 'C', text: "Ownership <code>kubelet:root</code> and permissions <code>0640</code>" },
      { id: 'D', text: "Ownership <code>root:root</code> and permissions <code>0600</code> (or <code>chmod 600 /etc/kubernetes/admin.conf</code>)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Delete all existing secrets from etcd, restart <code>kube-apiserver</code> with the new key, and redeploy applications from Helm charts" },
      { id: 'B', text: "Change the provider name from <code>aescbc</code> to <code>identity</code>, restart <code>kube-apiserver</code>, and then add the new key" },
      { id: 'C', text: "Add the new key as the first entry under <code>keys</code> in the provider configuration, keep the old key as a secondary entry, restart <code>kube-apiserver</code>, rewrite all secrets with <code>kubectl get secrets -A -o json | kubectl replace -f -</code>, and finally remove the old key from the configuration file" },
      { id: 'D', text: "Replace the old key directly with the new key in <code>enc.yaml</code> and restart all control plane and worker nodes simultaneously" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure <code>--kubelet-port=10255</code> and disable <code>--kubelet-https</code>" },
      ...
      { id: 'D', text: "Configure <code>--kubelet-client-certificate</code>, <code>--kubelet-client-key</code>, and <code>--kubelet-certificate-authority</code>" }
    ],
    correctAnswers: ['D'],
    type: "single",
