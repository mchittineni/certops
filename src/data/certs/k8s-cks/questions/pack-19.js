export const K8S_CKS_QUESTIONS_19 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure an Audit Webhook backend in `kube-apiserver` (`--audit-webhook-config-file`) to stream audit events over HTTPS to the SIEM ingestion endpoint." },
      { id: 'B', text: "Manually download audit log text files once a week and upload them via email." },
      { id: 'C', text: "Store audit logs on a temporary worker node RAM disk." },
