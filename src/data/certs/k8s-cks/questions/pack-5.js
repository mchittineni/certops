export const K8S_CKS_QUESTIONS_5 = [
  ...
  },
  {
    ...
    title: "MutatingWebhookConfiguration injecting sidecars securely: Operational Strategy (Part 102)",
    scenario: "A healthcare telemedicine network is evaluating Certified Kubernetes Security Specialist practices specifically regarding MutatingWebhookConfiguration injecting sidecars securely. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #102.",
    ...
    options: [
      ...
      { id: 'C', text: "Deploy native automation for mutatingwebhookconfiguration injecting sidecars securely utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
  ...
  },
  {
    ...
    title: "etcd encryption at rest with EncryptionConfiguration: Operational Strategy (Part 103)",
  ...
  },
  {
    ...
    title: "Linux capabilities dropping ALL and adding NET_BIND_SERVICE: Operational Strategy (Part 104)",
    scenario: "A global streaming entertainment platform is evaluating Certified Kubernetes Security Specialist practices specifically regarding Linux capabilities dropping ALL and adding NET_BIND_SERVICE. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #104.",
  ...
  },
  {
    ...
    title: "Kubernetes Secret encryption with KMS plugin integration: Operational Strategy (Part 105)",
    scenario: "An algorithmic trading exchange is evaluating Certified Kubernetes Security Specialist practices specifically regarding Kubernetes Secret encryption with KMS plugin integration. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #105.",
  ...
  },
  {
    ...
    title: "Cosign cryptographic signature verification before deployment: Operational Strategy (Part 106)",
    scenario: "A logistics and supply chain optimization service is evaluating Certified Kubernetes Security Specialist practices specifically regarding Cosign cryptographic signature verification before deployment. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #106.",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Monitoring, Logging and Runtime Security",
    title: "Detecting container escape attempts and kernel exploitation: Operational Strategy (Part 107)",
    scenario: "An IoT industrial telematics infrastructure is evaluating Certified Kubernetes Security Specialist practices specifically regarding Detecting container escape attempts and kernel exploitation. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #107.",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Cluster Threat Defense and Admission Control",
    title: "Open Policy Agent Gatekeeper ConstraintTemplates and Constraints: Operational Strategy (Part 108)",
    scenario: "A multi-tenant enterprise SaaS provider is evaluating Certified Kubernetes Security Specialist practices specifically regarding Open Policy Agent Gatekeeper ConstraintTemplates and Constraints. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #108.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cluster Setup and Hardening",
    title: "API server authorization modes Node and RBAC: Operational Strategy (Part 109)",
    scenario: "A public sector aerospace engineering department is evaluating Certified Kubernetes Security Specialist practices specifically regarding API server authorization modes Node and RBAC. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #109.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "System Hardening and Kernel Security",
    title: "Restricting hostPath volume mounts with Pod Security Standards: Operational Strategy (Part 110)",
    scenario: "An automotive connected-vehicle fleet manager is evaluating Certified Kubernetes Security Specialist practices specifically regarding Restricting hostPath volume mounts with Pod Security Standards. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #110.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy native automation for serviceaccount automountserviceaccounttoken set to false utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'B', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'C', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'D', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." }
    ],
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Supply Chain Security and Static Analysis",
    title: "Base image minimization using Google distroless containers: Operational Strategy (Part 112)",
    scenario: "A pharmaceutical clinical trial data service is evaluating Certified Kubernetes Security Specialist practices specifically regarding Base image minimization using Google distroless containers. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #112.",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Monitoring, Logging and Runtime Security",
    title: "Analyzing suspicious network connections from compromised pods: Operational Strategy (Part 113)",
    scenario: "A renewable energy smart-grid operator is evaluating Certified Kubernetes Security Specialist practices specifically regarding Analyzing suspicious network connections from compromised pods. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #113.",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Cluster Threat Defense and Admission Control",
    title: "Kyverno cluster policies preventing privileged containers: Operational Strategy (Part 114)",
    scenario: "A mobile gaming backend architecture is evaluating Certified Kubernetes Security Specialist practices specifically regarding Kyverno cluster policies preventing privileged containers. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #114.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cluster Setup and Hardening",
    title: "Restricting anonymous authentication on kubelet port 10250: Operational Strategy (Part 115)",
    scenario: "A ride-sharing dispatch system is evaluating Certified Kubernetes Security Specialist practices specifically regarding Restricting anonymous authentication on kubelet port 10250. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #115.",
    ...
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'C', text: "Deploy native automation for restricting anonymous authentication on kubelet port 10250 utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'D', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "System Hardening and Kernel Security",
    title: "Disabling root user and privileged execution on worker nodes: Operational Strategy (Part 116)",
    scenario: "An insurance claims processing engine is evaluating Certified Kubernetes Security Specialist practices specifically regarding Disabling root user and privileged execution on worker nodes. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #116.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Minimize Microservice Vulnerabilities",
    title: "Bound service account token projection with audience validation: Operational Strategy (Part 117)",
    scenario: "A commercial airline reservation service is evaluating Certified Kubernetes Security Specialist practices specifically regarding Bound service account token projection with audience validation. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #117.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Supply Chain Security and Static Analysis",
    title: "Static manifest analysis using Kube-linter and Conftest: Operational Strategy (Part 118)",
    scenario: "A cybersecurity threat intelligence agency is evaluating Certified Kubernetes Security Specialist practices specifically regarding Static manifest analysis using Kube-linter and Conftest. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #118.",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Monitoring, Logging and Runtime Security",
    title: "Investigating node-level audit logs for unauthorized binary execution: Operational Strategy (Part 119)",
    scenario: "A real estate property management portal is evaluating Certified Kubernetes Security Specialist practices specifically regarding Investigating node-level audit logs for unauthorized binary execution. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #119.",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Cluster Threat Defense and Admission Control",
    title: "Restricting NodePort services across production namespaces: Operational Strategy (Part 120)",
    scenario: "An autonomous robotics manufacturing facility is evaluating Certified Kubernetes Security Specialist practices specifically regarding Restricting NodePort services across production namespaces. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #120.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "System Hardening and Kernel Security",
    title: "AppArmor profile enforcement via container annotations: Operational Strategy (Part 122)",
    scenario: "A global hotel hospitality reservation platform is evaluating Certified Kubernetes Security Specialist practices specifically regarding AppArmor profile enforcement via container annotations. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #122.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Minimize Microservice Vulnerabilities",
    title: "Pod Security Standards enforce baseline and restricted profiles: Operational Strategy (Part 123)",
    scenario: "A digital payments settlement processor is evaluating Certified Kubernetes Security Specialist practices specifically regarding Pod Security Standards enforce baseline and restricted profiles. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #123.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Supply Chain Security and Static Analysis",
    title: "Container image vulnerability scanning with Trivy in CI: Operational Strategy (Part 124)",
    scenario: "A genomics sequencing data pipeline is evaluating Certified Kubernetes Security Specialist practices specifically regarding Container image vulnerability scanning with Trivy in CI. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #124.",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Monitoring, Logging and Runtime Security",
    title: "Falco runtime security rules detecting shell spawns in pods: Operational Strategy (Part 125)",
    scenario: "A cloud-native telecommunications provider is evaluating Certified Kubernetes Security Specialist practices specifically regarding Falco runtime security rules detecting shell spawns in pods. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #125.",
