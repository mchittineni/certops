export const K8S_CKS_QUESTIONS_2 = [
  {
    ...
    title: "Disabling root user and privileged execution on worker nodes: Operational Strategy (Part 26)",
    scenario: "A multinational fintech banking platform is evaluating Certified Kubernetes Security Specialist practices specifically regarding Disabling root user and privileged execution on worker nodes. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #26.",
    ...
    options: [
      ...
      { id: 'C', text: "Deploy native automation for disabling root user and privileged execution on worker nodes utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
  ...
  },
  {
    ...
    title: "Bound service account token projection with audience validation: Operational Strategy (Part 27)",
    ...
    options: [
      ...
      { id: 'D', text: "Deploy native automation for bound service account token projection with audience validation utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    title: "Static manifest analysis using Kube-linter and Conftest: Operational Strategy (Part 28)",
    scenario: "A high-throughput e-commerce retailer is evaluating Certified Kubernetes Security Specialist practices specifically regarding Static manifest analysis using Kube-linter and Conftest. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #28.",
  ...
  },
  {
    ...
    title: "Investigating node-level audit logs for unauthorized binary execution: Operational Strategy (Part 29)",
    scenario: "A global streaming entertainment platform is evaluating Certified Kubernetes Security Specialist practices specifically regarding Investigating node-level audit logs for unauthorized binary execution. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #29.",
    ...
    options: [
      ...
      { id: 'B', text: "Deploy native automation for investigating node-level audit logs for unauthorized binary execution utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
  ...
  },
  {
    ...
    title: "Restricting NodePort services across production namespaces: Operational Strategy (Part 30)",
    scenario: "An algorithmic trading exchange is evaluating Certified Kubernetes Security Specialist practices specifically regarding Restricting NodePort services across production namespaces. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #30.",
    ...
    options: [
      { id: 'A', text: "Deploy native automation for restricting nodeport services across production namespaces utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'C', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'D', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." }
    ],
  ...
  },
  {
    ...
    title: "CIS Kubernetes Benchmark assessment with kube-bench: Operational Strategy (Part 31)",
    scenario: "A logistics and supply chain optimization service is evaluating Certified Kubernetes Security Specialist practices specifically regarding CIS Kubernetes Benchmark assessment with kube-bench. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #31.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Minimize Microservice Vulnerabilities",
    title: "Pod Security Standards enforce baseline and restricted profiles: Operational Strategy (Part 33)",
    scenario: "A multi-tenant enterprise SaaS provider is evaluating Certified Kubernetes Security Specialist practices specifically regarding Pod Security Standards enforce baseline and restricted profiles. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #33.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Supply Chain Security and Static Analysis",
    title: "Container image vulnerability scanning with Trivy in CI: Operational Strategy (Part 34)",
    scenario: "A public sector aerospace engineering department is evaluating Certified Kubernetes Security Specialist practices specifically regarding Container image vulnerability scanning with Trivy in CI. The engineering group is implementing automated canary analysis with instant rollback capabilities triggered by error budget burn rates for service tier #34.",
    ...
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'C', text: "Deploy native automation for container image vulnerability scanning with trivy in ci utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'D', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Monitoring, Logging and Runtime Security",
    title: "Falco runtime security rules detecting shell spawns in pods: Operational Strategy (Part 35)",
    scenario: "An automotive connected-vehicle fleet manager is evaluating Certified Kubernetes Security Specialist practices specifically regarding Falco runtime security rules detecting shell spawns in pods. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #35.",
    ...
    options: [
      ...
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'C', text: "Deploy native automation for falco runtime security rules detecting shell spawns in pods utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'D', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Cluster Threat Defense and Admission Control",
    title: "ValidatingWebhookConfiguration for policy admission enforcement: Operational Strategy (Part 36)",
    scenario: "A digital media publishing network is evaluating Certified Kubernetes Security Specialist practices specifically regarding ValidatingWebhookConfiguration for policy admission enforcement. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #36.",
    ...
    options: [
      ...
      { id: 'D', text: "Deploy native automation for validatingwebhookconfiguration for policy admission enforcement utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cluster Setup and Hardening",
    title: "NetworkPolicy default-deny ingress and egress rules: Operational Strategy (Part 37)",
    scenario: "A pharmaceutical clinical trial data service is evaluating Certified Kubernetes Security Specialist practices specifically regarding NetworkPolicy default-deny ingress and egress rules. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #37.",
    ...
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'C', text: "Deploy native automation for networkpolicy default-deny ingress and egress rules utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'D', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "System Hardening and Kernel Security",
    title: "Seccomp profile confinement with RuntimeDefault: Operational Strategy (Part 38)",
    scenario: "A renewable energy smart-grid operator is evaluating Certified Kubernetes Security Specialist practices specifically regarding Seccomp profile confinement with RuntimeDefault. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #38.",
    ...
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'C', text: "Deploy native automation for seccomp profile confinement with runtimedefault utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'D', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Minimize Microservice Vulnerabilities",
    title: "Configuring securityContext readOnlyRootFilesystem: Operational Strategy (Part 39)",
    scenario: "A mobile gaming backend architecture is evaluating Certified Kubernetes Security Specialist practices specifically regarding Configuring securityContext readOnlyRootFilesystem. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #39.",
    ...
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'C', text: "Deploy native automation for configuring securitycontext readonlyrootfilesystem utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'D', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Supply Chain Security and Static Analysis",
    title: "Image digest pinning using sha256 immutable references: Operational Strategy (Part 40)",
    scenario: "A ride-sharing dispatch system is evaluating Certified Kubernetes Security Specialist practices specifically regarding Image digest pinning using sha256 immutable references. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #40.",
    ...
    options: [
      { id: 'A', text: "Deploy native automation for image digest pinning using sha256 immutable references utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'C', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'D', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." }
    ],
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Monitoring, Logging and Runtime Security",
    title: "Kubernetes API server audit logging configuration: Operational Strategy (Part 41)",
    scenario: "An insurance claims processing engine is evaluating Certified Kubernetes Security Specialist practices specifically regarding Kubernetes API server audit logging configuration. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #41.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cluster Setup and Hardening",
    title: "etcd encryption at rest with EncryptionConfiguration: Operational Strategy (Part 43)",
    scenario: "A cybersecurity threat intelligence agency is evaluating Certified Kubernetes Security Specialist practices specifically regarding etcd encryption at rest with EncryptionConfiguration. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #43.",
    ...
    options: [
      { id: 'A', text: "Deploy native automation for etcd encryption at rest with encryptionconfiguration utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'C', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'D', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." }
    ],
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "System Hardening and Kernel Security",
    title: "Linux capabilities dropping ALL and adding NET_BIND_SERVICE: Operational Strategy (Part 44)",
    scenario: "A real estate property management portal is evaluating Certified Kubernetes Security Specialist practices specifically regarding Linux capabilities dropping ALL and adding NET_BIND_SERVICE. The engineering group is implementing automated canary analysis with instant rollback capabilities triggered by error budget burn rates for service tier #44.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Minimize Microservice Vulnerabilities",
    title: "Kubernetes Secret encryption with KMS plugin integration: Operational Strategy (Part 45)",
    scenario: "An autonomous robotics manufacturing facility is evaluating Certified Kubernetes Security Specialist practices specifically regarding Kubernetes Secret encryption with KMS plugin integration. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #45.",
    ...
    options: [
      ...
      { id: 'B', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'C', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'D', text: "Deploy native automation for kubernetes secret encryption with kms plugin integration utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Supply Chain Security and Static Analysis",
    title: "Cosign cryptographic signature verification before deployment: Operational Strategy (Part 46)",
    scenario: "A higher education student information system is evaluating Certified Kubernetes Security Specialist practices specifically regarding Cosign cryptographic signature verification before deployment. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #46.",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Monitoring, Logging and Runtime Security",
    title: "Detecting container escape attempts and kernel exploitation: Operational Strategy (Part 47)",
    scenario: "A global hotel hospitality reservation platform is evaluating Certified Kubernetes Security Specialist practices specifically regarding Detecting container escape attempts and kernel exploitation. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #47.",
    ...
    options: [
      { id: 'A', text: "Deploy native automation for detecting container escape attempts and kernel exploitation utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'C', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'D', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." }
    ],
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Cluster Threat Defense and Admission Control",
    title: "Open Policy Agent Gatekeeper ConstraintTemplates and Constraints: Operational Strategy (Part 48)",
    scenario: "A digital payments settlement processor is evaluating Certified Kubernetes Security Specialist practices specifically regarding Open Policy Agent Gatekeeper ConstraintTemplates and Constraints. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #48.",
    ...
    options: [
      ...
      { id: 'B', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'C', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'D', text: "Deploy native automation for open policy agent gatekeeper constrainttemplates and constraints utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cluster Setup and Hardening",
    title: "API server authorization modes Node and RBAC: Operational Strategy (Part 49)",
    scenario: "A genomics sequencing data pipeline is evaluating Certified Kubernetes Security Specialist practices specifically regarding API server authorization modes Node and RBAC. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #49.",
    ...
    options: [
      ...
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'C', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'D', text: "Deploy native automation for api server authorization modes node and rbac utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "System Hardening and Kernel Security",
    title: "Restricting hostPath volume mounts with Pod Security Standards: Operational Strategy (Part 50)",
    scenario: "A cloud-native telecommunications provider is evaluating Certified Kubernetes Security Specialist practices specifically regarding Restricting hostPath volume mounts with Pod Security Standards. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #50.",
