export const K8S_CKS_QUESTIONS_6 = [
  {
    ...
    title: "ValidatingWebhookConfiguration for policy admission enforcement: Operational Strategy (Part 126)",
    scenario: "A multinational fintech banking platform is evaluating Certified Kubernetes Security Specialist practices specifically regarding ValidatingWebhookConfiguration for policy admission enforcement. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #126.",
    ...
    options: [
      ...
      { id: 'B', text: "Deploy native automation for validatingwebhookconfiguration for policy admission enforcement utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
  ...
  },
  {
    ...
    title: "NetworkPolicy default-deny ingress and egress rules: Operational Strategy (Part 127)",
    scenario: "A healthcare telemedicine network is evaluating Certified Kubernetes Security Specialist practices specifically regarding NetworkPolicy default-deny ingress and egress rules. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #127.",
  ...
  },
  {
    ...
    title: "Seccomp profile confinement with RuntimeDefault: Operational Strategy (Part 128)",
  ...
  },
  {
    ...
    title: "Configuring securityContext readOnlyRootFilesystem: Operational Strategy (Part 129)",
    scenario: "A global streaming entertainment platform is evaluating Certified Kubernetes Security Specialist practices specifically regarding Configuring securityContext readOnlyRootFilesystem. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #129.",
  ...
  },
  {
    ...
    title: "Kubernetes API server audit logging configuration: Operational Strategy (Part 131)",
    scenario: "A logistics and supply chain optimization service is evaluating Certified Kubernetes Security Specialist practices specifically regarding Kubernetes API server audit logging configuration. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #131.",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Cluster Threat Defense and Admission Control",
    title: "MutatingWebhookConfiguration injecting sidecars securely: Operational Strategy (Part 132)",
    scenario: "An IoT industrial telematics infrastructure is evaluating Certified Kubernetes Security Specialist practices specifically regarding MutatingWebhookConfiguration injecting sidecars securely. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #132.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cluster Setup and Hardening",
    title: "etcd encryption at rest with EncryptionConfiguration: Operational Strategy (Part 133)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "System Hardening and Kernel Security",
    title: "Linux capabilities dropping ALL and adding NET_BIND_SERVICE: Operational Strategy (Part 134)",
    scenario: "A public sector aerospace engineering department is evaluating Certified Kubernetes Security Specialist practices specifically regarding Linux capabilities dropping ALL and adding NET_BIND_SERVICE. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #134.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Minimize Microservice Vulnerabilities",
    title: "Kubernetes Secret encryption with KMS plugin integration: Operational Strategy (Part 135)",
    scenario: "An automotive connected-vehicle fleet manager is evaluating Certified Kubernetes Security Specialist practices specifically regarding Kubernetes Secret encryption with KMS plugin integration. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #135.",
    ...
    options: [
      { id: 'A', text: "Deploy native automation for kubernetes secret encryption with kms plugin integration utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'C', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'D', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." }
    ],
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Supply Chain Security and Static Analysis",
    title: "Cosign cryptographic signature verification before deployment: Operational Strategy (Part 136)",
    scenario: "A digital media publishing network is evaluating Certified Kubernetes Security Specialist practices specifically regarding Cosign cryptographic signature verification before deployment. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #136.",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Monitoring, Logging and Runtime Security",
    title: "Detecting container escape attempts and kernel exploitation: Operational Strategy (Part 137)",
    scenario: "A pharmaceutical clinical trial data service is evaluating Certified Kubernetes Security Specialist practices specifically regarding Detecting container escape attempts and kernel exploitation. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #137.",
    ...
    options: [
      ...
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'C', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'D', text: "Deploy native automation for detecting container escape attempts and kernel exploitation utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Cluster Threat Defense and Admission Control",
    title: "Open Policy Agent Gatekeeper ConstraintTemplates and Constraints: Operational Strategy (Part 138)",
    scenario: "A renewable energy smart-grid operator is evaluating Certified Kubernetes Security Specialist practices specifically regarding Open Policy Agent Gatekeeper ConstraintTemplates and Constraints. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #138.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cluster Setup and Hardening",
    title: "API server authorization modes Node and RBAC: Operational Strategy (Part 139)",
    scenario: "A mobile gaming backend architecture is evaluating Certified Kubernetes Security Specialist practices specifically regarding API server authorization modes Node and RBAC. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #139.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "System Hardening and Kernel Security",
    title: "Restricting hostPath volume mounts with Pod Security Standards: Operational Strategy (Part 140)",
    scenario: "A ride-sharing dispatch system is evaluating Certified Kubernetes Security Specialist practices specifically regarding Restricting hostPath volume mounts with Pod Security Standards. The engineering group is implementing automated canary analysis with instant rollback capabilities triggered by error budget burn rates for service tier #140.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Deploy native automation for serviceaccount automountserviceaccounttoken set to false utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Supply Chain Security and Static Analysis",
    title: "Base image minimization using Google distroless containers: Operational Strategy (Part 142)",
    scenario: "A commercial airline reservation service is evaluating Certified Kubernetes Security Specialist practices specifically regarding Base image minimization using Google distroless containers. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #142.",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Monitoring, Logging and Runtime Security",
    title: "Analyzing suspicious network connections from compromised pods: Operational Strategy (Part 143)",
    scenario: "A cybersecurity threat intelligence agency is evaluating Certified Kubernetes Security Specialist practices specifically regarding Analyzing suspicious network connections from compromised pods. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #143.",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Cluster Threat Defense and Admission Control",
    title: "Kyverno cluster policies preventing privileged containers: Operational Strategy (Part 144)",
    scenario: "A real estate property management portal is evaluating Certified Kubernetes Security Specialist practices specifically regarding Kyverno cluster policies preventing privileged containers. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #144.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cluster Setup and Hardening",
    title: "Restricting anonymous authentication on kubelet port 10250: Operational Strategy (Part 145)",
    scenario: "An autonomous robotics manufacturing facility is evaluating Certified Kubernetes Security Specialist practices specifically regarding Restricting anonymous authentication on kubelet port 10250. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #145.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "System Hardening and Kernel Security",
    title: "Disabling root user and privileged execution on worker nodes: Operational Strategy (Part 146)",
    scenario: "A higher education student information system is evaluating Certified Kubernetes Security Specialist practices specifically regarding Disabling root user and privileged execution on worker nodes. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #146.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Minimize Microservice Vulnerabilities",
    title: "Bound service account token projection with audience validation: Operational Strategy (Part 147)",
    scenario: "A global hotel hospitality reservation platform is evaluating Certified Kubernetes Security Specialist practices specifically regarding Bound service account token projection with audience validation. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #147.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Supply Chain Security and Static Analysis",
    title: "Static manifest analysis using Kube-linter and Conftest: Operational Strategy (Part 148)",
    scenario: "A digital payments settlement processor is evaluating Certified Kubernetes Security Specialist practices specifically regarding Static manifest analysis using Kube-linter and Conftest. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #148.",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Monitoring, Logging and Runtime Security",
    title: "Investigating node-level audit logs for unauthorized binary execution: Operational Strategy (Part 149)",
    scenario: "A genomics sequencing data pipeline is evaluating Certified Kubernetes Security Specialist practices specifically regarding Investigating node-level audit logs for unauthorized binary execution. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #149.",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Cluster Threat Defense and Admission Control",
    title: "Restricting NodePort services across production namespaces: Operational Strategy (Part 150)",
    scenario: "A cloud-native telecommunications provider is evaluating Certified Kubernetes Security Specialist practices specifically regarding Restricting NodePort services across production namespaces. The engineering group is implementing automated canary analysis with instant rollback capabilities triggered by error budget burn rates for service tier #150.",
