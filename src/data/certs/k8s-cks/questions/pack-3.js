export const K8S_CKS_QUESTIONS_3 = [
  {
    ...
    options: [
      { id: 'A', text: "The container is automatically granted the <code>cluster-admin</code> RBAC role by the API server" },
      ...
      { id: 'C', text: "The container forces the node to reboot when its process finishes execution" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Configure an egress NetworkPolicy blocking UDP port 53" },
      { id: 'D', text: "Enable the <code>NodeRestriction</code> admission plugin on <code>kube-apiserver</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Load the profile in complain mode using <code>aa-complain &lt;profile-name&gt;</code> or pass the <code>-C</code> flag to <code>apparmor_parser</code>" },
      { id: 'B', text: "Set <code>enforce: false</code> inside the Pod <code>securityContext.appArmorProfile</code> block" },
      { id: 'C', text: "Annotate the pod with <code>container.apparmor.security.beta.kubernetes.io/mode: 'audit-only'</code>" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Execute <code>lsof -iTCP:9099 -sTCP:LISTEN -n -P</code>" },
      { id: 'C', text: "Execute <code>find / -name 9099</code>" },
      { id: 'D', text: "Execute <code>ip link show port 9099</code>" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Docker daemon with <code>runc</code> and default seccomp profiles" },
      { id: 'B', text: "Kata Containers (using QEMU, Cloud-Hypervisor, or Firecracker via <code>kata-runtime</code>)" },
      { id: 'C', text: "Cilium CNI with eBPF host routing enabled" },
      { id: 'D', text: "Standard containerd with AppArmor enforce profiles" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set <code>AllowUsers *</code> and disable <code>PubkeyAuthentication</code>" },
      { id: 'B', text: "Set <code>StrictModes no</code> and configure <code>X11Forwarding yes</code>" },
      { id: 'C', text: "Set <code>PermitRootLogin no</code>, <code>PasswordAuthentication no</code>, <code>MaxAuthTries 3</code>, and <code>ClientAliveInterval 300</code>" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "The container gains automatic approval to modify other pods' resource quotas" },
      { id: 'D', text: "The container is granted access to all host devices in <code>/dev</code>, disables seccomp and AppArmor profiles, and inherits nearly all Linux kernel capabilities, effectively negating container isolation" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Kube-bench static YAML analyzer" },
      { id: 'C', text: "CoreDNS metrics scraper" },
      { id: 'D', text: "CRI-O log parser" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Mount <code>/proc</code> with <code>readOnly: true</code>" },
      { id: 'C', text: "Configure an ingress NetworkPolicy on TCP port 80" },
      { id: 'D', text: "Set <code>securityContext.runAsNonRoot: true</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Execute <code>systemctl list-dependencies kubelet</code>" },
      { id: 'B', text: "Execute <code>crictl images</code>" },
      { id: 'C', text: "Execute <code>lsmod</code> (or inspect <code>/proc/modules</code>) and verify module signatures using <code>modinfo &lt;module-name&gt;</code>" },
      { id: 'D', text: "Execute <code>kubectl get nodes -o wide</code>" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set <code>readOnly: true</code> in the container's <code>volumeMounts</code> entry referencing the <code>hostPath</code> volume" },
      { id: 'B', text: "Set <code>readOnlyRootFilesystem: true</code> in the pod's <code>securityContext</code>" },
      { id: 'C', text: "Configure <code>allowPrivilegeEscalation: false</code> on the container" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure <code>--file-umask=000</code> in the kubelet configuration file" },
      { id: 'C', text: "Add <code>securityContext.runAsGroup: 0</code> to all pod manifests" },
      { id: 'D', text: "Set <code>chmod 600 /</code> across the entire filesystem" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set <code>net.ipv4.conf.all.rp_filter = 1</code> and <code>net.ipv4.conf.default.rp_filter = 1</code> in sysctl configuration" },
      ...
      { id: 'D', text: "Set <code>net.ipv4.tcp_rfc1337 = 0</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>allowPrivilegeEscalation: false</code>" },
      { id: 'B', text: "<code>privileged: false</code>" },
      { id: 'C', text: "<code>runAsNonRoot: true</code>" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Kubernetes assigns each Pod its own dedicated IPC namespace by default; ensuring <code>hostIPC: false</code> (the default) prevents pods from accessing host POSIX shared memory" },
      { id: 'C', text: "Kubernetes shares the host IPC namespace by default and requires <code>isolateIPC: true</code>" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Remove the <code>/lib/modules</code> directory entirely from the worker node filesystem" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure <code>securityContext.supplementalGroups: [2000]</code> (or <code>fsGroup: 2000</code>) in the Pod specification" },
      { id: 'B', text: "Set <code>securityContext.runAsUser: 0</code> and change file permissions via an entrypoint script" },
      { id: 'C', text: "Add the <code>CAP_DAC_OVERRIDE</code> capability to the container" },
      { id: 'D', text: "Set <code>privileged: true</code> on the volume mount specification" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "It automatically disables all networking when a container attempts to execute a shell" },
      { id: 'C', text: "It forces all container processes to execute inside a virtual machine hardware sandbox" },
      { id: 'D', text: "It mounts the host root filesystem as an immutable tmpfs volume" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure an admission webhook that denies pods requesting SSH ports" },
      ...
      { id: 'D', text: "Configure <code>pam_faillock.so</code> (or legacy <code>pam_tally2.so</code>) in <code>/etc/pam.d/common-auth</code> with <code>deny=5 unlock_time=900</code>" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Delete <code>/var/log/pods</code> and stream all logs directly over raw UDP to external syslog" },
      { id: 'B', text: "Mount <code>/var/log/pods</code> inside every pod with <code>readOnly: false</code>" },
      { id: 'C', text: "Ensure <code>/var/log/pods</code> directories are owned by <code>root:root</code> with permissions <code>0700</code> or <code>0750</code>, and configure kubelet log rotation parameters (<code>containerLogMaxSize</code> and <code>containerLogMaxFiles</code>)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Execute <code>ipcs</code> (or <code>ipcs -a</code>)" },
      { id: 'D', text: "Execute <code>crictl stats</code>" }
    ],
    correctAnswers: ['C'],
    type: "single",
