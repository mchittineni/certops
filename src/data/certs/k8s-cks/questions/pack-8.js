export const K8S_CKS_QUESTIONS_8 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Set <code>level: None</code> for resources <code>secrets</code>" },
      { id: 'C', text: "Set <code>level: Request</code> with an omitStages filter" },
      { id: 'D', text: "Set <code>level: RequestResponse</code> for resources <code>secrets</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure <code>audit: true</code> in the kube-apiserver ConfigMap in <code>kube-system</code>" },
      { id: 'C', text: "Set <code>--log-dir=/var/log/audit</code> on the kubelet daemon on each worker node" },
      { id: 'D', text: "Add <code>--enable-audit-logs=true</code> and set <code>--audit-destination=syslog</code> without volume mounts" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "<code>RequestReceived</code>" },
      { id: 'C', text: "<code>ResponseStarted</code>" },
      { id: 'D', text: "<code>Panic</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>list</code> defines reusable items; <code>macro</code> defines reusable condition snippets; <code>rule</code> combines conditions with <code>output</code>, <code>priority</code>, and <code>tags</code>" },
      { id: 'B', text: "<code>rule</code> defines YAML loops; <code>macro</code> defines regex filters; <code>output</code> formats syslog packets" },
      { id: 'C', text: "Falco rules must be compiled into C code before loading" },
      { id: 'D', text: "Falco uses Rego syntax identical to Open Policy Agent" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Execute <code>kill -SIGSTOP &lt;container-pid&gt;</code>" },
      { id: 'C', text: "Execute <code>nsenter -t &lt;container-pid&gt; -n tcpdump -i eth0</code>" },
      { id: 'D', text: "Execute <code>chroot /proc/&lt;container-pid&gt;/root tcpdump</code>" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Access to <code>/dev/mem</code> causes the kubelet to restart immediately" },
      { id: 'B', text: "Access to these devices automatically resets the node's network interface" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Set <code>output_format: json</code> with <code>destination: /var/log/audit.log</code>" },
      { id: 'C', text: "Configure <code>falco_sink: all</code>" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run <code>etcdctl get /containers/diff</code>" },
      { id: 'B', text: "Run <code>kubectl logs &lt;pod&gt; --all-files</code>" },
      { id: 'C', text: "Run <code>crictl stats --format json</code>" },
      { id: 'D', text: "Inspect the container's storage root graph driver directory (under <code>/var/lib/containerd/...</code> or overlayfs <code>diff/</code> directory) on the host node" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Search the audit log for entries matching <code>user.username: 'system:anonymous'</code>" },
      { id: 'C', text: "Query <code>kubectl get events -n kube-system</code>" },
      { id: 'D', text: "Check <code>dmesg</code> for unauthenticated kernel calls" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Monitor <code>syscall = mprotect</code> with PROT_READ only" },
      { id: 'B', text: "Monitor <code>evt.type = socket</code> for TCP connections" },
      { id: 'C', text: "Monitor <code>evt.type = memfd_create</code> or <code>proc.cmdline startswith '/memfd:'</code>" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Binding to localhost port 8080" },
      { id: 'C', text: "A rapid burst of outbound <code>connect</code> system calls to a high volume of distinct destination IP addresses or ports within a short time window" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Execute <code>crictl inspect 14205</code>" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>init_module</code> and <code>finit_module</code>" },
      { id: 'B', text: "<code>fork</code> and <code>clone</code>" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "<code>evt.type = listen and fd.port = 443</code>" },
      { id: 'C', text: "<code>evt.type = accept and container.id = host</code>" },
      { id: 'D', text: "<code>evt.type = recvfrom and fd.port = 53</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Set <code>engine: { kind: ebpf }</code> (or <code>ebpf: { enabled: true }</code>) and specify <code>probe: /root/.falco/falco-bpf.o</code>" },
      { id: 'D', text: "Set <code>kernel_module: force</code>" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An audit event with <code>verb: delete</code> on namespace <code>kube-system</code>" },
      { id: 'B', text: "An audit event with <code>verb: list</code>, <code>objectRef.resource: secrets</code>, and an empty (all namespaces) <code>objectRef.namespace</code> field" },
      { id: 'C', text: "An audit event with <code>level: None</code>" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "<code>evt.type = connect and fd.port in (10250, 10255) and container.id != host</code>" },
      { id: 'C', text: "<code>evt.type = open and file.name = '/var/lib/kubelet/config.yaml'</code>" },
      { id: 'D', text: "<code>evt.type = accept and fd.port = 80</code>" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Block all UDP packets on port 53" },
      ...
      { id: 'D', text: "Monitor container CPU usage using <code>top</code>" }
    ],
    correctAnswers: ['C'],
    type: "single",
