export const K8S_CKS_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>*.* @@syslog.enterprise.com:514</code>" },
      { id: 'B', text: "<code>systemd.forward_to_syslog = yes</code>" },
      { id: 'C', text: "<code>*.* @syslog.enterprise.com:514</code> (UDP)" },
      { id: 'D', text: "<code>forward.all = true</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Execute <code>ps -ef | grep &lt;PID&gt;</code> without tree flags" },
      { id: 'B', text: "Execute <code>uname -r</code>" },
      { id: 'C', text: "Execute <code>crictl stats</code>" },
      { id: 'D', text: "Execute <code>pstree -p -s &lt;PID&gt;</code>" }
    ],
    correctAnswers: ['D'],
    type: "single",
