export const K8S_CKS_QUESTIONS_10 = [
  {
    ...
    options: [
      { id: 'A', text: "<code>LimitRange</code> admission controller" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "<code>regex(object.spec.replicas, '^[2-9]$')</code>" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "The binding passes secrets via HTTP GET parameters to the API server" },
      { id: 'D', text: "The binding executes an external shell script to read local environment variables" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The webhook allows requests even if TLS certificates are expired" },
      { id: 'B', text: "The webhook does not log incoming requests to disk" },
      { id: 'C', text: "The webhook has no out-of-band side effects on external systems during dry-run evaluations, ensuring <code>kubectl apply --dry-run=server</code> executes safely without modifying external state" },
      { id: 'D', text: "The webhook ignores non-root containers" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Add the webhook certificate directly to the Linux host kernel keystore" },
      { id: 'B', text: "Mount <code>/etc/kubernetes/pki</code> into the webhook pod" },
      { id: 'C', text: "Embed the base64-encoded root CA certificate that signed the webhook server's certificate into the <code>clientConfig.caBundle</code> field of the webhook configuration" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>kubesec</code>" },
      { id: 'B', text: "<code>kube-hunter</code>" },
      { id: 'C', text: "<code>falco</code>" },
      { id: 'D', text: "<code>kube-bench</code> (run as a Job or binary on cluster nodes)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A <code>verifyImages</code> rule matching <code>environment</code>" },
      { id: 'C', text: "A <code>validate</code> rule with a <code>pattern: { metadata: { labels: { environment: '?*' } } }</code>" },
      { id: 'D', text: "A <code>mutate</code> rule with <code>patchStrategicMerge</code>" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Annotate the constraint with <code>gatekeeper.sh/mode: 'audit'</code>" },
      { id: 'D', text: "Set <code>spec.enforcementAction: deny</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Delete the <code>kube-system</code> namespace" },
      { id: 'B', text: "Configure <code>namespaceSelector.matchExpressions</code> to exclude namespaces with label <code>kubernetes.io/metadata.name: kube-system</code>" },
      { id: 'C', text: "Set <code>failurePolicy: Ignore</code> across all namespaces" },
      { id: 'D', text: "Set <code>rules: [{ apiGroups: ['*'], resources: ['nodes'] }]</code>" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Delete <code>/etc/kubernetes/kubelet.conf</code>" },
      { id: 'B', text: "Add an ingress rule blocking port 6443" },
      { id: 'C', text: "In <code>/var/lib/kubelet/config.yaml</code>, set <code>authentication.anonymous.enabled: false</code> and restart the kubelet daemon" },
      { id: 'D', text: "Add <code>--anonymous-auth=true</code> to <code>/etc/kubernetes/manifests/kube-apiserver.yaml</code>" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It allows the kubelet to issue TLS certificates to pods" },
      { id: 'B', text: "It encrypts the host root filesystem using client certificates" },
      { id: 'C', text: "It instructs the kubelet to authenticate incoming requests to its HTTPS API (port 10250) using X.509 client certificate verification, preventing unauthenticated callers from executing commands or reading logs" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A <code>mutate</code> rule using a <code>patchStrategicMerge</code> overlay" },
      { id: 'B', text: "A <code>validate</code> rule with <code>enforce</code> mode" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In <code>/var/lib/kubelet/config.yaml</code>, set <code>etcd.auth: client</code>" },
      { id: 'B', text: "In the etcd CoreDNS configuration file" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Discovery of an open, unauthenticated Kubelet Read-Only Port on TCP port 10255" },
      { id: 'B', text: "Discovery of open TCP port 443 with TLS mutual authentication required" },
      { id: 'C', text: "Discovery of open UDP port 53 inside the pod network" },
      { id: 'D', text: "Discovery of an open SSH port requiring ed25519 key authentication" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>messageExpression</code> using string concatenation or formatting in CEL (e.g., <code>'CPU request ' + object.spec.containers[0].resources.requests.cpu + ' exceeds maximum limit 4'</code>)" },
      { id: 'B', text: "<code>errorMessage</code>" },
      { id: 'C', text: "<code>rejectionText</code>" },
      { id: 'D', text: "<code>alertTemplate</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Set <code>authorization.mode: Node</code>" },
      { id: 'C', text: "Set <code>authorization.mode: ABAC</code>" },
      { id: 'D', text: "Set <code>authorization.mode: AlwaysAllow</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Execute <code>systemctl mask kubelet</code>" },
      { id: 'D', text: "Execute <code>chown root:root /etc/systemd/system/kubelet.service.d/10-kubeadm.conf && chmod 600 /etc/systemd/system/kubelet.service.d/10-kubeadm.conf</code>" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>object.containers.filter(c =&gt; c.privileged).length() == 0</code>" },
      { id: 'B', text: "<code>object.spec.privileged == false</code>" },
      { id: 'C', text: "<code>spec.securityContext.privileged != true</code>" },
      { id: 'D', text: "<code>!object.spec.containers.exists(c, has(c.securityContext) && has(c.securityContext.privileged) && c.securityContext.privileged == true)</code>" }
    ],
    correctAnswers: ['D'],
    type: "single",
