export const K8S_CKS_FLASHCARDS_19 = [
  {
    ...
    certId: "k8s-cks",
    domainId: "d6",
    front: "Container Drift Detection in the Overlay Upper Layer (Dr Failover)",
    hint: "Comparing running container filesystems against base images to detect tampering.",
    back: "Inspect the container's <strong>overlayfs upper (diff) directory</strong> on the node: it holds every file added or modified in the read-write layer, with whiteouts for deletions, exposing drift and backdoors. crictl has no <code>diff</code> subcommand.",
  ...
  },
  {
    ...
    certId: "k8s-cks",
    domainId: "d6",
    front: "Container Drift Detection in the Overlay Upper Layer (High Load Scale)",
    hint: "Comparing running container filesystems against base images to detect tampering.",
    back: "Inspect the container's <strong>overlayfs upper (diff) directory</strong> on the node: it holds every file added or modified in the read-write layer, with whiteouts for deletions, exposing drift and backdoors. crictl has no <code>diff</code> subcommand.",
  ...
  },
  {
    ...
    certId: "k8s-cks",
    domainId: "d6",
    front: "Container Drift Detection in the Overlay Upper Layer (Security Compliance)",
    hint: "Comparing running container filesystems against base images to detect tampering.",
    back: "Inspect the container's <strong>overlayfs upper (diff) directory</strong> on the node: it holds every file added or modified in the read-write layer, with whiteouts for deletions, exposing drift and backdoors. crictl has no <code>diff</code> subcommand.",
  ...
  },
  {
    ...
    certId: "k8s-cks",
    domainId: "d6",
    front: "Container Drift Detection in the Overlay Upper Layer (Hybrid Migration)",
    hint: "Comparing running container filesystems against base images to detect tampering.",
    back: "Inspect the container's <strong>overlayfs upper (diff) directory</strong> on the node: it holds every file added or modified in the read-write layer, with whiteouts for deletions, exposing drift and backdoors. crictl has no <code>diff</code> subcommand.",
  ...
  },
  {
    ...
    certId: "k8s-cks",
    domainId: "d6",
    front: "Container Drift Detection in the Overlay Upper Layer (Resilience Failure)",
    hint: "Comparing running container filesystems against base images to detect tampering.",
    back: "Inspect the container's <strong>overlayfs upper (diff) directory</strong> on the node: it holds every file added or modified in the read-write layer, with whiteouts for deletions, exposing drift and backdoors. crictl has no <code>diff</code> subcommand.",
