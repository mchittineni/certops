export const K8S_CKS_FLASHCARDS_4 = [
  ...
  },
  {
    ...
    "certId": "k8s-cks",
    "domainId": "d3",
    "front": "Swap on Kubernetes Nodes: How do you keep secrets off disk when nodes use swap?",
    "hint": "Swap is supported (stable since v1.34), but the kubelet does not encrypt it.",
    "back": "Provision <strong>encrypted swap</strong> at the OS level, because the kubelet does not encrypt it, then set <code>failSwapOn: false</code> and <code>swapBehavior: LimitedSwap</code> so pods can use it (NodeSwap, stable since v1.34). Disabling swap, the historical default, also keeps secret pages off disk.",
    "tags": [
      "CKS",
      "Minimize"
    ]
