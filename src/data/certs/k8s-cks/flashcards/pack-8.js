export const K8S_CKS_FLASHCARDS_8 = [
  ...
  },
  {
    ...
    "hint": "Set engine.kind: modern_ebpf in falco.yaml.",
    "back": "In <code>falco.yaml</code>, set <strong>engine: { kind: modern_ebpf }</strong>. The CO-RE probe is bundled in Falco and is the default driver, so no probe object is needed. The legacy <code>ebpf</code> probe was removed in Falco 0.44.0.",
    "tags": [
      "CKS",
      "Monitoring,"
    ]
