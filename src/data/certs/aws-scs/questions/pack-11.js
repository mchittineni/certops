export const AWS_SCS_QUESTIONS_11 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Write custom shell scripts on individual developer laptops that invoke raw AWS CLI delete commands." },
      { id: 'C', text: "Grant full administrative IAM rights to all third-party finding ingestion integrations." },
      { id: 'D', text: "Disable Security Hub compliance standards (CIS AWS Foundations) to clear the finding queue." }
    ],
    correctAnswers: ['A'],
    type: "single",
