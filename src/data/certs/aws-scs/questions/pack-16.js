export const AWS_SCS_QUESTIONS_16 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Associate each VPC attachment with a dedicated Transit Gateway route table and omit routes between development and production VPCs." },
      { id: 'C', text: "Create full-mesh VPC peering connections between all development and production VPCs." },
      { id: 'D', text: "Disable network firewalls between development and production environments." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Associate each VPC attachment with a dedicated Transit Gateway route table and omit routes between development and production VPCs." },
      { id: 'C', text: "Create full-mesh VPC peering connections between all development and production VPCs." },
      { id: 'D', text: "Route all traffic through a single default route table that interconnects every subnet across the enterprise." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Associate each VPC attachment with a dedicated Transit Gateway route table and omit routes between development and production VPCs. AWS Transit Gateway route tables act as virtual routing instances (VRFs). Platform engineers establish strict network segmentation by creating separate route tables (e.g., `Prod-RT`, `Dev-RT`, `Shared-RT`). Prod and Dev tables route only to Shared Services and the Internet, maintaining complete isolation from each other.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Attach an IAM Permissions Boundary to developer roles, requiring any newly created role to have that boundary attached." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable IAM role creation and force all microservices to share a single static access key." },
      { id: 'C', text: "Rely on annual code reviews to detect unauthorized administrative role creation." },
      { id: 'D', text: "Grant developers unrestricted `iam:*` permissions across all AWS accounts." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Attach an IAM Permissions Boundary to developer roles, requiring any newly created role to have that boundary attached. An IAM Permissions Boundary defines the maximum permissions an IAM identity can have. By enforcing a condition (`iam:PermissionsBoundary`) on `iam:CreateRole`, administrators delegate role creation safely: developers can create roles, but those roles can never exceed the permissions boundary (preventing privilege escalation).",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Grant developers unrestricted `iam:*` permissions across all AWS accounts." },
      { id: 'C', text: "Attach an IAM Permissions Boundary to developer roles, requiring any newly created role to have that boundary attached." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Attach an AWS Organizations Service Control Policy (SCP) with an explicit Deny on non-whitelisted regions and security service disablement." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure IAM policies on individual users in each account, leaving root accounts unrestricted." },
      { id: 'B', text: "Rely on billing alerts to discover resources deployed in unapproved regions weeks after deployment." },
      { id: 'C', text: "Send an executive email memo asking developers not to use overseas AWS regions." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Grant all developers unrestricted access to all resources regardless of project ownership." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Allow developers to access production accounts without multi-factor authentication." },
      { id: 'D', text: "Configure AWS IAM Identity Center (AWS SSO) with SCIM identity synchronization and assign scoped Permission Sets across accounts." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Distribute a shared master root password spreadsheet to all developers." },
      { id: 'B', text: "Configure AWS IAM Identity Center (AWS SSO) with SCIM identity synchronization and assign scoped Permission Sets across accounts." },
      { id: 'C', text: "Create local IAM users with static passwords in every individual AWS account." },
      { id: 'D', text: "Allow developers to access production accounts without multi-factor authentication." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure AWS IAM Identity Center (AWS SSO) with SCIM identity synchronization and assign scoped Permission Sets across accounts." },
      { id: 'B', text: "Allow developers to access production accounts without multi-factor authentication." },
      { id: 'C', text: "Distribute a shared master root password spreadsheet to all developers." },
      { id: 'D', text: "Create local IAM users with static passwords in every individual AWS account." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Configure AWS IAM Identity Center (AWS SSO) with SCIM identity synchronization and assign scoped Permission Sets across accounts. AWS IAM Identity Center (successor to AWS Single Sign-On) centralizes workforce authentication. It integrates with corporate IdPs via SAML 2.0 and SCIM (for automatic user provisioning/deprovisioning) and manages multi-account access through reusable, temporary credential Permission Sets.",
