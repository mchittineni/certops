export const AWS_SCS_QUESTIONS_8 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon S3 with SSE-S3 default encryption" },
      { id: 'B', text: "Standard AWS KMS with multi-tenant hardware security modules (FIPS 140-2 Level 2)" },
      { id: 'C', text: "AWS Systems Manager Parameter Store with SecureString" },
      { id: 'D', text: "AWS CloudHSM (or an AWS KMS Custom Key Store backed by CloudHSM)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS KMS **Multi-Region Keys** (creating a primary key in us-east-1 and replicating it to us-west-2)" },
      { id: 'B', text: "Using default AWS managed keys in both Regions" },
      { id: 'C', text: "Exporting the private key material to an S3 bucket replicated with Cross-Region Replication" },
      { id: 'D', text: "Creating two separate independent KMS keys with identical aliases in each Region" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Secrets Manager with auto-rotation" },
      { id: 'B', text: "AWS Certificate Manager Private CA (AWS Private CA)" },
      { id: 'C', text: "Public AWS Certificate Manager (ACM)" },
      { id: 'D', text: "AWS CloudHSM CLI tool" }
    ],
    correctAnswers: ['B'],
    type: "single",
