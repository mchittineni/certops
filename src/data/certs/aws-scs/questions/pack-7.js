export const AWS_SCS_QUESTIONS_7 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Call `GenerateDataKey`, encrypt locally with the plaintext key, and store the wrapped key beside the object" },
    ...
    tags: ["KMS", "Envelope Encryption", "Data Protection", "Cryptography"]
  },
  {
    id: "aws-scs-172",
    difficulty: "medium",
    ...
    options: [
      ...
      { id: 'C', text: "S3 Lifecycle transition to Glacier Flexible Retrieval" },
      { id: 'D', text: "Legal Hold alone without retention mode" }
    ],
    correctAnswers: ['A'],
    type: "single",
    ...
    tags: ["S3", "Object Lock", "Compliance Mode", "Data Protection"]
  },
  {
    id: "aws-scs-173",
    difficulty: "easy",
    ...
    tags: ["KMS", "Key-Policy", "IAM-Delegation", "Access-Control"]
  },
  {
    id: "aws-scs-174",
    difficulty: "medium",
    ...
    options: [
      ...
      { id: 'D', text: "KMS creates new backing material for future encryption while retaining the old for decryption" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["KMS", "Automatic-Rotation", "Key-Management", "Data-Protection"]
  },
  {
    id: "aws-scs-175",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "Pass the order and customer identifiers as the encryption context, which KMS binds to the ciphertext" },
      { id: 'B', text: "Store the customer identifier alongside the ciphertext in a bucket with Object Lock enabled" },
      { id: 'C', text: "Raise a CloudWatch alarm whenever a row is updated with a mismatched customer identifier" },
      { id: 'D', text: "Encrypt the customer identifier separately with an asymmetric key pair held per customer" }
    ],
    correctAnswers: ['A'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["KMS", "Encryption-Context", "AAD", "Tamper-Resistance"]
  }
];
