export const AWS_SCS_QUESTIONS_3 = [
  {
    ...
    options: [
      { id: 'A', text: "<code>{ \"source\": [\"aws.cloudtrail\"], \"detail-type\": [\"AWS API Call via CloudTrail\"], \"detail\": { \"eventSource\": [\"cloudtrail.amazonaws.com\"], \"eventName\": [\"StopLogging\", \"DeleteTrail\", \"UpdateTrail\"] } }</code>" },
      { id: 'B', text: "<code>{ \"source\": [\"aws.health\"], \"detail\": { \"service\": [\"CLOUDTRAIL\"] } }</code>" },
      { id: 'C', text: "<code>{ \"source\": [\"aws.ec2\"], \"detail-type\": [\"EC2 Instance State-change Notification\"] }</code>" },
      { id: 'D', text: "<code>{ \"source\": [\"aws.guardduty\"], \"detail\": { \"severity\": [\"LOW\"] } }</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
    ...
    tags: ["EventBridge", "CloudTrail", "StopLogging", "Tamper-Detection"]
  },
  {
    id: "aws-scs-52",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "<code>{ $.eventSource = \"s3.amazonaws.com\" }</code>" },
      { id: 'B', text: "<code>{ $.userIdentity.sessionContext.sessionIssuer.userName = \"NetworkAdmin\" }</code>" },
      { id: 'C', text: "<code>{ $.eventName = \"AuthorizeSecurityGroupIngress\" }</code>" },
      { id: 'D', text: "<code>{($.eventName=CreateCustomerGateway)||($.eventName=DeleteCustomerGateway)||($.eventName=AttachInternetGateway)||($.eventName=CreateInternetGateway)||($.eventName=DeleteInternetGateway)||($.eventName=DetachInternetGateway)||($.eventName=CreateNatGateway)||($.eventName=DeleteNatGateway)}</code>" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["CloudWatch", "Metric-Filter", "Network-Gateway", "CIS-Benchmark"]
  },
  {
    id: "aws-scs-53",
    difficulty: "hard",
    ...
    options: [
      ...
      { id: 'B', text: "Grant public access to the OpenSearch cluster and configure member accounts to write directly over the public internet" },
      { id: 'C', text: "Export CloudWatch Logs to local member account S3 buckets and configure S3 cross-region replication to OpenSearch" },
      { id: 'D', text: "Configure CloudWatch Logs Subscription Filters in each member account targeting an Amazon Kinesis Data Stream in the Security account via a cross-account IAM role, and process the stream into OpenSearch using Kinesis Data Firehose" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["CloudWatch-Logs", "OpenSearch", "Subscription-Filter", "Cross-Account"]
  },
  {
    id: "aws-scs-54",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "S3 server access logs can only record PUT requests, while CloudTrail records only GET requests" },
      { id: 'B', text: "S3 server access logging requires customer managed KMS keys, while CloudTrail cannot be encrypted" },
      { id: 'C', text: "CloudTrail S3 data events provide detailed caller IAM identity (role ARN, session context, STS credentials) and integrate with EventBridge, whereas S3 server access logs provide HTTP-level details (Turnaround Time, HTTP status codes) but have best-effort delivery and no EventBridge integration" },
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["S3", "Server-Access-Logs", "CloudTrail", "Data-Events"]
  },
  {
    id: "aws-scs-55",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "<code>CreateGrant</code> and <code>ListGrants</code>" },
      { id: 'B', text: "<code>Encrypt</code> and <code>Decrypt</code>" },
      { id: 'C', text: "<code>GenerateDataKey</code> and <code>DescribeKey</code>" },
      { id: 'D', text: "<code>ScheduleKeyDeletion</code> and <code>DisableKey</code>" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["KMS", "ScheduleKeyDeletion", "CloudTrail", "Ransomware-Prevention"]
  },
  {
    id: "aws-scs-56",
    difficulty: "easy",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["CloudWatch", "OAM", "Cross-Account", "Observability"]
  },
  {
    id: "aws-scs-57",
    difficulty: "medium",
    ...
    options: [
      ...
      { id: 'B', text: "<code>{($.eventSource=s3.amazonaws.com)&&(($.eventName=PutBucketAcl)||($.eventName=PutBucketPolicy)||($.eventName=PutBucketCors)||($.eventName=PutBucketLifecycle)||($.eventName=PutBucketReplication)||($.eventName=DeleteBucketPolicy)||($.eventName=DeleteBucketCors)||($.eventName=DeleteBucketLifecycle))}</code>" },
      { id: 'C', text: "<code>{ $.errorCode = \"403\" }</code>" },
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["CloudWatch", "Metric-Filter", "S3-Bucket-Policy", "CIS-Benchmark"]
  },
  {
    id: "aws-scs-58",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "Use CloudWatch Metrics for ALB RequestCount" },
      { id: 'B', text: "Open each raw gzip file locally using text editors" },
      { id: 'C', text: "Review the AWS WAF Sampled Requests tab which displays 100% of all requests" },
      { id: 'D', text: "Create an Athena table over the ALB access logs S3 location, and run a query grouping by <code>client_ip</code> with <code>COUNT(*)</code> ordered descending" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["ALB", "Access-Logs", "Athena", "Incident-Analysis"]
  },
  {
    id: "aws-scs-59",
    difficulty: "hard",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["CloudTrail-Insights", "Anomaly-Detection", "Machine-Learning", "Threat-Hunting"]
  },
  {
    id: "aws-scs-60",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "Reactive mode evaluation via CloudWatch alarms" },
      { id: 'B', text: "Detective mode evaluation using CloudTrail event triggers" },
      { id: 'C', text: "Proactive mode evaluation using the <code>StartResourceEvaluation</code> API or CloudFormation Guard" },
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["AWS-Config", "Proactive-Mode", "CI-CD", "DevSecOps"]
  },
  {
    id: "aws-scs-61",
    difficulty: "medium",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["Transit-Gateway", "Flow-Logs", "Network-Security", "Hub-and-Spoke"]
  },
  {
    id: "aws-scs-62",
    difficulty: "easy",
    ...
    options: [
      ...
      { id: 'C', text: "S3 Glacier Vault Lock alone without versioning" },
      { id: 'D', text: "S3 Bucket Policy denying s3:DeleteObject for non-root users" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>iam-user-unused-credentials-check</code>" },
      { id: 'B', text: "<code>cw-loggroup-retention-period-check</code>" },
      { id: 'C', text: "<code>cloudtrail-s3-dataevents-enabled</code>" },
      { id: 'D', text: "<code>s3-bucket-retention-check</code>" }
    ],
    correctAnswers: ['B'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["AWS-Config", "CloudWatch-Logs", "Retention", "Compliance"]
  },
  {
    id: "aws-scs-64",
    difficulty: "medium",
    ...
    options: [
      ...
      { id: 'C', text: "<code>{ $.userIdentity.type = \"Root\" }</code>" },
      { id: 'D', text: "<code>{($.eventName=ConsoleLogin)&&($.errorMessage=\"Failed authentication\")}</code>" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["CloudWatch", "Metric-Filter", "Authentication", "Brute-Force"]
  },
  {
    id: "aws-scs-65",
    difficulty: "hard",
    ...
    options: [
      { id: 'A', text: "VPC Flow Logs on CloudFront edge locations" },
      { id: 'B', text: "CloudFront standard logging delivered to Amazon S3" },
      { id: 'C', text: "CloudFront Real-Time Logs configured to publish selected fields to an Amazon Kinesis Data Stream" },
      { id: 'D', text: "AWS CloudTrail S3 data events" }
    ],
    correctAnswers: ['C'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["CloudFront", "Real-Time-Logs", "Kinesis", "Bot-Mitigation"]
  },
  {
    id: "aws-scs-66",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "Metric <code>BlockedRequests</code> in namespace <code>AWS/WAFV2</code> with dimensions <code>WebACL</code>, <code>Rule</code> (matching the SQL injection rule), and <code>Region</code>" },
      { id: 'B', text: "Metric <code>HTTPCode_Target_5XX_Count</code> in namespace <code>AWS/ApplicationELB</code>" },
      { id: 'C', text: "Metric <code>RequestCount</code> in namespace <code>AWS/CloudFront</code>" },
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["AWS-WAF", "CloudWatch", "BlockedRequests", "SQLi"]
  },
  {
    id: "aws-scs-67",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "An Amazon CloudWatch Logs metric filter that runs once a day" },
      { id: 'B', text: "A cron script that calls aws ec2 describe-security-groups every hour" },
      { id: 'C', text: "An S3 Lifecycle rule that deletes security groups" },
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["EventBridge", "Security-Groups", "AuthorizeSecurityGroupIngress", "Automation"]
  },
  {
    id: "aws-scs-68",
    difficulty: "easy",
    ...
    options: [
      ...
      { id: 'B', text: "<code>SELECT count(*) FROM cloudtrail_logs GROUP BY eventsource;</code>" },
      { id: 'C', text: "<code>SELECT * FROM vpc_flow_logs WHERE action = 'REJECT';</code>" },
      { id: 'D', text: "<code>SELECT eventtime, eventsource, eventname, sourceipaddress, useragent FROM cloudtrail_logs WHERE useridentity.accesskeyid = 'AKIAEXAMPLE12345' AND eventtime &gt;= '2026-09-01T00:00:00Z' ORDER BY eventtime DESC;</code>" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["Athena", "CloudTrail", "Forensics", "Access-Keys"]
  },
  {
    id: "aws-scs-69",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "Disable S3 bucket encryption in Account B" },
      { id: 'B', text: "Attach an IAM user policy to the root account of Account B" },
      { id: 'C', text: "Grant full <code>s3:*</code> access to <code>*</code> without any conditions" },
      { id: 'D', text: "Grant <code>s3:PutObject</code> and <code>s3:GetBucketAcl</code> permissions to the principal <code>cloudtrail.amazonaws.com</code> with a condition matching Account A's ARN or ID (or <code>aws:SourceArn</code> of the trail)" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["S3-Bucket-Policy", "CloudTrail", "Cross-Account", "Least-Privilege"]
  },
  {
    id: "aws-scs-70",
    difficulty: "medium",
    ...
    options: [
      ...
      { id: 'B', text: "<code>{($.eventName=CreateRoute)||($.eventName=CreateRouteTable)||($.eventName=ReplaceRoute)||($.eventName=ReplaceRouteTableAssociation)||($.eventName=DeleteRouteTable)||($.eventName=DeleteRoute)||($.eventName=DisassociateRouteTable)}</code>" },
      { id: 'C', text: "<code>{ $.eventSource = \"iam.amazonaws.com\" }</code>" },
      { id: 'D', text: "<code>{ $.eventName = \"DescribeRouteTables\" }</code>" }
    ],
    correctAnswers: ['B'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["CloudWatch", "Metric-Filter", "Route-Tables", "CIS-Benchmark"]
  },
  {
    id: "aws-scs-71",
    difficulty: "hard",
    ...
    options: [
      { id: 'A', text: "<code>{($.eventName=CreateNetworkAcl)||($.eventName=CreateNetworkAclEntry)||($.eventName=DeleteNetworkAcl)||($.eventName=DeleteNetworkAclEntry)||($.eventName=ReplaceNetworkAclEntry)||($.eventName=ReplaceNetworkAclAssociation)}</code>" },
      { id: 'B', text: "<code>{ $.eventSource = \"lambda.amazonaws.com\" }</code>" },
      { id: 'C', text: "<code>{ $.responseElements = true }</code>" },
      { id: 'D', text: "<code>{ $.eventName = \"DescribeNetworkAcls\" }</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["CloudWatch", "Metric-Filter", "Network-ACL", "CIS-Benchmark"]
  },
  {
    id: "aws-scs-72",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "AWS WAF Data Masking rules attached to the ECS task definition" },
      ...
      { id: 'C', text: "Amazon GuardDuty Malware Protection" },
      { id: 'D', text: "S3 Glacier Vault Lock policies" }
    ],
    correctAnswers: ['B'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["CloudWatch-Logs", "Data-Protection", "PII-Masking", "Compliance"]
  },
  {
    id: "aws-scs-73",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "<code>{ \"source\": [\"aws.s3\"], \"detail-type\": [\"AWS API Call via CloudTrail\"], \"detail\": { \"eventSource\": [\"s3.amazonaws.com\"], \"eventName\": [\"DeleteBucketLifecycle\"] } }</code>" },
      { id: 'B', text: "<code>{ \"source\": [\"aws.glacier\"], \"detail\": { \"action\": [\"Expire\"] } }</code>" },
      { id: 'C', text: "<code>{ \"source\": [\"aws.config\"], \"detail\": { \"configRuleName\": [\"s3-lifecycle\"] } }</code>" },
      { id: 'D', text: "<code>{ \"source\": [\"aws.s3\"], \"detail\": { \"eventName\": [\"GetObject\"] } }</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["EventBridge", "S3", "DeleteBucketLifecycle", "Data-Retention"]
  },
  {
    id: "aws-scs-74",
    difficulty: "easy",
    ...
    options: [
      { id: 'A', text: "AWS Artifact Reports" },
      { id: 'B', text: "Amazon Inspector Assessment Templates" },
      { id: 'C', text: "AWS Config Conformance Packs deployed organization-wide using an Organization Conformance Pack" },
      { id: 'D', text: "AWS Systems Manager Inventory dashboards" }
    ],
    correctAnswers: ['C'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["AWS-Config", "Conformance-Packs", "PCI-DSS", "Governance"]
  },
  {
    id: "aws-scs-75",
    difficulty: "medium",
    ...
    options: [
      { id: 'A', text: "Metric <code>IncomingBytes</code> in namespace <code>AWS/Kinesis</code>" },
      { id: 'B', text: "Metric <code>DDoSDetected</code> in namespace <code>AWS/DDoSProtection</code> with dimension <code>ResourceArn</code>" },
      { id: 'C', text: "Metric <code>SurgeQueueLength</code> in namespace <code>AWS/ELB</code>" },
      { id: 'D', text: "Metric <code>CPUUtilization</code> in namespace <code>AWS/EC2</code>" }
    ],
    correctAnswers: ['B'],
    type: "single",
    ...
    referenceUrl: "https://docs.aws.amazon.com/security/",
    tags: ["Shield-Advanced", "DDoSDetected", "CloudWatch", "Perimeter-Security"]
  }
];
