export const AWS_SCS_QUESTIONS_3 = [
  {
    ...
    options: [
      { id: 'A', text: "<code>{ \"source\": [\"aws.health\"], \"detail\": { \"service\": [\"CLOUDTRAIL\"] } }</code>" },
      { id: 'B', text: "<code>{ \"source\": [\"aws.guardduty\"], \"detail\": { \"severity\": [\"LOW\"] } }</code>" },
      { id: 'C', text: "<code>{ \"source\": [\"aws.ec2\"], \"detail-type\": [\"EC2 Instance State-change Notification\"] }</code>" },
      { id: 'D', text: "<code>{ \"source\": [\"aws.cloudtrail\"], \"detail-type\": [\"AWS API Call via CloudTrail\"], \"detail\": { \"eventSource\": [\"cloudtrail.amazonaws.com\"], \"eventName\": [\"StopLogging\", \"DeleteTrail\", \"UpdateTrail\"] } }</code>" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>{ $.userIdentity.sessionContext.sessionIssuer.userName = \"NetworkAdmin\" }</code>" },
      { id: 'B', text: "<code>{($.eventName=CreateCustomerGateway)||($.eventName=DeleteCustomerGateway)||($.eventName=AttachInternetGateway)||($.eventName=CreateInternetGateway)||($.eventName=DeleteInternetGateway)||($.eventName=DetachInternetGateway)||($.eventName=CreateNatGateway)||($.eventName=DeleteNatGateway)}</code>" },
      { id: 'C', text: "<code>{ $.eventName = \"AuthorizeSecurityGroupIngress\" }</code>" },
      { id: 'D', text: "<code>{ $.eventSource = \"s3.amazonaws.com\" }</code>" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Export CloudWatch Logs to local member account S3 buckets and configure S3 cross-region replication to OpenSearch" },
      { id: 'C', text: "Configure CloudWatch Logs Subscription Filters in each member account targeting an Amazon Kinesis Data Stream in the Security account via a cross-account IAM role, and process the stream into OpenSearch using Kinesis Data Firehose" },
      { id: 'D', text: "Grant public access to the OpenSearch cluster and configure member accounts to write directly over the public internet" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>ScheduleKeyDeletion</code> and <code>DisableKey</code>" },
      { id: 'B', text: "<code>GenerateDataKey</code> and <code>DescribeKey</code>" },
      { id: 'C', text: "<code>Encrypt</code> and <code>Decrypt</code>" },
      { id: 'D', text: "<code>CreateGrant</code> and <code>ListGrants</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "S3 Bucket Policy denying s3:DeleteObject for non-root users" },
      { id: 'C', text: "S3 Object Lock in Governance mode" },
      { id: 'D', text: "S3 Glacier Vault Lock alone without versioning" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>cloudtrail-s3-dataevents-enabled</code>" },
      { id: 'B', text: "<code>iam-user-unused-credentials-check</code>" },
      { id: 'C', text: "<code>cw-loggroup-retention-period-check</code>" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CloudFront standard logging delivered to Amazon S3" },
      { id: 'B', text: "AWS CloudTrail S3 data events" },
      { id: 'C', text: "VPC Flow Logs on CloudFront edge locations" },
      { id: 'D', text: "CloudFront Real-Time Logs configured to publish selected fields to an Amazon Kinesis Data Stream" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Metric <code>HTTPCode_Target_5XX_Count</code> in namespace <code>AWS/ApplicationELB</code>" },
      { id: 'B', text: "Metric <code>RequestCount</code> in namespace <code>AWS/CloudFront</code>" },
      { id: 'C', text: "Metric <code>BlockedRequests</code> in namespace <code>AWS/WAFV2</code> with dimensions <code>WebACL</code>, <code>Rule</code> (matching the SQL injection rule), and <code>Region</code>" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An S3 Lifecycle rule that deletes security groups" },
      { id: 'B', text: "An Amazon CloudWatch Logs metric filter that runs once a day" },
      { id: 'C', text: "A cron script that calls aws ec2 describe-security-groups every hour" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "<code>SELECT * FROM vpc_flow_logs WHERE action = 'REJECT';</code>" },
      { id: 'C', text: "<code>SELECT eventtime, eventsource, eventname, sourceipaddress, useragent FROM cloudtrail_logs WHERE useridentity.accesskeyid = 'AKIAEXAMPLE12345' AND eventtime &gt;= '2026-09-01T00:00:00Z' ORDER BY eventtime DESC;</code>" },
      { id: 'D', text: "<code>SELECT count(*) FROM cloudtrail_logs GROUP BY eventsource;</code>" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Attach an IAM user policy to the root account of Account B" },
      { id: 'B', text: "Grant <code>s3:PutObject</code> and <code>s3:GetBucketAcl</code> permissions to the principal <code>cloudtrail.amazonaws.com</code> with a condition matching Account A's ARN or ID (or <code>aws:SourceArn</code> of the trail)" },
      { id: 'C', text: "Grant full <code>s3:*</code> access to <code>*</code> without any conditions" },
      { id: 'D', text: "Disable S3 bucket encryption in Account B" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>{ $.eventSource = \"lambda.amazonaws.com\" }</code>" },
      { id: 'B', text: "<code>{ $.eventName = \"DescribeNetworkAcls\" }</code>" },
      { id: 'C', text: "<code>{($.eventName=CreateNetworkAcl)||($.eventName=CreateNetworkAclEntry)||($.eventName=DeleteNetworkAcl)||($.eventName=DeleteNetworkAclEntry)||($.eventName=ReplaceNetworkAclEntry)||($.eventName=ReplaceNetworkAclAssociation)}</code>" },
      { id: 'D', text: "<code>{ $.responseElements = true }</code>" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon GuardDuty Malware Protection" },
      ...
      { id: 'C', text: "S3 Glacier Vault Lock policies" },
      { id: 'D', text: "AWS WAF Data Masking rules attached to the ECS task definition" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>{ \"source\": [\"aws.config\"], \"detail\": { \"configRuleName\": [\"s3-lifecycle\"] } }</code>" },
      { id: 'B', text: "<code>{ \"source\": [\"aws.glacier\"], \"detail\": { \"action\": [\"Expire\"] } }</code>" },
      { id: 'C', text: "<code>{ \"source\": [\"aws.s3\"], \"detail\": { \"eventName\": [\"GetObject\"] } }</code>" },
      { id: 'D', text: "<code>{ \"source\": [\"aws.s3\"], \"detail-type\": [\"AWS API Call via CloudTrail\"], \"detail\": { \"eventSource\": [\"s3.amazonaws.com\"], \"eventName\": [\"DeleteBucketLifecycle\"] } }</code>" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Config Conformance Packs deployed organization-wide using an Organization Conformance Pack" },
      { id: 'B', text: "AWS Artifact Reports" },
      { id: 'C', text: "AWS Systems Manager Inventory dashboards" },
      { id: 'D', text: "Amazon Inspector Assessment Templates" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Metric <code>DDoSDetected</code> in namespace <code>AWS/DDoSProtection</code> with dimension <code>ResourceArn</code>" },
      { id: 'B', text: "Metric <code>SurgeQueueLength</code> in namespace <code>AWS/ELB</code>" },
      { id: 'C', text: "Metric <code>CPUUtilization</code> in namespace <code>AWS/EC2</code>" },
      { id: 'D', text: "Metric <code>IncomingBytes</code> in namespace <code>AWS/Kinesis</code>" }
    ],
    correctAnswers: ['A'],
    type: "single",
