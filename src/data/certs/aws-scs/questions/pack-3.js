export const AWS_SCS_QUESTIONS_3 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>cw-loggroup-retention-period-check</code>" },
      { id: 'B', text: "<code>cloudtrail-s3-dataevents-enabled</code>" },
      { id: 'C', text: "<code>iam-user-unused-credentials-check</code>" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "<code>{ \"source\": [\"aws.s3\"], \"detail\": { \"eventName\": [\"DeleteBucketLifecycle\"] } }</code>" },
