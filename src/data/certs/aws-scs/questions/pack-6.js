export const AWS_SCS_QUESTIONS_6 = [
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "An AWS WAF **IP Set** associated with a rule set to Block in the Web ACL, updated dynamically using the AWS SDK API <code>UpdateIPSet</code>"
      },
      {
        "id": "B",
        "text": "A Network ACL entry created manually in each subnet"
      },
      {
        "id": "C",
        "text": "A security group ingress rule with action Deny"
      },
      {
        "id": "D",
        "text": "An IAM user policy containing IP restrictions"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "An **API Gateway Resource Policy** with an explicit Allow for the partner IAM role ARNs and a default Deny for all other callers"
      },
      {
        "id": "B",
        "text": "An AWS WAF Web ACL matching HTTP 200 responses"
      },
      {
        "id": "C",
        "text": "An IAM group policy attached to the API Gateway deployment stage"
      },
      {
        "id": "D",
        "text": "A Network ACL attached to the API Gateway edge server"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Generate CloudFront **Signed URLs** or **Signed Cookies** using a CloudFront key group and private RSA key, setting an expiration timestamp and optional IP address restriction"
      },
      {
        "id": "B",
        "text": "Require all users to enter AWS IAM access keys in their web browsers"
      },
      {
        "id": "C",
        "text": "Configure S3 bucket public-read permissions with long obfuscated object keys"
      },
      {
        "id": "D",
        "text": "Deploy an AWS WAF rate-limiting rule on the video files"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "AWS Systems Manager **State Manager** associations executing compliance documents on a recurring schedule"
      },
      {
        "id": "B",
        "text": "AWS CloudFormation template deployments on every instance boot"
      },
      {
        "id": "C",
        "text": "AWS Config managed rules running once per week"
      },
      {
        "id": "D",
        "text": "Amazon EventBridge rules monitoring EC2 CPU usage"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Stateless rule groups evaluate first; matching packets can be dropped, passed immediately, or forwarded to stateful rule groups for deep packet inspection"
      },
      {
        "id": "B",
        "text": "Stateful rule groups evaluate first, and stateless groups evaluate only on error"
      },
      {
        "id": "C",
        "text": "Stateless and stateful rules are merged into a single iptables chain"
      },
      {
        "id": "D",
        "text": "Network Firewall does not support stateless rules"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Attach an IAM permissions boundary to all developer roles and mandate that any role created by leads must have that permissions boundary attached using a condition in the lead's IAM policy"
      },
      {
        "id": "B",
        "text": "Use AWS Systems Manager Parameter Store to store encrypted IAM credentials"
      },
      {
        "id": "C",
        "text": "Require all developers to share a single shared administrative IAM user account"
      },
      {
        "id": "D",
        "text": "Apply an AWS Organizations Service Control Policy (SCP) at the root level"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "A service-linked role trust policy allowing only aws:SourceArn from AWS Cost Explorer"
      },
      {
        "id": "B",
        "text": "A condition requiring the sts:ExternalId provided uniquely by the SaaS vendor for this customer relationship"
      },
      {
        "id": "C",
        "text": "A condition restricting source IP to the SaaS vendor's public CIDR range"
      },
      {
        "id": "D",
        "text": "Attaching the AdministratorAccess policy to the cross-account role"
      }
    ],
    "correctAnswers": [
      "B"
