export const AWS_SCS_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>iam-password-policy</code>" },
      { id: 'B', text: "<code>lambda-function-settings-check</code>" },
      { id: 'C', text: "<code>ec2-volume-inuse-check</code>" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Managed Rules for Known Bad Inputs (AWSManagedRulesKnownBadInputsRuleSet)" },
      { id: 'B', text: "AWS Managed Rules for Core Rule Set (AWSManagedRulesCommonRuleSet)" },
      { id: 'C', text: "AWS Managed Rules for SQL Database (AWSManagedRulesSQLiRuleSet)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>\"Condition\": { \"Bool\": { \"aws:SecureTransport\": \"false\" } }</code>" },
      { id: 'B', text: "<code>\"Condition\": { \"IpAddress\": { \"aws:SourceIp\": \"10.0.0.0/16\" } }, \"Effect\": \"Allow\"</code>" },
      { id: 'C', text: "<code>\"Condition\": { \"StringNotEquals\": { \"aws:sourceVpce\": \"vpce-12345678\" } }, \"Effect\": \"Deny\"</code>" },
      { id: 'D', text: "<code>\"Condition\": { \"StringEquals\": { \"aws:PrincipalArn\": \"*\" } }</code>" }
    ],
    correctAnswers: ['C'],
    type: "single",
