export const AWS_SCS_QUESTIONS_5 = [
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Reference the security group ID of the application servers in VPC A (e.g. <code>sg-app12345</code>) as the source in the database security group ingress rule"
      },
      {
        "id": "B",
        "text": "Specify the entire subnet CIDR block of VPC A (10.1.0.0/16)"
      },
      {
        "id": "C",
        "text": "Attach a Network ACL rule permitting port 5432 to 0.0.0.0/0"
      },
      {
        "id": "D",
        "text": "Establish an SSH tunnel between the instances"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable the Amazon EC2 Block Public Access for AMIs feature at the AWS account or AWS Organizations level"
      },
      {
        "id": "B",
        "text": "Deploy an AWS Config rule that sends an email after an AMI is made public"
      },
      {
        "id": "C",
        "text": "Delete all customer managed AMIs from the account"
      },
      {
        "id": "D",
        "text": "Rely on Amazon Inspector vulnerability scans"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Set the rule order to <code>Strict order</code> and specify rule order evaluation priority"
      },
      {
        "id": "B",
        "text": "Set the rule order to <code>Default action order</code>"
      },
      {
        "id": "C",
        "text": "Disable stateless inspection on the firewall policy"
      },
      {
        "id": "D",
        "text": "Configure all rules as stateless rules"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "<code>\"Condition\": { \"StringEquals\": { \"aws:PrincipalOrgID\": \"o-exampleorg123\" } }</code>"
      },
      {
        "id": "B",
        "text": "<code>\"Condition\": { \"IpAddress\": { \"aws:SourceIp\": \"0.0.0.0/0\" } }</code>"
      },
      {
        "id": "C",
        "text": "<code>\"Condition\": { \"StringLike\": { \"s3:prefix\": \"*\" } }</code>"
      },
      {
        "id": "D",
        "text": "<code>\"Condition\": { \"Bool\": { \"aws:MultiFactorAuthPresent\": \"true\" } }</code>"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Configure the WAF rule action to <code>Challenge</code> (silent browser token verification) or <code>CAPTCHA</code> (interactive visual puzzle)"
      },
      {
        "id": "B",
        "text": "Set the action to <code>Count</code> and ignore the logs"
      },
      {
        "id": "C",
        "text": "Set the action to <code>Block</code> with HTTP 500 error code"
      },
      {
        "id": "D",
        "text": "Attach an Amazon Cognito User Pool to the load balancer"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "<code>deregistration_delay.timeout_seconds</code>"
      },
      {
        "id": "B",
        "text": "<code>stickiness.lb_cookie.duration_seconds</code>"
      },
      {
        "id": "C",
        "text": "<code>slow_start.duration_seconds</code>"
      },
      {
        "id": "D",
        "text": "<code>health_check_interval_seconds</code>"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a TLS listener on port 443 with an ACM certificate and attach a security group directly to the Network Load Balancer"
      },
      {
        "id": "B",
        "text": "Convert the NLB into a Classic Load Balancer"
      },
      {
        "id": "C",
        "text": "Attach an AWS WAF Web ACL directly to the NLB TCP listener"
      },
      {
        "id": "D",
        "text": "Deploy an iptables firewall on each backend target instance"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "In the EC2 User Data script by writing parameters to <code>/etc/sysctl.d/99-security.conf</code> and running <code>sysctl -p /etc/sysctl.d/99-security.conf</code>"
      },
      {
        "id": "B",
        "text": "In the IAM role trust policy attached to the instance"
      },
      {
        "id": "C",
        "text": "In the VPC DHCP options set configuration"
      },
      {
        "id": "D",
        "text": "In the Network ACL inbound rule configuration"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable S3 Versioning and configure MFA Delete using the AWS CLI with the AWS account root credentials and a physical MFA token"
      },
      {
        "id": "B",
        "text": "Attach an S3 bucket policy allowing s3:DeleteObject only during business hours"
      },
      {
        "id": "C",
        "text": "Enable S3 Server Access Logging and S3 Event Notifications"
      },
      {
        "id": "D",
        "text": "Configure Amazon S3 Transfer Acceleration"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "<code>drop http $HOME_NET any -&gt; $EXTERNAL_NET any (msg:\"Malware C2 Beacon Detected\"; content:\"malware_c2_beacon\"; http_uri; sid:1000001; rev:1;)</code>"
      },
      {
        "id": "B",
        "text": "<code>deny tcp any any -&gt; any any (action: block; string: \"malware_c2_beacon\";)</code>"
      },
      {
        "id": "C",
        "text": "<code>filter outbound http where uri contains 'malware_c2_beacon' drop</code>"
      },
      {
        "id": "D",
        "text": "<code>reject ip any -&gt; any (payload: \"malware_c2_beacon\")</code>"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "C",
        "text": "Default tenancy EC2 instances in an isolated VPC"
      },
      {
        "id": "D",
        "text": "Spot Instances with placement groups"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Configure a WAF SQL injection match statement that inspects the <code>Single header</code> or <code>Cookie</code> with the specific cookie name <code>session_token</code>"
      },
      {
        "id": "B",
        "text": "Inspect the query string for SQL injection patterns"
      },
      {
        "id": "C",
        "text": "Attach a rate-based rule on the IP address"
      },
      {
        "id": "D",
        "text": "Configure an ALB listener rule to drop all cookies"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "<code>restricted-common-ports</code>"
      },
      {
        "id": "B",
        "text": "<code>s3-bucket-public-read-prohibited</code>"
      },
      {
        "id": "C",
        "text": "<code>ec2-instance-managed-by-ssm</code>"
      },
      {
        "id": "D",
        "text": "<code>cloudtrail-enabled</code>"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Configure CloudFront Origin Access Control (OAC), and update the S3 bucket policy to allow s3:GetObject only when <code>aws:SourceArn</code> matches the CloudFront distribution ARN"
      },
      {
        "id": "B",
        "text": "Configure CloudFront Origin Access Identity (OAI) with an open S3 bucket policy"
      },
      {
        "id": "C",
        "text": "Store S3 objects with public-read ACLs"
      },
      {
        "id": "D",
        "text": "Configure Route 53 CNAME records pointing directly to S3"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "The CNAME record created during initial certificate issuance must remain permanently present in the domain's public DNS zone, and the certificate must be actively associated with an in-use AWS service"
      },
      {
        "id": "B",
        "text": "The certificate private key must be exported to an S3 bucket"
      },
      {
        "id": "C",
        "text": "The domain registrar must send a signed fax to Amazon Trust Services"
      },
      {
        "id": "D",
        "text": "The certificate must be renewed manually every 13 months via the AWS CLI"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "AWS Systems Manager Run Command using the <code>AWS-RunShellScript</code> document, logging standard output to an encrypted S3 bucket"
      },
      {
        "id": "B",
        "text": "SSH executed via bash loops over a public bastion host"
      },
      {
        "id": "C",
        "text": "AWS CodeDeploy deploying a full application update"
      },
      {
        "id": "D",
        "text": "AWS Lambda running inside the default VPC"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "AWS VPC Peering strictly forbids transitive routing; traffic cannot hop through an intermediate VPC, so VPC A cannot reach VPC C unless a direct peering connection is established"
      },
      {
        "id": "B",
        "text": "Transitive routing is enabled by default in all VPC peering connections"
      },
      {
        "id": "C",
        "text": "Transitive routing occurs only if Network ACLs allow port 80"
      },
      {
        "id": "D",
        "text": "VPC B automatically acts as a NAT gateway for VPC A"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "CloudFront Response Headers Policies attached to the distribution's cache behaviors"
      },
      {
        "id": "B",
        "text": "AWS WAF Web ACL request transformation rules"
      },
      {
        "id": "C",
        "text": "S3 metadata tags on each uploaded static file"
      },
      {
        "id": "D",
        "text": "Route 53 latency routing policies"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable TLS Inspection configuration on the Network Firewall policy, providing an internal CA certificate imported into AWS Certificate Manager (ACM) to generate re-signed certificates for inspected sessions"
      },
      {
        "id": "B",
        "text": "Install Wireshark on the Internet Gateway"
      },
      {
        "id": "C",
        "text": "Attach an AWS WAF Web ACL to the NAT Gateway"
      },
      {
        "id": "D",
        "text": "Deploy CloudFront in reverse proxy mode inside the private subnet"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Application Load Balancers (ALB), Amazon API Gateway REST APIs, AWS AppSync GraphQL APIs, Amazon Cognito User Pools, and AWS App Runner services"
      },
      {
        "id": "B",
        "text": "Amazon EC2 instances directly and Network Load Balancers"
      },
      {
        "id": "C",
        "text": "Amazon S3 buckets and Amazon EFS file systems"
      },
      {
        "id": "D",
        "text": "Amazon RDS databases and Amazon ElastiCache clusters"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Amazon EKS Security Groups for Pods using the Amazon VPC CNI plugin to attach dedicated Elastic Network Interfaces (ENIs) with distinct security groups directly to individual Kubernetes pods"
      },
      {
        "id": "B",
        "text": "Standard Kubernetes ClusterIP services without VPC integration"
      },
      {
        "id": "C",
        "text": "Relying solely on node-level security groups on the EC2 worker instances"
      },
      {
        "id": "D",
        "text": "Deploying an external squid proxy in a separate VPC"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable Termination Protection (<code>DisableApiTermination=true</code>) on the EC2 instance, and attach an IAM policy with an explicit Deny on <code>ec2:TerminateInstances</code> unless a specific MFA token is presented"
      },
      {
        "id": "B",
        "text": "Remove all security groups from the instance"
      },
      {
        "id": "C",
        "text": "Change the instance tenancy from Default to Dedicated"
      },
      {
        "id": "D",
        "text": "Store the EC2 instance ID in a private S3 bucket"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "The application embeds the AWS WAF JavaScript SDK to obtain an encrypted WAF token (cookie) verified by Challenge or CAPTCHA rules on sensitive mutating endpoints"
      },
      {
        "id": "B",
        "text": "AWS WAF replaces all user passwords with one-time SMS codes"
      },
      {
        "id": "C",
        "text": "The ALB drops all HTTP requests containing cookies"
      },
      {
        "id": "D",
        "text": "CloudFront caches all POST requests for 24 hours"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable **EBS encryption by default** in the EC2 settings for the Region, and specify a Customer Managed KMS Key as the default key"
      },
      {
        "id": "B",
        "text": "Attach an IAM policy denying ec2:RunInstances"
      },
      {
        "id": "C",
        "text": "Deploy an AWS Lambda function that stops instances every 10 minutes"
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Associate a custom route table containing only the local VPC route (e.g. <code>10.0.0.0/16 -&gt; local</code>) with zero 0.0.0.0/0 default routes"
      },
      {
        "id": "B",
        "text": "Add a route 0.0.0.0/0 pointing to an Internet Gateway with a disabled state"
      },
      {
        "id": "C",
        "text": "Configure a 0.0.0.0/0 route pointing to blackhole"
      },
      {
        "id": "D",
        "text": "Delete the subnet from the VPC"
      }
    ],
    "correctAnswers": [
      "A"
