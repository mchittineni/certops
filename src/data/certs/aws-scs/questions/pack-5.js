export const AWS_SCS_QUESTIONS_5 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "<code>\"Condition\": { \"IpAddress\": { \"aws:SourceIp\": \"0.0.0.0/0\" } }</code>" },
      { id: 'C', text: "<code>\"Condition\": { \"StringEquals\": { \"aws:PrincipalOrgID\": \"o-exampleorg123\" } }</code>" },
      { id: 'D', text: "<code>\"Condition\": { \"StringLike\": { \"s3:prefix\": \"*\" } }</code>" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon EC2 Dedicated Instances" },
      { id: 'B', text: "Amazon EC2 Dedicated Hosts" },
      { id: 'C', text: "Spot Instances with placement groups" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "<code>s3-bucket-public-read-prohibited</code>" },
      { id: 'B', text: "<code>ec2-instance-managed-by-ssm</code>" },
      { id: 'C', text: "<code>cloudtrail-enabled</code>" },
      { id: 'D', text: "<code>restricted-common-ports</code>" }
    ],
    correctAnswers: ['D'],
    type: "single",
