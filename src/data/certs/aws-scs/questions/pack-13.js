export const AWS_SCS_QUESTIONS_13 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Store logs in an S3 bucket with S3 Object Lock enabled in Compliance Mode with a 7-year retention period." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Store logs on an unencrypted on-premises NAS drive with no write protection." },
  ...
  },
  {
    ...
    question: "Which incident response workflow or AWS service configuration contains the threat effectively while preserving forensic evidence?",
    options: [
      { id: 'A', text: "Configure an Amazon Athena table utilizing Partition Projection on account, region, and date partitions." },
      { id: 'B', text: "Execute full table scans across millions of unindexed S3 objects using standard relational SELECT queries." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Delete historical log files older than 24 hours to keep query sizes small." },
      { id: 'C', text: "Download all S3 log files to a local database server before running SQL queries." },
      { id: 'D', text: "Configure an Amazon Athena table utilizing Partition Projection on account, region, and date partitions." }
    ],
    correctAnswers: ['D'],
