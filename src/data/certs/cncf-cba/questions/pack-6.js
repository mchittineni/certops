export const CNCF_CBA_QUESTIONS_6 = [
  {
    id: "cncf-cba-126",
    difficulty: "easy",
    certId: "cncf-cba",
    ...
    title: "Entity model taxonomy Component, API, Resource, System, and Domain: Operational Strategy (Part 126)",
    scenario: "A multinational fintech banking platform is evaluating Certified Backstage Associate practices specifically regarding Entity model taxonomy Component, API, Resource, System, and Domain. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #126.",
  ...
  },
  {
    ...
    title: "Scaffolder step actions fetch:template, publish:github, and catalog:register: Operational Strategy (Part 127)",
    scenario: "A healthcare telemedicine network is evaluating Certified Backstage Associate practices specifically regarding Scaffolder step actions fetch:template, publish:github, and catalog:register. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #127.",
  ...
  },
  {
    ...
    title: "Configuring Kubernetes plugin for multi-cluster pod and deployment views: Operational Strategy (Part 128)",
    scenario: "A high-throughput e-commerce retailer is evaluating Certified Backstage Associate practices specifically regarding Configuring Kubernetes plugin for multi-cluster pod and deployment views. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #128.",
  ...
  },
  {
    ...
    title: "Service discovery and app-config.yaml configuration hierarchy: Operational Strategy (Part 129)",
    scenario: "A global streaming entertainment platform is evaluating Certified Backstage Associate practices specifically regarding Service discovery and app-config.yaml configuration hierarchy. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #129.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Software Templates and Scaffolder",
    title: "Building dynamic UI parameter forms with react-jsonschema-form: Operational Strategy (Part 131)",
    scenario: "A logistics and supply chain optimization service is evaluating Certified Backstage Associate practices specifically regarding Building dynamic UI parameter forms with react-jsonschema-form. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #131.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Deploy native automation for building dynamic ui parameter forms with react-jsonschema-form utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'C', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'D', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." }
    ],
    correctAnswers: ['B'],
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Plugins, TechDocs and Administration",
    title: "CI/CD plugins integrating GitHub Actions, GitLab CI, and Jenkins: Operational Strategy (Part 132)",
    scenario: "An IoT industrial telematics infrastructure is evaluating Certified Backstage Associate practices specifically regarding CI/CD plugins integrating GitHub Actions, GitLab CI, and Jenkins. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #132.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Backstage Architecture and Core Concepts",
    title: "Authentication providers GitHub, Google, Okta, and Guest access: Operational Strategy (Part 133)",
    scenario: "A multi-tenant enterprise SaaS provider is evaluating Certified Backstage Associate practices specifically regarding Authentication providers GitHub, Google, Okta, and Guest access. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #133.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
      ...
      { id: 'C', text: "Deploy native automation for authentication providers github, google, okta, and guest access utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'D', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Software Catalog and Metadata",
    title: "Entity relations owner, dependsOn, providesApi, and consumesApi: Operational Strategy (Part 134)",
    scenario: "A public sector aerospace engineering department is evaluating Certified Backstage Associate practices specifically regarding Entity relations owner, dependsOn, providesApi, and consumesApi. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #134.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Software Templates and Scaffolder",
    title: "Authoring custom Scaffolder actions in the Backstage backend: Operational Strategy (Part 135)",
    scenario: "An automotive connected-vehicle fleet manager is evaluating Certified Backstage Associate practices specifically regarding Authoring custom Scaffolder actions in the Backstage backend. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #135.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Plugins, TechDocs and Administration",
    title: "Backstage Permissions framework role-based catalog access control: Operational Strategy (Part 136)",
    scenario: "A digital media publishing network is evaluating Certified Backstage Associate practices specifically regarding Backstage Permissions framework role-based catalog access control. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #136.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Backstage Architecture and Core Concepts",
    title: "Backstage plugin architecture core plugins vs community plugins: Operational Strategy (Part 137)",
    scenario: "A pharmaceutical clinical trial data service is evaluating Certified Backstage Associate practices specifically regarding Backstage plugin architecture core plugins vs community plugins. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #137.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Deploy native automation for backstage plugin architecture core plugins vs community plugins utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'C', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'D', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." }
    ],
    correctAnswers: ['B'],
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Software Templates and Scaffolder",
    title: "Dry-run testing and debugging template execution logs: Operational Strategy (Part 139)",
    scenario: "A mobile gaming backend architecture is evaluating Certified Backstage Associate practices specifically regarding Dry-run testing and debugging template execution logs. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #139.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Plugins, TechDocs and Administration",
    title: "Production deployment topology containerization, PostgreSQL, and caching: Operational Strategy (Part 140)",
    scenario: "A ride-sharing dispatch system is evaluating Certified Backstage Associate practices specifically regarding Production deployment topology containerization, PostgreSQL, and caching. The engineering group is implementing automated canary analysis with instant rollback capabilities triggered by error budget burn rates for service tier #140.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Backstage Architecture and Core Concepts",
    title: "Backstage monorepo architecture React frontend and Node.js backend: Operational Strategy (Part 141)",
    scenario: "An insurance claims processing engine is evaluating Certified Backstage Associate practices specifically regarding Backstage monorepo architecture React frontend and Node.js backend. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #141.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Software Catalog and Metadata",
    title: "catalog-info.yaml metadata schema syntax and API versions: Operational Strategy (Part 142)",
    scenario: "A commercial airline reservation service is evaluating Certified Backstage Associate practices specifically regarding catalog-info.yaml metadata schema syntax and API versions. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #142.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Software Templates and Scaffolder",
    title: "Backstage Software Templates Scaffolder syntax and template parameters: Operational Strategy (Part 143)",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Plugins, TechDocs and Administration",
    title: "TechDocs architecture mkdocs generation and cloud storage publishing: Operational Strategy (Part 144)",
    scenario: "A real estate property management portal is evaluating Certified Backstage Associate practices specifically regarding TechDocs architecture mkdocs generation and cloud storage publishing. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #144.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Backstage Architecture and Core Concepts",
    title: "Core concepts Software Catalog, Software Templates, TechDocs, and Search: Operational Strategy (Part 145)",
    scenario: "An autonomous robotics manufacturing facility is evaluating Certified Backstage Associate practices specifically regarding Core concepts Software Catalog, Software Templates, TechDocs, and Search. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #145.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Software Catalog and Metadata",
    title: "Entity model taxonomy Component, API, Resource, System, and Domain: Operational Strategy (Part 146)",
    scenario: "A higher education student information system is evaluating Certified Backstage Associate practices specifically regarding Entity model taxonomy Component, API, Resource, System, and Domain. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #146.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Deploy native automation for entity model taxonomy component, api, resource, system, and domain utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Software Templates and Scaffolder",
    title: "Scaffolder step actions fetch:template, publish:github, and catalog:register: Operational Strategy (Part 147)",
    scenario: "A global hotel hospitality reservation platform is evaluating Certified Backstage Associate practices specifically regarding Scaffolder step actions fetch:template, publish:github, and catalog:register. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #147.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Plugins, TechDocs and Administration",
    title: "Configuring Kubernetes plugin for multi-cluster pod and deployment views: Operational Strategy (Part 148)",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Backstage Architecture and Core Concepts",
    title: "Service discovery and app-config.yaml configuration hierarchy: Operational Strategy (Part 149)",
    scenario: "A genomics sequencing data pipeline is evaluating Certified Backstage Associate practices specifically regarding Service discovery and app-config.yaml configuration hierarchy. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #149.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Software Catalog and Metadata",
    title: "Organizational entities User and Group defining service ownership: Operational Strategy (Part 150)",
...
export default CNCF_CBA_QUESTIONS_6;
