export const CNCF_CBA_QUESTIONS_14 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Commit an unformatted binary blob to an untracked local git branch." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Leave the owner field blank to encourage shared responsibility without accountability." },
      { id: 'D', text: "Assign all enterprise software to the CEO's personal User entity." }
    ],
    correctAnswers: ['A'],
    type: "single",
