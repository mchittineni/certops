export const CNCF_CBA_QUESTIONS_14 = [
  ...
  },
  {
    ...
    question: "Which architectural approach or Backstage configuration satisfies these enterprise portal objectives?",
    options: [
      { id: 'A', text: "Set `spec.owner` to the team Slack channel URL, which the catalog cannot resolve to an entity." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Set `spec.owner` to the team Slack channel URL, which the catalog cannot resolve to an entity." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Set `spec.owner` to the team Slack channel URL, which the catalog cannot resolve to an entity." },
