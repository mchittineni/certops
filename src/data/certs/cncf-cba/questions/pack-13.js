export const CNCF_CBA_QUESTIONS_13 = [
  {
    ...
    options: [
      { id: 'A', text: "Disable CORS security checks and bypass backend authorization entirely." },
      ...
      { id: 'D', text: "Send user passwords in plaintext URL query strings." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Send user passwords in plaintext URL query strings." },
      ...
      { id: 'C', text: "Use raw browser `window.fetch` without attaching authentication headers." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Send user passwords in plaintext URL query strings." },
      { id: 'B', text: "Disable CORS security checks and bypass backend authorization entirely." },
      { id: 'C', text: "Use raw browser `window.fetch` without attaching authentication headers." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable CORS security checks and bypass backend authorization entirely." },
      { id: 'B', text: "Send user passwords in plaintext URL query strings." },
      { id: 'C', text: "Use the Backstage `fetchApi` (`fetchApi.fetch(...)`), which automatically injects the active user's `Authorization: Bearer &lt;token&gt;` header." },
      { id: 'D', text: "Use raw browser `window.fetch` without attaching authentication headers." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Use the Backstage `fetchApi` (`fetchApi.fetch(...)`), which automatically injects the active user's `Authorization: Bearer &lt;token&gt;` header. The Backstage `FetchApi` wraps the standard Fetch API to automatically inject authorization headers containing Backstage identity tokens on requests directed to Backstage backend plugins, guaranteeing authenticated request forwarding.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Display raw stack traces in modal alert popups that block user interaction indefinitely." },
      { id: 'B', text: "Trigger user alerts using `alertApi.post({ message, severity: 'error' })` and report exceptions via `errorApi.post(error)`." },
      { id: 'C', text: "Silently suppress all application errors without logging or user notification." },
      { id: 'D', text: "Crash the entire browser window using unhandled JavaScript exceptions." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Crash the entire browser window using unhandled JavaScript exceptions." },
      { id: 'B', text: "Silently suppress all application errors without logging or user notification." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Silently suppress all application errors without logging or user notification." },
      { id: 'B', text: "Crash the entire browser window using unhandled JavaScript exceptions." },
      { id: 'C', text: "Trigger user alerts using `alertApi.post({ message, severity: 'error' })` and report exceptions via `errorApi.post(error)`." },
      { id: 'D', text: "Display raw stack traces in modal alert popups that block user interaction indefinitely." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Trigger user alerts using `alertApi.post({ message, severity: 'error' })` and report exceptions via `errorApi.post(error)`. Backstage provides standard utility APIs including `AlertApi` and `ErrorApi`. Plugins post notification messages with severity levels (`info`, `warning`, `error`) to display uniform toast notifications, while exceptions are forwarded to centralized monitoring.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run Backstage directly inside a root developer workstation terminal connected via SSH." },
      { id: 'B', text: "Expose raw development servers running with hot-reloading enabled in production." },
      ...
      { id: 'D', text: "Deploy the entire development repository including git history, test suites, and uncompiled source code into production containers." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Expose raw development servers running with hot-reloading enabled in production." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run Backstage directly inside a root developer workstation terminal connected via SSH." },
      { id: 'B', text: "Build a multi-stage Docker image that compiles frontend assets into static files served by the Node.js backend runtime." },
      { id: 'C', text: "Deploy the entire development repository including git history, test suites, and uncompiled source code into production containers." },
      { id: 'D', text: "Expose raw development servers running with hot-reloading enabled in production." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy the entire development repository including git history, test suites, and uncompiled source code into production containers." },
      { id: 'B', text: "Build a multi-stage Docker image that compiles frontend assets into static files served by the Node.js backend runtime." },
      { id: 'C', text: "Run Backstage directly inside a root developer workstation terminal connected via SSH." },
      { id: 'D', text: "Expose raw development servers running with hot-reloading enabled in production." }
    ],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure Kubernetes liveness and readiness probes against `/.backstage/health/v1/readiness` and export Prometheus metrics using `@backstage/plugin-metrics-node`." },
      { id: 'B', text: "Ping the portal home page once daily over email." },
      { id: 'C', text: "Rely exclusively on manual user bug reports to detect service outages." },
      { id: 'D', text: "Disable Kubernetes health probes to prevent restarting failed pods." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Configure Kubernetes liveness and readiness probes against `/.backstage/health/v1/readiness` and export Prometheus metrics using `@backstage/plugin-metrics-node`. Backstage backend services expose standard health check endpoints (`/.backstage/health/v1/liveness` and `/.backstage/health/v1/readiness`) for Kubernetes probes and support Prometheus metrics collection to monitor HTTP latencies, queue depths, and database pools.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Rely exclusively on manual user bug reports to detect service outages." },
      { id: 'B', text: "Disable Kubernetes health probes to prevent restarting failed pods." },
      ...
      { id: 'D', text: "Ping the portal home page once daily over email." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Configure Kubernetes liveness and readiness probes against `/.backstage/health/v1/readiness` and export Prometheus metrics using `@backstage/plugin-metrics-node`. Backstage backend services expose standard health check endpoints (`/.backstage/health/v1/liveness` and `/.backstage/health/v1/readiness`) for Kubernetes probes and support Prometheus metrics collection to monitor HTTP latencies, queue depths, and database pools.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Ping the portal home page once daily over email." },
      { id: 'B', text: "Disable Kubernetes health probes to prevent restarting failed pods." },
      { id: 'C', text: "Rely exclusively on manual user bug reports to detect service outages." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable Kubernetes health probes to prevent restarting failed pods." },
      { id: 'B', text: "Rely exclusively on manual user bug reports to detect service outages." },
      { id: 'C', text: "Ping the portal home page once daily over email." },
      { id: 'D', text: "Configure Kubernetes liveness and readiness probes against `/.backstage/health/v1/readiness` and export Prometheus metrics using `@backstage/plugin-metrics-node`." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Store search indices in plaintext memory without any indexing data structures." },
      { id: 'B', text: "Force users to manually browse hundreds of raw YAML files to find software documentation." },
      ...
      { id: 'D', text: "Perform sequential full-table scans across all database tables for every individual search keystroke." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Store search indices in plaintext memory without any indexing data structures." },
      { id: 'C', text: "Perform sequential full-table scans across all database tables for every individual search keystroke." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Perform sequential full-table scans across all database tables for every individual search keystroke." },
      { id: 'B', text: "Force users to manually browse hundreds of raw YAML files to find software documentation." },
      { id: 'C', text: "Configure `@backstage/plugin-search-backend` with document Collators feeding into a search engine backend like Elasticsearch or Postgres." },
      { id: 'D', text: "Store search indices in plaintext memory without any indexing data structures." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Configure `@backstage/plugin-search-backend` with document Collators feeding into a search engine backend like Elasticsearch or Postgres. Backstage Search combines document collators (which extract metadata from sources like Catalog or TechDocs), index decorators, and a search engine (Lunr for dev, Elasticsearch or Postgres for production) to provide indexed full-text search across portal assets.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Force users to manually browse hundreds of raw YAML files to find software documentation." },
      { id: 'B', text: "Store search indices in plaintext memory without any indexing data structures." },
      { id: 'C', text: "Configure `@backstage/plugin-search-backend` with document Collators feeding into a search engine backend like Elasticsearch or Postgres." },
      { id: 'D', text: "Perform sequential full-table scans across all database tables for every individual search keystroke." }
    ],
