export const CNCF_CBA_QUESTIONS_17 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Compile raw C++ binaries inside client browser tabs." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Upload code to public unauthenticated pastebins." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Delete the catalog-info.yaml file during repository publishing." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy untested templates directly to all enterprise development teams in production." },
