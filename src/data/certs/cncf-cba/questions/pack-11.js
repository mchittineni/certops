export const CNCF_CBA_QUESTIONS_11 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Hardcode all UI components into a single massive index.html file." },
      { id: 'C', text: "Embed separate iframe elements for every external team website with no shared routing." },
      { id: 'D', text: "Execute imperative DOM queries from backend database workers to render client buttons." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Manually instantiate hundreds of raw Express routers inside a single procedural callback." },
      { id: 'C', text: "Deploy separate independent virtual machines for every backend helper utility." },
      { id: 'D', text: "Remove the Node.js backend entirely and connect the browser directly to PostgreSQL." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Store portal configuration across thousands of disconnected unversioned text files on local developer laptops." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Bypass authentication by granting all anonymous visitors root cluster admin access." },
