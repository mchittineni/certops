export const CNCF_CBA_QUESTIONS_15 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Model databases as frontend website Component entities." },
      { id: 'D', text: "Assume all applications connect exclusively to local temporary memory." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Instruct developers to bypass catalog registration and rely on memory." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Instruct human administrators to type 50,000 user records into a spreadsheet." },
      { id: 'D', text: "Disable user authentication and ownership validation." }
    ],
    correctAnswers: ['A'],
    type: "single",
