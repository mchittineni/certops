export const CNCF_CBA_QUESTIONS_18 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Store GitHub personal access tokens in public git repository README files." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Modify Backstage core library source files directly inside node_modules." },
