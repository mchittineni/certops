export const AWS_DOP_QUESTIONS_4 = [
  {
    ...
    certId: "aws-dop",
    domainId: "d2",
    domainName: "Configuration Management and IaC",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Attach an IAM permission boundary to all users that denies cloudformation:DescribeStacks" },
      { id: 'B', text: "Set the stack status to ROLLBACK_COMPLETE and lock the template in Amazon S3" },
      { id: 'C', text: "Configure DeletionPolicy: Retain on all individual resources in the template" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Individual AWS Config rules deployed via manual CloudFormation templates in each account" },
      { id: 'B', text: "An AWS Systems Manager State Manager association executing a shell script that verifies CIS controls" },
      { id: 'C', text: "AWS Config Conformance Packs deployed at the AWS Organizations level as an Organization Conformance Pack" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon DynamoDB single-region table with periodic nightly S3 export backups" },
      { id: 'B', text: "Amazon Aurora Global Database with managed storage-level replication across target regions" },
      { id: 'C', text: "Amazon RDS for MySQL with cross-region read replicas using asynchronous binlog replication" },
      { id: 'D', text: "EC2 instances running self-managed PostgreSQL with custom rsync scripts over VPN" }
    ],
    correctAnswers: ['B'],
    type: "single",
