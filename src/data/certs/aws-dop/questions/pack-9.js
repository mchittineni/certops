export const AWS_DOP_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon SQS with message delay timers" },
      { id: 'B', text: "AWS Step Functions Standard Workflows" },
      { id: 'C', text: "AWS Lambda with a 15-minute execution limit" },
      { id: 'D', text: "Amazon EventBridge rules with cron expressions" }
    ],
    correctAnswers: ['B'],
    type: "single",
