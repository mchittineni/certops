export const AWS_DOP_QUESTIONS_9 = [
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable S3 Replication Time Control (S3 RTC) and configure CloudWatch alarms on the ReplicationLatency and OperationsFailedReplication metrics"
      },
      {
        "id": "B",
        "text": "Write a Python script that compares S3 bucket inventory files daily using Athena"
      },
      {
        "id": "C",
        "text": "Configure S3 Object Lock with legal hold enabled"
      },
      {
        "id": "D",
        "text": "Enable S3 Transfer Acceleration on both buckets"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "AWS Systems Manager Quick Setup deployed at the AWS Organizations management level targeting all member accounts"
      },
      {
        "id": "B",
        "text": "A manual bash script executed via SSH on each instance"
      },
      {
        "id": "C",
        "text": "An AWS CloudFormation template applied manually in each member account console"
      },
      {
        "id": "D",
        "text": "An AWS Organizations SCP denying instance launches without tags"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "B",
        "text": "AWS Lambda with a 15-minute execution limit"
      },
      {
        "id": "C",
        "text": "Amazon EventBridge rules with cron expressions"
      },
      {
        "id": "D",
        "text": "Amazon SQS with message delay timers"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "DynamoDB Global Tables provide active-active multi-region replication with automatic 'last-writer-wins' conflict resolution; applications simply redirect requests to the healthy regional DynamoDB endpoint"
      },
      {
        "id": "B",
        "text": "Applications must execute a manual failover command in the DynamoDB console to promote the replica table"
      },
      {
        "id": "C",
        "text": "DynamoDB Global Tables require an external Redis cluster to synchronize distributed transaction locks"
      },
      {
        "id": "D",
        "text": "Write operations are blocked during a regional outage until an administrator restores a backup"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "AWS Systems Manager OpsCenter"
      },
      {
        "id": "B",
      ...
      {
        "id": "C",
        "text": "AWS Systems Manager Maintenance Windows"
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Amazon Data Lifecycle Manager (Amazon DLM) lifecycle policies targeting volumes by resource tags"
      },
      {
        "id": "B",
        "text": "A scheduled cron job on an EC2 instance that executes the ec2:CreateSnapshot API"
      },
      {
        "id": "C",
        "text": "An AWS Lambda function triggered by an EventBridge scheduled rule running a custom snapshot script"
      },
      {
        "id": "D",
        "text": "AWS CloudFormation custom resources that recreate volumes daily"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "B",
        "text": "AWS CloudTrail Event History with standard filters"
      },
      {
        "id": "C",
        "text": "Amazon Macie data discovery"
      },
      {
        "id": "D",
        "text": "AWS Trusted Advisor Service Limits check"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "CodeDeploy monitors the CloudWatch alarm configured on the deployment group; when the alarm triggers, CodeDeploy immediately aborts the deployment, shifts 100% of traffic back to the previous Lambda version, and marks the deployment as failed"
      },
      {
        "id": "B",
        "text": "The engineer must manually click 'Stop and roll back deployment' in the CodeDeploy console"
      },
      {
        "id": "C",
        "text": "CodeDeploy retries the deployment 3 times before terminating the Lambda function"
      },
      {
        "id": "D",
        "text": "API Gateway returns HTTP 503 until a developer pushes a hotfix to CodeCommit"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "KMS keys cannot be accessed by IAM roles within the same AWS account"
      },
      {
        "id": "B",
        "text": "The IAM role must be assigned an Elastic IP address to authenticate with KMS"
      },
      {
        "id": "C",
        "text": "The KMS key policy does not contain a statement delegating access to the account root or specifically authorizing the IAM role"
      },
      {
        "id": "D",
        "text": "KMS Customer Managed Keys only support symmetrical encryption via AWS CLI root credentials"
      }
    ],
    "correctAnswers": [
      "C"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Rotate passwords manually during quarterly maintenance downtime windows"
      },
      {
        "id": "B",
        "text": "Write an on-premises batch script that changes passwords and emails credentials to developers"
      },
      {
        "id": "C",
        "text": "Store passwords in clear text in an S3 bucket with versioning and object lock enabled"
      },
      {
        "id": "D",
        "text": "Configure AWS Secrets Manager with automatic rotation enabled, using the built-in AWS Lambda rotation function template within the database VPC"
      }
    ],
    "correctAnswers": [
      "D"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "An SCP with an explicit 'Deny' on '*' with a StringNotEquals condition on 'aws:RequestedRegion' for 'eu-west-1' and 'eu-central-1', combined with a StringNotLike condition excluding services like 'iam:*', 'route53:*', 'cloudfront:*', and 'support:*'"
      },
      {
        "id": "B",
        "text": "An SCP with an explicit 'Allow' statement that lists only 'eu-west-1' and 'eu-central-1' in the Action element"
      },
      {
        "id": "C",
        "text": "An AWS Config rule that automatically terminates instances launched outside of the approved European regions"
      },
      {
        "id": "D",
        "text": "An IAM permission boundary applied to individual IAM users in member accounts"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Deploy the rotation Lambda function in the same VPC and private subnets as the Aurora database, configure a Secrets Manager VPC Interface Endpoint (PrivateLink) with appropriate security group rules, and configure Secrets Manager automatic rotation"
      },
      {
        "id": "B",
        "text": "Attach an Internet Gateway to the database private subnets to allow the rotation Lambda to reach AWS endpoints"
      },
      {
        "id": "C",
        "text": "Write a Python script on an on-premises server that connects over public internet to change the password"
      },
      {
        "id": "D",
        "text": "Store database credentials in plaintext in an Amazon S3 bucket with versioning enabled"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Attach an IAM Permission Boundary to developer identities requiring that any 'iam:CreateRole' or 'iam:PutRolePolicy' call must specify the same permission boundary ARN"
      },
      {
        "id": "B",
        "text": "Use Service Control Policies (SCPs) to deny IAM role creation across all member accounts"
      },
      {
        "id": "C",
        "text": "Configure an AWS Config rule that triggers an alert when a role with AdministratorAccess is created"
      },
      {
        "id": "D",
        "text": "Grant developers IAM ReadOnlyAccess and require support tickets for all role requests"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable Amazon ECR Enhanced Scanning powered by Amazon Inspector, configured with continuous scanning on repositories"
      },
      {
        "id": "B",
        "text": "Enable ECR Basic Scanning on push and run a daily cron job that triggers scans via the AWS CLI"
      },
      {
        "id": "C",
        "text": "Run an open-source scanner in the local Docker daemon on developer laptops before pushing"
      },
      {
        "id": "D",
        "text": "Deploy an EC2 instance running a vulnerability scanner that pulls images from ECR hourly"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "The KMS Key Policy in Account A must grant 'kms:Decrypt' to Account B (or the pipeline role ARN), the S3 Bucket Policy in Account A must grant 's3:GetObject' to Account B, and the IAM Role in Account B must have permissions for both 's3:GetObject' and 'kms:Decrypt' targeting the Key ARN in Account A"
      },
      {
        "id": "B",
        "text": "Disable encryption on the S3 bucket in Account A"
      },
      {
        "id": "C",
        "text": "Attach the AWS-managed 'aws/s3' KMS key policy to the Account B IAM role"
      },
      {
        "id": "D",
        "text": "Create an IAM user in Account A and hardcode its static access keys in Account B"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Configure the CloudFront cache behavior with 'Viewer Protocol Policy: Redirect HTTP to HTTPS', set the CloudFront Security Policy to TLSv1.2_2021, and configure the ALB HTTPS listener with a modern predefined SSL Security Policy (such as ELBSecurityPolicy-TLS13-1-2-2021-06)"
      },
      {
        "id": "B",
        "text": "Deploy an AWS WAF rule that blocks HTTP requests with a 403 status code"
      },
      {
        "id": "C",
        "text": "Disable port 80 in the VPC security group and configure a self-signed certificate on the EC2 instances"
      },
      {
        "id": "D",
        "text": "Enable Route 53 DNSSEC on the domain hosted zone"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "AWS Security Hub with automated security standards enabled across all member accounts"
      },
      {
        "id": "B",
        "text": "AWS Trusted Advisor Cost Optimization dashboard"
      },
      {
        "id": "C",
      ...
      {
        "id": "D",
        "text": "AWS Systems Manager Run Command executing OpenSCAP scripts"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Use the Condition 'StringEquals: { \"aws:ResourceTag/Project\": \"${aws:PrincipalTag/Project}\" }' in the IAM policy attached to the developer role"
      },
      {
        "id": "B",
        "text": "Create 20 separate IAM policies explicitly hardcoding the resource ARNs for each project"
      },
      {
        "id": "C",
        "text": "Use Service Control Policies with an explicit deny for all EC2 actions"
      },
      {
        "id": "D",
        "text": "Deploy an AWS Lambda function that checks tags every 5 minutes and terminates non-compliant instances"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Deploy the AWS Config managed rule 'encrypted-volumes', configure an Automatic Remediation targeting an SSM Automation runbook that creates an encrypted copy and updates the instance attachment"
      },
      {
        "id": "B",
        "text": "Create an IAM policy denying the ec2:CreateVolume API action"
      },
      {
        "id": "C",
        "text": "Deploy an AWS WAF rule targeting EBS API endpoints"
      },
      {
        "id": "D",
        "text": "Schedule an AWS Lambda function to poll all EBS volumes once a week"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Configure an IAM OpenID Connect (OIDC) identity provider for GitHub in AWS, and create an IAM role with a trust policy allowing GitHub Actions to assume the role using the sts:AssumeRoleWithWebIdentity action with repository-specific Subject (sub) conditions"
      },
      {
        "id": "B",
        "text": "Rotate the static IAM access keys manually every 7 days in the GitHub secrets settings"
      },
      {
        "id": "C",
        "text": "Deploy an EC2 instance in a public subnet to act as a self-hosted GitHub Actions runner"
      },
      {
        "id": "D",
        "text": "Generate temporary AWS credentials using AWS CloudShell and paste them into GitHub before each build"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Use DNS Validation and add the generated CNAME records to the domain's Amazon Route 53 hosted zone; ACM automatically validates and renews the certificates as long as the CNAME records remain in place"
      },
      {
        "id": "B",
        "text": "Use Email Validation and configure an automated email parsing Lambda function"
      },
      {
        "id": "C",
        "text": "Purchase certificates from a third-party CA and import them into ACM annually"
      },
      {
        "id": "D",
        "text": "Write a script that calls the acm:RequestCertificate API every 90 days"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create an AWS WAF Web ACL associated with the API Gateway stage, adding the AWSManagedRulesSQLiRuleSet, the AWSManagedRulesAmazonIpReputationList, and a custom Rate-Based Rule with an action of Block"
      },
      {
        "id": "B",
        "text": "Deploy an Amazon CloudFront distribution with an origin access control (OAC)"
      },
      {
        "id": "C",
        "text": "Configure an EC2 security group allowing inbound traffic only from port 443"
      },
      {
        "id": "D",
        "text": "Enable Amazon GuardDuty S3 Protection in the account"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Run 'aws accessanalyzer validate-policy' in the CI build step to check policies for syntax errors, security warnings, and general recommendations"
      },
      {
        "id": "B",
        "text": "Run 'aws iam get-account-summary' to check policy quota limits"
      },
      {
        "id": "C",
        "text": "Execute 'aws cloudtrail lookup-events' to verify IAM API calls"
      },
      {
        "id": "D",
        "text": "Deploy the policies to a production account and check CloudWatch alarms"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable S3 Versioning and S3 Object Lock in Compliance Mode with a retention period of 7 years on the bucket"
      },
      {
        "id": "B",
        "text": "Enable S3 Object Lock in Governance Mode with a retention period of 7 years"
      },
      {
        "id": "C",
        "text": "Configure an S3 Bucket Policy with an explicit Deny on s3:DeleteObject"
      },
      {
        "id": "D",
        "text": "Enable S3 Server-Side Encryption with Customer-Provided Keys (SSE-C)"
      }
    ],
    "correctAnswers": [
      "A"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Enable Amazon GuardDuty with EKS Audit Log Monitoring and GuardDuty EKS Runtime Monitoring"
      },
      {
        "id": "B",
        "text": "Configure Amazon Inspector on EC2 worker nodes"
      },
      {
        "id": "C",
        "text": "Deploy an open-source Falco DaemonSet that writes logs to a local file"
      },
      {
        "id": "D",
        "text": "Enable AWS Config managed rules for EC2 instances"
      }
    ],
    "correctAnswers": [
      "A"
