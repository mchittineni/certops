export const AWS_DOP_QUESTIONS_1 = [
  {
    ...
    tags: ["CodePipeline", "KMS", "Cross-Account", "IAM"]
  },
  {
    id: "aws-dop-2",
    difficulty: "medium",
    ...
    tags: ["CodeDeploy", "Lambda", "Canary", "AppSpec"]
  },
  {
    id: "aws-dop-3",
    difficulty: "hard",
    ...
    options: [
      ...
      { id: 'C', text: "AfterInstall" },
      { id: 'D', text: "AfterAllowTestTraffic" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    tags: ["CodeDeploy", "ECS", "AppSpec", "Lifecycle Hooks"]
  },
  {
    id: "aws-dop-4",
    difficulty: "medium",
    ...
    tags: ["CodeBuild", "VPC", "Networking", "Security"]
  },
  {
    id: "aws-dop-5",
    difficulty: "easy",
    ...
    tags: ["CodeBuild", "Caching", "Performance", "Optimization"]
  },
  {
    id: "aws-dop-6",
    difficulty: "medium",
    ...
    tags: ["CodeDeploy", "Rollback", "CloudWatch", "Alarms"]
  },
  {
    id: "aws-dop-7",
    difficulty: "hard",
    ...
    tags: ["CodePipeline", "Multi-Region", "KMS", "Artifacts"]
  },
  {
    id: "aws-dop-8",
    difficulty: "medium",
    ...
    tags: ["Elastic Beanstalk", "Deployment Policies", "Compute"]
  },
  {
    id: "aws-dop-9",
    difficulty: "medium",
    ...
    options: [
      ...
      { id: 'D', text: "AWS CodeStar Connections (AWS CodeConnections)" }
    ],
    correctAnswers: ['D'],
    type: "single",
    ...
    tags: ["CodePipeline", "GitHub", "CodeConnections", "SDLC"]
  },
  {
    id: "aws-dop-10",
    difficulty: "easy",
    ...
    tags: ["CodeBuild", "CodeDeploy", "Buildspec", "AppSpec"]
  },
  {
    id: "aws-dop-11",
    difficulty: "medium",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Manual ECS service replica updates using the AWS CLI" },
      { id: 'C', text: "Route 53 round-robin DNS records configured with 0-second TTL" },
      { id: 'D', text: "Canary10Percent10Minutes deployment configuration using an ALB listener rule" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which configuration or architectural pattern satisfies these requirements?",
    options: [
      { id: 'A', text: "Triggering Lambda functions with synchronous HTTP polling" },
      { id: 'B', text: "Launching hundreds of independent CodePipeline pipelines manually" },
      { id: 'C', text: "AWS CodeBuild batch build matrix configuration" },
      { id: 'D', text: "Running tests sequentially on a single EC2 instance" }
    ],
    correctAnswers: ['C'],
    type: "single",
