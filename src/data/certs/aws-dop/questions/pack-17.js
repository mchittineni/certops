export const AWS_DOP_QUESTIONS_17 = [
  {
    ...
    options: [
      { id: 'A', text: "Rely on internal ping checks to load balancer health check endpoints." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy Amazon CloudWatch Synthetics Canaries running Puppeteer/Node.js scripts on a recurring 5-minute schedule." },
      { id: 'D', text: "Wait for customer support calls to discover checkout breakage." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Inspect log streams one by one in the CloudWatch management console." },
      ...
      { id: 'D', text: "Write a custom MapReduce job on Amazon EMR to scan log files." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable container metric collection to save disk storage." },
      { id: 'B', text: "Write a custom bash script inside each Docker container to push metrics." },
      { id: 'C', text: "Enable CloudWatch Container Insights on the ECS cluster or deploy the AWS Distro for OpenTelemetry (ADOT) collector on EKS." },
      { id: 'D', text: "SSH into every Kubernetes worker node and run top command manually." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Write a custom bash script inside each Docker container to push metrics." },
      { id: 'B', text: "Disable container metric collection to save disk storage." },
      { id: 'C', text: "SSH into every Kubernetes worker node and run top command manually." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Send all alerts to a junk email folder." },
      ...
      { id: 'C', text: "Configure separate individual alarms that both send high-priority SMS pages." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Configure separate individual alarms that both send high-priority SMS pages." },
      { id: 'D', text: "Create a CloudWatch Composite Alarm that uses boolean rule logic (`ALARM(HighCPU) AND ALARM(High5xxErrors)`) to trigger incident notifications." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Create a CloudWatch Composite Alarm that uses boolean rule logic (`ALARM(HighCPU) AND ALARM(High5xxErrors)`) to trigger incident notifications. CloudWatch Composite Alarms evaluate multiple underlying metric alarms using boolean logic (`AND`, `OR`, `NOT`). This prevents alert noise and false positives by triggering actions only when multiple related indicators simultaneously degrade (e.g., CPU high AND error rate elevated).",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Send all alerts to a junk email folder." },
      { id: 'B', text: "Disable alerts whenever CPU utilization exceeds 80%." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Enable CloudWatch cross-account cross-region observability by sharing monitoring accounts with source accounts and building unified dashboards." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Require all services to run in a single AWS account and region." },
      { id: 'D', text: "Export metrics to CSV files and build manual graphs in Excel." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Enable CloudWatch cross-account cross-region observability by sharing monitoring accounts with source accounts and building unified dashboards. CloudWatch cross-account cross-region observability allows designated monitoring accounts to seamlessly search, visualize, and analyze metrics, logs, and traces across thousands of source accounts and regions without requiring complex manual data pipelines.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Export metrics to CSV files and build manual graphs in Excel." },
      { id: 'B', text: "Enable CloudWatch cross-account cross-region observability by sharing monitoring accounts with source accounts and building unified dashboards." },
      { id: 'C', text: "Open multiple browser windows logged into separate AWS accounts simultaneously." },
      { id: 'D', text: "Require all services to run in a single AWS account and region." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable CloudWatch cross-account cross-region observability by sharing monitoring accounts with source accounts and building unified dashboards." },
      { id: 'B', text: "Require all services to run in a single AWS account and region." },
      { id: 'C', text: "Export metrics to CSV files and build manual graphs in Excel." },
      { id: 'D', text: "Open multiple browser windows logged into separate AWS accounts simultaneously." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Enable CloudWatch cross-account cross-region observability by sharing monitoring accounts with source accounts and building unified dashboards. CloudWatch cross-account cross-region observability allows designated monitoring accounts to seamlessly search, visualize, and analyze metrics, logs, and traces across thousands of source accounts and regions without requiring complex manual data pipelines.",
