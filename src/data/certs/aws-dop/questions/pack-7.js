export const AWS_DOP_QUESTIONS_7 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "CloudWatch Logs Insights query in batch mode" },
      { id: 'C', text: "CloudWatch Logs Live Tail" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Amazon QuickSight dashboard" },
      { id: 'C', text: "AWS Config timeline view" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Budgets Alerts" },
      { id: 'B', text: "Amazon Inspector" },
      { id: 'C', text: "Amazon CloudWatch Application Signals" },
