export const AWS_DOP_QUESTIONS_5 = [
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Configure the Lambda function to delete any message that fails on the first attempt without logging"
      },
      {
        "id": "B",
        "text": "Increase the SQS visibility timeout to 12 hours so failed messages remain hidden"
      },
      {
        "id": "C",
        "text": "Replace the standard queue with an Amazon SNS FIFO topic with zero retries"
      },
      {
        "id": "D",
        "text": "Configure an Amazon SQS Dead-Letter Queue (DLQ) with a maxReceiveCount threshold, and use SQS dead-letter queue redrive to reprocess messages after fixing the underlying bug"
      }
    ],
    "correctAnswers": [
      "D"
