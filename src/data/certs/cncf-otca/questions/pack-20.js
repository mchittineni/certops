export const CNCF_OTCA_QUESTIONS_20 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Store plain text authentication passwords inside Git repositories." },
      { id: 'C', text: "Configure TLS/mTLS and authentication extensions (`bearertokenauth`) on receivers, and use `redaction` processor to scrub sensitive attributes." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Never redact customer passwords from telemetry traces." },
      { id: 'B', text: "Store plain text authentication passwords inside Git repositories." },
  ...
  },
  {
    ...
    question: "Which OpenTelemetry component design or collector configuration handles this volume efficiently while protecting downstream storage backends?",
    options: [
      { id: 'A', text: "Crash the entire Kubernetes node to shed load." },
      { id: 'B', text: "Disable all rate limiting and backpressure mechanisms." },
      { id: 'C', text: "Configure `memory_limiter` to return backpressure (HTTP 429 / gRPC ResourceExhausted) to upstream clients, forcing senders to throttle." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Recompile third-party database exporters from source code." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which OpenTelemetry configuration or processor implementation satisfies these security and governance controls?",
    options: [
      { id: 'A', text: "Deploy a standalone Prometheus server, a Thanos cluster, and a Grafana instance solely to scrape one endpoint." },
      { id: 'B', text: "Recompile third-party database exporters from source code." },
      { id: 'C', text: "Configure the `prometheus` receiver in the OpenTelemetry Collector with standard Prometheus scrape configurations and job definitions." },
      { id: 'D', text: "Prometheus format metrics cannot be ingested by OpenTelemetry." }
    ],
    correctAnswers: ['C'],
    type: "single",
