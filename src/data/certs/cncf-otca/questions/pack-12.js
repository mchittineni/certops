export const CNCF_OTCA_QUESTIONS_12 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Use the OpenTelemetry Baggage API to attach key-value pairs that are propagated across network boundaries via W3C Baggage headers." },
      { id: 'B', text: "Pass customer metadata in raw TCP socket options." },
  ...
  },
  {
    ...
    scenario: "An enterprise observability architecture team is standardizing distributed telemetry collection, correlation, and sampling pipelines across multiple cloud environments. The observability engineer needs to model an operation within a payment service that performs an external credit card authorization and records fraud check timestamps.",
    question: "Which architectural approach or OpenTelemetry configuration satisfies these enterprise observability objectives?",
    options: [
      ...
      { id: 'C', text: "Spans cannot contain attributes or events." },
  ...
  },
  {
    ...
    scenario: "A high-throughput cloud-native platform experiences spikes of billions of spans and metrics daily and requires low-latency telemetry processing and reliable backpressure management. The observability engineer needs to model an operation within a payment service that performs an external credit card authorization and records fraud check timestamps.",
    question: "Which OpenTelemetry component design or collector configuration handles this volume efficiently while protecting downstream storage backends?",
    options: [
      { id: 'A', text: "Create a Span from the Tracer, record start/end timestamps, add attributes (`payment.amount`), and record point-in-time Events." },
  ...
  },
  {
    ...
    scenario: "A platform security and compliance auditor requires cryptographic TLS authentication, PII data masking, and strict tenancy segregation across all telemetry pipelines. The observability engineer needs to model an operation within a payment service that performs an external credit card authorization and records fraud check timestamps.",
    question: "Which OpenTelemetry configuration or processor implementation satisfies these security and governance controls?",
    options: [
      { id: 'A', text: "Create a Span from the Tracer, record start/end timestamps, add attributes (`payment.amount`), and record point-in-time Events." },
      { id: 'B', text: "Write timestamps to a flat text file on disk." },
  ...
  },
  {
    ...
    scenario: "An engineering organization is migrating legacy monolithic instrumentation and vendor-locked agents to the vendor-agnostic OpenTelemetry ecosystem across polyglot microservices. The observability engineer needs to model an operation within a payment service that performs an external credit card authorization and records fraud check timestamps.",
    question: "Which pattern or OpenTelemetry feature enables the team to migrate telemetry collection with minimal service disruption?",
    options: [
      { id: 'A', text: "Create a Span from the Tracer, record start/end timestamps, add attributes (`payment.amount`), and record point-in-time Events." },
      { id: 'B', text: "Create a new Trace ID for every individual function call." },
  ...
  },
  {
    ...
    scenario: "A site reliability engineering team is optimizing observability infrastructure to eliminate collector bottlenecks, prevent memory starvation, and provide continuous health monitoring. The observability engineer needs to model an operation within a payment service that performs an external credit card authorization and records fraud check timestamps.",
    question: "Which deployment strategy or configuration guarantees resilient telemetry pipeline operation?",
    options: [
      { id: 'A', text: "Create a Span from the Tracer, record start/end timestamps, add attributes (`payment.amount`), and record point-in-time Events." },
      { id: 'B', text: "Create a new Trace ID for every individual function call." },
  ...
  },
  {
    ...
    scenario: "An enterprise observability architecture team is standardizing distributed telemetry collection, correlation, and sampling pipelines across multiple cloud environments. The observability engineer needs to choose the correct OpenTelemetry metric instruments to measure total HTTP requests, current active WebSocket connections, and request latencies.",
    question: "Which architectural approach or OpenTelemetry configuration satisfies these enterprise observability objectives?",
    options: [
  ...
  },
  {
    ...
    scenario: "A high-throughput cloud-native platform experiences spikes of billions of spans and metrics daily and requires low-latency telemetry processing and reliable backpressure management. The observability engineer needs to choose the correct OpenTelemetry metric instruments to measure total HTTP requests, current active WebSocket connections, and request latencies.",
    question: "Which OpenTelemetry component design or collector configuration handles this volume efficiently while protecting downstream storage backends?",
    options: [
  ...
  },
  {
    ...
    scenario: "A platform security and compliance auditor requires cryptographic TLS authentication, PII data masking, and strict tenancy segregation across all telemetry pipelines. The observability engineer needs to choose the correct OpenTelemetry metric instruments to measure total HTTP requests, current active WebSocket connections, and request latencies.",
    question: "Which OpenTelemetry configuration or processor implementation satisfies these security and governance controls?",
    options: [
      { id: 'A', text: "Use a `Counter` for total requests, an `UpDownCounter` or `Gauge` for active connections, and a `Histogram` for request durations." },
      { id: 'B', text: "Use a Counter for request latency." },
  ...
  },
  {
    ...
    scenario: "An engineering organization is migrating legacy monolithic instrumentation and vendor-locked agents to the vendor-agnostic OpenTelemetry ecosystem across polyglot microservices. The observability engineer needs to choose the correct OpenTelemetry metric instruments to measure total HTTP requests, current active WebSocket connections, and request latencies.",
    question: "Which pattern or OpenTelemetry feature enables the team to migrate telemetry collection with minimal service disruption?",
    options: [
      { id: 'A', text: "Use a Counter for request latency." },
      { id: 'B', text: "Measure all values using distributed traces instead of metric instruments." },
      { id: 'C', text: "Use an UpDownCounter for cumulative lifetime requests." },
      { id: 'D', text: "Use a `Counter` for total requests, an `UpDownCounter` or `Gauge` for active connections, and a `Histogram` for request durations." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Use a `Counter` for total requests, an `UpDownCounter` or `Gauge` for active connections, and a `Histogram` for request durations. OpenTelemetry provides synchronous and asynchronous metric instruments: `Counter` (monotonically increasing values like total requests), `UpDownCounter` (values that increase and decrease like queue size), `Gauge` (current non-additive values like temperature), and `Histogram` (statistical distribution like latency).",
  ...
  },
  {
    ...
    scenario: "A site reliability engineering team is optimizing observability infrastructure to eliminate collector bottlenecks, prevent memory starvation, and provide continuous health monitoring. The observability engineer needs to choose the correct OpenTelemetry metric instruments to measure total HTTP requests, current active WebSocket connections, and request latencies.",
    question: "Which deployment strategy or configuration guarantees resilient telemetry pipeline operation?",
    options: [
      { id: 'A', text: "Use a `Counter` for total requests, an `UpDownCounter` or `Gauge` for active connections, and a `Histogram` for request durations." },
      { id: 'B', text: "Use a Counter for request latency." },
  ...
  },
  {
    ...
    scenario: "An enterprise observability architecture team is standardizing distributed telemetry collection, correlation, and sampling pipelines across multiple cloud environments. The observability engineer needs to integrate existing application logging frameworks (Log4j, Zap, Serilog, Winston) into OpenTelemetry without rewriting all logging calls.",
    question: "Which architectural approach or OpenTelemetry configuration satisfies these enterprise observability objectives?",
    options: [
      { id: 'A', text: "Manually rewrite thousands of log statements across the entire application codebase." },
      { id: 'B', text: "Pipe stdout logs directly into an unencrypted public web server." },
      { id: 'C', text: "Disable application logging and rely solely on distributed traces." },
      { id: 'D', text: "Install the appropriate OpenTelemetry Log Appender/Bridge library that intercepts logs from existing frameworks and emits OTel log records." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    scenario: "A high-throughput cloud-native platform experiences spikes of billions of spans and metrics daily and requires low-latency telemetry processing and reliable backpressure management. The observability engineer needs to integrate existing application logging frameworks (Log4j, Zap, Serilog, Winston) into OpenTelemetry without rewriting all logging calls.",
    question: "Which OpenTelemetry component design or collector configuration handles this volume efficiently while protecting downstream storage backends?",
    options: [
  ...
  },
  {
    ...
    scenario: "A platform security and compliance auditor requires cryptographic TLS authentication, PII data masking, and strict tenancy segregation across all telemetry pipelines. The observability engineer needs to integrate existing application logging frameworks (Log4j, Zap, Serilog, Winston) into OpenTelemetry without rewriting all logging calls.",
    question: "Which OpenTelemetry configuration or processor implementation satisfies these security and governance controls?",
    options: [
      { id: 'A', text: "Install the appropriate OpenTelemetry Log Appender/Bridge library that intercepts logs from existing frameworks and emits OTel log records." },
      { id: 'B', text: "Pipe stdout logs directly into an unencrypted public web server." },
      { id: 'C', text: "Manually rewrite thousands of log statements across the entire application codebase." },
      { id: 'D', text: "Disable application logging and rely solely on distributed traces." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Install the appropriate OpenTelemetry Log Appender/Bridge library that intercepts logs from existing frameworks and emits OTel log records. OpenTelemetry does not aim to replace established logging libraries. Instead, it provides the Log Bridge API and SDK Log Appenders. Log appenders hook into existing frameworks (e.g., Logback, Winston), translating standard log events into OpenTelemetry log records enriched with active TraceID and SpanID.",
  ...
  },
  {
    ...
    scenario: "An engineering organization is migrating legacy monolithic instrumentation and vendor-locked agents to the vendor-agnostic OpenTelemetry ecosystem across polyglot microservices. The observability engineer needs to integrate existing application logging frameworks (Log4j, Zap, Serilog, Winston) into OpenTelemetry without rewriting all logging calls.",
    question: "Which pattern or OpenTelemetry feature enables the team to migrate telemetry collection with minimal service disruption?",
    options: [
  ...
  },
  {
    ...
    scenario: "A site reliability engineering team is optimizing observability infrastructure to eliminate collector bottlenecks, prevent memory starvation, and provide continuous health monitoring. The observability engineer needs to integrate existing application logging frameworks (Log4j, Zap, Serilog, Winston) into OpenTelemetry without rewriting all logging calls.",
    question: "Which deployment strategy or configuration guarantees resilient telemetry pipeline operation?",
    options: [
      { id: 'A', text: "Manually rewrite thousands of log statements across the entire application codebase." },
