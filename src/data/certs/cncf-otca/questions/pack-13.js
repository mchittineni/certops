export const CNCF_OTCA_QUESTIONS_13 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Resource metadata cannot be attached to OpenTelemetry signals." },
      { id: 'B', text: "Hardcode pod and instance metadata directly in application source code files." },
      { id: 'C', text: "Configure OpenTelemetry Resource Detectors (e.g., `k8s`, `container`, `aws`) in the SDK or Collector to attach standard resource attributes." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Resource metadata cannot be attached to OpenTelemetry signals." },
      { id: 'B', text: "Require developers to pass instance IDs manually in HTTP headers." },
      { id: 'C', text: "Hardcode pod and instance metadata directly in application source code files." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "OpenTracing and OpenCensus are actively developed competing standards with OpenTelemetry." },
  ...
  },
  {
    ...
    question: "Which OpenTelemetry configuration or processor implementation satisfies these security and governance controls?",
    options: [
      { id: 'A', text: "OpenTelemetry is a proprietary product owned by a single commercial cloud vendor." },
  ...
  },
  {
    ...
    question: "Which OpenTelemetry component design or collector configuration handles this volume efficiently while protecting downstream storage backends?",
    options: [
      { id: 'A', text: "Disable the batch processor and send every single span as an individual network packet immediately." },
      { id: 'B', text: "Buffer all spans in memory indefinitely without timeouts." },
      { id: 'C', text: "Add the `batch` processor to every pipeline, configuring `send_batch_size`, `timeout`, and `send_batch_max_size`." },
      { id: 'D', text: "Drop 90% of telemetry to reduce load." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Drop 90% of telemetry to reduce load." },
      { id: 'C', text: "Add the `batch` processor to every pipeline, configuring `send_batch_size`, `timeout`, and `send_batch_max_size`." },
