export const CNCF_OTCA_QUESTIONS_3 = [
  {
    id: "cncf-otca-51",
    difficulty: "easy",
    certId: "cncf-otca",
    ...
    title: "Recording span events, status codes, and contextual attributes: Operational Strategy (Part 51)",
    scenario: "A multinational fintech banking platform is evaluating OpenTelemetry Certified Associate practices specifically regarding Recording span events, status codes, and contextual attributes. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #51.",
  ...
  },
  {
    ...
    title: "OpenTelemetry Collector health checks and self-observability metrics: Operational Strategy (Part 52)",
    scenario: "A healthcare telemedicine network is evaluating OpenTelemetry Certified Associate practices specifically regarding OpenTelemetry Collector health checks and self-observability metrics. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #52.",
  ...
  },
  {
    ...
    title: "Pipeline routing using connector components and routing processors: Operational Strategy (Part 54)",
    scenario: "A global streaming entertainment platform is evaluating OpenTelemetry Certified Associate practices specifically regarding Pipeline routing using connector components and routing processors. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #54.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Instrumentation and Signals",
    title: "Metric instruments Counter, UpDownCounter, Histogram, and Gauge: Operational Strategy (Part 55)",
    scenario: "An algorithmic trading exchange is evaluating OpenTelemetry Certified Associate practices specifically regarding Metric instruments Counter, UpDownCounter, Histogram, and Gauge. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #55.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operationalizing and Exporters",
    title: "Troubleshooting pipeline errors using the debug and file exporters: Operational Strategy (Part 56)",
    scenario: "A logistics and supply chain optimization service is evaluating OpenTelemetry Certified Associate practices specifically regarding Troubleshooting pipeline errors using the debug and file exporters. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #56.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OpenTelemetry Overview and Architecture",
    title: "Semantic Conventions for HTTP, database, and RPC operations: Operational Strategy (Part 57)",
    scenario: "An IoT industrial telematics infrastructure is evaluating OpenTelemetry Certified Associate practices specifically regarding Semantic Conventions for HTTP, database, and RPC operations. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #57.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "OpenTelemetry Collector and Pipelines",
    title: "Configuring OTLP receiver over gRPC port 4317 and HTTP port 4318: Operational Strategy (Part 58)",
    scenario: "A multi-tenant enterprise SaaS provider is evaluating OpenTelemetry Certified Associate practices specifically regarding Configuring OTLP receiver over gRPC port 4317 and HTTP port 4318. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #58.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Instrumentation and Signals",
    title: "Context propagation across asynchronous boundaries using Baggage: Operational Strategy (Part 59)",
    scenario: "A public sector aerospace engineering department is evaluating OpenTelemetry Certified Associate practices specifically regarding Context propagation across asynchronous boundaries using Baggage. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #59.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operationalizing and Exporters",
    title: "Tuning collector memory buffers, queue sizes, and worker pool scaling: Operational Strategy (Part 60)",
    scenario: "An automotive connected-vehicle fleet manager is evaluating OpenTelemetry Certified Associate practices specifically regarding Tuning collector memory buffers, queue sizes, and worker pool scaling. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #60.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "OpenTelemetry Collector and Pipelines",
    title: "OpenTelemetry Collector architecture receivers, processors, exporters: Operational Strategy (Part 62)",
    scenario: "A pharmaceutical clinical trial data service is evaluating OpenTelemetry Certified Associate practices specifically regarding OpenTelemetry Collector architecture receivers, processors, exporters. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #62.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operationalizing and Exporters",
    title: "Exporting telemetry to Prometheus, Jaeger, Zipkin, and cloud backends: Operational Strategy (Part 64)",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OpenTelemetry Overview and Architecture",
    title: "OpenTelemetry API vs OpenTelemetry SDK responsibilities: Operational Strategy (Part 65)",
    scenario: "A ride-sharing dispatch system is evaluating OpenTelemetry Certified Associate practices specifically regarding OpenTelemetry API vs OpenTelemetry SDK responsibilities. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #65.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "OpenTelemetry Collector and Pipelines",
    title: "Configuring batch processor and memory_limiter processor: Operational Strategy (Part 66)",
    scenario: "An insurance claims processing engine is evaluating OpenTelemetry Certified Associate practices specifically regarding Configuring batch processor and memory_limiter processor. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #66.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Instrumentation and Signals",
    title: "Manual tracing with Tracer, Span, SpanKind, and SpanStatus: Operational Strategy (Part 67)",
    scenario: "A commercial airline reservation service is evaluating OpenTelemetry Certified Associate practices specifically regarding Manual tracing with Tracer, Span, SpanKind, and SpanStatus. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #67.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operationalizing and Exporters",
    title: "Sampling strategies head-based probabilistic vs tail-based collector sampling: Operational Strategy (Part 68)",
    scenario: "A cybersecurity threat intelligence agency is evaluating OpenTelemetry Certified Associate practices specifically regarding Sampling strategies head-based probabilistic vs tail-based collector sampling. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #68.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OpenTelemetry Overview and Architecture",
    title: "OpenTelemetry signals traces, metrics, logs, and baggage: Operational Strategy (Part 69)",
    scenario: "A real estate property management portal is evaluating OpenTelemetry Certified Associate practices specifically regarding OpenTelemetry signals traces, metrics, logs, and baggage. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #69.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "OpenTelemetry Collector and Pipelines",
    title: "Collector deployment patterns agent daemonset vs gateway deployment: Operational Strategy (Part 70)",
    scenario: "An autonomous robotics manufacturing facility is evaluating OpenTelemetry Certified Associate practices specifically regarding Collector deployment patterns agent daemonset vs gateway deployment. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #70.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Instrumentation and Signals",
    title: "Recording span events, status codes, and contextual attributes: Operational Strategy (Part 71)",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Operationalizing and Exporters",
    title: "OpenTelemetry Collector health checks and self-observability metrics: Operational Strategy (Part 72)",
    scenario: "A global hotel hospitality reservation platform is evaluating OpenTelemetry Certified Associate practices specifically regarding OpenTelemetry Collector health checks and self-observability metrics. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #72.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria? (Focus: OpenTelemetry Collector health checks and self-observability metrics in Operationalizing and Exporters)",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "OpenTelemetry Overview and Architecture",
    title: "W3C Trace Context specification traceparent and tracestate headers: Operational Strategy (Part 73)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "OpenTelemetry Collector and Pipelines",
    title: "Pipeline routing using connector components and routing processors: Operational Strategy (Part 74)",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Instrumentation and Signals",
    title: "Metric instruments Counter, UpDownCounter, Histogram, and Gauge: Operational Strategy (Part 75)",
    scenario: "A cloud-native telecommunications provider is evaluating OpenTelemetry Certified Associate practices specifically regarding Metric instruments Counter, UpDownCounter, Histogram, and Gauge. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #75.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability? (Focus: Metric instruments Counter, UpDownCounter, Histogram, and Gauge in Instrumentation and Signals)",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
...
export default CNCF_OTCA_QUESTIONS_3;
