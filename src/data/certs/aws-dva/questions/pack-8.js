export const AWS_DVA_QUESTIONS_8 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In the Globals: Function: section of the template" },
      { id: 'B', text: "In the Parameters section" },
      { id: 'C', text: "In the Mappings section" },
      { id: 'D', text: "In an external JSON file in S3" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Set the Role property to an inline policy granting s3:* on all buckets" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The Conditions section with !If" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Stack B reads the VPC ID from an SSM Parameter Store parameter" },
      { id: 'B', text: "Stack B queries Stack A using the DescribeStacks CLI inside user data" },
      { id: 'C', text: "Stack A saves the VPC ID in an unencrypted S3 file" },
      { id: 'D', text: "Stack A exports the value; Stack B uses !ImportValue" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "CloudFormation Nested Stacks" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "DeletionPolicy: Snapshot" },
      { id: 'C', text: "UpdateReplacePolicy: Delete" },
      { id: 'D', text: "DependsOn: ProtectedTable" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Procfile" },
      { id: 'B', text: "appspec.yml" },
      { id: 'C', text: "Dockerfile" },
      { id: 'D', text: "buildspec.yml" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "AWS App Runner alone" },
      { id: 'D', text: "On-Demand EC2 instances" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "random" },
      { id: 'C', text: "distinctInstance" },
      { id: 'D', text: "binpack (memory)" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "distinctInstance" },
      { id: 'B', text: "memberOf (attribute:ecs.instance-type == t3.large)" },
      { id: 'C', text: "binpack" },
      { id: 'D', text: "spread" }
    ],
    correctAnswers: ['A'],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A container healthCheck command" },
      { id: 'B', text: "Increase the container memory limit" },
      { id: 'C', text: "Enable CloudWatch Logs metric filters" },
      { id: 'D', text: "Attach an Elastic IP to the container" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Scan on Push (scanOnPush: true)" },
      { id: 'B', text: "Lifecycle Policy" },
      { id: 'C', text: "KMS Encryption at rest" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "ECR Lifecycle Policies" },
      { id: 'B', text: "ECR Scan on Push" },
      { id: 'C', text: "Amazon S3 Lifecycle Rules" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CodeCommit Repository Triggers alone" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CloudWatch Dashboard URL" },
      { id: 'B', text: "CodeBuild Build Badges" },
      { id: 'C', text: "CodeDeploy Status Reports" },
