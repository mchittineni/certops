export const AWS_DVA_QUESTIONS_19 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Output structured JSON logs to standard output adhering to the CloudWatch Embedded Metric Format (EMF) specification." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run a CloudWatch Logs Insights query using `fields`, `filter @message like /500/`, `stats count(*) by clientIp`, and `sort`." },
