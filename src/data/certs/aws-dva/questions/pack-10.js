export const AWS_DVA_QUESTIONS_10 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "CloudWatch High-Resolution Alarms" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable Enhanced Monitoring in the EC2 Console" },
      { id: 'B', text: "Memory metrics are unavailable on AWS" },
      { id: 'C', text: "Reboot instances into Nitro Hypervisor mode" },
      { id: 'D', text: "Install the unified CloudWatch agent" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "DynamoDB DAX" },
      { id: 'B', text: "Redis Cluster Mode Enabled" },
      { id: 'C', text: "Memcached Single Node" },
      { id: 'D', text: "Redis Cluster Mode Disabled" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The IAM role has expired" },
      { id: 'B', text: "The table partition key is too long" },
      { id: 'C', text: "A GSI has insufficient write capacity" },
      { id: 'D', text: "Point-in-time recovery is taking a backup" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Delete and recreate the DynamoDB table" },
      { id: 'B', text: "Retry only the unprocessed items using exponential backoff and jitter" },
      { id: 'C', text: "Retry all 25 items immediately in a tight loop" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Fixed 5 RCU / 5 WCU" },
      { id: 'B', text: "Provisioned Capacity Mode with manual scaling" },
      { id: 'C', text: "On-Demand Capacity Mode" },
      { id: 'D', text: "Reserved Capacity Mode" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Versioned filenames update instantly at no cost" },
      { id: 'B', text: "Invalidations take 24 hours to propagate across edge locations" },
      { id: 'C', text: "CloudFront cannot invalidate CSS files" },
      { id: 'D', text: "Invalidations delete the files from the origin S3 bucket" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "CloudWatch Metrics Math" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The integration missed the 29-second timeout" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The Execution Event History tab" },
      { id: 'B', text: "CloudWatch Synthetics console" },
      { id: 'C', text: "AWS CloudTrail Event History alone" },
      { id: 'D', text: "Amazon EventBridge rules" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "ApproximateAgeOfOldestMessage" },
      { id: 'C', text: "NumberOfMessagesSent" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Retry with backoff and jitter, then add shards" },
      { id: 'B', text: "Immediately drop all throttled records without retrying" },
      { id: 'C', text: "Switch the stream to FIFO mode" },
      { id: 'D', text: "Delete the stream and recreate it with standard settings" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS Health Dashboard (AWS Health API)" },
      { id: 'B', text: "AWS Status Page (status.aws.amazon.com) alone" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "8 RCUs for both modes" },
      { id: 'C', text: "2 RCUs for Eventually Consistent read, 4 RCUs for Strongly Consistent read" },
      { id: 'D', text: "0.5 RCU for Eventually Consistent read, 1 RCU for Strongly Consistent read" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Visibility timeout must be six times the function timeout" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Forward the X-Amzn-Trace-Id header downstream" },
      { id: 'B', text: "Add the user session token to the request payload" },
      { id: 'C', text: "Enable CloudWatch Logs metric filters on both services" },
      { id: 'D', text: "Use the same IAM execution role on Lambda and ECS" }
    ],
    correctAnswers: ['A'],
    type: "single",
