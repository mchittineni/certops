export const AWS_DVA_QUESTIONS_10 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Install the unified CloudWatch agent" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A GSI has insufficient write capacity" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Versioned filenames update instantly at no cost" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Retry with backoff and jitter, then add shards" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Visibility timeout must be six times the function timeout" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Forward the X-Amzn-Trace-Id header downstream" },
