export const AWS_DVA_QUESTIONS_17 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Execute tests inside an AWS Lambda function handler with a 3-second timeout." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Define a `buildspec.yml` file in the source repository containing `install`, `pre_build`, `build`, and `post_build` phases with an `artifacts` block. AWS CodeBuild relies on a `buildspec.yml` file located in the root of the source directory. It defines structured execution phases: `install` (runtime setup), `pre_build` (linting/dependency verification), `build` (compilation/testing), and `post_build` (packaging/tagging), followed by artifact declarations.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Store build commands in an S3 bucket policy." },
      { id: 'C', text: "A `buildspec.yml` with the build phases and an `artifacts` block." },
      { id: 'D', text: "Write a custom Windows batch script and run it on an EC2 instance manually." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which implementation or architectural approach satisfies these resilience criteria?",
    options: [
      { id: 'A', text: "Configure an Application Load Balancer target group health check on port 8080." },
      { id: 'B', text: "An `appspec.yaml` with traffic lifecycle hooks calling validation functions." },
      { id: 'C', text: "Deploy the function using the AWS Management Console with an overwrite flag." },
      { id: 'D', text: "Write a bash script that sleeps for 5 minutes during the build pipeline." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy an EC2 instance with a custom NGINX proxy shifting traffic." },
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Manually update the Route 53 DNS record weight by 10% every 10 minutes." },
  ...
  },
  {
    ...
    question: "Which implementation or architectural approach satisfies these resilience criteria?",
    options: [
      { id: 'A', text: "Create IAM user access keys in the production account and embed them in the pipeline build script." },
      { id: 'B', text: "Cross-account roles with a CMK-encrypted artifact bucket and key delegation." },
      { id: 'C', text: "Use the default pipeline artifact bucket with its AWS-managed key." },
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Cross-account roles with a CMK-encrypted artifact bucket and key delegation." },
