export const AWS_DVA_QUESTIONS_15 = [
  {
    ...
    options: [
      { id: 'A', text: "Configure an IAM role trust policy that allows the third-party account to call `sts:AssumeRole` with a mandatory `sts:ExternalId` condition." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Deploy an AWS Lambda function that issues hardcoded IAM user credentials to authenticated clients." }
    ],
    correctAnswers: ['A'],
    type: "single",
