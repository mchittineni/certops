export const AWS_DVA_QUESTIONS_15 = [
  {
    ...
    options: [
      { id: 'A', text: "A trust policy allowing `sts:AssumeRole` with an `sts:ExternalId` condition." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Attach an AdministratorAccess managed policy to the third-party role without conditions." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Exchange the user pool token for credentials in a Lambda that calls AssumeRole." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A user pool for sign-in, federated into an identity pool for IAM credentials." },
      { id: 'C', text: "Use an Amazon Cognito Identity Pool alone to manage user passwords and email verification." },
  ...
  },
  {
    ...
    question: "Which solution provides a robust implementation while minimizing ongoing operational maintenance?",
    options: [
      { id: 'A', text: "Use an Amazon Cognito Identity Pool alone to manage user passwords and email verification." },
      { id: 'B', text: "Use an Amazon Cognito User Pool alone and embed an IAM access key in the user profile." },
      { id: 'C', text: "Exchange the user pool token for credentials in a Lambda that calls AssumeRole." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A Lambda request authorizer with identity sources and policy caching." },
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Attach an IAM permission boundary to all users invoking the API." },
      { id: 'B', text: "Deploy an AWS Network Firewall cluster in front of the API Gateway public endpoint." },
      { id: 'C', text: "Configure a Security Group on the API Gateway endpoint allowing port 443." },
      { id: 'D', text: "A resource policy denying any request whose `aws:sourceVpc` does not match." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Attach an API Gateway Resource Policy with an explicit Deny action for all requests where the `aws:sourceVpc` condition does not match the allowed VPC ID. API Gateway Resource Policies are JSON policy documents attached directly to a REST API to control whether a specified principal can invoke the API. Using condition keys like `aws:sourceVpc` or `aws:SourceIp`, architects can restrict access exclusively to specific private VPCs or corporate IP ranges.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "A bucket policy denying `s3:*` when `aws:SecureTransport` is false." },
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Enable default Amazon S3 server-side encryption (SSE-S3) on the bucket." },
