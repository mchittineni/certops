export const AWS_DVA_QUESTIONS_20 = [
  {
    ...
    options: [
      { id: 'A', text: "Write a custom Python script that polls the log group every second using `GetLogEvents`." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Write a custom Python script that polls the log group every second using `GetLogEvents`." },
      { id: 'B', text: "Deploy an AWS WAF Web ACL to scan log files in CloudWatch." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy an AWS WAF Web ACL to scan log files in CloudWatch." },
      { id: 'C', text: "A metric filter on `NullPointerException` feeding a custom metric alarm." },
      { id: 'D', text: "Write a custom Python script that polls the log group every second using `GetLogEvents`." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Monitor EC2 CPU utilization metrics in CloudWatch." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Assign the minimum 128 MB memory to all Lambda functions to save money." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Assign the maximum 10,240 MB memory to all Lambda functions unconditionally." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Deploy the open-source AWS Lambda Power Tuning state machine to benchmark the function across different memory configurations (128 MB to 10,240 MB). AWS Lambda allocates proportional CPU power, network bandwidth, and memory as memory configuration increases. The open-source AWS Lambda Power Tuning state machine runs multiple concurrent test invocations across memory sizes to generate a visual Pareto chart identifying the sweet spot between cost and execution speed.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Enable S3 Transfer Acceleration and use the `s3-accelerate` domain." },
      { id: 'C', text: "Deploy an Amazon CloudFront distribution with caching enabled for POST requests." },
      { id: 'D', text: "Enable S3 Versioning on the bucket." }
    ],
    correctAnswers: ['B'],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Store logs in Amazon S3 and download them to local workstations for grep analysis." },
