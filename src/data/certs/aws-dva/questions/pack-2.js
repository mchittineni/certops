export const AWS_DVA_QUESTIONS_2 = [
  {
    ...
    options: [
      { id: 'A', text: "Lambda retries continuously for 14 days every 5 seconds" },
      { id: 'B', text: "Lambda immediately drops the event without any retries" },
      { id: 'C', text: "Lambda converts the invocation to a synchronous HTTP request" },
      { id: 'D', text: "Lambda retries twice more with exponential backoff" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Ephemeral storage cannot be encrypted under any circumstances" },
      { id: 'C', text: "Developers must format /tmp with an ext4 encrypted filesystem manually" },
      { id: 'D', text: "Developers must write a custom encryption filter using GPG in Python before saving to /tmp" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy an Application Load Balancer in front of the Function URL" },
      { id: 'B', text: "Embed CORS headers in an S3 bucket policy" },
      { id: 'C', text: "Configure the CORS settings directly in the Lambda Function URL configuration" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An OAuth 2.0 bearer token issued by Google Accounts" },
      { id: 'B', text: "A basic authentication header with an IAM user password" },
      { id: 'C', text: "A client SSL certificate installed in the browser" },
      { id: 'D', text: "A SigV4 authorization header signed with AWS credentials" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Private REST APIs via VPC endpoints" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Point each stage at the $LATEST alias and deploy per environment" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable API Gateway caching on the stage and configure a TTL of 1800 seconds" },
      { id: 'B', text: "Add an SQS queue between API Gateway and the Lambda function" },
      { id: 'C', text: "Increase Lambda concurrency to 10,000" },
      { id: 'D', text: "Deploy an Amazon CloudWatch Synthetics canary to warm the cache" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The $connect route and $context.connectionId" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "API Gateway Request Validators using JSON Schema models" },
      { id: 'B', text: "AWS WAF regex match statements" },
      { id: 'C', text: "Lambda input validation checks inside the handler code" },
      { id: 'D', text: "Amazon CloudWatch Metric Alarms" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In the API Gateway custom domain settings" },
      { id: 'B', text: "In the Lambda function deployment package zip file" },
      { id: 'C', text: "In AWS Secrets Manager as a binary secret" },
      { id: 'D', text: "In an Amazon DynamoDB table mapped via VTL template" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An AWS service integration to DynamoDB with a VTL template" },
      { id: 'B', text: "Use Lambda synchronous invocations with maximum memory" },
      { id: 'C', text: "Configure an SQS queue to poll API Gateway every 5 seconds" },
      { id: 'D', text: "Attach an Amazon EC2 instance running Nginx reverse proxy" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Public WebSocket API endpoints with IAM authentication" },
      { id: 'B', text: "Private API endpoints accessed via an interface VPC endpoint (AWS PrivateLink)" },
      { id: 'C', text: "Regional API endpoints with public IP addresses" },
      { id: 'D', text: "Edge-optimized API endpoints with CloudFront distribution endpoints" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "LAMBDA integration" },
      { id: 'C', text: "HTTP integration" },
      { id: 'D', text: "AWS_PROXY integration" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "HTTP Integration" },
      { id: 'B', text: "Lambda Proxy Integration (AWS_PROXY)" },
      { id: 'C', text: "Lambda Custom Integration" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Custom domain base path mappings" },
      { id: 'B', text: "Route 53 latency routing policies" },
      { id: 'C', text: "AWS WAF header rewriting rules" },
      { id: 'D', text: "CloudFront signed URLs" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In the stage access logging settings" },
