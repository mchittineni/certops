export const AWS_DVA_QUESTIONS_16 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Request an ACM public certificate and validate by DNS with Route 53 CNAMEs." },
      { id: 'B', text: "Generate a self-signed OpenSSL certificate on an EC2 instance and upload it to IAM." },
      { id: 'C', text: "Purchase an SSL certificate from an external registrar and email the private key to AWS Support." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Request an ACM public certificate and validate by DNS with Route 53 CNAMEs." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Request a public certificate in AWS Certificate Manager (ACM) and use DNS validation by creating CNAME records in Amazon Route 53. AWS Certificate Manager (ACM) provisions, manages, and automatically renews public SSL/TLS certificates for AWS services. Choosing DNS validation allows ACM to renew certificates automatically and indefinitely as long as the DNS CNAME record remains in Route 53, eliminating manual renewal friction.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Query the Secrets Manager `GetSecretValue` API on every single incoming HTTP request." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Store the database secret in a public Amazon S3 bucket." },
      { id: 'B', text: "Read the secret once at container start and hold it for the process lifetime." },
      { id: 'C', text: "Use the Secrets Manager client-side caching library with a TTL." },
      { id: 'D', text: "Query the Secrets Manager `GetSecretValue` API on every single incoming HTTP request." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Store the database secret in a public Amazon S3 bucket." },
      { id: 'D', text: "Read the secret once at container start and hold it for the process lifetime." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Integrate the AWS Secrets Manager Client-side Caching library in the application code to cache secrets in memory with a configurable TTL. The AWS Secrets Manager Client-side Caching library enables in-memory caching of secrets for Java, Python, .NET, and Go applications. It handles secret retrieval and TTL expiration locally in memory, drastically reducing `GetSecretValue` API call volume, avoiding throttling limits, and reducing billing costs.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "An explicit Deny in any applicable policy overrides every Allow." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure an S3 ACL that grants public read access." },
      { id: 'C', text: "An explicit Deny in any applicable policy overrides every Allow." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Enable Inspector enhanced scanning on ECR for continuous assessment." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Configure Amazon GuardDuty to inspect application logs for vulnerability mentions." },
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Write a custom bash script that invokes the AWS CLI `aws lambda create-function` command sequentially." },
      { id: 'B', text: "Deploy resources manually using the AWS Management Console." },
      { id: 'C', text: "Use an AWS SAM template with `Transform: AWS::Serverless-2016-10-31` and declare `AWS::Serverless::Function` resources." },
      { id: 'D', text: "Write a 1,000-line standard CloudFormation template declaring raw `AWS::Lambda::Function` and `AWS::IAM::Role` resources." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Use an AWS SAM template with `Transform: AWS::Serverless-2016-10-31` and declare `AWS::Serverless::Function` resources. AWS SAM is an extension of AWS CloudFormation specifically optimized for serverless applications. Using `Transform: AWS::Serverless-2016-10-31`, developers write concise shorthand resource definitions (like `AWS::Serverless::Function`) that SAM expands into full CloudFormation syntax during deployment.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Use an AWS SAM template with `Transform: AWS::Serverless-2016-10-31` and declare `AWS::Serverless::Function` resources." },
      { id: 'B', text: "Deploy resources manually using the AWS Management Console." },
      { id: 'C', text: "Write a 1,000-line standard CloudFormation template declaring raw `AWS::Lambda::Function` and `AWS::IAM::Role` resources." },
      { id: 'D', text: "Write a custom bash script that invokes the AWS CLI `aws lambda create-function` command sequentially." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Use an AWS SAM template with `Transform: AWS::Serverless-2016-10-31` and declare `AWS::Serverless::Function` resources. AWS SAM is an extension of AWS CloudFormation specifically optimized for serverless applications. Using `Transform: AWS::Serverless-2016-10-31`, developers write concise shorthand resource definitions (like `AWS::Serverless::Function`) that SAM expands into full CloudFormation syntax during deployment.",
