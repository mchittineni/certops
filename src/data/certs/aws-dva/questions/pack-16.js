export const AWS_DVA_QUESTIONS_16 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy resources manually using the AWS Management Console." },
      { id: 'B', text: "Write a custom bash script that invokes the AWS CLI `aws lambda create-function` command sequentially." },
      ...
      { id: 'D', text: "Use an AWS SAM template with `Transform: AWS::Serverless-2016-10-31` and declare `AWS::Serverless::Function` resources." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Write a 1,000-line standard CloudFormation template declaring raw `AWS::Lambda::Function` and `AWS::IAM::Role` resources." },
      { id: 'B', text: "Use an AWS SAM template with `Transform: AWS::Serverless-2016-10-31` and declare `AWS::Serverless::Function` resources." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Write a 1,000-line standard CloudFormation template declaring raw `AWS::Lambda::Function` and `AWS::IAM::Role` resources." },
      { id: 'B', text: "Write a custom bash script that invokes the AWS CLI `aws lambda create-function` command sequentially." },
      { id: 'C', text: "Deploy resources manually using the AWS Management Console." },
      { id: 'D', text: "Use an AWS SAM template with `Transform: AWS::Serverless-2016-10-31` and declare `AWS::Serverless::Function` resources." }
    ],
    correctAnswers: ['D'],
    type: "single",
