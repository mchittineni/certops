export const AWS_DVA_QUESTIONS_4 = [
  {
    ...
    options: [
      { id: 'A', text: "Express Workflows" },
      { id: 'B', text: "Standard Workflows" },
      { id: 'C', text: "Dynamic Workflows" },
      { id: 'D', text: "Batch Workflows" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Configure an SQS queue between every Step Functions state" },
      { id: 'C', text: "Increase the state machine timeout to 1 year" },
      { id: 'D', text: "Wrap the Lambda function in an infinite while loop" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AWS CloudFormation Change Sets" },
      { id: 'B', text: "Amazon Simple Email Service (SES)" },
      { id: 'C', text: "Amazon S3 Static Hosting" },
      { id: 'D', text: "AWS AppSync GraphQL Subscriptions" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Perform Shard Splitting or increase provisioned shard count to 4 shards" },
      { id: 'B', text: "Increase the Lambda function execution timeout to 15 minutes" },
      { id: 'C', text: "Convert the Kinesis stream to an SQS FIFO queue" },
      { id: 'D', text: "Decrease the data retention period from 7 days to 24 hours" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CloudWatch Logs Insights export" },
      { id: 'B', text: "Kinesis Data Firehose buffer interval tuning" },
      { id: 'C', text: "Enhanced Fan-Out with HTTP/2 SubscribeToShard API" },
      { id: 'D', text: "Standard SQS polling with maximum batch size" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hardcode temporary access keys in the Lambda function environment variables" },
      { id: 'B', text: "Enable DynamoDB Streams without IAM policies" },
      { id: 'C', text: "Create a dedicated IAM execution role granting dynamodb:GetItem and dynamodb:Query restricted to the Customers table ARN" },
      { id: 'D', text: "Attach the AmazonDynamoDBFullAccess policy to the default account root user" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "iam:CreateAccessKey" },
      { id: 'C', text: "sts:GetFederationToken" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable encryption at rest to avoid KMS API limits" },
      { id: 'B', text: "Store the plaintext encryption key in the S3 object metadata headers" },
      { id: 'C', text: "Transmit the 50 GB payload directly to the kms:Encrypt API endpoint" },
      { id: 'D', text: "Call kms:GenerateDataKey to obtain a plaintext data key and an encrypted data key, encrypt data locally with the plaintext key, then securely erase the plaintext key and store the encrypted key with the ciphertext" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "KMS keys do not support IAM policies under any circumstances" },
      { id: 'B', text: "The KMS Key Policy does not explicitly grant permissions or delegate authorization to the AWS account root principal" },
      { id: 'C', text: "KMS keys take 7 days to become active after creation" },
      { id: 'D', text: "The developer must be logged in as the AWS root account user" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Rotate the IAM access keys of the developer every 90 days" },
      { id: 'B', text: "Manually create a new CMK each year, re-encrypt all existing database records, and delete the old key" },
      { id: 'C', text: "Enable Automatic Key Rotation on the Customer Managed Key (CMK) in KMS" },
      { id: 'D', text: "Write a cron job that calls kms:UpdateKeyDescription annually" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure automatic rotation in Secrets Manager using a managed rotation Lambda function template" },
      ...
      { id: 'D', text: "Disable authentication on the Aurora cluster" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Store the password in an unencrypted S3 bucket" },
      { id: 'B', text: "Disable SSL/TLS encryption between Lambda and the database" },
      { id: 'C', text: "Use the AWS Secrets Manager client-side caching library to cache credentials in memory across invocations" },
      { id: 'D', text: "Hardcode the database password in the Lambda handler code" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Standard Parameter tier with type String in plain text" },
      { id: 'C', text: "Advanced Parameter tier with type Boolean" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cognito User Pool alone for both authentication and STS credential generation" },
      { id: 'B', text: "Cognito User Pool for authentication and user management, paired with Cognito Identity Pool for temporary AWS credentials" },
      { id: 'C', text: "IAM users created programmatically for every mobile user" },
      { id: 'D', text: "Cognito Identity Pool alone without a user directory" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "ID Token" },
      { id: 'B', text: "Access Token" },
      { id: 'C', text: "Refresh Token" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable all authentication on the backend DynamoDB table" },
      { id: 'B', text: "Create a dummy user in Cognito User Pools with password 'guest'" },
      { id: 'C', text: "Enable Unauthenticated Identities in the Identity Pool and assign a guest IAM role with read-only permissions" },
      { id: 'D', text: "Create an IAM root user access key and embed it in the mobile app binary" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Require users to install the AWS CLI and configure local profiles" },
      { id: 'B', text: "Make the S3 bucket completely public with anonymous write access" },
      { id: 'C', text: "Generate an Amazon S3 presigned URL with an expiration time in the backend and return it to the browser for direct HTTP PUT upload" },
      { id: 'D', text: "Embed company AWS IAM access keys in the client-side JavaScript bundle" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Condition: { Null: { aws:PrincipalArn: true } }" },
      { id: 'B', text: "Condition: { StringEquals: { s3:x-amz-server-side-encryption: AES256 } }" },
      { id: 'C', text: "Condition: { Bool: { aws:SecureTransport: false } }" },
      { id: 'D', text: "Condition: { IpAddress: { aws:SourceIp: 10.0.0.0/8 } }" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Server-Side Encryption with AWS KMS (SSE-KMS)" },
      ...
      { id: 'D', text: "Client-Side Symmetric Master Key encryption without AWS services" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Pass the user password in an HTTP Basic Authorization header" },
      { id: 'C', text: "Embed an IAM secret key in every client browser request" },
      { id: 'D', text: "Deploy a custom Lambda authorizer that manually verifies the JWT signature" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Access is permitted if the request uses multi-factor authentication" },
      { id: 'B', text: "Access is granted on weekdays but denied on weekends" },
      { id: 'C', text: "Access is allowed because the user-level policy takes precedence over the group policy" },
      { id: 'D', text: "Access is denied because an explicit Deny statement in any policy always overrides all Allow statements" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "S3 Glacier Vault Lock alone without retention" }
    ],
    correctAnswers: ['A'],
    type: "single",
