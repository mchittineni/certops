export const AWS_DVA_QUESTIONS_5 = [
  {
    ...
    options: [
      { id: 'A', text: "aws:SourceIp" },
      { id: 'B', text: "aws:VpcSourceIp" },
      { id: 'C', text: "aws:PrincipalArn" },
      { id: 'D', text: "aws:RequestedRegion" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An asymmetric KMS key pair" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "S3 Bucket ACLs" },
      { id: 'B', text: "KMS Grants (CreateGrant)" },
      { id: 'C', text: "IAM Instance Profiles alone" },
      { id: 'D', text: "KMS Key Aliases" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A resource policy on the secret plus kms:Decrypt on the key" },
      { id: 'B', text: "Replicate the secret into the Production Account on a schedule" },
      { id: 'C', text: "Create a VPC Peering connection and disable all IAM policies" },
      { id: 'D', text: "Send the secret value in an SQS message across accounts" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "BatchGetParameterByPrefix" },
      { id: 'C', text: "GetParameter with a wildcard asterisk" },
      { id: 'D', text: "DescribeParameters with a regex filter" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Define Auth Challenge Lambda Trigger" },
      { id: 'B', text: "Pre Token Generation Lambda Trigger" },
      { id: 'C', text: "Post Authentication Lambda Trigger" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "BlockPublicAcls" },
      { id: 'B', text: "IgnorePublicAcls" },
      { id: 'C', text: "BlockPublicPolicy" },
      { id: 'D', text: "RestrictPublicBuckets" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Amazon S3 Static Website Hosting" },
      { id: 'B', text: "AWS Storage Gateway" },
      { id: 'C', text: "Amazon S3 Object Lockers" },
      { id: 'D', text: "Amazon S3 Access Points" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The IAM Group membership" },
      { id: 'B', text: "The Permissions Policy attached to the role" },
      { id: 'C', text: "The AWS KMS key policy" },
      { id: 'D', text: "The trust policy on the role" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "To stop developers passing high-privilege roles to compute" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "AWS CloudTrail Event Keys" },
      { id: 'C', text: "KMS Asymmetric Key Pairs" },
      { id: 'D', text: "CloudHSM Classic clusters" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "GenerateSecretString" },
      { id: 'B', text: "CreatePasswordHash" },
      { id: 'C', text: "GetRandomPassword" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Advanced Parameter tier" },
      { id: 'B', text: "Standard Parameter tier" },
      { id: 'C', text: "Enterprise Parameter tier" },
      { id: 'D', text: "Encrypted Parameter tier" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Authorization code grant with PKCE" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Create two identity pools and pick one in the client by group" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A Geo-Match Rule" },
      { id: 'C', text: "An SQL Injection Rule" },
      { id: 'D', text: "A Size Constraint Rule" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An S3 CORS rule allowing that origin for GET" },
      { id: 'B', text: "A bucket policy allowing s3:GetObject from the app referer header" },
      { id: 'C', text: "An IAM policy granting s3:GetObject to anonymous users" },
      { id: 'D', text: "An S3 lifecycle rule to purge old versions" }
    ],
    correctAnswers: ['A'],
    type: "single",
