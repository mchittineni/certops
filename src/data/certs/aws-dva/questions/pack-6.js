export const AWS_DVA_QUESTIONS_6 = [
  {
    ...
    options: [
      { id: 'A', text: "S3 Glacier Vault Lock" },
      { id: 'B', text: "S3 Glacier Vault Notifications" },
      { id: 'C', text: "S3 Bucket Versioning" },
      { id: 'D', text: "KMS Key Policy" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "AWS Config Snapshot" },
      { id: 'C', text: "AWS Trusted Advisor Check" },
      { id: 'D', text: "The IAM credential report" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure Multi-Region Secret Replication on the secret in Secrets Manager" },
      { id: 'B', text: "Deploy an SQS queue to pass passwords across regions" },
      { id: 'C', text: "Write a cron job that calls PutSecretValue in both regions" },
      { id: 'D', text: "Create a separate secret in each region and keep them in step by hand" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Post Authentication Trigger" },
      { id: 'B', text: "User Migration Lambda Trigger" },
      { id: 'C', text: "Pre Sign-up Trigger" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "API Gateway Client Certificate" },
      { id: 'B', text: "API Gateway Usage Plans" },
      { id: 'C', text: "Amazon Route 53 DNSSEC" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "AbortIncompleteMultipartUpload" },
      { id: 'B', text: "Transition to S3 Glacier" },
      { id: 'C', text: "Expire Current Versions" },
      { id: 'D', text: "NoncurrentVersionExpiration" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "KMS Key Tag" },
      { id: 'C', text: "KMS Key ARN" },
      { id: 'D', text: "KMS Grant Token" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Generate a new access key with no expiration date" },
      { id: 'C', text: "Switch to an IAM user instead of a role" },
      { id: 'D', text: "Request an IAM root user password reset" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "ABAC on aws:ResourceTag and aws:PrincipalTag" },
      { id: 'B', text: "Separate IAM roles per project, assumed by each team" },
      { id: 'C', text: "Cognito User Pool Groups" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "One GetCredentialsForIdentity call returns the credentials" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "RetireGrant" },
      { id: 'B', text: "RevokeGrant" },
      { id: 'C', text: "DeleteKey" },
      { id: 'D', text: "DisableKey" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Adaptive authentication" },
      { id: 'B', text: "Cognito Sync" },
      { id: 'C', text: "Cognito Identity Pools Basic Auth" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Bake node_modules into a custom CodeBuild image rebuilt on each change" },
      { id: 'C', text: "Disable unit tests during the build phase" },
      { id: 'D', text: "Commit node_modules to the repository so the build skips the install" }
    ],
    correctAnswers: ['A'],
    type: "single",
