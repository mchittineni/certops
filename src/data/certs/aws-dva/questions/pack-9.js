export const AWS_DVA_QUESTIONS_9 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CodeDeployDefault.AllAtOnce" },
      { id: 'B', text: "CodeDeployDefault.OneAtATime" },
      { id: 'C', text: "CodeDeployDefault.HalfAtATime" },
      { id: 'D', text: "Canary10Percent5Minutes" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CodeDeployDefault.OneAtATime" },
      { id: 'B', text: "CodeDeployDefault.AllAtOnce" },
      { id: 'C', text: "CodeDeployDefault.HalfAtATime" },
      { id: 'D', text: "Linear10PercentEvery1Minute" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Custom subsegments around downstream calls" },
      { id: 'B', text: "Deploy a separate X-Ray daemon on an EC2 instance in every AZ" },
      { id: 'C', text: "Enable CloudWatch Logs metric filters" },
      { id: 'D', text: "Increase the X-Ray sampling rate to 100%" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable and disable X-Ray tracing manually every hour via the AWS CLI" },
      { id: 'B', text: "Set the Lambda function memory to 128 MB" },
      { id: 'C', text: "Custom X-Ray sampling rules with a fixed rate and reservoir" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "UDP port 2000" },
      { id: 'B', text: "TCP port 443" },
      { id: 'C', text: "TCP port 8080" },
      { id: 'D', text: "UDP port 53" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Install the Datadog agent on the CloudWatch data center" },
      { id: 'B', text: "A metric filter on FATAL_ERROR incrementing a custom metric" },
      { id: 'C', text: "Write a Lambda function that downloads the log group files every minute" },
      { id: 'D', text: "Export the logs to S3 and run Athena queries every hour" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Write-Behind" },
      { id: 'C', text: "Lazy Loading (Cache-Aside)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Eviction-Only" },
      { id: 'B', text: "Write-Through" },
      { id: 'C', text: "Lazy Loading" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "S3 Byte-Range Fetches" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Write sharding with a random key suffix" },
      { id: 'B', text: "Change the table read capacity units from 1 to 100" },
      { id: 'C', text: "Switch the table from on-demand to provisioned mode" },
      { id: 'D', text: "Enable DynamoDB point-in-time recovery" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "PutMetricData with StorageResolution of 1 second" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "X-Ray Service Graph" },
      { id: 'B', text: "X-Ray Trace List" },
      { id: 'C', text: "CloudWatch Metric Math" },
      { id: 'D', text: "AWS Systems Manager Inventory" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Wrap the HTTP library with captureHTTPs at startup" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "CloudWatch Logs Subscription Filters" },
      { id: 'B', text: "CloudWatch Metric Streams" },
      { id: 'C', text: "S3 Export Tasks" },
      { id: 'D', text: "CloudWatch Logs Insights Scheduled Queries" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "CloudWatch Contributor Insights" },
      { id: 'C', text: "CloudWatch Metric Math" },
