export const AWS_DVA_QUESTIONS_7 = [
  {
    ...
    options: [
      { id: 'A', text: "A Manual Approval action" },
      { id: 'B', text: "A CloudWatch Alarm trigger" },
      { id: 'C', text: "A Lambda Invocation action" },
      { id: 'D', text: "A Step Functions Wait state" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Type: AWS::Serverless::Application" },
      { id: 'B', text: "TemplateVersion: SAM-v2" },
      { id: 'C', text: "Transform: AWS::Serverless-2016-10-31" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "!Ref" },
      { id: 'C', text: "!GetAtt" },
      { id: 'D', text: "!Join with a single argument" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "!Sub MyBucket.Arn" },
      { id: 'C', text: "!Select MyBucket" },
      { id: 'D', text: "!Ref MyBucket" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Use a CreationPolicy with a timeout but no signal from the instance" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In the /var/log/eb-engine/ directory" },
      { id: 'B', text: "In an Amazon S3 public bucket root" },
      { id: 'C', text: "In the package.json dependencies array" },
      { id: 'D', text: ".ebextensions and .platform/hooks" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "ECR and logs on the execution role, DynamoDB on the task" },
      { id: 'B', text: "Assign all permissions to the EC2 instance profile only" },
      { id: 'C', text: "Assign all permissions to the Task Role only" },
      { id: 'D', text: "Attach both sets of permissions to the task execution role only" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A GitPush deny and approval rule" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Define a secondary-artifacts block in the artifacts section of buildspec.yml" },
      { id: 'B', text: "Run two independent CodeBuild projects sequentially" },
      { id: 'C', text: "Manually call aws s3 cp in the post_build phase without artifact declarations" },
      { id: 'D', text: "Secondary artifacts are not supported in AWS CodeBuild" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "env: variables: section" },
      { id: 'B', text: "cache: paths:" },
      { id: 'C', text: "phases: install: commands:" },
      { id: 'D', text: "env: parameter-store: section" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Rollback triggers tied to a 5XX CloudWatch alarm" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The agent must run and the instance needs the right profile" },
      { id: 'B', text: "Docker must be installed and port 80 must be open to 0.0.0.0/0" },
      { id: 'C', text: "The instance must have a static Elastic IP and root SSH enabled" },
      { id: 'D', text: "CodeCommit credentials must be placed in /root/.gitconfig" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Application Load Balancer (ALB) Target Groups" },
      { id: 'B', text: "Amazon Route 53 DNS record weighting alone" },
      { id: 'C', text: "Network Access Control Lists" },
      { id: 'D', text: "NAT Gateway route tables" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable all encryption on the artifact S3 bucket" },
      { id: 'C', text: "Copy artifacts via public unauthenticated URLs" },
      { id: 'D', text: "Use the default AWS-managed aws/s3 KMS key" }
    ],
    correctAnswers: ['A'],
    type: "single",
