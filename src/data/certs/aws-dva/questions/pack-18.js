export const AWS_DVA_QUESTIONS_18 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure the deployment policy to Rolling with 50% batch sizes." },
      { id: 'B', text: "Configure the deployment policy to All at Once." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Store package install scripts in an S3 bucket policy." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Terminate authentication at an Application Load Balancer OIDC listener rule." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Terminate authentication at an Application Load Balancer OIDC listener rule." },
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "A task definition with CPU, memory and `secrets` referencing Secrets Manager." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy containers directly on an on-premises VMware cluster." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Configure the Amazon ECS service to use the AWS Fargate launch type." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Configure the Amazon ECS service to use the AWS Fargate launch type. AWS Fargate is a serverless compute engine for Amazon ECS and EKS that removes the need to manage underlying virtual machines. Developers specify container requirements, and Fargate dynamically provisions and isolates compute capacity per container with pay-as-you-go billing.",
