export const AWS_DVA_QUESTIONS_13 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy an Amazon SNS HTTP topic with client browser subscriptions." },
      { id: 'C', text: "A WebSocket API storing connection IDs in DynamoDB, pushed via `@connections`." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A WebSocket API storing connection IDs in DynamoDB, pushed via `@connections`." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Deploy an Amazon API Gateway WebSocket API, store connection IDs in Amazon DynamoDB upon `$connect`, and use the `@connections` API to push messages to connected clients. API Gateway WebSocket APIs maintain persistent bidirectional stateful connections with client browsers. The `$connect` route stores client `connectionId` values (e.g. in DynamoDB), and backend services send messages directly to specific connected clients at any time using the API Gateway `@connections` API callback endpoint.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy an Amazon API Gateway REST API with client polling every 500 milliseconds." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Stream the file as a base64-encoded string through an Amazon SQS standard queue." },
      { id: 'D', text: "Upload the file to an Amazon DynamoDB table in 400 KB binary chunks." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which implementation or architectural approach satisfies these resilience criteria?",
    options: [
      { id: 'A', text: "Enable Long Polling by setting `ReceiveMessageWaitTimeSeconds` to 20 seconds on the SQS queue." },
      ...
      { id: 'D', text: "Configure Amazon CloudWatch to restart consumer instances every 5 minutes." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Decrease the SQS message visibility timeout to 0 seconds." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy a standard SQS queue with an Amazon DynamoDB table storing processed message hashes." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy a standard SQS queue with an Amazon DynamoDB table storing processed message hashes." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Deploy an Amazon SNS standard topic configured with subscriber message ordering filters." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Deploy an Amazon SQS FIFO queue, populate `MessageGroupId` with the customer account ID, and specify a unique `MessageDeduplicationId` for each transaction. SQS FIFO queues preserve exact message ordering within each `MessageGroupId` and ensure that multiple consumer threads can process different groups concurrently without interleaving. The `MessageDeduplicationId` (or content-based deduplication) guarantees exactly-once processing by rejecting duplicate messages sent within 5 minutes.",
