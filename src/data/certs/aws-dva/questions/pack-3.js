export const AWS_DVA_QUESTIONS_3 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Install the X-Ray daemon inside the API Gateway deployment package" },
      { id: 'B', text: "Add an X-Ray tracking header manually in client browser cookies" },
      { id: 'C', text: "Configure Amazon CloudWatch Logs Insights subscription filters" },
      { id: 'D', text: "Enable X-Ray Tracing checkbox in the API Gateway Stage settings" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Strongly Consistent Read" },
      { id: 'B', text: "Eventually Consistent Read" },
      { id: 'C', text: "Transactional Scan Read" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Composite primary key on the base table" },
      { id: 'B', text: "DynamoDB Accelerator (DAX) secondary key" },
      { id: 'C', text: "Local Secondary Index (LSI) with Status as the partition key" },
      { id: 'D', text: "Global Secondary Index (GSI) with Status as the partition key" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable concurrent writes in DynamoDB table settings" },
      { id: 'B', text: "Route all writes through a single-threaded SQS FIFO queue with a 10-second delay" },
      { id: 'C', text: "Include a versionNumber attribute and use a ConditionExpression expecting the current versionNumber" },
      { id: 'D', text: "Lock the entire table using a pessimistic database transaction lock" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "PutItem with ReturnValues" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure S3 lifecycle rules on the DynamoDB backup bucket" },
      { id: 'B', text: "Enable CloudTrail data events and write a custom Bash log parser" },
      { id: 'C', text: "Run a cron job that executes a full table Scan every minute" },
      { id: 'D', text: "Enable DynamoDB Streams on the table and configure an AWS Lambda trigger" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable Time to Live (TTL) on a timestamp attribute in epoch seconds" },
      { id: 'B', text: "Schedule a nightly Lambda function that runs a Scan and calls DeleteItem on every expired item" },
      { id: 'C', text: "Configure an S3 Glacier archival lifecycle rule" },
      { id: 'D', text: "Decrease the write capacity units (WCU) to zero at midnight" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Amazon CloudFront distribution" },
      { id: 'C', text: "Amazon ElastiCache Memcached cluster" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "KeyConditionExpression" },
      { id: 'B', text: "FilterExpression" },
      { id: 'C', text: "ProjectionExpression" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure a Subscription Filter Policy on the Fraud Alert SNS subscription" },
      { id: 'B', text: "Create separate SNS topics for every customer in the database" },
      { id: 'C', text: "Filter the messages inside the downstream service after receiving them" },
