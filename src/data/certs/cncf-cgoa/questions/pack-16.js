export const CNCF_CGOA_QUESTIONS_16 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "The `argo-cd-repo-server` clones the repository, renders manifests (via Kustomize, Helm, or plugins), and returns them to the controller." },
      { id: 'C', text: "Manifest rendering is performed inside the user's browser client." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Set `prune: false` so deleted resources remain running in the cluster indefinitely." },
      { id: 'C', text: "Disable auto-sync and require engineers to click the 'Sync' button in the UI for every commit." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Put both resources in the same YAML file with no annotations." },
      { id: 'C', text: "Annotate the migration Job with `sync-wave: \"0\"` and the application Deployment with `sync-wave: \"1\"`." },
      { id: 'D', text: "Sync waves are not supported in Argo CD." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Use a standard Kubernetes Deployment and manually change replica counts by hand." },
      { id: 'C', text: "Replace the Kubernetes Deployment with an Argo `Rollout` resource configured with canary steps and an `AnalysisTemplate`." },
      { id: 'D', text: "Switch 100% of user traffic to the new version immediately without analysis." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Replace the Kubernetes Deployment with an Argo `Rollout` resource configured with canary steps and an `AnalysisTemplate`. Argo Rollouts replaces the standard Kubernetes Deployment with a `Rollout` controller supporting advanced canary and blue-green strategies. Linking an `AnalysisTemplate` queries metrics (Prometheus, Datadog) at each canary step, automatically aborting and rolling back if error thresholds are exceeded.",
  ...
  },
  {
    ...
    question: "Which architectural pattern or GitOps engine configuration manages this delivery scale effectively while preventing controller bottlenecks and sync delays?",
    options: [
      { id: 'A', text: "Source acquisition and manifest application are locked into a single indivisible CRD." },
      { id: 'B', text: "Flux runs as a single monolithic process that bypasses the Kubernetes API." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Source acquisition and manifest application are locked into a single indivisible CRD." },
      { id: 'B', text: "Flux requires an external SQL database to track Git commits." },
