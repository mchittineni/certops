export const CNCF_CGOA_QUESTIONS_11 = [
  ...
  },
  {
    ...
    question: "Which solution implements these mandatory GitOps security and governance controls?",
    options: [
      { id: 'A', text: "Store manifests on an unversioned local hard drive." },
      ...
      { id: 'D', text: "Use a shared Google Doc to record infrastructure parameters." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Store desired state in Git, where commits are immutable, versioned, cryptographically signed, and provide complete historical auditability. The second OpenGitOps principle requires desired state to be versioned and immutable. Git provides content-addressable, immutable commit histories, ensuring every transition is recorded with author identity, timestamp, and review approvals, enabling instant point-in-time rollbacks.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy an in-cluster reconciliation agent (like Argo CD or Flux) that continuously pulls approved state declarations from the Git repository." },
  ...
  },
  {
    ...
    question: "Which architectural approach or configuration satisfies these GitOps disaster recovery and operational continuity objectives?",
    options: [
      { id: 'A', text: "Rely on annual external compliance audits to identify drift." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Disable all automated healing to preserve manual modifications." },
  ...
  },
  {
    ...
    question: "Which solution implements these mandatory GitOps security and governance controls?",
    options: [
      { id: 'A', text: "Push-based CI is inherently more secure because it runs outside the cluster." },
