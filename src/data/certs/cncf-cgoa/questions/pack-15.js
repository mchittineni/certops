export const CNCF_CGOA_QUESTIONS_15 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy the new image tag directly to production without testing in dev or staging." },
      { id: 'B', text: "Manually edit running pods in production with `kubectl set image`." },
      { id: 'C', text: "Use mutable `:latest` image tags across all environments." },
      { id: 'D', text: "Update the image tag in the environment-specific overlay file in Git via automated pull requests, promoting across environments via PR merges." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Update the image tag in the environment-specific overlay file in Git via automated pull requests, promoting across environments via PR merges. In GitOps, environment promotion is represented as Git commits or pull requests. When a release passes verification in dev, an automated bot or engineer submits a PR updating the image tag in the staging overlay, ensuring every environment promotion is tracked in Git history.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Use mutable `:latest` image tags across all environments." },
      { id: 'C', text: "Deploy the new image tag directly to production without testing in dev or staging." },
      { id: 'D', text: "Update the image tag in the environment-specific overlay file in Git via automated pull requests, promoting across environments via PR merges." }
    ],
    correctAnswers: ['D'],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Configure Argo CD ApplicationSet with the Pull Request generator to dynamically create ephemeral namespaces and applications for active PRs." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Test all pull requests directly in the shared staging environment simultaneously." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Configure Argo CD ApplicationSet with the Pull Request generator to dynamically create ephemeral namespaces and applications for active PRs. Argo CD ApplicationSet includes a Pull Request generator that queries GitHub/GitLab for open pull requests. It automatically provisions an ephemeral environment (isolated namespace, deployed apps, unique URL) for each PR and tears it down upon PR merge or closure.",
  ...
  },
  {
    ...
    question: "Which solution implements these mandatory GitOps security and governance controls?",
    options: [
      { id: 'A', text: "Disable pull request testing to save cloud resources." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Package common templates as versioned OCI artifacts or Helm charts hosted in a container registry rather than using Git submodules." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Separate CRD installation into a prerequisite sync phase (e.g., Argo CD PreSync hooks or Flux dedicated CRD Kustomizations)." },
      { id: 'C', text: "Avoid using Custom Resources in Kubernetes." },
      { id: 'D', text: "Instruct developers to re-run the sync manually when it fails." }
    ],
    correctAnswers: ['B'],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Provision a new cluster with Terraform and point the GitOps controller at the existing Git repository to recreate all workloads automatically." },
      { id: 'C', text: "Accept that all customer application workloads are permanently lost." },
  ...
  },
  {
    ...
    question: "Which practice or platform feature enables the engineering team to modernize delivery workflows with minimal operational friction?",
    options: [
      { id: 'A', text: "Attempt to extract raw files from crashed worker node hard drives." },
      { id: 'B', text: "Provision a new cluster with Terraform and point the GitOps controller at the existing Git repository to recreate all workloads automatically." },
