export const CNCF_CGOA_QUESTIONS_18 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The CI pipeline triggers a webhook on the developer's laptop." },
      { id: 'B', text: "The developer manually edits the image tag in Git after the CI build finishes." },
      { id: 'C', text: "The CI pipeline connects directly to the Kubernetes API and runs `kubectl set image`." },
      { id: 'D', text: "The CI pipeline builds and pushes the container image to a registry, then commits the new image tag to the GitOps repository using a bot account." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Annotate the notification and warm-up Jobs with `helm.sh/hook: post-install,post-upgrade` or `argocd.argoproj.io/hook: PostSync`." },
  ...
  },
  {
    ...
    question: "Which architectural pattern or GitOps engine configuration manages this delivery scale effectively while preventing controller bottlenecks and sync delays?",
    options: [
      { id: 'A', text: "Put the warm-up script inside an init container in the main application pod." },
  ...
  },
  {
    ...
    question: "Which solution implements these mandatory GitOps security and governance controls?",
    options: [
      { id: 'A', text: "Manual edits must be approved by the Flux notification controller." },
      ...
      { id: 'C', text: "Helm charts cannot be protected against manual cluster edits." },
      { id: 'D', text: "Flux only installs Helm charts once and never reconciles them again." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Flux `helm-controller` continuously compares live Helm releases against Git-declared values and automatically re-applies the release upon drift. Unlike standalone Helm CLI (which only performs one-time installations and cannot detect drift), the Flux `helm-controller` operates a continuous reconciliation loop. It checks the live Helm release against the declared values in Git, automatically undoing manual cluster edits.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Flux `helm-controller` continuously compares live Helm releases against Git-declared values and automatically re-applies the release upon drift." },
      { id: 'C', text: "Flux only installs Helm charts once and never reconciles them again." },
      { id: 'D', text: "Manual edits must be approved by the Flux notification controller." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Rely on customer complaints when deployments fail." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Scrape Prometheus metrics exposed by Argo CD or Flux (`argocd_app_info`, `gotk_reconcile_condition`) and configure alerting rules." },
      { id: 'D', text: "Rely on customer complaints when deployments fail." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Scrape Prometheus metrics exposed by Argo CD or Flux (`argocd_app_info`, `gotk_reconcile_condition`) and configure alerting rules. Both Argo CD and Flux expose rich Prometheus metrics detailing sync status, reconciliation durations, Git polling latencies, and controller error counts. Metrics like `argocd_app_info{sync_status=\"OutOfSync\"}` power operational alerts and dashboards.",
