export const ISC2_CCSP_QUESTIONS_18 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Follow a formal chain of custody: capture bit-stream images/snapshots, calculate cryptographic hashes (SHA-256), and log all handler actions." },
      { id: 'B', text: "Modify evidence files directly on the live server while conducting forensic investigation." },
      { id: 'C', text: "Store forensic disk images on unencrypted public file-sharing websites." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Modify evidence files directly on the live server while conducting forensic investigation." },
      { id: 'B', text: "Store forensic disk images on unencrypted public file-sharing websites." },
      { id: 'C', text: "Follow a formal chain of custody: capture bit-stream images/snapshots, calculate cryptographic hashes (SHA-256), and log all handler actions." },
      { id: 'D', text: "Power off the compromised virtual machine immediately, wiping volatile system RAM and active network sockets." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Power off the compromised virtual machine immediately, wiping volatile system RAM and active network sockets." },
      { id: 'B', text: "Store forensic disk images on unencrypted public file-sharing websites." },
      { id: 'C', text: "Modify evidence files directly on the live server while conducting forensic investigation." },
      { id: 'D', text: "Follow a formal chain of custody: capture bit-stream images/snapshots, calculate cryptographic hashes (SHA-256), and log all handler actions." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Follow a formal chain of custody: capture bit-stream images/snapshots, calculate cryptographic hashes (SHA-256), and log all handler actions. Forensic readiness requires strict chain of custody: 1) preserve volatile RAM first using live acquisition tools, 2) capture point-in-time storage snapshots, 3) generate cryptographic SHA-256 hashes immediately to prove evidence has not been tampered with, and 4) document every custodian in a verifiable custody log.",
  ...
  },
  {
    ...
    question: "Which architectural approach or cloud security control satisfies these enterprise governance objectives?",
    options: [
      { id: 'A', text: "Immediately wipe all servers upon initial alert without conducting detection, analysis, or evidence preservation." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Rely on ad-hoc, unpracticed emergency responses during active production crises." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Avoid vulnerability scanning to prevent discovering compliance deficiencies." },
  ...
  },
  {
    ...
    question: "Which data security mechanism or cryptographic architecture guarantees compliance with international privacy mandates?",
    options: [
      { id: 'A', text: "Conduct penetration tests against other tenants' virtual machines without authorization." },
      { id: 'B', text: "Avoid vulnerability scanning to prevent discovering compliance deficiencies." },
      { id: 'C', text: "Review and adhere to the cloud provider's Penetration Testing Rules of Engagement, focusing on customer-owned infrastructure and apps." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable configuration tracking to prevent generating non-compliance notifications." },
      { id: 'C', text: "Allow engineers to make untracked manual edits directly in cloud web consoles during off-peak hours." },
      { id: 'D', text: "Perform manual configuration audits once a year using paper checklists." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Deploy automated configuration compliance tools that continuously compare running infrastructure against declared IaC baselines and remediate drift." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Reboot all 500 servers simultaneously without a rolling deployment strategy, causing total service downtime." },
  ...
  },
  {
    ...
    question: "Which data security mechanism or cryptographic architecture guarantees compliance with international privacy mandates?",
    options: [
      { id: 'A', text: "Log into all 500 servers sequentially over SSH and execute `apt-get upgrade` interactively." },
      { id: 'B', text: "Bake a new hardened Golden AMI/image with the patched kernel, update the Launch Template, and trigger an automated rolling instance refresh." },
      { id: 'C', text: "Postpone kernel patching indefinitely because recompiling images takes operational effort." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Bake a new hardened Golden AMI/image with the patched kernel, update the Launch Template, and trigger an automated rolling instance refresh." },
      { id: 'B', text: "Reboot all 500 servers simultaneously without a rolling deployment strategy, causing total service downtime." },
      { id: 'C', text: "Postpone kernel patching indefinitely because recompiling images takes operational effort." },
