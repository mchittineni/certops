export const ISC2_CCSP_QUESTIONS_11 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Require manual IT administrator approvals via paper ticketing for every single resource allocation." },
      { id: 'C', text: "Disable resource metering and usage accounting across all tenant workloads." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Require manual IT administrator approvals via paper ticketing for every single resource allocation." },
      { id: 'B', text: "Disable resource metering and usage accounting across all tenant workloads." },
      { id: 'C', text: "Evaluate the environment against all five NIST SP 800-145 essential characteristics: on-demand self-service, broad network access, resource pooling, rapid elasticity, and measured service." },
      { id: 'D', text: "Assume that running VMware ESXi on dedicated local servers automatically constitutes cloud computing." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which infrastructure security design or platform control prevents unauthorized lateral movement and hypervisor compromise?",
    options: [
      { id: 'A', text: "Assume the customer is responsible for physical data center server maintenance in SaaS." },
      { id: 'B', text: "Assume the cloud provider is responsible for customer application data classification and access policies in IaaS." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Recognize that in PaaS (e.g., AWS Elastic Beanstalk, Azure App Service), the CSP manages the underlying OS and runtime, while the customer secures application code and data." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Recognize that in PaaS (e.g., AWS Elastic Beanstalk, Azure App Service), the CSP manages the underlying OS and runtime, while the customer secures application code and data. Under the Shared Responsibility Model, security obligations shift with the service tier: in IaaS, the customer manages the OS, middleware, and applications; in PaaS, the CSP manages the hardware, network, and OS, while the customer manages application code and data; in SaaS, the CSP manages almost the entire stack, while the customer retains data governance.",
  ...
  },
  {
    ...
    question: "Which architectural approach or cloud security control satisfies these enterprise governance objectives?",
    options: [
      { id: 'A', text: "Store healthcare records on unencrypted consumer USB drives mailed between hospitals." },
      { id: 'B', text: "Build completely disconnected on-premises silos that prohibit data sharing between institutions." },
  ...
  },
  {
    ...
    question: "Which application security practice or runtime defense mitigates critical OWASP vulnerabilities before deployment?",
    options: [
      { id: 'A', text: "Hire private investigators to inspect vendor server facilities without permission." },
      { id: 'B', text: "Assume all cloud providers have identical security capabilities and choose solely based on cheapest price." },
      { id: 'C', text: "Use the Cloud Security Alliance (CSA) Cloud Controls Matrix (CCM) and Consensus Assessments Initiative Questionnaire (CAIQ)." },
      { id: 'D', text: "Rely on marketing brochures and unverified sales claims provided by vendor representatives." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Implement Zero Trust Architecture (ZTA): enforce explicit continuous authentication, least-privilege access, and assume breach." },
      { id: 'D', text: "Trust all network traffic originating from within the internal corporate VPN without re-authenticating." }
    ],
    correctAnswers: ['C'],
    type: "single",
