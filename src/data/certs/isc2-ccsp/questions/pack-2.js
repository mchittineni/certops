export const ISC2_CCSP_QUESTIONS_2 = [
  {
    id: "isc2-ccsp-26",
    difficulty: "medium",
    certId: "isc2-ccsp",
    ...
    title: "Secure cloud storage architectures object, block, volume, and ephemeral: Operational Strategy (Part 26)",
    scenario: "A multinational fintech banking platform is evaluating Certified Cloud Security Professional practices specifically regarding Secure cloud storage architectures object, block, volume, and ephemeral. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #26.",
  ...
  },
  {
    ...
    title: "Container security and runtime isolation mechanisms: Operational Strategy (Part 27)",
    scenario: "A healthcare telemedicine network is evaluating Certified Cloud Security Professional practices specifically regarding Container security and runtime isolation mechanisms. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #27.",
  ...
  },
  {
    ...
    title: "API security, rate limiting, and OWASP Top 10 API vulnerabilities: Operational Strategy (Part 28)",
    scenario: "A high-throughput e-commerce retailer is evaluating Certified Cloud Security Professional practices specifically regarding API security, rate limiting, and OWASP Top 10 API vulnerabilities. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #28.",
  ...
  },
  {
    ...
    title: "Security Information and Event Management SIEM in multi-cloud: Operational Strategy (Part 29)",
    scenario: "A global streaming entertainment platform is evaluating Certified Cloud Security Professional practices specifically regarding Security Information and Event Management SIEM in multi-cloud. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #29.",
  ...
  },
  {
    ...
    title: "Electronic discovery eDiscovery and cross-border data transfer restrictions: Operational Strategy (Part 30)",
    scenario: "An algorithmic trading exchange is evaluating Certified Cloud Security Professional practices specifically regarding Electronic discovery eDiscovery and cross-border data transfer restrictions. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #30.",
  ...
  },
  {
    ...
    title: "Cloud computing service models IaaS, PaaS, SaaS and shared responsibility: Operational Strategy (Part 31)",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Cloud Platform and Infrastructure Security",
    title: "Hypervisor architecture Type 1 vs Type 2 and virtualization vulnerabilities: Operational Strategy (Part 33)",
    scenario: "A multi-tenant enterprise SaaS provider is evaluating Certified Cloud Security Professional practices specifically regarding Hypervisor architecture Type 1 vs Type 2 and virtualization vulnerabilities. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #33.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Cloud Application Security",
    title: "Secure Software Development Life Cycle SSDLC in cloud architectures: Operational Strategy (Part 34)",
    scenario: "A public sector aerospace engineering department is evaluating Certified Cloud Security Professional practices specifically regarding Secure Software Development Life Cycle SSDLC in cloud architectures. The engineering group is implementing automated canary analysis with instant rollback capabilities triggered by error budget burn rates for service tier #34.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Cloud Security Operations",
    title: "Security operations center SOC continuous monitoring and alerting: Operational Strategy (Part 35)",
    scenario: "An automotive connected-vehicle fleet manager is evaluating Certified Cloud Security Professional practices specifically regarding Security operations center SOC continuous monitoring and alerting. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #35.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Legal, Risk and Compliance",
    title: "International privacy laws including GDPR, CCPA, and HIPAA compliance: Operational Strategy (Part 36)",
    scenario: "A digital media publishing network is evaluating Certified Cloud Security Professional practices specifically regarding International privacy laws including GDPR, CCPA, and HIPAA compliance. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #36.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts, Architecture and Design",
    title: "Cloud deployment models public, private, hybrid, and community: Operational Strategy (Part 37)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Cloud Data Security",
    title: "Data discovery and classification methodologies in multi-tenant cloud: Operational Strategy (Part 38)",
    scenario: "A renewable energy smart-grid operator is evaluating Certified Cloud Security Professional practices specifically regarding Data discovery and classification methodologies in multi-tenant cloud. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #38.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Cloud Platform and Infrastructure Security",
    title: "Software-Defined Networking SDN security and micro-segmentation: Operational Strategy (Part 39)",
    scenario: "A mobile gaming backend architecture is evaluating Certified Cloud Security Professional practices specifically regarding Software-Defined Networking SDN security and micro-segmentation. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #39.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Cloud Application Security",
    title: "Application security testing comparing SAST, DAST, IAST, and SCA: Operational Strategy (Part 40)",
    scenario: "A ride-sharing dispatch system is evaluating Certified Cloud Security Professional practices specifically regarding Application security testing comparing SAST, DAST, IAST, and SCA. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #40.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Cloud Security Operations",
    title: "Cloud incident response triage, containment, and eradication: Operational Strategy (Part 41)",
    scenario: "An insurance claims processing engine is evaluating Certified Cloud Security Professional practices specifically regarding Cloud incident response triage, containment, and eradication. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #41.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Legal, Risk and Compliance",
    title: "SOC 1, SOC 2 Type II, and SOC 3 reporting and audit assertions: Operational Strategy (Part 42)",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts, Architecture and Design",
    title: "Cloud reference architecture CSA and enterprise security architecture: Operational Strategy (Part 43)",
    scenario: "A cybersecurity threat intelligence agency is evaluating Certified Cloud Security Professional practices specifically regarding Cloud reference architecture CSA and enterprise security architecture. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #43.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Cloud Data Security",
    title: "Information Rights Management IRM and Digital Rights Management DRM: Operational Strategy (Part 44)",
    scenario: "A real estate property management portal is evaluating Certified Cloud Security Professional practices specifically regarding Information Rights Management IRM and Digital Rights Management DRM. The engineering group is implementing automated canary analysis with instant rollback capabilities triggered by error budget burn rates for service tier #44.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Cloud Application Security",
    title: "Threat modeling methodologies STRIDE and DREAD in cloud systems: Operational Strategy (Part 46)",
    scenario: "A higher education student information system is evaluating Certified Cloud Security Professional practices specifically regarding Threat modeling methodologies STRIDE and DREAD in cloud systems. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #46.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Cloud Security Operations",
    title: "Digital forensics in cloud environments and chain of custody preservation: Operational Strategy (Part 47)",
    scenario: "A global hotel hospitality reservation platform is evaluating Certified Cloud Security Professional practices specifically regarding Digital forensics in cloud environments and chain of custody preservation. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #47.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Legal, Risk and Compliance",
    title: "ISO/IEC 27017 cloud security and ISO/IEC 27018 cloud privacy controls: Operational Strategy (Part 48)",
    scenario: "A digital payments settlement processor is evaluating Certified Cloud Security Professional practices specifically regarding ISO/IEC 27017 cloud security and ISO/IEC 27018 cloud privacy controls. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #48.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts, Architecture and Design",
    title: "Evaluating cloud service providers CSPs and third-party risk analysis: Operational Strategy (Part 49)",
    scenario: "A genomics sequencing data pipeline is evaluating Certified Cloud Security Professional practices specifically regarding Evaluating cloud service providers CSPs and third-party risk analysis. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #49.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Cloud Data Security",
    title: "Data tokenization vs format-preserving encryption and masking: Operational Strategy (Part 50)",
    scenario: "A cloud-native telecommunications provider is evaluating Certified Cloud Security Professional practices specifically regarding Data tokenization vs format-preserving encryption and masking. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #50.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
...
export default ISC2_CCSP_QUESTIONS_2;
