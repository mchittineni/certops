export const ISC2_CCSP_QUESTIONS_14 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Over-write cloud storage blocks with zeros once using consumer operating system format utilities." },
      { id: 'C', text: "Execute crypto-shredding: securely delete and zeroize all cryptographic keys used to encrypt the target datasets." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Demand that the cloud provider physically melt and shred shared multi-tenant storage arrays hosting other customer data." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Display full credit card numbers in plaintext to all call center employees." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Truncate the middle digits of the card number in memory without using a token vault." },
  ...
  },
  {
    ...
    question: "Which legal, risk, or compliance procedure guarantees due diligence and satisfies regulatory requirements?",
    options: [
      { id: 'A', text: "Truncate the middle digits of the card number in memory without using a token vault." },
      { id: 'B', text: "Display full credit card numbers in plaintext to all call center employees." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Verify the provider's physical security layers: perimeter fencing, biometric mantraps, 24/7 video surveillance, dual power feeds, and HVAC fire suppression." },
      { id: 'C', text: "Assume physical security is irrelevant in cloud computing because workloads run virtually." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Allow unescorted public visitor tours through production cloud server halls." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Verify the provider's physical security layers: perimeter fencing, biometric mantraps, 24/7 video surveillance, dual power feeds, and HVAC fire suppression. Physical security in cloud computing relies on layered defense (defense-in-depth): outer perimeter barriers, biometric multi-factor mantraps, security escort policies, continuous video retention, and environmental safeguards (N+1 redundant generators, precision cooling, clean-agent fire suppression).",
  ...
  },
  {
    ...
    question: "Which application security practice or runtime defense mitigates critical OWASP vulnerabilities before deployment?",
    options: [
      { id: 'A', text: "Disable internal network filtering to optimize network packet processing speeds." },
      { id: 'B', text: "Place all application servers, databases, and admin consoles in a single flat, unrouted VLAN." },
      { id: 'C', text: "Implement software-defined micro-segmentation, enforcing granular virtual firewall rules that allow only authorized ports between tiers." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable internal network filtering to optimize network packet processing speeds." },
      { id: 'C', text: "Implement software-defined micro-segmentation, enforcing granular virtual firewall rules that allow only authorized ports between tiers." },
      { id: 'D', text: "Place all application servers, databases, and admin consoles in a single flat, unrouted VLAN." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Implement software-defined micro-segmentation, enforcing granular virtual firewall rules that allow only authorized ports between tiers. Software-Defined Networking (SDN) abstracts the physical network, enabling micro-segmentation. By attaching distributed virtual firewall rules directly to virtual machine NICs or container pods, security teams isolate east-west traffic, preventing lateral attacker movement even within the same subnet.",
