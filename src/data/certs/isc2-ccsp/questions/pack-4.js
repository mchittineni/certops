export const ISC2_CCSP_QUESTIONS_4 = [
  {
    id: "isc2-ccsp-76",
    difficulty: "medium",
    certId: "isc2-ccsp",
    ...
    title: "Threat modeling methodologies STRIDE and DREAD in cloud systems: Operational Strategy (Part 76)",
    scenario: "A multinational fintech banking platform is evaluating Certified Cloud Security Professional practices specifically regarding Threat modeling methodologies STRIDE and DREAD in cloud systems. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #76.",
  ...
  },
  {
    ...
    title: "Digital forensics in cloud environments and chain of custody preservation: Operational Strategy (Part 77)",
    scenario: "A healthcare telemedicine network is evaluating Certified Cloud Security Professional practices specifically regarding Digital forensics in cloud environments and chain of custody preservation. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #77.",
  ...
  },
  {
    ...
    title: "ISO/IEC 27017 cloud security and ISO/IEC 27018 cloud privacy controls: Operational Strategy (Part 78)",
    scenario: "A high-throughput e-commerce retailer is evaluating Certified Cloud Security Professional practices specifically regarding ISO/IEC 27017 cloud security and ISO/IEC 27018 cloud privacy controls. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #78.",
  ...
  },
  {
    ...
    title: "Evaluating cloud service providers CSPs and third-party risk analysis: Operational Strategy (Part 79)",
    scenario: "A global streaming entertainment platform is evaluating Certified Cloud Security Professional practices specifically regarding Evaluating cloud service providers CSPs and third-party risk analysis. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #79.",
    ...
    options: [
      ...
      { id: 'D', text: "Deploy native automation for evaluating cloud service providers csps and third-party risk analysis utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    title: "Data tokenization vs format-preserving encryption and masking: Operational Strategy (Part 80)",
    scenario: "An algorithmic trading exchange is evaluating Certified Cloud Security Professional practices specifically regarding Data tokenization vs format-preserving encryption and masking. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #80.",
  ...
  },
  {
    ...
    title: "Physical and environmental security controls for hyperscale data centers: Operational Strategy (Part 81)",
    scenario: "A logistics and supply chain optimization service is evaluating Certified Cloud Security Professional practices specifically regarding Physical and environmental security controls for hyperscale data centers. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #81.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Cloud Application Security",
    title: "Federated identity management with SAML 2.0, OAuth 2.0, and OIDC: Operational Strategy (Part 82)",
    scenario: "An IoT industrial telematics infrastructure is evaluating Certified Cloud Security Professional practices specifically regarding Federated identity management with SAML 2.0, OAuth 2.0, and OIDC. The engineering group is implementing automated canary analysis with instant rollback capabilities triggered by error budget burn rates for service tier #82.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Cloud Security Operations",
    title: "Patch management, vulnerability assessment, and baseline drift auditing: Operational Strategy (Part 83)",
    scenario: "A multi-tenant enterprise SaaS provider is evaluating Certified Cloud Security Professional practices specifically regarding Patch management, vulnerability assessment, and baseline drift auditing. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #83.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Legal, Risk and Compliance",
    title: "Contractual obligations, Service Level Agreements SLAs, and liabilities: Operational Strategy (Part 84)",
    scenario: "A public sector aerospace engineering department is evaluating Certified Cloud Security Professional practices specifically regarding Contractual obligations, Service Level Agreements SLAs, and liabilities. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #84.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Deploy native automation for contractual obligations, service level agreements slas, and liabilities utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'C', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'D', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." }
    ],
    correctAnswers: ['B'],
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts, Architecture and Design",
    title: "Business impact analysis BIA and cloud financial economics: Operational Strategy (Part 85)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Cloud Data Security",
    title: "Secure cloud storage architectures object, block, volume, and ephemeral: Operational Strategy (Part 86)",
    scenario: "A digital media publishing network is evaluating Certified Cloud Security Professional practices specifically regarding Secure cloud storage architectures object, block, volume, and ephemeral. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #86.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'C', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'D', text: "Deploy native automation for secure cloud storage architectures object, block, volume, and ephemeral utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Cloud Platform and Infrastructure Security",
    title: "Container security and runtime isolation mechanisms: Operational Strategy (Part 87)",
    scenario: "A pharmaceutical clinical trial data service is evaluating Certified Cloud Security Professional practices specifically regarding Container security and runtime isolation mechanisms. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #87.",
    question: "Which configuration provides the most cost-effective and secure solution to achieve these criteria?",
    options: [
      { id: 'A', text: "Deploy native automation for container security and runtime isolation mechanisms utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Cloud Application Security",
    title: "API security, rate limiting, and OWASP Top 10 API vulnerabilities: Operational Strategy (Part 88)",
    scenario: "A renewable energy smart-grid operator is evaluating Certified Cloud Security Professional practices specifically regarding API security, rate limiting, and OWASP Top 10 API vulnerabilities. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #88.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'C', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'D', text: "Deploy native automation for api security, rate limiting, and owasp top 10 api vulnerabilities utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Cloud Security Operations",
    title: "Security Information and Event Management SIEM in multi-cloud: Operational Strategy (Part 89)",
    scenario: "A mobile gaming backend architecture is evaluating Certified Cloud Security Professional practices specifically regarding Security Information and Event Management SIEM in multi-cloud. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #89.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts, Architecture and Design",
    title: "Cloud computing service models IaaS, PaaS, SaaS and shared responsibility: Operational Strategy (Part 91)",
    scenario: "An insurance claims processing engine is evaluating Certified Cloud Security Professional practices specifically regarding Cloud computing service models IaaS, PaaS, SaaS and shared responsibility. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #91.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Cloud Platform and Infrastructure Security",
    title: "Hypervisor architecture Type 1 vs Type 2 and virtualization vulnerabilities: Operational Strategy (Part 93)",
    scenario: "A cybersecurity threat intelligence agency is evaluating Certified Cloud Security Professional practices specifically regarding Hypervisor architecture Type 1 vs Type 2 and virtualization vulnerabilities. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #93.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
      { id: 'A', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Cloud Application Security",
    title: "Secure Software Development Life Cycle SSDLC in cloud architectures: Operational Strategy (Part 94)",
    scenario: "A real estate property management portal is evaluating Certified Cloud Security Professional practices specifically regarding Secure Software Development Life Cycle SSDLC in cloud architectures. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #94.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Cloud Security Operations",
    title: "Security operations center SOC continuous monitoring and alerting: Operational Strategy (Part 95)",
    scenario: "An autonomous robotics manufacturing facility is evaluating Certified Cloud Security Professional practices specifically regarding Security operations center SOC continuous monitoring and alerting. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #95.",
    question: "Which design pattern should be implemented to ensure continuous compliance, automated validation, and high availability?",
    options: [
      { id: 'A', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'B', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Legal, Risk and Compliance",
    title: "International privacy laws including GDPR, CCPA, and HIPAA compliance: Operational Strategy (Part 96)",
    scenario: "A higher education student information system is evaluating Certified Cloud Security Professional practices specifically regarding International privacy laws including GDPR, CCPA, and HIPAA compliance. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #96.",
    question: "What is the recommended implementation strategy to satisfy these technical requirements according to official best practices?",
    options: [
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts, Architecture and Design",
    title: "Cloud deployment models public, private, hybrid, and community: Operational Strategy (Part 97)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Cloud Data Security",
    title: "Data discovery and classification methodologies in multi-tenant cloud: Operational Strategy (Part 98)",
    scenario: "A digital payments settlement processor is evaluating Certified Cloud Security Professional practices specifically regarding Data discovery and classification methodologies in multi-tenant cloud. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #98.",
    question: "Which architectural approach fulfills these operational objectives while maintaining reliability and minimal engineering overhead?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Cloud Platform and Infrastructure Security",
    title: "Software-Defined Networking SDN security and micro-segmentation: Operational Strategy (Part 99)",
    scenario: "A genomics sequencing data pipeline is evaluating Certified Cloud Security Professional practices specifically regarding Software-Defined Networking SDN security and micro-segmentation. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #99.",
    question: "How should the engineering team configure the platform to ensure resilient, automated operation without manual intervention?",
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
...
export default ISC2_CCSP_QUESTIONS_4;
