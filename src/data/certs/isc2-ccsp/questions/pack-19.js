export const ISC2_CCSP_QUESTIONS_19 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Assume cloud provider marketing claims of high availability guarantee that applications will never fail." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Conduct controlled chaos engineering experiments (e.g., AWS Fault Injection Simulator, Chaos Mesh) simulating regional network blackholes. Chaos engineering proactively injects controlled disruptions (terminating instances, injecting network latency, blackholing dependencies) into running environments. This validates that automated failover, health probes, circuit breakers, and self-healing controllers operate as designed before real incidents occur.",
  ...
  },
  {
    ...
    question: "Which data security mechanism or cryptographic architecture guarantees compliance with international privacy mandates?",
    options: [
      { id: 'A', text: "Refuse to delete customer records when requested under the GDPR Right to Erasure." },
      { id: 'B', text: "Enforce data residency within EU cloud regions, implement technical safeguards (encryption, pseudonymization), and support data subject access requests." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Refuse to delete customer records when requested under the GDPR Right to Erasure." },
      { id: 'B', text: "Assume global privacy laws apply only to companies with physical headquarters in that specific jurisdiction." },
      ...
      { id: 'D', text: "Transfer all European citizen records to unencrypted public servers in foreign jurisdictions with no legal adequacy agreements." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Enforce data residency within EU cloud regions, implement technical safeguards (encryption, pseudonymization), and support data subject access requests. Data sovereignty laws dictate that data is subject to the legal framework of the jurisdiction where it is located. GDPR (EU) and CCPA/CPRA (California) mandate strict cross-border transfer rules (Standard Contractual Clauses), data subject rights (access, rectification, erasure), and severe penalties for non-compliance.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Review the provider's independent SOC 2 Type II report, evaluating the design and operating effectiveness of security controls over time." },
      { id: 'C', text: "Download a generic marketing SOC 3 report and assume it contains detailed technical testing evidence." },
      { id: 'D', text: "Rely on a SOC 2 Type I report which only evaluates control design at a single point in time without testing operational effectiveness." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Request a SOC 1 report to evaluate technical cybersecurity controls against malware." },
      { id: 'B', text: "Download a generic marketing SOC 3 report and assume it contains detailed technical testing evidence." },
      { id: 'C', text: "Rely on a SOC 2 Type I report which only evaluates control design at a single point in time without testing operational effectiveness." },
