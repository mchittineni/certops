export const ISC2_CCSP_QUESTIONS_15 = [
  {
    ...
    options: [
      { id: 'A', text: "Disable version control for server configuration scripts." },
      ...
      { id: 'D', text: "Adopt Immutable Infrastructure: build hardened Golden Images via automated pipelines, disable SSH access, and replace instances upon updates." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Keep servers running continuously for five years without rebuilding base images." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Share a single corporate master administrative password among all IT team members." },
      { id: 'D', text: "Disable multi-factor authentication during identity federation to streamline login workflows." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which infrastructure security design or platform control prevents unauthorized lateral movement and hypervisor compromise?",
    options: [
      { id: 'A', text: "Disable multi-factor authentication during identity federation to streamline login workflows." },
      { id: 'B', text: "Create local username and password accounts for each employee in every individual cloud service console." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Disable subnet routing and connect databases directly to external public WiFi routers." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which data security mechanism or cryptographic architecture guarantees compliance with international privacy mandates?",
    options: [
      { id: 'A', text: "Assign public IPv4 addresses to all database servers and rely on passwords alone." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Assign public IPv4 addresses to all database servers and rely on passwords alone." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Assign public IPv4 addresses to all database servers and rely on passwords alone." },
      { id: 'B', text: "Disable subnet routing and connect databases directly to external public WiFi routers." },
      { id: 'C', text: "Place database servers in the same public subnet as internet-facing web proxies." },
      { id: 'D', text: "Place database servers in private subnets with no public IPs, routing egress via NAT gateways and accessing cloud services via private endpoints." }
    ],
    correctAnswers: ['D'],
  ...
  },
  {
    ...
    question: "Which application security practice or runtime defense mitigates critical OWASP vulnerabilities before deployment?",
    options: [
      { id: 'A', text: "Mount the host root filesystem (`/`) directly into all application containers." },
      { id: 'B', text: "Run all containerized processes as root with `--privileged=true` enabled." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy default unhardened operating system installations directly into production." },
