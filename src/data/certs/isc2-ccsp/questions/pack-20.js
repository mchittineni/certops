export const ISC2_CCSP_QUESTIONS_20 = [
  {
    id: "isc2-ccsp-476",
    difficulty: "hard",
    certId: "isc2-ccsp",
    ...
    options: [
      ...
      { id: 'C', text: "Assume all cloud startups have equal financial backing and disaster recovery capabilities." },
      { id: 'D', text: "Perform a formal risk assessment evaluating financial viability, sub-processor security, exit strategies, and regulatory attestations." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Assume all cloud startups have equal financial backing and disaster recovery capabilities." },
      { id: 'D', text: "Sign vendor agreements without reviewing terms regarding data ownership or liability caps." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Perform a formal risk assessment evaluating financial viability, sub-processor security, exit strategies, and regulatory attestations. Cloud risk management requires assessing risks unique to outsourcing: vendor lock-in (proprietary APIs preventing migration), vendor insolvency (financial stability), supply chain risk (fourth-party sub-processors), and legal jurisdiction risks. Mitigations include multi-cloud architectures, escrow agreements, and exit strategies.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Sign vendor agreements without reviewing terms regarding data ownership or liability caps." },
      { id: 'D', text: "Assume all cloud startups have equal financial backing and disaster recovery capabilities." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Perform a formal risk assessment evaluating financial viability, sub-processor security, exit strategies, and regulatory attestations. Cloud risk management requires assessing risks unique to outsourcing: vendor lock-in (proprietary APIs preventing migration), vendor insolvency (financial stability), supply chain risk (fourth-party sub-processors), and legal jurisdiction risks. Mitigations include multi-cloud architectures, escrow agreements, and exit strategies.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Sign vendor agreements without reviewing terms regarding data ownership or liability caps." },
      { id: 'C', text: "Perform a formal risk assessment evaluating financial viability, sub-processor security, exit strategies, and regulatory attestations." },
      { id: 'D', text: "Migrate production databases immediately without evaluating vendor viability or exit strategies." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Perform a formal risk assessment evaluating financial viability, sub-processor security, exit strategies, and regulatory attestations. Cloud risk management requires assessing risks unique to outsourcing: vendor lock-in (proprietary APIs preventing migration), vendor insolvency (financial stability), supply chain risk (fourth-party sub-processors), and legal jurisdiction risks. Mitigations include multi-cloud architectures, escrow agreements, and exit strategies.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Ensure the Service Level Agreement (SLA) defines clear availability percentages, financial service credits, and narrow exclusion clauses." },
      { id: 'C', text: "Assume verbal sales promises of 'five nines' availability are legally binding without written contract clauses." },
      { id: 'D', text: "Accept contract clauses that grant the cloud provider complete ownership of all customer data." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Sign contracts with no defined uptime commitments or financial remedies for downtime." },
      { id: 'C', text: "Accept contract clauses that grant the cloud provider complete ownership of all customer data." },
      { id: 'D', text: "Assume verbal sales promises of 'five nines' availability are legally binding without written contract clauses." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Ensure the Service Level Agreement (SLA) defines clear availability percentages, financial service credits, and narrow exclusion clauses. A Cloud Service Level Agreement (SLA) defines formal performance commitments: availability metrics (e.g., 99.99% uptime), measurement windows, financial service credit structures, notification timelines, and exclusions (e.g., scheduled maintenance, force majeure). Contracts must also guarantee data portability upon termination.",
  ...
  },
  {
    ...
    question: "Which application security practice or runtime defense mitigates critical OWASP vulnerabilities before deployment?",
    options: [
      { id: 'A', text: "Accept contract clauses that grant the cloud provider complete ownership of all customer data." },
      { id: 'B', text: "Assume verbal sales promises of 'five nines' availability are legally binding without written contract clauses." },
      { id: 'C', text: "Ensure the Service Level Agreement (SLA) defines clear availability percentages, financial service credits, and narrow exclusion clauses." },
      { id: 'D', text: "Sign contracts with no defined uptime commitments or financial remedies for downtime." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Ensure the Service Level Agreement (SLA) defines clear availability percentages, financial service credits, and narrow exclusion clauses. A Cloud Service Level Agreement (SLA) defines formal performance commitments: availability metrics (e.g., 99.99% uptime), measurement windows, financial service credit structures, notification timelines, and exclusions (e.g., scheduled maintenance, force majeure). Contracts must also guarantee data portability upon termination.",
  ...
  },
  {
    ...
    question: "Which architectural approach or cloud security control satisfies these enterprise governance objectives?",
    options: [
      { id: 'A', text: "Instruct employees to delete their email inboxes to prevent opposing legal counsel from finding embarrassing messages." },
      ...
      { id: 'C', text: "Rely on standard 30-day auto-purge policies that automatically destroy relevant legal evidence." },
      { id: 'D', text: "Export records to personal flash drives and delete the original cloud storage containers." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which data security mechanism or cryptographic architecture guarantees compliance with international privacy mandates?",
    options: [
      { id: 'A', text: "Export records to personal flash drives and delete the original cloud storage containers." },
      ...
      { id: 'C', text: "Rely on standard 30-day auto-purge policies that automatically destroy relevant legal evidence." },
      { id: 'D', text: "Apply a Legal Hold to relevant cloud mailboxes and storage repositories, preventing object deletion or modification regardless of retention schedules." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Apply a Legal Hold to relevant cloud mailboxes and storage repositories, preventing object deletion or modification regardless of retention schedules. Under the Federal Rules of Civil Procedure (FRCP), organizations have a legal duty to preserve electronic records when litigation is reasonably anticipated. Cloud Legal Holds override standard lifecycle deletion policies, preserving documents and metadata in an unalterable state to avoid spoliation sanctions.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Rely on standard 30-day auto-purge policies that automatically destroy relevant legal evidence." },
      { id: 'D', text: "Instruct employees to delete their email inboxes to prevent opposing legal counsel from finding embarrassing messages." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Apply a Legal Hold to relevant cloud mailboxes and storage repositories, preventing object deletion or modification regardless of retention schedules. Under the Federal Rules of Civil Procedure (FRCP), organizations have a legal duty to preserve electronic records when litigation is reasonably anticipated. Cloud Legal Holds override standard lifecycle deletion policies, preserving documents and metadata in an unalterable state to avoid spoliation sanctions.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Apply a Legal Hold to relevant cloud mailboxes and storage repositories, preventing object deletion or modification regardless of retention schedules." },
      { id: 'B', text: "Instruct employees to delete their email inboxes to prevent opposing legal counsel from finding embarrassing messages." },
      { id: 'C', text: "Export records to personal flash drives and delete the original cloud storage containers." },
      { id: 'D', text: "Rely on standard 30-day auto-purge policies that automatically destroy relevant legal evidence." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Apply a Legal Hold to relevant cloud mailboxes and storage repositories, preventing object deletion or modification regardless of retention schedules. Under the Federal Rules of Civil Procedure (FRCP), organizations have a legal duty to preserve electronic records when litigation is reasonably anticipated. Cloud Legal Holds override standard lifecycle deletion policies, preserving documents and metadata in an unalterable state to avoid spoliation sanctions.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Apply a Legal Hold to relevant cloud mailboxes and storage repositories, preventing object deletion or modification regardless of retention schedules." },
      { id: 'D', text: "Instruct employees to delete their email inboxes to prevent opposing legal counsel from finding embarrassing messages." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Demand that the provider give customer security auditors direct root passwords to physical hypervisors." },
      { id: 'C', text: "Review the provider's independent third-party audit reports (SOC 2 Type II, ISO 27001) and negotiate specific contractual right-to-audit terms." },
      { id: 'D', text: "Attempt to gain unauthorized physical access to the provider's data center by climbing perimeter fences." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Attempt to gain unauthorized physical access to the provider's data center by climbing perimeter fences." },
      { id: 'D', text: "Review the provider's independent third-party audit reports (SOC 2 Type II, ISO 27001) and negotiate specific contractual right-to-audit terms." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Review the provider's independent third-party audit reports (SOC 2 Type II, ISO 27001) and negotiate specific contractual right-to-audit terms. Because multi-tenant security prohibits customers from physically inspecting data centers or accessing shared infrastructure, cloud auditing relies on independent third-party attestations (AICPA SOC 2 Type II, ISO 27001/27017 certificates, FedRAMP). Contracts may also grant targeted audit rights for tenant-specific configurations.",
  ...
  },
  {
    ...
    question: "Which infrastructure security design or platform control prevents unauthorized lateral movement and hypervisor compromise?",
    options: [
      { id: 'A', text: "Review the provider's independent third-party audit reports (SOC 2 Type II, ISO 27001) and negotiate specific contractual right-to-audit terms." },
      { id: 'B', text: "Attempt to gain unauthorized physical access to the provider's data center by climbing perimeter fences." },
      { id: 'C', text: "Cancel all audits and conclude that public cloud providers cannot be held accountable to security standards." },
      { id: 'D', text: "Demand that the provider give customer security auditors direct root passwords to physical hypervisors." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Review the provider's independent third-party audit reports (SOC 2 Type II, ISO 27001) and negotiate specific contractual right-to-audit terms. Because multi-tenant security prohibits customers from physically inspecting data centers or accessing shared infrastructure, cloud auditing relies on independent third-party attestations (AICPA SOC 2 Type II, ISO 27001/27017 certificates, FedRAMP). Contracts may also grant targeted audit rights for tenant-specific configurations.",
  ...
  },
  {
    ...
    question: "Which application security practice or runtime defense mitigates critical OWASP vulnerabilities before deployment?",
    options: [
      { id: 'A', text: "Attempt to gain unauthorized physical access to the provider's data center by climbing perimeter fences." },
      ...
      { id: 'C', text: "Demand that the provider give customer security auditors direct root passwords to physical hypervisors." },
      { id: 'D', text: "Cancel all audits and conclude that public cloud providers cannot be held accountable to security standards." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Review the provider's independent third-party audit reports (SOC 2 Type II, ISO 27001) and negotiate specific contractual right-to-audit terms. Because multi-tenant security prohibits customers from physically inspecting data centers or accessing shared infrastructure, cloud auditing relies on independent third-party attestations (AICPA SOC 2 Type II, ISO 27001/27017 certificates, FedRAMP). Contracts may also grant targeted audit rights for tenant-specific configurations.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Claim that migrating to the cloud automatically transfers all legal liability and regulatory responsibility to the provider." },
      { id: 'D', text: "Migrate mission-critical corporate workloads to an unvetted cloud provider without reviewing security controls or contracts." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Document formal risk assessments, verify provider compliance attestations, enforce encryption, and establish continuous monitoring." },
      { id: 'D', text: "Migrate mission-critical corporate workloads to an unvetted cloud provider without reviewing security controls or contracts." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which infrastructure security design or platform control prevents unauthorized lateral movement and hypervisor compromise?",
    options: [
      { id: 'A', text: "Document formal risk assessments, verify provider compliance attestations, enforce encryption, and establish continuous monitoring." },
      { id: 'B', text: "Migrate mission-critical corporate workloads to an unvetted cloud provider without reviewing security controls or contracts." },
      { id: 'C', text: "Claim that migrating to the cloud automatically transfers all legal liability and regulatory responsibility to the provider." },
      { id: 'D', text: "Ignore industry compliance mandates and dismiss cybersecurity as an unnecessary business expense." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Document formal risk assessments, verify provider compliance attestations, enforce encryption, and establish continuous monitoring. Due Diligence is the practice of investigating and assessing risks before entering into a transaction (e.g., verifying certifications, reviewing contracts). Due Care is the continuous practice of implementing and maintaining reasonable security controls (prudent person rule). Organizations cannot outsource ultimate legal liability for data breaches.",
...
export default ISC2_CCSP_QUESTIONS_20;
