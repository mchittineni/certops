export const ISC2_CCSP_QUESTIONS_13 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Split the file manually into two unencrypted halves using a zip utility." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Implement Information Dispersal Algorithms (IDA) with bit-splitting and erasure coding, distributing data slices across diverse providers." },
  ...
  },
  {
    ...
    question: "Which data security mechanism or cryptographic architecture guarantees compliance with international privacy mandates?",
    options: [
      { id: 'A', text: "Allow unrestricted data exfiltration to external cloud storage providers." },
      { id: 'B', text: "Rely on employee code-of-conduct agreements without technical enforcement controls." },
      { id: 'C', text: "Block all outgoing internet traffic across the entire enterprise permanently." },
      { id: 'D', text: "Deploy a Cloud Data Loss Prevention (DLP) solution enforcing content inspection, regex pattern matching, and automated egress blocking." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Deploy a Cloud Data Loss Prevention (DLP) solution enforcing content inspection, regex pattern matching, and automated egress blocking. Cloud DLP systems monitor data in motion, at rest, and in use. By combining deep content inspection (credit cards, PII regex, document fingerprinting) with contextual awareness (user role, destination IP, encryption status), DLP blocks unauthorized data transfer and exfiltration in real time.",
  ...
  },
  {
    ...
    question: "Which architectural approach or cloud security control satisfies these enterprise governance objectives?",
    options: [
      { id: 'A', text: "Use default cloud provider-managed keys where the CSP controls both storage and cryptographic keys." },
      { id: 'B', text: "Disable encryption at rest and rely on network firewalls alone." },
  ...
  },
  {
    ...
    question: "Which infrastructure security design or platform control prevents unauthorized lateral movement and hypervisor compromise?",
    options: [
      { id: 'A', text: "Implement a Hold-Your-Own-Key (HYOK) or dedicated on-premises Hardware Security Module (HSM) architecture with client-side encryption." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Use static preshared keys transmitted in plaintext query parameters." },
      { id: 'C', text: "Enforce TLS 1.3 with Perfect Forward Secrecy (PFS), disable obsolete SSL/TLS protocols and weak ciphers, and implement mutual TLS (mTLS)." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Email private encryption keys across unencrypted corporate chat channels." },
      { id: 'C', text: "Establish a formal key lifecycle policy governing generation (FIPS HSMs), access control, annual rotation, revocation, and cryptographic destruction." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Use a single master encryption key indefinitely without ever rotating it." },
      { id: 'C', text: "Generate encryption keys using predictable pseudo-random number generators seeded with timestamp zero." },
      { id: 'D', text: "Establish a formal key lifecycle policy governing generation (FIPS HSMs), access control, annual rotation, revocation, and cryptographic destruction." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Establish a formal key lifecycle policy governing generation (FIPS HSMs), access control, annual rotation, revocation, and cryptographic destruction. NIST SP 800-57 defines the cryptographic key lifecycle: Pre-operational (generation using approved entropy, distribution), Operational (active encryption/decryption, access control), Post-operational (archived for decryption of legacy data, rotation), and Destroyed (zeroized/shredded).",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Use a single master encryption key indefinitely without ever rotating it." },
      { id: 'D', text: "Email private encryption keys across unencrypted corporate chat channels." }
    ],
    correctAnswers: ['A'],
    type: "single",
