export const ISC2_CCSP_QUESTIONS_13 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enforce TLS 1.3 with Perfect Forward Secrecy (PFS), disable obsolete SSL/TLS protocols and weak ciphers, and implement mutual TLS (mTLS)." },
      ...
      { id: 'D', text: "Use static preshared keys transmitted in plaintext query parameters." }
    ],
    correctAnswers: ['A'],
    type: "single",
