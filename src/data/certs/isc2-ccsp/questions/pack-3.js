export const ISC2_CCSP_QUESTIONS_3 = [
  {
    id: "isc2-ccsp-51",
    difficulty: "easy",
    certId: "isc2-ccsp",
  ...
  },
  {
    ...
    title: "Federated identity management with SAML 2.0, OAuth 2.0, and OIDC: Operational Strategy (Part 52)",
    scenario: "A healthcare telemedicine network is evaluating Certified Cloud Security Professional practices specifically regarding Federated identity management with SAML 2.0, OAuth 2.0, and OIDC. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #52.",
  ...
  },
  {
    ...
    title: "Patch management, vulnerability assessment, and baseline drift auditing: Operational Strategy (Part 53)",
    scenario: "A high-throughput e-commerce retailer is evaluating Certified Cloud Security Professional practices specifically regarding Patch management, vulnerability assessment, and baseline drift auditing. The engineering group is implementing automated canary analysis with instant rollback capabilities triggered by error budget burn rates for service tier #53.",
  ...
  },
  {
    ...
    title: "Business impact analysis BIA and cloud financial economics: Operational Strategy (Part 55)",
    scenario: "An algorithmic trading exchange is evaluating Certified Cloud Security Professional practices specifically regarding Business impact analysis BIA and cloud financial economics. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #55.",
  ...
  },
  {
    ...
    title: "Secure cloud storage architectures object, block, volume, and ephemeral: Operational Strategy (Part 56)",
    scenario: "A logistics and supply chain optimization service is evaluating Certified Cloud Security Professional practices specifically regarding Secure cloud storage architectures object, block, volume, and ephemeral. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #56.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Cloud Platform and Infrastructure Security",
    title: "Container security and runtime isolation mechanisms: Operational Strategy (Part 57)",
    scenario: "An IoT industrial telematics infrastructure is evaluating Certified Cloud Security Professional practices specifically regarding Container security and runtime isolation mechanisms. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #57.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Cloud Application Security",
    title: "API security, rate limiting, and OWASP Top 10 API vulnerabilities: Operational Strategy (Part 58)",
    scenario: "A multi-tenant enterprise SaaS provider is evaluating Certified Cloud Security Professional practices specifically regarding API security, rate limiting, and OWASP Top 10 API vulnerabilities. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #58.",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Cloud Security Operations",
    title: "Security Information and Event Management SIEM in multi-cloud: Operational Strategy (Part 59)",
    scenario: "A public sector aerospace engineering department is evaluating Certified Cloud Security Professional practices specifically regarding Security Information and Event Management SIEM in multi-cloud. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #59.",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Legal, Risk and Compliance",
    title: "Electronic discovery eDiscovery and cross-border data transfer restrictions: Operational Strategy (Part 60)",
    scenario: "An automotive connected-vehicle fleet manager is evaluating Certified Cloud Security Professional practices specifically regarding Electronic discovery eDiscovery and cross-border data transfer restrictions. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #60.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts, Architecture and Design",
    title: "Cloud computing service models IaaS, PaaS, SaaS and shared responsibility: Operational Strategy (Part 61)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Cloud Data Security",
    title: "Cloud data lifecycle create, store, use, share, archive, destroy: Operational Strategy (Part 62)",
    scenario: "A pharmaceutical clinical trial data service is evaluating Certified Cloud Security Professional practices specifically regarding Cloud data lifecycle create, store, use, share, archive, destroy. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #62.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Cloud Platform and Infrastructure Security",
    title: "Hypervisor architecture Type 1 vs Type 2 and virtualization vulnerabilities: Operational Strategy (Part 63)",
    scenario: "A renewable energy smart-grid operator is evaluating Certified Cloud Security Professional practices specifically regarding Hypervisor architecture Type 1 vs Type 2 and virtualization vulnerabilities. The engineering group is implementing automated canary analysis with instant rollback capabilities triggered by error budget burn rates for service tier #63.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Cloud Application Security",
    title: "Secure Software Development Life Cycle SSDLC in cloud architectures: Operational Strategy (Part 64)",
    scenario: "A mobile gaming backend architecture is evaluating Certified Cloud Security Professional practices specifically regarding Secure Software Development Life Cycle SSDLC in cloud architectures. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #64.",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Cloud Security Operations",
    title: "Security operations center SOC continuous monitoring and alerting: Operational Strategy (Part 65)",
    scenario: "A ride-sharing dispatch system is evaluating Certified Cloud Security Professional practices specifically regarding Security operations center SOC continuous monitoring and alerting. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #65.",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Legal, Risk and Compliance",
    title: "International privacy laws including GDPR, CCPA, and HIPAA compliance: Operational Strategy (Part 66)",
    scenario: "An insurance claims processing engine is evaluating Certified Cloud Security Professional practices specifically regarding International privacy laws including GDPR, CCPA, and HIPAA compliance. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #66.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts, Architecture and Design",
    title: "Cloud deployment models public, private, hybrid, and community: Operational Strategy (Part 67)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Cloud Data Security",
    title: "Data discovery and classification methodologies in multi-tenant cloud: Operational Strategy (Part 68)",
    scenario: "A cybersecurity threat intelligence agency is evaluating Certified Cloud Security Professional practices specifically regarding Data discovery and classification methodologies in multi-tenant cloud. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #68.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Cloud Platform and Infrastructure Security",
    title: "Software-Defined Networking SDN security and micro-segmentation: Operational Strategy (Part 69)",
    scenario: "A real estate property management portal is evaluating Certified Cloud Security Professional practices specifically regarding Software-Defined Networking SDN security and micro-segmentation. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #69.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Cloud Application Security",
    title: "Application security testing comparing SAST, DAST, IAST, and SCA: Operational Strategy (Part 70)",
    scenario: "An autonomous robotics manufacturing facility is evaluating Certified Cloud Security Professional practices specifically regarding Application security testing comparing SAST, DAST, IAST, and SCA. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #70.",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Cloud Security Operations",
    title: "Cloud incident response triage, containment, and eradication: Operational Strategy (Part 71)",
    scenario: "A higher education student information system is evaluating Certified Cloud Security Professional practices specifically regarding Cloud incident response triage, containment, and eradication. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #71.",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Legal, Risk and Compliance",
    title: "SOC 1, SOC 2 Type II, and SOC 3 reporting and audit assertions: Operational Strategy (Part 72)",
    scenario: "A global hotel hospitality reservation platform is evaluating Certified Cloud Security Professional practices specifically regarding SOC 1, SOC 2 Type II, and SOC 3 reporting and audit assertions. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #72.",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Cloud Data Security",
    title: "Information Rights Management IRM and Digital Rights Management DRM: Operational Strategy (Part 74)",
    scenario: "A genomics sequencing data pipeline is evaluating Certified Cloud Security Professional practices specifically regarding Information Rights Management IRM and Digital Rights Management DRM. The engineering group must enforce zero-trust identity boundaries and cryptographic verification across all service endpoints for service tier #74.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Cloud Platform and Infrastructure Security",
    title: "Business continuity and disaster recovery BCDR strategies RTO and RPO: Operational Strategy (Part 75)",
    scenario: "A cloud-native telecommunications provider is evaluating Certified Cloud Security Professional practices specifically regarding Business continuity and disaster recovery BCDR strategies RTO and RPO. The engineering group needs to optimize cloud expenditure and implement real-time cost attribution across engineering teams for service tier #75.",
...
export default ISC2_CCSP_QUESTIONS_3;
