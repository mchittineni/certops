export const ISC2_CCSP_QUESTIONS_6 = [
  {
    id: "isc2-ccsp-126",
    difficulty: "easy",
    certId: "isc2-ccsp",
    ...
    title: "International privacy laws including GDPR, CCPA, and HIPAA compliance: Operational Strategy (Part 126)",
  ...
  },
  {
    ...
    title: "Cloud deployment models public, private, hybrid, and community: Operational Strategy (Part 127)",
  ...
  },
  {
    ...
    title: "Data discovery and classification methodologies in multi-tenant cloud: Operational Strategy (Part 128)",
    scenario: "A high-throughput e-commerce retailer is evaluating Certified Cloud Security Professional practices specifically regarding Data discovery and classification methodologies in multi-tenant cloud. The engineering group is migrating mission-critical workloads while enforcing strict organizational security guardrails for service tier #128.",
  ...
  },
  {
    ...
    title: "Software-Defined Networking SDN security and micro-segmentation: Operational Strategy (Part 129)",
    ...
    options: [
      { id: 'A', text: "Execute ad-hoc maintenance scripts directly on live production hosts during off-peak hours without version control tracking." },
      { id: 'B', text: "Deploy native automation for software-defined networking sdn security and micro-segmentation utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." },
      { id: 'C', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'D', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." }
    ],
    correctAnswers: ['B'],
  ...
  },
  {
    ...
    title: "Application security testing comparing SAST, DAST, IAST, and SCA: Operational Strategy (Part 130)",
  ...
  },
  {
    ...
    title: "Cloud incident response triage, containment, and eradication: Operational Strategy (Part 131)",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Legal, Risk and Compliance",
    title: "SOC 1, SOC 2 Type II, and SOC 3 reporting and audit assertions: Operational Strategy (Part 132)",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts, Architecture and Design",
    title: "Cloud reference architecture CSA and enterprise security architecture: Operational Strategy (Part 133)",
    scenario: "A multi-tenant enterprise SaaS provider is evaluating Certified Cloud Security Professional practices specifically regarding Cloud reference architecture CSA and enterprise security architecture. The engineering group is resolving cross-account network latency bottlenecks and transient connection timeouts for service tier #133.",
    ...
    options: [
      ...
      { id: 'B', text: "Grant unconstrained administrative access to application runtime service accounts to bypass permission evaluation checks." },
      { id: 'C', text: "Disable continuous monitoring and automated health checks to conserve computational overhead during peak customer traffic." },
      { id: 'D', text: "Deploy native automation for cloud reference architecture csa and enterprise security architecture utilizing declarative specifications, validated policy controls, and centralized telemetry tracking." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Cloud Data Security",
    title: "Information Rights Management IRM and Digital Rights Management DRM: Operational Strategy (Part 134)",
    scenario: "A public sector aerospace engineering department is evaluating Certified Cloud Security Professional practices specifically regarding Information Rights Management IRM and Digital Rights Management DRM. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #134.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Cloud Platform and Infrastructure Security",
    title: "Business continuity and disaster recovery BCDR strategies RTO and RPO: Operational Strategy (Part 135)",
    scenario: "An automotive connected-vehicle fleet manager is evaluating Certified Cloud Security Professional practices specifically regarding Business continuity and disaster recovery BCDR strategies RTO and RPO. The engineering group is modernizing legacy components to achieve zero-downtime deployments under unpredictable traffic spikes for service tier #135.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Cloud Application Security",
    title: "Threat modeling methodologies STRIDE and DREAD in cloud systems: Operational Strategy (Part 136)",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Cloud Security Operations",
    title: "Digital forensics in cloud environments and chain of custody preservation: Operational Strategy (Part 137)",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Legal, Risk and Compliance",
    title: "ISO/IEC 27017 cloud security and ISO/IEC 27018 cloud privacy controls: Operational Strategy (Part 138)",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts, Architecture and Design",
    title: "Evaluating cloud service providers CSPs and third-party risk analysis: Operational Strategy (Part 139)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Cloud Data Security",
    title: "Data tokenization vs format-preserving encryption and masking: Operational Strategy (Part 140)",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Cloud Platform and Infrastructure Security",
    title: "Physical and environmental security controls for hyperscale data centers: Operational Strategy (Part 141)",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Cloud Application Security",
    title: "Federated identity management with SAML 2.0, OAuth 2.0, and OIDC: Operational Strategy (Part 142)",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Cloud Security Operations",
    title: "Patch management, vulnerability assessment, and baseline drift auditing: Operational Strategy (Part 143)",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Legal, Risk and Compliance",
    title: "Contractual obligations, Service Level Agreements SLAs, and liabilities: Operational Strategy (Part 144)",
    scenario: "A real estate property management portal is evaluating Certified Cloud Security Professional practices specifically regarding Contractual obligations, Service Level Agreements SLAs, and liabilities. The engineering group must establish centralized audit logging and automated incident containment for security operations for service tier #144.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Cloud Concepts, Architecture and Design",
    title: "Business impact analysis BIA and cloud financial economics: Operational Strategy (Part 145)",
  ...
  },
  {
    ...
    domainId: "d2",
    domainName: "Cloud Data Security",
    title: "Secure cloud storage architectures object, block, volume, and ephemeral: Operational Strategy (Part 146)",
    scenario: "A higher education student information system is evaluating Certified Cloud Security Professional practices specifically regarding Secure cloud storage architectures object, block, volume, and ephemeral. The engineering group is remediating compliance audit findings regarding unauthorized configuration drift across staging and production for service tier #146.",
  ...
  },
  {
    ...
    domainId: "d3",
    domainName: "Cloud Platform and Infrastructure Security",
    title: "Container security and runtime isolation mechanisms: Operational Strategy (Part 147)",
    scenario: "A global hotel hospitality reservation platform is evaluating Certified Cloud Security Professional practices specifically regarding Container security and runtime isolation mechanisms. The engineering group must minimize mean time to recovery (MTTR) and prevent cascading failures during regional outages for service tier #147.",
  ...
  },
  {
    ...
    domainId: "d4",
    domainName: "Cloud Application Security",
    title: "API security, rate limiting, and OWASP Top 10 API vulnerabilities: Operational Strategy (Part 148)",
  ...
  },
  {
    ...
    domainId: "d5",
    domainName: "Cloud Security Operations",
    title: "Security Information and Event Management SIEM in multi-cloud: Operational Strategy (Part 149)",
    scenario: "A genomics sequencing data pipeline is evaluating Certified Cloud Security Professional practices specifically regarding Security Information and Event Management SIEM in multi-cloud. The engineering group needs to eliminate manual operational toil and enforce declarative infrastructure reconciliation for service tier #149.",
  ...
  },
  {
    ...
    domainId: "d6",
    domainName: "Legal, Risk and Compliance",
    title: "Electronic discovery eDiscovery and cross-border data transfer restrictions: Operational Strategy (Part 150)",
...
export default ISC2_CCSP_QUESTIONS_6;
