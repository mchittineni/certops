export const ISC2_CCSP_QUESTIONS_17 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Allow developers to download and execute arbitrary public scripts directly in production without vetting." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable dependency checking to accelerate build completion times." },
      ...
      { id: 'D', text: "Assume open-source packages hosted on public repositories are thoroughly vetted and safe." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Deploy Software Composition Analysis (SCA) to continuously audit open-source dependencies and generate Software Bills of Materials (SBOMs). Modern applications are composed of up to 90% third-party open-source libraries. Software Composition Analysis (SCA) identifies known vulnerabilities (CVEs) and restrictive licenses across dependency trees, while SBOMs (SPDX/CycloneDX) provide transparent provenance for compliance.",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy Software Composition Analysis (SCA) to continuously audit open-source dependencies and generate Software Bills of Materials (SBOMs)." },
      { id: 'B', text: "Allow developers to download and execute arbitrary public scripts directly in production without vetting." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy Software Composition Analysis (SCA) to continuously audit open-source dependencies and generate Software Bills of Materials (SBOMs)." },
      { id: 'C', text: "Assume open-source packages hosted on public repositories are thoroughly vetted and safe." },
      { id: 'D', text: "Allow developers to download and execute arbitrary public scripts directly in production without vetting." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Deploy Software Composition Analysis (SCA) to continuously audit open-source dependencies and generate Software Bills of Materials (SBOMs). Modern applications are composed of up to 90% third-party open-source libraries. Software Composition Analysis (SCA) identifies known vulnerabilities (CVEs) and restrictive licenses across dependency trees, while SBOMs (SPDX/CycloneDX) provide transparent provenance for compliance.",
  ...
  },
  {
    ...
    question: "Which architectural approach or cloud security control satisfies these enterprise governance objectives?",
    options: [
      { id: 'A', text: "Conduct a threat modeling exercise using the STRIDE methodology across application data flow diagrams (DFDs)." },
      ...
      { id: 'D', text: "Rely solely on automated network port scans to identify software design weaknesses." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which infrastructure security design or platform control prevents unauthorized lateral movement and hypervisor compromise?",
    options: [
      { id: 'A', text: "Wait until after production launch to discover architectural security flaws." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Assume cloud infrastructure eliminates all application-level threat vectors." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Conduct a threat modeling exercise using the STRIDE methodology across application data flow diagrams (DFDs). Threat modeling identifies design flaws before code is written. Using the STRIDE framework (Spoofing, Tampering, Repudiation, Information Disclosure, Denial of Service, Elevation of Privilege) mapped across Data Flow Diagrams, teams implement mitigations (authentication, integrity, encryption) proactively.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Wait until after production launch to discover architectural security flaws." },
      { id: 'D', text: "Conduct a threat modeling exercise using the STRIDE methodology across application data flow diagrams (DFDs)." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which architectural approach or cloud security control satisfies these enterprise governance objectives?",
    options: [
      { id: 'A', text: "Pass unencrypted user passwords in HTTP GET query strings for all API requests." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Accept unsigned JWT tokens with `alg: none` to simplify token parsing." },
      { id: 'D', text: "Use static, unexpiring API keys shared across all mobile application users." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Implement an API Gateway enforcing OAuth 2.0 authorization code flow with PKCE, validating cryptographic JWT signatures, and rate limiting. API security requires defense-in-depth: an API Gateway authenticates requests via OAuth 2.0 (Authorization Code with PKCE for public clients), validates JWT signatures and claims (issuer, audience, expiration), and applies per-client rate limiting to prevent denial of service.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Pass unencrypted user passwords in HTTP GET query strings for all API requests." },
      { id: 'C', text: "Use static, unexpiring API keys shared across all mobile application users." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Store administrative passwords in unencrypted text files on local developer desktops." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Store administrative passwords in unencrypted text files on local developer desktops." },
      { id: 'B', text: "Use a centralized cloud secrets manager (e.g., HashiCorp Vault, AWS Secrets Manager) providing short-lived, dynamically rotated credentials." },
  ...
  },
  {
    ...
    question: "Which architectural approach or cloud security control satisfies these enterprise governance objectives?",
    options: [
      { id: 'A', text: "Rely on security analysts to manually inspect raw log files across 50 disconnected cloud dashboards." },
      ...
      { id: 'C', text: "Disable event correlation and evaluate each alert in complete isolation." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Rely on security analysts to manually inspect raw log files across 50 disconnected cloud dashboards." },
      { id: 'B', text: "Disable event correlation and evaluate each alert in complete isolation." },
  ...
  },
  {
    ...
    question: "Which infrastructure security design or platform control prevents unauthorized lateral movement and hypervisor compromise?",
    options: [
      { id: 'A', text: "Deploy a cloud-native SIEM/SOAR platform that ingests multi-source telemetry, correlates threat indicators, and triggers automated playbooks." },
