export const GCP_PCA_QUESTIONS_1 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Shared VPC with a central host project" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Autoscale on Pub/Sub backlog depth per instance" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "BigQuery separates Dremel compute from Colossus storage over the Jupiter fabric" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Four interconnects across two colocation facilities and two regions" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A dual-region bucket across two European regions" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "VPC peering is non-transitive, so A cannot reach C through B" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A private GKE cluster with master authorized networks" }
    ],
    correctAnswers: ['D'],
    type: "single",
