export const GCP_PCA_QUESTIONS_1 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Cloud SQL for PostgreSQL with read replicas" },
      { id: 'C', text: "Cloud Bigtable with multi-cluster routing" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud SQL for MySQL with autoincrement integer primary key" },
      { id: 'B', text: "Cloud Bigtable with row key format: meterId#reversedTimestamp" },
      { id: 'C', text: "Cloud Bigtable with row key format: timestamp#meterId" },
      { id: 'D', text: "Firestore with timestamp as document ID" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Cloud Run for Anthos alone" },
      { id: 'C', text: "GKE Autopilot" },
      { id: 'D', text: "GKE Standard with manual node pools" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Internal Passthrough Network Load Balancer" },
      { id: 'B', text: "External Network Load Balancer (Proxy)" },
      { id: 'C', text: "Regional External Application Load Balancer" },
      { id: 'D', text: "Global External Application Load Balancer (HTTP/S)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "HA VPN over internet" },
      { id: 'B', text: "Cloud Router with BGP alone" },
      { id: 'C', text: "Dedicated Interconnect" },
      { id: 'D', text: "Partner Interconnect" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud VPN tunnels between every project" },
      { id: 'B', text: "Serverless VPC Access connectors" },
      { id: 'C', text: "Shared VPC (with a central Host Project and connected Service Projects)" },
      { id: 'D', text: "VPC Network Peering mesh across 20 projects" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Nearline Storage" },
      { id: 'B', text: "Standard Storage" },
      { id: 'C', text: "Archive Storage" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Set a fixed static instance count" },
      { id: 'B', text: "Autoscale based on HTTP load balancing serving capacity" },
      { id: 'C', text: "Autoscale based on average CPU utilization target 60%" },
      { id: 'D', text: "Configure autoscaling based on a Cloud Monitoring metric (Pub/Sub subscription backlog depth per instance)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "BigQuery separates compute (dynamic Dremel query engine with worker slots) from storage (Colossus distributed filesystem) over Jupiter multi-terabit network fabric" },
      { id: 'B', text: "BigQuery stores all table data in local VM RAM disks attached to Compute Engine" },
      { id: 'C', text: "BigQuery requires provisioning fixed SSD persistent disks for each table" },
      { id: 'D', text: "BigQuery executes all queries inside Cloud Functions serverless containers" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Cloud Run" },
      { id: 'D', text: "Google Kubernetes Engine Standard with manual scaling" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Firestore in Native Mode" },
      { id: 'D', text: "Firestore in Datastore Mode" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Projects -> Folders -> Organization -> Resources" },
      { id: 'C', text: "Organization -> Projects -> Folders -> Resources" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Pub/Sub Lite" },
      { id: 'C', text: "Cloud Pub/Sub (Standard)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A single 100 Gbps Dedicated Interconnect circuit" },
      { id: 'B', text: "Four interconnects across two distinct colocation facilities (metropolitan areas) with redundant Cloud Routers in two GCP regions" },
      { id: 'C', text: "A single Dedicated Interconnect paired with an IPSec VPN backup" },
      { id: 'D', text: "Two interconnects in a single colocation facility with one Cloud Router" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Storage Archive tier" },
      { id: 'B', text: "Single-Region bucket in europe-west3 with nightly sync" },
      { id: 'C', text: "Multi-Region EU bucket" },
      { id: 'D', text: "Dual-Region bucket pairing two specific European regions (e.g. europe-west3 and europe-west1)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Cloud Bigquery ML" },
      { id: 'C', text: "Cloud Dataflow" },
      { id: 'D', text: "Cloud Dataprep" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Local SSD alone" },
      { id: 'B', text: "Standard Persistent Disk (pd-standard)" },
      { id: 'C', text: "Extreme Persistent Disk (pd-extreme)" },
      { id: 'D', text: "Balanced Persistent Disk (pd-balanced)" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Local SSD (nvme)" },
      { id: 'B', text: "SSD Persistent Disk (pd-ssd)" },
      { id: 'C', text: "Extreme Persistent Disk (pd-extreme)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Router alone" },
      { id: 'B', text: "Cloud NAT (Network Address Translation)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Cloud NAT with external IPs" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "VPC Network Peering is non-transitive; traffic from VPC A cannot transit VPC B to reach VPC C" },
      { id: 'B', text: "VPC Network Peering requires Cloud NAT to route across networks" },
      { id: 'C', text: "Transitive peering is allowed only on weekends" },
      { id: 'D', text: "VPC Peering requires all networks to have identical CIDR ranges" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Chronicle SIEM" },
      { id: 'D', text: "Security Command Center alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Bigtable" },
      { id: 'B', text: "Cloud Spanner" },
      { id: 'C', text: "Cloud Memorystore for Redis" },
      { id: 'D', text: "Cloud Memorystore for Memcached" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy GKE in public mode and attach an external Cloud NAT" },
      { id: 'B', text: "Use Cloud Armor on the GKE kubelet port" },
      { id: 'C', text: "Enable GKE Private Cluster and configure Master Authorized Networks with the corporate CIDR" },
      { id: 'D', text: "Disable VPC native routing and enable public NodePools" }
    ],
    correctAnswers: ['C'],
    type: "single",
