export const GCP_PCA_QUESTIONS_1 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Bigtable with row key format: meterId#reversedTimestamp" },
      { id: 'B', text: "Cloud SQL for MySQL with autoincrement integer primary key" },
      { id: 'C', text: "Firestore with timestamp as document ID" },
      { id: 'D', text: "Cloud Bigtable with row key format: timestamp#meterId" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "GKE Standard with manual node pools" },
      { id: 'C', text: "Compute Engine Managed Instance Groups" },
      { id: 'D', text: "Cloud Run for Anthos alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Global External Application Load Balancer (HTTP/S)" },
      { id: 'B', text: "Regional External Application Load Balancer" },
      { id: 'C', text: "External Network Load Balancer (Proxy)" },
      { id: 'D', text: "Internal Passthrough Network Load Balancer" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "HA VPN over internet" },
      { id: 'D', text: "Cloud Router with BGP alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Shared VPC with a central host project" },
      { id: 'B', text: "VPC Network Peering mesh across 20 projects" },
      { id: 'C', text: "Cloud VPN tunnels between every project" },
      { id: 'D', text: "Serverless VPC Access connectors" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Autoscale on Pub/Sub backlog depth per instance" },
      { id: 'B', text: "Autoscale based on average CPU utilization target 60%" },
      { id: 'C', text: "Autoscale based on HTTP load balancing serving capacity" },
      { id: 'D', text: "Set a fixed static instance count" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "BigQuery separates Dremel compute from Colossus storage over the Jupiter fabric" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Google Kubernetes Engine Standard with manual scaling" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A primary and standby in separate zones, synchronously replicated" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Firestore in Native Mode" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Pub/Sub (Standard)" },
      { id: 'B', text: "Cloud Tasks" },
      { id: 'C', text: "Pub/Sub Lite" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Two interconnects in a single colocation facility with one Cloud Router" },
      { id: 'B', text: "A single 100 Gbps Dedicated Interconnect circuit" },
      { id: 'C', text: "A single Dedicated Interconnect paired with an IPSec VPN backup" },
      { id: 'D', text: "Four interconnects across two colocation facilities and two regions" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A dual-region bucket across two European regions" },
      { id: 'B', text: "Multi-Region EU bucket" },
      { id: 'C', text: "Single-Region bucket in europe-west3 with nightly sync" },
      { id: 'D', text: "Cloud Storage Archive tier" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Cloud Dataprep" },
      { id: 'C', text: "Cloud Dataproc" },
      { id: 'D', text: "Cloud Bigquery ML" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Balanced Persistent Disk (pd-balanced)" },
      { id: 'B', text: "Standard Persistent Disk (pd-standard)" },
      { id: 'C', text: "Local SSD alone" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud NAT (Network Address Translation)" },
      { id: 'B', text: "Cloud Router alone" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud NAT with external IPs" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "VPC peering is non-transitive, so A cannot reach C through B" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Memorystore for Redis" },
      { id: 'B', text: "Cloud Memorystore for Memcached" },
      { id: 'C', text: "Cloud Bigtable" },
      { id: 'D', text: "Cloud Spanner" }
    ],
    correctAnswers: ['A'],
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A private GKE cluster with master authorized networks" },
      { id: 'B', text: "Disable VPC native routing and enable public NodePools" },
      { id: 'C', text: "Deploy GKE in public mode and attach an external Cloud NAT" },
      { id: 'D', text: "Use Cloud Armor on the GKE kubelet port" }
    ],
    correctAnswers: ['A'],
    type: "single",
