export const GCP_PCA_QUESTIONS_5 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Router accepts unbounded routes without limits" },
      { id: 'B', text: "Google Cloud billing charges $1 per route automatically" },
      { id: 'C', text: "Cloud Router drops excess routes or resets the session" },
      { id: 'D', text: "All GCP projects in the organization are deleted" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It can be unlocked by opening a Google Support ticket" },
      { id: 'B', text: "It unlocks automatically after 30 days" },
      { id: 'C', text: "It can be removed by project Owners with the storage.admin role" },
      { id: 'D', text: "It is irreversible and cannot be removed or shortened" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "High Availability mode" },
      { id: 'B', text: "Enable Automatic Storage Increase" },
      { id: 'C', text: "Enable storage tiered caching" },
      { id: 'D', text: "Automated storage compaction" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Multipart Upload in a single HTTP stream" },
      { id: 'C', text: "Signed URLs with POST" },
      { id: 'D', text: "Simple Upload" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Guest Attributes" },
      { id: 'B', text: "Instance Metadata (read-only from inside guest)" },
      { id: 'C', text: "Cloud Logging alone" },
      { id: 'D', text: "Serial Console Port 1" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "BGP Graceful Restart" },
      { id: 'B', text: "BGP Fast Reroute" },
      { id: 'C', text: "Bidirectional Forwarding Detection (BFD)" },
      { id: 'D', text: "Static failover" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Customer-Managed Encryption Keys (CMEK) via Cloud KMS" },
      { id: 'B', text: "Default Google-Managed Encryption (GMK)" },
      { id: 'C', text: "Customer-Supplied Encryption Keys (CSEK) only" },
      { id: 'D', text: "Client-side encryption using PGP scripts" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The disk can be decrypted by the Organization Administrator" },
      { id: 'B', text: "Google Cloud Support can decrypt the data from internal recovery logs" },
      { id: 'C', text: "Google cannot recover the key; all data on the disk is permanently and irrecoverably lost" },
      { id: 'D', text: "The data is converted to Google-managed keys automatically" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud External Key Manager (Cloud EKM)" },
      { id: 'B', text: "Cloud KMS Software Keys" },
      { id: 'C', text: "Cloud HSM (Google-hosted)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "VPC Service Controls (Service Perimeter)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Container Analysis alone" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Security Command Center Premium tier" },
      { id: 'B', text: "Security Command Center Standard tier" },
      { id: 'C', text: "Cloud Monitoring basic tier" },
      { id: 'D', text: "Cloud Asset Inventory alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "System Event logs" },
      { id: 'B', text: "Admin Activity audit logs" },
      { id: 'C', text: "VPC Flow Logs" },
      { id: 'D', text: "Data Access audit logs (DATA_READ and DATA_WRITE)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Access Approval" },
      { id: 'B', text: "Access Transparency" },
      { id: 'C', text: "VPC Service Controls" },
      { id: 'D', text: "Cloud IAM Privileged Access" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Service account impersonation" },
