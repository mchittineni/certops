export const GCP_PCA_QUESTIONS_14 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Assign public IP addresses directly to all virtual machines." },
      { id: 'D', text: "Deploy Cloud NAT configured on the Cloud Router associated with the subnet." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Deploy Cloud NAT configured on the Cloud Router associated with the subnet. Cloud NAT (Network Address Translation) is a fully managed, software-defined service that enables instances without external IP addresses to access the internet for updates and downloads, while preventing external hosts from initiating inbound connections to the private instances.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Use DNS round-robin routing to advertise on-premises subnets." },
      { id: 'D', text: "Deploy Google Cloud Router and establish Border Gateway Protocol (BGP) sessions with on-premises routers." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Edit local /etc/network/interfaces files on individual virtual machines." },
      { id: 'C', text: "Configure static routes manually in the Google Cloud Console for every on-premises subnet." },
      { id: 'D', text: "Deploy Google Cloud Router and establish Border Gateway Protocol (BGP) sessions with on-premises routers." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Configure static routes manually in the Google Cloud Console for every on-premises subnet." },
      { id: 'B', text: "Edit local /etc/network/interfaces files on individual virtual machines." },
      { id: 'C', text: "Deploy Google Cloud Router and establish Border Gateway Protocol (BGP) sessions with on-premises routers." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Use DNS round-robin routing to advertise on-premises subnets." },
      { id: 'D', text: "Edit local /etc/network/interfaces files on individual virtual machines." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Deploy Google Cloud Router and establish Border Gateway Protocol (BGP) sessions with on-premises routers. Google Cloud Router uses Border Gateway Protocol (BGP) to dynamically exchange routes between your Google Cloud VPC network and on-premises networks. If a link fails, BGP automatically updates route tables within seconds without manual intervention.",
  ...
  },
  {
    ...
    question: "Which concept or service configuration satisfies these operational resilience objectives?",
    options: [
      { id: 'A', text: "Manually deploy single virtual machines in two separate regions." },
      { id: 'B', text: "Host the application on an unmanaged local physical server." },
      { id: 'C', text: "Deploy a regional managed instance group across zones." },
      { id: 'D', text: "Deploy a Zonal Managed Instance Group in zone-a only." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy a regional managed instance group across zones." },
      { id: 'B', text: "Manually deploy single virtual machines in two separate regions." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Create a standard multi-region bucket without replication SLAs." },
      { id: 'D', text: "Schedule an hourly cron job on a VM to rsync files between regional buckets." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Schedule an hourly cron job on a VM to rsync files between regional buckets." },
      { id: 'B', text: "Write a custom Python script that downloads and re-uploads objects sequentially." },
      { id: 'C', text: "Create a Dual-Region Cloud Storage bucket with Turbo Replication enabled." },
      { id: 'D', text: "Create a standard multi-region bucket without replication SLAs." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Create a Dual-Region Cloud Storage bucket with Turbo Replication enabled. Cloud Storage Turbo Replication provides an SLA-backed guarantee that 100% of newly written objects are replicated to a secondary paired region within 15 minutes, meeting strict business continuity and disaster recovery compliance requirements.",
  ...
  },
  {
    ...
    question: "Which design pattern or service configuration eliminates operational bottlenecks and delivers automated management?",
    options: [
      { id: 'A', text: "Write a custom Python script that downloads and re-uploads objects sequentially." },
      { id: 'B', text: "Schedule an hourly cron job on a VM to rsync files between regional buckets." },
      { id: 'C', text: "Create a standard multi-region bucket without replication SLAs." },
      { id: 'D', text: "Create a Dual-Region Cloud Storage bucket with Turbo Replication enabled." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Create a Dual-Region Cloud Storage bucket with Turbo Replication enabled. Cloud Storage Turbo Replication provides an SLA-backed guarantee that 100% of newly written objects are replicated to a secondary paired region within 15 minutes, meeting strict business continuity and disaster recovery compliance requirements.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Deploy a private GKE cluster with master authorized networks." },
      { id: 'C', text: "Assign external public IP addresses to all GKE node pool instances." },
  ...
  },
  {
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Assign external public IP addresses to all GKE node pool instances." },
