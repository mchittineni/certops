export const GCP_PCA_QUESTIONS_10 = [
  {
    ...
    certId: "gcp-pca",
    domainId: "d6",
    domainName: "Ensuring solution and operations excellence",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Distribution metrics for both requirements" },
      { id: 'B', text: "Distribution metric for errors; Counter metric for latencies" },
      { id: 'C', text: "A counter for errors; a distribution for latency percentiles" },
      { id: 'D', text: "Counter metrics for both requirements" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Log Exclusion Filters on the _Default log sink" },
      { id: 'B', text: "Deleting logs manually after ingestion" },
      { id: 'C', text: "VPC Firewall Rules" },
      { id: 'D', text: "Cloud Trace exclusion rules" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A metric absence condition" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Action Groups (Azure term)" },
      { id: 'B', text: "Log Sinks" },
      { id: 'C', text: "Alert Routing Tables" },
      { id: 'D', text: "Notification channels" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Profiler" },
      { id: 'B', text: "Cloud Error Reporting" },
      { id: 'C', text: "Cloud Trace" },
      { id: 'D', text: "Cloud Logging standard viewer alone" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enhanced Support (1 hour P1 response, no TAM)" },
      { id: 'B', text: "Basic Support (free billing support only)" },
      { id: 'C', text: "Standard Support (4 hour P1 response)" },
      { id: 'D', text: "Premium Support" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Twitter/X social media feeds" },
      { id: 'B', text: "Personalized Service Health (in the Google Cloud console)" },
      { id: 'C', text: "Public Google Cloud Status Dashboard (status.cloud.google.com)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "SQL-92 alone" },
      { id: 'B', text: "MQL or PromQL" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Maximum instance count" },
      { id: 'C', text: "Scale-in control alone" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "kubectl drain (with graceful termination periods)" },
      { id: 'B', text: "kubectl delete node immediately" },
      { id: 'C', text: "kubectl cordon alone" },
      { id: 'D', text: "kubectl scale deployment --replicas=0" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "HorizontalPodAutoscaler" },
      { id: 'B', text: "PodDisruptionBudget (PDB)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In VPC Subnet properties" },
      { id: 'B', text: "In Cloud Logging Log Buckets (retentionDays setting)" },
      { id: 'C', text: "In Cloud Storage lifecycle rules alone" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Cloud Monitoring Custom Dashboards" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Readiness gates endpoints; liveness restarts the pod" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "MQL query timeout" },
      { id: 'B', text: "Incident Auto-Close Duration" },
      { id: 'C', text: "Notification Channel interval" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The SPANNER_SYS statistics tables" },
      { id: 'B', text: "Cloud Logging standard logs alone" },
      { id: 'C', text: "Compute Engine metrics" },
      { id: 'D', text: "BigQuery information schema alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
