export const GCP_PCA_QUESTIONS_18 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable network caching on all servers." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploy physical satellite links between regional offices." },
      { id: 'B', text: "Disable network caching on all servers." },
      { id: 'C', text: "Standard Tier for downloads, Premium Tier for the APIs." },
  ...
  },
  {
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Recreate the analytical dataset inside a single-node MySQL database." },
      { id: 'B', text: "Pre-calculate all dashboard queries manually every morning." },
      { id: 'C', text: "Allocate BigQuery BI Engine reservation capacity." },
      { id: 'D', text: "Export data to local Excel spreadsheets for executive review." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Allocate BigQuery BI Engine reservation capacity to accelerate dashboard queries in-memory. BigQuery BI Engine is a fast, in-memory analysis service built directly into BigQuery. By allocating a BI Engine memory reservation, queries from Looker, Power BI, Tableau, or custom apps run in sub-second response times by caching frequently used table columns in RAM.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Allow unmetered on-demand query execution across all developer accounts." },
  ...
  },
  {
    ...
    question: "Which solution properly implements these mandatory security and governance controls?",
    options: [
      { id: 'A', text: "Migrate data to an unmanaged CSV flat file storage system." },
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Force all workloads to run exclusively on on-premises physical blade servers." },
      { id: 'B', text: "Rewrite application code specifically for each individual cloud vendor SDK." },
      { id: 'C', text: "Manage each cloud platform independently using disparate proprietary management tools." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Force all workloads to run exclusively on on-premises physical blade servers." },
      { id: 'B', text: "Implement Google Cloud Distributed Cloud (formerly Anthos) with Anthos Config Management." },
      { id: 'C', text: "Rewrite application code specifically for each individual cloud vendor SDK." },
      { id: 'D', text: "Manage each cloud platform independently using disparate proprietary management tools." }
    ],
    correctAnswers: ['B'],
    type: "single",
    explanation: "Implement Google Cloud Distributed Cloud (formerly Anthos) with Anthos Config Management. Google Cloud Distributed Cloud (Anthos) is a hybrid and multi-cloud management platform. It extends Google Cloud services and engineering practices to on-premises datacenters and other public clouds, enabling consistent Kubernetes management, centralized configuration, and unified service mesh observability.",
  ...
  },
  {
    ...
    question: "Which principle or solution enables the enterprise to achieve these cloud migration goals?",
    options: [
      { id: 'A', text: "Rewrite application code specifically for each individual cloud vendor SDK." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Require operations staff to manually apply Kubernetes YAML files after business hours." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which architectural approach should the team select to manage this demand efficiently?",
    options: [
      { id: 'A', text: "Run Jenkins on a Compute Engine VM that polls the repository for changes." },
      { id: 'B', text: "Compile software binaries manually on developer laptops and copy via SCP to production servers." },
      { id: 'C', text: "Configure a Cloud Build trigger linked to the Git repository executing a cloudbuild.yaml pipeline." },
      { id: 'D', text: "Require operations staff to manually apply Kubernetes YAML files after business hours." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Run Jenkins on a Compute Engine VM that polls the repository for changes." },
      { id: 'B', text: "Configure a Cloud Build trigger linked to the Git repository executing a cloudbuild.yaml pipeline." },
      { id: 'C', text: "Require operations staff to manually apply Kubernetes YAML files after business hours." },
