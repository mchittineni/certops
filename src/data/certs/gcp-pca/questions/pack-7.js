export const GCP_PCA_QUESTIONS_7 = [
  {
    ...
    options: [
      { id: 'A', text: "The GKE cluster cannot connect to the internet" },
      { id: 'B', text: "Kubernetes API commands take 10x longer to execute" },
      { id: 'C', text: "Every pod shares the node's permissions" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Existing objects keep version 1; new uploads use version 2" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Default infoTypes" },
      { id: 'B', text: "Cloud KMS Keys" },
      { id: 'C', text: "Custom infoTypes (Stored infoTypes)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Storage CSV export alone" },
      { id: 'B', text: "Cloud Billing export to BigQuery" },
      { id: 'C', text: "Cloud Monitoring billing dashboard alone" },
      { id: 'D', text: "Cloud Billing PDF invoice download" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Active Assist (Recommender API)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cold Standby with nightly backup restoration" },
      { id: 'B', text: "Automated backup exports to tape" },
      { id: 'C', text: "Warm Standby (Pilot Light) with minimal instances" },
      { id: 'D', text: "Hot multi-region active-active deployment" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hot Standby (Active-Active)" },
      { id: 'B', text: "Multi-Cloud Mirroring" },
      { id: 'C', text: "Cold Standby (Backup and Restore)" },
      { id: 'D', text: "Warm Standby (Pilot Light)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "SLA is 5 minutes; SLO is 30 minutes" },
      { id: 'B', text: "RTO is 5 minutes; RPO is 30 minutes" },
      { id: 'C', text: "RPO is 5 minutes; RTO is 30 minutes" },
      { id: 'D', text: "MTTR is 5 minutes; MTTF is 30 minutes" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Build alone" },
      { id: 'B', text: "Cloud Composer" },
      { id: 'C', text: "Google Cloud Deploy" },
      { id: 'D', text: "Artifact Registry" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Compute Engine local repository" },
      { id: 'B', text: "Container Registry (gcr.io legacy)" },
      { id: 'C', text: "Google Cloud Artifact Registry" },
      { id: 'D', text: "Cloud Storage public bucket" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Elimination of automated testing" },
      { id: 'C', text: "Lowest infrastructure compute cost during rollouts" },
      { id: 'D', text: "Simultaneous multi-master database schema changes" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "In-place database replacement" },
      { id: 'C', text: "Recreate Deployment" },
      { id: 'D', text: "Canary with weighted traffic" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Billing Subaccounts" },
      { id: 'B', text: "Multiple Google Workspace domains" },
      { id: 'C', text: "Separate IAM organizations for each project" },
      { id: 'D', text: "Prepaid debit cards per project" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "SLI is measured, SLO is the internal target, SLA the contract" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Ignore the error budget and continue releasing features" },
      { id: 'B', text: "Halt feature releases and spend the effort on reliability" },
      { id: 'C', text: "Terminate the on-call engineers" },
      { id: 'D', text: "Lower the SLO to 99.0% immediately" }
    ],
    correctAnswers: ['B'],
    type: "single",
