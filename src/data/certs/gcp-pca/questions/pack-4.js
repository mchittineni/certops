export const GCP_PCA_QUESTIONS_4 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Service accounts can only be used on Windows VMs" },
      { id: 'B', text: "Instance admins can change network tags" },
      { id: 'C', text: "Network tags support only UDP traffic" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "VPC Packet Mirroring" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Compute Engine Activity Logs" },
      { id: 'B', text: "Packet Mirroring" },
      { id: 'C', text: "VPC Flow Logs" },
      { id: 'D', text: "Cloud Audit Logs" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The gcs backend with versioning enabled" },
      { id: 'B', text: "Public GitHub repository" },
      { id: 'C', text: "Compute Engine metadata" },
      { id: 'D', text: "Local terraform.tfstate on developer laptops" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Helm Package Manager" },
      { id: 'B', text: "Anthos Service Mesh" },
      { id: 'C', text: "Config Connector" },
      { id: 'D', text: "KEDA" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In instance metadata under startup-script" },
      { id: 'B', text: "In the Google Cloud console notification settings" },
      { id: 'C', text: "In Cloud DNS TXT records" },
      { id: 'D', text: "In the VM /boot directory on persistent disk" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Nested Virtualization" },
      { id: 'B', text: "Confidential Computing" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Custom Machine Type" },
      { id: 'C', text: "Instance Template alone (without machine image)" },
      { id: 'D', text: "Custom Disk Snapshot alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A Serverless VPC Access connector" },
      { id: 'B', text: "Cloud NAT" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Spanner Built-in Backup and Restore" },
      { id: 'B', text: "Export to Cloud Storage via Dataflow (Avro format)" },
      { id: 'C', text: "Copying table data with SQL INSERT queries" },
      { id: 'D', text: "Nightly disk snapshots" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Point-in-time recovery" },
      { id: 'B', text: "Database backups taken last night" },
      { id: 'C', text: "Change Streams alone" },
      { id: 'D', text: "Cloud Storage Versioning" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Key Visualizer" },
      { id: 'B', text: "Cloud Monitoring Metrics Explorer" },
      { id: 'C', text: "Bigtable Query Optimizer" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Local SSD data migrates with the VM and is preserved" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The data is retained until the VM is restarted" },
      { id: 'B', text: "The Local SSD data is backed up to Cloud Storage automatically" },
      { id: 'C', text: "The Local SSD remains attached to the project" },
      { id: 'D', text: "The data is permanently discarded and cannot be recovered" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Bigtable Autoscaling" },
      { id: 'B', text: "Compute Engine Autoscaler" },
      { id: 'C', text: "Cloud Monitoring Alert with Cloud Function" },
      { id: 'D', text: "GKE Horizontal Pod Autoscaler" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Monitoring custom metrics API alone" },
      { id: 'B', text: "Datadog agent alone" },
      { id: 'C', text: "Self-hosted Thanos cluster on VMs" },
      { id: 'D', text: "Google Cloud Managed Service for Prometheus (GMP)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Compute Engine persistent disk snapshots alone" },
      { id: 'B', text: "Velero running manually on VMs" },
      { id: 'C', text: "Cloud Storage rsync cron job" },
      { id: 'D', text: "Backup for GKE" }
    ],
    correctAnswers: ['D'],
    type: "single",
