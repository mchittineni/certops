export const GCP_PCA_QUESTIONS_6 = [
  {
    ...
    options: [
      { id: 'A', text: "Google Cloud Secret Manager" },
      { id: 'B', text: "Compute Engine instance metadata" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "IAM Conditions using CEL" },
      { id: 'B', text: "Primitive IAM Roles" },
      { id: 'C', text: "VPC Firewall Rules" },
      { id: 'D', text: "Cloud Armor Security Policies" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "IAM Allow Policies" },
      { id: 'B', text: "Service Account permissions" },
      { id: 'C', text: "Resource Manager Folders" },
      { id: 'D', text: "IAM Deny Policies" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Cloud KMS is located outside Google Cloud" },
      { id: 'C', text: "Envelope encryption is required only for quantum computers" },
      { id: 'D', text: "Cloud KMS can only encrypt plain text strings under 10 characters" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Binary Authorization alone" },
      { id: 'D', text: "Security Command Center Standard alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Armor Custom Rules (using CEL match expressions)" },
      { id: 'B', text: "Cloud Armor Preconfigured WAF rules only" },
      { id: 'C', text: "VPC Firewall Rules" },
      { id: 'D', text: "Cloud Load Balancing URL maps" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Audit Logs alone" },
      { id: 'B', text: "Enable Cloud NAT logging" },
      { id: 'C', text: "Enable VPC Flow Logs only" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Organization policies" },
      { id: 'B', text: "IAM Deny Policies" },
      { id: 'C', text: "VPC Firewall Rules" },
      { id: 'D', text: "Resource Manager Labels" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "constraints/iam.allowedPolicyMemberDomains" },
      { id: 'B', text: "constraints/compute.trustedImageProjects" },
      { id: 'C', text: "constraints/iam.disableServiceAccountKeyCreation" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "constraints/iam.disableServiceAccountCreation" },
      { id: 'B', text: "Cloud KMS Policy" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Date Shifting" },
      { id: 'B', text: "Random Masking" },
      { id: 'C', text: "Simple Redaction" },
      { id: 'D', text: "Deterministic Encryption / CryptoReplaceFfxFpeConfig (Format-Preserving Encryption)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Event Threat Detection (ETD)" },
      { id: 'B', text: "Security Health Analytics" },
      { id: 'C', text: "Web Security Scanner" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Container Threat Detection" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Manually maintaining thousands of CIDR rules in firewall lists" },
      { id: 'B', text: "Disabling HTTP load balancing" },
      { id: 'C', text: "Blocking all traffic from international regions" },
      { id: 'D', text: "Cloud Armor Named IP Lists" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create key rings in the required regions" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Lifecycle management rule" },
      { id: 'B', text: "Object Holds (Event-based or Temporary Hold)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable Firewall Rules Logging on the target firewall rule" },
      { id: 'B', text: "Enable Packet Mirroring on all subnets" },
      { id: 'C', text: "Deploy a syslog agent on every VM" },
      { id: 'D', text: "Export Cloud Billing data" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Identity basic authentication" },
      { id: 'B', text: "Cloud Armor Security Policy" },
      { id: 'C', text: "Compute Engine OS Login" },
      { id: 'D', text: "Access Context Manager (Context-Aware Access levels)" }
    ],
    correctAnswers: ['D'],
    type: "single",
