export const GCP_PCA_QUESTIONS_8 = [
  {
    ...
    options: [
      { id: 'A', text: "Request an upfront Quota Increase through the Google Cloud console well in advance and work with Google account teams for capacity reservations" },
      { id: 'B', text: "Quotas scale up automatically when VMs are created" },
      { id: 'C', text: "Create 50 separate projects to bypass the quota" },
      { id: 'D', text: "Quotas only apply to free tier accounts" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Move all VMs from Project B into Project A manually" },
      { id: 'B', text: "CUDs cannot be shared under any circumstances" },
      { id: 'C', text: "Enable Committed Use Discount Sharing at the Cloud Billing account level" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Anthos Config Management (ACM) / Config Sync" },
      { id: 'B', text: "Jenkins running on Compute Engine" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The on-premises PostgreSQL to Cloud SQL for PostgreSQL migration (homogeneous)" },
      { id: 'B', text: "The Oracle to Cloud SQL for PostgreSQL migration (homogeneous)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The Dockerfile" },
      { id: 'C', text: "The cloudbuild.yaml file alone" },
      { id: 'D', text: "The Kubernetes deployment.yaml file alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Managed Service for Microsoft Active Directory (Managed AD)" },
      { id: 'B', text: "Cloud Identity alone" },
      { id: 'C', text: "Firebase Authentication" },
      { id: 'D', text: "Google Identity Platform" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hot Active-Active multi-region" },
      { id: 'B', text: "Warm Standby (Pilot Light)" },
      { id: 'C', text: "Dual-region active replication" },
      { id: 'D', text: "Cold Standby (Backup and Restore using daily Cloud Storage backups and scripted VM provisioning)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Resource Manager Folders" },
      { id: 'B', text: "Cloud Asset Inventory" },
      { id: 'C', text: "Cloud Logging alone" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "On-Demand pricing ($6.25 per TB scanned)" },
      { id: 'B', text: "BigQuery BI Engine alone" },
      { id: 'C', text: "Cloud Storage pricing alone" },
      { id: 'D', text: "Capacity-based pricing (purchasing dedicated BigQuery Slots)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Shut down the database and copy files using FTP" },
      { id: 'B', text: "Perform a single mysqldump during the 10-minute maintenance window" },
      { id: 'C', text: "Perform an initial baseline sync followed by continuous replication (CDC) to keep databases synchronized, then execute a brief cutover" },
      { id: 'D', text: "Ship the hard drives via postal courier during the window" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Cloud Billing Cost Anomaly Detection" },
      { id: 'D', text: "Static budget thresholds alone" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Manual desktop walkthroughs alone" },
      { id: 'B', text: "Reviewing architectural diagrams annually" },
      { id: 'C', text: "Static code analysis" },
      { id: 'D', text: "Chaos Engineering (Fault Injection Testing)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Manual approval gates only" },
      { id: 'B', text: "Cloud Build trigger after deploy" },
      { id: 'C', text: "The Verify phase (verify: true in Delivery Pipeline)" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deploying the StratoZone Agentless Data Collector appliance that queries servers via WMI (Windows) and SSH (Linux)" },
      { id: 'B', text: "Installing a Python script on every host machine manually" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Aligning data lifecycle with appropriate storage classes (e.g. Coldline or Archive storage)" },
      { id: 'B', text: "Storing all data in memory-optimized Compute Engine instances" },
      { id: 'C', text: "Running dedicated Hadoop clusters 24/7" },
      { id: 'D', text: "Disabling backups to save disk space" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Spot VMs" },
      { id: 'D', text: "Sustained Use Discounts alone" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "An Aggregated Log Sink created at the Organization level with includeChildren = true" },
      { id: 'B', text: "Creating individual log sinks manually in every project" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Assign the same waitFor: ['-'] attribute to all three build steps" },
      { id: 'B', text: "Write three separate Cloud Build triggers" },
      { id: 'C', text: "Sequential execution is mandatory in Cloud Build" },
      { id: 'D', text: "Run a shell script with three background threads" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Deleting all incident logs to avoid liability" },
      { id: 'B', text: "Preventing all future production releases permanently" },
      { id: 'C', text: "The post-mortem must be blameless: focusing on system design flaws, lack of guardrails, and automated recovery rather than blaming individuals" },
      { id: 'D', text: "Punishing the engineer who executed the query" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "GKE Fleets (Anthos Fleets)" },
      { id: 'B', text: "VPC Network Peering" },
      { id: 'C', text: "Compute Engine Unmanaged Instance Groups" },
      { id: 'D', text: "Cloud Load Balancing basic backends" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Compute Engine Load Balancer alone" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Datastream" },
      { id: 'D', text: "Cloud SQL Federations" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "By opening inbound TCP port 443 through corporate firewalls" },
      { id: 'B', text: "By deploying a public Elastic IP on the on-premises switch" },
      { id: 'C', text: "By deploying the Google Cloud Connect Agent inside the cluster to initiate outbound encrypted connections to Google Cloud" },
