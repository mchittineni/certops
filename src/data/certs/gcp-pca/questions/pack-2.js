export const GCP_PCA_QUESTIONS_2 = [
  {
    ...
    options: [
      { id: 'A', text: "Cloud Run accepts any container image" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Interleaved tables in a parent table" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Hotspotting on sequential row keys; add a hash prefix" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A 3-year committed use discount" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Through Sustained Use Discounts once a VM exceeds 25% of the month" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Cloud CDN at the load balancer" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Writes need Paxos consensus in the leader region" },
