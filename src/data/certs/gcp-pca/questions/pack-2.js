export const GCP_PCA_QUESTIONS_2 = [
  {
    ...
    options: [
      { id: 'A', text: "Cloud Functions has a 10-second timeout limit" },
      { id: 'B', text: "Cloud Functions does not support Python" },
      { id: 'C', text: "Cloud Run accepts any container image" },
      { id: 'D', text: "Cloud Run does not support scale to zero" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Interleaved tables in a parent table" },
      { id: 'B', text: "Creating a Secondary Index on Orders" },
      { id: 'C', text: "Normalizing tables into separate databases" },
      { id: 'D', text: "Using Foreign Key constraints with CASCADE" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The Bigtable cluster must be converted to Cloud SQL" },
      { id: 'B', text: "Hotspotting on sequential row keys; add a hash prefix" },
      { id: 'C', text: "Bigtable cannot handle more than 100 rows per second" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Cloud Storage Customer-Managed Encryption Keys" },
      { id: 'C', text: "Making the Cloud Storage bucket public" },
      { id: 'D', text: "Embedding service account private keys in mobile app binaries" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Standard On-Demand VMs" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Free Tier credits" },
      { id: 'D', text: "A 3-year committed use discount" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "By giving free Cloud Storage credits" },
      { id: 'B', text: "By automatically upgrading the VM to a higher CPU tier for free" },
      { id: 'C', text: "Through Sustained Use Discounts once a VM exceeds 25% of the month" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Standard Tier" },
      { id: 'B', text: "Direct Peering Tier" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud CDN at the load balancer" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Multi-Cluster Ingress (MCI)" },
      { id: 'B', text: "Standard Ingress controller per cluster" },
      { id: 'C', text: "External DNS with round-robin records" },
      { id: 'D', text: "Cloud Endpoints" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A cross-region read replica in Europe" },
      { id: 'B', text: "Export data nightly using mysqldump" },
      { id: 'C', text: "Increase CPU on the primary US database" },
      { id: 'D', text: "Deploy a standby instance in another zone in us-central1" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud Spanner does not support writes outside North America" },
      { id: 'B', text: "Writes need Paxos consensus in the leader region" },
      { id: 'C', text: "Europe is disconnected from Google's private network" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Confidential VMs (Confidential Computing)" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud DNS Private Zones" },
      { id: 'B', text: "Cloud DNS Public Zones" },
      { id: 'C', text: "Configuring /etc/hosts on every VM manually" },
      { id: 'D', text: "Cloud Domains" }
    ],
    correctAnswers: ['A'],
    type: "single",
