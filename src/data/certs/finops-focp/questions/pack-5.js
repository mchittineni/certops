export const FINOPS_FOCP_QUESTIONS_5 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Building cost-effective architectures and rightsizing or removing idle capacity" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Budgeting, forecasting, variance analysis and cost allocation" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Procurement persona" },
      { id: 'C', text: "Incident Response persona" },
      { id: 'D', text: "Quality Assurance persona" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configuring reverse proxy web servers for development teams" },
      { id: 'B', text: "Approving individual virtual machine restart requests via email" },
      { id: 'C', text: "Manually tagging individual storage blobs every Friday afternoon" },
      { id: 'D', text: "Sponsorship, accountability, and alignment with business growth" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Bridging engineering, finance and procurement as the in-house expert" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "IT Asset Management (ITAM)" },
      { id: 'B', text: "Security Operations (SecOps)" },
      { id: 'C', text: "IT Service Management (ITSM)" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Site Reliability Engineering" },
      { id: 'C', text: "Container Orchestration" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cost estimation and policy checks inside the CI/CD pipeline" },
      { id: 'B', text: "Mandating that finance write all Docker container files" },
      { id: 'C', text: "Prohibiting developers from deploying code more than once a month" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Product Owners manually patching Linux server kernels" },
      { id: 'B', text: "Product Owners negotiating datacenter electricity contracts" },
      { id: 'C', text: "Product Owners writing low-level network device drivers" },
      { id: 'D', text: "Product owners weighing feature profit against unit cost" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Delegating all financial decisions to external auditors" },
      { id: 'B', text: "Punishing teams publicly whenever cloud spend increases" },
      { id: 'C', text: "Canceling all meetings between engineering and finance to minimize friction" },
      { id: 'D', text: "A recurring cadence where engineering and finance review trends" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Teaching engineers billing mechanics, tagging and efficiency" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Individual employee password expiration dates" },
      { id: 'B', text: "Cloud spend as a share of revenue, and unit cost trends" },
      { id: 'C', text: "Raw lists of millions of unaggregated disk read/write operations" },
      { id: 'D', text: "Daily server chassis temperature logs" }
    ],
    correctAnswers: ['B'],
    type: "single",
