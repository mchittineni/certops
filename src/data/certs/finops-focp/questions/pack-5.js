export const FINOPS_FOCP_QUESTIONS_5 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Quality Assurance persona" },
      { id: 'C', text: "Procurement persona" },
      { id: 'D', text: "Incident Response persona" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Facilities Management" },
      { id: 'B', text: "Security Operations (SecOps)" },
      { id: 'C', text: "IT Asset Management (ITAM)" },
      { id: 'D', text: "IT Service Management (ITSM)" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Site Reliability Engineering" },
