export const FINOPS_FOCP_QUESTIONS_9 = [
  {
    ...
    options: [
      { id: 'A', text: "Idle resources belong to production; over-provisioned resources belong to development" },
      { id: 'B', text: "An idle resource has no utilization; an over-provisioned one has far too much" },
      { id: 'C', text: "An idle resource is powered on; an over-provisioned resource is powered off" },
      { id: 'D', text: "Idle resources are billable; over-provisioned resources are free of charge" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Approximately 25% to 30%" },
      { id: 'B', text: "Approximately 10% to 15%" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It makes the trade-off between speed, quality and cost explicit" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Act as an authoritarian gatekeeper approving every individual virtual machine launched" },
      { id: 'B', text: "Take complete ownership of writing and deploying all application code to ensure cost efficiency" },
      { id: 'C', text: "Audit and penalize engineering teams that exceed monthly forecasts" },
      { id: 'D', text: "Acting as a collaborative enabler with shared data, tooling and practice" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Optimize: Buy multi-year commitments to cut costs immediately" },
      { id: 'B', text: "Exit: Repatriate all workloads back to an on-premises datacenter" },
      { id: 'C', text: "Inform: visibility, allocation tags and baseline reporting" },
      { id: 'D', text: "Operate: Build complex automated self-healing scripts to terminate VMs" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Eliminating all cloud engineers and replacing them with financial accountants" },
      { id: 'B', text: "Having zero cloud spending variance from month to month" },
      { id: 'C', text: "Conducting annual paper audits of cloud invoices" },
      { id: 'D', text: "Near-real-time remediation, CI/CD cost checks, and KPIs in every decision" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Immediately dispute the charges with corporate credit card providers" },
      { id: 'C', text: "Force engineering to roll back the serverless migration and maintain legacy database instances" },
      { id: 'D', text: "Exchange convertible reservations, sell standard RIs, or modify them" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Only the random string generated by the deployment script" },
      { id: 'B', text: "CostCenter, Owner, Environment, Application, Classification" },
      { id: 'C', text: "ServerName, IPAddress, and MACAddress" },
      { id: 'D', text: "Only the personal name of the engineer who created the resource" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "OpenCost or Kubecost, allocating node cost by container requests and usage" },
      { id: 'B', text: "Mandate that each microservice must run in its own dedicated single-tenant Kubernetes cluster" },
      { id: 'C', text: "Charge the entire bill to the DevOps team that deployed the Kubernetes control plane" },
      { id: 'D', text: "Equally divide the $60,000 by 10 teams regardless of container CPU and memory consumption" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Purchasing 3-year Reserved Instances automatically offsets all carbon emissions" },
      { id: 'B', text: "Sustainability requires operating only during daylight hours" },
      { id: 'C', text: "Cutting idle compute reduces energy use and datacenter emissions" },
      { id: 'D', text: "Cloud sustainability is completely unrelated to workload optimization and server sizing" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Linear extrapolation cannot anticipate business events like a sale" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Blocking all customer downloads from the production web application" },
      { id: 'B', text: "CDN edge caching, co-locating services, and private VPC endpoints" },
      { id: 'C', text: "Moving all workloads to a different cloud provider every week" },
      { id: 'D', text: "Disabling TLS encryption on all outbound network traffic" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Engineers can provision thousands of dollars in seconds from an API call" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Purchasing commercial licenses through retail consumer outlets" },
      { id: 'B', text: "Deleting all database backups to save disk space" },
      { id: 'C', text: "BYOL on dedicated hosts, and moving to open-source engines" },
      { id: 'D', text: "Running unlicensed pirated software on cloud virtual machines" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Writing an hourly script that terminates all running GPU instances regardless of who owns them" },
      { id: 'B', text: "Policy guardrails denying unauthorized instance types in dev accounts" },
      { id: 'C', text: "Revoking console access for all software engineers" },
      { id: 'D', text: "Requiring every developer to fill out a paper ticket approved by the CFO before every launch" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Have finance review the monthly bill against each team forecast" },
      { id: 'B', text: "Shift-left estimation in CI/CD, posting cost diffs on pull requests" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Delete the AWS account immediately" },
      { id: 'B', text: "Never use serverless technologies in enterprise environments" },
      { id: 'C', text: "Increase the Lambda memory allocation to 10 GB so the loop finishes faster" },
      { id: 'D', text: "Concurrency limits, billing alarms, and a separate output bucket" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The number of active credit cards registered with cloud providers" },
      { id: 'B', text: "The ratio of virtual machines to physical hosts" },
      { id: 'C', text: "Total on-demand spend divided by total invoice amount" },
      { id: 'D', text: "Effective Savings Rate: the discount against on-demand list price" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Architects, engineers and stakeholders" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The cloud provider shuts down all production systems on the last day of the contract" },
      { id: 'B', text: "It must pay the $2,500,000 shortfall or lose the negotiated discounts" },
      { id: 'C', text: "The cloud provider forgives the shortfall with no financial obligation" },
      { id: 'D', text: "The shortfall is automatically converted into physical server hardware delivered to the company" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Teams cannot see aggregate usage or reach pooled volume tiers" },
      { id: 'B', text: "Because cloud providers only allow one user per company to log in" },
      { id: 'C', text: "Because developers are legally prohibited from viewing cloud pricing calculators" },
      { id: 'D', text: "Because central procurement teams do not understand technology" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "It forces all cloud providers to charge identical hourly prices for virtual machines" },
      { id: 'C', text: "A vendor-neutral schema and terminology for cloud cost data" },
      { id: 'D', text: "It replaces all cloud billing consoles with a proprietary desktop application" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "By fining team members personally for unattached storage volumes" },
      { id: 'B', text: "Publicly ranking teams on tag compliance and waste reduction" },
      { id: 'C', text: "By withholding software releases until all unit tests pass with zero cost" },
      { id: 'D', text: "By assigning all cloud bills to the newest software intern" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Release unattached Elastic IPs, move to private subnets, adopt IPv6" },
      { id: 'B', text: "Assign public IP addresses to every internal database server to increase utilization" },
      { id: 'C', text: "Purchase Reserved IP addresses for a 3-year term" },
      { id: 'D', text: "Ignore the charge because IPv4 addresses are free of charge across all cloud providers" }
    ],
    correctAnswers: ['A'],
    type: "single",
