export const FINOPS_FOCP_QUESTIONS_1 = [
  {
    ...
    options: [
      ...
      { id: 'B', text: "A cloud financial management practice in which engineering, finance and business teams decide on spend together from shared data" },
      { id: 'C', text: "FinOps is an automated software agent that revokes cloud access from engineers who exceed monthly budgets" },
      { id: 'D', text: "FinOps is a procurement mandate focused exclusively on cutting cloud spending by eliminating all non-essential development environments" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Everyone takes ownership for their cloud usage" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Cloud spend should remain fixed regardless of user volume fluctuations" },
      { id: 'B', text: "Spend rises are justified when they drive proportional or greater revenue" },
      { id: 'C', text: "FinOps prioritizes maintaining static quarterly cloud budgets above customer acquisition" },
      { id: 'D', text: "Any increase in cloud spend represents an operational failure regardless of revenue growth" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Because cloud vendors disallow the use of enterprise corporate credit cards" },
      { id: 'C', text: "Because public clouds legally mandate annual on-site hardware inspections" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Moving from annual budgets to rolling forecasts" },
      { id: 'B', text: "Eliminating all budgeting processes entirely" },
      { id: 'C', text: "Depreciating server racks over five fiscal years" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "A vendor-neutral Linux Foundation standards community" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Viewing cost as an unavoidable fixed administrative overhead" },
      { id: 'B', text: "Treating cloud bills as non-negotiable legal liabilities" },
      { id: 'C', text: "Ignoring cloud usage until year-end audits" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Blocking developers from viewing resource cost dashboards" },
      { id: 'B', text: "Billing individual engineers personal expenses for cloud spikes" },
      { id: 'C', text: "Sending quarterly retrospective billing summaries to managers only" },
      { id: 'D', text: "Giving engineers immediate cost feedback" }
    ],
    correctAnswers: ['D'],
    type: "single",
