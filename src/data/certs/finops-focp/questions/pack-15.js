export const FINOPS_FOCP_QUESTIONS_15 = [
  {
    ...
    options: [
      ...
      { id: 'C', text: "Cost estimation in pull requests, judged before merge." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Wait for monthly cloud provider invoices to arrive before checking if new services are expensive." },
      { id: 'C', text: "Prohibit engineers from introducing any new cloud services to avoid cost increases." },
      { id: 'D', text: "Rely on annual retrospective audits to identify architecture inefficiencies." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Integrate cost estimation tools (e.g., Infracost) into pull requests and CI/CD pipelines, evaluating architectural cost changes before merge. A key hallmark of FinOps maturity is transitioning from reactive cost management (analyzing invoices post-facto) to proactive engineering (shift left). Integrating tools like Infracost into pull requests gives developers immediate cost diffs on Terraform changes prior to provisioning.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Claim that purchasing a commercial FinOps software license is sufficient evidence of continuous improvement." },
      { id: 'C', text: "Stop measuring metrics once the initial low-hanging cleanup fruit has been harvested." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Engineering wants all cloud infrastructure replaced by manual paperwork." },
      { id: 'C', text: "Engineering wants reliable services and actionable cost advice." },
      { id: 'D', text: "Engineering focuses exclusively on general ledger journal entries and balance sheet depreciation schedules." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    question: "Which FinOps capability or technical optimization practice maximizes cost efficiency without sacrificing system reliability?",
    options: [
      { id: 'A', text: "Engineering wants reliable services and actionable cost advice." },
      { id: 'B', text: "Engineering focuses exclusively on general ledger journal entries and balance sheet depreciation schedules." },
      { id: 'C', text: "Engineering owns the budget and finance is only informed of the outcome." },
  ...
  },
  {
    ...
    question: "Which FinOps reporting mechanism or allocation strategy guarantees accurate cost attribution across business units?",
    options: [
      { id: 'A', text: "Finance is solely responsible for determining the number of CPU cores in microservices." },
      { id: 'B', text: "Finance wants predictability, reconciliation and better contracts." },
