export const FINOPS_FOCP_QUESTIONS_15 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Engineering focuses on building reliable, performant services while seeking frictionless self-service and actionable cost recommendations." },
      { id: 'B', text: "Engineering focuses exclusively on general ledger journal entries and balance sheet depreciation schedules." },
      { id: 'C', text: "Engineering exists to manually review employee travel expense receipts." },
