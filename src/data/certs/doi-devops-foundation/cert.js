/**
 * DevOps Institute DevOps Foundation (DOF) — exam blueprint.
 *
 ...
 *   4. add content: npm run new:pack -- --cert doi-devops-foundation --kind questions --count 50
 */
export default {
  "id": "doi-devops-foundation",
  "provider": "DevOps Institute",
  "code": "DOF",
  "title": "DevOps Institute DevOps Foundation",
  "category": "DevOps & SRE",
  "tier": "foundational",
  "status": "planned",
  "priority": null,
  ...
  "icon": "devops",
  "color": "#14b8a6",
  "description": "TODO one-sentence description of what DOF validates.",
  "passingScore": 65,
  "maxScore": 100,
