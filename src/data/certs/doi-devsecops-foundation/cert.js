/**
 * DevSecOps Foundation (DSOF) — exam blueprint.
 *
 ...
 *   4. add content: npm run new:pack -- --cert doi-devsecops-foundation --kind questions --count 50
 */
export default {
  "id": "doi-devsecops-foundation",
  ...
  "icon": "devops",
  "color": "#14b8a6",
  "description": "TODO one-sentence description of what DSOF validates.",
  "passingScore": 65,
  "maxScore": 100,
