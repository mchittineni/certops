export const GITHUB_GHAS_FLASHCARDS_2 = [
  ...
  },
  {
    ...
    certId: "github-ghas",
    domainId: "d5",
    front: "Requesting a CVE for a Repository Security Advisory",
    hint: "GitHub as a CVE Numbering Authority (CNA) issuing official CVE identifiers.",
    back: "GitHub is a <strong>CVE Numbering Authority (CNA)</strong>. Maintainers request a CVE on the <strong>draft</strong> repository security advisory, before publishing it, and GitHub assigns the identifier from the repository interface.",
