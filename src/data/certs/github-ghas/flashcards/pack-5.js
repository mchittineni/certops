export const GITHUB_GHAS_FLASHCARDS_5 = [
  ...
  },
  {
    ...
    certId: "github-ghas",
    domainId: "d1",
    front: "Secret Protection and Code Security Licensing Model",
    hint: "Active committers licensing calculation on private repositories.",
    back: "GitHub Advanced Security is sold as two products, <strong>GitHub Secret Protection</strong> and <strong>GitHub Code Security</strong>. Each is licensed by the count of <strong>unique active committers</strong> who pushed to private repositories with that product enabled in the last 90 days. On public repositories, secret scanning, push protection, code scanning and dependency review are free.",
  ...
  },
  {
    ...
    certId: "github-ghas",
    domainId: "d6",
    front: "Restricting Secret Protection and Code Security Enablement",
    hint: "Controlling which organization owners can enable the paid security products and consume licenses.",
    back: "Enterprise administrators configure policies to allow only enterprise admins (or approved organization owners) to enable <strong>GitHub Secret Protection</strong> and <strong>GitHub Code Security</strong>, preventing accidental licence over-allocation.",
