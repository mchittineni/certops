export const GITHUB_GHAS_FLASHCARDS_4 = [
  ...
  },
  {
    ...
    back: "<strong>GitHub Copilot Autofix</strong> analyzes a CodeQL alert and suggests a code change with an explanation. The suggestion is <strong>not verified</strong>: developers must review and test it, because it may fail to fix the issue or introduce new vulnerabilities.",
