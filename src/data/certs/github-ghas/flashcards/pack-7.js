export const GITHUB_GHAS_FLASHCARDS_7 = [
  ...
  },
  {
    ...
    certId: "github-ghas",
    domainId: "d1",
    front: "Enterprise Committer Calculation for Security Product Billing",
    hint: "How GitHub calculates active committer licenses across organizations.",
    back: "GitHub deduplicates users across an enterprise: a developer pushing commits to 10 private repositories with GitHub Code Security enabled, across 3 organizations, consumes exactly <strong>one Code Security committer licence</strong>. GitHub Secret Protection is licensed and counted separately in the same way.",
