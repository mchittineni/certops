export const GITHUB_GHAS_QUESTIONS_1 = [
  {
    ...
    options: [
      { id: 'A', text: "Confirm whether the value is genuinely inert, and if so remove the push protection block by supplying a bypass reason, which is recorded and raises an alert for security to review." },
      { id: 'B', text: "Disable push protection for the repository, push the branch, then re-enable it." },
      { id: 'C', text: "Rename the variable holding the value, which changes the pattern match and allows the push." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Push protection applies to the default branch only, so a commit to any other branch is unaffected." },
      { id: 'D', text: "Push protection applies only to users without write access." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "All three are enabled by a single toggle and cannot be configured independently." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Removing the dependency from the manifest so Dependabot does not see it." },
      { id: 'C', text: "Setting open-pull-requests-limit to zero for the ecosystem." },
      { id: 'D', text: "Adding the dependency to an allow entry, which pins it to its current version." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Advanced setup for both, because default setup cannot analyse interpreted languages." },
      { id: 'C', text: "Default setup for both, because it accepts a configuration file supplying build commands and query packs." },
      { id: 'D', text: "Default setup for the compiled project, since it handles build detection, and advanced setup for the interpreted one." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The database must be created after the analysis step, and the ordering in the workflow is reversed." },
      { id: 'C', text: "Compiled languages require the source to be uploaded as a SARIF file rather than analysed directly." },
      { id: 'D', text: "The repository is too large for extraction, and the remedy is to exclude directories with a paths filter." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The security-and-quality suite adds security queries only, and security-extended adds quality queries." },
      { id: 'C', text: "There is one suite whose sensitivity is set by a threshold value in the configuration." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "A code scanning merge protection rule configured in a repository ruleset, applied at organization level and specifying the tool and the severity that should block." },
