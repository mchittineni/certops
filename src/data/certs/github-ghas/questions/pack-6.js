export const GITHUB_GHAS_QUESTIONS_6 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable Secret Scanning across all private repositories to stop sending alerts" },
      { id: 'C', text: "Configure pre-commit hooks on individual developer laptops" },
      { id: 'D', text: "Revoke write permissions for all developers and require pull requests for every branch" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "corp_sec_[0-9a-fA-F]{32}" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "security_advisory" },
      { id: 'B', text: "push" },
      { id: 'C', text: "secret_scanning_alert" },
      { id: 'D', text: "workflow_job" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The commit succeeds but sends a warning email to the organization owner" },
      { id: 'B', text: "GitHub converts the repository from public to private" },
      { id: 'C', text: "GitHub deletes the file from the repository entirely" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "hook.create" },
      { id: 'C', text: "repo.create_secret" },
      { id: 'D', text: "secret_scanning.bypass" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "GitHub sent a non-destructive verification request to the partner provider's public validation endpoint using the detected token" },
      { id: 'B', text: "GitHub logged into the customer's cloud account using stored administrator credentials" },
      { id: 'C', text: "GitHub decrypted the token using the organization's master key" },
      { id: 'D', text: "The developer who committed the token manually marked it as active" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable Secret Scanning on the entire organization" },
      { id: 'B', text: "Mark every future alert as 'Won't fix'" },
      { id: 'C', text: "Increase the minimum required character length and define explicit start/end prefix boundaries or regex lookbehind/lookahead assertions" },
      { id: 'D', text: "Exclude all markdown files from git version control" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Assign the department leads to the Repository Admin role and use organization security configurations with delegated administration" },
      { id: 'B', text: "Grant department leads Billing Manager access" },
      { id: 'C', text: "Create separate GitHub Enterprise instances for every department" },
      { id: 'D', text: "Store repository admin passwords in a shared spreadsheet" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In the organization or enterprise Security Overview dashboard" },
      { id: 'B', text: "In the repository Insights network graph" },
      { id: 'C', text: "In the Actions workflow log archive" },
      { id: 'D', text: "In the GitHub Marketplace billing receipt" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "All commits are accepted, and warning issues are opened" },
      { id: 'B', text: "The push is rejected in its entirety, and the CLI error provides distinct remediation URLs for each detected secret" },
      { id: 'C', text: "The branch is renamed automatically to quarantine" },
      { id: 'D', text: "Commit 1 and 2 are pushed successfully, while commit 3 is dropped" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "GET /repos/{owner}/{repo}/code-scanning/alerts" },
      { id: 'B', text: "POST /repos/{owner}/{repo}/secret-scanning/list" },
      { id: 'C', text: "GET /repos/{owner}/{repo}/secret-scanning/alerts?state=open" },
      { id: 'D', text: "DELETE /repos/{owner}/{repo}/secret-scanning/alerts" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Client-side hooks only work on Windows operating systems" },
      { id: 'B', text: "Client-side hooks run locally and can be easily bypassed or disabled by any developer using git commit --no-verify" },
      { id: 'C', text: "Client-side hooks consume too much cloud bandwidth" },
      { id: 'D', text: "Client-side hooks cannot inspect commit messages" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Re-activate the token immediately" },
      { id: 'B', text: "Clean git history or ensure the token cannot be regenerated, and verify that no secondary systems shared that credential format" },
      { id: 'C', text: "Convert the repository to public" },
      { id: 'D', text: "Leave the revoked token in history because it cannot be exploited" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Each organization owner must manually copy and paste the regex patterns into their settings" },
      { id: 'B', text: "The custom patterns automatically apply to all repositories across all organizations belonging to the enterprise" },
      { id: 'C', text: "Custom patterns require an individual pull request in every repository" },
      { id: 'D', text: "Custom patterns only apply to the enterprise management repository" }
    ],
    correctAnswers: ['B'],
    type: "single",
