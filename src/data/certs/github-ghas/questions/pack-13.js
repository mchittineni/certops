export const GITHUB_GHAS_QUESTIONS_13 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Ignore all dependency alerts until a security breach is publicly reported." },
      { id: 'D', text: "Disable Dependabot alerts to reduce notification email volume." }
    ],
    correctAnswers: ['A'],
    type: "single",
