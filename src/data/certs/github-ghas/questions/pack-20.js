export const GITHUB_GHAS_QUESTIONS_20 = [
  ...
  },
  {
    ...
    title: "Secret Protection and Code Security Committer Licensing: Enterprise Rollout",
    scenario: "An enterprise application security team is deploying GitHub Advanced Security (GHAS) across hundreds of repositories to establish automated vulnerability management and compliance guardrails. The AppSec engineer needs to understand how GitHub Secret Protection and GitHub Code Security licenses are counted and how to optimize license consumption across an enterprise.",
    question: "Which architectural approach or GHAS configuration satisfies these enterprise security rollout objectives?",
    options: [
      { id: 'A', text: "Track active committers per product who pushed to enabled private repos in the last 90 days." },
      ...
      { id: 'D', text: "Assume that read-only repository viewers consume full committer licenses too." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Track active committers for each product. GitHub Secret Protection and GitHub Code Security are licensed separately, and each counts the unique users who pushed to a private or internal repository with that product enabled within the last 90 days. A committer uses one licence per product no matter how many repositories they contribute to, and read-only viewers or company email accounts that never push consume nothing.",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Describe GitHub Security suites, features, and ecosystem",
    title: "Secret Protection and Code Security Committer Licensing: Supply Chain Defense",
    ...
    options: [
      ...
      { id: 'B', text: "Track active committers per product who pushed to enabled private repos in the last 90 days." },
      { id: 'C', text: "Assume that read-only repository viewers consume full committer licenses too." },
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Describe GitHub Security suites, features, and ecosystem",
    title: "Secret Protection and Code Security Committer Licensing: Secret Leak Prevention",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Describe GitHub Security suites, features, and ecosystem",
    title: "Secret Protection and Code Security Committer Licensing: Static Analysis Codeql",
  ...
  },
  {
    ...
    domainId: "d1",
    domainName: "Describe GitHub Security suites, features, and ecosystem",
    title: "Secret Protection and Code Security Committer Licensing: Governance And Compliance",
