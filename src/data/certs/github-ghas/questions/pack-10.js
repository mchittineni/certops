export const GITHUB_GHAS_QUESTIONS_10 = [
  {
    ...
    options: [
      { id: 'A', text: "Organization and Enterprise Security Overview" },
      { id: 'B', text: "GitHub Packages" },
      { id: 'C', text: "GitHub Discussions" },
      { id: 'D', text: "Repository Insights" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Apply an enterprise Security Configuration and toggle 'Enforce' to lock the policy against local repository overrides" },
      { id: 'B', text: "Revoke all developer repository write access" },
      { id: 'C', text: "Send an email reminder to all maintainers" },
      { id: 'D', text: "Delete repository administration tabs" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Billing Manager" },
      { id: 'B', text: "Repository Admin on all repositories" },
      { id: 'C', text: "Security Managers team role" },
      { id: 'D', text: "Organization Owner" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Create an Enterprise Ruleset targeting all default branches with 'Require status checks to pass' specifying the CodeQL workflow" },
      { id: 'B', text: "Manually configure branch protection rules in every individual repository" },
      { id: 'C', text: "Run an hourly script that reverts non-compliant commits" },
      { id: 'D', text: "Write a custom git hook on developer laptops" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Every user with an account in the enterprise consumes a license" },
      { id: 'B', text: "Licenses are billed per line of code scanned" },
      ...
      { id: 'D', text: "Licenses are billed based on the number of open security alerts" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "In a public blog post outside GitHub" },
      { id: 'B', text: "In package.json" },
      { id: 'C', text: "In the repository git tag message" },
      { id: 'D', text: "In the repository root, .github/, or docs/ directory as SECURITY.md, or in a central .github repository for organization-wide visibility" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Configure Audit Log Streaming in Enterprise Settings to forward JSON audit events in real time to Amazon S3, Azure Event Hubs, Splunk, or Datadog" },
      { id: 'B', text: "Rely on GitHub's internal 90-day retention" },
      { id: 'C', text: "Write a cron job that scrapes GitHub web pages" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Fine-grained PATs do not require authentication" },
      { id: 'C', text: "Fine-grained PATs are only usable from web browsers" },
      { id: 'D', text: "Fine-grained PATs can be scoped to specific repositories, grant minimal API permissions, enforce mandatory expiration dates (max 1 year), and support organization approval workflows" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Require signed commits (verifying GPG, SSH, or S/MIME cryptographic signatures)" },
      { id: 'C', text: "Require linear history" },
      { id: 'D', text: "Require pull request reviews" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "DNS routing policies" },
      { id: 'B', text: "Enterprise IP allow lists, restricting web UI and API access strictly to designated CIDR blocks" },
      { id: 'C', text: "Branch protection IP filters" },
      { id: 'D', text: "Firewall Rules in Actions workflows" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Launching a Security Campaign in Security Overview targeting the specific advisory and tracking remediation percentages against a due date" },
      { id: 'B', text: "Deleting non-compliant repositories" },
      { id: 'C', text: "Creating a public discussion thread" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The setting takes effect only for newly invited users" },
      { id: 'B', text: "GitHub deletes all repositories owned by non-compliant members" },
      ...
      { id: 'D', text: "All members without 2FA enabled are automatically converted to billing managers" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "security.bypass" },
      { id: 'B', text: "action.dismiss" },
      { id: 'C', text: "repo.remove_alert" },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disabling the 'Allow forking of private repositories' setting in organization settings" },
      { id: 'B', text: "Deleting all personal GitHub accounts" },
      { id: 'C', text: "Requiring signed commits" },
      { id: 'D', text: "Setting repository visibility to public" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Under Organization Settings → Roles → Create a role, selecting granular permissions like 'View security overview' and 'View code scanning alerts'" },
      { id: 'C', text: "Custom roles are not supported in GitHub" },
      { id: 'D', text: "By editing linux file permissions on the runner" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "GraphQL allows querying Code Scanning, Secret Scanning, and Dependabot alerts across hundreds of repositories in a single nested query, drastically reducing rate limit consumption" },
      { id: 'B', text: "GraphQL runs faster on developer laptops" },
      { id: 'C', text: "REST API is deprecated across GitHub" },
      { id: 'D', text: "GraphQL does not require authentication tokens" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Write a cron job that scans repositories once a month" },
      { id: 'C', text: "Assign an engineer to manually configure settings every time a repository is created" },
      { id: 'D', text: "Configure the default Organization Security Configuration and enable 'Automatically apply to newly created repositories'" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Disable Actions completely" },
      { id: 'B', text: "Ban developers from using GitHub Marketplace" },
      { id: 'C', text: "Configure 'Allow select actions' and choose 'Allow actions created by GitHub and verified creators'" },
      { id: 'D', text: "Require manual approval for every single workflow run" }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "The GitHub Advisory Database, which propagates CVE data to the National Vulnerability Database (NVD) and global package registries" },
      { id: 'B', text: "A private email list" },
      { id: 'C', text: "The operating system systemd log" },
      { id: 'D', text: "Only the local repository README file" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Organization secrets cannot be restricted" },
      { id: 'B', text: "Share the secret in a public Slack channel" },
      { id: 'C', text: "Allow all repositories in the organization access" },
      { id: 'D', text: "Set secret access to 'Selected repositories' and grant access strictly to authorized production release repos" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "By disabling branch protection permanently" },
      { id: 'B', text: "By configuring an explicit Bypass List in the Ruleset specifying designated teams or roles (e.g. 'Site Reliability Leads') permitted to bypass" },
      { id: 'C', text: "Rulesets do not allow any bypass under any circumstances" },
      { id: 'D', text: "By sharing administrator root passwords" }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "By purchasing external insurance policies" },
      { id: 'B', text: "By replacing all human software developers with AI bots" },
      { id: 'C', text: "By encrypting repository names" },
      { id: 'D', text: "By providing automated vulnerability scanning, immutable audit logs, cryptographic commit signing verification, and tamper-evident pull request review tracking" }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Code Scanning (CodeQL), Secret Scanning (including Push Protection), and Dependabot (Supply Chain Security)" },
      { id: 'B', text: "Git CLI, GitHub Desktop, and Mobile" },
      { id: 'C', text: "Issues, Discussions, and Projects" },
      { id: 'D', text: "Actions, Packages, and Pages" }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "By paying cash bounties directly from GitHub credit balances" },
      { id: 'D', text: "By deleting the vulnerability report after publication" }
    ],
    correctAnswers: ['A'],
    type: "single",
