export const GITHUB_GHAS_QUESTIONS_14 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Disable private package scanning and assume internal packages are completely immune to vulnerabilities." },
      { id: 'D', text: "Make the internal enterprise package registry publicly accessible to the entire internet." }
    ],
    correctAnswers: ['A'],
    type: "single",
