export const GITHUB_GHAS_QUESTIONS_14 = [
  {
    ...
    options: [
      { id: 'A', text: "Write custom shell scripts that run `npm update` on production servers without pull request review." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Manually check package registries for new library releases every morning." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Manually review and dismiss 2,000 individual development alerts by hand every week." },
  ...
  },
  {
    ...
    question: "Which CodeQL feature or workflow configuration enables developers to catch and fix vulnerabilities before merge?",
    options: [
      { id: 'A', text: "Treat devDependencies with the exact same criticality as public production web servers." },
      { id: 'B', text: "Manually review and dismiss 2,000 individual development alerts by hand every week." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Scan dependencies only after code is merged into the production main branch." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Allow developers to introduce arbitrary dependencies without automated CI review." },
      { id: 'D', text: "Disable pull request status checks to speed up merge velocity." }
    ],
    correctAnswers: ['A'],
    type: "single",
    explanation: "Add the `actions/dependency-review-action` workflow to pull requests, configured to fail on `fail-on-severity: high` and unapproved licenses. The Dependency Review Action (`actions/dependency-review-action`) scans the diff of pull requests for changes to dependencies. It acts as an automated security gate, comparing changes against the Advisory Database and license policies, blocking PRs before vulnerable packages reach main.",
  ...
  },
  {
    ...
    question: "Which architectural approach or GHAS configuration satisfies these enterprise security rollout objectives?",
    options: [
      { id: 'A', text: "Refuse to provide an SBOM and claim software dependencies are trade secrets." },
      { id: 'B', text: "Generate an SBOM by taking screenshots of the repository package.json file." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'D', text: "Export the repository Software Bill of Materials (SBOM) using the GitHub REST API or UI in standard SPDX 2.3 JSON format." }
    ],
    correctAnswers: ['D'],
    type: "single",
    explanation: "Export the repository Software Bill of Materials (SBOM) using the GitHub REST API or UI in standard SPDX 2.3 JSON format. GitHub supports exporting Software Bills of Materials (SBOMs) directly from the Dependency Graph. Compliant with executive orders and industry standards, the REST API (`/repos/{owner}/{repo}/dependency-graph/sbom`) exports machine-readable SPDX JSON files detailing all direct and transitive components.",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Disable private package scanning and assume internal packages are completely immune to vulnerabilities." },
