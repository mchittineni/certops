export const GITHUB_GHAS_QUESTIONS_16 = [
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Enable Code Scanning Default Setup, allowing GitHub to automatically detect languages, compile code, and run standard query suites." },
      { id: 'B', text: "Use third-party bash scripts that invoke unverified web scrapers." },
      { id: 'C', text: "Write bespoke, multi-hundred line GitHub Actions YAML workflows by hand for every single repository." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Disable static analysis and wait for penetration testers to find SQL injection manually." },
      { id: 'D', text: "Rely on unit tests that only execute happy-path hardcoded inputs." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Search for string occurrences of 'SELECT' in source code using simple text grep commands." },
      { id: 'C', text: "Rely on unit tests that only execute happy-path hardcoded inputs." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Attempt to reproduce the vulnerability by guessing random HTTP payloads in a web browser." },
  ...
  },
  {
    ...
    question: "Which Dependabot practice or supply chain security configuration defends the software lifecycle effectively?",
    options: [
      { id: 'A', text: "Disable static code analysis for internal proprietary functions." },
      { id: 'B', text: "Write a custom bash script that scans source files using fragile regex patterns." },
      { id: 'C', text: "Author a custom CodeQL query (`.ql`) importing language security libraries, and package it into a versioned CodeQL query pack (`qlpack.yml`)." },
      { id: 'D', text: "Manually review every line of code committed across 500 repositories." }
    ],
    correctAnswers: ['C'],
    type: "single",
    explanation: "Author a custom CodeQL query (`.ql`) importing language security libraries, and package it into a versioned CodeQL query pack (`qlpack.yml`). Security teams write custom CodeQL queries using QL, an object-oriented query language. Queries are organized into CodeQL packs (`qlpack.yml`) with dependencies and published to GitHub Container Registry (GHCR) as OCI artifacts, allowing organizations to share custom rules fleet-wide.",
