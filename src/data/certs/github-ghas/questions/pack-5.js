export const GITHUB_GHAS_QUESTIONS_5 = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Merge the pull request and remove the credential in a follow-up commit on the default branch." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Set a target branch, which controls the delivery time." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Alert details are available to users with write access, along with administrators and security managers, so granting read access does not expose them, though for a public repository some code scanning alert information is visible more broadly." },
      { id: 'B', text: "Alerts are visible to anyone who can read the repository, so wider read access exposes them." },
      { id: 'C', text: "Alerts are visible only to organization owners in every case." },
      { id: 'D', text: "Alerts are visible to nobody until they are dismissed or fixed." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The analysis can be pointed at only the changed files, which is the standard configuration for pull requests." },
      { id: 'C', text: "Pull request analysis reuses the database from the last default branch run, so no extraction happens." },
      { id: 'D', text: "Pull request analysis is a text diff scan rather than a semantic analysis, which is why it is fast." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Defer to the security reviewer in all cases, since security owns the alert queue." },
      { id: 'C', text: "Defer to the developer in all cases, since they know the code." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "A statement that the project takes security seriously and a maintainer email address." },
      { id: 'C', text: "The list of security tools the project runs, so reporters know what is already covered." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Stream the audit log to the monitoring platform and alert on the configuration event types that represent a weakening, since these are administrative changes rather than alerts and appear nowhere in the security alert feeds." },
      { id: 'B', text: "Poll security overview daily and compare the coverage view to yesterday's." },
      { id: 'C', text: "Subscribe to the secret scanning and code scanning alert webhooks, which include configuration changes." },
