export const GITHUB_GHAS_QUESTIONS_2 = [
  {
    ...
    options: [
      { id: 'A', text: "Disabling push protection for the repositories that report the most false positives." },
      ...
      { id: 'C', text: "Converting the false positive patterns into custom patterns, which suppresses the block." },
      { id: 'D', text: "Requiring two reviewers on every pull request, which covers the bypass decision." }
    ],
    correctAnswers: ['B'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "Running a repository search for the token prefix, which is equivalent to the scanner behaviour." },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'B', text: "The software bill of materials export, which blocks disallowed licences at export time." },
      { id: 'C', text: "Dependabot alerts, which include licence findings alongside vulnerabilities." },
      { id: 'D', text: "A CodeQL query that inspects licence files in dependencies." }
    ],
    correctAnswers: ['A'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Whether the release notes are authoritative, since advisories are only updated quarterly." },
      ...
      { id: 'D', text: "Whether the vulnerable package is still resolved transitively through another dependency, whether a lockfile still pins the old version, and whether the advisory affects a version range the new release still falls within." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "One analysis of the dominant language, since findings in the others are covered transitively." },
      { id: 'B', text: "A single database covering all languages at once, analysed in one step." },
      { id: 'C', text: "A matrix over the languages, so each language gets its own database creation, its own build handling where required and its own analysis, which is reported under its own category." },
      { id: 'D', text: "Three separate repositories, one per language, since one repository supports one language." }
    ],
    correctAnswers: ['C'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "It is the call stack captured when the analysis executed the code, showing the runtime sequence." },
      { id: 'B', text: "It is a list of every function that mentions the variable name, in file order." },
      { id: 'C', text: "It is a suggested refactoring produced by the analysis, which should be applied as shown." },
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: "Grant the team write access to every repository through a nested team structure." },
      { id: 'B', text: "Add the team as an administrator on every repository individually." },
      { id: 'C', text: "Make the team organization owners, which is the only way to see every repository." },
      { id: 'D', text: "Assign the security manager role to the team, which grants read access to every repository and the ability to manage security alerts and settings without conferring organization ownership." }
    ],
    correctAnswers: ['D'],
    type: "single",
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: "Consumption is per alert raised, so the estimate depends on how vulnerable the code is." },
      { id: 'D', text: "Consumption is per commit, so the estimate should be based on historical commit volume." }
    ],
    correctAnswers: ['A'],
    type: "single",
