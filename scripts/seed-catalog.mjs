...
const ROADMAP = [
  ...
  ['aws-soa', 'AWS', 'SOA-C03', 'AWS Certified CloudOps Engineer - Associate', 'cloud', 'associate', 720, 1000, 130, null],
  ['aws-dop', 'AWS', 'DOP-C02', 'AWS Certified DevOps Engineer - Professional', 'devops', 'professional', 750, 1000, 180, 1],
  ['aws-ans', 'AWS', 'ANS-C01', 'AWS Certified Advanced Networking - Specialty', 'cloud', 'specialty', 700, 1000, 170, null],
  ...
  ['github-actions', 'GitHub', 'GH-200', 'GitHub Actions', 'devops', 'associate', 700, 1000, 100, null],
  ['github-ghas', 'GitHub', 'GH-500', 'GitHub Advanced Security', 'security', 'associate', 700, 1000, 100, null],
  ['github-foundations', 'GitHub', 'GH-900', 'GitHub Foundations', 'devops', 'foundational', 700, 1000, 100, null],
  ['github-admin', 'GitHub', 'GH-100', 'GitHub Administration', 'devops', 'associate', 700, 1000, 100, null],
  ['github-copilot', 'GitHub', 'GH-300', 'GitHub Copilot', 'devops', 'associate', 700, 1000, 100, null],
  ['github-agentic-ai', 'GitHub', 'GH-600', 'GitHub Certified: Agentic AI Developer', 'devops', 'associate', 700, 1000, 120, null],
