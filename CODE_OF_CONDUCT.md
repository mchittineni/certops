...
Do not submit material taken from a real certification exam. Recalled exam
questions ("braindumps") violate every certification body's NDA and put the
people who use them at risk of decertification. Contributions must be written
from public documentation. Repeatedly submitting such material is grounds for a
permanent ban.
...
reported to the maintainers using GitHub's private reporting: open the
repository's **Security** tab and choose **Report a vulnerability**, which
creates a private thread visible only to maintainers. Use it for conduct reports
too — it is the only private channel this project publishes.
